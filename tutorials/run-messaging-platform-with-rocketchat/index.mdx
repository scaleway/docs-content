...
meta:
  ...
  description: Use RocketChat to run your community with chat, private messaging, and file sharing. Learn how in this guide.
content:
  h1: Running a messaging platform with RocketChat
  paragraph: Use RocketChat to run your community with chat, private messaging, and file sharing. Learn how in this guide.
