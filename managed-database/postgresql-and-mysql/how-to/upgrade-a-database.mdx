...
<Navigation title="See Also">
  <PreviousButton to="/managed-database/postgresql-and-mysql/how-to/configure-advanced-settings/">How to configure advanced settings</PreviousButton>
  <NextButton to="/managed-database/postgresql-and-mysql/how-to/connect-database-private-network/">How to connect a Database Instance to a Private Network</NextButton>
</Navigation>
