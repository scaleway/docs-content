...
Scaleway Database Instances now support Private Networks as a Beta feature. This document will guide you through the steps to configure the Private Network feature on a Scaleway Database Instance through the API. For more information on how to configure Private Networks for Database Instances from the Scaleway Console, follow [this guide]()
