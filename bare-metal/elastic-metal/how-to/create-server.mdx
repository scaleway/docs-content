...
3. Complete the server creation wizard:
    ...
    - Configure the partitions of your server. You can either choose a default configuration or [configure your own partitioning](/bare-metal/elastic-metal/how-to/configure-disk-partitions/) using a JSON configuration.
