...
Clusters for Apache Spark™ (formerly known as Data Lab for Apache Spark™) allows you to create an Apache Spark™ cluster that is distributed across multiple worker nodes to accelerate the processing of large datasets to save time and gain access to actionable insights faster. 
