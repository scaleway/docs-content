...
- A [Serverless Containers namespace](/containers/concepts/#namespace), that contains a [Serverless Container](/containers/quickstart/), which hosts your Next.js application
