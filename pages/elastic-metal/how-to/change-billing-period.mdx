...
1. Click [Elastic Metal](https://account.scaleway.com/?service=elementselastic-metal/servers) in the **Bare Metal** section of the [Scaleway console](https://account.scaleway.com/?service=elements) side menu. The Elastic Metal dashboard displays.
