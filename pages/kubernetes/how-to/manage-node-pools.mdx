...
1. Navigate to the page of the pool that you wish to configure. Once there, click the **Scheduling & Placement** tab.
...
We do not manage the Pod side (Tolerations). This remains the responsibility of the developer in their YAML manifests.
...
1. Navigate to the page of the pool where you wish to define node labels. 
2. In section **Pool details** > **Node labels**, specify a key and a value.
