...
3. Select the customer whose consumption you want to view from the dropdown. Consumption details are displayed in the bar graph. You can adjust the filters for a more precise view. Click **Export from API** to extract consumption data. 
