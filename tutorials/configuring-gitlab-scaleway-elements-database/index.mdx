...
Scaleway Cost-Optimized Instances provide a reliable and performant solution to host your GitLab Instance with a Managed Database for PostgreSQL.
...
5. Set your domain name in the `EXTERNAL_URL` variable, then install GitLab using `apt`:
    ...
    <Message type="important">
      GitLab will automatically request a [Let's Encrypt](/tutorials/configure-nginx-lets-encrypt/) certifcate for your domain name. Make sure you have pointed the `A-Record` of your domain to your Instance's IP address to be able to obtain a valid certificate.
    </Message>
