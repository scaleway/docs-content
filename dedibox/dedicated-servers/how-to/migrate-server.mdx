...
- [Use FTP](/dedibox/dedicated-servers/how-to/connect-to-server/#using-sftp-with-filezilla)
- [Use SCP](/dedibox/dedicated-servers/how-to/connect-to-server/#using-scp-in-a-terminal)
