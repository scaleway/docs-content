...
For dates, use `Month Day, Year` format for optimized readability. Abbreviated format with a 3-letter abbreviation for the month is also accepted when content needs to fit a tight space (e.g., table).
