...
- Attached [Scaleway Block Storage](/block/how-to/attach-a-volume/) to each GlusterFS Instance
...
1. Create and attach Scaleway Block Storage to each Instance:
   - From the Scaleway Console, [create a new Block Storage volume](/block/how-to/create-a-volume/) for each GlusterFS server.
