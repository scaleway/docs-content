...
tags: database compute mysql MariaDB
excerpt: |
...
steps:
  - step: Installing MariaDB
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-install-mariadb-on-ubuntu/#-Installing-MariaDB
  - step: Managing MariaDB Database Server
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-install-mariadb-on-ubuntu/#-Managing-MariaDB-Database-Server
  - step: Securing MariaDB
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-install-mariadb-on-ubuntu/#-Securing-MariaDB
  - step: Resetting MariaDB Root Password
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-install-mariadb-on-ubuntu/#-Resetting-Your-MariaDB-Root-Password
categories:
  - compute
  - storage
brands:
...
permalink: docs/how-to-install-mariadb-on-ubuntu/
