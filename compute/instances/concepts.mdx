...
POP2 Instances are compute resource with dedicated resources (RAM and vCPUs). Designed for demainding applications, high-traffic databases and production workloads.
