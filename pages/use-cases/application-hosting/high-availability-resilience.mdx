...
<Message type="tip">
  See [Product availability by region](https://www.scaleway.com/en/product-availability-by-region/) for an updated list of which products are available in which regions and AZs.
</Message>
