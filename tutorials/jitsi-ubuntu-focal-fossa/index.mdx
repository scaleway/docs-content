...
steps:
  - step: Installing Jitsi Meet
    type: HowToStep
    url: https://www.scaleway.com/en/docs/installing-jitsi-meet-videoconferencing-ubuntu-focal-fossa/#-Installing-Jitsi-Meet
categories:
  - compute
...
<Message type="requirement">
  ...
  - You have a [Scaleway Instance](/compute/instances/how-to/create-an-instance/) running Ubuntu Focal Fossa (for better performance, we recommend that you use an instance with **at least 4 GB of RAM** - DEV1-M or larger)
