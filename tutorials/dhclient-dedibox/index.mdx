...
tags: dedibox dhcpv6 duid autostart dhcp dedicated-servers dhclient
dates:
...
<Message type="important">
  For servers supporting [IPv6 SLAAC](/dedibox-network/ipv6/how-to/enable-ipv6-slaac), it is important to enable SLAAC to ensure proper functioning of DHCPv6. If SLAAC is disabled, the server won't be able to learn its IPv6 default route.
</Message>
