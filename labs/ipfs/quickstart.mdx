...
IPFS is a protocol -made by Protocol Labs- for decentralized storage and content sharing.

You can leverage our IPFS pinning service to store permanently your data on the public IPFS network. You can [create](/labs/ipfs/api-cli/volumes-operations) and manage your Volumes and Pins from the [console](https://console.scaleway.com/login), via the [API](https://developers.scaleway.com/en/products/instance/api/) or via the [Scaleway Command Line Interface](https://github.com/scaleway/scaleway-cli).
...
## How to pin a CID in your volume storage IPFS
...
1. Add content by cid
  ```
  scw ipfs ipfs add-cid volume-id=11111111-1111-1111-1111-111111111111 cid=QmQ6znATkFZdgniHofhFUSm3imBWN5yf5yiU5sLp56VRCu name=MyPinByCID
  ```
...
If you don't want to store a content anymore, you can delete it by indicating the pin-id to remove.
<Message type="note">
  The content will be removed from our storage if your were the last owner of the content.
</Message>
...
It is possible to delete the entire volume, which will remove every attached pins.
