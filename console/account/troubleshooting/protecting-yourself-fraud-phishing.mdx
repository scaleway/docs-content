...
meta:
  ...
  description: This page helps you to protect yourself against phishing and fraud
content:
  h1: Protecting yourself against phishing and fraud
  paragraph: This page helps you to protect yourself against phishing and fraud
...
- **Verify the sender:** Always check the email address of the sender to ensure it’s from an official Scaleway domain.
...
2. **Report to Scaleway:** Forward the email or provide details of the suspicious activity to Scaleway’s security team at security@scaleway.com.
...
For more information, visit [Scaleway Security](https://www.scaleway.com/security).