...
Each Network has its protocol-related specificities, which you can find in the [Networks reference documentation](/iot-hub/reference-content/networks/).
...
For more information about the different authentication protocols, refer to the [Devices reference documentation](/iot-hub/reference-content/devices/).
...
There are also multiple additional features such as topics wildcards, message retention and QoS levels. Head to our [Hubs reference documentation](/iot-hub/reference-content/hubs/) for more information.
...
Services can reply with a message to publish back on your IoT Hub. For more information, check our [Routes reference documentation](/iot-hub/reference-content/routes/).
