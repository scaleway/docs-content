...
categories:
  - webhosting
---
import image from './assets/scaleway-webhosting-overview.webp'
import image2 from './assets/scaleway-webhosting-control-panel-dashboard.webp'
import image3 from './assets/scaleway-cpanel-login1.webp'
import image4 from './assets/scaleway-webhosting-overview.webp'
import image5 from './assets/scaleway-webhosting-control-panel-dashboard.webp'
import image6 from './assets/scaleway-plesk-login.webp'
import image7 from './assets/scaleway-cpanel-language1.webp'
import image8 from './assets/scaleway-cpanel-language2.webp'
import image9 from './assets/scaleway-cpanel-language3.webp'
import image11 from './assets/scaleway-cpanel-login1.webp'
import image12 from './assets/scaleway-cpanel-login2.webp'
import image13 from './assets/scaleway-cpanel-login1.webp'
import image14 from './assets/scaleway-cpanel-login2.webp'
import image15 from './assets/scaleway-cpanel-email.webp'
import image16 from './assets/scaleway-cpanel-email-create.webp'
import image17 from './assets/scaleway-cpanel-email-create-form.webp'
import image18 from './assets/scaleway-email-created.webp'
import image19 from './assets/scaleway-plesk-email.webp'
import image21 from './assets/scaleway-plesk-webmail.webp'
import image22 from './assets/scaleway-cpanel-filemanager.webp'
import image23 from './assets/scaleway-cpanel-filemanager-view.webp'
import image24 from './assets/scaleway-plesk-filemanager.webp'
...
3. Select a **region** and a **control panel** for your Web Hosting plan. 
     * You can choose between:
      ...
      <Message type="tip">
          Unsure which control panel to choose? Check out our documentation on [Understanding the differences between cPanel and Plesk](/webhosting/reference-content/understanding-differences-cpanel-plesk/).
      </Message>
4. Follow these steps to configure your Web Hosting:
   - Enter your **domain name**. Remember, it must be pre-registered and you must be the registrant. Need to register one? [Read our documentation how to register a domain name](/domains-and-dns/how-to/register-internal-domain/).
...
<Tabs>
    ...
    <TabsTab label="Plesk Web Hosting">
        ...
        2. Enter your **user** and the **temporary password** from the mail you have received after account creation.
            <Lightbox src={image13} alt="" />
        3. Enter your **temporary password** as well as your **new password** and it's confirmation. A secret password with a score of 65/100 or more is required for the new password.
            <Lightbox src={image14} alt="" />
            <Message type="tip">
                You can use the **Password generator** to generate a safe random password.
            </Message>
        4. Click **Change your password now** to confirm the password update. You are being redirected to the login screen and you can login using your user and the newly set password.
