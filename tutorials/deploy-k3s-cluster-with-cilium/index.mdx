...
7. Create an environment variable named `master` with the public IPv6 address assigned to the instance.
...
2. Connect to the Scaleway instance: `ssh root@[$master]`
...
6. As you will install Cilium with Gateway API support, you need to make sure the Gateway API CRDS are installed.
...
3. Verify that your application is deployed and accessible `http://[2001:bc8:1210:2fb:dc00:ff:fe20:adef]/`
...
5. Connect to `master` and verify the status of the Kubernetes nodes.
