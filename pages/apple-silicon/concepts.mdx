...
By committing to a plan, you can enjoy better rates compared to pay-as-you-go pricing. The initial commitment is for one month from the order of the server. At the end of your initial commitment period, the commitment is automatically renewed every month on the anniversary date, unless you choose to delete the machine, in which case the deletion will take effect on the anniversary date of the commitment.

The commitment concerns the server and its associated options (such as the VPC option), which also have lower prices with monthly billing. [Learn how to manage a commitment plan.](/apple-silicon/how-to/manage-commitment-plan/)
