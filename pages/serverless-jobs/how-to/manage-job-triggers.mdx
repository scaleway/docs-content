...
3. Click **+ Create trigger**. The trigger creation form displays.
    ...
    4. Optionally, enter a [command and arguments](/serverless-jobs/concepts/#commands-and-arguments) specifically for this trigger to override the default command and arguments of your job at runtime.
