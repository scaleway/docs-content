...
Domain Name System (DNS) is a domain name management service that allows you to avoid browsing the internet only by IP addresses. It provides human management of addressable resources on the internet. It is possible to create zones and records to manage a subdomain (e.g., `test.mydomain.com`) or specific configurations, such as the MX of your mailbox.
...
Refer to the [dedicated documentation](/domains-and-dns/reference-content/registration-requirements/) to find out about domain registration requirements.

### How long is the registration of a domain name valid for?

Your registration is valid for a minimum of 1 year.
You can reserve certain extensions for up to 10 years.
...
### I received an email verification request. Is it legitimate? What should I do?

You can receive legitimate email verification requests which can sometimes appear in your spam folder. In accordance with [ICANN](https://www.icann.org/resources/pages/about-icann) requirements, Scaleway must verify the email address associated with your domain name. This verification may be required following a domain registration, an incoming transfer, or an update to the registrant's contact information.

- Open the verification email you received. 

    <Message type="important">
      Before clicking the verification link, make sure it redirects to https://emailverification.info/. If the destination is different or the message appears suspicious, do not proceed and contact our [Support team](https://console.scaleway.com/support/tickets/create).
      Your login and password information will NOT be asked during all this process.
    </Message> 

 - To verify your email address, click the link to https://emailverification.info/ and enter the verification code.

The verification must be completed within 15 calendar days. Otherwise, the domain name may be suspended, and services relying on the domain, such as your website or email, will become unavailable until the verification is completed. 
...
The reasons for refusal are generally because the domain name:

- Is locked with the status `client transfer prohibited`: the applicant forgot to remove the padlock from the registrar before requesting the transfer of the domain name
- Was registered for less than 60 days
- Was the subject of a previous transfer for less than 60 days
- Has expired
- Is the subject of a dispute in progress (UDRP procedure, for example)
