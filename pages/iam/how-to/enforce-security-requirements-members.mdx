...
From their first login, Members have a default grace period of 7 days to comply with security requirements before their access to the Organization is automatically locked. You can extend or reduce the grace period in the console.
