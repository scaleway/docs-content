...
When your consumption exceeds the Free Tier, you will be billed for each additional token consumed by the model and token type. Free Tier is first applied to most expensive tokens first. **The minimum billing unit is 1,000 tokens**.
