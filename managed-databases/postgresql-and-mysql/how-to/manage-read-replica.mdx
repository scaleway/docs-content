...
- [Created a Read Replica](/postgresql-and-mysql/how-to/create-read-replica/)
...
Refer to the [How to delete a public endpoint](/postgresql-and-mysql/how-to/remove-public-endpoint/#from-read-replicas) documentation page to do so for your Read Replica.
