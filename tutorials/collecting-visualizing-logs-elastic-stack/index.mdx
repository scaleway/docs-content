...
meta:
  ...
  description: This tutorial shows how to collect logs and manage ELK logging.
content:
...
tags: Instances bare-metal ELK-stack ELK-logging elastic-stack elasticsearch logstash kibana 
steps:
...
The ELK stack consists of: 
  ...
  - [Logstash](https://www.elastic.co/products/logstash), a server-side data processing pipeline that accepts data from various simultaneously, transforms it, and exports the data to various targets.
...
<Message type="requirement">
  ...
  - You have created [an Instance](/compute/instances/how-to/create-an-instance/) or a [Bare Metal server](/compute/bare-metal-cloud/how-to/create-server/) with at least 4GB of RAM
...
11. Run the following command to verify if Elasticsearch is running:
  ```
...
15. Use OpenSSL to create a user and password for the Elastic Stack interface. This command generates a `htpasswd` file, containing the user `kibana` and a password you are be prompted to create.
