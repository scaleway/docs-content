...
<Message type="note">
        If your deployment is inside a Private Network, see [how to connect your deployment to PowerBI in a Private Network](/data-warehouse/how-to/connect-powerbi-vpc/). 
    </Message>
