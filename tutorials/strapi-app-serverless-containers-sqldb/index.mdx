...
You can either deploy your application:
  - [step by step using the Scaleway CLI](#deploy-strapi-headless-cms-using-scaleway-cli/) to understand each action performed in detail and the resources required
