...
Postman also disposes of a Command Line Interface (CLI) called `newman` that you can use to run your collections. Find out more about newman in the [README](https://github.com/postmanlabs/newman).
