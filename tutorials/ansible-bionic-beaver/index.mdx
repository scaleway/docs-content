...
totalTime: PT20M
steps:
  - step: Installing Ansible 2.6 on Ubuntu Bionic Beaver
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/ansible-galaxy/#-Installing-Ansible-26-on-Ubuntu-Bionic-Beaver
  - step: Installing Ansible from PPA repository
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/ansible-galaxy/#-Installing-Ansible-from-PPA-repository
  - step: Alternative Installation of Ansible
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/ansible-galaxy/#-Alternative-Installation-of-Ansible
  - step: Configuring SSH Access to the Ansible Hosts
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/ansible-galaxy/#-Configuring-SSH-Access-to-the-Ansible-Hosts
  - step: Configuring Ansible Hosts
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/ansible-galaxy/#-Configuring-Ansible-Hosts
  - step: Using Ansible Commands
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/ansible-galaxy/#-Using-Ansible-Commands
  - step: Going Further?
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/ansible-galaxy/#-Going-Further
categories:
  - compute
  - instance-dev
image: /assets/images/docs/scaleway.png
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, linux server, baremetal, scalability, ARM, physical server, dedicated server, ansible, playbook, hosts, roles
dates:
