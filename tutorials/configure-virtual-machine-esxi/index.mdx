...
The process from this step forward may differ according to the KVM model being used. Please refer to the Dedibox [KVM over IP documentation](/dedibox/kvm-over-ip/quickstart/) to conclude the installation.
