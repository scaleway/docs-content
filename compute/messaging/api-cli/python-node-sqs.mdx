...
<Message type="note">
  ...
  The `endpoint_url` for Scaleway Messaging is `http://51.159.73.139:4280`. For the access and secret key values, use the credentials you [generated](/compute/messaging/how-to/create-credentials/) for your SNS/SQS namespace.
