...
This list [defines permissions for remote access to a Deployment](/ai-data/llm-inference/how-to/manage-allowed-ip-addresses/). The IP allowed can be a single IP or an IP block. You can use this feature to define which host and networks can connect to your LLM Inference endpoints. You can add, edit, or delete allowed IPs. In the absence of allowed IPs, all IP addresses are allowed by default.
