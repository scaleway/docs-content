---
layout: docs
title: Quickstart RPN
description: This page shows you how to get started with RPN (Real Private Network)
excerpt: |
  This page shows you how to get started with RPN (Real Private Network).
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/dedibox-network/rpn/quickstart
dates:
...
<Message type="note">
  ...
  A VLAN ID is assigned automatically during the group creation. It is possible to modify the VLAN it with walues between 1 and 3967 
...
The following configuration example uses [Netplan](https://netplan.io/). If you are using a classic network configuration, refer to the Debian documentation. 
...
The RPN supports Jumboframes with a maximum payload of 9000 bytes. You need to configure your RPN interface to send pacekets with a MTU 9000. For more information refer to our how to: [Configuration of Jumboframes](/rpn/how-to/configure-jumboframes/)
