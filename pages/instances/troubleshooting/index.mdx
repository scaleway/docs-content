...
<Grid>
    ...
    <DefaultCard
      ...
      description="Compare pricing and functioning to choose the best Instance type for your use case."
      url="/instances/reference-content/choosing-instance-type/"
      label="See more"
    />
    <DefaultCard
      title="Instances datasheet"
      description="Compare technical specifications with the Instances datasheet."
...
<Grid>
    ...
    <DefaultCard
      ...
      description="Learn about the technical aspects of internet and Block Storage bandwidth of Instance types."
