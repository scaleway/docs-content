...
Whenever your Database Instance volume is close to reaching full capacity, and there is only 1GB of free space left, your Database Instance switches to `disk_full` state. 

This state allows you to increase your volume, if you use Block Storage, or [upgrade your node type](). You are also able to clear some space in your volume increase your capacity. 
