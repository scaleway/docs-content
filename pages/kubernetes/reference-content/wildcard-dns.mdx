...
```
  ...
  - The `nodeSelector` ensures the ingress controller pods run on nodes in the `39149a15-8707-4ae3-b326-3e0a74bf4880` pool, which have public IPs. Replace `scaleway.com/pool: 39149a15-8707-4ae3-b326-3e0a74bf4880` if your public IP pool has a different name (check via `kubectl get nodes -o wide`).
