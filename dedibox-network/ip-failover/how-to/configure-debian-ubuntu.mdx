...
This page shows you how to configure a [failover IP](/ip-failover/concepts/#failover-ips) on Dedibox servers running on Debian or Ubuntu Linux.
...
<Message type="note">
  If you are using Ubuntu 18.04 or later, you should configure the interfaces using [Netplan](/network/how-to/configure-network-netplan/).
</Message>
