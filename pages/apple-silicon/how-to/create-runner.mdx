...
5. Retrieve the token from the command in the **Configure** section of the instructions.
    ...
    <Message type="tip">
      The registration token is **single-use** and **expires 1 hour after generation**. Do not share it or publish it publicly.
    </Message>
