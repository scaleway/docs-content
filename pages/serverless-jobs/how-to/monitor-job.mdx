...
You can monitor the activity of your Serverless Jobs using the [Scaleway console](https://account.scaleway.com/?service=elements) to check the current status, RAM, and CPU consumption of your runs. Also, Serverless Jobs is fully integrated into Scaleway’s Observability [Cockpit](/cockpit/quickstart/), and allows you to quickly access your logs.
