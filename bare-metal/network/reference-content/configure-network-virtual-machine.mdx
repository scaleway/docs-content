---
meta:
  title: Configuring the network of a virtual machine
  description: This page explains how to configure the network of a virtual machine.
content:
  h1: Configuring a network of a virtual machine
...
<Message type="requirement">
  ...
  - You have [created](//bare-metal/dedibox/how-to/order-dedibox) a Dedibox dedicated server and installed a hypervisor on it
...
2. Enter the following information in the network adapter configuration:
 ...
 <Navigation title="See Also">
  <PreviousButton to="/bare-metal/network/reference-content/configure-multiip-virtualmac">Creating a multi-IP virtual MAC group</PreviousButton>
  <NextButton to="/bare-metal/network/reference-content/configure-network-netplan/">Network configuration with Netplan on Ubuntu</NextButton>
</Navigation>
