---
layout: docs
title: Vulunerability Scanning with Vuls on Ubuntu Bionic
...
excerpt: |
  Vuls is an open-source vulnerability scanner written in Go. It automates security vulnerability checks on the software installed on a system, which can be a demanding task in a system administrators daily life.
totalTime: PT30M
steps:
  - step: Installing the Dependencies and Pre-work
    type: HowToStep
    url: https://www.scaleway.com/en/docs//tutorials/vuls-security-scanner#-Installing-the-Dependencies-and-Pre-work
  - step: Deploying go-cve-dictionary
    type: HowToStep
    url: https://www.scaleway.com/en/docs//tutorials/vuls-security-scanner#-Deploying-go-cve-dictionary
  - step: Deploying goval-dictionary
    type: HowToStep
    url: https://www.scaleway.com/en/docs//tutorials/vuls-security-scanner#-Deploying-goval-dictionary
  - step: Deploying go-exploitdb
    type: HowToStep
    url: https://www.scaleway.com/en/docs//tutorials/vuls-security-scanner#-Deploying-go-exploitdb
  - step: Deploying Vuls
    type: HowToStep
    url: https://www.scaleway.com/en/docs//tutorials/vuls-security-scanner#-Deploying-Vuls
  - step: Configuring Vuls
    type: HowToStep
    url: https://www.scaleway.com/en/docs//tutorials/vuls-security-scanner#-Configuring-Vuls
  - step: Scanning Multiple Machines (Optional)
    type: HowToStep
    url: https://www.scaleway.com/en/docs//tutorials/vuls-security-scanner#-Scanning-Multiple-Machines-(Optional)
  - step: Configuring Slack Notifications and Periodic Scanning
    type: HowToStep
    url: https://www.scaleway.com/en/docs//tutorials/vuls-security-scanner#-Configuring-Slack-Notifications-and-Periodic-Scanning
categories:
  - compute
  - instances
tags: compute server vuls security vulnerability scanner
image: /assets/images/docs/scaleway.png
permalink: docs//tutorials/vuls-security-scanner
keywords: cloud tutorials, cloud documentations, cloud server, cloud hosting, ubuntu server, debian server, linux server, IAAS, baremetal, scalability, ARM, physical server, dedicated server, physicalization, server, security, vulnerability, vuls, scanner
dates:
...
4. Examine the results:
  ...
  <Lightbox src="scaleway-vuls-scan.png" alt="" />
...
2. Update the APT packet cache, the already installed software on the instance and install `sudo` and `debian-goodies`, which is required for Vuls:
...
2. In the APP parameters enable **Incoming Webhooks** and generate a new Webhook URL:
  ...
  <Lightbox src="scaleway-vuls_webhook.png" alt="" />
...
4. Test the configuration by running the following command:
  ...
  <Lightbox src="scaleway-vuls_slack.png" alt="" />
...
8. Open a web browser and point it to `http://YOUR_SERVER_IP:5111` to visualize the Vuls reports:
  ...
  <Lightbox src="scaleway-vuls_reports.png" alt="" />
