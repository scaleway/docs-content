...
**IP** **A**ddress **M**anager (IPAM) acts as a single source of truth for the IP addresses of Scaleway resources. It has a number of associated functionalities to help you plan, track and manage your Scaleway IP address space.
