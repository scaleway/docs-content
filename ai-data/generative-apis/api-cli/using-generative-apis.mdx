...
- Access to this service is restricted while in beta. Fill out the [participation form](https://www.scaleway.com/en/betas/#generative-api) to request access to the product.
- You need a valid [API key](/identity-and-access-management/iam/how-to/create-api-keys/).
