...
<Message type="tip">
  If you are unsure which chat model to use, we currently recommend `mistral-small-3.2-24b-instruct-2506` to get started, and `qwen3.5-397b-a17b` for best accuracy or coding tasks.
</Message>
