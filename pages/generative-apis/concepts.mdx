...
The **Allowed IPs** feature is no longer available for Generative APIs - Dedicated deployments. Use one of the alternative methods detailed in our [documentation about access management](/managed-inference/how-to/manage-allowed-ips/) to restrict access to your Generative APIs dedicated deployments.
