...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/hardware/reference-content/configure-dell-perc-h310/">How to configure the DELL PERC H310 RAID controller</PreviousButton>
  <NextButton to="/bare-metal/hardware/reference-content/configure-dell-perc-h800/">How to configure the DELL PERC H800 RAID controller</NextButton>
</Navigation>
