...
| Product         | Base bandwidth (Mbps) | Traffic allowance (TB/month) | Throttled speed (Mbps) |
|-----------------|-----------------------|------------------------------|------------------------|
| VPS-START-2-XS  | 200                   | 1 TB                         | 10                     |
| VPS-START-2-S   | 250                   | 2 TB                         | 10                     |
| VPS-START-2-M   | 300                   | 4 TB                         | 15                     |
| VPS-START-2-L   | 500                   | 5 TB                         | 15                     |
| VPS-START-2-XL  | 750                   | 10 TB                        | 30                     |
| VPS-START-2-XXL | 1000                  | 15 TB                        | 30                     |

* **Dedibox VPS PRO 2**

| Product        | Base bandwidth (Mbps)  | Traffic allowance (TB/month) | Throttled speed (Mbps) |
|----------------|------------------------|------------------------------|------------------------|
| VPS-PRO-2-XS   | 300                    | 3 TB                         | 75                     |
| VPS-PRO-2-S    | 400                    | 4 TB                         | 75                     |
| VPS-PRO-2-M    | 500                    | 5 TB                         | 75                     |
| VPS-PRO-2-L    | 600                    | 10 TB                        | 100                    |
| VPS-PRO-2-XL   | 800                    | 15 TB                        | 150                    |
| VPS-PRO-2-XXL  | 1000                   | 20 TB                        | 200                    |
| VPS-PRO-2-XXXL | 1000                   | Fair use \*                  | 300                    |

\* "Fair use" means that bandwidth is throttled only when abuse or a DDoS attack is detected. Otherwise, traffic is unlimited for normal usage.

* **Dedibox VPS STORE 2**

| Product          | Base bandwidth (Mbps)  | Traffic allowance (TB/month) | Throttled speed (Mbps) |
|------------------|------------------------|------------------------------|------------------------|
| VPS-STORE-2-XS   | 10000                  | Fair use \*                  | 300                    |
| VPS-STORE-2-S    | 10000                  | Fair use                     | 500                    |
| VPS-STORE-2-M    | 10000                  | Fair use                     | 750                    |
| VPS-STORE-2-L    | 10000                  | Fair use                     | 1000                   |
| VPS-STORE-2-XL   | 10000                  | Fair use                     | 1250                   |
| VPS-STORE-2-XXL  | 10000                  | Fair use                     | 1500                   |
| VPS-STORE-2-XXXL | 10000                  | Fair use                     | 1500                   | 
