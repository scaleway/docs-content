...
The retry option allows you to define how many times a Serverless Job is automatically rerun in case of failure. When the maximum number of failed retries is reached, the job is permanently marked as failed.
...
4. Set the number of times you want your job to be rerun in case of failure. The default value is 0, and the maximum value is 5.
