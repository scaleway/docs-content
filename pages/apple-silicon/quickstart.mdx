...
1. Click **Apple silicon** in the **Bare Metal** section of the side menu. The [Apple silicon creation page](https://account.scaleway.com/?service=elementsasaas/servers) displays.
...
1. Navigate to the [Scaleway console](https://account.scaleway.com/?service=elements) and log in with your credentials.
