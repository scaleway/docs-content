...
Containers rely on the HTTP protocol, and must therefore include a web server to work properly. Refer to the [differences between Containers, Jobs, and Functions](/containers/reference-content/difference-jobs-functions-containers/) for more information on Scaleway's different Serverless products.
...
4. Click **Create namespace and add container**. The container creation wizard displays.
    <Message type="note">
      Refer to the [How to create, manage and delete a Containers namespace](/containers/how-to/create-manage-delete-containers-namespace/) documentation page for more information on the different parameters.
    </Message>
5. Complete the following steps in the wizard:
    ...
    <Message type="note">
      Refer to [How to deploy a Container from the Scaleway Registry](/containers/how-to/deploy-container/) for more information on the different parameters.
    </Message>
...
5. Complete the following steps in the wizard:
    ...
    - Verify the estimated cost.
    <Message type="note">
      Refer to [How to deploy a Container from an external container registry](/containers/how-to/deploy-container/) for more information on the different parameters.
    </Message>
...
For advanced usage, such as larger projects with dependencies, automation, multiple containers, and more, there are [several ways to deploy containers](/containers/reference-content/deploy-container/).
