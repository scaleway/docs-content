...
You can easily create a NATS namespace from the [Scaleway console](/serverless/messaging/how-to/create-namespace), via the [Scaleway API](https://www.scaleway.com/en/developers/api/messaging-and-queuing/) or via [Terraform](https://registry.terraform.io/providers/scaleway/scaleway/latest/docs/guides/mnq_with_nats_terraform_provider).
