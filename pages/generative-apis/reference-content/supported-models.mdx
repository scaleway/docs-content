...
Note that due to a partnership between H company and Scaleway, licence `CC-BY-NC-4.0` for `holo2-30b-a3b` does not apply to usage made through Scaleway Products, and does not restrict any commercial usage. The original licence applying to the publicly available model is still mentioned for transparency.
