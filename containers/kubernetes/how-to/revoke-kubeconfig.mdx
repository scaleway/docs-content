...
Kubernetes Kapsule uses now an updated authentication system, based on IAM tokens. **This leads to the simultaneous existence of two authentication mechanisms.**
