...
1. Build your image using the following command: 
    ...
    ```
2. [Push](/containers/container-registry/how-to/push-images/) the created image into the [container registry](https://www.scaleway.com/en/docs/containers/container-registry/quickstart/) linked to your Containers namespace
    <Message type="tip">
