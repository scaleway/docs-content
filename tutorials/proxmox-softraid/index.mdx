...
- A [Dedibox](https://www.scaleway.com/en/dedibox/) with [KVM-over-IP](/kvm-over-ip/concepts/#kvm-over-ip) access

## Installing Proxmox

1. Create a [KVM-over-IP](/kvm-over-ip/quickstart/) session from your [Dedibox console](https://console.online.net/).
...
- [Failover IP configuration for VMs on Dedibox servers](/ip-failover/quickstart/)