...
Access control list (ACL) rules [define permissions for remote access to an Instance](/managed-database/postgresql-and-mysql/how-to/manage-allowed-ip-addresses/). A rule consists of an IP address or an IP range.
...
A database backup is a complete dated export of a Database Instance stored on an offsite backup backend. Once a backup is [created](/managed-database/postgresql-and-mysql/how-to/manage-manual-backups/), it can be used to fully restore the database.
