...
3. Run the container with the following command: 
    ...
    * Replace `$DB_PORT` with the port your MySQL server is listening on. 
    ...
    If you are using a [Managed Database for MySQL](https://www.scaleway.com/en/databases/) you can find the connection details on the Database information page: 
