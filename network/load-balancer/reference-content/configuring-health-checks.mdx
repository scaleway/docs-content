...
This setting is inherited from the [backend configuration](/network/load-balancer/reference-content/configuring-backends/#verify-certificate) and cannot be overriden:
