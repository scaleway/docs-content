...
This documentation page provides information about the different secret types available with the Secret Manager API, and how to use them with Terraform/OpenTofu.
...
Refer to the [Secret Manager API documentation](https://www.scaleway.com/en/developers/api/secret-manager/#path-secrets-create-a-secret) for more information.
