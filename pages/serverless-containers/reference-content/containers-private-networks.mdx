...
Scaleway Serverless Containers support [Virtual Private Cloud (VPC)](/vpc/) and can be attached to a Private Network, which allows you to securely connect your resources in an isolated environment. See [Use Private Networks](/serverless-containers/how-to/use-private-networks/) for more information.

[VPC routing](/vpc/reference-content/understanding-routing/): custom routes and cross-PN automatic routing are supported on Serverless Containers.
...
- Enable the private endpoint for your container to communicate with other resources attached to the same Private Network.
- Disable the public endpoint for your container to isolate it from the public internet.
...
See [Organization Quotas](/organizations-and-projects/additional-content/organization-quotas/) for more information on Private Networks quotas for Serverless Containers.
