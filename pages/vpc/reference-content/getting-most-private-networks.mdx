...
* **Compatible with reserved IPs**: Whether or not you can use a [reserved IP](/ipam/how-to/attach-resource/#how-to-attach-a-managed-resource-to-a-private-network-using-a-reserved-ip-address) to attach the resource to a Private Network

|                              | Instance | Elastic Metal | Apple silicon | Kubernetes | Generative APIs - Dedicated Deployment |
|------------------------------|----------|---------------|---------------|------------|-------------------|
