...
To use Packer with Scaleway, you must [generate an API key](/iam/credentials/create-api-keys/) from the management console.
...
- `commercial_type` (string) - The name of the commercial type used to boot for example: RENDER-S, GP1-L, GP1-M, GP1-S, GP1-XS.
