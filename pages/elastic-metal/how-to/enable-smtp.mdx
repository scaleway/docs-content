...
- [Verified your identity](/account/setup-lifecycle/verify-identity/)
...
2. Click the **General Settings** tab. The SMTP configuration displays.
   <Message type="important">
      You must [verify your identity](/account/setup-lifecycle/verify-identity/) before you can enable the SMTP ports.
   </Message>
