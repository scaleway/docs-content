...
1. Click your username, next to _logged in as_, in the top right corner of the [Online console](https://account.scaleway.com/?service=dedibox). From the drop-down menu, select **Services**. The service page displays.
