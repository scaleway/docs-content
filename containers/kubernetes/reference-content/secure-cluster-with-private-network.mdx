...
You can use the Scaleway console to migrate all your previous clusters **(recommended)** or the CLI or Terraform.
...
<Message type="important">
  Existing Kapsule clusters can me migrated by adding the `private_network_id` attribute over an existing Terraform definition.
