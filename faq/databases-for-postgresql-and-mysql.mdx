...
[CIDR notation](https://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing) is the shortest notation containing the required information to configure the endpoint: IP address and network mask.
