...
During the installation or reinstallation of a Elastic Metal server with a Windows Server operating system, an administrator password is set by you (Administrator account).
