...
Cloud Twins, or simply Twins, are virtual representations of your physical assets. Technically, they are JSON document sets stored in a Hub. You can store and fetch data at any time with these documents. Refer to [our documentation about Cloud Twins](/iot/iot-hub/reference-content/twins/).
