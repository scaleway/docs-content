...
You are billed for a VPN gateway from the moment you create it, until you delete it. You can [delete a VPN gateway](/site-to-site-vpn/how-to/create-manage-vpn-gateway/#how-to-delete-a-vpn-gateway) at any time.
