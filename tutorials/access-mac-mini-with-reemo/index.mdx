...
1. Log into your Mac mini. You can [connect](/bare-metal/apple-silicon/how-to/connect-to-mac-mini-m1/) to your machine either using the VNC client or via SSH. 
2. If you are logged into the Mac mini via VNC, open a terminal. If you are connected via SSH you can skip this step.
3. Run the following command to install the Reemo client on your machine:
    ...
    ```
    <Message type="note">
      You must be logged into the administrator account of your Mac mini to run the command above.
    </Message>
