...
You must be the owner of the VPC, or have the correct [permission sets](/iam/reference-content/permission-sets/#scoped-by-project) in order to create a peering connector where it is defined as origin. You also need to know the unique VPC ID of the target VPC you want to peer with. Older VPCs must have [activated routing](/vpc/how-to/manage-routing/#how-to-activate-routing) for successful peering.
