...
This leads to unexpected and unreliable behavior, as the Cloud Controller Manager of the cluster is unaware of the Load Balancer and attempts to overwrite configurations made in the console.
