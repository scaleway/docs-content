...
Permissions define the actions a user or an application can perform on a database. They are managed using Scaleway's [Identity and Access Management](/iam/concepts/quickstart/) interface.
...
4. Complete the steps on the first page of the creation wizard:
    ...
    - Select a **principal**, who will be the target of your policy. The [principal](/iam/concepts/glossary/#principal) should be the user, application, or group you want to grant access to your database.
...
6. Select **Access to resources**, then, select the [Project](/iam/concepts/glossary/#project) in which you want the permissions to apply.
