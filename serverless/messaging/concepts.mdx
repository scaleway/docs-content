...
**A**dvanced **M**essage **Q**ueuing **P**rotocol (AMQP) is an open standard messaging [protocol](#messaging-protocol) that allows sending transactional messages between servers and devices via a message broker. The advantages of AMQP are reliable communication and interoperability.
