...
description: Find out how to create a routing policy for your Scaleway InterLink. allow incoming and outgoing route announcements, so that traffic can flow securely over your InterLink.
dates:
