...
content:
  h1: How to attach a Local Storage volume to an Instance
  paragraph: This guide explains how to attach a Local Storage volume to a Scaleway Instance. Follow simple steps to manage your storage efficiently.
