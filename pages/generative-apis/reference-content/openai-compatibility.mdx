---
title: OpenAI API compatibility for Dedicated Deployments
description: Scaleway Generative APIs - Dedicated Deployment provides compatibility with parts of the OpenAI API, to help connect existing applications.
