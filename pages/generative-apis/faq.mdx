...
In this case, we recommend to use models which supports custom dimensions number (also known as [Matryoshka embeddings](https://huggingface.co/blog/matryoshka)).
