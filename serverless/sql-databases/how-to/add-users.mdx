...
- [Created a policy to manage users' permissions](/sql-databases/how-to/manage-permissions/)
- [Invited a user to your Organization](/iam/how-to/invite-user-to-orga/) or [created an application](/iam/how-to/create-application/) in IAM
...
5. Choose **Select an unassigned policy**, then, select the previously created policy from the drop-down menu.
    ...
    <Message type="note">
        You can also [create a new policy](/sql-databases/how-to/manage-permissions/) or duplicate an existing one to manage the permissions of a user.
    </Message>
...
6. Choose **Select an unassigned policy**, then, select the previously created policy from the drop-down menu.
    ...
    <Message type="note">
        You can also [create a new policy](/sql-databases/how-to/manage-permissions/) or duplicate an existing one to manage the permissions of an application.
    </Message>
