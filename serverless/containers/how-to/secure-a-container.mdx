...
content:
  ...
  paragraph: This page explains how to secure a Serverless container
...
<Message type="requirement">
  ...
  - You have created an [authentication token](/serverless/container/how-to/create-auth-token-from-console/) for your container
</Message>
...
6. If required, [create an access token](/serverless/container/how-to/create-auth-token-from-console/) for your container.
...
<Navigation title="See Also">
  ...
  <NextButton to="/serverless/containers/how-to/add-trigger-to-a-container//">How to add a trigger to a container</NextButton>
</Navigation>