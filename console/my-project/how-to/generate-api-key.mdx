...
[API keys](/console/my-account/concepts/#api-key) are unique identifiers associated with your Scaleway Projects and consist of an [access key](/console/my-account/concepts/#access-key) and a [secret key](/console/my-account/concepts/#secret-key). They allow you to use the [Scaleway API](https://www.scaleway.com/en/developers/api/). 
