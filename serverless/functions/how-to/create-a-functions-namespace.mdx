...
meta:
  ...
  description: Step-by-step process for creating a Serverless Functions namespace in Scaleway.
content:
  h1: How to create a functions namespace
  paragraph: Step-by-step process for creating a Serverless Functions namespace in Scaleway.
...
This page shows you how to create a functions namespace using the Scaleway console.
