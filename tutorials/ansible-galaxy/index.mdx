...
content:
  ...
  paragraph: Discover how to configure Ansible Galaxy
tags: ansible getting-started ansible-galaxy 
steps:
...
Ansible roles are consists of several playbooks which are a way to group multiple tasks together into one container to do the automation in very effective manner with clean directory structures.
