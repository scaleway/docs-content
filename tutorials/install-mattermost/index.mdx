...
totalTime: PT10M
steps:
  - step: Installing Mattermost
    type: HowToStep
    url: https://www.scaleway.com/en/docs/installing-mattermost-messaging-ubuntu-bionic/#-Installing-Mattermost
  - step: Installing a Nginx Proxy with Let's Encrypt
    type: HowToStep
    url: https://www.scaleway.com/en/docs/installing-mattermost-messaging-ubuntu-bionic/#-Installing-a-Nginx-Proxy-with-Lets-Encrypt
categories:
  - compute
brands:
  - elements
...
permalink: /tutorials/install-mattermost/index.mdx
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, debian server, linux server, IAAS, baremetal, scalability, ARM, physical server, dedicated server, physicalization, server, messaging, slack, mattermost, workplace, self-hosted, selfhosted
dates:
...
1. Download the [latest version](https://mattermost.com/download/) of the Mattermost server to your instance. At the time writing this tutorial it is version 5.7.
