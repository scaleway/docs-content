...
You can use Public Gateways in [SHH bastion](https://www.scaleway.com/en/docs/network/public-gateways/how-to/use-ssh-bastion/) mode and perform port forwarding.
</Message>
...
<Navigation title="See also">
  ...
  <NextButton to="/managed-databases/postgresql-and-mysql/how-to/remove-public-endpoint">How to remove public endpoints</NextButton>
</Navigation>
