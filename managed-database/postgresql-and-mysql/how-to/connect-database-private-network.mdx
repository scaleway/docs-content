...
<Navigation title="See Also">
  <PreviousButton to="/managed-database/postgresql-and-mysql/how-to/upgrade-a-database/">How to upgrade a database</PreviousButton>
  <NextButton to="/managed-database/postgresql-and-mysql/how-to/delete-a-database/">How to delete a database</NextButton>
</Navigation>