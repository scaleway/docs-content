...
3. Scroll down to the **Device Auto-Provisioning** panel and slide the <Icon name="toggle" /> toggle to **Enabled**.
    ...
    When auto-provisioning is enabled, IoT Hub will try to add new devices upon first connection. A [Hub Event](/managed-services/iot-hub/concepts/#hub-events) will be raised upon success or failure.
