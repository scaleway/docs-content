...
This state allows you to increase your volume, if you use Block Storage, or [upgrade your node type](/postgresql-and-mysql/how-to/upgrade-a-database/). You can also clear some space in your volume to increase your capacity.
...
1. [Connect to your Database Instance](/postgresql-and-mysql/how-to/connect-database-instance/).
