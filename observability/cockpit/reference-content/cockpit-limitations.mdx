...
[Metrics](/observability/cockpit/concepts/#metric) data is retained for 30 days. After this period, data older than 30 days is deleted.

Extended retention is available for €29 per month, which includes 12 months of retention for metrics and 1 month for logs. Check out the [Cockpit pricing](https://www.scaleway.com/en/pricing/?tags=available,managedservices-observability-cockpit) page for more information.

## Logs

[Logs](/observability/cockpit/concepts/#logs) data is retained for 7 days. After this period, data older than 7 days is deleted.

Extended retention is available for €29 per month, which includes 12 months of retention for metrics and 1 month for logs. Check out the [Cockpit pricing](https://www.scaleway.com/en/pricing/?tags=available,managedservices-observability-cockpit) page for more information.

## Traces

[Traces](/observability/cockpit/concepts/#traces) are free of charge during Public beta. Traces data is retained for 14 days. After this period, data older than 14 days is deleted.
