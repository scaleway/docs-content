...
- [Definitions](#definitions)
  ...
  + [Task](#task)
    - [Call](#call)
        ...
        + ~~[A2A](#a2a-call)~~ 
        + ~~[MCP](#mcp-call)~~ 
        + [ServerlessJob](#serverless-job-call)
        + [ServerlessFunction](#serverless-function-call)
        + [ServerlessContainer](#serverless-container-call)
    - [Do](#do)
    - ~~[Emit](#emit)~~ 
    - ~~[For](#for)~~ 
    - [Fork](#fork)
    ...
    - [Run](#run)
        ...
        + [ServerlessContainer](#serverless-container-run)
    - [Set](#set)
    - [Switch](#switch)
    - [Try](#try)
    - [Wait](#wait)
...
> [!IMPORTANT]
> Not used in dsl, use the scaleway features
...
> [!NOTE]
> Not yet implemented, See the Scaleway roadmap
...
##### Serverless-Job Call
{/* Add by Scaleway/Data-Orchestrator team */}

The [Scaleway Serverless Job Call](#serverless-job-call) allow you to run recurring and autonomous tasks in the cloud.
...
> [!IMPORTANT]
> The job must be in the same project as your workflow.
...
The [Scaleway Serverless Function Call](#serverless-function-call) allow you to call default endpoint of yours Serverless Functions, as a http call.
...
> [!IMPORTANT]
> The function must be in the same project as your workflow.
...
##### serverless-container Call
{/* Add by Scaleway/Data-Orchestrator team */}

The [Scaleway Serverless Container Call](#serverless-container-call) allow you to call default endpoint of yours Serverless Containers, as a http call.
...
> [!IMPORTANT]
> The container must be in the same project as your workflow.
...
[//]: # ( TODO SAA-411 revoir tout ce qui concerne RUN)

Provides the capability to execute external [Scaleway Serverless Containers](#serverless-container-run).

##### Properties

| Name | Type | Required | Description |
|:--|:---:|:---:|:---|
| run.serverless_container | [`serverless_container`](#serverless-container-run) | `no` | The definition of the Scaleway Serverless Container to run.<br />*Required if `container`, `script`, `shell` and `workflow` have not been set.* |
...
##### Serverless Container Run

{/* Added by Scaleway/Data-Orchestrator team */}

The [Scaleway Serverless Container Run](#serverless-container-run) allows you to deploy, manage, and delete Scaleway Serverless Containers directly from your workflows.
