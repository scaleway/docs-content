...
1. From the [Scaleway console](https://console.scaleway.com), navigate to the [Credentials](/console/organizations-and-projects/concepts/#ssh-key) tab of your Project Dashboard.
