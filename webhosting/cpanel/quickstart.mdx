...
<Lightbox src="scaleway_hosting1.png" alt="" />
<Lightbox src="scaleway_hosting2.png" alt="" />
<Lightbox src="scaleway_dashboard_cpanel.png" alt="" />

## How to access the Webmail 

The classic Scaleway Dedibox webmail interface will remain available via the [website](webmail.cloud.online.net). If you wish to manage your e-mails through cPanel, you can access the webmail platform directly via the cPanel dashboard.
...
1. From the console, click **Domain** on the upper menu of the Scaleway Dedibox console. A list of your domain names displays. 
    ...
    <Lightbox src="scaleway_domain_cpanel1.png" alt="" />

2. Click the **Configure domain name** action of the domain you wish to set-up. The **Status of domain name** page displays. 

    <Lightbox src="scaleway_list_of_domains.png" alt="" />
    <Lightbox src="scaleway_status_of_domain_names.png" alt="" />
