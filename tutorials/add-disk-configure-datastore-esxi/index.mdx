...
On [Dedibox](https://www.scaleway.com/en/dedibox/), you can order as many [additional disks](https://www.scaleway.com/en/dedibox/storage/) as you need. They can be used as additional Datastore in [ESXi](https://www.vmware.com/products/esxi-and-esx.html) to store your virtual machines, for example.
...
Note that instead of adding additional disks to your server, you can also use remote storage based on our RPN-SAN service to add an additional datastore to your ESXi host.
