...
Git is unarguably the most popular and powerful version control system to store your code, and can handle files up to 5 GB thanks to Git LFS. But what about large datasets?

In that case, you might need to turn to third-party version control tools that are designed to handle large datasets. 
...
<Message type="requirement">
  ...
  - You have made your [first request with Scaleway API](https://www.scaleway.com/en/developers/api/#quickstart:-first-request)
