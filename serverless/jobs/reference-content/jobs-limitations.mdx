...
You must ensure to build your image to target `amd64` architecture, to acheive this there are multiple solutions:
* you can use the following docker command: `docker buildx build --platform linux/amd64 .`
* or you can use an Instance with `amd64` architecture to run your builds.
