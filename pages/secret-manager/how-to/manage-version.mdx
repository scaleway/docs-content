...
This page explains how to manage a secret [version](/secret-manager/concepts/#version) using the [Scaleway console](https://account.scaleway.com/?service=elements).
