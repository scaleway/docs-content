---
title: How to configure the Annotations permission set
...
This page teaches you how to configure the necessary IAM permission set to access [Annotations](/annotations/concepts/#annotations).
...
3. Select the **Access to Organization features** scope and click **Validate** to move on to the next step.
    <Message type="important">
     The **Access to Organization features** scope allows you to give the [principal](/iam/concepts/#principal) permissions to Organization-level features such as IAM, Annotations, billing, support tickets, and project management.
    </Message>
