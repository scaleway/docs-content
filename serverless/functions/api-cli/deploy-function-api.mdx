...
3. Create a zip file containing your function's code by following [this procedure](/functions/how-to/package-function-dependencies-in-zip/).
...
4. Upload your zip file [using the Scaleway console or the Scaleway API](/functions/how-to/package-function-dependencies-in-zip/#how-to-upload-your-zip-file).
