---
meta:
  title: Configuring a RPNv1 gateway on an RPNv2 Dedibox
  description: This page explains how to configure the RPNv1 gateway on a Dedibox
content:
  h1: Configuring a RPNv1 gateway on an RPNv2 Dedibox
...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/network/reference-content/use-rpn-vpn/">How to use the RPN VPN</PreviousButton>
  <NextButton to="/bare-metal/network/reference-content/find-rpn-gateway/">How to find the RPNv1 gateway</NextButton>
</Navigation>