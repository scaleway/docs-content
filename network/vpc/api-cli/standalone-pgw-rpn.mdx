...
Scaleway regional Private Networks currently support [Public Gateways](/network/public-gateways/concepts/#public-gateway): Instances attached to the regional Private Network are automatically assigned an IP address via the gateway's managed DHCP functionality.
