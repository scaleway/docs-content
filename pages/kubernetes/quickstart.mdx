...
1. Configure the following for each pool:
    ...
    * Configure **pool options**:
      ...
      * **Advanced options** tab: Configure an optional [cloud-init](/kubernetes/how-to/create-cluster/#how-to-configure-a-cloud-init-script) script to customize your nodes on first boot.
...
2. Configure your pool:
    ...
    * If required, configure **pool options**:
      ...
      * **Advanced options** tab: Configure an optional [cloud-init](/kubernetes/how-to/create-kosmos-cluster/#how-to-configure-a-cloud-init-script) script to customize your nodes on first boot.
