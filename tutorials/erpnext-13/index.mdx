...
categories:
  ...
  - dedibox
  - compute
image: /assets/scaleway_erpnext.webp
dates:
  validation: 2022-06-24
  posted: 2021-09-14
---
...
2. Initialize the Frappe framework using the following command. Remember to replace `/home/mariecurie` with the proper home path of your user:
  ...
  ERPnext requires specific versions of certain Python packages. In case the `bench init` command fails, install the versions required by running the following command: 
