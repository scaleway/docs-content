...
All new Kubernetes clusters are deployed with a Scaleway [regional Private Network](https://www.scaleway.com/docs/network/vpc/concepts/#regional-private-networks). **We recommend migrating existing clusters to a regional Private Network as well, using the Scaleway console.**
...
Yes they are. You will have to create a new endpoint on your Database Instance, specifying an automated configuration of your Private Network with Scaleway IPAM service.
