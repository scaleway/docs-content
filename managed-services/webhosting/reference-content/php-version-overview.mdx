...
Below you find an overview of the available PHP versions for the existing infrastructures: [Dedibox Classic](/classic-hosting/), [Dedibox cPanel](/cpanel-hosting/), and [Scaleway Web Hosting](/webhosting/) (cPanel and Plesk).
