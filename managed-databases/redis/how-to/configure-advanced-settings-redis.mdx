...
meta:
  ...
  description: This page explains how to configure advanced Databases for Redis™ settings 
content:
  h1: How to configure advanced settings 
  paragraph: This page explains how to configure advanced Databases for Redis™ settings 
dates:
...
- You have a [Redis™ Database Instance](/databases/databases-for-redis/quickstart)
