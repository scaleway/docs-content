...
<Message type="note">
     You are viewing a summary of setting up a multi-AZ Kubernetes cluster. For a detailed insight into the concept and step-by-step guidance, we recommend following our **[complete tutorial](/tutorials/k8s-kapsule-multi-az/)**.
</Message>
...
<Message type="note">
     You now have a brief overview of how to set up a multi-AZ Kubernetes Kapsule cluster on Scaleway. For further information, refer to our complete step-by-step tutorial [Deploying a multi-AZ Kubernetes cluster with Terraform and Kapsule](/tutorials/k8s-kapsule-multi-az/).
</Message>
