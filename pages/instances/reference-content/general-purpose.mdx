...
Scaleway's **General Purpose** range includes POP2 Instances, whih are high-end, dedicated cloud Instances for demanding workloads. They offer the highest consistent performance per core to support real-time applications. In addition, their computing power makes them generally more robust for compute-intensive workloads.
