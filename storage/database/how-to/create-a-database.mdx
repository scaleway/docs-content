---
title: How to create a Managed Database 
description: This page explains how to create a Managed Database 
excerpt: |
  This page explains how to create a Managed Database 
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/storage/database/how-to/create-a-database
...
3. Complete the following steps in the wizard:
    ...
    - Select a database engine. **PostgreSQL** and **MySQL8** are available.  
