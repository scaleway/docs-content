...
tags: compute apps elasticsearch kibana logstash
excerpt: |
  This page shows you how to use the ELK stack InstantApp on your Scaleway instance.
  ELK stack is an environment that lets you collect and visualize your logs with Elasticsearch, Logstash and Kibana.
totalTime: PT20M
steps:
