...
The snapshot feature lets you create an image of a specific [volume](/compute/instances/concepts/#volumes) of your Instance. A snapshot is a full-volume copy stored in our secure data centers. They are usually used to recover volume data or to create a copy of a volume.
