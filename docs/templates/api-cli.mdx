...
- Created an [API key](https://www.scaleway.com/en/docs/iam/credentials/create-api-keys/) and that the API key has sufficient [IAM permissions](https://www.scaleway.com/en/docs/iam/policies-permissions/permission-sets/) to perform the actions described on this page
