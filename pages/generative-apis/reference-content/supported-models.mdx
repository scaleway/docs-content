...
Deprecated models should not be queried anymore. We recommend to use newer models available in Generative APIs or to deploy these models in dedicated [Managed Inference](https://account.scaleway.com/?service=elementsinference/deployments) deployments.
...
These models are not accessible anymore from Generative APIs. They can still however be deployed on dedicated [Managed Inference](https://account.scaleway.com/?service=elementsinference/deployments) deployments.
