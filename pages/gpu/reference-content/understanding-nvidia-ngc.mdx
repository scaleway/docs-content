...
1. Deploy your Scaleway GPU Instance from the [Scaleway console](https://account.scaleway.com/?service=elementsinstance/servers/create?imageKey=7bdc1afb-231f-486a-9b85-1b0478bc0e4a&offerName=RENDER-S&zone=fr-par-2), the [CLI tools](https://github.com/scaleway/scaleway-cli), or the [Scaleway API](https://www.scaleway.com/en/developers/api/instance/).<sup>1</sup>
