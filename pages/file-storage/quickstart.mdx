...
- Ccreated a [compatible Instance](/file-storage/reference-content/file-system-instance-selection/)
...
<Message type="note">
To mount a file system to an Instance, you must have [attached your file system to an Instance](#how-to-attach-a-file-system-to-one-or-more-instances) beforehand. File systems can only be attached to POP2 Instances.
</Message>
