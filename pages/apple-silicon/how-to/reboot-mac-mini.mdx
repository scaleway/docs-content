...
For other operating systems (such as Asahi Linux), automatic restart is not enabled. Therefore, do not power off the machine, as it will not be able to restart remotely.
