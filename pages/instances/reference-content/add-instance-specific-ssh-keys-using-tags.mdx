...
3. Click the Instance you want to add a specific key to.
4. Navigate to the section where you can add tags to the Instance on the Instances overview page.
5. Add the public SSH key tag by writing in the **Tags** form. You can add multiple keys by creating separate `AUTHORIZED_KEY` tags for each SSH key.
