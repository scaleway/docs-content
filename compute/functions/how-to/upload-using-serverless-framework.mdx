...
excerpt: |
  This page explains how to upload your function using Serverless.com framework.
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
...
permalink: docs/compute/functions/how-to/upload-using-serverless-framework
keywords: Serverless, functions, serverless.com, package, golang, python, javascript
---
...
- `package.exclude`: usually, you do not need to configure it. It enables to exclude directories from the deployment
...
For more detail on how to package your dependencies please refer to [How to package your function and upload it as a Zip](/compute/functions/how-to/package-your-function-in-a-zip/).
