...
excerpt: |
  This tutorial will explain how to configure a Nagios monitoring with an Apache web server to monitor your servers.
  It is an open source monitoring system which can automatically alert you in case of a server disfunction.
totalTime: PT30M
steps:
  - step: Installing Nagios
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-nagios-monitoring/#-Installing-Nagios
  - step: Installing Apache
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-nagios-monitoring/#-Installing-Apache
  - step: Configuring Nagios
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-nagios-monitoring/#-Configuring-Nagios
  - step: Configuring Apaches
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-nagios-monitoring/#-Configuring-Apache
  - step: Configuring the systemd Script
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-nagios-monitoring/#-Configuring-the-systemd-Script
  - step: Monitoring a Server with the NPRE Service
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-nagios-monitoring/#-Monitoring-a-Server-with-the-NPRE-Service
categories:
  - compute
  - instances
image: /assets/images/docs/scaleway.png
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, debian server, linux server, Object Storage, S3, IAAS, baremetal, scalability, ARM, physical server, dedicated server, physicalization, account, sentry, error, error-tracking, tracking
dates:
...
- You have created [at least two Instances](/compute/instances/how-to/create-an-instance/) or [at least two Bare Metal servers](/compute/bare-metal-cloud/how-to/create-server/)

</Message>

This tutorial will explain how to configure a [Nagios](https://www.nagios.org/) monitoring with an Apache web server to monitor your servers.
It is an open source monitoring system which can automatically alert you in case of a server disfunction.
...
We will use **Apache** as Webserver for the Nagios interface.
...
13. Save the file and restart the application:
  ...
  <Lightbox src="scaleway-nagios.png" alt="" />

Nagios is widely used because of its flexibility and versatility. Don't hesitate to refer to the [Documentation](https://assets.nagios.com/downloads/nagioscore/docs/nagioscore/4/en/index.html) of the software to find more out about further configuration options.
