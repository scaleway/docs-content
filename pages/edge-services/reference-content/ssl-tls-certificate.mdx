...
SSL/TLS certificates all expire at some point. If your certificate expires before you upload a new one, you will see an error like this on your Edge Services dashboard:
    ...
    <Lightbox src={image} alt="Your SSL/TLS certificate has expired. Update your certificate in Secret Manager. Your initial certificate will remain in use until the error is fixed." />
