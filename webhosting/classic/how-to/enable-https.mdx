...
The certificate is issued by [Let's Encrpyt](https://letsencrypt.org) an initiative that allows to generate SSL certificates, known by all browsers for free.
...
<Lightbox src="scaleway_insecure_connection.png" alt="" />
...
<Lightbox src="scaleway_connection_failed.png" alt="" />
