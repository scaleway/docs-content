...
In this tutorial, we will build a basic architecture to store and automatically convert images to PDF. The focus is on transferring large messages using a messaging service, specifically the NATS server from Scaleway. Our setup involves using the Object Storage service for image storage and the Serverless Function service for conversion.
...
This tutorial's architecture is very basic, consisting of two main components:
