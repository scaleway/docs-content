...
If you were billed for resources that have been correctly stopped, please [contact our Support team](https://account.scaleway.com/?service=elementssupport/tickets/create), providing the name of the product and resource, and the date of deactivation.
...
If you only have one payment method and need to use it on more than one account, [contact our Support team](https://account.scaleway.com/?service=elementssupport/tickets/create) to request an individual verification.

### I added a physical credit card, but it was declined. Why?
If your credit card complies with the payment requirements but was still declined, please [contact our Support team](https://account.scaleway.com/?service=elementssupport/tickets/create) for assistance.
...
If your case does not match the situations above and you still cannot remove your credit card, [contact our Support team](https://account.scaleway.com/?service=elementssupport/tickets/create) for a manual verification.
...
You can manage your billing from the [billing section](https://account.scaleway.com/?service=elementsbilling/overview) of the Scaleway console. Your recent invoices, as well as the consumption report for the current month, are available for download.
...
It is not possible to edit your country and region directly from the Scaleway console. Please [contact our Support team](https://account.scaleway.com/?service=elementssupport/tickets/create) if you need to change this information.
...
It is impossible to edit your VAT number once a value has been set. [Contact our Support team](https://account.scaleway.com/?service=elementssupport/tickets/create) if you need to update it.
