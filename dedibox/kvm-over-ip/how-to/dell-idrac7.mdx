...
meta:
  ...
  description: This page explains how to use the KVM DELL iDRAC 7 on a Scaleway Dedibox
content:
  h1: How to use the KVM Dell iDRAC 7
  paragraph: This page explains how to use the KVM DELL iDRAC 7 on a Scaleway Dedibox
