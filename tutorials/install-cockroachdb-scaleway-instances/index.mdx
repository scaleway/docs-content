...
### Requirements
    ...
    - You must have [created an SSH key](/console/organizations-and-projects/how-to/create-ssh-key/) to access the machine via SSH. This is necessary for distributing and starting CockroachDB binaries.
