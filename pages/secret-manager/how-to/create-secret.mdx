...
This page explains how to create a [secret](/secret-manager/concepts/#secret) for the first time using the [Scaleway console](https://account.scaleway.com/?service=elements) and how to create a secret if you have already created resources in Secret Manager.
...
<Tabs id="install">
  <TabsTab label="Create your first secret">
      1. Click **Secret Manager** in the **Security & Identity** section of the [Scaleway console](https://account.scaleway.com/?service=elements) side menu.
