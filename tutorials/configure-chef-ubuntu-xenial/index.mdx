...
4. Copy the download URL, and from your terminal launch the installation using `wget` + the URL:
  ...
  ```
  wget https://packages.chef.io/files/stable/chef-server/14.10.23/ubuntu/16.04/chef-server-core_14.10.23-1_amd64.deb?_ga=2.239017542.793288551.1637763130-1348836278.1637763130
  ```
