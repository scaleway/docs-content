...
5. Deploy the application. This step can be done in two ways:
  ...
  * **Deployment from Application Library**
    ...
    * Get the Load Balancer external IP and use it in your web browser to access your application (Wordpress in this case)
