...
Refer to the [dedicated documentation](/functions/how-to/create-a-function/) for more information.

Deploying larger projects with dependencies and many files requires zipping your code before uploading it. Refer to the documentation on [packaging functions in a zip file](/functions/how-to/package-function-dependencies-in-zip/) for more information.
...
Refer to the [API procedure](/functions/api-cli/deploy-function-api/) for more information.
