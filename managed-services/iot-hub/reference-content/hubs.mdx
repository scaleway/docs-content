...
When you create a Hub, it comes with a Scaleway-generated [Certificate Authority](/managed-services/iot-hub/concepts/#hub-certificate-authority). The Hub Certificate Authority is used to authenticate connecting devices through mutual TLS authentication.
