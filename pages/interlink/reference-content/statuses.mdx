...
| **Ready**           | The self-hosted InterLink has been created and is ready to connect.. <br/><br/> The tunnel(s) cannot be established because the customer gateway device is not yet successfully configured.  |
