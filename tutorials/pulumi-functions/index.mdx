...
hero: assets/scaleway_pulumi.webp
dates:
validation: 2023-02-23
posted: 2023-02-23
---

In this tutorial, we will deploy two simple functions using Pulumi. To complete the tutorial, we will deploy a SQS/SNS message queue.
