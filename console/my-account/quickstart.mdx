...
4. Check the box and solve the [reCaptcha](https://en.wikipedia.org/wiki/ReCAPTCHA). You can also subscribe to Scaleway's marketing communications. Then, click **Create an account** to create your account. A message displays to request that you check your email inbox for the verification email.
