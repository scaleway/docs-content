...
Check out the [Scaleway Provider for Terraform](https://registry.terraform.io/providers/scaleway/scaleway/latest/docs) documentation for more information.
...
1. Create a new file called `test.tf` in a new folder. 
