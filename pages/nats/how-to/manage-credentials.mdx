...
content:
  h1: How to manage credentials for Scaleway NATS
  paragraph: Master managing credentials for Scaleway NATS. Follow this guide to securely update, rotate, and control access to your messaging services.
dates:
