...
<Message type="important">
  Be aware that **Custom Domains** does not currently support websockets. If you need to use websockets you must configure them with the original function URL.
</Message>
