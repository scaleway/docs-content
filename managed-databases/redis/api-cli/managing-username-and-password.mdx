...
<Message type="tip">
You can also define a username when you [create a Redis™ Database Instance](/managed-databases/redis/how-to/create-a-database-for-redis) via the Scaleway console.
</Message>
