...
The tool helps to improve your site performance, with the analytics script weighing less then 1 KB - that is 45 times smaller than the site tag of a commercial analytics solution. Plausible Analytics is designed to be self-hosted through Docker.
