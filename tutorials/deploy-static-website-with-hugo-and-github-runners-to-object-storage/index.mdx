...
It uses Markdown files with front matter for metadata, making it lightweight and easy to use. 

In this tutorial you learn how to install Hugo on your local computer so you can build your website locally, before pushing your content into a GitHub repository where a GitHub runner will take the content, generate the HTML version of it and upload to a Object Storage bucket automatically.
