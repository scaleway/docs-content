...
For **Serverless** models, model and inference characteristics (such as [quantization](https://huggingface.co/docs/optimum/en/concept_guides/quantization), [chat templates](https://huggingface.co/docs/transformers/en/chat_templating), [guided decoding backend](https://huggingface.co/blog/nmmursit/guided-decoding)...) are not all provided. However, updates to these characteristics are consistent with our [Model Lifecycle Policy](/generative-apis/reference-content/model-lifecycle/):
