...
1. Access the [Scaleway homepage](https://www.scaleway.com/en/) and on the bottom, click **Chat Room** or access it directly via [this link](https://scaleway-community.slack.com/ ).
...
3. Fill out the fields **Full Name** and **Password** with the requested information.
    ...
    **Sure** or **No, thanks** to choose. Then, click **Create Account** to resume
    your registration.
...
1. By default, you are added to the **#community** and **#community-fr** channels. Click the word **Channels** to browse our catalog and find others you would like to join.
2. You can sort them by _Channel name_, _Creation date (newest first)_, _Members (most to fewest)_ or _Members (fewest to most)_ and select which ones you want displayed: _All channels_, _Private channels_ or _Archived channels_. Select a Channel and click to visualize it.
...
1. Click "Scaleway Community" in the upper left corner of the screen. A drop-down menu displays with different options.
