---
meta:
  title: Configuring a failover IP on CentOS 
  description: This page explains how to configure a failover IP on CentOS.
content:
  h1: Configuring a failover IP on CentOS 
...
This page shows you how to configure a [failover IP](/bare-metal/dedibox/concepts/#failover-ips) on Dedibox servers running on CentOS.
...
<Navigation title="See Also">
  <NextButton to="/bare-metal/network/reference-content/configure-debian-ubuntu">Configuring a failover IP on Debian/Ubuntu</NextButton>
</Navigation>
