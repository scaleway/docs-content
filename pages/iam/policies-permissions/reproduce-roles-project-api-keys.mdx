...
[Identity and Access Management](/iam/concepts/glossary/) provides a set of concepts and features to help you easily manage access to your Scaleway Organization.
...
When your Organization was migrated to IAM, three [groups](/iam/concepts/glossary/#group) were created, with three [policies](/iam/concepts/glossary/#policy) attached to them.
...
1. [Create a group](/iam/principals/create-group/) from the Groups tab, preferably with a name related to the corresponding role (e.g. “Administrators”, “Editors” or “Billing Administrators”).

2. [Create a policy](/iam/policies-permissions/create-policy/) from the Policies tab, attached to the group you have just created and with the appropriate permission sets:
...
When your Organization was migrated to IAM, for each Project existing at the time of the migration, an [application](/iam/concepts/glossary/#application) and a [policy](/iam/concepts/glossary/#policy) were automatically created. These were both given the same name: `Project - [name of the project] (id of the project)`.
...
1. [Create an application](/iam/principals/create-application/), preferably with a name related to the Project.
2. [Create a policy](/iam/policies-permissions/create-policy/) from the policy tab, attached to the application you just created and with the permission set `AllProductsFullAccess` for the Project in question.
