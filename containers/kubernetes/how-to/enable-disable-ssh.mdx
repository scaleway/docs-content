...
<Navigation title="See Also">
  ...
  <NextButton to="/containers/kubernetes/how-to/upgrade-kubernetes-version-using-cli/">How to upgrade your Kubernetes Kapsule cluster using the CLI</NextButton>
</Navigation>