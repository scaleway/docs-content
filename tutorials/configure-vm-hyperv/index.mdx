...
excerpt: |
  Microsoft Hyper-V is a hypervizor which allows you to create virtual machines on x86-64 systems. It is available since the release of Windows Server 2012.
