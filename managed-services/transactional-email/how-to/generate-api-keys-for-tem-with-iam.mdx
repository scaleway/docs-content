...
This page shows you how to generate [API keys](/console/my-account/concepts/#api-key) with IAM to send [transactional emails](/managed-services/transactional-email/concepts/#transactional-email) via API and SMTP.
