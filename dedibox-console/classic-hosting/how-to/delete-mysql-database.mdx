...
<Navigation title="See Also">
  <PreviousButton to="/dedibox-console/classic-hosting/how-to/change-password-mysql-database/">How to change the password of a MySQL database</PreviousButton>
  <NextButton to="/dedibox-console/classic-hosting/how-to/manage-mysql-database-phpmyadmin/">How to manage MySQL databases with PHPmyAdmin</NextButton>
</Navigation> 
