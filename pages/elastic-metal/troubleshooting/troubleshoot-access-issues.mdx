---
meta:
  title: Troubleshouting common Elastic Metal server access issues
  description: Common access issues encountered with Scaleway Elastic Metal servers and their solutions.
content:
  h1: Troubleshouting common Elastic Metal server access issues
...
If you still cannot access your server, contact the [technical support](https://console.scaleway.com/support) with:
