...
- Added [SPF, DKIM](/managed-services/transactional-email/how-to/add-spf-dkim-records-to-your-domain), [MX](/managed-services/transactional-email/how-to/add-mx-record-to-your-domain) and [DMARC](/content/managed-services/transactional-email/how-to/add-dmarc-record) records to your domain(s)
