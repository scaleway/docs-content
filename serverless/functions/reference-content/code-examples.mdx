...
```
<Message type="note">
  If you want to use other libraries like `request`, you need to upload your project [with advanced methods](/serverless/functions/reference-content/deploy-function/) (recommanded)
