...
<Tabs id="create-pn">
  ...
  <TabsTab label="Terraform">
    ...
    3. Add the following block to create a Private Network:
        ...
        The Private Network will be created in the [default VPC](TODO) for the specified region. Alternatively, you can add the `vpc_id` argument to specify an alternative VPC to create it in.
