...
- A [Database Instance](/postgresql-and-mysql/how-to/create-a-database/) running a PostgreSQL engine
...
8. [Connect to your Database Instance](/postgresql-and-mysql/how-to/connect-database-instance/).
...
<Tabs id="pgauditlog">
 ...
 <TabsTab label="For a specific database">
   ...
   1. [Connect to your database](/postgresql-and-mysql/how-to/connect-database-instance/) as an admin user.
...
2. [Connect to your database](/postgresql-and-mysql/how-to/connect-database-instance/) as an admin user and run the following command:
    ```
