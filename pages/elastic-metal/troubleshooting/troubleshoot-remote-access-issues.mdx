...
- Log in to the [Scaleway console](https://account.scaleway.com/?service=elements) and navigate to your Elastic Metal server.
...
- Create a [Private Network](/vpc/faq/#private-networks) to avoid exposing the server admin interface on the public internet.
...
If remote access is still unavailable, contact [technical support](https://account.scaleway.com/?service=elementssupport) with:
