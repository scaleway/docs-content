---
meta:
  title: Configuring a RPNv1 on a Dedibox
  description: This page explains how to configure the RPNv1 on a Dedibox
content:
  h1: Configuring a RPNv1 on a Dedibox
...
## Creating a new RPNv1 group from the Scaleway console
...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/network/reference-content/configure-jumboframes/">Configuring jumbo frames</PreviousButton>
  <NextButton to="/bare-metal/network/reference-content/configure-rpnv2/">Configuring a RPNv2</NextButton>
</Navigation>
