...
For more information see [how to add users](/managed-database/postgresql-and-mysql/how-to/add-users).
...
<Navigation title="See Also">
  <PreviousButton to="/managed-database/postgresql-and-mysql/how-to/add-users/">How to add users</PreviousButton>
  <NextButton to="/managed-database/postgresql-and-mysql/how-to/manage-allowed-ip-addresses/">How to manage allowed IPs</NextButton>
</Navigation>
