...
An endpoint is the URL generated to access your resource. It can be customized with [custom domains](#custom-domain). The public endpoint can be disabled to isolate the container from the public internet.
