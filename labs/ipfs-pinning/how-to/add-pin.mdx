...
<Message type="requirement">
  ...
  - You have downloaded and installed [IPFS Desktop App](/labs/ipfs-pinning/reference-content/install-ipfs-desktop)
...
<Navigation title="See Also">
  <PreviousButton to="/labs/ipfs-pinning/how-to/create-volume/">How to create a volume</PreviousButton>
  <NextButton to="/labs/ipfs-pinning/how-to/delete-volume/">How to delete a volume</NextButton>
</Navigation>