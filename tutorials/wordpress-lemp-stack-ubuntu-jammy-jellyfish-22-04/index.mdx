...
We presume that you have already completed the installation of the LEMP stack as outlined [here](/tutorials/installation-lemp-ubuntu-bionic/). Let us proceed with the installation of WordPress on your Ubuntu Jammy instance.
