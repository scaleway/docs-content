...
You should adjust it based on your function's traffic spikes, keeping in mind that you may wish to limit the maximum scale to manage costs effectively while provisioning enough containers to handle spikes.
...
The performance of a vCPU is determined by the percentage of time spent on the physical processor's core. It is possible to allocate different resource allowances to specific vCPUs for specific containers or virtual machines.
