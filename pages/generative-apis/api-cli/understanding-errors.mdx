...
- 500 - **API error**: An unexpected internal error has occurred within Scaleway's systems. If the issue persists, please [open a support ticket](https://account.scaleway.com/?service=elementssupport/tickets/create).
