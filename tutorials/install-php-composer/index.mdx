...
content:
  ...
  paragraph: Learn how to install PHP Composer on Ubuntu 20.04 LTS (Focal Fossa) with this step-by-step guide. Set up PHP Composer quickly and efficiently on your Scaleway server for seamless dependency management.
