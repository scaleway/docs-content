...
This improves performance by reducing the latency between your nodes. It also increases the security of your databases, as Instances in your Private Network can directly to your Database Instance, without passing through the public Internet.
