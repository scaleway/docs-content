...
Implementing the [Container Storage Interface specification](https://github.com/container-storage-interface/spec/blob/master/spec.md), the CSI driver allows container orchestration engines like Kubernetes to manage Scaleway Block Storage volumes and File Storage file systems. It is installed by default on every Kubernetes Kapsule and Kosmos cluster.
