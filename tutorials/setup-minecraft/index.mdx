...
excerpt: |
  Discover how to configure your own Minecraft server on a Scaleway Elements Virtual Instance and customize the game towards your preferences using mods and add-ons.
totalTime: PT15M
steps:
...
permalink: docs/tutorials/setup-minecraft/
keywords: cloud tutorials, cloud documentations, cloud server, cloud hosting, ubuntu server, debian server, linux server, IAAS, baremetal, minecraft, self-hosted, own hosted, private server, mine craft, minecraft mods, mods, modding
dates:
