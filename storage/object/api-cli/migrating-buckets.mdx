...
- Installed and initialized the [AWS CLI for Scaleway](/object/api-cli/object-storage-aws-cli/)
...
2. Copy the objects between the Object Storage buckets.
    <Message type="important">
      If you have objects in the Scaleway `Glacier` storage class you must [restore](/object/how-to/restore-an-object-from-glacier/) them before continuing.
    </Message>
