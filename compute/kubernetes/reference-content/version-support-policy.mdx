...
With Scaleway Kubernetes you can use the latest version of Kubernetes as soon as the it is officially released and certified by the [Cloud Native Computing Foundation](https://www.cncf.io/). The versions are usually available in Kubernetes Kapsule and Kubernetes Kosmos within a few days after the release.
