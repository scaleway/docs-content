...
|:-----------------:|:-----------------:|
| `2023-06-07-alpha`| Current           |
| `2023-04-17`      | Extended support  |
...
- If you use the `2023-06-07-alpha` version, every action that is not explicitly **denied** by the bucket policy is **allowed**, if it is allowed in the IAM policy.
