...
* [**Database as-a-Service**](https://www.scaleway.com/en/databases/), for your data storage
...
<<<<<<< HEAD
  - You have [created a Scaleway Database](/databases/databases-for-postgresql-and-mysql/how-to/create-a-database/)
=======
  - You have [created a Scaleway Managed Database](/databases/databases-for-postgresql-and-mysql/how-to/create-a-database/)
>>>>>>> fix(redis): links
