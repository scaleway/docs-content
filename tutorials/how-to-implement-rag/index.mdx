...
Create a .env file and add the following variables. These will store your API keys, database connection details, and other configuration values.
   ...
   SCW_INFERENCE_EMBEDDINGS_ENDPOINT="https://{{SCW_INFERENCE_EMBEDDINGS_DEPLOYMENT_ID}}.ifr.fr-par.scw.cloud/v1"  # Endpoint for sentence-transformers/sentence-t5-xxl deployment
