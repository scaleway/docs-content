...
<Grid>
    ...
    <DefaultCard
      ...
      description="Compare pricing and specs for your needs."
...
<Grid>
    <DefaultCard
      ...
      description="Key differences between x86 and ARM CPUs."
    ...
    <DefaultCard
      ...
      description="Bandwidth details for Instances and storage."
