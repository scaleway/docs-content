...
meta:
  ...
  description: This page shows you how to deploy an Elastic Metal server running on your favorite operating system with one API command
content:
  h1: Deploying an Elastic Metal server with one API call
  paragraph: This page shows you how to deploy an Elastic Metal server running on your favorite operating system with one API command
...
For more information about Elastic Metal servers, refer to our [dedicated product documentation](/bare-metal/elastic-metal/) and the [FAQ](https://www.scaleway.com/en/faq/elastic-metal-servers/).


<Navigation title="See also">
  <PreviousButton to="/bare-metal/elastic-metal/api-cli/elastic-metal-with-cli/">Creating and managing Elastic Metal servers with the CLI</PreviousButton>
</Navigation>
