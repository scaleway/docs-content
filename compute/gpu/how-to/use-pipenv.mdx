...
content:
  h1: How to use the pipenv python virtual environment
  paragraph: This page explains how to use the pipenv python virtual environment with your GPU Instane
dates:
...
<Message type="important">
  ...
  Originally, Scaleway GPU Instances were pre-installed with [Anaconda](https://www.anaconda.com) for managing python dependencies and virtual environments with Python. From now, Pipenv will replace Anaconda on our AI Docker images.
