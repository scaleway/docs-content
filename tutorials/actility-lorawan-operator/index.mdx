...
excerpt: |
  LoRaWAN is a low-power long-range radio protocol to use when 3G/4G/5G is not required. Actility is a LoRaWAN operator and is able to connect to IoT Hub to bring your LoRaWAN devices' data to the cloud.
totalTime: PT30M
...
## LoRaWAN&copy; and Actility Overview
...
[Actility](https://www.actility.com) is a LoRaWAN&copy; operator which can build a public or private LoRaWAN&copy; network.

In this tutorial we are going to:

- Create a IoT Hub which to receive/send messages from/to LoRaWAN&copy; devices
...
- Add another Device and connect it as a subscribe to receive LoRaWAN&copy; messages

---

## Create an IoT Hub

First, we need a Hub. Its role will be to distribute messages from your LoRaWAN&copy; devices to the intended targets. Please follow [this procedure](/iot/iot-hub/how-to/create-hub) to create an IoT Hub if you don't have one already. The hub's name and plan does not matter for this tutorial.
...
You can check the application is up and running by going to the application page and verifying the `Deployment Status` box is set to `Opened`. When it is, your LoRaWAN&copy; network is now connected to your IoT Hub.
