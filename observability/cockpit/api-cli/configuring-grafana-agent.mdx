...
7. Copy the following template and paste it into your file:
    ...
    ```
    <Message type="important">
     If you are using OSX, remove all occurrences of `,rslave` in your configuration file.
    </Message>
8. Run docker on your computer.
9. Run the following command to open your folder containing your configuration files:
...
7. Optionally, click the **Live** button on the top right corner of your screen to see your logs arriving in real time.
