...
### Does Scaleway Load Balancer impose a limit on the size of an HTTP request body? 

No, there are no restrictions or limits on the size of an HTTP request body. Simply ensure that your backend services and any upstream applications or proxies are configured to accept large request bodies, as they may have their own limits.
...
You can add a Web Application Firewall to your Load Balancer via [Edge Services](/edge-services/reference-content/understanding-waf/).
