...
dates:
  validation: 2021-10-18
  posted: 2021-10-18
---

This article includes several code snippets in [Python](#python), [Node](#node), and [Golang](#go):

* How to say *Hello world*
* How to use environment variables 
* How to use event components
* How to use fata from CRON jobs
* Hot to connect to HTTP services

<Message type="requirement">

- You have an account and are logged into the [Scaleway Console](https://console.scaleway.com)
- You have a [Serverless Functions namespace](/compute/functions/how-to/create-a-functions-namespace/)
- You have a text editor/IDE (for exmple [Visual Studio Code](https://code.visualstudio.com/) or [Atom](https://atom.io/))
...
* Using environment variables
  ...
  Python runtime include the “os” library which enable you to access the environment variables you define in your namespace or function
...
Please refer to our guide on [code packaging](https://www.scaleway.com/en/docs/compute/functions/how-to/package-function-in-zip/) if you want to use requests.
  ...
  * `POST` request example
  ...
  If you want to use other library like *request*, you need to upload your project [using a zip-file](https://www.scaleway.com/en/docs/compute/functions/how-to/package-function-in-zip/). 
...
* `Resource`: string - Resource path define in API Gateway
