...
**Ensure you have deleted all the Private Networks inside the VPC**. You can see how many Private Networks are in your [VPC listing](https://account.scaleway.com/?service=elementsvpc/vpc) in the Scaleway console.
