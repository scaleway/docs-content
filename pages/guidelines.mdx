...
| ------------------------------------------------------------------- | ---------------------------------------------------------- |
| ````Open the [Scaleway console](https://account.scaleway.com/?service=elements)````  | Open the [Scaleway console](https://account.scaleway.com/?service=elements) |
