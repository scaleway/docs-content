...
<Message type="tip">
  Traefik listens by default on port 80 and 443 of the public IP of the node on which it is deployed. You can retrieve the external IP of your clusters' nodes by runing the `kubectl get node -o wide` command.
</Message>
