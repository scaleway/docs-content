---
title: Migrating from Scaleway IoT Hub API v1
...
To ensure that consumers of the `v1beta1` API version have enough time to migrate, this version will remain online until **31 August 2021 23:59 UTC**.
...
<Navigation title="See Also">
  <PreviousButton to="/iot/iot-hub/api-cli/cli-db-tips-tricks/">Discovering IoT Hub CLI tips and tricks</PreviousButton>
</Navigation>
