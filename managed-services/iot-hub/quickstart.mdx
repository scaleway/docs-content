...
5. Click **Create a Hub** or **Create a Hub and Add a Device**.
    <Message type="note">
      If you want to directly add a first device to the hub, click **Create a Hub and Add a Device** and continue with the documentation [IoT Hub - Devices](/managed-services/iot-hub/how-to/add-device/)
    </Message>
