---
meta:
  title: Fix unreachable Ubuntu Focal Instance when it as two public IPv4 IPs
  description: This page helps you to recover or avoid unreachable Ubuntu 20.04 Focal Instance when it has two public IPv4 IP addresses.
content:
  h1: Fix unreachable Ubuntu Focal Instance when it as two public IPv4 IPs.
  paragraph: This page helps you to recover or avoid unreachable Ubuntu 20.04 Focal Instance when it has two public IPv4 IP addresses.
...
A modified `cloud-init` package named cloud-init_24.2-0ubuntu1~20.04.1+scaleway has been added to Scaleways stable PPA to work around this situation.
...
cloud-init init
```
From this point on, your instance may be safely rebooted and you will no longer loose connectivity.
