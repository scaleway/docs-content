...
Encrypted HTTPS traffic can be handled in two ways with Scaleway Load Balancers. You can either configure a managed SSL Offloading using **Let’s Encrypt Certificates** or a managed SSL offloading using **third party SSL Certificates**.
