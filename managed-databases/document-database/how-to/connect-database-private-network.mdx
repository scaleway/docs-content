---
meta:
  title: How to connect a Document Database Instance to a Private Network
  description: This page explains how to connect a Document Database Instance to a Private Network
content:
  h1: How to connect a Document Database Instance to a Private Network
  paragraph: This page explains how to connect a Document Database Instance to a Private Network
tags: managed-database postgresql ferretdb mongodb private-network database-instance
dates:
...
<Navigation title="See Also">
  <PreviousButton to="/managed-databases/document-database/how-to/upgrade-a-database-instance">How to upgrade a Database Instance</PreviousButton>
  <NextButton to="/managed-databases/document-database/how-to/create-read-replica">How to create Read Replicas</NextButton>
</Navigation>