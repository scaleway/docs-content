...
<Message type="tip">
  Our real-world examples use local testing. Check our repository here: [scaleway/serverless-examples repository](https://github.com/scaleway/serverless-examples).
</Message>
...
You will need to be able to install packages with the dependency manager of the runtime you use, such as `pip`, `go get`, etc.
