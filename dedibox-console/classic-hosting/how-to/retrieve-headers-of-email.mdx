...
### How to retrieve email eeaders in Gmail

1. Log in to your Gmail account.
2. Open the email whose headers you need.
...
3. The email headers can be found in the "Internet headers" section. Copy the headers from this section.
...
3. Click the **downward arrow** in the email's top right. A menu will appear.
