...
4. Enter the Authcode provided by your current registrar (if it is required: this depends on the domain extension).
    <Message type="note">
      By default, Scaleway DNS servers are not activated after the transfer. However, you can choose to activate these by ticking the box if you wish.
    </Message>
...
8. If you did not select hosting backup, a confirmation dialog box may appear. Click **Continue without backup** or **Add backup**. The **Contact information** page appears.
