...
meta:
  ...
  description: Learn how to resolve GPU issues caused by installing Nvidia driver packages on Scaleway GPU Instances. Follow our troubleshooting guide for optimal performance.
content:
  h1: Fixing GPU issues after installing nvidia-driver packages
  paragraph: Learn how to resolve GPU issues caused by installing Nvidia driver packages on Scaleway GPU Instances. Follow our troubleshooting guide for optimal performance.
