...
Using Cockpit with your Scaleway data for data ingestion is billed as follows:

- Custom metrics are billed €0.15 per million samples of metrics ingested, per month.
- Custom logs and traces are billed €0.35 per GB ingested, per month.

During beta, the [retention](/observability/cockpit/concepts/#retention) period for your data (data from [Scaleway resources integrated with Cockpit](/observability/cockpit/reference-content/cockpit-limitations/#product-integration-into-cockpit)) is free of charge.
...
During beta, the [retention](/observability/cockpit/concepts/#retention) period for your custom data is free of charge.
