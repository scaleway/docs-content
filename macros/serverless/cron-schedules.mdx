...
- Serverless Functions and Serverless Containers [CRON triggers](/functions/concepts#cron-trigger) use the **UTC** time zone. This parameter cannot be modified.

- Serverless Jobs allow modifying the time zone of their schedules via the Job **Settings** tab. Refer to [the job scheduling documentation](/jobs/how-to/manage-job-schedule/) for more information.