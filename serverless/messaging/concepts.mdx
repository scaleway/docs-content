...
SQS/SNS is one of the [namespace](#namespace) types available at Scaleway. You can use the [SNS](#sns) and/or [SQS](#sqs) protocols with this type of namespace.
