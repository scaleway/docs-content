...
Active series refer to [time series](#times-series) for which your Cockpit receives [samples](#samples) that are less than 10 minutes old. for which the last received samples are less than 10 minutes old.
