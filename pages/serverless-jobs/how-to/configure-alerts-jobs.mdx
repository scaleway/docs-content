...
- **High memory usage** - You are alerted if memory usage is higher than 80% for 10 consecutive minutes.
  ...
  See the [How to activate preconfigured alerts](/cockpit/how-to/activate-managed-alerts/#how-to-activate-preconfigured-alerts) page to learn how to activate them.
</Message>
