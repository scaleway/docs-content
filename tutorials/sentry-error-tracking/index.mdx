...
Sentry needs to run on an Instance with at least 4GB of RAM.
=======
In this tutorial, we will install sentry on an [Ubuntu Focal Fossa (20.04 LTS)](https://www.ubuntu.com) based Virtual Instance.

<Message type="note">

Sentry needs to run on a Virtual Instance with at least 4GB of RAM.
>>>>>>> 042a6c9... fix(tuto): updated tags and fixed typos
