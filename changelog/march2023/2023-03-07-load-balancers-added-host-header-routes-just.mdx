---
title: Host header routes just arrived!
status: added
author:
...
The console user interface manages everything for you and configures the route type automatically based on the frontend and backend you use. The API still lets you configure the route type but please be aware that from June 1st we won't support using SNI routes with HTTP backends, so please make sure you update your automation tools.
