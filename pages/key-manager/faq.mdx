...
Key Manager is compatible with Object Storage to store and manage bucket encryption keys.
...
- Symmetric and asymmetric key storage is billed €0.04 per key version monthly.
