...
For the full project + deployment using Serverless Framework refer to our [serverless-examples project](https://github.com/scaleway/serverless-examples/tree/main/functions/image-transform-node)
