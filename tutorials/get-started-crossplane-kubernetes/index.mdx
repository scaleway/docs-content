...
In this tutorial, you will learn how to install Upbound Universal Crossplane (UXP) into your Kubernetes cluster, configure the provider to authenticate with Scaleway, and create a Scaleway [Kubernetes](https://www.scaleway.com/containers/kubernetes/quickstart/) managed resource directly from your cluster.

<Macro id="iam-requirements" />

<Message type="requirement">
 - You have an account and are logged into the [Scaleway console](https://console.scaleway.com)
 - You have created a [Kubernetes cluster](/containers/kubernetes/how-to/create-cluster/) and downloaded its [Kubeconfig file](https://www.scaleway.com/containers/kubernetes/concepts#kubeconfig)
