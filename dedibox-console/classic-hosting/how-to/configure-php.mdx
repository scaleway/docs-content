...
Refer to the [documentation](/dedibox-console/classic-hosting/how-to/manage-mysql-database-phpmyadmin/) on how to configure the connection to a database using PHP.
