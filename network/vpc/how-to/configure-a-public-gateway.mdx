...
By default, the SMTP ports (25, 465 and 587) on your Public Gateway are blocked to avoid spam. If you wish to send emails from resources located behind your Public Gateway, you should open these ports by enabling SMTP as follows:
