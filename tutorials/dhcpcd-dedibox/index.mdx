...
<Message type="note">
  We assume you have already generated an [IPv6 prefix and its associated DUID](/ipv6/how-to/request-prefix/).
</Message>
...
Your server is now ready to communicate with IPv6. For more information about IPv6 at Scaleway Dedibox, refer to our [dedicated documentation](/ipv6/quickstart/).