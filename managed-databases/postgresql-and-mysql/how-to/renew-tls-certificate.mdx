...
4. Click **Renew TLS certificate** once you have read the warnings displayed and wish to continue.
    ...
    <Message type="important">
      Renewing a certificate means you:
        - Will not be able to connect to your Database Instance with the previous certificate when using the [verify-ca and verify-full](/postgresql-and-mysql/api-cli/verify-ca-postgresql/).
