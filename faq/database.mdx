...
meta:
  title: Database
  description: Discover Scaleway Database and how to access it for PostgreSQL and MySQL.
content:
  h1: Database
  paragraph: Discover Scaleway Database and how to access it for PostgreSQL and MySQL.
image: database.webp
---
...
## In what regions is the Private Networks feature available for Databases
