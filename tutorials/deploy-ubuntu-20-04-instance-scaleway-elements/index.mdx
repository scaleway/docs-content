...
- Basic knowledge of [Linux commands](/dedicated-servers/reference-content/basic-linux-commands/)
...
<Message type="tip">
  For more information about how to use the APT package manager, run the following command: `apt help`, or refer to our documentation on [how to manage packages](/dedicated-servers/how-to/manage-packages/).
</Message>
