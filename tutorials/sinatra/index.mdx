...
In the example above, The `get '/' do` part of the code is very important. It tells what to do when getting a slash if there is no specified path in the URL after the port.
