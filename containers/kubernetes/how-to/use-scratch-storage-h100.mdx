...
- [Created](/containers/kubernetes/how-to/create-cluster) a Kubernetes Kapsule or Kosmos cluster that uses [H100 GPU Instances](https://www.scaleway.com/en/h100-pcie-try-it-now/)
...
<Navigation title="See also">
  ...
  <NextButton to="/containers/kubernetes/how-to/deploy-x86-arm-images/">How to deploy both x86 and ARM images in Kubernetes</NextButton>
</Navigation>