...
The installation of pfSense is done using the [KVM-over-IP device](/compute/elastic-metal/how-to/install-server-from-kvm/) of the Elastic Metal server or the Scaleway Dedibox.

</Message>

1. Connect to the [KVM-over-IP device](/compute/elastic-metal/how-to/install-server-from-kvm/) of your Elastic Metal server or Scaleway Dedibox.
