...
When VPC and regional Private Networks moved from Public Beta to General Availability of this product, all mono-AZ Private Networks were automatically migrated to be regional. This is a seamless process with no downtime, that should not require any extra configuration on the client side. [Read the documentation](/network/vpc/reference-content/vpc-migration/) to find out more about the migration process.