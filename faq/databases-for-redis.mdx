...
Using Managed Database for Redis™ as a cache optimizes the speed of your requests as copies of the most frequently used data are stored in memory, making them accessible in milliseconds. [Learn more about Managed Database for Redis™](/redis/how-to/create-a-database-for-redis/).
...
Refer to the [Managing the default user's username and password](/redis/api-cli/managing-username-and-password/) documentation page to learn how.

For more information, refer to the [Understanding default user permissions](/redis/reference-content/default-user-permissions/) documentation page.
