...
5. Add your [SSH key](/organizations-and-projects/concepts/glossary/#ssh-key).
    <Message type="note">
      If you have already [uploaded an SSH key](/iam/security/create-ssh-key/#how-to-upload-the-public-ssh-key-to-the-scaleway-interface), it will appear in the list of keys.
    </Message>
