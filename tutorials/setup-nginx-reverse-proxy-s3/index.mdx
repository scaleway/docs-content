...
To further enhance performance and reduce load on the bucket, frequently accessed objects can be cached locally within Nginx.
...
- An [Object Storage bucket](/storage/object/how-to/create-a-bucket/) with [public, readable](/faq/objectstorage/#how-can-i-make-an-object-public) objects
