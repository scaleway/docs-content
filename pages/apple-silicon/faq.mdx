...
The minimum lease period for Apple Silicon-as-a-Service is 24 hours due to licensing restrictions. A Mac mini can only be deleted after this 24-hour minimum allocation period.
You can opt for automatic deletion after 24 hours by enabling this setting in the console. Note that the exstimated cost displayed in the console is indicative only and does not reflect the final cost nor engage you in consuming the selected rental period.
