Below is a revised version of the MDX file that aligns the terminology with the actual Scaleway API/Console, fixes the dates, clarifies billing, and separates the *protected* attribute from the lifecycle states.
...
Feel free to copy this snippet into your documentation repository. Let me know if you need any further tweaks (e.g., adding a diagram, linking to the API reference, or adjusting the wording for a specific audience).