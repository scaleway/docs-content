...
<Message type="requirement">
  ...
  - You have a [Block Storage volume](/compute/instances/api-cli/creating-a-volume)
</Message>
...
<Navigation title="See also">
  <PreviousButton to="/compute/instances/api-cli/attaching-a-volume">Attaching a Block Storage volume via the Instance API</PreviousButton>
  <NextButton to="/compute/instances/api-cli/detaching-a-volume">Detaching a Block Storage volume via the Instance API</NextButton>
</Navigation>