...
5. Ceate Tasks to annotate datasets of your choice with [image-level tags, as well as points, bounding boxes, polygons, and 3D boxes](https://openvinotoolkit.github.io/cvat/docs/manual/basics/types-of-shapes/) and assign them to your users.
