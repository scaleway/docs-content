...
<Message type="tip">
  You can also configure Messaging and Queueing with the Terraform NATS Jetstream provider - take a look at our tutorial [here](https://registry.terraform.io/providers/scaleway/scaleway/latest/docs/guides/mnq_with_nats_terraform_provider).
</Message>
...
<Message type="requirement">
  ...
  - You have [created a NATS Messaging namespace](/serverless/messaging/how-to/create-namespace/)
  - You have [generated credentials](/serverless/messaging/how-to/create-credentials/) for your NATS Messaging and Queuing namespace and downloaded them to your machine.
</Message>
...
- Replace `{Scaleway NATS URL}` with the URL of your NATS namespace (find this in the console on your [Namespaces dashboard](https://console.scaleway.com/messaging/namespaces/)).
- Replace `{path to your creds file}` with the path to the location where you [downloaded your `.creds` file](https://www.scaleway.com/en/docs/serverless/messaging/how-to/create-credentials/#how-to-create-credentials-for-a-nats-namespace).
