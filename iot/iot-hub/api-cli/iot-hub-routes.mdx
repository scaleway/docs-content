...
<Navigation title="See Also">
  <PreviousButton to="/iot/iot-hub/api-cli/trigger-functions-from-messages/">Triggering functions from IoT Hub messages</PreviousButton>
  <NextButton to="/iot/iot-hub/api-cli/cli-db-tips-tricks/">Discovering IoT Hub CLI tips and tricks</NextButton>
</Navigation>
