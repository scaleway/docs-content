...
In this tutorial we use a Scaleway Database for MySQL. To create the database, follow [this how-to](/databases/databases-for-postgresql-and-mysql/how-to/create-a-database/).
