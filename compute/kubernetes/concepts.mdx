...
excerpt: |
  This page explains all the concepts related to Kubernetes Kapsule that you might encounter while using Scaleway products and ressources.
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/compute/kubernetes/concepts
categories:
  - compute
brands:
  - elements
image: /assets/images/docs/scaleway.png
permalink: docs/compute/kubernetes/concepts
...
The Easy Deploy feature allows you to pull images directly from Scaleway Container Registry, instantly deploying containerized applications in your Kubernetes Kapsule cluster. With only the basic options to set, you can use Kubernetes Kapsule without needing to manage your `.yaml ` manifests. Check out our documentation on [creating containerized applications with the Easy Deploy feature](/compute/kubernetes/how-to/enable-easy-deploy/) for more information.
...
Kubectl is the command line interface for running commands against Kubernetes clusters. You can [use kubectl](/compute/kubernetes/how-to/connect-cluster-kubectl/) to connect to and manage your clusters from the command line.
...
Kubernetes Kapsule provides a managed environment for you to create, configure and run a cluster of preconfigured machines for containerized applications. It allows you to create [Kubernetes](https://kubernetes.io) clusters without the complexity of managing the infrastructure. Kubernetes Kapsule clusters are composed uniquely of Scaleway Instances. Find out how to create a Kubernetes Kapsule [here](/compute/kubernetes/how-to/create-cluster/). To create clusters including instances from external cloud providers, see [Kubernetes Kosmos](#kubernetes-kosmos)
...
## Pool
The Pool resource is a group of Scaleway compute instances, organized by type (e.g., GP1-S, GP1-M). It represents the computing power of the cluster and contains the Kubernetes nodes, on which the containers run. Consider the following when creating a Pool:
