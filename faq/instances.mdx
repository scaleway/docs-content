...
We provide a wide range of different Linux distributions and InstantApps for Instances. Refer to [Scaleway Instance OS images and InstantApps](/docs/compute/instances/reference-content/images-and-instantapps/) for a complete list of all available OSes and InstantApps.
