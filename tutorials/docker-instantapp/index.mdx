...
description: This page shows you how to use the Docker InstantApp on a Virtual Instance.
tags: compute gaming server apps docker
excerpt: |
  Docker, allows you to build and ship applications in containers. “Dockerized” apps are completely portable and can run anywhere.
  This page shows you how to deploy a cloud instance with the Docker InstantApp and how to build and run your first container.
totalTime: PT10M
steps:
...
brands:
  - elements
permalink: docs/getting-started-with-the-docker-instant-app/
image: /assets/images/docs/scaleway.png
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, debian server, linux server, docker, container
dates:
