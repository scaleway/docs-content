...
<Message type="note">
  For more information about how to use the default MQTT Network, see [How to connect to the default MQTT Network.](/iot-hub/how-to/connect-default-mqtt-network/).
</Message>
...
<Message type="tip">
  For more information about the default WebSocket Network, check out [how to connect to the default WebSocket Network.](/iot-hub/how-to/connect-default-websocket-network/).
</Message>
...
<Message type="note">
  For more information about how to use REST Networks, check out [how to set up and use REST Networks](/iot-hub/how-to/setup-use-rest-network/).
</Message>
