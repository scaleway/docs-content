...
<Message type="tip">
  ...
  - If it stops responding, you can try [rebooting your server in Rescue Mode](/dedibox/how-to/use-rescue-mode/). In the case the problem persists, [open a support ticket](https://account.scaleway.com/?service=dediboxen/assistance/ticket) to ask for a hardware check of your server.
</Message>
