...
- Access to a Scaleway [Managed Inference](/managed-inference/reference-content/pixtral-12b-2409/) endpoint with Pixtral deployed or to Scaleway [Generative APIs](/generative-apis/quickstart/) service
