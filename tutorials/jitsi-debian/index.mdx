...
3. Install an [Nginx](https://nginx.org) web server before installing Jitsi Meet. The Jitsi installation tool will take care of the Nginx configuration, if it is present on the system. Run the following commands to install and enable Nginx:
