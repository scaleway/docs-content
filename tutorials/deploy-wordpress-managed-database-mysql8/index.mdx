...
1. Go to the [Database section](https://account.scaleway.com/?service=elementsrdb/instances) of your Scaleway console and choose your Database Instance from the list:
