...
content:
  h1: Load Balancer
  paragraph: Let us address the most common questions you have about Load Balancer.
...
Your frontend listens to your Load Balancer's flexible IP address. In case of a failure of the Load Balancer, a replica Load Balancer is immediately spawned and deployed and the IP address is automatically rerouted this replica. This is done automatically, by the Load Balancer control subsystems.
