...
This page explains how to add more [versions](/secret-manager/concepts/#version) to a secret using the [Scaleway console](https://account.scaleway.com/?service=elements).
