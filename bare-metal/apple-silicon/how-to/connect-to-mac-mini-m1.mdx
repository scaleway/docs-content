...
This page shows how to connect to your [Mac mini M1](/bare-metal/compute/apple-silicon/concepts/#mac-mini-m1) via either [VNC](/bare-metal/compute/apple-silicon/concepts/#vnc) or [SSH](/console/my-account/concepts/#ssh-key).
...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/compute/apple-silicon/how-to/create-mac-mini-m1/">How to create a Mac mini M1</PreviousButton>
  <NextButton to="/bare-metal/compute/apple-silicon/how-to/reboot-mac-mini-m1/">How to reboot a Mac mini M1</NextButton>
</Navigation>
