...
5. Set up public connectivity to access your Load Balancer from the internet.
    ...
    <Message type="note">
      You can set up private connectivity by [attaching a Private Network](/load-balancer/how-to/use-with-private-network/) to your Load Balancer after its creation.
    </Message>
