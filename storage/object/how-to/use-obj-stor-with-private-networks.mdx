...
1. Follow the instructions for [creating a Private Network](/network/vpc/how-to/create-private-network/). Make sure you create it in the same region of the Availability Zone of the Instance you previously created.
