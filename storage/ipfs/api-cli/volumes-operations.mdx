...
<Message type="important">
  Deleting a volume will also delete all of its associated pins.<br /><br />Once you do so, the volume and all of its pins and versions will no longer be displayed in the console, nor available via the APIs.
</Message>
