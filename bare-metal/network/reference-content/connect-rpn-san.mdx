...
<Message type="important">
  - RPN SAN does not support RPNv2. To use RPNv2, you either need a server with an RPNv1 connection **or** to [enable the RPNv1 gateway](/bare-metal/network/reference-content/configure-rpnv1-gateway).
...
<Message type="tip">
  Some SAN endpoints may not be reachable directly from the RPNv2 and it is required to configure an [RPNv1 gateway](/bare-metal/network/reference-content/configure-rpnv1-gateway/) to use them with RPNv2.
</Message>
...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/network/reference-content/find-rpn-gateway/">How to find the RPNv1 gateway</PreviousButton>
  <NextButton to="/bare-metal/network/reference-content/mount-rpn-san-linux/">How to mount an RPN SAN on Linux</NextButton>
</Navigation>