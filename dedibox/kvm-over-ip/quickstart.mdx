...
In this document, we show you how to access the IPMI for a Dell or HP server. See the [KVM-over-IP](/kvm-over-ip/) documentation for information about other server models.
