...
4. Select the type and version of the operating system you want to install.
    <Message type="tip">
      For more information about OS types, refer to the [dedicated servers concepts page](/dedibox/concepts/#os-type).
    </Message>
5. Personalize the following [partitioning](/dedibox/concepts/#partitioning) parameters:
...
- [Created](/dedibox/how-to/order-dedibox) and [installed](/dedibox/how-to/install-dedibox) a Dedibox and transferred your SSH key to the server during installation
