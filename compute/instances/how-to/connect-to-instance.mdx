...
This page shows how to connect to your Scaleway Instance via SSH version 2. Thanks to the SSH key that you created and uploaded, you can use a terminal application on your local computer to remotely connect to your Instance as root. This enables you to use your Instance as you wish.
...
<Navigation title="See Also">
  <PreviousButton to="/compute/instances/how-to/manage-volumes/">How to manage Block Storage volumes</PreviousButton>
