...
<Message type="note">
 ...
 You have created an Instance and an image called "Wordpress", added the two mandatory tags which allow you to trigger `auto-install`, named your Weblog "Mon Blog Scaleway" 
