...
1. Click **Local Storage** in the **Storage** section of the side menu. The [Local Storage overview](https://account.scaleway.com/?service=elementsinstance/servers) displays.
...
1. Click **Local Storage** in the **Storage** section of the side menu. The [Local Storage page](https://account.scaleway.com/?service=elementsinstance/servers) displays.
2. Click the **Snapshots** tab.
