...
2. The registration page displays. Choose one of the proposed SSO methods or click **Continue with Email** to use your email address.
  ...
  <Lightbox src="scaleway-slack-login.png" alt="" />
...
4. An account validation e-mail will be sent to your address. Login to your e-mail account and check that you have received it. You should see the message as pictured below. Click **Join Now** to open the sign up page.
