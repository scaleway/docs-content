...
Serverless SQL Database is compatible with most PostgreSQL-compatible clients and tools. Due to connection pooling support, some minor features are disabled or will not work as expected. Refer to the [Known differences](/serverless/sql-databases/reference-content/known-differences/) page for more information.
