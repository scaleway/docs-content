...
3. Install the required software packages using the `apt` package manager.
    ...
    ```
4. Download and unpack Focalboard. In this tutorial, we use v7.10.4 of Focalboard, but you can find the **latest** release in the project's [GitHub repository](https://github.com/mattermost/focalboard/releases).
    ```
