...
3. Complete the following steps in the wizard:
    ...
    - Select an operating system version. 
      ...
      - On Mac mini M2 Pro machines, you can also choose Asahi Linux as an alternative to macOS.    - Optionally, configure the available public bandwidth for your server. This option may not be available for all offers.
