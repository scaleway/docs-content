...
An Elastic Metal server can be reinstalled at any time from the [Scaleway console](https://account.scaleway.com/?service=elements). This can be useful when you want to run a different image on the machine or if you want to have a fresh installation.
