...
2. Click the **Confirm Subscription** button at the top right of the page. A popup displays:
...
2. Use the dropdown menu to select the [region](/serverless/messaging/concepts/#region) containing the subscription you want to delete.
