...
An Instance is a virtual computing unit that offers resources for running applications. It functions as a self-contained entity with its own operating system, RAM, and storage. You have the flexibility to tailor the Instance configuration according to your requirements, including the number of vCPUs, RAM capacity, and storage. Refer to our [Instance types documentation](/compute/instances/reference-content/choosing-instance-type/) for further details on the various Scaleway Instance options.
