...
[Scaleway Database](/storage/database/concepts/#managed-database) provides fully-managed relational Database Instances, with MySQL and PostgreSQL as database engines.
