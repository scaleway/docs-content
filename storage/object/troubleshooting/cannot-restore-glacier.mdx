...
The time it takes to restore an object depends on the size of the object, and if [multipart](/object/concepts/#multipart-uploads) is configured. If your object is larger than 1 MB, it can take anywhere from a few minutes to 24 hours for restore to start.
...
- Refer to the documentation on [how to restore objects from Glacier](/object/how-to/restore-an-object-from-glacier/) for more information.
