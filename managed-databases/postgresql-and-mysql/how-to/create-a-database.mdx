...
3. Complete the following steps in the wizard:
    ...
    - Enable encryption at rest if you want to ensure the permanent encryption of your database data.
        <Message type="important">
          When you enable encryption at rest, you cannot disable it after database creation. All databases, all data and all snapshots will be encrypted. Backup encryption is currently not available.
          <br /><br />
          During the beta phase, if chose to enable encryption after database creation, you must make an enablement request via a [support ticket](https://console.scaleway.com/support).
          <br /><br />
          Enabling encryption incurs in the copy of the database data into a new, encrypted block volume. This takes approximately 1h per 100GB of storage. A couple seconds of downtime are also expected towards the end of the copying process, when the volumes are being switched.
        </Message>
    - Select a node type.
    - Choose your storage type and capacity. Two types of storage are available:
        ...
        - **Block Storage Low Latency**: This storage type works like the [Basic Block Storage](#basic-block-storage), while providing lower latency and high resiliency through 5k IOPS. You can increase your volume to up to 10 TB.
