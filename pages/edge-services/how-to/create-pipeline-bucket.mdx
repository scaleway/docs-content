...
2. Click **Create pipeline**. The pipeline creation wizard displays.
    ...
    <Lightbox src={image} alt="A screenshot of the Scaleway console shows the Edge Services pipeline creation wizard. It prompts you to select an origin type (Load Balancer or Object Storage), origin bucket, and choose a name for the pipeline." />
