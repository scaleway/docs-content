...
meta:
  title: Database
  description: Discover Scaleway Managed Database and how to access it for PostgreSQL and MySQL.
content:
  h1: Database
  paragraph: Discover Scaleway Managed Database and how to access it for PostgreSQL and MySQL.
image: database.webp
---
...
The idea is to offer the best performances to ours users by reducing latencies between active and hot standby nodes as we use a sync replication process between the nodes
