...
We provide two distinct migration strategies tailored to various requirements and limitations.

| **Migration Strategy 1**: API-Guided Migration                                                                                                                                                                                                                                                                                                             | **Migration Strategy 2**: Parallel Cluster Deployment                                                                                                                                                                                                                                            |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Description:**                                                                                                                                                                                                                                                                                                                                           | **Description:**                                                                                                                                                                                                                                                                                 |
| Uses the migration API provided by Kubernetes Kapsule.                                                                                                                                                                                                                                                                                                     | Deploys a new Kapsule cluster on a Private Network in parallel to the existing public cluster.                                                                                                                                                                                                   |
| **Implementation:**                                                                                                                                                                                                                                                                                                                                        | **Implementation:**                                                                                                                                                                                                                                                                              |
| 1. Access migration API: [Scaleway API Documentation](https://www.scaleway.com/en/developers/api/kubernetes/#path-clusters-migrate-an-existing-cluster-to-a-private-network-cluster).<br />2. Initiate migration via Scaleway Console's Private Network tab.<br />3. For Terraform users: Attach a Private Network ID to the cluster resource to activate migration. | 1. Establish a new Kapsule cluster on a Private Network.<br />2. Manually deploy services & containers.<br />3. Run both clusters simultaneously.<br />4. Once the new cluster is verified functional, redirect traffic to it.<br />5. Decommission the old cluster. Configuration intricacy can affect this method. |
| **Downtime:**                                                                                                                                                                                                                                                                                                                                              | **Downtime:**                                                                                                                                                                                                                                                                                    |
| Expected 1-10 minutes. Downtime occurs due to Pod network unavailability when all CNI Pods restart. The duration depends on cluster size and CNI used.                                                                                                                                                                                                     | Aims to reduce or even bypass downtime. The exact duration is contingent on the efficiency of parallel deployment and the migration process.                                                                                                                                                     |
| **Pros:**                                                                                                                                                                                                                                                                                                                                                  | **Pros:**                                                                                                                                                                                                                                                                                        |
| 1. Detailed migration guidelines: [Scaleway Documentation](https://www.scaleway.com/en/docs/containers/kubernetes/reference-content/secure-cluster-with-private-network/#how-can-i-migrate-my-existing-clusters-to-private-networks).<br />2. Efficient migration via the provided API.                                                                         | 1. Potential for negligible downtime.<br />2. Thorough testing & validation of the new cluster prior to traffic rerouting.                                                                                                                                                                            |
| **Cons:**                                                                                                                                                                                                                                                                                                                                                  | **Cons:**                                                                                                                                                                                                                                                                                        |
| Downtime during migration.                                                                                                                                                                                                                                                                                                                      | 1. Necessitates a new cluster, leading to extra expenses.<br />2. Complexity varies with workload & configuration.<br />3. Replication and validation can prolong migration.                                                                                                                               |
