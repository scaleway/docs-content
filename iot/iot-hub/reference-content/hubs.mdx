...
Upon connecting a not-yet-known device with a valid certificate, your Hub can automatically add it to its device list if you enable the auto-provisioning feature, otherwise connection will be denied.
