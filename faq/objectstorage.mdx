...
If you want to deliver your content to several geographic locations with minimal latency, you can use Scaleway's [Edge Services](/storage/object/how-to/get-started-edge-services/).
