...
1. Click **Domains and DNS** in the **Domains & Web Hosting** section of the [Scaleway console](https://account.scaleway.com/?service=elements) side menu. The list of your domains displays.
