...
<Message type="note">
  Kapsule and Kosmos clusters created after April 12th 2024 are deployed with IP mobility enabled by default. For existing clusters, you can manually launch the migration to routed IPs.
</Message>
