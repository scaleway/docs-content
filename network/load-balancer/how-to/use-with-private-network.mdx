...
6. Click **Attach to Private Network** to validate the form. The Private Network is attached to the Load Balancer and displays in the **Private Network** tab. Its private IPv4 and IPv6 addresses on the network are also visible, if you activated DHCP.
    ...
    For more information on Private Networks, and how resources' IP addresses on Private Networks are set by DHCP, see our [dedicated documentation](/network/vpc/concepts/#private-networks).
