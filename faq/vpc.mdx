...
One default VPC (**V**irtual **P**rivate **C**loud) for every available region is automatically created in each Scaleway [Project](/console/organizations-and-projects/concepts/#project). A VPC offers layer 3 network isolation.
