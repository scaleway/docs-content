...
<Message type="important">
  ...
  The version of `s3fs` available for installation using the systems package manager does not support files larger than 10GB. It is therefore recommended to compile a version, including the reqired corrections, from the sourcecode repository of the tool. This tutorial will guide you through the process of fixing, compiling and installing `s3fs` on your machine.
