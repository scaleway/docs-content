...
excerpt: |
  This page explains how to monitor your Dedibox server
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/dedibox/dedicated-servers/how-to/monitor-server
image: /assets/images/docs/scaleway.png
keywords: console, my-account, Howto, monitor
dates:
...
3. Click **Monitoring** in the left side menu. The monitoring page displays.
  ...
  <Lightbox src="scaleway-dedibox-monitoring.png" alt="" />
...
3. Click **Logs** in the left side menu. The logs page displays.
  ...
  <Lightbox src="scaleway-dedibox-logs.png" alt="" />
