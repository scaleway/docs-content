...
<Tabs>
  <TabsTab label="Via the console">
    ...
    A list of your permission sets for the selected Organization displays. You can see the scope of the permissions, in which [IAM policy](/iam/concepts/glossary/#policy) they were defined, and to which [principal](/iam/concepts/glossary/#principal) they are attached to.
  </TabsTab>
