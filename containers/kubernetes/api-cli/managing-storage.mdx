...
2. After updating the cluster tag, the cluster switches to the _updating_ status, indicating the deployment of the new CSI v0.3 on your nodes.
    ...
    <Message type="important">
        Once the migration to CSI v0.3 is initiated, a **rollback to CSI v0.2 is impossible**. Conduct thorough prerequisite and compatibility checks before proceeding.
    </Message>

    <Message type="note">
      Note: This migration process applies specifically to PVCs (Persistent Volume Claims) and Snapshots. System volumes remain on the Instances side, unaffected by this migration.
    </Message>
