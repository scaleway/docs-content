...
8. Enter a name for your Data Lab cluster, and add an optional description and/or tags.

9. Verify the estimated cost.

10. Click **Create Data Lab cluster** to finish. You are directed to the Data Lab cluster overview page.