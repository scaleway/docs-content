...
It is composed of the following:
  ...
  - Cluster: An Apache Spark cluster with a Lighter component responsible for creating the computation pods when the notebook is in use.
...
3. Complete the following steps in the wizard:
    ...
    - Optionally, choose an Object Storage bucket in the desired region to store the configuration files, the output and the dependencies.
...
## How to set up your notebook environment

1. From the Data Lab home screen, double-click `quickstart.ipynb` in the left-hand files list to open it.
