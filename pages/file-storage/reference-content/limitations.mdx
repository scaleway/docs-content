...
To ensure optimum performance, the number of file systems you can attach to an Instance is limited based on the Instance's configuration, as shown in the table below.
...
<Message type="note">
You can find the maximum number of file systems you can attach to a Scaleway Instance using the following [Scaleway CLI](/scaleway-cli/quickstart/) command:
```bash
