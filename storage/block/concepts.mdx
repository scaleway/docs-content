...
IOPS or Input/Ouptut Operations Per Second, is a unit of measurement that indicates how many input or output operations a storage device can perform per second.

Scaleway Block Storage offers two IOPS:
