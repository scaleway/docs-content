...
1. On the pool configuration page, go to the **Cloud-init** section.
2. Use the toggle to enable cloud-init.
3. Add your YAML-formatted script in the **Cloud-init configuration** box. 
