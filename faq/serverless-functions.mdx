...
content:
  ...
  paragraph: Let us address the most common questions you have about Serverless Functions.
image: faas.png
---
...
## What are Serverless Functions limitations?

Refer to our dedicated page about [Serverless Functions limitations and configuration restrictions](/compute/containers/reference-content/functions-limitations/) for more information.