...
categories:
  - instances
tags: newsletter Mailtrain Ubuntu
dates:
  validation: 2023-12-13
  posted: 2021-12-20
---

[Mailtrain](https://mailtrain.org/) is a self-hosted open-source newsletter application built in [Node.js](https://nodejs.org/en/) and using [MariaDB](/tutorials/mariadb-ubuntu-bionic/) as datastore.
...
- An [Instance](/compute/instances/how-to/create-an-instance) running on Ubuntu Bionic or later
- [Unlocked the SMTP ports](/compute/instances/how-to/send-emails-from-your-instance/)
