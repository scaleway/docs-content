...
If your use case requires that your organization comply with security regulations and standards (e.g., PCI‑DSS, FIPS, HIPAA, ISO 27001), proving to auditors that keys have never been compromised might be difficult.
