...
| SecretManagerSecretCreate    | Create permission to secret manager secrets and their versions. Does not include update permission on secrets, versions and folders             |
| SecretManagerSecretDelete    | Delete permission to secret manager secrets and their versions             |
| SecretManagerSecretWrite     | Write permission to secret manager secrets and their versions. Does not include creation permission on secrets, versions and folders             |
