...
Too low vCPU and RAM values can lead to Functions going to error status so it's important to select enough of vCPU and RAM.
The recommended approach is to set high values and then use Metrics [(see documentation)](/serverless/functions/how-to/monitor-function/) to monitor
...
* **Increase resources**: Adding more vCPU and RAM can help to reduce significantly the cold-starts of your functon.
