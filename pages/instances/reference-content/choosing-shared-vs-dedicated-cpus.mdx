...
Shared vCPU Instances, including [Development](/instances/reference-content/development/) and [General Purpose](/instances/reference-content/general-purpose/), are cost-effective virtual machines in which CPU resources are shared among multiple Instances.
...
Dedicated vCPU Instances, including [General Purpose](/instances/reference-content/general-purpose/), [Compute Optimized](/instances/reference-content/compute-optimized/), and [Memory Optimized](/instances/reference-content/memory-optimized/) Instances provide exclusive access to physical CPU cores.
