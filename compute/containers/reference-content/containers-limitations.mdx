...
The limits mentioned beforehand are technical limits. Also [account quotas](/console/my-account/reference-content/account-quotas/#serverless-containers), depending on your account level, are applied.
