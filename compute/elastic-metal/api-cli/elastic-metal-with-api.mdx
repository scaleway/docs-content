...
The new deployment in one command feature allows you to speed up the delivery of your servers, as you don’t have to wait for it to be delivered to install the server. You can do both in a single API call, and your server is up and running in less than 15 minutes. 
