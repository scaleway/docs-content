...
meta:
  ...
  description: Learn how to migrate your Scaleway Dedibox server to a newer model.
content:
  h1: How to migrate your Dedibox server
  paragraph: This guide explains how to migrate your Scaleway Dedibox server to a newer model.
...
- [Use FTP](/dedibox/how-to/connect-to-server/#using-sftp-with-filezilla)
- [Use SCP](/dedibox/how-to/connect-to-server/#using-scp-in-a-terminal)
