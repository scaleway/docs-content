...
First released in 2004, Ubuntu, whose name is based on an ancient African word meaning _humanity to others_, became quickly the favourite Linux distribution of users around the world, mostly because it is easy to install and use.
