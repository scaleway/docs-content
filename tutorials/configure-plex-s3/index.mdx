...
2. Access Plex interface throught an SSH tunnel
...
7. Click **Browse and select a multimedia folder** to do so.
    - Plex recommend to create seperate folter for each type of media. For example, if your library is about movies, create a folder `Movies` in your bucket, throught the `/mnt/media` mounted folder or the Scaleway Console.
...
10. You can now add a media to your bucket and trigger a scan of you media folder in the Plex interface.
11. Do you see your media in Plex? If yes, it's all set up!