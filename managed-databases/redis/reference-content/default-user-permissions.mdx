...
<Message type="important">
  You can change the default username and password anytime via the Scaleway API or the CLI. Refer to the [Managing the default user's username and password](/redis/api-cli/managing-username-and-password/) documentation page for more information.
</Message>
