...
| RelationalDatabasesReadOnly  | List and read access to Databases for PostgreSQL and MySQL                                             |
| RelationalDatabaseFullAccess | Full access to create, read, list, edit and delete Databases for PostgreSQL and MySQL |
