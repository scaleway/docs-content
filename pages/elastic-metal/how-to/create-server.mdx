...
3. Complete the server creation wizard:
    ...
    - Choose your preferred billing method: **hourly** or **monthly**.
      <Message type="tip">
        You can update the billing period to monthly at any time after your server has been delivered. [Learn more about switching billing plans](/elastic-metal/how-to/change-billing-period/).
      </Message>
