...
Once you have connected via SSH, you can [launch a Docker container](/compute/instances/how-to/use-gpu-with-docker/) or [use a pre-installed python environment](/compute/instances/how-to/use-pipenv/) to start working on your AI projects.
