...
excerpt: |
  Scaleway Elements Kubernetes Kapsule is not delivered with an embedded logging feature. In this tutorial, you will learn how to collect your Kubernetes logs using Loki and Grafana. Loki is a log aggregation system inspired by Prometheus.
totalTime: PT15M
steps:
...
Scaleway Elements [Kubernetes Kapsule](/compute/kuberenetes/how-to/create-cluster) is not delivered with an embedded logging feature.  
