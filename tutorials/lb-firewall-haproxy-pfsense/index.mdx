...
<Message type="important">
  The installation of pfSense is done using the [KVM-over-IP device](/kvm-over-ip/quickstart/) of the Elastic Metal server or the Scaleway Dedibox.
</Message>

1. Connect to the [KVM-over-IP device](/kvm-over-ip/quickstart/) of your Elastic Metal server or Scaleway Dedibox.
...
With [RPNv2](https://www.scaleway.com/en/dedibox/private-network-rpn/), it is possible to configure multiple private networks on the physical network interface. We suppose the [RPNv2 group](/rpn/quickstart/#how-to-create-an-rpnv2-group) is already configured.
