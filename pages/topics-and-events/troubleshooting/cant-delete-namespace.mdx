...
You may be trying to delete a Scaleway [Project](/organizations-and-projects/concepts/glossary/#project), and encounter an error message telling you that the Project cannot be deleted due to an existing Messaging namespace.
