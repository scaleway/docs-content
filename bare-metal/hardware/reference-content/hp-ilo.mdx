...
This page shows you how to use [KVM](/bare-metal/hardware/concepts/#kvm-over-ip) on a Dedibox with HP iLO.
...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/hardware/reference-content/configure-raid-kvm-p420/">Configuring a HP Smart Array P420 RAID controller from the KVM</PreviousButton>
  <NextButton to="/bare-metal/hardware/reference-content/dell-idrac6/">Using DELL iDRAC 6</NextButton>
</Navigation>