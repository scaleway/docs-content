...
[Rocket.Chat](https://rocket.chat) is a free and open source team chat software solution. It provides features like audio and video conferencing, guest access, screen sharing, file sharing, LiveChat, LDAP Group Sync, multifactor authentication (MFA), E2E encryption, SSO, and more. The tool uses [MongoDB](/tutorials/mongodb-ubuntu-1604/) as database and the JavaScript runtime [Node.js](https://nodejs.org/en/).
