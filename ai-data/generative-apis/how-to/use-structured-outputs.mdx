...
- Access to Generative APIs.
    While in beta, the service is restricted to invited users. You can request access by filling out a form on the Scaleway's [Betas page](https://www.scaleway.com/en/betas/#generative-apis).
