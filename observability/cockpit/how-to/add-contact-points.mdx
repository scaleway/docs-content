...
This page shows you how to associate [contact points](/observability/cockpit/concepts/#contact-points) with the default [receiver](/observability/cockpit/concepts/#receivers) using the [Scaleway console](https://console.scaleway.com/).
