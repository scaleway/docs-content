...
1. Click **Apple silicon** in the **Bare Metal** section of the side menu. A list of your Mac mini s displays.
...
<Message type="note">
  The default user to connect to your Mac mini is `m1`. The SSH command to connect is `ssh @<your_mac_mini__ip>`.
</Message>
...
You are returned to the list of your Mac mini s, where the machine you deleted no longer appears.
