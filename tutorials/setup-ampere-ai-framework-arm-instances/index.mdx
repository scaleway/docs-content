...
8. Verify your SSH key fingerprint is shown. If not, click **Add SSH key** and paste the SSH key you have [pre-generated](/console/organizations-and-projects/how-to/create-ssh-key) for secure access to the Instance.
