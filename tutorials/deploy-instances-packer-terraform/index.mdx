...
1. Download [Packer](https://www.packer.io/downloads.html) for your Operating System. If you want to define specific configuration, you can also [build the application](https://www.packer.io/intro/getting-started/install.html#compiling-from-source) from source.
