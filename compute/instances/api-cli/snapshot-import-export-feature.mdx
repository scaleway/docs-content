...
Snapshots are created using the QCOW2 format and stored in a Scaleway Objetct Storage Bucket that holds the data. These images can then be used to create a copy of an Instance in a different AZ.
...
This document shows you how to use this functionality using the Scaleway API. The import/export feature is also available in the Console, CLI, and SDK.
