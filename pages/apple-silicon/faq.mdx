...
You can opt for automatic deletion after 24 hours by enabling this setting in the console. Note that the exstimated cost displayed in the console is indicative only and does not reflect the final cost or commit you to consuming the full allocated period.
