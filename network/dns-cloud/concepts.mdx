...
<Lightbox src="scaleway-domain-namespace.jpg" alt="" />

[Skip to concept](#dns-namespace/)

**DNS Nameserver**

<Lightbox src="scaleway-dns-nameserver.jpg" alt="" />
...
A DNS nameserver stores the [DNS Records](#dns-record) for a given domain(s). Scaleway has its own nameservers for its managed domains.
