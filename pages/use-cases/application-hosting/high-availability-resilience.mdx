...
**Example use-case:** A mission-critical SaaS platform running in active-passive mode across two regions, with each region operating in a multi-AZ configuration using Scaleway Instances and Load Balancers, combined with cross-region DNS failover for uninterrupted service.
...
| High availability and auto-failover | Multi-AZ with HA services (Load Balancer) |
