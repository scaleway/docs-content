...
| <Lightbox image={stop} alt="" />  | End of Life (EOL)         | The service is retired. Any remaining Instances are automatically shut down, and existing Instances are automatically migrated to equivalent offers to ensure continuity.                    |
