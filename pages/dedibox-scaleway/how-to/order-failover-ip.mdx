...
content:
  h1: How to order a failover IP for Dedibox from the Scaleway console
...
Failover IPs can be bought as single IP addresses with a maximum number of IPs per Dedibox server, depending on your offer, or as /27 IP blocks for Dedibox servers with business service level.
