...
In an Edge Services pipeline, WAF sits before the backend stage. This means that WAF only protects your backend, it does not protect or filter requests towards the cache.
