...
- A member status of the customer Organization whose tickets you want to access.
...
<Message type="note">
  You must be a member of the customer's Organization to access their support section. If you do not yet have access, refer to [how to add a client](/partner-space/how-to/add-client/) and make sure you accepted the membership invitation.
</Message>
