...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/hardware/reference-content/dell-idrac8/">How to use DELL iDRAC 8</PreviousButton>
  <NextButton to="/bare-metal/hardware/reference-content/supermicro/">How to use the Supermicro KVM</NextButton>
</Navigation>