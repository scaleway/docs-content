...
2. Click **Virtual Media** > **CD-ROM Image** in the menu: 
    ...
    <Lightbox src="scaleway_supermicro_vm.png" alt="" />

3. Enter the image file path of your OS image: 

    <Lightbox src="scaleway_supermicro_nas.png" alt="" />
