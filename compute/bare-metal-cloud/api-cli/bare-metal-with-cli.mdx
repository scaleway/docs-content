...
6. Type `scw baremetal server list zone=fr-par-2` to check the status of your server.
 ...
 * Before powering off your server, we recommend you [log into your server as root](https://www.scaleway.com/en/docs/compute/bare-metal-cloud/how-to/connect-to-server/) and execute the `halt` command to shutdown the OS. 
