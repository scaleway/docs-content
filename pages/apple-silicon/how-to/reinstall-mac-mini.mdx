...
4. Select the operating system version that you want to reinstall from the drop-down menu.
...
5. Type **REINSTALL** to confirm the installation of your Mac mini and click **Reinstall Mac mini** to validate.
    <Message type="important">
