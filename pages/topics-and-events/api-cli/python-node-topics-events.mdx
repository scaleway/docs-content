...
You can find the value for `[Function URL]` in the [Scaleway console](https://account.scaleway.com/?service=elements) in the **Endpoints** tab of your function's **Overview** page. 
