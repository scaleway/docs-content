...
- Make sure you have built your image for an `amd64` architecture, as `arm64` is not supported. See the [Architecture](/containers/reference-content/containers-limitations/#architecture) documentation for more information.

- Make sure your deployment does not exceed the limitations of [Serverless Containers](/containers/reference-content/containers-limitations/).
