...
steps:
  - step: Installing the NGINX web server
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-nginx-letsencrypt/#-Installing-the-NGINX-web-server
  - step: Configuring a Server Block
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-nginx-letsencrypt/#-Configuring-a-Server-Block
  - step: Installing Certbot and obtaining a Certificate
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-nginx-letsencrypt/#-Installing-Certbot-and-Obtaining-a-Certificate
categories:
  - compute
  - instances
tags: compute server teamspeak voice audio
image: /assets/images/docs/scaleway.png
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, debian server, linux server, IAAS, baremetal, scalability, ARM, physical server, dedicated server, physicalization, server, teamspeak, conference, gaming
dates:
...
8. When typing *http://example.com* in your browser, you should see your newly created place holder page:
  ...
  <Lightbox src="scaleway-example_site.png" alt="" />
...
<Lightbox src="scaleway-example_https.png" alt="" />
