...
meta:
  ...
  description: Learn how to create credentials for Scaleway Messaging and Queuing. Securely manage access and ensure seamless integration with this step-by-step guide.
content:
  h1: How to create credentials for Messaging and Queuing
  paragraph: Learn how to create credentials for Scaleway Messaging and Queuing. Securely manage access and ensure seamless integration with this step-by-step guide.
