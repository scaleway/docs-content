...
See [Domains](/domains/concepts/#domain-name).

## DNS

The **D**omain **N**ame **S**ystem is a name management system for computing devices connected to a network, be it public (Internet) or private. It translates text-based [domain names](/domains/concepts/#domain-name) to numerical [IP addresses](#ip-address).
...
Root Servers are a type of [DNS Name Server](#dns-name-servers) pertaining to [Top Level domains](/domains/concepts/#tld). They are the first step in the resolution of any domain name, since they contain information about the authoritative DNS servers for each Top Level Domain.
