...
1. [Create a regional Private Network](/network/vpc/how-to/create-private-network/) and [attach at least two Instances](https://www.scaleway.com/docs/network/vpc/how-to/attach-resources-to-pn/) to it.
