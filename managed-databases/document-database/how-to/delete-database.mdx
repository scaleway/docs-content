...
<Message type="requirement">
  ...
  - You have a [database](/managed-databases/document-database/how-to/add-a-database)
</Message>
...
5. Type **DELETE** to confirm and click **Delete this Instance**.


<Navigation title="See Also">
  <PreviousButton to="/managed-databases/document-database/how-to/manage-read-replica">How to manage Read Replicas</PreviousButton>
