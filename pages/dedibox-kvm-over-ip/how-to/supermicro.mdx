...
1. Access your [Dedibox console](https://account.scaleway.com/?service=dedibox) and navigate to **Server** > **Server List**. This will display a list of your dedicated servers.
