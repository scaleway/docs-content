...
- [Deployed a container](/containers/how-to/deploy-container/)
- Created an [authentication token](/containers/how-to/create-auth-token-from-console/) for your container
...
6. If required, [create an access token](/containers/how-to/create-auth-token-from-console/) for your container.
...
Refer to the [How to create an authentication token](/containers/how-to/create-auth-token-from-console/) documentation for more information.
