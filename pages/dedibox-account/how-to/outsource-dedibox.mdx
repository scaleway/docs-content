...
4. Enter the **Scaleway console identifier** of the recipient account.
   <Message type="important">
     Identifier refers to the unique ID of the account to which the machine will be outsourced, **not** your personal user ID.
     You can find this ID on the [outsourcing page](https://console.online.net/en/account/outsourcing/requests/) of the recipient’s Dedibox console.
