...
<Message type="important">
  ...
  - Currently, any update to your alias must be made via [support ticket](https://account.scaleway.com/?service=elementssupport).
</Message>

1. Go to the [Organization settings page](https://account.scaleway.com/?service=elementssettings/organization/information).
