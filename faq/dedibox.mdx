...
Your server is on a monthly contract, with the billing cycle running from the first to the last day of each month. When placing an order, you will be billed pro rata for the current month, except if you are paying via SEPA direct debit. In that case, your first invoice will be issued during your first complete month and will include both the pro rata amount for the current month and the full amount for the following month.
<Message type="note">
  If you chose a commitment period during server creation, your contract is fixed for a duration of 12 or 36 months, depending on the commitment option you selected.
</Message>
...
### Can I benefit from a commitment plan on an already rented server?
...
### At the end of the commitment, what will be the price for my Dedibox?
...
This version should be clearer and more accurate, enhancing the user's understanding of the commitment plans and their terms.
