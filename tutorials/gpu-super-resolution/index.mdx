...
In this tutorial, we will show you how to prepare your data, construct the **sub-pixel convolutional** neural network, train it, and test it using a Scaleway [GPU instance](https://account.scaleway.com/?service=elementsinstance/servers/create).
