...
3. Enter the code and validate the form.
    <Message type="note">
      ...
      - The authorization charge is **€1** and will carry a 4-digit validation code, displayed on your bank account statement. This validation code will be used to verify your credit card for your Scaleway account. You will be refunded for the €1 within 48 to 72 hours.
    </Message>
