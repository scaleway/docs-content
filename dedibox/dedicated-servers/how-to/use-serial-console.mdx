...
3. Click **Serial Console**. The connection information displays.
    <Lightbox src="scaleway-serial-console.webp" />
4. Click **Access** to access the serial console of your server.
    <Lightbox src="scaleway-serial-console-2.webp" />
...
<Lightbox src="scaleway-serial-console-esxi.webp" />
...
5. Enter 9600 (2) as value:
    <Lightbox src="scaleway-serial-console-esxi2.webp" />
