...
You may still be able to install ESXi on Elastic Metal or Dedibox servers using the [KVM-over-IP](/kvm-over-ip/quickstart/) system. However, note that we cannot provide support for its configuration or operation.
