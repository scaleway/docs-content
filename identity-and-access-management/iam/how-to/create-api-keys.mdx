...
7. Select whether the API key will be used for Object Storage. Choose from:
    ...
    - **No, skip for now**: the Project that you are currently navigating in the console (i.e. the one that is selected in your [Project dashboard](/console/organizations-and-projects/concepts/#project-dashboard)) will be automatically selected as the preferred Project for Object Storage.
