...
content:
  ...
  paragraph: This page provides information on how to deploy a virtual machine with Microsoft Hyper-V on Scaleway Dedibox.
...
10. Assign a virtual MAC address to the failover IP from the [Dedibox console](https://console.online.net/) to make sure that the virtual machine is able to communicate on the internet. Refer to the [dedicated documentation](/ip-failover/how-to/create-virtual-mac/) for more information about how to create a virtual MAC address. Click **Settings** in the VM section of the menu.
