...
Scaleway provides the following preconfigured alerts for Serverless Jobs:

- **Job Run failed** - You are alerted if a job run has failed.
- **High CPU usage** - You are alerted if CPU usage is higher than 80% for 10 consecutive minutes.
- **High memory usage** - You are alerted if memory usage is higher than 80% for 10 consecutive minutes.

<Message type="note">
  Refer to the [How to activate preconfigured alerts](/cockpit/how-to/activate-managed-alerts/#how-to-activate-preconfigured-alerts) page to learn how to activate them.
</Message>

## Manual alerts

1. [Log in to Grafana](/cockpit/how-to/access-grafana-and-managed-dashboards/).
