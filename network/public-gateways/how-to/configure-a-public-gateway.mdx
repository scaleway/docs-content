...
6. Click **Attach to Private Network** to finish. You are taken back to the Private Networks tab, where the network you attached now appears, along with the services configured and the IP address of the Public Gateway.
...
Dynamic NAT is automatically activated. Howveer, you can review and (if you wish) modify the static NAT configuration of an existing Public Gateway as follows:
...
3. Click the **NAT** tab. 
4. Click **Add Static NAT** to add a new configuration for any Private Network attached to this Gateway. The following screen displays:
