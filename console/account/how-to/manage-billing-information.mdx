...
meta:
  ...
  description: Learn how to manage your billing information on Scaleway. Add credit cards or SEPA mandates, change payment methods, and update your billing address easily.
content:
...
3. Enter the code and validate the form.
    <Message type="note">
      ...
      - The authorization charge is **€1** and will carry a 4-digit validation code, displayed on your bank account statement. This validation code will be used to verify your credit card for your Scaleway account. The authorization charge will be refunded within 48 to 72 hours.
    </Message>
