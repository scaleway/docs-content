...
3. Write `my/topic` under the **Topic** field, and `Hello World` in the **Message** field in the **Publish** panel. Then, click **Publish**.
...
<Message type="note">
  ...
  To learn more about MQTT, refer to this blogpost: [An Introduction to the MQTT protocol](https://blog.scaleway.com/introduction-to-mqtt-protocol/).
