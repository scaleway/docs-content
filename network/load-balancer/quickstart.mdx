...
6. Select the **accessibility** of your Load Balancer. It can be either:
    - **Private**: A private Load Balancer will have no public IP address, and is only accessible from the Private Network(s) it is attached to. You can [attach your Load Balancer to a Private Network](/network/load-balancer/how-to/use-with-private-network/) after you have created it. [Read more about private Load Balancers](/network/load-balancer/concepts/#private-load-balancer).
...
7. Select an **IP address** for your Load Balancer. You can either allocate a new IP, or select one of your existing IPs.

8. Click **Create and add front and backend** to create your Load Balancer, and configure a frontend and backend for it.
