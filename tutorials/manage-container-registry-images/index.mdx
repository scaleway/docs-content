...
2. Click **Functions** in the **Serverless** section of the side menu. The Functions page displays.
...
12. Define the following **Secrets** as secret environment variables for your Function: 
    | Key          | Value                                          |
    |--------------|------------------------------------------------|
...
14. Deploy the Function by clicking **Create a Function**. The list of your functions displays.

## Configuring a Trigger

A trigger allows you to invoke functions by handleing events coming from other sources, such as CRON.
