...
- [Owner status](https://console.scaleway.com) or [IAM permissions](/iam/concepts/glossary/#permission) to perform actions in the intended Organization.
    ...
    <Tabs>
      ...
      <TabsTab label="Using the Scaleway CLI">
         ...
         2. Run the following command and follow the prompts to set up your CLI with your Scaleway API keys:
            ...
            scw init
            ```
            You will need your [API Key](/iam/credentials/create-api-keys/) (access key and secret key).
