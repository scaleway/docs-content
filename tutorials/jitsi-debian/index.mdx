...
Jitsi Meet offers the following capabilities:
...
<Message type="note">
  This tutorial shows the installation of Jitsi Meet on Debian Buster. If you prefer the installation of Jitsi Meet on Ubuntu Jammy Jellyfish, see the [Installing Jitsi Meet on Ubuntu Jammy Jellyfish](/tutorials/jitsi-ubuntu-jammy-jellyfish/) tutorial.
</Message>
...
7. Open a web browser and type the FQDN of your Instance, for example: `https://jitsi.mydomain.tld`. The following screen opens:
