...
<Message type="requirement">
  - You have an account and are logged into the [Scaleway console](/console/account/how-to/create-an-account/)
...
4. Copy the following yaml template.
    <Message type="important">
     ...
     - Make sure you replace `<your push token>` with the token you created in step 2
    </Message>
...
5. Select the **Metrics** data source and click **Import**. Your dashboard displays with your metrics.
...
3. Click **Explore**.
4. Select the **Logs** data source on the top left corner of your screen.
5. Click **Log browser**.
