...
However, to ensure the best performance of the SQL servers, we have defined limits for the sizes of the databases:
  ...
  - Maximum size of a table: 1 GB for the all offers
...
<Message type="important">
  ...
  The databases that exceed these quotas are automatically blocked. You will not be able to add additional data or update it. Only the options to view and delete data remain active.
