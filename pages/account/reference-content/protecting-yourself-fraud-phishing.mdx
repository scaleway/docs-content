...
- **Review login activity:** Regularly check your account [login activity and active sessions](https://account.scaleway.com/?service=elementssettings/account/security) for any unauthorized access.
...
2. **Report to Scaleway:** Forward the email or provide details of the suspicious activity to Scaleway’s security team [by ticket](https://account.scaleway.com/?service=elementssupport/tickets/create) from your Scaleway console.
