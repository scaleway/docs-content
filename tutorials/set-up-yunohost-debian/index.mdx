---
layout: docs
title: Setting up Yunohost on Debian 9
description: This page shows you how to setup your own server with Yunohost

excerpt: |
  Yunohost is an open-source solution designed for the administration of a personal server. It allows manage users, domains, websites and comes with a full email stack. The tool is designed to be lightweight and intuitive and is designed to work with Debian 9 (Stretch).
totalTime: PT30M
steps:
  - step: Installing Yunohost
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/set-up-yunohost-debian/#-Installing-Yunohost
  - step: Creating a User
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/set-up-yunohost-debian/#-Creating-a-User
  - step: Installing an Application
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/set-up-yunohost-debian/#-Installing-an-Application
categories:
  - compute
  - instances
tags: compute communication administration hosting
image: /assets/images/docs/scaleway.png
permalink: docs/tutorials/set-up-yunohost-debian/
keywords: cloud tutorials, cloud documentations, cloud server, cloud hosting, ubuntu server, debian server, linux server, IAAS, baremetal, scalability, ARM, physical server, dedicated server, physicalization, server, messaging, selfhosted, younohost, blog, email, e-mail,
dates:
...
[Yunohost](https://yunohost.org/) is an open-source solution designed for the administration of a personal server. It allows manage users, domains, websites and comes with a full email stack. The tool is designed to be lightweight and intuitive and is designed to work with Debian 9 (Stretch).
...
1. Connect to the compute instance via [SSH](https://www.scaleway.com/docs/create-and-connect-to-your-server/#-Logging-into-the-Instance).
...
9. A warning may appear in your browser, as the SSL certificate of Yunohost is self-signed:
  ...
  <Lightbox src="scaleway-yunohost_01.png" alt="" />

  Click **Advanced** to proceed to the site, which will display the login prompt:

  <Lightbox src="scaleway-yunohost_02.png" alt="" />
...
12. Once DNS zone has been updated with the required information, request a [Let's Encrypt](https://letsencrypt.org) SSL certificate to encrypt the connection between a visitor and the server. Yunohost manages the certificate handling. Request it by clicking on **SSL Certificate** in the Overview of the domain, then on **Install a Let's Encrypt Certificate**:
  ...
  <Lightbox src="scaleway-yunohost_07.png" alt="" />
  ...
  <Lightbox src="scaleway-yunohost_08.png" alt="" />
...
1. Go to the admin interface of Yunohost and click **Users** > **New User**. Fill in the required information for the new user:

  <Lightbox src="scaleway-yunohost_09.png" alt="" />
...
1. Go to the admin Interface of Yunohost and click **Applications** to land on the applications list:
  ...
  <Lightbox src="scaleway-yunohost_10.png" alt="" />
