...
* perform live demonstrations of applications installed on the remote machine
...
We recommend you create a regular user to connect to the remote desktop, to avoid security issues.
...
1. Download and install a RDP client of your choice. In this tutorial we use the [Microsoft Remote Desktop Client](https://docs.microsoft.com/en-us/windows-server/remote/remote-desktop-services/clients/remote-desktop-clients).
