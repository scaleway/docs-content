...
## STANDARD3-X Instance

Scaleway’s **General Purpose** range includes STANDARD3-X Instances, which run on the latest hardware generation from AMD Epyc: Turin (Zen 5). They offer up to 35% improved performance than Instances running on previous generation (POP2). Tackle your typical general purpose use cases, faster.

See below the technical specifications of STANDARD3-X Instances:

| Range                         	| General Purpose                                                          |
|:--------------------------------|:------------------------------------------------------------------------------|
| Instance Type   	              | STANDARD3-X                                                          	        |
| Availability Zone   	          | PAR1, PAR2, AMS1, AMS2, MIL1                                                  |
| Storage   	                    | Block                                                                         |
| Max. Bandwidth   	              | From 500 Mbps to 16 Gbps                                                      |
| Resources   	                  | Dedicated vCPUs                                                               |
| Sizing   	                      | From 2 to 64 vCPUs  <br /> From 8 GiB to 256 GiB RAM                          |
| vCPU:RAM ratio                  | 1:4                                                                           |
| SLO                            	| 99.5% availability                      	                                      |


## BASIC3-X Instance
Scaleway’s **General Purpose** range includes BASIC3-X Instances, designed for cost-effective, flexible computing. These instances run on the latest AMD Epyc (Zen 5) Turin hardware, offering improved efficiency and performance over previous generations. Ideal for development environments, small applications, and light workloads.

See below the technical specifications of BASIC3-X Instances:
| Range                          | General Purpose                                                          |
|:-------------------------------|:-------------------------------------------------------------------------|
| Instance Type                  | BASIC3-X                                                                 |
| Availability Zone              | PAR1, PAR2, AMS1, AMS2, WAW1, WAW2, MIL1                                 |
| Storage                        | Block                                                                    |
| Max. Bandwidth                 | From 350 Mbps to 3 Gbps                                                  |
| Resources                      | Shared vCPUs                                                             |
| Sizing                         | From 2 to 16 vCPUs <br /> From 4 GiB to 64 GiB RAM                       |
