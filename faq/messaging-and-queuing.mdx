...
- You must [activate](/serverless/messaging/how-to/get-started/#how-to-activate-sqs-or-sns) the SQS and/or SNS protocols on your [Scaleway Project](/console/organizations-and-projects/concepts/#project)
...
NATS and SQS protocols have left Public Beta and are now in General Availability (GA) This means that the Messaging and Queuing product, when used with these protocols, is billable.
