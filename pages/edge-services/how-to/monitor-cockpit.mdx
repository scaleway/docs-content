...
- **Cache hit ratio**: The percentage of requests served from Edge Services' cache, compared to the total number of requests to reach Edge Services for this backend, over the specified time period.
