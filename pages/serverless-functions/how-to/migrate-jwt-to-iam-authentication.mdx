...
This feature is now deprecated, you must therefore use Scaleway IAM to access your private functions and containers using an [API key](/iam/credentials/create-api-keys/). This change allows for a better Scaleway ecosystem integration. Read the documentation on [advanced access control with IAM conditions](/serverless-functions/how-to/secure-a-function/#advanced-access-control-with-iam-conditions) for more information.
