...
[Rclone](https://rclone.org) is a command-line tool that can be used to manage your cloud storage. It communicates with any Amazon Amazon S3-compatible cloud storage provider as well as other storage platforms.
