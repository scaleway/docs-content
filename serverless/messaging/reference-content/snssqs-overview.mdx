...
Before you can start using SQS or SNS with Scaleway Messaging and Queuing, you must first enable your chosen protocol (or indeed, both, if you prefer). You can do this in a few clicks from the [Scaleway console](https://console.scaleway.com) by [following our how-to](/serverless/messaging/how-to/get-started/). Alternatively, you can also use the [Scaleway API](https://www.scaleway.com/en/developers/api/messaging-and-queuing/).
