...
It is possible to access your bucket via a Instance as a proxy. Transfer of data between your bucket and the compute platform is free of charge, and you can use the bandwidth included with your instance to distribute the files in your bucket. We will use the [Nginx](http://nginx.org/) reverse proxy to provide read-only access to the bucket's contents.
...
- You have a Instance running Ubuntu or Debian Linux
