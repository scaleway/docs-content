...
totalTime: PT20M
steps:
  - step: Downloading and Installing Packer
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/deploy-instances-packer-terraform/#-Downloading-and-Installing-Packer
  - step: Packer Configuration Files
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/deploy-instances-packer-terraform/#-Packer-Configuration-Files
  - step: Building an Image with Packer
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/deploy-instances-packer-terraform/#-Building-an-Image-with-Packer
  - step: Deploying Machine Images with Terraform
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/deploy-instances-packer-terraform/#-Deploying-Machine-Images-with-Terraform
categories:
  - compute
  - instance-dev
tags: image server cloudserver cloud-server manage packer imagebuilder
image: /assets/images/docs/scaleway.png
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, scalability, ARM, physical server, dedicated server, server, image, operating system, imagebuilder, image builder
dates:
...
- `image` (string) - The UUID of the base image to use. This will be used to boot the server on, before launching the additional tasks. A complete list of all base image UUIDs is available at [https://api-marketplace.scaleway.com/images](https://api-marketplace.scaleway.com/images).
