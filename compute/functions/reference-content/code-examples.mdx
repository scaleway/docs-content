...
Python runtime includes the **OS library**, which enables you to access the environment variables you define in your namespaces or functions.
...
- `return object with body and statusCode` will set the status code as HTTP Response Code, and body as the Response's body, headers as Headers.
...
- Return `object/entity (number, boolean, string...)` without properties body and statusCode
