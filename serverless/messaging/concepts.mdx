...
A NATS account sets a scope for your NATS credentials, messages, queues and streams. You can create one or multiple NATS accounts with Scaleway Messaging and Queuing.
...
Queue volume is one of the factors affecting the billing of Scaleway Messaging and Queuing with SQS. Queue volume is calculated as the number of messages in a queue * the message size.
...
Stream volume is one of the factors affecting the billing of Scaleway Messaging and Queuing with NATS. Stream volume is calculated as the number of messages in a stream * the message size.
