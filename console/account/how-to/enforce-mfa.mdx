...
<Navigation title="See Also">
  <PreviousButton to="/console/account/how-to/redeem-coupon-code/">Redeem a coupon code</PreviousButton>
  <NextButton to="/console/account/how-to/use-2fa">How to use Multifactor Authentication (MFA)</NextButton>
</Navigation>
