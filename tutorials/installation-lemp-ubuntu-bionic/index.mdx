...
tags: account LEMP-Stack Ubuntu-Bionic 
steps:
...
1. Use the `apt` package manager of Ubuntu to install the required packages. Make sure that the system is up to date and has the latest bug-fixes and updates installed by running the following command:
...
1. Enable HTTP and SSH connections in the [firewall](/tutorials/installation-uncomplicated-firewall/) configuration of the server by typing the following command:
