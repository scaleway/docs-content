...
- You have [created](/compute/dedibox/how-to/order-server) and [installed](/compute/dedibox/how-to/install-dedibox) a Dedibox server, and transferred your SSH key to the server during installation
