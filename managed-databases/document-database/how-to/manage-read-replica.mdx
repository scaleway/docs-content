...
tags: managed-database read replicas read-replicas mongodb ferretdb document
dates:
...
<Message type="requirement">
  ...
  - You have [created a Read Replica](/managed-databases/document-database/how-to/create-read-replica)
</Message>

## How to resync a Read Replica

When you resync a Read Replica, first it is reset, and then its data is resynchronized from the primary node. Your Read Replica will be unavailable during the resynchronization process. The duration of this process is proportional to your Database Instance size. The configured endpoints will not change.
...
## How to detach a Private Network from a Read Replica
...
<Navigation title="See also">
  <PreviousButton to="/managed-databases/document-database/how-to/create-read-replica">How to create Read Replicas</PreviousButton>
  <NextButton to="/managed-databases/document-database/how-to/delete-database">How to delete a database</NextButton>
</Navigation>