...
content:
  h1: How to create a Local Storage snapshot
  paragraph: Learn how to create a Local Storage snapshot for a Scaleway Instance with this easy-to-follow guide.
