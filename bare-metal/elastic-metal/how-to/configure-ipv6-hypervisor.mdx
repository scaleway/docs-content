...
<Message type="tip">
  ...
  * The DNS cache server (nameservers) may be different depending on the physical location of your server. Refer to our [network information documentation](/dedibox-network/network/reference-content/dedibox-network-info/#dns-cache-servers) to find the IPv6 addresses to use with your machine.
</Message>
...
<Navigation title="See Also">
  ...
  <NextButton to="/bare-metal/elastic-metal/how-to/configure-reverse-dns-flexible-ip/">How to configure the reverse DNS of a flexible IP</NextButton>
</Navigation>