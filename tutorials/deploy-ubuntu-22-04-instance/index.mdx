...
1. Click **CPU & GPU Instances** in the **Compute** section of the side menu. The [Instance creation page](https://account.scaleway.com/?service=elementsinstance/servers/create) displays.
