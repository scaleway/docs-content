...
1. Open a terminal and access your folder containing  your Terraform configuration file,
2. Run the following command to delete the corresponding resources:
  ```
  terraform destroy
  ```
