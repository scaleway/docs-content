...
steps:
  ...
  - step: Setting up Container Registry credentials 
    type: HowToStep
    url: https://www.scaleway.com/en/docs/deploying-saas-with-elements/#-Setting-up-Container-Registry-credentials 
...
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, server, object storage, kubernetes, kubernetes kapsule, database, kubernetes secret, docker, saas, software as-a-Service, container registry
dates:
