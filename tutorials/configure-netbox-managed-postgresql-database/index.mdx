...
<Message type="requirement">
  ...
  - You have an [Instance](/compute/instances/how-to/create-an-instance/) running Ubuntu Focal Fossa (20.04 LTS) or later
  - You have a [Database for PostgreSQL](/managed-databases/postgresql-and-mysql/quickstart/)
</Message>
...
3. Install the required packages using the `apt` package manager:
    ...
    ```
4. Download the [latest release](https://github.com/netbox-community/netbox/releases/latest) of NetBox. At the time of writing this tutorial it is version 3.4.7. Unpack it into the `/opt` directory:
    ```
