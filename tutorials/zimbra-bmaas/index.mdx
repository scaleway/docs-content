...
During this tutorial you will learn how to install the latest version of open-source version of Zimbra on a [Bare Metal server](https://www.scaleway.com/en/bare-metal-servers/) running on Ubuntu Bionic Beaver server.

<Message type="requirement">

- You have an account and are logged into the [Scaleway Console](https://console.scaleway.com)
- You have [configured your SSH Key](/console/my-project/how-to/create-ssh-key)
- You have [created a Bare Metal server](/compute/bare-metal-cloud/how-to/create-server/) which is running Ubuntu Bionic Beaver (18.04 LTS)
