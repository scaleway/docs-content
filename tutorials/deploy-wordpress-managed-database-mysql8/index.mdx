...
content:
  h1: Deploying a WordPress blog backed by Scaleway Managed Database for MySQL 8
  paragraph: Learn how to deploy your own WordPress blog backed by Scaleway Managed Database for MySQL 8.
