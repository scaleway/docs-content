...
1. Connect to your Instance using [SSH](https://www.scaleway.com/en/docs/compute/instances/how-to/connect-to-instance/). 
  ...
  You can connect to your Instance even if it doesn't have a [flexible IP address](https://www.scaleway.com/en/docs/compute/instances/how-to/use-flexips/) by using its IPv6 address.
