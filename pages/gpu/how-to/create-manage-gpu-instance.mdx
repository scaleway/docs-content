...
1. Navigate to **CPU & GPU Instances** under the **Compute** section in the side menu of the [Scaleway console](https://account.scaleway.com/?service=elements). This action will direct you to the [Instance dashboard](https://account.scaleway.com/?service=elementsinstance/servers).
2. Click **+ Create Instance** to proceed to the [Instance creation page](https://account.scaleway.com/?service=elementsinstance/servers).
