...
- Serverless Jobs allow modifying the time zone of their schedules via the Job **Triggers** tab. Refer to [the job triggers documentation](/serverless-jobs/how-to/manage-job-triggers/) for more information.
