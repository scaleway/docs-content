...
excerpt: |
  This page explains how to disable boot errors using iDRAC
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/dedibox/dedicated-servers/how-to/disable-boot-errors-idrac
image: /assets/images/docs/scaleway.png
keywords: console, my-account, Howto, connect, serial, console, idrac, boot errors
dates:
...
The server reboots. You can watch the boot process in the KVM to make sure the server loads the OS correctly.
  ...
  <Lightbox src="scaleway-bootstuck3.png" alt=""/>
