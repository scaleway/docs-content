...
3. Click **+Create routing policy**. The **Create a routing policy** wizard displays.
        ...
        <Lightbox src="scaleway-create-routing-policy.webp" alt="In the Scaleway console, the create a routing policy wizard is displayed. There are 3 steps: 1. Choose a name and region, 2. Whitelist outgoing routes and 3. Whitelist incoming routes" />
