...
<Message type="note">
VPC Peering is currently in Public Beta, and available only via he Scaleway API. For specific API calls, read our API-based quickstart in the [VPC Peering API documentation](https://www.scaleway.com/en/developers/api/vpc-peering/#quickstart). 
</Message>
...
For full details about VPC Peering, refer to [Understanding VPC Peering](/vpc-peering/referece-content/understanding-vpc-peering/).
...
1. [Create a peering connector](TODO-LINK-TO-API-METHOD), defining your VPC as origin, and the VPC you want to peer with as target.
...
5. When you no longer need your VPC peering connection, you and an owner of the matching connector can [delete your connectors](TODO-LINK-TO-API-METHOD). 
