...
6. Select **Detect Changes via XMIN** as **Update Method** (other methods are not supported).
    ...
    <Message type="note">
    If you have set up IP address access restrictions from your IAM policies, copy the addresses from Fivetran IPs and edit your IAM policies to allow them.
    </Message>
