...
5. Click **Attach to a Private Network** to attach the IP address to your Instance. Your static IP is now assigned to the Database Instance:
...
<Message type="tip">
  ...
  Warning: The `scaleway-k8s-vpc` is not an officially supported by Scaleway.
</Message>
