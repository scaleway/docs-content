...
meta:
  ...
  description: This page explains how to download an invoice
content:
  h1: How to download an invoice
  paragraph: This page explains how to download an invoice
...
2. Scroll down to find **Recent invoices**.
    <Message type="note">
...
3. Click <Icon name="download" /> to download a copy of the invoice.

<Message type="note">
  The file is saved in **PDF format** in the **Downloads** folder on your system.
</Message>


<Navigation title="See also">
  <PreviousButton to="/console/billing/how-to/use-billing-alerts">How to use billing alerts</PreviousButton>
</Navigation>
