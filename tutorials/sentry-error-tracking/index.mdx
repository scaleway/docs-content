...
Today's world is running on applications and whether you are an engineer, support technician or product manager, everyone needs visibility into application health. Sentry is an open source solution for monitoring & error tracking in applications. It is written in Python and can provide real-time reporting of errors in applications based on a client/server architecture. You can easily integrate it into your applications via its SDK and let them automatically report the errors via common messaging tools like Slack, IRC and more. This helps reduce the time for development of your applications and improves the user experience.
