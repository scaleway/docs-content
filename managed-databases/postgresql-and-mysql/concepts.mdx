...
Basic Block Storage is a volume type. With this type your storage is decoupled from your compute resources. You can increase your storage space without changing your node type. You can define your storage capacity by entering the desired amount in the box. You can increase your volume to up to 10 TB.
...
Block Storage Low Latency is a storage type that works like the [Basic Block Storage](#basic-block-storage), while providing lower latency and high resiliency through 5k IOPS. You can increase your volume to up to 10 TB.
...
<Message type="note">
  Block Low Latency volumes are only with new-generation node types.
</Message>
