...
With the release of the H100 GPU, NVIDIA introduced support for a new datatype called FP8 (8-bit floating point), enabling higher throughput of matrix multiplies and convolutions.
