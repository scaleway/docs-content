...
<Message type="note">
Repeat the process above for each NATS account you want to delete. Remember to use the region dropdown as appropriate to access the different NATS accounts you hold in different regions.
</Message>
