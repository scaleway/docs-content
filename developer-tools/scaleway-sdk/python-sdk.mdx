...
meta:
  ...
  description: This page explains how to install and use the Scaleway Python software developement kit (SDK)
content:
  h1: Scaleway Python software developement kit (SDK)
  paragraph: This page explains how to install and use the Scaleway Python software developement kit (SDK)
