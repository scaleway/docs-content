...
2. Click the name of the bucket you want to create an Edge Services pipeline for.
    <Lightbox src={image} alt="A screenshot of the Scaleway console shows a listing of Object Storage buckets, with an arrow showing that you click on the name of the bucket you want to enable Edge Services on." />

3. Click the **Edge Services** tab.

    <Lightbox src={image2} alt="A screenshot of the Scaleway console shows the Edge Services tab for the selected bucket: it is in an empty state, with a button inviting you to enable Edge Services." />
