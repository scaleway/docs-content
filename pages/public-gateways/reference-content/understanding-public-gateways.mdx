...
Public Gateways are available in multiple different Availability Zones. For the most up-to-date information, check out the [Scaleway console](https://console.scaleway.com/public-gateway/public-gateways/create) or the [Product Availability](/account/products-availability/) page.
