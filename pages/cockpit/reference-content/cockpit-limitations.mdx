...
| `max_global_series_per_user`       | 1000000            | Maximum number of series in memory for a datasource, in the last 10 minutes       |
...
The following table provides information about [Alerting-Rules](/cockpit/concepts/#alerting-rules)'s limits.
