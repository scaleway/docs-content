...
This page shows examples of functions in [Python](#python), [Node](#node),[Golang](#go), and [Rust](#rust) that can be used in your Serverless Functions projects, such as functions that allow you to:
