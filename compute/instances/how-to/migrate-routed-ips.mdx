...
* For Ubuntu and Dedbian Instances, you can use the following command:
    ```bash
    apt update scaleway-ecosystem cloud-init -y
    ```
* For CentOS and Fedora systems, you can use the following command:
    ```bash
    apt update scaleway-ecosystem cloud-init -y
    ```
