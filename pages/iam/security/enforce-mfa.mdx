...
[Multifactor Authentication (MFA)](/account/concepts/glossary/#multifactor-authentication-mfa) adds an extra layer of security to your Organization. Enforcing MFA will make it mandatory for all users in the Organization.
...
5. Type **ENFORCE** in the box.
    ...
    - If MFA is enforced in your Organization, all new [Members](/iam/concepts/glossary/#member) you create will have to enable MFA within the [grace period](/iam/concepts/glossary/#grace-period) you set. If they fail to do so before the grace period is over, their account will be locked. The same applies for existing members who do not yet have MFA enabled. Once you enforce MFA, they also have to comply with this [security requirement](/organizations-and-projects/organization/enforce-security-requirements-members/) within the grace period.
    </Message>
6. Click **Enforce MFA**.
