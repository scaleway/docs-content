...
Refer to the [Managing the default user's username and password](/managed-databases/redis/api-cli/configuring-user-permissions) documentation page to learn how.
