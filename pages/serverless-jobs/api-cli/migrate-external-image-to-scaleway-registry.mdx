...
4. Your image now appears in the [Container Registry section](https://account.scaleway.com/?service=elementsregistry/namespaces) of the Scaleway console, in the namespace specified above.
