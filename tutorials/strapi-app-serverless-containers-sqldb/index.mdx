...
You can either deploy your application:
  - [step by step using the Scaleway CLI](#deploy-strapi-headless-cms-using-scaleway-cli) to understand each detailed action performed, and the resources and subresources required
  - [using a Terraform template](#deploy-strapi-using-scaleway-terraform-templates) to deploy your application faster and have ready-to-use Infrastructure as Code.
