...
dates:
  ...
  posted: 2022-06-20
---
import image from './assets/scaleway-iam-owners-guests.webp'
import image2 from './assets/scaleway-iam-users-dashboard.webp'
import image3 from './assets/scaleway-guest-or-member.webp'
...
<Lightbox src={image} alt="a diagram shows the relationship between owners and Guests. Alice's Organization contains Alice as an owner and Bob as a Guest. Bob's Organization contains Alice and Charlie as Guests. Alice is an Owner in her Organization and a Guest in Bob's, and vice-versa" />
