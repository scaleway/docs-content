...
Any model served through Scaleway Generative APIs gets limited based by:
- Tokens per minute
- Queries per minute

Base limits apply if you registered a valid payment method and corresponds to [quotas for your organisation](https://www.scaleway.com/en/docs/organizations-and-projects/additional-content/organization-quotas/). This limits are increased automatically if you also validate your identity. 
