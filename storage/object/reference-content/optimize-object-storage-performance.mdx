...
Media and content distribution are often heavily affected by the physical distance between the host and the client, as objects are usually large in this scenario.
...
Leverage the different [storage classes](/storage/object/concepts/#storage-class) offered by Scaleway, and benchmark
