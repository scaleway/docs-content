...
This feature uses a [Write-Once-Read-Many (WORM)](/object-storage/concepts/#retention-period) data protection model, a standard requirement for regulatory compliance. You can configure object lock in [two distinct retention modes](/object-storage/how-to/object-lock/#retention-modes):
