...
<Message type="important">
  If you wish to change details pertaining to the identity of the owner (full name(s) of a natural person or corporate name for a legal entity) this must be done by the [change of ownership process](/dedibox-console/domains/how-to/change-ownership)
</Message>
...
<Navigation title="See Also">
  <PreviousButton to="/dedibox-console/domains/how-to/change-ownership/">How to change the ownership of a domain</PreviousButton>
  <NextButton to="/dedibox-console/domains/how-to/validate-waps-info/">How to validate WAPS information</NextButton>
</Navigation>
