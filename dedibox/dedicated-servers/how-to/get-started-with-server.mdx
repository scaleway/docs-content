...
If you prefer a graphical interface, you can install a desktop-oriented distribution and connect using the X2Go Client. For more information, refer to our [guide on connecting via Windows Remote Desktop](/dedibox/dedicated-servers/how-to/connect-to-server/#connecting-via-remote-desktop).
