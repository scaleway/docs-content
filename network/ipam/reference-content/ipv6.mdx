...
Full information on IPv6 with Dedibox can be found in our [dedicated documentation](/ipv6/), or you can read more in our [blog post](https://www.scaleway.com/en/blog/ipv6-the-future-proof-internet-protocol/#ipv6-at-scaleway-dedibox).
