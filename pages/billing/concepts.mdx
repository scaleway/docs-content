...
The Billing Alerts functionality within the [Scaleway console](https://account.scaleway.com/?service=elements) allows users to oversee and control their expenses efficiently. This feature allows you to create alerts that notify [users](/iam/concepts/#user) when predefined budget thresholds are met. Your alerts can be seamlessly delivered through SMS, email, or API webhook channels.
...
Consists of information about the Organization that will be billed. They will appear on the invoice and can be modified on the Scaleway console. Find out more about [how to read an invoice](/billing/faq/#how-to-read-my-invoice).
