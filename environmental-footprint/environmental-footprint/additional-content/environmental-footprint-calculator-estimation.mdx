...
The estimation is represented by three green leaf icons:
  ...
  - When the three leaves are dark green, this means that the AZ has the lowest quantity of CO2e emitted per kW consumed, so each kw consumed in you elastic metal will have a lower impact.
