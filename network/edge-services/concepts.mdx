...
You can create an Edge Services pipelines for each of your Object Storage buckets  or Load Balancer origins. Note that the cache can be enabled and disabled at will, so is an optional part of the pipeline, as is the customization of the endpoint.
