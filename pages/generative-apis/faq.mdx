...
We cannot communicate publicly on planned new models before they are released.
...
If you require a specific model, please upvote existing [Feature Request](https://feature-request.scaleway.com/) or create a new one.
