...
4. Complete the following steps in the wizard:
    ...
    - Choose your storage type and capacity. Two types of storage are available:
        - **Block Storage**: This storage type works like Block Storage Legacy, while providing lower latency and high resiliency through 5k or 15k IOPS. You can increase your volume up to 15 TB.
