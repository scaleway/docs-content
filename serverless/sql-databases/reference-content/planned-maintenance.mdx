...
The maintenance operations particularly concern our [connection pooler](/sql-databases/reference-content/serverless-sql-databases-overview/) for now, as we are working on making it as transparent as possible in future Serverless SQL Databases updates.
