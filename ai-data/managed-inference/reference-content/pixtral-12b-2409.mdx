...
- Pixtral allows to process real world and high resolution images, unlocking capacities such as transcribing handwritten files or payment receipts, extracting information from graphs, captioning images...
...
1. Image URLs
If the image is available online, you can just include the image URL in your request as demonstrated above. This approach is simple and doesn't require any encoding.
