...
excerpt: |
  This page shows how to configure a remote desktop environment with xfce and xrdp on Ubuntu Bionic Beaver (18.04 LTS)
totalTime: PT30M
steps:
...
keywords: cloud tutorials, cloud documentations, cloud server, cloud hosting, ubuntu server, debian server, linux server, IAAS, scalability, cloud, cluster, clustering, placement, instance, cloud instance, remote desktop, rdp, xrdp, cloud desktop
dates:
