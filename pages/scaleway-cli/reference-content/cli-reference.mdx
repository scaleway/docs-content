...
| Product                         | Page                  |
| ------------------------------- | --------------------- |
| Instances                       | [Scaleway Instances CLI cheatsheet](/instances/api-cli/cli-cheatsheet/) |
| Instances                       | [Using cloud-init with Scaleway API and CLI](/instances/api-cli/using-cloud-init/) |
