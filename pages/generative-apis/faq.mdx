...
- For **Preview** models, characteristics may change, in order to benefit from the latest optimizations (tokens throughput, latency, availability...) while maintaining good accuracy for most use cases.
