---
meta:
  title: Understanding the differences between ARM vs. x86 Instances
  description: Learn more about the architectural differences between x86 and ARM
content:
  h1: Understanding the differences between ARM vs. x86 Instances
...
The decision between ARM and x86 Instances is often not straightforward and is depending on various factors, including the specific application workload, energy efficiency objectives, and software ecosystem prerequisites.
