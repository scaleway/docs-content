...
<Navigation title="See Also">
  <PreviousButton to="/managed-database/postgresql-and-mysql/how-to/connect-database-private-network/">Connect a database to a Private Network</PreviousButton>
</Navigation>
