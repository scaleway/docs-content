...
2. Select the [principal](/identity-and-access-management/iam/concepts/#principal) to connect to the database:
    ...
    - or an [IAM application](/identity-and-access-management/iam/concepts/#application) that you [previously created](/identity-and-access-management/iam/how-to/create-application/) in the IAM section of the console.
    <Message type="note">
