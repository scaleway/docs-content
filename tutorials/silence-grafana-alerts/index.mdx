...
content:
  h1: Silencing Cockpit alerts in Grafana
  paragraph: Learn how to temporarily mute Cockpit alerts in Grafana using silences without disabling them.
...
3. Click **Alerting**, then click **Silences**. Make sure that **Scaleway Alerting** is selected in the **Choose Alertmanager** drop-down.
...
8. Enter a label to match your silence with the alert you want to target. Optionally, click **+ Add matcher** to add more. The alert affected by this silence should display.
    ...
    <Lightbox src="scaleway-silenced-alert.webp" alt="Silence configuration for the high CPU usage Grafana alert. The time range of the silence is of a week starting from June 16th" />
...
10. Click **Save silence** to confirm. Your silence displays in the list.
    <Message type="tip">
     ...
     <Lightbox src="scaleway-unsilence-button.webp" alt="Grafana Silences page with an active silence and the Unsilence button highlighted." />
