...
A subscription is a connection between a client or endpoint, and a topic. By creating a subscription, the subscribed endpoint receives messages and notifications published to the topic. You can set up your subscriptions in the Scaleway [console](https://console.scaleway.com), for HTTP/S endpoints or Scaleway Serverless [Functions](/serverless/functions/quickstart/) or [Containers](/serverless/containers/quickstart/).
