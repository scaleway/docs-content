---
title: Migrating MySQL databases to a Managed Database for PostgreSQL using pgLoader
...
excerpt: |
  This page shows you how to migrate an existing MySQL database to a managed PostgreSQL database using pgLoader
totalTime: PT15M
steps:
  - step: Setting up pgLoader
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/migrate-mysql-databases-postgresql-pgloader//#Setting-up-pgLoader
  - step: Migrating your database
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/migrate-mysql-databases-postgresql-pgloader/#Migrating-your-database
categories:
  - storage
  - database
...
[pgLoader](https://pgloader.io/) is an open-source database migration tool developed to simplify the process of migrating an existing database from one database engine to [PostgreSQL](https://www.postgresql.org/).  
...
In this tutorial you will learn how to migrate from an existing remote MySQL database to a [Managed Database for PostgreSQL](https://www.scaleway.com/en/database/) using an intermediate [Development Instance](https://www.scaleway.com/en/virtual-instances/development/) running Ubuntu Bionic Beaver.
...
- You have an existing MySQL database.
