...
7. In the same terminal, run the following command.
        ...
        ```
        ts=2026-06-27T14:23:05.542081Z level=info msg="now listening for http traffic" service=http addr=127.0.0.1:12345
        ts=2026-06-27T14:23:13.432896Z level=info msg="Done replaying WAL" component_path=/ component_id=prometheus.remote_write.cockpit subcomponent=rw remote_name=aa0551 url=https://xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx.metrics.cockpit.fr-par.scw.cloud/api/v1/push duration=12.900498616s
        ```
