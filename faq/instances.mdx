...
*All regions include `PAR1`, `PAR2`, `AMS1`, `AMS2`, `AMS3`, `WAW1`and `WAW2`. `PAR3` prices are shown separately. 
...
*All regions include `PAR1`, `PAR2`, `AMS1`, `AMS2`, `AMS3`, `WAW1` and `WAW3`. `PAR3` prices are shown separately.
