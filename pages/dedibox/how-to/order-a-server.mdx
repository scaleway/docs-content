...
<Message type="tip">
  You can order Dedibox servers also using the [Scaleway console](/dedibox-scaleway/how-to/order-dedibox/) to profit from the whole Scaleway ecosystem and the latest console.
</Message>
