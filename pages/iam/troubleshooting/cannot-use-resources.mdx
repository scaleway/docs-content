...
You (or the IAM [user](/iam/concepts/glossary/#user) or [application](/iam/concepts/glossary/#application)) may not have the correct appropriate [IAM permissions](/iam/policies-permissions/view-permission-sets/) to perform the desired actions.
...
3. If you **do not** have [Owner](/iam/concepts/glossary/#owner) status for the Organization in which you are trying to perform actions, contact the IAM manager or owner of this Organization.
