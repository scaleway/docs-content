...
Domain Name System (DNS) is a domain name management service that allows you to avoid browsing the Internet only by IP. It provides human management of addressable resources on the Internet. It is possible to create zones and records to manage a sub-domain (e.g,: `test.mydomain.com`) or specific configurations such as the MX of your mailbox.
