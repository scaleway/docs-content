...
<Message type="requirement">
  ...
  - You have [created an Elastic Metal server](/bare-metal/elastic-metal/how-to/create-server)
</Message>
...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/elastic-metal/how-to/install-server/">How to install a server</PreviousButton>
  <NextButton to="/bare-metal/elastic-metal/how-to/order-flexible-ip/">How to order a flexible IP</NextButton>
</Navigation>
