...
excerpt: |
  Zammad is a an open-source helpdesk system with features to manage customer communication via several channels including telephone, Facebook, Twitter, chat and e-mails.
totalTime: PT20M
steps:
...
categories:
  - compute
  - instances
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, zmmad, helpdesk, tickets, email, sms, facbook, twitter
dates:
