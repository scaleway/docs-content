...
* In Scaleway Instances, the first NIC (e.g. `eth0`) must be associated to the public network and need to be configured (For example using: Cloud-init, DHCP, and others.)
