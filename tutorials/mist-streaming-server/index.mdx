...
1. Open a web browser and point it to `http://your.instance.ip.address:4242/` (replace `your.instance.ip.address` with the IP of your Virtual Instance).
...
6. Enter the details of the new stream and click **Save** once everything is set:
  ...
  <Lightbox src="scaleway-mistserver_05.png" alt="" />
    ...
    - **Source:** Enter the source of the stream. You can either stream local files from your Virtual Instance. Choose the content by clicking on **Browse**. To stream a live stream, enter the IP address of the source in the text box, i.e. `play://51.15.123.231`.
...
3. Configure the streaming server in OBS Studio by clicking on **Settings** -> **Stream**
  ...
  <Lightbox src="scaleway-obs_settings.png" alt="" />
    ...
    - **Server** Enter the stream URL of your Virtual Instance, for example: `rtmp://51.15.123.222/live`
...
You can now start streaming your video content directly using your Virtual Instance. To learn more about MistServer, refer to the [official documentation](https://mistserver.org/guides/latest).
