...
excerpt: |
  In this tutorial you will learn to host your own GitHub runner on a Virtual Instance.
totalTime: PT20M
steps:
...
brands: 
  - elements
permalink: docs/how-to-host-github-runners-on-scaleway-virtual-instances/
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, github, git, github runners, self-hosted, virtual, virtual instance, ubuntu
dates:
