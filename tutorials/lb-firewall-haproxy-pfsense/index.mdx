...
The installation of pfSense is done using the [KVM-over-IP device](/compute/bare-metal-cloud/how-to/install-server-from-kvm/) of the Bare Metal server or the Scaleway Dedibox.

</Message>

1. Connect to the [KVM-over-IP device](/compute/bare-metal-cloud/how-to/install-server-from-kvm/) of your Bare Metal server or Scaleway Dedibox.
