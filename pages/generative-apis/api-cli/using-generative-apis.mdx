...
- A valid [API key](/iam/credentials/create-api-keys/) is needed.
...
Permissions define the actions a user or an application can perform on Scaleway Generative APIs. They are managed using Scaleway’s [Identity and Access Management](/iam/concepts/quickstart/) interface.

[Owner](/iam/concepts/glossary/#owner) status or certain [IAM permissions](/iam/concepts/glossary/#permission) allow you to perform actions in the intended Organization.

Querying AI models hosted by Scaleway Generative APIs will require any of the following [permission sets](/iam/concepts/glossary/#permission-set):
...
You can scope your Generative APIs consumption to a [Project](/iam/concepts/glossary/#project). This is helpful to restrict IAM users’ access to only the Project they are working on, or to isolate your bills between Projects.
