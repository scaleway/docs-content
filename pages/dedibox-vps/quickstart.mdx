...
7. Optionally, paste an [SSH key](/iam/security/create-ssh-key/#how-to-upload-the-public-ssh-key-to-the-scaleway-interface) for authentication.
...
1. Access your list of virtual machines by clicking **Dedibox VPS** within the [Dedibox console](https://console.online.net/en/login).
