...
- [Created](/dedicated-servers/how-to/order-a-server/) a Dedibox server and [installed Debian](/dedicated-servers/how-to/install-a-server/) on it
- [Connected](/dedicated-servers/how-to/connect-to-server/#connecting-via-ssh) to your Dedibox via SSH as `root`
