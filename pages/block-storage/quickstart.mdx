...
1. Click **Block Storage** in the **Storage** section of the [Scaleway console](https://account.scaleway.com/?service=elements) side menu. The Block Storage page displays.
...
1. Click **Block Storage** in the **Storage** section of the [Scaleway console](https://account.scaleway.com/?service=elements) side menu. Your volumes display.
