...
<Message type="tip">
You can also use the integrated Scaleway console CLI by clicking the button at the top of the [Scaleway console](https://account.scaleway.com/?service=elements).
</Message>
...
2. The following message displays:
    ...
    Enter your [API secret Key](/iam/how-to/create-api-keys/).
...
3. The following message displays:
    ...
    Enter your [API access key](/iam/how-to/create-api-keys/).
