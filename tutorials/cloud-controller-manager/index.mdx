...
You have successfully deployed a cluster with `kubeadm` and the `scaleway-cloud-controlle-manager`. 
To learn more about the function of a [Cloud Controller Manager](https://kubernetes.io/docs/tasks/administer-cluster/running-cloud-controller/) within Kubernetes refer to the official documentation. 
For more information about the Scaleway Cloud Controller Manager, follow the project on [GitHub](https://github.com/scaleway/scaleway-cloud-controller-manager).