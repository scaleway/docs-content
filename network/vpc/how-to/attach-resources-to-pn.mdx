...
If you don't see an IP address in the screens above for your resource and you think you should, check out our [troubleshooting](/network/vpc/troubleshooting/resource-attached-no-ip/) guide. <br /> <br />
