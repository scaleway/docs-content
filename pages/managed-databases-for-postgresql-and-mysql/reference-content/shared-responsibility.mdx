---
title: Shared responsibility model in Managed Databases for PostgreSQL and MySQL
...
This page covers essential security principles and best practices for developping reliable applications with Managed Databases for PostgreSQL and MySQL.
