...
3. During installation, you are prompted which MySQL product you want to install. You can keep the default configuration (MySQL 8 Server). Confirm by pressing OK.
