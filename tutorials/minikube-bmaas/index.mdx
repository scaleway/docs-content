---
meta:
  title: Setting up Kubernetes with Minikube on a Bare Metal Server
  description: This page shows how set up a Kubernetes cluster with Minikube on a Bare Metal Server
content:
  h1: Setting up Kubernetes with Minikube on a Bare Metal Server
  paragraph: This page shows how set up a Kubernetes cluster with Minikube on a Bare Metal Server
steps:
  - step: Downloading and Installing Minikube
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/minikube-bmaas/#-Downloading-and-Installing-Minikube
  - step: Using Minikube
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/minikube-bmaas/#-Using-Minikube
categories:
  - compute
  - bare-metal
tags: compute Kubernetes Minikube server Bare-Metal-server
...
- You have created a [Bare Metal server](/compute/bare-metal-cloud/how-to/create-server/) which is running Ubuntu Bionic Beaver (18.04).
...
7. Download and install `kubectl`, a [CLI tool](https://kubernetes.io/docs/reference/kubectl/overview/) to manage Kubernetes:
