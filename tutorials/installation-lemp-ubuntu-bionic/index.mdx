...
content:
  ...
  paragraph: Discover how to install the LEMP Stack (Linux, Nginx, MySQL, PHP) on an Ubuntu-based Scaleway Instance. Follow our detailed, step-by-step guide to set up this powerful web server environment efficiently.
