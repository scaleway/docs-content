...
meta:
  ...
  description: This page explains how to delete an Object Storage bucket.
content:
  h1: How to delete a bucket
  paragraph: This page explains how to delete an Object Storage bucket.
...
5. If you understand and agree to the conditions, type **DELETE** in the box and click **Delete bucket**.
    <Lightbox src="scaleway-delete-bucket-popup.webp" alt="" />

    <Message type="important">
     Files bigger than 1 GB might take longer to be effectively deleted.
    </Message>
