...
OS Level Isolation - Faster cold start but some incompatibility, ideal for API development or web application, works for most workloads.
...
GVisor Compatibility
    ...
    Application compatibility with GVisor: https://gvisor.dev/docs/user_guide/compatibility/

Refer to the [official GVisor documentation](https://gvisor.dev/docs/) for more information.

## Kata Container	

VM Level Isolation - Higher cold start, full linux compatibility, better if you need specific system librairies or perform network intensive tasks, not recommended for lower tiers (less than 1 vCPU).
