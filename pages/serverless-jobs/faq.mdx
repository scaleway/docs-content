...
### Can I whitelist the IPs of my Serverless Jobs?

Due to the nature of serverless computing, Serverless Jobs do not have dedicated or predictable IP addresses assigned to them. This means you cannot whitelist specific IPs for your Serverless Jobs.
