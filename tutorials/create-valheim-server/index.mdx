---
title: How to create a Valheim server with Scaleway Elements
description: In this tutorial you will learn how to create your own Valheim server with Scaleway Elements Virtual Instances. We offer a large range of instances that will suits your gaming needs for your Valheim server.
tags: compute image gameserver game play valheim valheim-server
image: /assets/scaleway_valheim.png
excerpt: |
  In this tutorial you will learn how to create your own Valheim server with Scaleway Elements Virtual Instances. We offer a large range of instances that will suits your gaming needs for your Valheim server.
totalTime: PT20M
steps:
  - step: Deploying a Virtual Instance
    type: HowToStep
...
categories: 
  - compute
  - instances
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, valheim, valheim game, valheim download, valheim server, game server, gameserver, online game, self-hosted
---
...
<Lightbox src="scaleway-valheim-logo.png" alt="" />

At Scaleway, we offer a large range of instances that will suit the gaming needs of your Valheim server. In this tutorial you will learn how to create your own Valheim server with Scaleway Elements Virtual Instances. 
...
## Deploying a Virtual Instance

1. Click **Instances** in the **Compute** section of the Scaleway Console side menu. 

2. Click on **Create an Instance** and enter the required information for your Virtual Instance: 
    * The **Availability Zone** is the geographical region in which your Virtual Instance will be deployed. In this tutorial, we use `FR-PAR2`, but you can choose the one closest to your location. 
...
1. Log into your Virtual Instance using [SSH](/compute/instances/how(to/connect-to-instance). 
...
You have now configured your own Valheim server on a Scaleway Virtual Instance, installed basic protection through UFW and are ready to invite your friends to explore the different worlds of Valheim. For more information about the game, refer to the official [Valheim website](https://www.valheimgame.com/).
