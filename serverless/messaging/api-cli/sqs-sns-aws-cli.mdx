...
- Have [activated SQS/SNS](/serverless/messaging/how-to/get-started/#how-to-activate-sqs-or-sns)
- Valid [credentials](/serverless/messaging/how-to/create-credentials/) for SQS/SNS
- Have [connected SQS/SNS to the AWS-CLI](/serverless/messaging/api-cli/connect-aws-cli/)
- Have [jq](https://stedolan.github.io/jq/download/) installed on your machine
