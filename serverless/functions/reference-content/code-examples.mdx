...
<Message type="tip">
  Many more examples using Serverless Functions and Serverless Containers can be found in our [Serverless Examples repository](https://github.com/scaleway/serverless-examples).
</Message>
...
The examples shown here include:
  ...
  - Using the event and context passed to your functions
...
```
<Message type="note">
  If you want to use other libraries like `request`, you need to upload your project [with advanced methods](/serverless/functions/reference-content/deploy-function/) (recommended)
