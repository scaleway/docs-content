...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/hardware/reference-content/dell-idrac7/">How to use DELL iDRAC 7</PreviousButton>
  <NextButton to="/bare-metal/hardware/reference-content/dell-idrac9/">How to use DELL iDRAC 9</NextButton>
</Navigation>