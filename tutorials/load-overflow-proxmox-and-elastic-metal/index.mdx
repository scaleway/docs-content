...
1. Go to the [Load Balancers](https://account.scaleway.com/?service=elementsload-balancer/lbs/) section in the Scaleway console and select the Load Balancer you want to configure.
