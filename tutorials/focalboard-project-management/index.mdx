...
meta:
  ...
  description: This page shows how to set up a Focalboard project-management tool on Cost-Optimized Instances running Ubuntu Linux
content:
  h1: Project management for technical teams with Focalboard on Ubuntu Instances
  paragraph: This page shows how to set up a Focalboard project-management tool on Cost-Optimized Instances running Ubuntu Linux
