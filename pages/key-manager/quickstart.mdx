...
4. Choose a [key storage option](/key-manager/faq/#what-is-the-difference-between-a-software-protected-key-and-an-hsm-backed-key):
...
6. Select the [encryption method](/key-manager/concepts/#encryption-method) for your key.
...
8. Click **Create key**. The **Overview** page of your key displays.
