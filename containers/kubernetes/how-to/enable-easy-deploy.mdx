...
<Navigation title="See Also">
  ...
  <NextButton to="/containers/kubernetes/how-to/monitor-cluster/">How to monitor a Kubernetes Kapsule cluster with Cockpit</NextButton>
</Navigation>
