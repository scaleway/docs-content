...
This page shows an example of connecting to Scaleway's object storage using the AWS SDK and Python or Node.

<Message type="requirement">

  - You have an account and are logged into the [Scaleway Console](https://console.scaleway.com)
  - You have created a [Functions namespace](/compute/functions/how-to/create-a-functions-namespace/)
  - You have uploaded a function using the serverless framework or by using a [ZIP file](/compute/functions/how-to/package-function-in-zip/)
...
We are going to use the AWS SDK for Python (boto3) in the following steps. [Learn more about boto3.](/storage/object/api-cli/object-storage-aws-cli/)
...
2. Write your code.
    ...
    * Write a new bucket object:
    ...
    ```
3. Push your code to Serverless Function using a zip-file or the serverless framework (the latter is recommended).
    * Don not forget to add the following environment variables:
        * `ACCESS_KEY_ID`
        * `ACCESS_KEY`
        * `BUCKET_NAME`
        * `REGION`
...
We use the NodeJS aws-sdk library to push a file to an Object storage bucket using the S3 protocol.
