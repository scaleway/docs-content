...
description: Discover how to manage your Scaleway Elements Database Instances with pgAdmin 4 from an easy-to-use web interface
tags: database postgresql sql postgre
keywords: cloud tutorials, cloud documentations, database, postgresql, pgsql
excerpt: |
  pgAdmin is an open-source management tool for PostgreSQL databases. It allows the management of databases through an easy-to-use web-interface within your web browser.
totalTime: PT10M
steps:
  - step: Installing pgAdmin
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/manage-database-instance-pgadmin4/#Installing-pgAdmin
  - step: Configuring pgAdmin
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/manage-database-instance-pgadmin4/#Configuring-pgAdmin
categories:
  - compute
  - storage
...
[pgAdmin](https://www.pgadmin.org/) is an open-source management tool for PostgreSQL databases. It allows the management of your [Scaleway Elements Database Instances](https://www.scaleway.com/en/database/) and other PostgreSQL databases through an easy-to-use web-interface within your web browser.
...
6. During the installation, you are prompted to enter the email address of the first user for pgAdmin. Enter your email address and press **Enter**:
  <Lightbox src="scaleway-pgadmin_install_email.png" alt="" />

7. The installation tool asks for a password for the pgAdmin user. Enter it and press **Enter**:
  <Lightbox src="scaleway-pgadmin_install_password.png" alt="" />
...
<Lightbox src="scaleway-pgadmin_login.png" alt="" />

2. Enter the username and password configured during the installation and click **Login**

3. The pgAdmin dashboard displays, to connect the application with your Scaleway Elements Database Instance, click **Add New Server**:
<Lightbox src="scaleway-pgadmin_dashboard.png" alt="" />

4. Specify the general information of the Database Instance:
  <Lightbox src="scaleway-pgadmin_create_general.png" alt="" />
...
<Lightbox src="scaleway-pgadmin_create_connection.png" alt="" />
...
<Lightbox src="scaleway-pgadmin_create_ssl.png" alt="" />
...
<Lightbox src="scaleway-pgadmin_dashboard_connected.png" alt="" />
