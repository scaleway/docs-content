...
1. Log in to your [Dedibox console](https://console.online.net/en/login) account and locate **Dedibox VPS** in the top navigation menu. Click it to access the list of your Dedibox VPS.
