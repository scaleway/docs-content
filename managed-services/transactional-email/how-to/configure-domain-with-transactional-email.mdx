...
When you use a domain name regsitered with [Scaleway Domains and DNS]() you can benefit from DNS autoconfiguration. We can automatically configure SPF, DKIM, DMARC, MX on your behalf so 
...
5. Tick the checkbox to confirm that you agree to Scaleway's antispam policy, then click **Validate domain name**
...
4. Tick the checkbox to confirm that you agree to Scaleway's antispam policy, then **Validate domain name** to confirm.
