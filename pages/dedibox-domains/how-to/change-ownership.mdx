...
import image from './assets/scaleway-trade-domain.webp'
import image2 from './assets/scaleway-trade-domain-2.webp'
...
5. Select the identifier of the new owner, searching for it via the account identifier if necessary, and click **Confirm**.
  <Lightbox image={image2} alt="" />
    <Message type="important">
      This identifier is the unique ID of the new owner account, **not** your personal user ID.  
      You can find it on the [outsourcing page](https://console.online.net/en/account/outsourcing/requests/) in the Dedibox console of the recipient account.
