...
* **Auto-scaling (soon!)**: Scaleway LLM Inference automatically scales your instances based on the demand, ensuring that your models are always available and responsive.

<Message type="important">
  This service is in private beta. [Specific Terms and Conditions](https://www.scaleway.com/en/contracts/) are applicable.
</Message>
...
5. Configure the **network** settings for the deployment:
    ...
    - Enable **Public Network** to access resources via the public Internet. A token protection is enabled by default.
    <Message type="important">
...
<Message type="important">
  Deleting a deployment is a permanent action, erasing all its associated configuration and resources.
</Message>
