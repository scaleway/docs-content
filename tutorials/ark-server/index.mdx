...
steps:
  ...
  - step: Why should I start an ARK server?
    type: HowToStep
    url: https://www.scaleway.com/en/docs/ark-server/#-Why-should-I-start-an-ARK-server
  - step: How can I create an ARK server?
    type: HowToStep
    url: https://www.scaleway.com/en/docs/ark-server/#-How-can-I-create-an-ARK-server
  - step: How can I connect to my ARK server?
    type: HowToStep
    url: https://www.scaleway.com/en/docs/ark-server/#-How-can-I-connect-to-my-ARK-server
categories:
  - compute
  - instances
image: /assets/scaleway_arkserver.webp
dates:
  validation: 2021-11-23
  posted: 2020-11-10
---
