...
7. Open the VMkernel NIC configuration file in a text editor:
    ...
    vi vmknics.json
    ```
8. Replace the MAC address of your RPN VMkernel NIC with your [Virtual MAC](/bare-metal/network/reference-content/create-virtual-mac/).
...
13. Run the following command to add the RPN route:
    ...
    <Message type="tip"> 
      You can find the RPN gateway either on your server's overview page in the Dedibox console or by following [this guide](//bare-metal/dedibox/how-to/activate-ipv6-block/).
    </Message>
...
3. Add the server(s) you want to permit to access your SAN services in the list. Optionally you can add RPN subnet IPs. Please note that if you use RPNv2, an [additional configuration](/bare-metal/network/reference-content/find-rpn-gateway/)  is required to access the RPN-SAN.
    <Message type="note">
...
<Message type="important">
  To proceed with these steps, you need to configure at least one [failover IP](/bare-metal/dedibox/how-to/configure-failover-ip/) with an associated [virtual MAC address](/bare-metal/network/reference-content/create-virtual-mac/). If you have not yet configured it, go to your [Dedibox Console](https://console.online.net) before proceeding.
</Message>
