...
3. Complete the following steps in the wizard:
    ...
    - Add a **cron schedule** in the `* * * * *` format, and select your time zone to run your job periodically. Refer to the [cron schedules documentation](/jobs/reference-content/cron-schedules/) for more information.
    ...
    - Add the desired [secret references](/jobs/how-to/reference-secret-in-job/) to your job.
...
<Message type="note">
  Refer to [How to monitor a job](/jobs/how-to/monitor-job/) to see the logs of the job you just executed.
</Message>
...
3. Complete the following steps in the wizard:
    ...
    - Select the region in which your job will be created.
    - Choose the **resources** to be allocated to your job at runtime. These define the performance characteristics of your job.
    - Optionally, add a **cron schedule** in the `* * * * *` format, and select your time zone to run your job periodically. Refer to the [cron schedules documentation](/jobs/reference-content/cron-schedules/) for more information.
    - Define any **environment variables** you want to inject into your job in the advanced options. For each environment variable, click **+Add new variable** and enter the key/value pair.
        <Message type="note">
        Encode your environment variables to `base64` if they are too large, and contain carriage returns.
        </Message>
