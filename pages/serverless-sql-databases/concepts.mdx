...
meta:
  ...
  description: Detailed explanation of concepts and architecture behind Scaleway's serverless SQL databases.
content:
...
Credentials are the login and password (also called "username" and "password" in PostgreSQL vocabulary) used by a user, or an application to connect to a database. With Scaleway Serverless SQL Databases, logins are [IAM principal IDs](/iam/concepts/#principal) and passwords are [IAM secret keys](/iam/concepts/#api-key).
