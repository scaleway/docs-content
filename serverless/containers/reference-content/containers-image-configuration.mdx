...
* **Token and access management**: You can configure a token through the [Scaleway Console](/serverless/containers/how-to/create-auth-token-from-console) or  the [API](https://developers.scaleway.com/en/products/containers/api/#tokens-management). Token validation is handled by our service.
