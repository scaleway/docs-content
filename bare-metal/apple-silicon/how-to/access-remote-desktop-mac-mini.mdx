...
| RealVNC                  | All           | 〰️ (some issues)                | ❌ (not with free version) | ❌ (manual tunnel, data unencrypted with free version) | ❌                        | ⭐ (not recommended)                |
| Remmina                  | Linux         | ✅ (manual, only from local to server) | ❌                    | ❌ (manual tunnel)                    | ❌                        | ⭐ ⭐                   |
| Devolutions remote desktop Manager | All           | ✅                            | ❌                    | ✅ (requires additional setup - SSH tunnel)    | ❌                        | ⭐ ⭐                   |
