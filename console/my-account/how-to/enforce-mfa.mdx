...
6. Click **Enforce MFA**.
    ...
    <Message type="important">
      ...
      Users who are new to Scaleway must follow the [procedure to activate a new account after being invited to an Organization with enforced MFA](/console/my-account/how-to/accept-invitation-new-scw-account).
    </Message>
