...
This page shows you how to configure a basic [DMARC record](/transactional-email/concepts/#dmarc-record) on your domain.
...
For more information about DMARC configuration and examples of DMARC records you can configure, refer to the [dedicated documentation](/transactional-email/reference-content/dmarc-configuration/).
...
6. Confirm the changes and add the DMARC record.
    ...
    <Message type="tip">
     If you have a domain at Scaleway Domains and DNS, you can access your account from the Scaleway [console](https://account.scaleway.com/?service=elements), click **Domains and DNS** > **Your domain** > **DNS Zones**, then add a record in the same zone as your Transactional Email's domain.
    </Message>
