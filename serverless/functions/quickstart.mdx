...
<Message type="tip">
  This page explains how to deploy a functions using Scaleway Console but for advanced usage (ex: larger project with dependencies, automation, multiple functions...) [several ways to deploy functions](/serverless/functions/reference-content/deploy-function/) are available.
