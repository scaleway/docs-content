...
You can carry out actions on Scaleway Object Storage resources either via the [Scaleway console](https://account.scaleway.com/?service=elements), or via a third-party API or CLI, such as [the AWS CLI](/object-storage/api-cli/object-storage-aws-cli/), [MinIOClient](/object-storage/api-cli/installing-minio-client/) or [Rclone](/object-storage/api-cli/installing-rclone/).
...
From the [API key list](https://account.scaleway.com/?service=elementsiam/api-keys), click on <Icon name="more"/> icon to the right of the API key you want to edit, and select *Edit** from the menu. A pop-up displays, and you can choose a new preferred project for Object Storage for this API key
...
8. Go to the [Scaleway console](https://account.scaleway.com/?service=elementsobject-storage/buckets) in your browser, click **Object Storage** in the side menu, and ensure you are on the **default** Project. The bucket you just created with the IAM application's API key appears in the list of buckets.
...
2. From the [Project Dashboard](https://account.scaleway.com/?service=elementsproject/settings), ensure you are in `my-second-project`, and copy the Project ID.
...
6. Go to the [Scaleway console](https://account.scaleway.com/?service=elementsobject-storage/buckets) in your browser, click **Object Storage** in the side menu, and ensure you are on **my-second-project**. The bucket you just created with the IAM application's API key appears in the list of buckets.