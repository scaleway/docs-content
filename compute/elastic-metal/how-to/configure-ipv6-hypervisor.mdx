...
<Message type="requirement">
  ...
  - You have an account and are logged into the [Scaleway console](https://console.scaleway.co/m)
  ...
  - You have ordered a [flexible IPv6](/compute/elastic-metal/how-to/order-fleible-ip/)
  - You have generated a [virtual MAC address](/dedibox-network/ip-failover/concepts/#virtual-mac-address)

</Message>

When you install your server with a virtualization solution like VMware vSphere Hypervisor (ESXi) or Proxmox you can create multiple virtual machines on the physical server and configure them to use fleible IPv6 addresses.
