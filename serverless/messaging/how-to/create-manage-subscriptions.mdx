...
4. Click **create subscription**. The subscription creation wizard displays:
    ...
    <Lightbox src="scaleway-create-subscription.webp" alt="" /> TODO CHECK
...
1. Access the subscription's **Settings** page (from the console side menu, **Serverless** > **Topics and Events** > **Topics**, click the topic containing the subscription, then click the subscription).

2. Click the **Confirm Subscription** button at the top right of the page. A pop-up displays:

     <Lightbox src="scaleway-confirm-subscription.webp" alt="" /> TODO CHECK
