...
This tutorial covers the **PostgreSQL** database system. You can use a [Scaleway Database instance](https://account.scaleway.com/?service=elementsrdb/instances), or any other PostgreSQL instance publicly accessible.
...
You can use a [Scaleway Instance](https://account.scaleway.com/?service=elementsinstance/servers), or any other machine with a public IP address.
