...
<Message type="important">
  The monitoring feature is deprecated and **no longer available** from the Dedibox console. The monitoring feature is deprecated and **no longer available** from the Dedibox console. For advanced monitoring of your server, refer to Scaleway’s [Observability Cockpit](https://www.scaleway.com/en/cockpit/).
</Message>
