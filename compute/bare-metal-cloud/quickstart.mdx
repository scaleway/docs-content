---
layout: docs
title: Quickstart Bare Metal Cloud 
description: This page shows you how to get started with Scaleway Elements Bare Metal Servers.
excerpt: |
  Scaleway's Bare Metal Cloud Server offer provides 100% dedicated resources, combined with the advantages of the cloud, such as hourly billing and full flexibiliy. The servers’ hardware is 100% dedicated to you, there is no virtualization, no overallocation, no neighbours on your server.
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
...
keywords: bare metal, cloud computing, scaleway, baremetal, server, quickstart
dates:
  validation: 2021-05-26
  posted: 2021-05-26
---

Scaleway [Bare Metal Cloud Servers](/compute/bare-metal-cloud/concepts/#bare-metal-server) are dedicated physical servers that you can order on-demand, like cloud Instances. You can install an OS or other [image](/compute/bare-metal-cloud/concepts/#image) on your Bare Metal server and connect to it via SSH to use it as you require. You can power off the server when you're not using or, delete it from your account once you have finished with it. Bare Metal servers are ideal for large workloads, big data, and applications that require increased security and dedicated resources.
