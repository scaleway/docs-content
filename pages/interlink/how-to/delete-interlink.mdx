...
content:
  ...
  paragraph: Learn how to delete a Scaleway InterLink so that it is correctly deprovisioned on both the Scaleway side and (if relevant) the partner side. Follow our step by step guide.
dates:
...
5. Type **DELETE** in the box, and click **Delete InterLink**, and confirm when prompted.
