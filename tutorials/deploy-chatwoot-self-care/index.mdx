...
content:
  ...
  paragraph: Learn how to deploy the Chatwoot CRM on Scaleway Production-Optimized Instances with this comprehensive guide. Follow our step-by-step instructions to set up and optimize Chatwoot for seamless customer relationship management on Scaleway.
