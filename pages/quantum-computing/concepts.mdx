...
<Message type="tip">
  **Formula:** `Total Cost = (Nb_Circuits × Price_per_circuit) + (Nb_Circuits × Shots_per_circuit × Price_per_shot)`
</Message>

#### Example
If you submit **2 quantum circuits**, requesting accordingly **500 shots** and **1000 shots** for each circuit:
1. **Circuit Fees:** You pay the base fee for 2 circuits.
2. **Shot Fees:** You pay for 1500 shots (1 circuit × 500 shots + 1 circuit × 1000 shots).
