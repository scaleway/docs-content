...
content:
  h1: How to bootstrap a highly available infrastructure with round-robin DNS and HAproxy
  paragraph: This page shows how to configure round robin DNS and HAproxy to bootstrap a high available infrastructure.
steps:
