...
tags: compute messaging apache kafka bigdata
excerpt: |
...
totalTime: PT1H
steps:
  - step: What is a Messaging System?
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-apache-kafka/#-What-is-a-Messaging-System
  - step: Architecture of Apache Kafka
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-apache-kafka/#-Architecture-of-Apache-Kafka
  - step: Installing Kafka
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-apache-kafka/#-Installing-Kafka
  - step: Sending Messages
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-apache-kafka/#-Sending-Messages
  - step: Starting a Consumer
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-apache-kafka/#-Starting-a-Consumer
  - step: Starting a MultiBroker Cluster
    type: HowToStep
    url: https://www.scaleway.com/en/docs/configure-apache-kafka/#-Starting-a-MultiBroker-Cluster
  - step: Importing and Exporting Data with Kafka Connect
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-apache-kafka/#-Importing-and-Exporting-Data-with-Kafka-Connect
categories:
  - compute
  - kubernetes
  - instances
image: /assets/images/docs/scaleway.png
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, debian server, linux server, Object Storage, S3, IAAS, baremetal, scalability, ARM, physical server, dedicated server, physicalization, account, kafka, messaging, apache, bigdata
dates:
...
<Lightbox src="scaleway-schema-kafka.png" alt="" />
...
4. Start the first Kafka broker
