---
layout: docs
title: Bare Metal Cloud Concepts
...
An image is a file that contains the OS, application data, and any files that might be related to your applications. If you don’t know yet which image you want to run on the Bare Metal, you can order the server without preinstalled image.
