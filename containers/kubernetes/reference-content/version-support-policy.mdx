...
| 1.25               | August 2022      | October 2023         | February 1, 2023             | February 2025    | March 15, 2025    |
| 1.26               | December 2022    | February 2024        | February 1, 2023             | February 2025    | March 15, 2025    |
...
### Kubernetes v1.26
Starting from Kubernetes version 1.26 launch:
* Kubernetes Kapsule only supports **cilium** and **calico** as CNI.
* Kubernetes Kosmos only supports **kilo** as CNI.

| Interface | Deprecation |  Obsolete  |
|-----------|-------------|------------|
| Flannel   | from v1.25  | from v1.26 |
| Weave     | from v1.25  | from v1.26 |

* Migration policy:
  * Control Planes can not be upgraded on obsolete CNIs.
...
| Cri-o   | from v1.24  | from v.1.25 |

* Migration policies:
  * Pools using deprecated CRIs can not scale up.
  * Control Planes can not be upgraded if CRI used by any pool is obsolete.
  * *Recommended action:* Delete your old pools and create new ones with **containerd** as default, either via API or from the Scaleway console.
