...
These models are not accessible anymore from Generative APIs - Serverless. They can still however be deployed on [dedicated Generative APIs deployments](https://console.scaleway.com/generative-api/deployments).
