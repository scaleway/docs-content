...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/hardware/reference-content/dell-idrac6/">How to use DELL iDRAC 6</PreviousButton>
  <NextButton to="/bare-metal/hardware/reference-content/dell-idrac8/">How to use DELL iDRAC 8</NextButton>
</Navigation>