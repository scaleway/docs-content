...
---
Below is a list of Object Storage API actions authorized for each [permission set](/iam/policies-permissions/permission-sets/). Actions that are not explicitly authorized in a permission set are denied by default.
