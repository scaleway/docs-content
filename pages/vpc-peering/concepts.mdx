...
Scaleway VPC provides managed DNS resolution for resources attached to a Private Network, letting you address resources by hostname rather than IP. [Read more about VPC DNS](/vpc/reference-content/dns/).
