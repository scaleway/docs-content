...
- Created an [SSH key](/iam/security/create-ssh-key/)
...
2. Unless you want to change your configuration, type `n` and go directly to the [Creating an Instance](#creating-an-instance) step of this tutorial.
    ...
    ```
3. Enter either the email address for your account (you will then be asked for your password), or your [API secret key](/iam/security/create-ssh-key/):
    ```
...
<Message type="important">
  This action will delete all your volumes and data located on your Instance. To prevent data loss, we recommend performing regular snapshots.
</Message>
