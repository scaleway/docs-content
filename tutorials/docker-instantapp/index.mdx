...
Docker is an open source containerization platform. It allows developers to package their applications into containers, using OS-level virtualization. This page shows you how to create an Instance with Docker preinstalled using the Docker [InstantApp](/compute/instances/concepts/#instantapp), and then how to start using Docker for your containerization projects.
...
4. Open a text editor, copy and paste the following content, and save the file as `app.py`:
    ```py
