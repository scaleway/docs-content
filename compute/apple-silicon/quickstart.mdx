...
<Message type="important">
  ...
  - There is a maximum of one Mac mini M1 allowed per Organization per Availability Zone. For more information on quotas available, refer to our [documentation on account quotas](/console/my-account/reference-content/account-quotas/#apple-silicon-m1).
