---
meta:
  title: Configuring a DELL PERC H310 RAID controller
  description: This page explains how to configure the DELL PERC H310 RAID controller
content:
  h1: Configuring a DELL PERC H310 RAID controller
...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/hardware/reference-content/configure-dell-perc-h200/">Configuring a DELL PERC H200 RAID controller</PreviousButton>
  <NextButton to="/bare-metal/hardware/reference-content/configure-dell-perc-h700/">Configuring a DELL PERC H700/H710/H730/H730P RAID controller</NextButton>
</Navigation>
