...
<Message type="requirement">
  ...
  - You have a (sub-)domain pointed to the Instance's IP address
</Message>
...
You have now successfully installed Chatwoot on your Instance and have learned how to upgrade it to the latest version once there is a new release of the application. For more information about Chatwood, refer to the official [Chatwoot User Guide](https://www.chatwoot.com/docs/product).