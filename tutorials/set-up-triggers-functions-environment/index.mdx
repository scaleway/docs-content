...
In this project, you will create the following resources to use with your functions:

- A project dedicated to this tutoprial
- Two buckets to store media
- A queue to manage events
- IAM credentials to secure our environment
- A Cockpit to monitor your functions
...
8. Upload your images to the bucket.
...
Now, let's [create some functions](tutorials/manage-instances-with-terraform-and-functions/).