...
1. Connect to your webhosting using your [FTP account](LIEN). A listing of your remote files and folders displays in the right part of the FTP client:

    <Lightbox src="scaleway_subdomain_ftp.png" width="" />
