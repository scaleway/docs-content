...
=======
| PostgreSQL & MySQL         | **Integrated**                  | Refer to the [dedicated documentation](/audit-trail/reference-content/adt-supported-endpoints/#postgresql--mysql-supported-endpoints) to find out which PostgreSQL & MySQL endpoints are supported.|
| Public Gateways         | **Integrated**                  | Refer to the [dedicated documentation](/audit-trail/reference-content/adt-supported-endpoints/#public-gateways-supported-endpoints) to find out which Public Gateways endpoints are supported.|
>>>>>>> main
