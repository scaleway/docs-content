...
- Access to Scaleway [Generative APIs](/generative-apis/quickstart/)
...
# use the right name according to your dedicated Generative APIs deployment or Generative APIs model
