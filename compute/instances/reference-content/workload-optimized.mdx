...
categories: 
  - compute
tags: instance type workload workload-optimized range POP2-HM POP2-HC enterprise
---
...
## Workload-Optimized range: Enterprise Instances
...
* High-Memory: Made for RAM-intensive usages, and high memory production applications, these machines provide more RAM than vCPU. These Instances are designed for high demanding analysis, in-memory calculation, big-data processing, high-performance or cache databases.
