...
For Windows, Linux, and macOS for OS specific information, see [How to access the remote desktop of a Mac mini](/apple-silicon/how-to/access-remote-desktop-mac-mini/).
...
1. Click **Apple silicon** in the **Bare Metal** section of the side menu. A list of your Mac minis opens.
