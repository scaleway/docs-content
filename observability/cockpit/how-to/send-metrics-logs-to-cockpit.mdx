...
---
    ...
    3. Create a `python_logs.py` Python file and paste the following code snippet into it. Make sure that you replace `$SCW_SECRET_KEY` and `$COCKPIT_TOKEN_SECRET_KEY` with your values.
