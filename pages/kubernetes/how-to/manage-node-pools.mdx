...
5. Configure the pool:
    ...
    - Configure pool options. Configuration options include:
      ...
      - **Advanced options** tab: Configure an optional [cloud-init script](/kubernetes/how-to/create-cluster/#how-to-configure-a-cloud-init-script) to customize your nodes.  
