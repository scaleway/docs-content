...
meta:
  ...
  description: This page provides information on how to deploy Gestionnaire Libre de Parc Informatique (GLPI), or Open Source IT Equipment Manager in English with Managed Database for MySQL.
content:
