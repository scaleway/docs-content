...
4. Type `yes` and Enter to apply the changes. An output similar to the following displays:
    ...
    scaleway_cockpit.main: Creation complete after 0s [id=xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx]
    scaleway_cockpit_source.main: Creation complete after 0s [id=fr-par/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx]
    scaleway_cockpit_token.main: Creation complete after 0s [id=fr-par/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx]
    scaleway_cockpit_grafana_user.main: Creation complete after 6s [id=xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/3]
    grafana_folder.folder_test: Creating...
    grafana_folder.folder_test: Creation complete after 7s [id=1:xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx]
...
5. Log in to Grafana using your Grafana credentials. The Cockpit Dashboards page displays.
