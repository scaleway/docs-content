...
<Message type="important">
  - RPN SAN does not support RPNv2. To use RPNv2, you either need a server with an RPNv1 connection **or** to [enable the RPNv1 gateway](/rpn/how-to/configure-rpnv1-gateway/).
...
<Message type="tip">
  Some SAN endpoints may not be reachable directly from the RPNv2, and it is required to configure an [RPNv1 gateway](/rpn/how-to/configure-rpnv1-gateway/) to use them with RPNv2.
</Message>
