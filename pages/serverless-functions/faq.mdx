...
<Message type="note">
You create billing alerts to get notifications when your costs exceed a certain threshold. Refer to the [dedicated documentation](/billing/how-to/use-billing-alerts/) for more information.
</Message>
