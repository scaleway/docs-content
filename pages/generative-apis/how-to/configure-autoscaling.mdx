...
7. Click **Update node count** to update the number of nodes in your deployment.
    <Message type="note">
      The new node update may take 15-30 minutes to be deployed depending on the model size. Your deployment will remain available during the node count update. 
    </Message>
