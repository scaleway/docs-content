...
excerpt: |
  WireGuard is a modern VPN (Virtual Private Network) software. It is designed to be run almost anywhere and to be cross-platform. Compared to other similar software, it is faster, more secure and simpler. In the first part of this tutorial you configured Wireguard as a VPN to provide a securized Internet access. ‡In this second part we will spin up private mesh network using wireguard to have a secure private connection between your different servers.
totalTime: PT30M
