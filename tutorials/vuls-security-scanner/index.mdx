...
4. Examine the results:
    ...
    The report view is divided into four parts:
      ...
      - **Affected packages** in the lower right part of the screen, displays the affected package versions, and if there is a fixed version.
