...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/hardware/reference-content/configure-raid-kvm-h200/">How to configure the DELL PERC H200 RAID controller from the KVM</PreviousButton>
  <NextButton to="/bare-metal/hardware/reference-content/configure-raid-kvm-p410/">How to configure the HP Smart Array P410 RAID controller from the KVM</NextButton>
</Navigation>
