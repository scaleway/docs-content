...
excerpt: |
  This page explains how to use the serial console on a Dedibox server
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/dedibox/dedicated-servers/how-to/use-serial-console
image: /assets/images/docs/scaleway.png
keywords: console, my-account, Howto, connect, serial, console
dates:
...
3. Click **Serial Console**. The connection information displays.
  ...
  <Lightbox src="scaleway-serial-console.png" alt=""/>

4. Click **Access** to access the serial console of your server.

  <Lightbox src="scaleway-serial-console-2.png" alt=""/>
...
Directly from the vSphere client:
  ...
  <Lightbox src="scaleway-serial-console-esxi.png" alt=""/>
...
5. Enter 9600 (2) as value
  ...
  <Lightbox src="scaleway-serial-console-esxi2.png" alt=""/>

6. Look for the VMKernel.Boot.tty2Port value

7. Enter com2 as value

  <Lightbox src="scaleway-serial-console-esxi3.png" alt=""/>
