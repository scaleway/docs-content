...
<Message type="requirement">
  ...
  - You have three Ubuntu Bionic (18.04) or later servers
...
To protect the webinterface of CouchDB from unauthorized access, it is required to configure a secure Nginx proxy to restrict the access. 
