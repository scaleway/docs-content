...
3. Select the [region](/object/concepts/#region-and-availability-zone) in which to create your bucket:
...
6. Enable [bucket versioning](/object/how-to/use-bucket-versioning/) if you want to store multiple versions of your objects (this may lead to higher storage costs).
