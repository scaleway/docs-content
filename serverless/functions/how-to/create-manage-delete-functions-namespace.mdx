...
[Namespaces](/functions/concepts/#namespace) allow you to group your [functions](/functions/concepts/#function) and share environment variables, secrets and tokens between them.
...
4. Click **Create namespace only** to finish, or click **Create namespace and add a function** if you want to [create a function](/functions/how-to/create-a-function/) next.
