...
You can add a **W**eb **A**pplication **F**irewall to your Load Balancer using Scaleway Edge Services. [See the documentation](/edge-services/reference-content/understanding-waf/).