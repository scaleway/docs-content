...
<Message type="note">
  Despite efforts for accuracy, the possibility of generated text containing inaccuracies or [hallucinations](/generative-apis/concepts/#hallucinations) exists. Always verify the generated content.
</Message>
...
1. Have your [Scaleway API key](/iam/credentials/create-api-keys/) ready, or generate a new one from the Scaleway console.
