...
* **Noise model support:** Our Aer-based Platforms support custom noise models when you want to mimic real QPU behavior. See [additional documentation](https://qiskit.github.io/qiskit-aer/apidocs/aer_noise.html).
...
Aer emulator is accessible through multiple SDKs. [Check SDK/Backend compatibility](/quantum-computing/additional-content/sdk-backend-compatibility/).
