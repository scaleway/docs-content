...
You can find the code for the publisher and the subscriber servers, you can find the code on [GitHub](https://github.com/scaleway/sns-x-instances-tutorial).
...
7. Check that your `main.tf` file looks like the fully completed example shown on the [GitHub repository](https://github.com/scaleway/sns-x-instances-tutorial)
