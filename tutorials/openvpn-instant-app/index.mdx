...
meta:
  ...
  description: This page shows you how to use the OpenVPN InstantApp on your Scaleway instance.
content:
  h1: Installing the OpenVPN InstantApp
  paragraph: This page shows you how to use the OpenVPN InstantApp on your Scaleway instance.
tags: compute apps OpenVPN VPN Ubuntu InstantApp instance
steps:
  - step: Create and start a new server using the OpenVPN InstantApp
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-use-the-openvpn-instant-apps/#-Create-and-start-a-new-instance-using-the-OpenVPN-InstantApp
  - step: Create a VPN user
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-use-the-openvpn-instant-apps/#-Create-a-VPN-user
  - step: Create a new user using scw-ovpn
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-use-the-openvpn-instant-apps/#-Create-a-new-user-using-scwovpn
  - step: Conclusion
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-use-the-openvpn-instant-apps/#-Conclusion
categories:
  - compute
dates:
