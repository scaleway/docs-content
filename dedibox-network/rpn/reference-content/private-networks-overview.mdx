...
​
Learn more about [Private Networks](https://www.scaleway.com/en/private-networks/) by taking a look at our [documentation](/compute/instances/how-to/use-private-networks).
...
/tutorials/wireguard-mesh-vpn/) or using a [GRE Tunnel](/tutorials/setting-up-tunnel/).
