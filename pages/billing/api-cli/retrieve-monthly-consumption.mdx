...
- Created an [API key](/iam/credentials/create-api-keys/) with sufficient [IAM permissions](/iam/policies-permissions/permission-sets/) to perform the actions described on this page
