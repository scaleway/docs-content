...
5. Enter the names of the **index** and **error** files of your website that will be uploaded to the bucket. 
  ...
  <Message type="tip">
    ...
    - The index file is the default / home page for the website. It serves as an index to the other pages of the site.
...
7. Access the website by clicking on the **Website URL**.
