...
Mastodon provides the possibility of using [Amazon S3-compatible Object Storage](/object/how-to/create-a-bucket/) to store media content uploaded to Instances, making it flexible and scalable.
