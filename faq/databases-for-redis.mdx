...
You can connect to your Managed Database Redis™ using the IP address(es) and port(s) available on the details page of your Redis™ Database Instance next to the title **Endpoints**.
