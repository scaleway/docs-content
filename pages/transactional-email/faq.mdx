...
Domains are automatically blocked to protect the domain [reputation](/transactional-email/reference-content/understanding-tem-reputation-score/) when you have a high rate of undelivered emails. The solution is detailed in a [dedicated troubleshooting page](/transactional-email/troubleshooting/blocked-domain/).

### How do I solve the errors "DMARC policy failure", "Multiple SPF records found", "SPF lookup limit exceeded", or invalid records?
The solutions for most common issues you may encounter are detailed in a [dedicated troubleshooting page](/transactional-email/troubleshooting/fix-common-issues/).
