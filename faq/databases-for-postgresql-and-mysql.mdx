...
No, the second node created when you activate the HA on your Managed Database Instance is a hot standby. This node allow fast failover in case of issue on the Primary Node.
