...
Scaleway Local Storage is an storage solution integrated directly into some of Scaleway's cloud Instances. The storage capacity varies by Instance type, with a maximum of 600GB.
