...
Scaleway recognizes three BGP communities, and applies routing priorities based on the community applied. This lets you influence routing between the various InterLinks or Site-to-Site VPN connections in a VPC, for traffic flowing from Scaleway to your external network.
