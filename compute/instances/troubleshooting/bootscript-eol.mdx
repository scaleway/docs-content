...
<Message type="important">
  ...
  If you see `ls: cannot access /sys/firmware/efi: No such file or directory` the UEFI directories are not installed on your Instance. Migrate your data using **option 2, 3 or 4**.
</Message>
