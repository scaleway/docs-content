...
5. Add a `nginx-configuration.conf` file inside the `demo-app` directory and add the following content to it:
  ...
  The configuration file above contains information about expiration headers for images and other content (CSS, HTML, etc.) and switches `gzip` compression on to improve performance of the application.
