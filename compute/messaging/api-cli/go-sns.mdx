...
<Message type="note">
  ...
  The `Endpoint` for Scaleway Messaging is `http://sqs-sns.mnq.fr-par.scw.cloud`. The values for the access and secret keys should be the credentials you [generated](/compute/messaging/how-to/create-credentials/) for your SNS/SQS namespace.
