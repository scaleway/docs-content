...
- An API key with the [`IAMManager` or `ProjectManager`](/identity-and-access-management/iam/how-to/manage-users/#how-to-view-and-delete-user-api-keys) permission set
