...
Scaleway Database Instances now support Private Networks as Beta feature. This document will guide you through the steps to configure the Private Network feature on DBaaS through the API. For more information how to configure Private Networks for Database Instances from the Scaleway Console, follow [this guide]()
...
5. Copy the ID of Private Network, as you require it in the next steps:
  <Lightbox src="scaleway-pn-dbaas-01.png" alt="" />

## Creating a new Database Instance with a Private Network endpoint

1. Run the commands below using a terminal to create a new Database Instance with Private Network endpoint. Make sure you replace the variables with the appropriate data.
  ```bash
