...
In this tutorial you will learn how to install and configure OpenProject on an Instance running Ubuntu Focal Fossa 20.04 while integrating a PostgreSQL [Managed Database](https://www.scaleway.com/en/databases/) into your stack.
...
Follow the instructions to [create a Database Instance](/en/docs/databases/databases-for-postgresql-and-mysql/how-to/create-a-database/). Ensure that you select **PostgreSQL** as the database engine.
