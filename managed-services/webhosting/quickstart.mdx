...
3. Click on the link next to **Link to Webmail** in the **Hosting information** of your Web Hosting plan to access the webmail interface in a new browser tab.
...
3. Navigate to the `public_html` directory to upload, modify, or download data of your Web Hosting.
    <Lightbox src="scaleway-cpanel-filemanager-view.webp" alt="" />
    <Message type="tip">
    * For more information, how to use the file manager, refer to the official [File Manager documentation](https://docs.cpanel.net/cpanel/files/file-manager/)
    * You can access data of your Web Hosting also using FTP by creating [FTP accounts](https://docs.cpanel.net/cpanel/files/ftp-accounts/)
    </Message>
