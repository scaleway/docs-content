...
In this tutorial, you learn how to install Odoo on a [Scaleway Kubernetes Kapsule](/containers/kubernetes/quickstart/) by using the [Easy-Deploy](/containers/kubernetes/how-to/enable-easy-deploy/) feature. Most of this can be achieved from within the Scaleway Console. The steps of this tutorial are shown in the side menu on the right.
