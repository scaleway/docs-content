...
6. Click **Edit** > **Add static association** and enter the MAC address and the private IP address for the Instance. Confirm by clicking <Icon name="yes" />

  <Lightbox src="scaleway_vpc_static_dhcp.png" />

7. Click the **NAT** tab to display the NAT configuration. 

8. Click **+ Add Static NAT** to conigure a new static NAT rule. In this example, we expose the internal port `22` of the Instance `192.168.0.2` to the external port `2202` of the Public Gateway. Confirm by clicking <Icon name="more" />:
