...
Managed Inference metrics and logs are available in [Scaleway Cockpit](https://console.scaleway.com/cockpit/overview). You can follow your deployment metrics in real-time, such as tokens throughput, requests latency, GPU power usage, and GPU VRAM usage.
