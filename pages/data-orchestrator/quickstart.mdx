...
This documentation explains how to quickly create a simple workflow, then run, monitor, schedule, and delete it.
...
3. Check the box marked **Enable run scheduling**.
