...
Scaleway Serverless Functions used to rely on JWT authentication tokens to access private resources. This feature is now deprecated, you must therefore use Scaleway IAM to access your private functions using an [API key](/iam/credentials/create-api-keys/).
</Message>
...
<Tabs id="token-serverless">
  ...
  1. [Create an IAM application](/iam/principals/create-application/) that will be used as a principal for the policy granting access to your private function.
