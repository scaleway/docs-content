...
7. Select the **number of nodes** (brokers) you want in the cluster.
    ...
    - For highly‑available clusters enabling data replication enabled: use ≥ 3 nodes.  
    - For testing / development: 1 node is sufficient, but it cannot be used with a multi‑AZ configuration.
