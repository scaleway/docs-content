...
<Message type="requirement">
  ...
  - You have [configured your SSH key](/console/organizations-and-projects/how-to/create-ssh-key/) and [your API key](/identity-and-access-management/iam/how-to/create-api-keys/)
