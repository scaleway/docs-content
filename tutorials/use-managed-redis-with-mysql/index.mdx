...
This tutorial demonstrates the integration of a [Scaleway Redis®](https://www.scaleway.com/en/managed-database-for-Redisr/) Instance as a record cache (commonly referred to as a second-level cache) for an application using a [Scaleway MySQL](https://www.scaleway.com/fr/database/) Instance through [Entity Framework](https://learn.microsoft.com/en-us/ef/).
