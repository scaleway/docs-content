...
This page shows how to connect to your [Mac mini](/bare-metal/apple-silicon/concepts/#mac-mini) via either [VNC](/bare-metal/apple-silicon/concepts/#vnc) or [SSH](/console/account/concepts/#ssh-key).
...
3. Click the **VNC** button to launch a VNC session on your Mac mini.
    ...
    <Message type="note">
      ...
      <Lightbox src="scaleway-m1-vnc-lang.webp" alt="" />
    </Message>
...
If you are using Linux and you experience problems using the [VNC button](#how-to-connect-via-vnc) to connect to your Mac mini, you can connect directly from a VNC client. In the example below, we use Remmina.
...
You can now log in the graphical environment of macOS using the default user m1 and the VNC password.
    ...
    <Message type="note">
      ...
      <Lightbox src="scaleway-m1-m1-m1-vnc-lang.webp" alt="" />
    </Message>
