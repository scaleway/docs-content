...
1. Open your web browser and go to the [Scaleway console](https://account.scaleway.com/?service=elements).
2. Click [Log in as an IAM Member](https://account.scaleway.com/member-login?redirectToUrl=https://account.scaleway.com/?service=elements).
