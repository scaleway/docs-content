...
More information on the migration steps is provided in [our reference documentation](https://www.scaleway.com/en/docs/kubernetes/reference-content/secure-cluster-with-private-network/).
