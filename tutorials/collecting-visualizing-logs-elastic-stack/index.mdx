...
<Message type="requirement">
  ...
  - You have [configured your SSH key](/console/my-project/how-to/create-ssh-key)  - You have created [an Instance](/compute/instances/how-to/create-an-instance/) or a [Elastic Metal server](/compute/elastic-metal/how-to/create-server/) with at least 4GB of RAM
