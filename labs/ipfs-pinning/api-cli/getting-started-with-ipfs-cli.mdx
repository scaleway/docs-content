...
In this quickstart, we show you how you can [create and manage your volumes](/labs/ipfs/api-cli/volumes-operations) and [pins](/labs/ipfs/api-cli/pin-operations) from the [console](https://console.scaleway.com/login), via the [Scaleway Command Line Interface](https://github.com/scaleway/scaleway-cli).
