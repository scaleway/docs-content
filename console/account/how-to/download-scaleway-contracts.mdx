...
|---------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| General Terms of Services             | Defines the respective rights and obligations of Scaleway and the client in connection with the use by the client of the services provided by Scaleway.                                             |
...
2. Select the contract you want to download.
