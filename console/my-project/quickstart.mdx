---
layout: docs
title: Quickstart My Project
description: This page shows you how to get started with the Project feature of your Scaleway account.
excerpt: |
  This page shows you how to get started with the Project feature of your Scaleway account.
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/console/my-project/quickstart
image: /assets/images/docs/scaleway.png
keywords: cloud computing, scaleway, elements, account, project, console, ssh key
dates:
...
[SSH keys](/console/my-account/concepts#ssh-key) allow you to securely connect to your compute instances without using a password.
...
On Windows, you can use the third-party application [PuTTYgen](https://www.chiark.greenend.org.uk/~sgtatham/putty/latest.html) to create an SSH key pair.
