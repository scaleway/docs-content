...
# Example platform ID: 'EMU-AER-H100' (Simulates using an NVIDIA H100 GPU)
# Check the documentation or list_backends() for available platforms.
backend = provider.get_backend("EMU-AER-H100")

print(f"Running on: {backend.name}")

# 3. Create a Quantum Circuit
# Let's simulate a Bell State with measurement
qc = QuantumCircuit(2)
qc.h(0)
qc.cx(0, 1)
qc.measure_all()
