---
meta:
  title: Configuring a HP SMART ARRAY P420 RAID controller
  description: This page explains how to configure the HP SMART ARRAY P420 RAID controller
content:
  h1: Configuring a HP SMART ARRAY P420 RAID controller
...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/hardware/reference-content/configure-hp-smart-array-p410/">Configuring a HP SMART ARRAY P410/P22 RAID controller</PreviousButton>
  <NextButton to="/bare-metal/hardware/reference-content/configure-raid-kvm-h200/">Configuring a DELL PERC H200 RAID controller from the KVM</NextButton>
</Navigation>
