...
2. [Apply the `sync` role to the user](/managed-mongodb-databases/how-to/manage-users/#how-to-create-a-new-user) for any database. The `db_admin`role also allows you to sync.
