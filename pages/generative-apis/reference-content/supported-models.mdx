...
Context size, Max output, License, Available in Serverless

## Models technical summary

| Model name | Available in Serverless? | Maximum context window (tokens) | Serverless: Maximum output (tokens) \* | Modalities | License \** |
|------------|--------------|--------------|------------|-----------|-----------|
...
| [`llama-3.3-70b-instruct`](#llama-33-70b-instruct) | Yes | 128k | 16k | Text | [Llama 3.3 Community](https://huggingface.co/meta-llama/Llama-3.3-70B-Instruct) |
...
| [`deepseek-r1-distill-70b`](#deepseek-r1-distill-llama-70b) | Yes | 128k | 4k | Text | [MIT](https://huggingface.co/deepseek-ai/DeepSeek-R1-Distill-Llama-70B/blob/main/LICENSE) and [Llama 3.3 Community](https://huggingface.co/meta-llama/Llama-3.3-70B-Instruct/blob/main/LICENSE) |
| [`deepseek-r1-distill-8b`](#deepseek-r1-distill-llama-8b) | No | 128k | N/A | Text | [MIT](https://huggingface.co/deepseek-ai/DeepSeek-R1-Distill-Llama-70B/blob/main/LICENSE) and [Llama 3.1 Community](https://huggingface.co/meta-llama/Llama-3.1-8B-Instruct/blob/main/LICENSE) |
...
| [`voxtral-small-24b-2507`](#voxtral-small-24b-2507) | Yes | 32k | 16k | Text | [Apache 2.0](https://www.apache.org/licenses/LICENSE-2.0) |
| [`mistral-nemo-instruct-2407`](#mistral-nemo-instruct-2407) | [EOL for Serverless](#end-of-life-eol-models-for-serverless) | 128k | [EOL for Serverless](#end-of-life-eol-models-for-serverless) | Text | [Apache 2.0](https://www.apache.org/licenses/LICENSE-2.0) |
...
| [`devstral-2-123b-instruct-2512`](#devstral-2-123b-instruct-2512) | Yes | 260k | 16k | Text, Code | [Modified MIT](https://huggingface.co/mistralai/Devstral-2-123B-Instruct-2512/blob/main/LICENSE) |
