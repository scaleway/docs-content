...
<Tabs id="object-lock-">
  ...
  3. Click <Icon name="more" /> next to the desired object, then click **Versioning**. A side-panel displays, containing the different versions of your object.
  ...
  7. Make sure you selected the correct retention mode and retain-until date, then click **Confirm** to proceed.
...
<Tabs id="object-lock-">
  ...
  6. Make sure you selected the correct retention mode and retain-until date, then click **Confirm** to proceed.
  </TabsTab>
  <TabsTab label="AWS CLI">
