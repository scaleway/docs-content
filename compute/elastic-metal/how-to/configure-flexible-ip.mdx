...
The gateway of all flexible IP's is `62.210.0.1`. This allows you to move your VMs between your hypervisors without changing the network configuration of the virtual machine.
