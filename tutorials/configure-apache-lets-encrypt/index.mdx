...
Let's Encrypt is a certificate authority providing free SSL certificates. The creation, validation, and installation is automated with certbot — all major browsers trust certificates issued by Let's Encrypt.
