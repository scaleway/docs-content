...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/network/reference-content/configure-windows">How configure a failover IP on Windows Server</PreviousButton>
  <NextButton to="/bare-metal/network/reference-content/configure-multiip-virtualmac">How to configure a multi-IP virtual MAC group</NextButton>
</Navigation>
