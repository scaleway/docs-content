...
This page shows how to connect to your [Mac mini M1](/bare-metal/apple-silicon/concepts/#mac-mini) via either [VNC](/bare-metal/apple-silicon/concepts/#vnc) or [SSH](/console/account/concepts/#ssh-key).
...
<Message type="requirement">
  ...
  - You have [created a Mac mini M1](/bare-metal/apple-silicon/how-to/create-mac-mini/)
</Message>
...
3. Click the **VNC** button to launch a VNC session on your Mac mini M1.
    <Lightbox src="scaleway-vnc.webp" alt="" />
...
<Lightbox src="scaleway-remote-desktop.webp" alt="" />
...
2. Click the Mac mini M1 you want to connect to. Your Mac mini M1 **Overview** displays. You can find your SSH connection information here, under **SSH command**.
    <Lightbox src="scaleway-ssh.webp" alt="" />
...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/apple-silicon/how-to/create-mac-mini/">How to create a Mac mini M1</PreviousButton>
  <NextButton to="/bare-metal/apple-silicon/how-to/reboot-mac-mini/">How to reboot a Mac mini M1</NextButton>
</Navigation>
