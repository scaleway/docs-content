...
This page shows you how to use [KVM](/bare-metal/hardware/concepts/#kvm-over-ip) on a Dedibox with DELL iDRAC 6.
...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/hardware/reference-content/hp-ilo/">Using HP iLO</PreviousButton>
  <NextButton to="/bare-metal/hardware/reference-content/dell-idrac7/">Using DELL iDRAC 7</NextButton>
</Navigation>