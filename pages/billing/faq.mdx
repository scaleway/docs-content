...
<Message type="important">
  ...
  - If the payment fails because the SEPA mandate is invalid, we will automatically change default payment device to the next SEPA mandate in the list or, if none was provided, to a valid card (if any) and change default payment mode to card.
</Message>
