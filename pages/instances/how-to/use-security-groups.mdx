...
<Message type="note">
  The default security group created when launching the first instance in a new Availability Zone is **stateless** by default. This behavior differs from security groups created via the console, which are stateful by default. If required, you can [edit the groups' settings](/instances/how-to/use-security-groups/#how-to-edit-a-security-group) to enable stateful behavior.
</Message>
