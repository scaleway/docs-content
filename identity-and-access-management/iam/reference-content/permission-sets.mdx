...
| InstanceReadOnly             | List and read access to Instances                                              |
...
| MessagingReadOnly            | List and read access to Messaging                                             |
| MessagingFullAccess          | Full access to create, read, list, edit and delete Messaging                          |
| DatabaseReadOnly             | List and read access to Databases                                             |
...
| SmartLabelingReadOnly        | List and read access to Smart Labeling                                        |
