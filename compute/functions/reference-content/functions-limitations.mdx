...
The limits mentioned beforehand are technical limits. Also [account quotas](/console/my-account/reference-content/account-quotas/#serverless-functions), depending on your account level, are applied.
