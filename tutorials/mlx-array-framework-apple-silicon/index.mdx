...
meta:
  ...
  description: This page provides information on how to install and use the MLX array framework on Scaleway's Apple silicon as a Service.
content:
  h1: Deploying the MLX array framework for Apple silicon
  paragraph: This page provides information on how to install and use the MLX array framework on Scaleway's Apple silicon as a Service.
categories:
  - apple-silicon
