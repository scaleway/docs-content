...
meta:
  ...
  description: Discover Scaleway Databases and how to access them for PostgreSQL and MySQL.
content:
  h1: Databases for PostgreSQL and MySQL
  paragraph: Discover Scaleway Databases and how to access them for PostgreSQL and MySQL.
image: database.webp
---
...
## In what regions is the Private Networks feature available for Databases for PostgreSQL and MySQL 
