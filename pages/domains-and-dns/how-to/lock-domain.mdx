...
meta:
  ...
  description: Discover how to lock internal domains effortlessly. Follow our detailed steps to manage domain security and facilitate transfers.
content:
  h1: How to lock an internal domain
  paragraph: Discover how to lock internal domains effortlessly. Follow our detailed steps to manage domain security and facilitate transfers.
tags: domain lock
dates:
