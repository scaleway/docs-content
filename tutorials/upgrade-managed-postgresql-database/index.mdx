...
content:
  h1: Upgrading your Managed Database for PostgreSQL to the latest version
  paragraph: This page shows how to upgrade your Managed Database for PostgreSQL to the latest version 
