...
4. Open the `~/.aws/credentials` file you just created, and add the access key and secret key you saved when you generated your [SQS or SNS credentials](/serverless/messaging/how-to/create-credentials/) as follows:
    ```
    [default]
