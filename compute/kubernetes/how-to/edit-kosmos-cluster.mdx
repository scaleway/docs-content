...
keywords: kubernetes, edit, kosmos, multi cloud, multicloud, multi-cloud, Howto
dates:
...
Nodes from multi-cloudd pools cannot benefit from the auto-healing and auto-scaling features of Scaleway Kapsule pool.
