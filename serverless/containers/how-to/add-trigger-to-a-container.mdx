...
A CRON trigger is a mechanism for invoking a Serverless Container at a specific time or on a recurring schedule, similar to a traditional CronJob on a Linux server.
