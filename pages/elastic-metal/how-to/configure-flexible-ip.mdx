...
<Message typ="tip">
  You can find information about the DNS resolver to use in each data center at the [network reference documentation](/account/support/scaleway-network-information/#dns-cache-servers-and-ntp-servers).
</Message>
