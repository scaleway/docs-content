...
2. Click on the **settings icon** in the application's sidebar.
3. Navigate to the **Model** tab and configure a new provider:
   - Click **Add Custom Provider** and enter:
     ...
     - **Model:** Choose a [supported model](/generative-apis/reference-content/supported-models/).
       <Message type="tip">
...
6. Verify that the AI’s responses meet your expectations.
