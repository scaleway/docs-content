...
Therefore, when you customize your Edge Services endpoint with a subdomain, you are prompted to generate or upload an SSL/TLS certificate for that subdomain. This certificate is stored in [Scaleway Secret Manager](/identity-and-access-management/secret-manager/quickstart/).
