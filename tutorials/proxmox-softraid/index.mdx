...
9. Configure the **Management Network**. This will be the network interface on which the Proxmox webinterface and APIs are available. It is recommended to configure it on the primary email address of your Dedibox.
