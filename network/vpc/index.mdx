...
<Alert
  sentiment="info"
  title="DHCP has moved from Public Gateways to Private Networks"
>
  Don't forget to [activate DHCP](/network/vpc/how-to/activate-dhcp/) on your legacy Private Networks. Check out the [VPC migration](/network/vpc/reference-content/vpc-migration/) documentation for full information.
</Alert>
