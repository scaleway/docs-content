...
1. Access the Scaleway homepage and on the bottom, click **Chat Room** or access it directly via the address [https://slack.scaleway.com](https://slack.scaleway.com)
