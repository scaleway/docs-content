...
This state allows you to increase your volume or [upgrade your node type](/managed-databases/document-database/how-to/upgrade-a-database-instance/). You are also able to clear some space in your volume to increase your capacity.
