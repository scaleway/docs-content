...
4. Configure the remote executor (in this case it is an emulator, but you can swap to QPU() if you want).
...
The following example is adapted from [QoolQit quickstart documentation](https://docs.pasqal.com/qoolqit/get_started/programming_with_qoolqit/#example-rydberg-blockade-demonstration) to work on Scaleway.
