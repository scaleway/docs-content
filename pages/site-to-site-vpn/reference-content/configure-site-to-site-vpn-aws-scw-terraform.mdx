...
- Installed [Terraform](https://developer.hashicorp.com/terraform/downloads) on your local machine
- Installed and configured the [Scaleway CLI](/scaleway-cli/quickstart/) (optional, for verification)

Refer to our [dedicated repository](https://github.com/scaleway/site-to-site-vpn-aws-scw) to see the full code.
