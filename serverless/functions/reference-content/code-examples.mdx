...
func Handle(w http.ResponseWriter, r *http.Request) {
  ...
  // Technically it's not recommanded to add database connection or other resource initialization 
...
Local development makes it easier to write test & debug and it makes it faster to call your function.
...
To find advanced and real world examples for Functions you can have a look on 
