...
This procedure shows how to create an Instance without a public IP address, create a Private Network with a Public Gateway, and a route from your Instance to an Object Storage bucket.
...
### Create a Private Network and attach the Instance
...
### Create a Public Gateway and attach the Private Network
...
You have now configured an Instance with a Private Network to communicate with Scaleway Object Storage using a Public Gateway. The gateway ensures the exchange of data between your Private Network and the public Internet.