...
| ObjectStorageReadObjects     | Read access to objects, tags, metadata and storage class                                   |
| ObjectStorageReadBuckets     | Read access to buckets and bucket configuration including lifecycle rules                    |
| ObjectStorageWriteObjects    | Access to create and edit objects, tags, metadata and storage class                                       |
| ObjectStorageDeleteObjects   | Access to delete objects	                     |
| ObjectStorageWriteBuckets    | Access to create and edit buckets, bucket configuration including lifecycle rules                                        |
| ObjectStorageDeleteBuckets   | Access to delete buckets	                    |
...
| PrivateNetworksReadOnly      | List and read access to Private Networks                                  |
