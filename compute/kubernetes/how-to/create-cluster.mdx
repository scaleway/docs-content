...
description:
  This page explains how to create a Kubernetes Kapsule cluster
excerpt: |
  This page explains how to create a Kubernetes Kapsule cluster.
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/compute/kubernetes/how-to/create-cluster/
image: /assets/images/docs/scaleway.png
keywords: kuberenetes, kapsule create, howto, cluster
dates:
...
Scaleway Elements Kubernetes Kapsule provides a managed environment for you to create, configure and run a cluster of preconfigured machines for containerized applications. You will be able to create [Kubernetes](https://kubernetes.io) clusters without the complexity of managing the infrastructure.
...
2. Enter the cluster creation wizard by clicking **Create a cluster**. The first page of the cluster creation wizard displays.
...
<Lightbox src="assets/scaleway-kapsule_creation.png" alt="" />

Once your cluster is created, it appears in the Clusters List.
<Lightbox src="assets/scaleway-kapsule_cluster_list.png" alt="" />

<Navigation title="See Also">
  <NextButton to="/compute/kubernetes/how-to/edit-cluster/">How to edit a Cluster</NextButton>
</Navigation>