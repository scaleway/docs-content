...
3. Complete the following steps in the wizard: 
    ...
    - Select **GPU** as the **Instance type** and choose your preferred GPU offer.
    ...
    - Optionally, add **Volumes**. These are the storage spaces used by your Instances. You can leave the default settings of a minimum storage required for the OS, or choose to add more [Block](/compute/instances/concepts/#block-volumes) and/or reduce [Local](/compute/instances/concepts/#local-volumes) Storage to your GPU Instance. You can also choose which volume to run the OS from.
