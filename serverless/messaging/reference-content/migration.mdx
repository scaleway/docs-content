...
Your NATS resources will automatically be migrated to the new version of the product. However, for SQS and SNS you will need to migrate, by recreating your resources in the new version. You can do this via the API or the console. It is very important that you migrate, because 30 days after the new version is released, the old version of the product will be decommissioned. All resources still existing within the old version will be deleted.
