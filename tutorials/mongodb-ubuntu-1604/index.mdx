...
<Message type="tip">
  If you want to set up a MongoDB® Instance without worrying about the upkeep of compute resources, you can [create a Managed Databases for MongoDB® Instance](/mongodb/how-to/create-a-database-instance). These are powerful Database Instances managed by Scaleway.
</Message>
