...
- You have an account and are logged into the [Scaleway console](https://console.scaleway.com)
  ...
  - You have [created a Scaleway Database](/managed-database/postgresql-and-mysql/how-to/create-a-database/)
