...
3. Open the file in a text editor and edit it as follows:
  ...
  <Message type="important">
    ...
    If you are using the AWS-CLI v2, you must include the path to the plugin in your configuration file. Use `cli_legacy_plugin_path = <path-to-plugin>` replacing `<path-to-plugin>` with the corresponding path. 
