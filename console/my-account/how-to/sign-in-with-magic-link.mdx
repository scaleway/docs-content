...
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/console/my-account/how-to/sign-in-with-magic-link
dates:
...
2. Enter your e-mail address in the form and click **Send a Magic Link**.
  <Lightbox src="scaleway-login-page-magic-link.png" alt="" />
...
<Lightbox src="scaleway-magic-link-email.png" alt="" />
