...
<Message type="important">
  This procedure refers to NVMe Block volumes. To create legacy block volumes, refer the [dedicated documentation](/compute/instances/how-to/create-a-block-volume/).
</Message>
