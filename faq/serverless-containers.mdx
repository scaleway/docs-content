...
Serverless Containers does not support Virtual Private Networks yet but you can use the Scaleway IP ranges defined in the following link that can be used on Managed Databases and other products that allow IP Filtering: https://www.scaleway.com/en/peering/](https://www.scaleway.com/en/peering/).
