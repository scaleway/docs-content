...
3. Scroll down to **Remote access** section and click **Activate**.
    <Message type="tip">
      If there is no button to activate the remote access feature, it means that this option is not available for your Elastic Metal server.
    </Message>
...
The connection details of your remote access display. Use the credentials provided to log in at the connection URL.
...
Each remote access session has a limited lifetime for security reasons. To renew a remote access session, scroll to the **Remote access** section on the server information page. Then click **Create remote access**.
...
To deactivate the remote access feature, scroll to the **Remote access** section on the server information page. Then click **Disable remote access**.
