...
This document presents how to use this functionality using the Scaleway API. The import/export feature will also be available in the Console, CLI, and SDK.
...
1. Create a Scaleway Object Storage bucket.
    You need a S3 bucket to export your QCOW2 file into. Any bucket that belongs to the same project as the snapshot can be used. However, if you don't have one already, you can [create it](https://www.scaleway.com/en/docs/storage/object/how-to/create-a-bucket/) in the Console.
