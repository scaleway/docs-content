...
- Current API supported features are available in our API documentation:
  - [Generative APIs - Serverless: API/CLI](/generative-apis/api-cli/)
  - [Generative APIs - Dedicated Deployment API](https://www.scaleway.com/en/developers/api/inference/)
- Advanced errors and edge case workarounds are provided in section [Fixing common issues with Generative APIs](/generative-apis/troubleshooting/fixing-common-issues/).
- Information about integration with third-party tools is available on our [dedicated documentation page](/generative-apis/reference-content/integrating-generative-apis-with-popular-tools/#openai-client-libraries).
...
All access to Generative APIs is authenticated and authorized, relying on [Scaleway IAM permissions sets](/iam/policies-permissions/permission-sets/).
...
Scaleway has no access to, nor knowledge of any inputs and outputs generated by the models, except temporarily and exceptionally for troubleshooting or security purposes as described under [Scaleway access](#scaleway-access). By using our AI products, you agree and acknowledge that you are (a) responsible for this use, including any content integrated into the models, and (b) required to use the AI products in compliance with our General Terms of Services.
