...
Dedibox provides an archive of several installation images at [https://virtualmedia.online.net/](https://virtualmedia.online.net).
However, this feature is currently not supported on specific Dedibox server models due to instability issues.
...
The following Dedibox server model is impacted by this limitation:
