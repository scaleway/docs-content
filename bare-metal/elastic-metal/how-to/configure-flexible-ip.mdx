...
<Message type="requirement">
  ...
  - You have [attached a flexible IP address](/bare-metal/elastic-metal/how-to/attach-detach-flexible-ip) to your Elastic Metal server
</Message>

<Message typ="tip">
  You can find information about the DNS resolver to use in each datacenter at the [network reference documentation](/dedibox-network/network/reference-content/dedibox-network-info/#dns-cache-servers).
</Message>
...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/elastic-metal/how-to/attach-detach-flexible-ip/">How to attach / detach a flexible IP</PreviousButton>
  <NextButton to="/bare-metal/elastic-metal/how-to/configure-flexible-ipv6/">How to configure a flexible IP (IPv6)</NextButton>
</Navigation>
