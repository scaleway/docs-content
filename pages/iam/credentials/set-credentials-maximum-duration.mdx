...
<Message type="important">
  The security measures described on this page apply to credentials of both [Owners](/iam/concepts/glossary/#owner) and [IAM members](/iam/concepts/glossary/#members).
</Message>
...
You can define a maximum duration for all API keys created inside your Organization. By default, API keys do not expire unless the creator specifies an expiration date [when creating them](/iam/credentials/create-api-keys/).
...
## How to define a maximum duration for console sessions
