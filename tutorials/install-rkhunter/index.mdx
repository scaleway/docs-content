...
excerpt: |
  The Rootkit Hunter (rkhunter) project provides an open source tool to scan Unix installations for rootkits, backdoors and possible local exploits. To archive this, the tool compares SHA-1 hashes of important files with known good ones in online databases, looking for default directories (of rootkits), wrong permissions, hidden files, suspicious strings in kernel modules, and by running special tests on the computer.
totalTime: PT10M
steps:
  - step: Installing rkhunter
    type: HowToStep
    url: https://www.scaleway.com/en/docs/detect-rootkit-security-holes-rkhunter-ubuntu/#-Installing-rkhunter
  - step: Running rkhunter
    type: HowToStep
    url: https://www.scaleway.com/en/docs/detect-rootkit-security-holes-rkhunter-ubuntu/#-Running-rkhunter
categories:
  - compute
brands:
  - elements
tags: compute mediaserver media streaming safety exploit storage
image: /assets/images/docs/scaleway.png
permalink: docs/detect-rootkit-security-holes-rkhunter-ubuntu/
