...
1. Access the [Scaleway homepage](https://www.scaleway.com/en/) and on the bottom, click **Chat Room** or access it directly via [this link](https://scaleway.slack.com/).
