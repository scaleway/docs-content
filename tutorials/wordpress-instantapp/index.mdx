...
import image3 from './assets/scaleway-wplogin.webp'
import image4 from './assets/scaleway-wp.webp'
...
2. Click **Create Instance**. The [Instance creation wizard](https://account.scaleway.com/?service=elementsinstance/servers/create) displays.
...
To avoid spam, remote mail ports cannot be reached from our infrastructure by default. As WordPress requires sending mail, we need to open them. Your account needs to be validated to perform this operation. [Contact our assistance](https://account.scaleway.com/?service=elementssupport/) to get your account reviewed.
