...
Follow the instructions to [create a Database Instance](/postgresql-and-mysql/how-to/create-a-database/). Ensure that you select **PostgreSQL** as the database engine.
