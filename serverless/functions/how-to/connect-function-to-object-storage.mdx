...
2. Write your code.
    ...
    * Write a new bucket object:
    ...
    ```
3. Push your code to Serverless Function [using a zip-file](/serverless/functions/how-to/package-function-in-zip/) or the serverless framework (the latter is recommended).
