...
Backups and snapshots must be configured by you. Please refer to our documentation for assistance in setting up backups for [Dedibox](/dedibox/how-to/use-dedibackup-ftp-backup/), [Elastic Metal](/faq/elastic-metal/#how-do-i-back-up-an-elastic-metal-server), and [Apple silicon](/faq/apple-silicon/#how-can-i-back-up-my-mac-mini).
