---
layout: docs
title: Quickstart Container Registry
description: This page shows you how to get started with Scaleway Container Registry.
excerpt: |
  This page shows you how to get started with Scaleway Container Registry.
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/compute/container-registry/quickstart
image: /assets/images/docs/scaleway.png
keywords: bare metal, cloud computing, scaleway, container registry, image, quickstart
dates:
...
4. Open a terminal window on your local computer. Then log into the namespace by running the following command from the terminal:
    ```
    docker login rg.fr-par.scw.cloud/mynamespace -u nologin -p [YOUR_SECRET_TOKEN]
    ```
    <Message type="important">

    Replace `[YOUR_SECRET_TOKEN]` with your [API Secret Key](/console/my-project/how-to/generate-api-key/) and `mynamespace` with the name of your namespace.
