...
<Message type="note">
  * Before powering off your server, we recommend you [log into your server as root](/compute/elastic-metal/how-to/connect-to-server/) and execute the `halt` command to shutdown the OS. 
...
<Message type="important">
  Before powering off your Elastic Metal server, we recommend you [log into your server as root](/compute/elastic-metal/how-to/connect-to-server/) and execute the `halt` command to shutdown the OS. 
</Message>
