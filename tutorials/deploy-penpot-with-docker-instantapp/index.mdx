...
content:
  h1: How to deploy a self-hosted Penpot Instance using the Docker InstantApp
...
Penpot is an open-source design and prototyping platform meant for cross-domain teams. It is completely web based and works with open web standards (SVG). Penpot can run in almost any modern browser, no matter of the underlying operating system.
...
1. In the Scaleway console click **Instances** in the **Compute** section of the navigation bar. Then [deploy](/compute/instances/how-to/create-an-instance/) a new Instance using the [Docker InstantApp](https://console.scaleway.com/instance/servers/create?area=fr-par-1&imageKey=c1b530d8-0ca0-45c4-80db-ba06608287b2&offerName=PLAY2-MICRO).
