...
<Message type="note">
  It is currently not possible to transfer resources from one Project to another. For Object Storage, you can [import copies of your objects to buckets in different Projects](/object/api-cli/migrating-buckets/).
</Message>
