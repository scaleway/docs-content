...
3. Select the geographical location in which your bucket will be created. Scaleway Object Storage is currently available in three Regions.
    ...
    - Warsaw, Poland:
      - Region: `pl-waw`
4. Check **Public** or **Private** to define the bucket visibility. The bucket visibility specifies whether everyone can see the list of objects in the bucket. It does not affect [object visibility](/storage/object/concepts/#visibility). You can later change the visibility settings in the Object Storage dashboard.
    <Message type="note">
