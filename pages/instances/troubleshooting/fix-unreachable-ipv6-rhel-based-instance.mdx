...
The affected OS distributions are:
...
## Going further
For general information on routed IPs and migration procedures, refer to the [related FAQ](/instances/faq/#are-there-any-limitations-on-ip-autoconfiguration-with-the-routed-ip-feature). If you still encounter issues, provide the following information when creating a support ticket:
- Instance ID
