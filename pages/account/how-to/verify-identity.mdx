...
1. Click **Add ID document** under **(Optional) Verify my ID document** on the [Organization dashboard](https://account.scaleway.com/?service=elementsorganization/). You can also verify your identity on your Organization [Settings](https://account.scaleway.com/?service=elementssettings/organization/information) page.
...
5. Click **Start** to center your ID and take a photo.
    <Message type="important">
      The **account.scaleway.com/?service=elements** website will request access to your camera. If you wish to proceed, allow your browser to use the camera.
    </Message>
...
8. Frame your face in the designated areas as requested by the validation process.
  ...
  <Message type="important">
    ...
    Once that period elapses, you should [contact our Support team](https://account.scaleway.com/?service=elementssupport/tickets/create) for a manual verification.
  </Message>