...
In this tutorial, we show you how to install Proxmox on your Elastic Metal servers, configure the Private Network via the Proxmox interface, and create a cluster of virtual machines across the two Elastic Metal servers which communicate via the Private Network. All the virtual machines can be managed from a single Proxmox interface, with the Private Network ensuring a high level of security and low latency.
...
- You have created a [Private Network](/elastic-metal/how-to/use-private-networks/) and attached your Elastic Metal servers to it
...
4. Enter the VLAN details for your Private Network: 
    ...
    <Lightframe src="scaleway-proxmox-vlan-details.png" alt="" />
