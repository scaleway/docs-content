...
<Concept>
  ...
  An external domain is any domain created via an external registrar (i.e. not by Scaleway). You can manage DNS zones for external domains from the Scaleway console.
</Concept>
