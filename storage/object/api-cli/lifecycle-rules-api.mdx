...
<Message type="important">
  ...
  Refer to our [dedicated documentation](/object/how-to/edit-storage-class/) to manually change the storage class of your objects.
</Message>
...
<Message type="note">
  To see examples of lifecycle rules API requests, refer to the Bucket Operations [documentation page](/object/api-cli/bucket-operations/#putbucketlifecycleconfiguration).
</Message>
...
You can automate the removal of incomplete multipart uploads by adding or uploading a lifecycle configuration to your bucket. The setup can be done via an API call or an [AWS-CLI](/object/api-cli/object-storage-aws-cli/) command.

Send a [putbucketlifecycleconfiguration](/object/api-cli/bucket-operations/#putbucketlifecycleconfiguration) request with the following XML payload:
