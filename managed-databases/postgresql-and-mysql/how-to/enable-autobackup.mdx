...
3. Click <Icon name="edit" /> in the **Backup** tab to configure the backup frequency and retention.
    ...
    <Message type="note">
      Although autobackup is enabled by default you can select **Manual** in the **Choose a snapshot configuration** step of the Database Instance creation wizard to disable the feature before you create the Instance. You can also disable it after the Database Instance is ready.
    </Message>
