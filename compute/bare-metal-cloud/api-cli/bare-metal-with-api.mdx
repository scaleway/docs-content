...
content:
  h1: Deploying a Bare Metal server with one API call
  paragraph: This page shows you how to deploy a Bare Metal server running on your favourite Operating System with one API command 
