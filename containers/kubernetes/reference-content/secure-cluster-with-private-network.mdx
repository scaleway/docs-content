...
You have the option to use a Public Gateway when setting up your cluster with [full isolation](#what-is-the-difference-between-controlled-isolation-and-full-isolation). This allows the Kapsule nodes with private IPs to route their outgoing traffic through the Public Gateway. For detailed steps on setting up a Public Gateway, refer to our [Public Gateway documentation](/network/public-gateways/how-to/configure-a-public-gateway/).
