...
5. Enter a name for the volume (or use the default suggested name), select the volume type, and click **Create volume from Snapshot**.
    ...
    The volume is created, and can be viewed in the [Volumes tab](https://console.scaleway.com/instance/volumes). Check out our documentation on [attaching volumes](/block/how-to/attach-a-volume/) and [mounting volumes](/block/api-cli/managing-a-volume/#mounting-and-using-a-block-storage-volume) to learn how to use the volume with your Instances.
