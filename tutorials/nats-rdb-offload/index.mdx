...
To be sure we did not forgot anything for the Scaleway [context](/serverless/messaging/api-cli/nats-cli/#define-a-context), paste the following code in a new window of your terminal
    ```
