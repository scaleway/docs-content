...
<Message type="important">
     You will receive an email verification request to validate the transfer (check your spam folder). Click the link to https://emailverification.info/ and enter the verification code to confirm the transfer.
</Message>
