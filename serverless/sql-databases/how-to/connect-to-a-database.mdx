...
Use the five connection parameters (host, port, user, password, database name) previously saved to connect your application to the database.

<Message type="note">
  Connection methods vary greatly depending on the framework of your application. Refer to the corresponding official documentation for more information.
</Message>
