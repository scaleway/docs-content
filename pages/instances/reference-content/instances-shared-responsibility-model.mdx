...
Refer to our documentation on [encrypting volumes for sensitive data](/tutorials/encrypt-volumes/) for further information.
...
* Using Audit Trail for log provisioning purposes.
...
### HDS-compliant resource identification

You are responsible for:

- Knowing which of your resources are HDS-compliant and which are not.
- Attaching only HDS-compliant volumes to HDS Instances.
...
|-------------------------------------------------------------|-----------------------------|-------------------------------------------------------------------------------------------------|
| Other Instances SLO (DEV1, GP1, PLAY2, PRO2, ENT1) | No                          | N/A                                                                                             |
