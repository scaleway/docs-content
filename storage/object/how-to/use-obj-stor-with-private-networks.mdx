...
You have now configured a Instance with a Private Network to communicate with Scaleway's Object Storage platform using the Public Gateway feature. The gateway ensures the exchange of data between your Private Network and the public Internet.
