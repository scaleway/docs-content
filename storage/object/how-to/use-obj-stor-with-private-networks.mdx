...
1. Follow the instructions for [creating a Private Network](/network/public-gateways/ic-gateways/how-to/use-private-networks/#how-to-create-a-private-network). Make sure to select the same availability zone as for your previously created Instance. After creating your Private Network, you are directed to a list of this and any other Private Networks you have previously created.
