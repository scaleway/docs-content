...
Your NATS resources were automatically migrated to the new version of the product. However, for SQS and SNS you were prompted to migrate, by recreating your resources in the new version. In December 2023, as warned, the old product version was retired and resources which remained there were deleted.
