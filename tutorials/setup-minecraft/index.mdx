...
Deploying your own Minecraft server can be done in a few easy steps on a [Scaleway Elements Development Instance](https://www.scaleway.com/en/virtual-instances/development/). In case you do not have an Instance yet, start by [deploying your first Instance](/compute/instances/how-to/create-an-instance/).
