...
This guide walks you through deploying a Serverless Container behind a Scaleway Edge Service pipeline. You create a namespace, deploy a container, and configure an Edge Service pipeline with stages for backend routing, TLS termination, and DNS to expose a public endpoint.
