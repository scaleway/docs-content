...
<Message type="note">
To attach a file system to an Instance, you must have created a [compatible Instance](/file-storage/reference-content/file-system-instance-selection/) beforehand.
</Message>
...
5. Select one Instance or more from the drop-down list, then click **Attach** to confirm.
    ...
    File systems can only be attached to [compatible Instances](/file-storage/reference-content/file-system-instance-selection/) within the same [region](/file-storage/concepts/#region).
    </Message>
...
<Message type="note">
To mount a file system to an Instance, you must have [attached your file system to an Instance](#how-to-attach-a-file-system-to-one-or-more-instances) beforehand. File systems can only be attached to [compatible Instances](/file-storage/reference-content/file-system-instance-selection/).
</Message>
