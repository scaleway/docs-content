...
4. Complete the following steps in the wizard: 
    ...
    - Click **Advanced Options** if you wish to set a custom timeout for your function.
      <Message type="note">
        [Triggers](/serverless/functions/concepts/#trigger) can no longer be added from this screen. Refer to [this page](/serverless/functions/how-to/add-trigger-to-a-function/) to add a trigger to your function.
      </Message>
