...
5. Enter the connection credentials of your Object Storage bucket:
    ...
    - **Access key**: Your Scaleway [access key](/identity-and-access-management/organizations-and-projects/how-to/create-ssh-key/)
    - **Secret key**: Your Scaleway [secret key](/identity-and-access-management/organizations-and-projects/how-to/create-ssh-key/)
