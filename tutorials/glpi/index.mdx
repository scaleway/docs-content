...
In this tutorial, we will install and configure a [LEMP-Stack](https://lemp.io/) using [Nginx](https://nginx.org/), a Database for [MySQL](https://www.scaleway.com/en/managed-postgresql-mysql/) and [PHP](https://www.php.net/).
