...
description: This page shows you how to get started with Scaleway Elements Kubernetes.
excerpt: |
  This page shows you how to get started with Scaleway Elements Kubernetes.
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
...
keywords: instances, cloud computing, scaleway, kubernetes, kapsule, kosmos
dates:
  validation: 2021-05-26
  posted: 2021-05-26
---

Scaleway [Kubernetes](/compute/kubernetes/concepts#kubernetes) provides a managed environment to create, configure and run a cluster of preconfigured machines for containerized applications. This allows you to create Kubernetes clusters without the complexity of managing the infrastructure. You can create a Kapsule cluster to your required specifications, edit it after creation and delete it all when you no longer need it. You might also want to check out our how-to on [deploying an image on your cluster](/compute/kubernetes/how-to/deploy-image-from-container-registry).
...
4. This page provides information on how to add your external node to the pool. Connect to your node and run the following command to add the node: 
  ...
  $> ./multicloud-init.sh -p c58bcee3-52db-4501-a96e-41dddbb6e5f4 -r fr-par -t SCW-TOKEN
  ```
  ...
  <Message type="important">
    ...
    * A Scaleway [token](/console/my-project/how-to/generate-api-key)
...
<Message type="important">
Deleting your cluster will permanently destroy your cluster and all its associated pools and Instances. External compute resources cannot be destroyed automatically and will remain active until destroyed at the concerned CSP.
</Message>
