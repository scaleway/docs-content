...
1. Click **CPU & GPU Instances** in the **Compute** section of the side menu. The [Instances overview](https://account.scaleway.com/?service=elementsInstance/servers) displays.
