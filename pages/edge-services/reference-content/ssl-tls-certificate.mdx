...
<Message type="note">
Even if you have an Edge Services pipeline for a Load Balancer, and you have already configured your Load Balancer with a certificate for HTTPS (using Let's Encrypt or a custom certificate), you will still need to follow the steps of this document to provide a certificate for your Edge Services pipeline's customized domain.
</Message>
