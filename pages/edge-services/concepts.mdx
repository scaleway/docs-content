...
You can also use a [Serverless Container](/serverless-containers/concepts/) (or [Serverless Function](/serverless-functions/concepts/)) as an Edge Services backend. This feature is not available in the Scaleway console. See the [guide to deploying a Serverless Container behind Edge Services](/serverless-containers/how-to/deploy-container-behind-edge-services/) for instructions using the CLI or Terraform.
