...
You can check your support plan on the support plan page within the Scaleway console. The free Basic support plan is included for all Scaleway Elements customers automatically.
...
For the Gold plan, we will charge you whichever is greater, either €499 per month (excluding taxes) or 3% of your net monthly spend. For example: If your net spend is €15,000, then 3% of €15,000 = €450. In this case, €499 is less than €450, so you will pay the fixed price at €499.
...
To report abuse or suspicion of abuse from our network, please open a new abuse report via abuse.scaleway.com. If relevant, feel free to include your logs.
