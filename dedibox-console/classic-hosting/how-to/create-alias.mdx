...
<Navigation title="See also">
  <PreviousButton to="/dedibox-console/classic-hosting/how-to/configure-outlook/">How to configure Outlook to receive and send email</PreviousButton>
  <NextButton to="/dedibox-console/classic-hosting/how-to/encrypt-emails-with-pgp-using-webmail/">How to encrypt your emails with PGP using the Scaleway webmail</NextButton>
</Navigation> 
