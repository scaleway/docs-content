...
4. Click **Delete Elastic Metal server**. A pop-up displays. Type **DELETE** to confirm and click **Delete Elastic Metal server** to proceed.
    ...
    <Message type="tip">
      Flexible IPs attached to your server will be detached during server deletion and released back into your [Flexible IP pool](https://account.scaleway.com/?service=elementselastic-metal/flexible-ips/). 
