...
Yes, Serverless Containers is auditable. For more information, read about [Supported endpoints in Audit Trail](/audit-trail/reference-content/adt-supported-endpoints/).
