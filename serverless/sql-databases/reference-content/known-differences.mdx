...
- Grafana: Serverless SQL Databases cannot yet be added as a PostgreSQL datasource in Grafana 10.1 and older versions as Server Name Indication (SNI) is not supported. However, this feature is supported by Grafana 10.2 or higher.
