...
4. Click **Create namespace and add function**. The function creation wizard displays.
    <Message type="note">
      Refer to the [How to create a Functions namespace](/serverless/functions/how-to/create-manage-functions-namespace/) documentation page for more information on the different parameters.
    </Message>
