...
<Message type="note">
  ...
  The `Endpoint` for Scaleway Messaging and Queuing is `https://sqs-sns.mnq.fr-par.scw.cloud`. For the access and secret key values, use the credentials you [generated](/serverless/messaging/how-to/create-credentials/) for your SNS/SQS namespace.
...
This tutorial use the `@aws-sdk/client-sqs` module which is the latests SDK available.
