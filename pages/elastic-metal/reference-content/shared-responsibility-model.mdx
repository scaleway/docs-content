...
* **Scaleway responsibility**: Technically guarantee that data remains within the authorized Parisian datacenters, and will not modify customer’s selected localization during resource allocation.  
...
Disk personalization options are **excluded from HDS perimeter**.
