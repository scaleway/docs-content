...
They work best when they are triggered by events stored in queues, which means that they can be edited without having to modify every microservices in the process.
