...
4. Follow these steps to configure your Web Hosting:
   - Enter your **domain name**. Remember, it must be pre-registered and you must be the registrant. Need to register one? [Read our documentation on how to register a domain name](/domains-and-dns/how-to/register-internal-domain/).
