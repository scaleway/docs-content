---
meta:
  title: Fix unreachable Ubuntu Focal Instance when it has two public IPv4 IPs
...
content:
  h1: Fix unreachable Ubuntu Focal Instance when it has two public IPv4 IPs
  paragraph: This page helps you recover or avoid unreachable Ubuntu 20.04 Focal Instance when it has two public IPv4 IP addresses.
