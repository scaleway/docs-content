...
If you require higher maximum output tokens, you can use [Managed Inference](https://console.scaleway.com/inference/deployments) where these limts to not apply (as your bill will be limited by the size of your deployment).
