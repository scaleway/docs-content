...
A vCPU (Virtual Central Processing Unit) is equivalent to 1000 mVPCU.
...
A namespace is a project that allows you to [group your containers](/compute/containers/how-to/create-a-containers-namespace/). Containers in the same Namespace can share environment variables and access tokens, defined at the namespace level.
