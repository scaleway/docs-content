...
5. Choose a CMS, such as WordPress. Refer to the official documentation for more information:
...
Refer to the [Containers use cases page](/serverless-containers/reference-content/containers-use-cases/) for more information on the different apps you can deploy using Serverless Containers.
