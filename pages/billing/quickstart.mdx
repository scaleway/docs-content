...
1. Click **Billing** in the Organization drop-down menu to go to the [Billing page](https://account.scaleway.com/?service=elementsbilling/overview).
...
1. Access the [Scaleway console](https://account.scaleway.com/?service=elementsorganization).
2. On the **Billing** page, click the [Payment and billing](https://account.scaleway.com/?service=elementsbilling/payment) tab.
...
1. Click **Billing** in the Organization drop-down menu to go to the [Billing page](https://account.scaleway.com/?service=elementsbilling/payment).
...
<Message type="note">
  It is not possible to edit your country and region information directly from this form. Contact the [Support team](https://account.scaleway.com/?service=elementssupport/tickets/) if you need to modify this information.
</Message>