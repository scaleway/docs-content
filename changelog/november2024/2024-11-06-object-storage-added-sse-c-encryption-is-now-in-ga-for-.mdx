...
For more information [read our dedicated documentation to get started with SSE-C on Object Storage](https://www.scaleway.com/en/docs/storage/object/api-cli/enable-sse-c/).
