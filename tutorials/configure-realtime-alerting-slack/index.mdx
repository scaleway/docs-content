...
When you use this tutorial in a production setting, we recommend that you:
  ...
  - for important alerts, depending on the content of the alert, notify the right Slack channel using a [Serverless Function](/functions/concepts/#serverless-functions) to make this choice.
