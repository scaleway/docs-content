...
- The **Email status** drop-down allows you to target specific emails according to their **status** or their **flags**.
    ...
    | Spam                                                               | Your email has been considered spam. [Find out how to abide by emailing best practices](/managed-services/transactional-email/reference-content/understanding-tem-reputation-score/#emailing-best-practices-to-improve-your-domain-reputation) to avoid your emails going into the spambox. |
