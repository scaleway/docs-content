...
<Message type="note">
     You are currently viewing a brief summary of setting up a Multi-AZ Kubernetes cluster. For a complete insight in the concept and step-by-step guidance, we recommend to follows our **[complete tutorial](/tutorials/k8s-kapsule-multi-az/)**.
</Message>
