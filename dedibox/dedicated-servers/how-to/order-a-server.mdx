...
excerpt: |
  This page explains how to order a Dedibox dedicated server
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/dedibox/dedicated-servers/how-to/order-a-server
...
2. Click **Server**. The server offers page displays.
  ...
  <Lightbox src="scaleway-server-offers.png" alt="" />
