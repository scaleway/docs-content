---
title: Shared Responsibility Model for Managed Databases for PostgreSQL and MySQL
...
This page covers key principles and best practices for developing secure and reliable applications with Managed Databases for PostgreSQL and MySQL.
...
Monitoring provides real-time visibility into database performance, security, and resource usage. It is essential to maintain reliable and secure services. Proactive monitoring helps you identify and address issues before they impact operations.
...
<Message type="note">
  Any intermediary Scaleway component, such as a Load Balancer, does not decrypt Managed Databases' traffic.
</Message>

### Encryption at rest

Managed PostgreSQL and MySQL instances support [encryption at rest](/managed-databases-for-postgresql-and-mysql/concepts/#encryption-at-rest), but you must explicitly enable it. When enabled, Scaleway manages the encryption key.
...
Managed Databases for PostgreSQL provides [IAM permissions sets](/iam/policies-permissions/permission-sets/) that allow or restrict specific actions a user or application can perform, such as creating or deleting Database Instances. These are:
...
Refer to the [How to create a policy](/iam/policies-permissions/create-policy/) documentation page to set up a policy for Managed Databases for PostgreSQL and MySQL.
