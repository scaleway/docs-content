...
categories:
  - compute
image: /assets/scaleway_glpi.webp
dates:
...
In this tutorial we will install and configure a [LEMP-Stack](https://lemp.io/) using [Ngnix](https://nginx.org/), a managed database for [MySQL](https://www.scaleway.com/en/databases/) and [PHP](https://www.php.net/).
...
In this tutorial we use a Scaleway Managed Database for MySQL. To create the database, follow [this how-to](/databases/databases-for-postgresql-and-mysql/how-to/create-a-database/).
