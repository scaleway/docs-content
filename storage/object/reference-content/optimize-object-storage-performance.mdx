...
Now that your hardware is properly set, make sure that your object transfers are properly set to leverage the full potential of Scaleway Object storage.

### 

The most impactful feature is multipart uploads. 
