...
1. Click **Load Balancers** in the **Network** section of the [Scaleway console](https://account.scaleway.com/?service=elements) side menu. If you have not already created a Load Balancer, the product creation page is displayed. Otherwise, your list of existing Load Balancers displays.
...
1. Click **Load Balancers** in the **Network** section of the [Scaleway console](https://account.scaleway.com/?service=elements) side menu. The Load Balancer dashboard displays.
