...
3. Run the container with the following command:
    ...
    * Replace `$DB_PORT` with the port your MySQL server is listening on.
    ...
    <Message type="tip">
      If you are using a [Database for MySQL](https://www.scaleway.com/en/docs/managed-databases/postgresql-and-mysql/quickstart/) you can find the connection details on the Database information page:
