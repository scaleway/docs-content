...
4. Complete the following steps in the wizard: 
    ...
    - Select the snapshot type. The available types of snapshots are depending on your volume type and can either be LSSD, BSSD, or Unified. 
...
5. Enter a name for the volume (or use the default suggested name), select the volume type, and click **Create Volume from Snapshot**.
  ...
  The volume types available may change according to the type of snapshot you select. 
