...
2. Type `n` and go directly to the [Creating a K8s Kapsule cluster](#creating-a-k8s-kapsule-cluster) step of this tutorial, if you do not want to edit your configuration.
    ...
    ```
3. Enter either the email address for your account (you will then be asked for your password), or your [API Secret Key](/identity-and-access-management/iam/how-to/manage-api-keys/):
    ```
