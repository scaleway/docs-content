---
meta:
  title: Installing LEMP-Stack (Linux, Nginx, MySQL, PHP) on Ubuntu Bionic
  description: How to install LEMP-Stack (Linux, Nginx, MySQL, PHP) on Ubuntu Bionic (18.04)
content:
  h1: Installing LEMP-Stack (Linux, Nginx, MySQL, PHP) on Ubuntu Bionic
  paragraph: How to install LEMP-Stack (Linux, Nginx, MySQL, PHP) on Ubuntu Bionic (18.04)
tags: account LEMP-Stack Ubuntu-Bionic Linux Nginx MySQL PHP certbot
steps:
  - step: Installing the Stack
    type: HowToStep
    url: https://www.scaleway.com/en/docs/installing-lemp-stack-on-ubuntu-linux-nginx-mysql-php/#-Installing-the-Stack
  - step: Configuring the Firewall
    type: HowToStep
    url: https://www.scaleway.com/en/docs/installing-lemp-stack-on-ubuntu-linux-nginx-mysql-php/#-Configuring-the-Firewall
  - step: Configuring MySQL / MariaDB
    type: HowToStep
    url: https://www.scaleway.com/en/docs/installing-lemp-stack-on-ubuntu-linux-nginx-mysql-php/#-Configuring-MySQL--MariaDB
  - step: Configuring a Nginx ServerBlock
    type: HowToStep
    url: https://www.scaleway.com/en/docs/installing-lemp-stack-on-ubuntu-linux-nginx-mysql-php/#-Configuring-a-Nginx-ServerBlock
  - step: Testing PHP
    type: HowToStep
    url: https://www.scaleway.com/en/docs/installing-lemp-stack-on-ubuntu-linux-nginx-mysql-php/#-Testing-PHP
  - step: Configuring SSL with Let's Encrypt
    type: HowToStep
    url: https://www.scaleway.com/en/docs/installing-lemp-stack-on-ubuntu-linux-nginx-mysql-php/#-Configuring-SSL-with-Lets-Encrypt
categories:
  - compute
dates:
  validation: 2021-12-03
  posted: 2018-07-31
---
...
2. Enter the current root password for the MariaDB server. when prompted As it not yet set, press `Enter`.
...
2. Create a new server block configuration file and name it after the domain name that points to your Instance, or else your Instance's public IP address. Here we use `example.com`:
...
3. Save the file and point your web browser to `http://example.com/phpinfo.php` (replacing `example.com` with your domain name or Instance IP as necessary). When you see an output like the following, PHP is setup correctly:

<Lightbox src="scaleway-lemp-php72.png" alt="" />
...
<Lightbox src="scaleway-lemp-https.png" alt="" />
