...
If you want to know more about the failover system, read [our article on strengthening our Load Balancer failover mechanism](https://blog.scaleway.com/strengthening-our-load-balancer-failover-mechanism/).
