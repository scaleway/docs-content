...
1. Navigate to the **Containers** section within the [Scaleway console](https://account.scaleway.com/?service=elements) sidebar and select **Kubernetes**. The Kubernetes Kapsule dashboard displays.
