...
1. Click **Managed Inference** in the **AI** section of the side menu in the [Scaleway console](https://account.scaleway.com/?service=elements) to access the dashboard.
