...
tags: compute systemd
excerpt: |
  systemd is a suite of tools that provide a fast and flexible init model for managing an entire machine from boot onwards. It provides a system and service manager which runs as PID 1 and controls the start of the rest of the system.
  In recent years the majority of Linux distributions have adopted systemd as their default init system.

  In this tutorial, you will learn a quick overview of the most important commands you'll need to know for managing a systemd enabled server. These should work on any operating system that uses systemd.
totalTime: PT30M
steps:
  - step: Analyzing the System State
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/systemd-essentials/#-Analyzing-the-System-State
  - step: Using Units
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/systemd-essentials/#-Using-Units
  - step: Enabling or Disabling Units
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/systemd-essentials/#-Enabling-or-Disabling-Units
  - step: Power Management
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/systemd-essentials/#-Power-Management
  - step: Viewing System Log Information
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/systemd-essentials/#-Viewing-System-Log-Information
  - step: Checking Unit States and Logs
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/systemd-essentials/#-Checking-Unit-States-and-Logs
  - step: Exploring Units and unit files
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/systemd-essentials/#-Exploring-Units-and-Unit-Files
  - step: Editing unit files
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/systemd-essentials/#-Editing-Unit-Files
  - step: Targets (Runlevel)
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/systemd-essentials/#-Targets-Runlevel
categories:
  - compute
  - instances
image: /assets/images/docs/scaleway.png
permalink: docs/tutorials/systemd-essentials/
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, debian server, linux server, IAAS, baremetal, scalability, ARM, physical server, dedicated server, physicalization, server, network, systemd, runlevel, administration
dates:
...
It will return you a list of the status of all services on the server and their current state. The report will look like the following sample:
...
To **start** a unit immediately, type the following command:

```s
systemctl start unit
```

To **stop** a unit immediately, type:
...
This command can be handy, in case you have edited some configuration files of a service and you don't want to restart it to reload the configuration.
...
The default configuration of most unit files does not let them start automatically at boot. To configure this behaviour, the unit has to be "enabled".
