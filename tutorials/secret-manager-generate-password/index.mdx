...
Once you have [created a secret](/identity-and-access-management/secret-manager/how-to/create-secret/) with Scaleway Secret Manager, you can send a request to generate a password for it. Your password will then be securely stored in Secret Manager.
