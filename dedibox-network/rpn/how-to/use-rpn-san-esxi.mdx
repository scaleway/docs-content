...
This documentation covers **VMWare ESXi version ESXi 5.0/5.1/5.5 and 6.0** and later. Follow [this link](/dedibox-network/rpn/howto/use-rpn-san-esxi-v7) to see the Documentation for ESXi 7 and later.
