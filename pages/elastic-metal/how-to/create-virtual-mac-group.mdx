...
1. Click **Elastic Metal** in the **Bare Metal** section of the [Scaleway console](https://account.scaleway.com/?service=elements) side menu. The Elastic Metal dashboard displays.
...
To remove a flexible IP from a virtual MAC group, click <Icon name="more" />, then **Generate MAC** and generate a new MAC address as described in the [adding a virtual MAC Address](/elastic-metal/how-to/add-virtual-mac-address/) documentation.
