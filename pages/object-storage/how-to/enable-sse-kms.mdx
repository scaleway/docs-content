...
- [Key Manager permission sets](/iam/policies-permissions/permission-sets/#key-manager) for every [principal](/iam/concepts/glossary/#principal) that reads or writes objects in the bucket: `KeyManagerKeyEncrypt` to upload or copy objects, and `KeyManagerKeyDecrypt` to download or copy them
