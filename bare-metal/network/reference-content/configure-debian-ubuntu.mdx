...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/network/reference-content/configure-centos">How to configure a failover IP on CentOS</PreviousButton>
  <NextButton to="/bare-metal/network/reference-content/configure-freebsd">How to configure a failover IP on FreeBSD</NextButton>
</Navigation>
