...
<Message type="note">
  This document concerns enabling SMTP for Instances. If you want to enable SMTP on other resources, see our documentation on [enabling SMTP on Elastic Metal servers](/compute/elastic-metal/how-to/enable-smtp/) and [enabling SMTP on Public Gateways](/network/public-gateways/how-to/configure-a-public-gateway/#how-to-enable-smtp).
</Message>
