...
The legacy public network is provided through a network component managing a carrier-grade NAT with private IP addresses.
...
The carrier-grade NAT establishes a one-to-one mapping between the public IP and the private IP assigned to the Instance during provisioning. Consequently, if the underlying node changes, the private IP address will also change.
