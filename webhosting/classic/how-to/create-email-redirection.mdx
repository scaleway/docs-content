...
3. Click **Add E-mail Redirection**. 
    ...
    <Lightbox src="scaleway_add_email_redirection.png" alt="" />
...
<Navigation title="See Also">
  <PreviousButton to="/webhosting/classic/how-to/manage-postgresql-database/">How to manage a PostGreSQL database</PreviousButton>
