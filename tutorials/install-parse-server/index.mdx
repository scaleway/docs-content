...
meta:
  ...
  description: This page shows you what steps are required to install a Parse server on a Scaleway Elements Instance.
content:
  h1: Installing Parse Server on Ubuntu 20.04
  paragraph: This page shows you what steps are required to install a Parse server on a Scaleway Elements Instance.
