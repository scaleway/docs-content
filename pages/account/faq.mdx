...
You can get more quotas by adding and verifying your [payment method](/billing/how-to/add-payment-method/) and [identity](/account/setup-lifecycle/verify-identity/).
...
[Closing your account](/account/setup-lifecycle/close-account/#how-to-close-your-account) permanently deletes your Organization, along with its servers, resources, services, and backups.
...
Yes, you can [reopen a closed account](/account/setup-lifecycle/close-account/#how-to-reopen-your-account). However, a closed account's resources are permanently deleted, and you cannot retrieve them.
...
Refer to the [How to delete your account and personal data](/account/setup-lifecycle/close-account/) documentation.
...
### How can I report spam sent to my mailbox?
...
When you report spam, your information is processed in real-time and shared with authorized entities that can take appropriate actions, such as identifying spammers, enforcing legal measures, and blocking harmful URLs. While Signal Spam does not filter emails or act as an antivirus, your reports help improve security measures and contribute to a safer online environment.
...
You can [change your support plan](/account/support/configure-support-plans/) on the support plan page via the Scaleway console.
...
Refer to the [Understanding support plans](/account/support/understanding-support-plans/) reference page for more details about how each plan works.
...
You can create and track your support tickets from the Scaleway console. [Follow this how to](/account/support/open-a-support-ticket/) for more details.
...
If you do not have access to certain Organization resources, you might not have the necessary [IAM](/iam/concepts/glossary/#iam) **permission set**.

[Read the documentation on permission sets](/iam/policies-permissions/permission-sets/) to learn more about the different access levels.
