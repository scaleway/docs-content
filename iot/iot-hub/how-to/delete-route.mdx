...
excerpt: |
  This page explains how to delete an IoT Hub route.
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/iot/iot-hub/how-to/delete-route/
image: /assets/images/docs/scaleway.png
keywords: IoT, delete, Howto
dates:
...
4. Click the <Icon name="more" /> icon next to the route you want to delete, and select **Delete** from the drop-down menu.
    ...
    <Lightbox src="assets/scaleway-iothub_routes_delete.png" alt="" />
...
<Navigation title="See Also">
  <PreviousButton to="/iot/iot-hub/how-to/use-logging-kickstart/">How to use the Logging Kickstart</PreviousButton>
