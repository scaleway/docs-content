---
meta:
  title: &title I am experiencing issues with object versioning
  description: &description Solve issues encountered while using object versioning with Scaleway Object Storage
content:
  h1: *title
