...
In this article, we will learn how to back up data from a Scaleway Instance, using [Scaleway's Object Storage](/object/quickstart/) service and Duplicity. [Duplicity](https://duplicity.gitlab.io/) is a free and open-source tool that backs up folders to a remote server, in this case, an Object Storage bucket. Using libsync and GPG, Duplicity can make space-efficient encrypted backups.
...
Follow the instructions to [create an Object Storage bucket](/object/how-to/create-a-bucket/). This bucket will be used to back up your Instance's data.
