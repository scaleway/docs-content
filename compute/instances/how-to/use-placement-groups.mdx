...
4. Complete the following steps in the wizard: 
    ...
    - Choose the **Policy** for your placement group:
      ...
      - **Optional** ensures that the settings of the placement group are applied wherever possible, but lets Instances boot on hypervisors that don't match the group policy.
