...
<ClickableBanner
  ...
  description="Scaleway is planning to offer pre-installed GitHub and GitLab runners on Mac Mini devices. These runners would be specifically optimized for macOS workflows, providing an efficient and seamless integration into your CI/CD pipelines."
  url="https://forms.gle/oWGkXdtDL5WBU5569"
  label="Fill out the form, if you are interested in learning more" />
