...
5. Click **Enable Edge Services** to confirm.
    ...
    - **If you do not want to use bucket website**: Simply enable Edge Services. If you activate bucket website after this, Edge Services will not be able to serve your bucket website URLs, and will continue to serve the regular bucket URLs.<br /><br />
