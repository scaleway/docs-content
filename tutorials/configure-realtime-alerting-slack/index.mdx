...
excerpt: |
  IoT Hub is very good at dispatching information from your devices, here is how you can use it to publish messages on your corporate Slack workspace.
totalTime: PT30M
image: assets/scaleway_iot_slack.png
keywords: iot, slack, alerting, automation, rest
categories:
  - iot
  - iot-hub
dates:
