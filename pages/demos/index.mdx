...
<Grid>
    <Card
      ...
      url="/account/concepts/quickstart/#console-overview"
      label="See demo"
    />
    <Card
    ...
    <Card
      ...
      url="/iam/credentials/log-in-as-a-member/"
      label="See demo"
    />
</Grid>
...
<Grid>
  <LinksList>
    ...
    - [CPU Instances: console overview](/instances/quickstart/#console-overview)
    ...
    - [IAM: console overview](/iam/concepts/quickstart/#console-overview)
...
<Grid>
  <LinksList>
    ...
    - [How to log in as an IAM Member](/iam/credentials/log-in-as-a-member/)
    - [How to grant access to the Partner Space](/partner-space/how-to/grant-access-to-partner-space/)
    - [How to manage Members](/iam/principals/manage-members/#interactive-demo)
