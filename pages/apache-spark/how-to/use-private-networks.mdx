...
2. Install Python 3.13 if you have not done it yet, then set the environment variables below:
...
3. Run the command below to execute `spark-submit` to calculate pi for 100 iterations. Do not forget to replace the placeholders with the appropriate values.
