...
- Storing of time-related data efficiently
- Providing an interface for basic visualization of the stored data and the possibility to use mathematical functions to sum, group, or scale stored data in real-time.
...
The default behavior is to get the average value when aggregating. This means unlike the most detailed information in the first collection, information is less accurate in the second and third collection.
