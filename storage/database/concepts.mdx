...
A snapshot is a full copy of a **volume** of your Database Instance at a certain point in time. It allows you to recover your volume data, much like [backups](#database-backup), but the snapshotted volume is deployed on a new Database Instance. Snapshots by themselves are not backups, since they are only of particular volumes, but can be used as part of the backup process.
