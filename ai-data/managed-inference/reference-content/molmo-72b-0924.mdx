...
Vision-language models like Molmo can analyze images and offer insights from visual content alongside text. This multimodal functionality creates new opportunities for applications that need both visual and textual comprehension. 
...
One conversation can handle up to 12 images (per request). The 13th will return a 413 error.