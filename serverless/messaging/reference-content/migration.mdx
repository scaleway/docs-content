...
You can recreate your credentials and queues either via the [console](https://console.scaleway.com/) or via the new `v1beta1` API directly. In terms of the API, the [current `v1alpha1`](https://www.scaleway.com/en/developers/api/messaging-and-queuing/) version will continue to be available until the 1st of December 2023. 
