...
The tasks executed by the Cron daemon are referred to as Cronjobs. By operating autonomously, Cronjobs enable the automation of maintenance-centric duties, facilitating the administration of your machines.
...
For more information about CronJobs, refer to the [official documentation](https://manpages.ubuntu.com/manpages/focal/en/man8/cron.8.html).