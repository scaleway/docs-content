...
If you have not created a functions namespace yet, refer to the [Serverless Functions Quickstart](/serverless/functions/quickstart/) documentation. 
...
4. Complete the following steps in the wizard: 
  ...
  - Configure the **scaling** of your function. Define a minimum of 1 instance or more to avoid cold starts.
