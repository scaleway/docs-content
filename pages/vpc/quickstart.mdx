...
<Message type="tip">
If you created your Scaleway [Project](/organizations-and-projects/concepts/glossary/#project) before 13 May 2025, one **default VPC** was automatically created in it for each region (Paris, Amsterdam and Warsaw). [Find out more](/vpc/faq/#what-is-a-default-vpc). 
</Message>
...
You can use the VPC [Network Access Control List](/vpc/reference-content/understanding-nacls/) to limit and restrict certain routes within a VPC. See our [how-to guide](/vpc/how-to/use-network-acl/) to get started.
