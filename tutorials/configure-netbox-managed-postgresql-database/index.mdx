...
tags: netbox dcim ipam database
excerpt: |
...
keywords: cloud tutorials, cloud documentations, cloud server, cloud hosting, ubuntu server, debian server, linux server, IAAS, baremetal, network, router, server, netbox, ipam, dcim
dates:
...
- You have an account and are logged into the [Scaleway Console](https://console.scaleway.com)- You have [configured your SSH Key](console/my-project/how-to/generate-api-key/)
