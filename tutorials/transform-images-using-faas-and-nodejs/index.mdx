...
Please refer to the Serverless Documentation to learn how to package and deploy your functions using [Serverless Framework](/serverless/functions/api-cli/fun-uploading-with-serverless-framework/) or a [zip-file](/serverless/functions/how-to/package-function-dependencies-in-zip/).
