...
- A private [Object Storage bucket](/object/how-to/create-a-bucket/)
- A [Scaleway Database](/postgresql-and-mysql/how-to/create-a-database/)
...
5. Now we can take a look at the variables we added in step 2. Since there are so many variable imbrications it may seem a little overwhelming. However, once the setup is complete you won't need to worry about them anymore:
    ...
    - `AWS_STORAGE_BUCKET_NAME` is the name you gave your [Object Storage bucket](/object/how-to/create-a-bucket/), e.g. `my_awesome_bucket`
