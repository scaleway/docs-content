...
Restoring objects from `GLACIER` to `STANDARD` is also free of charges.
...
It depends on how you will use Object Storage. If you consider that a 3 months old object is rarely used but still has a value, you might want to send it to the Glacier class, for example.
...
For increased security, we recommend encrypt your data before sending them to Scaleway Glacier.
