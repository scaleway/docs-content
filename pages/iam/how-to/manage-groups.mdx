...
2. Click **Delete group**. A warning displays, asking you to confirm your action:
    <Lightbox src={image4} alt="A pop up box displaying a warning: Warning: This will permanently delete your group. This action is irreversible and could delete permissions for group members. Policies attached to users and applications via this group will no longer apply." />
