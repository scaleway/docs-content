...
You are returned to the **Queues** tab, where your newly-created queue's **Overview** page now displays. Here you can see the URL and ARN (Amazon Resource Name) of the queue, to use for your API/CLI operations.
