...
2. Click [Log in as an IAM Member](https://account.scaleway.com/member-login?redirectToUrl=https://console.scaleway.com/).
    <Message type="important">
      Logging into an Organization as a Member is different from logging in as an Owner. To perform a non-Member login, you can follow the procedure described in the [How to log into the console](/account/login-credentials/log-in-to-the-console/) documentation page.
    </Message>
3. Enter the Organization ID and click **Continue**.
    <Message type="important">
      ...
      - If your Organization admin provided a [link to connect directly](/organizations-and-projects/organization/set-organization-alias/) to your Organization, you can disregard step 3.
    </Message>
      ...
      3. Enter the code you received in your email.
          <Message type="tip">
            If you did not receive the email you can follow these steps, in order:
              ...
              - If none of the actions above work, ask an administrator to [contact the support](/account/support/open-a-support-ticket/#writing-an-effective-subject-and-description)
          </Message>
      4. Click **Continue**.
      </TabsTab>
