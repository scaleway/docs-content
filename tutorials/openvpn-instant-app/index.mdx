...
content:
  h1: One-click OpenVPN deployment on Scaleway Instances using InstantApp
  paragraph: Learn how to get started with OpenVPN on Scaleway Instances using the OpenVPN InstantApp. Follow our step-by-step guide for a seamless VPN setup.
