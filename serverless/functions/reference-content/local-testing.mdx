...
Performance during local testing can differ from the deployed Serverless Functions environment, and will involve [limitations](/functions/reference-content/functions-limitations/) around resource usage and quotas.
