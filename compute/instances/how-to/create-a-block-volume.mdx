...
<Message type="tip">
  You can also [create](/block/how-to/create-a-volume/) Block Storage volumes from the [Block Storage console section](https://console.scaleway.com/block-storage/).
</Message>