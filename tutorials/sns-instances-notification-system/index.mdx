...
2. From the [Instances section](https://account.scaleway.com/?service=elementsinstance/servers) of the Scaleway console, access and copy the public IP address of the Instance we created via Terraform/OpenTofu (identifiable from its name: `subscriber_server`).
