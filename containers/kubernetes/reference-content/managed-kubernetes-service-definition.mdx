...
<Lightbox src="scaleway-managed-kubernetes-schema.webp" alt="" size="large" />

<Message type="important">
  Scaleway is committed to provide updates on the products lifecycle as follows:

  - Notification of feature deprecation will be announced in the [changelog](/changelog/).
...
<Message type="important">
  Scaleway will announce feature deprecations in the [changelog](/changelog/) and communicate feature End of Life (EOL) via support tickets and [scheduled maintenance notices](https://status.scaleway.com/). When a feature reaches EOL, it might be removed or migrated, but service continuity is not guaranteed. Users have to monitor updates and actively engage in transition plans to avoid service disruptions.
</Message>
