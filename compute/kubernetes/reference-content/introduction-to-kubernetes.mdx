...
excerpt: |
  Kubernetes (K8s) is an open-source platform for managing containerized workloads and services. This page explains the concept and the different compartments of Kubernetes.
totalTime: PT30M
steps:
  - step: From Traditional Deployment to Containerized Deployment
    type: HowToStep
    url: https://www.scaleway.com/en/docs/compute/kubernetes/reference-content/introduction-to-kubernetes/#-From-Traditional-Deployment-to-Containerized-Deployment
  - step: Kubernetes Architecture
    type: HowToStep
    url: https://www.scaleway.com/en/docs/compute/kubernetes/reference-content/introduction-to-kubernetes/#-kubernetes-components
  - step: Kubernetes Objects
    type: HowToStep
    url: https://www.scaleway.com/en/docs/compute/kubernetes/reference-content/introduction-to-kubernetes/#-kubernetes-objects
  - step: Going further?
    type: HowToStep
    url: https://www.scaleway.com/en/docs/compute/kubernetes/reference-content/introduction-to-kubernetes/#-going-further
categories: 
  - compute
  - kubernetes
image: /assets/images/docs/scaleway.png
keywords: cloud tutorials, cloud documentations, cloud server, cloud hosting, ubuntu server, debian server, linux server, IAAS, baremetal, scalability, ARM, physical server, dedicated server, kubernetes, k8s, orchestration, cloud, scaling
---


[Kubernetes (K8s)](https://kubernetes.io/) is an open-source platform for managing containerized workloads and services. Google initially developed the project and it has been made publicly available in 2014. Since then, it has a vast, rapidly growing ecosystem. The name Kubernetes derivates from the ancient Greek word meaning helmsman or pilot.
...
<Lightbox src="scaleway-deployment_evo.png" alt="" />
...
Each machine in a Kubernetes cluster has a given role within the Kubernetes ecosystem. One of these servers acts as the **master** server, the "brain" of the cluster exposing the different APIs, performing health checks on other servers, scheduling the workloads and orchestrating communication between different components.
...
The [cloud-controller-manager](https://kubernetes.io/docs/tasks/administer-cluster/running-cloud-controller/) is a master component that maps generic representations of resources to actual resources, provided by non-homogeneous cloud providers.
...
Kubernetes uses its own volumes abstraction, allowing data to be shared by all containers and remain available until the pod is terminated.
...
* [Discover how to deploy your first Kapsule on Scaleway Elements](/compute/kubernetes/how-to/create-cluster)
* [Deploy your first Kapsule on Scaleway Elements](https://console.scaleway.com/kapsule/)
* Learn mode about Kubernetes, by reading the [official documentation](https://kubernetes.io/docs/home/)
