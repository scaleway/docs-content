...
Access control list (ACL) rules [define permissions for remote access to a Database Instance](/managed-database/postgresql-and-mysql/how-to/manage-allowed-ip-addresses/). A rule consists of an IP address or an IP range.
