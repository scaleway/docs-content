...
4. Create the Dockerfile. This is a text file which gives instructions for building the Docker image for the application. Create it in the same directory as `myapp.py` with the following command
...
7. Run the following command to run the image. This tells Docker to instanciate and execute the image, launching a container instance of our application:
...
- [Getting started with Kubernetes: Part 1 - Containers & Docker [VIDEO TUTORIAL]](TODO LINK)
...
- [Docker Cheat Sheet](https://www.docker.com/sites/default/files/d8/2019-09/docker-cheat-sheet.pdfwhat)
