...
meta:
  ...
  description: This section provides information on how data is encrypted with Secret Manager
content:
  h1: Secret encryption with Scaleway's Secret Manager
  paragraph: This section provides information on how data is encrypted with Secret Manager
