...
If you plan to use a dedicated application or service account with a custom [IAM policy](/iam/policies-permissions/create-policy/), the minimum set of permissions required is:
...
See [How to create API keys](/iam/credentials/create-api-keys/) in the IAM documentation for details.
