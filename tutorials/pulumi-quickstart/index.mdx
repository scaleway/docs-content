...
image: /assets/pulumi-home.webp
dates:
  validation: 2022-07-22
  posted: 2022-07-22
---

<Lightbox src="pulumi-home.webp" alt="" />
...
3. Add the Scaleway provider
  ...
  ```
  $ npm install @jaxxstorm/pulumi-scaleway@0.3.0 --save --save-exact
  ```
...
You got a first impression on the lifecycle of an infrastructure using Pulumi. There are many more aspects to discover. Check the official Pulumi [docs](https://www.pulumi.com/docs/) to find out more.
