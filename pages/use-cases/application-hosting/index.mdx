...
<Grid>
    <SummaryCard
        ...
        description="Explores best practices and architectural principles for achieving high availability and resilience in application hosting on Scaleway."
        label="Read more"
        url="/use-cases/application-hosting/high-availability-resilience"
    />
    <SummaryCard
