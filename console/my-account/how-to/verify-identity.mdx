...
excerpt: |
  This page explains how to verify your identity
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/console/my-account/how-to/verify-identity
...
3. Select the country/region of issue and the type of your identity document.
  <Lightbox src="scaleway-choose-country-of-issue.png" alt="" />
