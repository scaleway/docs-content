...
You need to [add SPF and DKIM records](/transactional-email/how-to/configure-bimi/) to be able to send emails. Find out [how to set up your DNS records for other DNS providers](/tutorials/set-up-spf-dkim-for-dns-providers/).
