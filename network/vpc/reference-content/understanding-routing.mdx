...
Routing is activated by default whenever you create a new VPC, and can be activated on pre-existing VPCs by [following these steps](/network/vpc/how-to/manage-routing/#how-to-activate-routing). More routing features are planned for the future, such as the ability to create custom routes.
...
TO DO UPDATE WITH CUSTOM ROUTE
