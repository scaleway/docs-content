...
meta:
  ...
  description: Learn how to create a secret and migrate your secret into another path with the CLI and Go
content:
  h1: Creating and migrating a secret into a specific path using the CLI and Go
  paragraph: Learn how to create a secret and migrate your secret into another path with the CLI and Go
