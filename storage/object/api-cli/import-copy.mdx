...
<Message type="important">
  Before importing a copy, make sure all the source bucket's objects are in one of the two classes: `STANDARD` or `ONEZONE_IA` (only available in FR-PAR). If an object is in `GLACIER` class, the copy import will fail. To learn how to edit storage classes, refer to this [documentation page](/storage/object/how-to/edit-storage-class).
</Message>
