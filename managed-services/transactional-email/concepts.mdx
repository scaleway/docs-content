...
An aggregate report is a periodic summary of positive and negative DMARC results.
...
A forensic report or failure report, is a detailed record of an email message that has failed DMARC authentication. It provides nearly immediate detailed information about
