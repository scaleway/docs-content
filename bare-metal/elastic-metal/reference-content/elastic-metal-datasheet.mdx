...
It is important to note that both internet and Private Networks use the same physical network interface.
</Message>
...
| **RAM**               | 1536 GiB DDR4 ECC                 |
| **PMEM**              | 6144 GiB Intel Optane             |
| **Disk**              | 2 x 800 GB SSD SATA<br />6 x 3.2 TB NVMe |
| **Max. NIC bandwidth**| 10 Gbps                           |
| **Public bandwidth**  | 10 Gbps                           |
| **Private bandwidth** | 10 Gbps                           |
| **Availability Zones**| PARIS 2                           |
