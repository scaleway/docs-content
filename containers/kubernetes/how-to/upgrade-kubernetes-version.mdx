...
You can [apply the latest patches](#applying-patches-to-your-cluster-from-the-scaleway-console) to your Kubernetes cluster directly from the Scaleway console. If you want to [upgrade your cluster to the next minor release](#upgrading-to-the-next-minor-version-using-the-cli), you can achieve this using the CLI.

## Applying patches to your Cluster from the Scaleway console
...
## Upgrading to the next minor version using the CLI
