...
Read on to learn how to install Python on your computer, and learn and practice some of the basic concepts of this programming language. When you're done, you can move on to the [second tutorial in this series](/tutorials/python-lists-dicts).
