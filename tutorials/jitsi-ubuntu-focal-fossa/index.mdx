...
<Message type="requirement">
  ...
  - You have a [Scaleway Instance](/compute/instances/how-to/create-an-instance/) running Ubuntu Focal Fossa (for improved performance, we recommend you use an Instance with **at least 4 GB of RAM**)
