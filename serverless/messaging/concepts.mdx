...
meta:
  ...
  description: Understand the core concepts of Scaleway Messaging and Queuing. Explore fundamental principles for efficient message handling and service optimization.
content:
  h1: Messaging and Queuing - Concepts
  paragraph: Understand the core concepts of Scaleway Messaging and Queuing. Explore fundamental principles for efficient message handling and service optimization.
categories:
  -
...
SQS/SNS was previously a [namespace](#namespace) type available for Scaleway Messaging and Queuing. The two protocols have now been separated, and are activated and deactivated separately.
