...
excerpt: |
  This page explains how to configure a flexible IP on a Bare Metal Cloud Server
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
...
- You have [attached a flexible IP address](/compute/bare-metal-cloud/how-to/attach-flexible-ip) to your Bare Metal server
