...
3. Run the following command to verify that the backup was successful:
    ...
    Alternatively, you can access your bucket via the [Scaleway console](https://account.scaleway.com/?service=elementsobject-storage/buckets/). You can find the snapshots of your directory in the `/snapshots` folder.
