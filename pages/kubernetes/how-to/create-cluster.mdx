...
1. Configure the following for each pool:
    ...
    * Enter the name of the pool and optional tags. 
...
3. Specify a key-value pair and an effect:
    ...
    - **Value**: An optional string that further qualifies the taint. It allows you to identify taints that share the same key but represent different situations.
