...
excerpt: |
  This page explains how to migrate your Dedibox server
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/dedibox/dedicated-servers/how-to/migrate-server
image: /assets/images/docs/scaleway.png
keywords: console, my-account, Howto, migrate
dates:
...
- [Use Rsync](https://documentation.online.net/en/dedicated-server/tutorials/network/rpn-rsync)
