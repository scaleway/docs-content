...
For example if you build an image using an ARM CPU (for example on Apple Silicon) your image will be in the `arm64` architecture and you will have
and error message on deployment step.
