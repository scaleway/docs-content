...
- Have [activated traces](/observability/cockpit/how-to/activate-push-traces) if you want to create a token to push [traces](/observability/cockpit/concepts/#traces)
