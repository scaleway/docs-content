...
3. Complete the following steps of the wizard:
    ...
    * Choose a **Cluster Type**. This can be Kubernetes Kapsule or Kubernetes Kosmos.
      ...
      * **Kubernetes Kosmos** allows you to attach a Compute Instance or dedicated server from any Cloud provider to a Scaleway Kubernetes control plane.
      ...
      This document concerns the creation and management of a **Kubernetes Kosmos** cluster. To create a Kubernetes Kapsule Cluster, refer to the [alternative documentation](/containers/kubernetes/how-to/create-cluster)
...
4. Click **Create a Cluster** to create your cluster without any Scaleway pools. If you choose this option, your cluster and its control plane are deployed, and you are taken to the cluster's overview tab. Continue to [How to manage your Kubernetes Kosmos cluster](/containers/kubernetes/how-to/edit-kosmos-cluster) to find out how to add multi-cloud pools to your cluster.
