...
4. Once the job run is done, click **Show Markdown** in the **INFO** column to display a preview of the title, author, and URL of the top HackerNews articles. 
...
- Export variables
- do not reuse tags for the image
- make sure the assets and init file are properly configured (refer to example in repo)
