...
5. Save your changes.
    ...
    <Message type="note">
    If you do not wish to receive emails on your domain, you can also [add a null MX record](/managed-services/transactional-email/how-to/add-mx-record-to-your-domain/#how-to-add-a-null-mx-record).
    </Message>
