...
<Message type="requirement">
  ...
  - Your Scaleway Dedibox server fufils the hardware requirements of the [HyperV version](https://docs.microsoft.com/en-us/windows-server/virtualization/hyper-v/system-requirements-for-hyper-v-on-windows) used by you
</Message>
...
10. Assign a virtual MAC address to the failover IP from the [Dedibox Console](https://console.online.net/) to make sure that the virtual machine is able to communicate on the Internet. Refer to the [dedicated documentation](/bare-metal/network/reference-content/create-virtual-mac/) for more information about how to create a virtual MAC address. Click **Settings** in the VM section of the menu.
