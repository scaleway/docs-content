...
description: This page shows you how to use the Discourse forum instant app on your virtual instance.
tags: compute forum apps discourse
steps:
  - step: Installing Discourse
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/discourse-forum/#-Installing-Discourse
  - step: Configuring the Admin User
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/discourse-forum/#-Configuring-the-Admin-User
  - step: Configuring Discourse
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/discourse-forum/#-Configuring-Discourse
categories:
  - compute
  - instances
...
1. Once the installation is complete, open your web browser and go to your discourse subdomain (i.e. `https://discourse.example.com`). The configuration wizard displays. Click **Register** to create the first (admin) user:
  ...
  <Lightbox src="scaleway-discourse01.png" alt="" />
...
2. Enter an identifier and a secret password for the new user. Make sure that your email address is valid, as you will receive a confirmation link in this mailbox. Click **Register** to continue:
  ...
  <Lightbox src="scaleway-discourse02.png" alt="" />
