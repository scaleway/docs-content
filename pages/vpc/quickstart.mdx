...
import image2 from './assets/scaleway-default-vpc.webp'
...
<Lightbox src={image} alt="A diagram shows that several Private Networks exist within a single VPC" size="small" />
