...
#### Understanding Water Usage Effectiveness

Water Usage Effectiveness (WUE) is a metric used to measure the water consumption efficiency of a datacenter. It is defined as the amount of water used by a datacenter in liters, per kilowatt-hour (kWh) of energy consumed.
...
#### How to calculate water consumption for each Scaleway service
