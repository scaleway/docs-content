...
Object visibility specifies whether your object is visible to others or not, independently from [bucket visibility](/object/concepts/#visibility).
...
<Message type="tip">
If you upload a file using the CLI, you can make it public by using the `--acl public-read` parameter. However, [bucket policies](/object/api-cli/bucket-policy/) take precedence over ACLs.
</Message>

## Manage the visibility of multiple objects

You can manage the visibility of multiple ojects at a time using a [bucket policy](/object/api-cli/bucket-policy/) as shown below. By allowing [GetObject](/object/api-cli/object-operations/#getobject) operations to everyone, the desired objects can be accessed by any person with the link to the object.
