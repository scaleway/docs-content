...
<Message type="important">
  ...
  * This documentation addresses the setup of a /48 IPv6 network on your Dedibox. If you intend to utilize only the SLAAC IP address, no additional configuration is necessary, and your machine can acquire its IP address automatically.
</Message>
