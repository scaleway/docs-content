---
meta:
  title: Deploy GitLab repository manager InstantApp on Scaleway in a few clicks
...
content:
  h1: Deploy GitLab repository manager InstantApp on Scaleway in a few clicks
