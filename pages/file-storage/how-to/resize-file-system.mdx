...
<Message type="note">
You can also resize a file system from the [File Storage section](https://account.scaleway.com/?service=elementsfile-storage/) of the console, by clicking <Icon name="more" /> next to its name, and by selecting **Resize** from the drop-down menu.
</Message>