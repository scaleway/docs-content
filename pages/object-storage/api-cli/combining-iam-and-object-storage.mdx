...
Note that all principals with Object Storage access will have access to all Object Storage resources at the Project level. However, once you configure a bucket policy to restrict access to any principal, all other principals that need to keep access must now explicitly be granted access via the bucket policy.
