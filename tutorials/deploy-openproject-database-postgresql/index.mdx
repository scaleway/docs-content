...
Follow the instructions to [create a Database Instance](/en/docs/managed-database/postgresql-and-mysql/how-to/create-a-database/). Ensure that you select **PostgreSQL** as the database engine.
