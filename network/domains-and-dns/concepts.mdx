...
<Concept>
  ...
  A fully qualified domain name, also known as "absolute domain name", is a complete domain name that allows computers and servers connected to the internet to have unique identities and a location within the internet framework.
  A FQDN consists of a **hostname**, a **subdomain**, a **second-level-domain**, a **top-level domain (TLD)** and a **trailing dot**.
...
<Concept>
  ...
  In the [DN](#dns) hierarchy, a top-level domain is the last part of text in a domain name. For instance, in the domain name `mydomain.com`, **.com** is the top-level domain.
