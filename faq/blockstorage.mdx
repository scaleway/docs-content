...
Block Storage volumes are compatible with [Scaleway Instances](/instances/), [Managed Dabatase for PostgreSQL and MySQL](/postgresql-and-mysql/), and [Kubernetes](/kubernetes/) Kapsule clusters.
...
1. [Export a snapshot of your Block Storage volume](/instances/api-cli/snapshot-import-export-feature/#exporting-snapshots).
2. [Import the snapshot into a new Low Latency volume](/instances/api-cli/snapshot-import-export-feature/#importing-snapshots).
...
Find out about the [advantages of migrating the management of your volumes and snapshots](/block/reference-content/advantages-migrating-to-sbs) from the Instance API to the Block Storage API.
