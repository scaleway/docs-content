...
1. Click **Elastic Metal** in the **Bare Metal** section of the [Scaleway console](https://account.scaleway.com/?service=elements) side menu. This opens the Elastic Metal dashboard.
