...
<Message type="note">
  If you do not have a Database for PostgreSQL yet, [create a new one](/managed-databases-for-postgresql-and-mysql/how-to/create-a-database/) from your [Scaleway console](https://account.scaleway.com/?service=elementsrdb/instances).
</Message>

1. Enter the Database section of the [Scaleway console](https://account.scaleway.com/?service=elementsrdb/instances).
...
<Message type="note">
  If you do not have a Database for MySQL yet, [create a new one](/managed-databases-for-postgresql-and-mysql/how-to/create-a-database/) from your [Scaleway console](https://account.scaleway.com/?service=elementsrdb/instances).
</Message>
