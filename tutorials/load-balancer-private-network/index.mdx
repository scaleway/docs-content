...
Create or clone your virtual machines on both servers of the cluster to distibute the load between them using a Load Balancer. Your virtual machines can use the Public Gateway and dynamic NAT to communicate with the Internet for downloads and updates. If you want to expose certains ports of your VMs directly, configure [static NAT rules](/network/vpc/how-to/configure-a-public-gateway/#how-to-review-and-configure-nat)) for them. 
