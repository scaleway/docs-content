...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/hardware/reference-content/supermicro/">How to use the Supermicro KVM</PreviousButton>
  <NextButton to="/bare-metal/hardware/reference-content/quantaplex/">How to use the QuantaPlex KVM</NextButton>
</Navigation>