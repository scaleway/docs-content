...
## Creating the NextCloud Instance
...
5. Select the **NextCloud** image in the **InstantApps** tab.
    <Lightbox src="scaleway-instantapp-nextcloud.webp" alt="" />
...
2. The MySQL user, password, and database name is shown in the MOTD message that displays upon your first connection to the server:
    ```
    ################### NEXTCLOUD ###################
    ...
    #################################################
    ```
3. Open a web browser and enter the NextCloud URL visible in the MOTD in the navigation bar of it. NextCloud's installation script displays.
