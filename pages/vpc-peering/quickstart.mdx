...
<Message type="note">
VPC Peering is currently in Public Beta, and available only via he Scaleway API. For specific API calls, read refer to the [VPC Peering API documentation](https://www.scaleway.com/en/developers/api/TODOLINK/). 
</Message>
