...
3. Select **Yes** for **Enabled**, then click **Save**.

## Configure the user mapping in the Entra ID application

The Scaleway SCIM implementation does not support all the default object and attribute values in Microsoft Entra ID. Configure the following parameters.
