...
meta:
  ...
  description: This page shows you how to get started with the billing of your Scaleway account.
content:
  h1: Billing - Quickstart
  paragraph: This page shows you how to get started with the billing of your Scaleway account.
