...
2. Type the following command in your terminal to create an Instance: 
 ...
 - If you want to know what different types of Instances are available in a given zone, use the following command:`scw instance server-type list zone=xx-xxx-x`. For example, if you want to see the availability for Instances in Paris, use `scw instance server-type list zone=fr-par-1`.

  </Message>


## Creating an Instance volume
...
1. Type the following command in your terminal and replace "you-server" with your server's ID. 
