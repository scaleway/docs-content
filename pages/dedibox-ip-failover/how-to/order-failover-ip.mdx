...
1. In your [Dedibox console](https://console.online.net/en/login), click **Server** to display a list of your dedicated servers. Then click on the server you want to configure.
