...
Once you create a cluster in Kapsule, all nodes, particularly those with the Private Network feature enabled, are protected by a security group named `Kapsule default security group`. Any changes made to this security group will apply to all nodes in the cluster.
