...
meta:
  ...
  description: Let us address the most common questions you have about Container Registry.
content:
  h1: Container Registry
  paragraph: Let us address the most common questions you have about Container Registry.
image: containerregistry.png
---
...
Each Namespace has a unique name in each Availability Zone. If the Namespace's name is already taken it would not be available any longer.
