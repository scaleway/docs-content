...
Due to the nature of serverless computing, Serverless Functions not have dedicated or predictable IP addresses assigned to them. This means you cannot whitelist specific IPs for your Serverless Functions.
