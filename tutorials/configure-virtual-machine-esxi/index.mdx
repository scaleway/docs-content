...
<Message type="important">
  VMware has been acquired by Broadcom and free ESXi licenses have been discontinued. For details, see [here](https://knowledge.broadcom.com/external/article?legacyId=2107518). This content is provided as-is with no guarantee of functionality. Consider using alternative hypervisors like Proxmox. Learn more [here](/tutorials/configure-failover-proxmox/).
</Message>
