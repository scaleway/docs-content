...
DHCP is activated on your network, and attached resources will receive dynamically assigned static IP addresses no later than one hour from the time of activation. You can view their IP addresses by [following this procedure](/network/vpc/how-to/attach-resources-to-pn/#how-to-view-the-resources-ip-address).
