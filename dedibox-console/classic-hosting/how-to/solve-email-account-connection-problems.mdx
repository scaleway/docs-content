...
<Navigation title="See Also">
  <PreviousButton to="/dedibox-console/classic-hosting/how-to/manage-email-filter/">How to manage email filters</PreviousButton>
  <NextButton to="/dedibox-console/classic-hosting/how-to/configure-htaccess-file/">How to configure an htaccess file</NextButton>
</Navigation> 
