...
1. Click **Container Registry** in the **Containers** section of the [Scaleway console](https://account.scaleway.com/?service=elements) side menu. If you do not have a Registry already created, the product creation page is displayed.
...
1. Navigate to **Kubernetes** under the **Containers** section of the [Scaleway console](https://account.scaleway.com/?service=elements) side menu. The Kubernetes dashboard displays.
...
- **Scaleway Support**: Reach out via your [Scaleway console support](https://account.scaleway.com/?service=elementssupport) options.
