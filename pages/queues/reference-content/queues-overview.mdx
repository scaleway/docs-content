...
Credentials are scoped to your Scaleway Queues service at [Project](/organizations-and-projects/concepts/glossary/#project)-level. You can choose to give each set of credentials the required level of permissions:
