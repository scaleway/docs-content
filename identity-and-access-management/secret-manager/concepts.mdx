...
<Message type="important">
  - A path name can only contain 1 to 255 alphanumeric characters, dots, underscores and dashes.
  - If you leave the path name field empty when creating your folders or secrets, the default path will be `/`. Your secrets and folders will be under the `/` path.
</Message>
