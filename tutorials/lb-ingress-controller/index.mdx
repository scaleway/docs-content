...
The "normal" behavior, in this case, is that a new public IP will be associated with this LoadBalancer. This means that if you want to create a DNS record with that IP, for instance, you have to do it every time you spawn a new LoadBalancer. 
...
To create a secret key, use the following [tutorial](/identity-and-access-management/iam/how-to/create-api-keys/):
