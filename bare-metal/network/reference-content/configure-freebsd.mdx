...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/network/reference-content/configure-debian-ubuntu">How to configure a failover IP on Debian/Ubuntu</PreviousButton>
  <NextButton to="/bare-metal/network/reference-content/configure-windows">How to configure a failover IP on Windows Server</NextButton>
</Navigation>
