...
<Tabs>
  ...
  <TabsTab label="Linux Instances">
    ...
    <TabsTab label="Windows Instances">
      ...
      4. Click **Get password** to retrieve the password for your Instance. A popup will display a command for retrieving your initial password using the Scaleway CLI:
          ```bash
