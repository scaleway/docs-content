...
Upon activation, we automatically assign your hosting a dedicated IP after verifying it is not blocked. Deactivating the option triggers a similar check. If the IP is clean, it will automatically be removed from your account. Otherwise, [contact our Support team](https://console.scaleway.com/support/tickets) to address any issues.
