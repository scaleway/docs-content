...
Audit logs are enabled by default for Kubernetes clusters with [dedicated control planes](/kubernetes/reference-content/kubernetes-control-plane-offers/). 
...
Find more information in our [dedicated documentation](/kubernetes/how-to/access-audit-logs/)
