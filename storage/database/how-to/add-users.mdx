---
title: How to add users to a Managed Database
description: This page explains how to add users to a Managed Database
excerpt: |
  This page explains how to madd users to a Managed Database
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/storage/database/how-to/add-users
image: /assets/images/docs/scaleway.png
keywords: Database, users, Howto
dates:
...
<Navigation title="See Also">
  <PreviousButton to="/storage/database/how-to/create-a-database/">How to create a database</PreviousButton>
