...
meta:
  ...
  description: This page shows you how to a Ruby on Rails application on Scaleway using nginx, rbenv, puma, PostgreSQL and systemd on Ubuntu 18.04
content:
  h1: Deploying a Ruby on Rails application on Scaleway
  paragraph: This page shows you how to a Ruby on Rails application on Scaleway using nginx, rbenv, puma, PostgreSQL and systemd on Ubuntu 18.04
