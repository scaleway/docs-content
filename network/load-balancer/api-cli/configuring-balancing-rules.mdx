...
For help on possible parameter values see the [API documentation](https://www.scaleway.com/en/developers/api/load-balancer/zoned-api/#path-backends-create-a-backend-for-a-given-load-balancer). For assistance with configuring backends generally, see our [dedicated documentation]](https://www.scaleway.com/en/docs/network/load-balancer/reference-content/configuring-backends/).
