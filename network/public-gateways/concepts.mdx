...
The **D**omain **N**ame **S**ystem (DNS) is a naming system for devices connected to the Internet or Private Networks. Most prominently, DNS servers translate text-based domain names (eg www.scaleway.com) to numerical [IP addresses](#ip-address) eg (51.158.66.220). 
