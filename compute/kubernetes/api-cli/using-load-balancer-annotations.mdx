...
You can get a list of working annotations in the Scaleway Load Balancer [documentation](https://developers.scaleway.com/en/products/lb/zoned_api/#post-db0bfe) annotations are:
