...
meta:
  title: Block Storage
  description: Discover the differences between file storage and Block Storage and get answers to your performance and security concerns. 
content:
  h1: Block Storage
  paragraph: Discover the differences between file storage and Block Storage and get answers to your performance and security concerns. 
image: blockstorage.png
---
