...
To do this, you need to have several [failover IPs](/ip-failover/concepts/#failover-ips) at the same server and at least one [virtual MAC](/ip-failover/concepts/#virtual-mac-address) associated with one of these failover IPs.
...
- At least 2 [failover IPs](/ip-failover/concepts/#failover-ips)
- Generated a [virtual MAC address](/ip-failover/concepts/#virtual-mac-address)
