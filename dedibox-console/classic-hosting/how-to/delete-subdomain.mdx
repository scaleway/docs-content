...
<Navigation title="See Also">
  <PreviousButton to="/dedibox-console/classic-hosting/how-to/create-subdomain/">How to create a subdomain</PreviousButton>
  <NextButton to="/dedibox-console/classic-hosting/how-to/configure-backup-option/">How to configure the backup option</NextButton>
</Navigation> 
