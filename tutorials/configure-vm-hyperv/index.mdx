...
3. Click **I ACCEPT** once you have read and agreed to the terms displayed. You are then redirected to your server's status page.
...
2. Click **Next** to begin with the configuration of the new virtual machine:
