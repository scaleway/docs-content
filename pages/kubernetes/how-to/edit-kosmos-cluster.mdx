...
You can add nodes and pools to your Kosmos cluster from the [Scaleway console](https://account.scaleway.com/?service=elements) or by using the [API](https://www.scaleway.com/en/developers/). Here, we show you how to edit from the console.
...
1. Click **IAM & API keys** on the top-right drop-down menu of the Scaleway console. The [Identity and Access Management dashboard](https://account.scaleway.com/?service=elementsiam/) displays.
