...
It is not currently possible to move your flexible IPs between different products. Each set of flexible IPs you hold is independent and usable only with the specific product. An Instance's flexible IPs cannot be attached to Elastic Metal servers and vice versa.
