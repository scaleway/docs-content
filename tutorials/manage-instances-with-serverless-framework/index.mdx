...
For this example we will use Scaleway SDK and Scaleway console, for more information please refer to the [Python SDK Documentation](https://github.com/scaleway/python-scaleway) and the [package your function and upload it as a zip-file page](/serverless/functions/how-to/package-function-dependencies-in-zip/) how to.
