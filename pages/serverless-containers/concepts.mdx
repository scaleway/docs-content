...
Autoscaling parameters are [min-scale](/serverless-containers/concepts/#min-scale) and [max-scale](/docs/serverless-containers/concepts/#max-scale), scaling policies available are:
