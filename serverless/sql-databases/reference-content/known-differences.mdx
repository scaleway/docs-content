...
Serverless SQL Databases support the most popular PostgreSQL extensions. Refer to the [dedicated documentation](/sql-databases/reference-content/supported-postgresql-extensions/) for more information. 
