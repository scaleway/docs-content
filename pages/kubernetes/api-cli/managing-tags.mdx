...
content:
  ...
  paragraph: Learn how to manage tags and labels in Scaleway Kubernetes with the Cloud Controller Manager (CCM). Synchronize Scaleway Instance tags with Kubernetes labels and taints for efficient cluster management.
