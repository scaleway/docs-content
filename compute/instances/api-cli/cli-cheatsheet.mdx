...
meta:
  ...
  description: This page shows you the basic CLI commands to use Scaleway Instances.
content:
  h1: Scaleway Instances CLI Cheatsheet
  paragraph: This page shows you the basic CLI commands to use Scaleway Instances.
tags: instance
categories: 
  - compute
  - instance-dev
...
This page shows the most common Scaleway CLI commands to use Instances.
