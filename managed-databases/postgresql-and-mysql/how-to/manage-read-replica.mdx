...
6. Go back to the list of your Database Instances. The promoted Read Replica appears.
    <Message type="important">
      The new node originating from the Read Replica promotion will bear the prefix `promoted`, followed by the name of the original Database Instance that was replicated. You can change the name of your Database Instance on its overview page anytime. To do so, click <Icon name="edit" /> next to its name.
    </Message>
