---
title: Dedibox Dedicated Server Quickstart
description: This page explains how to get started with Dedibox dedicated servers
excerpt: |
  This page explains how to get started with Dedibox dedicated servers
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
...
3. If / when prompted, allow connection to the host by typing `yes`, then press **Enter**.
  ```
  The authenticity of host 'myhost.ext (212.47.226.35)' can not be established.
...
2. Launch PuTTy on your computer. The main screen of the application displays:
   ...
   <Lightbox src="scaleway-putty-main.png" alt="" />
...
7. Click **OK** to confirm.
   ...
   <Lightbox src="scaleway-putty-security.png" alt="" />
