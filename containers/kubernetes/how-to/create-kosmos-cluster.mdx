...
4. Click **Create cluster** to create your cluster without any Scaleway pools. If you choose this option, your cluster and its control plane are deployed, and you are taken to the cluster's overview tab. Continue to [How to manage your Kubernetes Kosmos cluster](/containers/kubernetes/how-to/edit-kosmos-cluster) to find out how to add multi-cloud pools to your cluster.
