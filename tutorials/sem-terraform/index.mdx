...
<Message type="requirement">
 - You have an account and logged into the [Scaleway console](https://console.scaleway.com/)
 - You have created an [API key](/identity-and-access-management/iam/how-to/create-api-keys/)
 - You have [configured your environment variables](/developer-tools/devtools/reference-content/environment-variables/#recommended-scaleway-configuration-file)
</Message>
...
4. Type `yes` and `Enter` when prompted to enter a value. An output similar to the following displays:
    ...
    database_public_endpoint = tolist([
      {
        "endpoint_id" = "2e7f8138-15c8-4dbc-be4c-f932a33e8910"
        "hostname" = ""
        "ip" = "51.158.58.102"
        "name" = ""
        "port" = 2255
...
6. Run the following command:
    ...
    ```bash
    DEFAULT REGION: fr-parSuccessfully connected!
    ```
