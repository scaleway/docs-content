...
Scaleway's Key Manager allows you to create key encryption keys from the [Scaleway console](https://account.scaleway.com/?service=elements). Key encryption keys can then be used to encrypt and decrypt your encrypted data.
...
1. Click Key Manager in the **Security and Identity section** of the [Scaleway console](https://account.scaleway.com/?service=elements) side menu.
2. Click **+ Create key**.
