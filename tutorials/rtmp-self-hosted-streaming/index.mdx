...
content:
  h1: Setting up a RTMP streaming server on a Scaleway Instance
  paragraph: This page shows you how to set up a self-hosted streaming server on a Scaleway Instance.
categories:
  - instances
