...
There are a number of different ways to expose your cluster to the internet. In this document, we explain and compare some of the different ways to do so, and provide information to help you get started.
...
<Lightbox src="scaleway-nodeport-diag.webp" alt="" />
...
<Lightbox src="scaleway-lb.webp" alt="" />
...
<Lightbox src="scaleway-ingress.webp" alt="" />
...
- [Using a Load Balancer to expose your Ingress Controller](/containers/kubernetes/how-to/lb-ingress-controller/)
