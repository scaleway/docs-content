...
<ClickableBanner
    productLogo="cli"
    title="MessageQ Developer Reference"
    description="Learn how to manage your Cloud Essentials for RabbitMQ endpoints through the Scaleway MessageQ API."
    url="https://www.scaleway.com/en/developers/api/messageq/"
    label="Go to MessageQ API"
/>
