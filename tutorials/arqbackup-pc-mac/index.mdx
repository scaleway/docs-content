...
8. Enter the Object Storage credentials:
    ...
    - **Access key ID:** The [access key](/iam/credentials/create-api-keys/) of the API key used for authentication
    - **Secret key:** The [secret key](/iam/credentials/create-api-keys/) of the API key used for authentication
