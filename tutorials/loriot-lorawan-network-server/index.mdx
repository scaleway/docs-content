...
First, we need to create a Hub. Its role will be to distribute messages from your LoRaWAN© devices to the intended targets. Follow [this procedure](/managed-services/iot-hub/how-to/create-hub/) to create an IoT Hub if you don't have one already. The hub's name and plan does not matter for this tutorial.
