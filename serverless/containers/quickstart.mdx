...
You can deploy a container either from the [Scaleway Container Registry](/containers/container-registry/quickstart/) or any other public container registry (Docker Hub, AWS Container registries, GitLab container registry, etc.).
