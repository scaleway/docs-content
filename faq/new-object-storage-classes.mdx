...
Unfortunately, you cannot use the old Standard class. You must use the [One Zone - IA class](/storage/object/concepts/#storage-class), which has the same behavior.
