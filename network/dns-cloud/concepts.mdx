...
An external domain is any domain created via an external registrar (i.e. not by Scaleway). Scaleway Domains and DNS is currently able to manage DNS zones for external domains.
