...
Follow this procedure to send application logs from your Kubernetes cluster to your Cockpit. You can use Helm directly, or deploy the Helm chart with with [Terraform](https://www.terraform.io/) or [OpenTofu](https://opentofu.org/).
