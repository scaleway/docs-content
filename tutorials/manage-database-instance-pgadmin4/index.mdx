...
[pgAdmin](https://www.pgadmin.org/) is an open-source management tool for PostgreSQL databases. It allows the management of your [Scaleway Database Instances](https://www.scaleway.com/en/databases/) and other PostgreSQL databases through an easy-to-use web-interface within your web browser.
