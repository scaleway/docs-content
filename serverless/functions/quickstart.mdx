...
Scaleway Serverless Functions makes your [functions](/functions/concepts/#function) available, executes them on demand and manages resource allocation for you.

Functions are designed for lightweight and short-lived workloads, and are limited to [a selection of runtimes](/functions/reference-content/functions-lifecycle/#available-runtimes) for optimum performance.

Refer to the [differences between Functions, Jobs, and Containers](/containers/reference-content/difference-jobs-functions-containers/) for more information on Scaleway's different Serverless products.
...
2. Click **+ Create a function**. The function [namespace](/functions/concepts/#namespace) creation wizard displays.
...
4. Click **Create namespace and add function**. The function creation wizard displays.
    <Message type="note">
      Refer to the [How to create, manage and delete a functions namespace](/functions/how-to/create-manage-delete-functions-namespace/) documentation page for more information on the different parameters.
    </Message>
5. Complete the following steps in the wizard:
    ...
    - If you used the code editor, enter the [handler](/functions/concepts/#handler) of your function.
    - Enter a **name** or use the automatically generated one. The name can only contain lowercase alphanumeric characters and dashes.
    - Enter an optional **description**.
    ...
    <Message type="note">
      Refer to the [How to create a function](/functions/how-to/create-a-function/) documentation page for more information on the different parameters.
    </Message>
...
If you require more advanced usage, such as large projects with dependencies, automation, and multiple functions, refer to our [deployment methods](/functions/reference-content/deploy-function/) documentation and check our [repository](https://github.com/scaleway/serverless-examples) for examples and use cases.