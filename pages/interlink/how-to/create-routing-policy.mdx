...
content:
  h1: How to create a routing policy
  paragraph: Find out how to create a routing policy for your Scaleway InterLink. Whitelist incoming and outgoing route announcements, so that traffic can flow securely over your InterLink.
dates:
...
3. Click **+Create routing policy**. The **Create a routing policy** wizard displays.
        ...
        <Lightbox src="scaleway-create-allowed-routes.webp" alt="TODO MODIFY In the Scaleway console, the Create an allowed routes List wizard is displayed. There are 3 steps: 1. Choose a name and region, 2. Whitelist outgoing routes and 3. Whitelist incoming routes" />
