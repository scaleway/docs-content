...
4. Click the **Add network** button to access the network creation wizard.
  <Lightbox src="scaleway-iothub_network_add.png" alt="" />
...
5. Complete the form by specifying the network's details:
  ...
  <Lightbox src="scaleway-iothub_network_modal_sigfox.png" alt="" />
...
2. Go the **DEVICE TYPE** tab
  <Lightbox src="scaleway-iothub_network_sigfox_devicetype_tab.png" alt="" />

3. Click the **CALLBACKS** entry in the left menu
  <Lightbox src="scaleway-iothub_network_sigfox_devicetype_callbacks.png" alt="" />

4. Select the **Custom callback** option
  <Lightbox src="scaleway-iothub_network_sigfox_devicetype_new_custom_callback.png" alt="" />

5. Fill-in the form like the example below.
  <Lightbox src="scaleway-iothub_network_sigfox_devicetype_callback_form.png" alt="" />
