...
Kapsule is Scaleway's **fully managed Kubernetes service**, enabling users to deploy, manage, and scale containerized applications seamlessly without the burden of infrastructure management.
  ...
  - Users can manage their Kubernetes clusters through the Kubernetes API, the intuitive Scaleway console or the devtools (namely Scaleway CLI or the Terraform provider).
...
| Node pools upgrades                 | Handled by Kapsule                                          | Must be carried out manually per node                                                                       |
