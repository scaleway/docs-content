...
1. Click the [CPU & GPU Instances section](https://account.scaleway.com/?service=elementsinstance/servers) of the Scaleway console, then click the Instance you want to snapshot.
...
1. Click the [Object Storage section](https://account.scaleway.com/?service=elementsobject-storage/buckets) of the Scaleway console, then click the bucket to which you have exported the snapshot. The snapshot copy should display in the list of your objects.
    <Message type="note">
...
1. Click the [Instances section](https://account.scaleway.com/?service=elementsinstance/servers) of the Scaleway console, then click **+Create Instance**.
