...
Resource-level conditions are built using [CEL](/iam/policies-permissions/understanding-policy-conditions/#common-expression-language) expressions. See [Understanding policy conditions](/iam/policies-permissions/understanding-policy-conditions/) for the general concepts, operators, and logical operators shared by all condition types.

<Message type="important">
  Resource-level conditions are currently only supported for a limited set of products. See [Products supporting resource-level conditions](/iam/policies-permissions/supported-products-resource-level/) for the up-to-date list.
</Message>
