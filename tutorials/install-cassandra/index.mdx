...
- **endpoint_snitch**: Represents the ‘snitch' used by Cassandra. A snitch tells Cassandra which data center and rack a node belongs to within a cluster. Various types could be used here, you may refer to the [official documentation](https://cassandra.apache.org/doc/latest/) for more information on this topic.
