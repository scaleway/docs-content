...
- An [Instance](/instances/how-to/create-an-instance/) with [Block Storage volumes](/block/how-to/create-a-volume/)
...
1. Create a Scaleway Object Storage bucket.
    ...
    You need an Object Storage bucket to export your QCOW2 file into. Any bucket that belongs to the same project as the snapshot can be used. However, if you do not have one already, you can [create it](/object/how-to/create-a-bucket/) in the console.
