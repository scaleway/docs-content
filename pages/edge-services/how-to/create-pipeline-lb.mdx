...
3. Configure the [origin](/edge-services/concepts/#origin) for this pipeline:
    ...
    Note that you cannot use a [private Load Balancer](/load-balancer/concepts/#private-load-balancer) as an Edge Services origin. Load Balancers must have a public IP address to be compatible with Edge Services. You can use [ACLs](/load-balancer/concepts/#acl) to filter traffic towards public Load Balancers.
    </Message>
