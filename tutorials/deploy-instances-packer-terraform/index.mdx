...
content:
  h1: Deploying Cloud Instances with Packer and Terraform/OpenTofu
  paragraph: This tutorial explains how to build and deploy Cloud Instances with Packer and Terraform/OpenTofu
categories:
  - instances
  - terraform
  - packer
