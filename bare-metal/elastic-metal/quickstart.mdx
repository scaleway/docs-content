...
5. Add your [SSH key](/console/account/concepts/#ssh-key).
    <Message type="note">
      If you have already [uploaded an SSH key](/console/organizations-and-projects/how-to/create-ssh-key/#how-to-upload-the-public-ssh-key-to-the-scaleway-interface), it will appear in the list of keys.
    </Message>
