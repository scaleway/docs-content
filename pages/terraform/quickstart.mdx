...
This example guides you through the creaation of a Kubernetes Kapsule cluster.
...
Your configuration is now ready to be deployed on the Scaleway infrastructure.
