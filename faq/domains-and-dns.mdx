...
meta:
  ...
  description: Explore everything you need to know about managing domains and DNS zones with Scaleway Domains and DNS. From understanding DNS features and prerequisites for domain registration to managing domain ownership and responsibilities, get comprehensive answers to your questions.
content:
  h1: Domains and DNS
