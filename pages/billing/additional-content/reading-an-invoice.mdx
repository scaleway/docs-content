...
<Lightbox image={image} size="medium" />
...
<Message type="note">
  Refer to the [Billing FAQ](/billing/faq/#what-does-the-status-of-my-invoice-mean) for a description of each existing invoice status.
</Message>
