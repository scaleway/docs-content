...
If your database engine is outdated, you can upgrade the version the latest one anytime via the Scaleway console.

We especially recommend that you upgrade your engine version if your Database Instance uses an End of Life engine version that is no longer maintained.

  <Message type="important">
    The version upgrade is only available for:
      - Database Instances using outdated engine versions.
...
<Message type="requirement">
  ...
  - You have a [PostgreSQL or MySQL Database Instance](/managed-databases/postgresql-and-mysql/how-to/create-a-database) running on an outdated engine version
</Message>
