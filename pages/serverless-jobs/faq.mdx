...
Serverless Jobsis billed on a pay-as-you-go basis, strictly on resource consumption (Memory and CPU). You only pay for the computing resources you use, with no upfront provisioning costs or charges for idle capacity.

For detailed and up-to-date pricing information, please refer to the [official Scaleway pricing page](https://www.scaleway.com/en/pricing/serverless/#serverless-jobs).
