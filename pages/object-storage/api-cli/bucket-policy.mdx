...
* You can restrict access to the resources of a given VPC with the `aws:SourceVpc` condition key. This condition key requires [private access for Object Storage](/vpc/api-cli/enable-object-storage-private-access/) to be enabled on the VPC:
