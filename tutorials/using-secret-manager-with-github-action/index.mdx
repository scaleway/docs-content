...
content:
  ...
  paragraph: Learn to securely fetch secrets from Scaleway Secret Manager, integrate GitHub Actions, and expose them as environment variables for automation and security.
