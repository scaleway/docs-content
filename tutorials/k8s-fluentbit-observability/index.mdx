...
- `Scrape_interval 60`: Metrics are collected every 60 seconds.

<Message type="important">
  Increasing the scrape interval allows you to push less metrics samples per minute to your Cockpit and thus, pay less.
</Message>
