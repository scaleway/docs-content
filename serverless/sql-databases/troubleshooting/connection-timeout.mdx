---
meta:
  title: Serverless SQL Databases connection timeout
  description: This page lists the different solutions for connection timeouts with Serverless SQL Databases.
content:
  h1: Serverless SQL Databases connection timeout
  paragraph: This page lists the different solutions for connection timeouts with Serverless SQL Databases.
