...
This page shows you how to use [KVM](/bare-metal/hardware/concepts/#kvm-over-ip) on a Dedibox with HP KVM.
...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/hardware/reference-content/dell-idrac9/">Using DELL iDRAC 9</PreviousButton>
  <NextButton to="/bare-metal/hardware/reference-content/quanta-computer/">Using the Quanta Computer KVM</NextButton>
</Navigation>