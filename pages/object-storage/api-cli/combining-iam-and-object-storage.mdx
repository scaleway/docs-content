...
2. [Create an IAM policy](/iam/how-to/create-policy/) named `S3-policy` in the [Scaleway console](https://account.scaleway.com/?service=elements), with the previously created group as a [principal](/iam/concepts/#principal). The members of this group will have the `ObjectStorageFullAccess` right.
