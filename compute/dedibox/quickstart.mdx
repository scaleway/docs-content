...
4. Select the type and version of the operating system you want to install. 
  ...
  <Message type="tip">
    ...
    For more information about OS types, refer to the [dedicated servers concepts page](/dedibox-console/scaleway-consoleconcepts#os-type).

  </Message>

5. Personalize the following [partitioning](/dedibox-console/scaleway-consoleconcepts#partioning) parameters:
...
- You have [created](/compute/dedibox/how-to/order-a-server) and [installed](/compute/dedibox/how-to/install-dedibox) a Dedibox, and transferred your SSH key to the server during installation
