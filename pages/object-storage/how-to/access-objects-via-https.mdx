...
If an object is [private](/object-storage/how-to/manage-object-visibility/), you can create a temporary public link from the [Scaleway console](https://account.scaleway.com/?service=elements).

If an object is public, you can retrieve the link to access it from the [Scaleway console](https://account.scaleway.com/?service=elements).
