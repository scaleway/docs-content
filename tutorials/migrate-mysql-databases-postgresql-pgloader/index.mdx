...
In this tutorial, you learn how to migrate an existing remote MySQL database to a [Database for PostgreSQL](https://www.scaleway.com/en/managed-postgresql-mysql/) using pgLoader and an intermediate [Development Instance](/instances/reference-content/development/) running Ubuntu Linux.
...
- A [Database Instance](https://www.scaleway.com/en/managed-postgresql-mysql/)
