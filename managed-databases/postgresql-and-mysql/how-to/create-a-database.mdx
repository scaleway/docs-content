...
3. Complete the following steps in the wizard:
    ...
    - Enable [encryption at rest](/postgresql-and-mysql/concepts/#encryption-at-rest) if you want to ensure the permanent encryption of your database data.
        <Message type="important">
    ...
    - Choose your storage type and capacity. Two types of storage are available:
        ...
        - **Block Storage Low Latency**: This storage type works like the [Block Storage Legacy](/postgresql-and-mysql/concepts/#block-storage-legacy), while providing lower latency and high resiliency through 5k IOPS. You can increase your volume to up to 10 TB.
    ...
    - Select the snapshot configuration. You can either leave the default **Automatic** option to enable [autobackups](/postgresql-and-mysql/how-to/enable-autobackup/), or select [Manual snapshots](/postgresql-and-mysql/how-to/manage-snapshots/).
