...
<Message type="important">
	Be aware that any existing Kapsule cluster **will be destroyed** and recreated, by adding private_network_id attribute over an existing terraform definition.
	More on : [Scaleway's terraform provider documentation (v2.19.0)](https://registry.terraform.io/providers/scaleway/scaleway/2.19.0/docs/resources/k8s_cluster).
</Message>
