...
- When configuring your **Block Storage** volumes, bear in mind the following:
  ...
  - If several Block Storage volumes are connected to an Enterprise Instance, the first volume will contain the OS and is required to boot the Instance. You may change your boot volume later in Advanced Settings.
