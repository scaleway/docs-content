...
categories:
  - compute
  - instance-dev
tags: compute installing Django
image: /assets/images/docs/scaleway.png
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, compute, django framework, web application, python
dates:
