...
<Message type="note">
Let's Encrypt certificates are not compatible with Load Balancers which have a TCP frontend listening on port 80. HTTP frontends listening on port 80, or TCP frontends listening on a different port, are both fine.
</Message>
