...
<Lightbox image={scalewayInterlinkListing} alt="A screen in the Scaleway console shows a listing of InterLinks, with the following information: name, status, partner, location, region and bandwidth." /> TODO UPDATE
