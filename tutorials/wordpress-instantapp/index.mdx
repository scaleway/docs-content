...
3. Choose the server type and click **Create a new Instance**.

### Open the mail ports to send emails

To avoid spam, remote mail ports cannot be reached from our infrastructure by default. As WordPress requires to send mail, we need to open them. Your account needs to be validated to perform this operation. [Contact our assistance](https://console.scaleway.com/support/) to get your account reviewed.
