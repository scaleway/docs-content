...
This page explains how to deploy, invoke and delete a basic Python function using the Scaleway Console. For advanced usage (ex: larger projects with dependencies, automation, multiple functions...) [several ways to deploy functions](/serverless/functions/reference-content/deploy-function/) are available.
