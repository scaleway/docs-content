...
## How to configure access to a Private Network ?

Scaleway Serverless Containers does not support Virtual Private Networks (VPC) for now, it's a feature under development.

If it's possible to add some network restrictions on your resource, here is the list of prefixes used at Scaleway: [https://www.scaleway.com/en/peering/](https://www.scaleway.com/en/peering/). Serverless ressources does not have dedicated and predictible IP address.
