...
<Message type="tip">
  For the most accurate and up-to-date product availability across regions and Availability Zones, refer to our detailed [Product Availability Guide](https://www.scaleway.com/en/product-availability-by-region/). It is regularly updated by product teams to reflect current GA and beta offerings.
</Message>
