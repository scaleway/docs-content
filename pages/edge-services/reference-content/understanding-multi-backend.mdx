...
<Message type="note">
Routing and multi-backend for Edge Services pipelines is currently in Public Beta, and available only via the [Edge Services API](TODO). This feature will be coming soon to the Scaleway console.
</Message>
