...
2. You should see the **Private Network** connected to the deployment resource and its **allocated IPs** listed.
    <Lightbox src={image} alt="A screenshot of the Scaleway console, hightlighting the Private Network configuration of the Managed Inference deployment" size="medium" />
...
2. Download the TLS certificate from your Managed Inference deployment, available from the **Overview** tab in the **Endpoints** section.
    <Lightbox src={image2} alt="A screenshot of the Managed Interface product overview tab in the Scaleway console, highlighting the TLS certificate download section" size="medium" />
...
4. Click **Detach Private Network**. A pop-up displays.
    <Lightbox src={image3} alt="A screenshot of the Managed Interface product overview tab in the Scaleway console, highlighting the Private Network detach section" size="medium" />
