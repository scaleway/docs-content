...
9. Open the VMkernel NIC configuration file in a text editor:
    ...
    vi vmknics.json
    ```
10. Replace the MAC address of your RPN VMkernel NIC with your [Virtual MAC](/dedibox-network/ip-failover/how-to/create-virtual-mac/).
...
2. Click **Actions** > **New data center** to create a new data center. A data center is a group of machines.
...
1. From the **Data center** dashboard in your vSphere web interface click **Actions** > **New Cluster**:
