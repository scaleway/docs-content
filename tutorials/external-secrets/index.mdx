...
2. Add the External Secrets Helm repo and update it:
    ```
...
The CRD's can only be installed for now with the corresponding git branch:
...
## Create a secret containing your Scaleway's API key information
