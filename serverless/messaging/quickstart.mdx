...
Two types of namespaces are available: [NATS](/serverless/messaging/concepts/#nats) and [SQS/SNS](/serverless/messaging/concepts/#sqssns). The type of namespace that you choose determines the messaging system used to distribute and queue your messages.
