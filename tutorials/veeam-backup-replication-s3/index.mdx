...
totalTime: PT10M
steps:
  - step: Configuring an Object Storage repository
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/veeam-backup-replication-s3/#Configuring-an-Object-Storage-repository
  - step: Configuring a Local Backup Repository
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/veeam-backup-replication-s3/#Configuring-a-local-backup-repository
  - step: Configuring a scaleout repository
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/veeam-backup-replication-s3/#Configuring-a-scaleout-repository
  - step: Adding a vSphere hypervisor in Veeam
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/veeam-backup-replication-s3/#Adding-a-vSphere-hypervisor-in-Veeam
  - step: Configuring a backup job
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/veeam-backup-replication-s3/#Configuring-a-backup-Job
categories:
  - storage
  - block
tags: compute backup vmware veeam esxi object storage
