...
- One of the following remote machines running Ubuntu (this tutorial was validated for machines running Ubuntu Xenial or Ubuntu Focal Fossa):
    ...
    - A [Dedibox dedicated server](/dedicated-servers/how-to/order-a-server/)
...
1. Connect to your remote machine via SSH. Follow the instructions depending on your remote machine type: [Instance](/instances/how-to/connect-to-instance/), [Elastic Metal](/elastic-metal/how-to/connect-to-server/), or [Dedibox](/dedicated-servers/how-to/connect-to-server/).
    <Message type="note">
