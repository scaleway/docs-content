...
Since the release of its version 18.04, Bionic Beaver, [Ubuntu](http://www.ubuntu.org) has switched to [Netplan](http://netplan.io) for the configuration of network interfaces. 

It is a [YAML](http://yaml.org/about.html) based configuration system, which simplifies the configuration process.
