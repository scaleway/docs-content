...
1. Go back to your IoT Hub in the Scaleway console and click on the [Kickstart](https://account.scaleway.com/?service=elementsiot-hub/kickstarts/create) tab. Click **Create a Kickstart**:
