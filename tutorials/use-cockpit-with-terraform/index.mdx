...
meta:
  ...
  description: Discover how to use Terraform to configure your Scaleway Cockpit. This detailed guide walks you through creating a token, setting up a Grafana user, and configuring Scaleway and custom data sources.
content:
