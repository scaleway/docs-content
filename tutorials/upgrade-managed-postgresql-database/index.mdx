...
3. Select **PostgreSQL-13** from the drop-down list and fill in the [required information](/postgresql-and-mysql/how-to/create-a-database/) for your new database Instance. Then click **Create an Instance**. Your database is created, and you are redirected to the database dashboard.
    <Message type="note">
...
5. Once the migration is complete, [delete](/postgresql-and-mysql/how-to/delete-a-database/) the old Database Instance from your account.
