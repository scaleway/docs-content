...
You can now access your container image from the [Scaleway Container Registry](https://account.scaleway.com/?service=elementsregistry/namespaces), and [deploy a Serverless Container](/serverless-containers/how-to/deploy-container/#deploy-from-an-external-container-registry) from this image.
