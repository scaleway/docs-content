...
<Message type="note">
  Bucket policies use a JSON-based access policy language. You can find more details on the JSON Policy Grammar [documentation page](/s3-json-policy-grammar/).
</Message>
