...
You can automate the removal of incomplete multipart uploads by adding or uploading a lifecycle cofiguration to your bucket. The set-up can be done via an API call or an [AWS-CLI](/storage/object/api-cli/object-storage-aws-cli/) command. 
