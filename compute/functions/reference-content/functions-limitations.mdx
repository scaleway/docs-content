...
The limits mentioned beforehand are technical limits. [Account quotas](/console/my-account/reference-content/account-quotas/#serverless-functions) are also applied depending on your account level. 
