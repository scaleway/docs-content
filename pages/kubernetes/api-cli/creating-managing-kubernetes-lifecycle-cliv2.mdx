...
## Configuring labels for your pool(s)

To add a label to multiple pools, execute the following command in your terminal. Remember to replace the placeholder values with your actual values.
