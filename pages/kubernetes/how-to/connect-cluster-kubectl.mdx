...
- A [Scaleway account](https://account.scaleway.com/?service=elements) logged into the console.
- [Owner status](https://account.scaleway.com/?service=elements) or [IAM permissions](/iam/concepts/#permission) to perform actions in the intended Organization.
