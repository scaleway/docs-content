...
However, the default payment method defined in the Scaleway console will allow you to pay all your Scaleway invoices (Scaleway Dedibox and Scaleway Cloud). It is important that you verify the default payment method defined in the Scaleway console after the linking process, to ensure the proper payment method will be used for your future invoices.<br />
...
For the first customers following the linking process, a discount of 100€ is applied directly to their Scaleway account. This discount is valid for six months after the link of your accounts. It is available on our Scaleway cloud services ordered through the Scaleway console, excluding Dedibox and Elastic Metal products.
