...
2. Click the database name or <Icon name="more" /> > **More info** to access the Database Instance information page.
3. Scroll down to the **Read Replica** section. 
4. Click <Icon name="more" /> > **Detach Private Network** next to the name of your selected read replica. A pop-up displays to ask if you are you sure you want to detach the Private Network.
