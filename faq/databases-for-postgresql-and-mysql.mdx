---
meta:
  title: Databases for PostgreSQL and MySQL
  description: Discover Scaleway Managed Databases and how to access it for PostgreSQL and MySQL.
content:
  h1: Databases for PostgreSQL and MySQL
  paragraph: Discover Scaleway Managed Databases and how to access it for PostgreSQL and MySQL.
image: database.webp
---

## What is Scaleway Databases for PostgreSQL and MySQL?


Scaleway Databases for PostgreSQL and MySQL provides fully-managed relational database Instances, supporting the database engines PostgreSQL and MySQL.
...
See our documentation on [upgrading managed Database for PostgreSQL](/tutorials/upgrade-managed-postgresql-database/).



**PostgreSQL** 

To access your Scaleway Databases for PostgreSQL Instance, use the psql command-line tool with the following command:
...
You can access your Scaleway Databases for MySQL Instance with the following command:
...
To import data into your Scaleway Databases for PostgreSQL, export your data using the `pg_dump` command in a first step:
...
If you want to import your existing database into a Scaleway Databases for MySQL, start by exporting your data using the command `mysqldump`:
...
This feature introduces a significant change in the architecture of Scaleway's Managed Databases: when using Private Networks, your application connects directly to your Database nodes, without going through a Load Balancer. 
