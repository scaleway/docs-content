...
This documentation is directed toward all users who dispose of a webhosting package powered by cPanel on [Scaleway Dedibox](https://www.scaleway.com/en/dedibox/cloud-hosting/), and provides useful links and information to manage and configure it.

</Message>


Refer to our [Quickstart](/webhosting/cpanel/quickstart) which contains useful links to answer your basic Frequently Asked Questions. 
...
## [JetBackup](https://docs.jetbackup.com/)
...
* [Remote MySQL®](https://docs.cpanel.net/cpanel/databases/remote-mysql/)
