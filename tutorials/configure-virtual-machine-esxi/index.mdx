...
EXSi can be installed on a Dedibox server in two ways: through the [Dedibox Console](https://console.online.net/en/login) or through [KVM over IP](https://en.wikipedia.org/wiki/KVM_switch#KVM_over_IP_(IPKVM)).
