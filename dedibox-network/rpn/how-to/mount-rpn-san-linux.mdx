...
content:
  h1: How to mount a RPN SAN volume on Linux
  paragraph: This page explains how to mount a RPN SAN volume on Linux
dates:
...
This method is not recommended, because it does not allow you to make changes afterwards, by aggregating several RPN SAN storage spaces.
...
This is the most stable available path.
