...
1. Run the following command to create a functions namespace:
...
2. Copy the `id` of your namespace, as you will need it for the next step.

3. Run the following command to create a function:
...
5. Upload your zip file [using the Scaleway console](/serverless/functions/how-to/package-function-dependencies-in-zip/#how-to-upload-your-zip-file-to-the-scaleway-console) or [using the Scaleway API](/serverless/functions/how-to/package-function-dependencies-in-zip/#how-to-upload-your-zip-file-using-the-scaleway-api).


6. Run the following command to deploy your function:
...
7. Run the following command to call your function once it is deployed:
