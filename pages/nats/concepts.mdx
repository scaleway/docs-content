...
NATS is available in multiple regions. A region designates the geographical area where the service is hosted. Refer to the [product availability table](/account/products-availability/) to check which regions are available for NATS.
