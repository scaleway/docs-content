...
REST Route forwards your messages to any RESTful API over HTTP or HTTPS.
...
Database Route forwards your messages to a database. PostgreSQL and MySQL are currently supported.
...
Object Storage Route forwards your messages to a [Scaleway Object Storage](https://www.scaleway.com/en/docs/storage/object/quickstart/) bucket.
