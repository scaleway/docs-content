...
<Message type="important">
 - Having the default configuration on your agents might lead to more of your resources’ metrics being sent, a high consumption and a high bill at the end of the month. Find out [how to avoid additional costs](/observability/cockpit/reference-content/understanding-cockpit-usage/).
