...
| SecretManagerSecretCreate    | Permission to create secrets and their versions in Secret Manager. Does not include permission to update secrets, versions and folders             |
| SecretManagerSecretDelete    | Permission to delete secrets and their versions  in Secret Manager            |
| SecretManagerSecretWrite     | Permission to write secrets and their versions in Secret Manager. Does not include permission to create secrets, versions and folders             |
