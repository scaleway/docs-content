...
To connect to a Serverless SQL Database, you can either use a **connection string**, or **connection parameters**.
  ...
  - Connection parameters provide the necessary information and parameters to connect an IAM principal (i.e. a user or an application) to a database. The parameters are expressed in the `KEY="value"` value format, as follows:
