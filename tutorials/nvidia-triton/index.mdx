...
2. [Create a new bucket](/object/how-to/create-a-bucket/) to store your model artifacts.
...
6. Upload the example model folder to your bucket in Scaleway Object Storage. You can use the [Scaleway Object Storage API](/object/api-cli/using-api-call-list/), any Amazon S3-compatible tool, or web interface to upload the model folder.
    <Message type="tip">
