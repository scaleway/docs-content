...
Private Networks also have built-in **D**ynamic **H**ost **C**onfiguration **P**rotocol (DHCP), making it easy to manage the private IP addresses of your resources on the network. IPs are staticallly allocated when resources are attached to a Private Network, and are managed by our internal [IPAM](/newtork/vpc/concepts/#ipam)
