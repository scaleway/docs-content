...
description: This page shows how setup SSL Offloading on Scaleway Managed Load Balancer
excerpt: |
  SSL Offloading allows to terminate SSL sessions directly on a Load Balancer
totalTime: PT30M
steps:
  - step: Configuring SSL Passstrough
    type: HowToStep
...
- [SSL Passtrough](#-Configuring-SSL-Passthrough)
