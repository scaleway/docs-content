...
A path refers to the directory structure to access your folders and secrets. Paths contain your folders, secrets and versions. Each path is prefixed with a slash.
