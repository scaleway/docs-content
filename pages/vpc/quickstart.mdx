...
You can use the VPC's [Network Access Control List](/vpc/reference-content/understanding-nacls/) to limit and restrict certain routes within a VPC. See our [how-to guide](/vpc/how-to/use-network-acl/) to get started.
