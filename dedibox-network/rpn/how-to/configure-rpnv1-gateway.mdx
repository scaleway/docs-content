---
meta:
  title: How to configure the RPNv1 gateway on a RPNv2 Dedibox
  description: This page explains how to configure the RPNv1 gateway on a Dedibox
content:
  h1: How to configure the RPNv1 gateway on a RPNv2 Dedibox
...
<Lightbox src="scaleway_rpnv1_gateway.png" alt="" />
