...
content:
  h1: Managing Computing Infrastructures with GLPI and a Managed Database for MySQL
  paragraph: This page provides information on how to deploy Gestionnaire Libre de Parc Informatique (GLPI), or Open Source IT Equipment Manager in English on Scaleway Dedibox with Managed Database for MySQL.
...
2. Use Ubuntu's apt package manager to install Nginx. Then, restart and enable it.
