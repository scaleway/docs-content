...
excerpt: |
  This page shows how to install Matomo, an open-source web-analytics platform, designed to evaluate the visitor's behaviour for one or multiple websites.
totalTime: PT30M
steps:
...
permalink: docs/setting-up-web-analytics-with-matomo-on-ubuntu-bionic/
keywords: cloud tutorials, cloud documentations, cloud server, cloud hosting, ubuntu server, debian server, linux server, IAAS, baremetal, scalability, statistics, analytics, matomo, pikwik, webanalytics, webstats, webalizer, awstats
dates:
