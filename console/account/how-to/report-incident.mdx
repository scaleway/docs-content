...
9. Once you have entered the information mentioned above, check the CAPTCHA form and click **Submit abuse report**.
    <Message type="note">
      In case you encounter difficulties to submit an abuse report, you can contact [Scaleway’s abuse team](https://www.scaleway.com/fr/contact-trust-et-safety/).
    </Message>
...
2. If your report is rejected, you will be informed of the reasons why by email.
    <Message type="note">
      * Repeatedly reporting the same practices or content forces the abuse team to carry out unnecessary actions which have a negative impact on their work. As such, it is counterproductive to massively report the same practices or content.
...
<Navigation title="See also">
  <PreviousButton to="/console/account/how-to/manage-my-personal-data-gdpr/">How to manage your personal data (GDPR)</PreviousButton>
  <NextButton to="/console/account/how-to/resolve-abuse">How to resolve abuses and cases</NextButton>
</Navigation>