---
meta:
  title: Configuring IPv6 connectivitiy using networkd
  description: This page explains how to configure IPv6 connectivitiy using networkd.
content:
  h1: Configuring IPv6 connectivitiy using networkd
...
`networkd` is the network manager of [systemd](https://en.wikipedia.org/wiki/Systemd) and can be used as an alternative to the configuration of IPv6 using a [standalone DHCP client](/bare-metal/network/reference-content/configure-ipv6-linux).
...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/network/reference-content/configure-ipv6-windows/">Configuring IPv6 on Windows</PreviousButton>
  <NextButton to="/bare-metal/network/reference-content/debug-ipv6/">How to resolve IPv6 connection issues</NextButton>
</Navigation>
