...
This page shows how to connect to your [Mac mini M1](/bare-metal/apple-silicon/concepts/#mac-mini-m1) via either [VNC](/bare-metal/apple-silicon/concepts/#vnc) or [SSH](/console/account/concepts/#ssh-key).
