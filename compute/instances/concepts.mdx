...
Stand-by mode is designed to temporarily stop an Instance. When you [put a Virtual Instance in stand-by mode](/compute/instances/how-to/use-standby-mode/), the server is halted, but the virtual Instance remains allocated to your account and all data remains on the local storage of the Instance.
