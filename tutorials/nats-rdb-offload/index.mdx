...
To properly follow this tutorial, we recommend you [create a dedicated Project](/organizations-and-projects/project/create-a-project/) in your Scaleway account. You can name it `RDB and NATS Tutorial`. It will hold all your Scaleway resources created for this tutorial, so they will be easier to find.
...
4. Go back to your database terminal window (the one with >sql) and run the following code:
    ...
    You should see your message in the table with a timestamp.
...
Here are some possible extensions to this basic example:
 ...
 - Use a Serverless Database to further embrace the Serverless architecture
