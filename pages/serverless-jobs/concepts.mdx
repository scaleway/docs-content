...
Retries refer to the automatic re-execution of a job run that has failed. Serverless Jobs can be configured to automatically retry a job run after up to five failed attempts. [Learn how to manage the retry attempts of a Serverless Job.](/serverless-jobs/how-to/manage-job-retries/)
