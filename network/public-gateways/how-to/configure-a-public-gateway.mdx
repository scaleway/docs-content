...
5. Choose to attach an existing or a new Private Network.
    ...
    - If you want to create and attach a new Private Network, select **Attach to a new Private Network**. The Private Network will be created with default configuration (a CIDR block will be automatically defined), in your default VPC for the region. A name for the Private Network will be suggested for you, but feel free to overwrite this with a new name of your choice.
6. Choose whether to activate [Dynamic NAT](/network/public-gateways/concepts/#nat) on the network.
