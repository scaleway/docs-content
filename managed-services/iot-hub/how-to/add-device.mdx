...
8. Click **Close** to leave the wizard or **Add new device** to add another device.
    ...
    Once the device is added, you may continue to configure [IoT Hub Routes](/managed-services/iot-hub/how-to/create-route/) to export your data to other Scaleway services.
