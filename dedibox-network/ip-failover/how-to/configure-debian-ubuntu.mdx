...
You will find below, information on how to configure a [failover IP](/dedibox-network/ip-failover/concepts/#failover-ips) on Dedibox servers running on Debian or Ubuntu Linux.
...
It is a [YAML-based](http://yaml.org/about.html) configuration system, which simplifies the configuration process.
