...
Data Orchestrator is based on the [Open Workflow Specification](https://open-workflow-specification.org/). For information on other action tasks, see the [Open Workflow DSL Reference](https://github.com/open-workflow-specification/specification/blob/main/dsl-reference.md).
