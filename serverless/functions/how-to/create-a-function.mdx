...
This page shows you how to deploy a [function](/functions/concepts/#function) using the Scaleway console.
...
4. Complete the following steps in the wizard:
    ...
    - Select **Deploy "Hello world"** to deploy a basic function, **Inline code editor** to enter your own function code, or **Upload a ZIP** to import a [packaged function](/functions/how-to/package-function-dependencies-in-zip/).
    - If you used the code editor, enter the [handler](/functions/reference-content/functions-handlers/) of your function.
...
5. Click **+ Advanced options** and complete the following steps:
    ...
    <Message type="note">
      [Triggers](/functions/concepts/#trigger) can no longer be added from this screen. For more information, refer to the [How to add a trigger to a function](/functions/how-to/add-trigger-to-a-function/) documentation.
    </Message>
    - Verify the **estimated cost**.
6. Click **Create function** to finish.

<Message type="tip">
  There are different ways to deploy Serverless Functions. Refer to our detailed [deployment information](/functions/reference-content/deploy-function/) for more advanced options to deploy your functions.
</Message>
