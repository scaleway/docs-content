...
1. Click **Messaging** in the **Serverless** section of the Scaleway console side menu. The following screen displays:
    ...
    <Lightbox src="scaleway-activate-mnq.webp" alt="" /> TODO update
...
3. Click **SQS**, then **Create queue**.

4. Click the `+` button to create a new queue. The queue creation wizard displays.
...
2. Use the dropdown menu to select the [region](/serverless/messaging/concepts/#region) of the NATS account for which you want to create credentials.
