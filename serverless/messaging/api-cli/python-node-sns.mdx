...
<Message type="note">
  ...
  The `Endpoint` for Scaleway Messaging and Queuing is `https://sqs-sns.mnq.fr-par.scw.cloud`. The values for the access and secret keys should be the credentials you [generated](/serverless/messaging/how-to/create-credentials/) for SNS.
...
<Message type="note">
  The `endpoint_url` for Scaleway Messaging and Queuing is `https://sqs-sns.mnq.fr-par.scw.cloud`. The values for the access and secret keys should be the credentials you [generated](/serverless/messaging/how-to/create-credentials/) for SNS.
</Message>
...
<Message type="note">
  The `endpoint_url` for Scaleway Messaging and Queuing is `https://sqs-sns.mnq.fr-par.scw.cloud`. For the access and secret key values, use the credentials you [generated](/serverless/messaging/how-to/create-credentials/) for SNS.
</Message>
