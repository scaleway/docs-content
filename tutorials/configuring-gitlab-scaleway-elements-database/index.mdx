...
1. [Create a Managed PostgreSQL Database Instance](/managed-database/postgresql-and-mysql/how-to/create-a-database/) from the Scaleway console. We name our database `gitlab_production`.
