...
2. Click **+ Create a bucket** to [create](https://console.scaleway.com/object-storage/buckets/create) a new `STANARD` class bucket in the Paris region..
    <Message type="note">
...
4. Run a second full sync to ensure that new objects, that have been added to the source bucket in between are also copied.
5. Point your application to the new bucket.
6. Recursive copy from the old bucket to the new bucket to ensure that new objects added in between are also copied:
    ```
