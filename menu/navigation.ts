...
export default [
  ...
  },
  {
    items: [
      {
        icon: 'AiCategoryIcon',
        items: [generativeApisMenu, managedInferenceMenu],
        label: 'AI',
        category: 'ai-data',
      },
      {
        icon: 'BaremetalCategoryIcon',
        items: [appleSiliconMenu, dediboxScalewayMenu, elasticMetalMenu],
        label: 'Bare Metal',
        category: 'bare-metal',
      },
      {
        icon: 'ComputeCategoryIcon',
        items: [instancesMenu, gpuMenu],
        label: 'Compute',
        category: 'compute',
      },
      {
        icon: 'ContainersCategoryIcon',
        items: [containerRegistryMenu, kubernetesMenu],
        label: 'Containers',
        category: 'containers',
      },
      {
      ...
      },
      {
        ...
        items: [dataWarehouseMenu, dataLabMenu, clustersForKafkaMenu, natsMenu],
        label: 'Data & Analytics',
        category: 'data-and-analytics',
      },
      {
        icon: 'DevToolsCategoryIcon',
        items: [scalewayCliMenu, scalewaySdkMenu, terraformMenu],
        label: 'Developer Tools',
        category: 'developer-tools',
      },
      {
        icon: 'DomainsAndWebHostingCategoryIcon',
        items: [domainsAndDnsMenu, transactionalEmailMenu, webhostingMenu],
        label: 'Domains & Web Hosting',
        category: 'domains-and-web-hosting',
      },
      {
        icon: 'IntegrationServicesCategoryIcon',
        items: [iotHubMenu, topicsAndEventsMenu, queuesMenu],
        label: 'Integration Services',
        category: 'integration-services',
      },
      {
        icon: 'MonitoringCategoryIcon',
        items: [auditTrailMenu, cockpitMenu],
        label: 'Monitoring',
        category: 'monitoring',
      },
      {
  ...
  },
  {
    items: [
      {
        icon: 'OrganizationDashboardCategoryIcon',
        items: [classicHostingMenu, cpanelHostingMenu, dediboxAccountMenu],
