---
layout: docs
title: Quickstart IoT Hub
description: This page shows you how to get started with Scaleway IoT Hub.
excerpt: |
  This page shows you how to get started with Scaleway IoT Hub.
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/iot/iot-hub/quickstart
image: /assets/images/docs/scaleway.png
keywords: iot, cloud computing, scaleway, internet of things, iot hub, connected objects
dates:
...
<Lightbox src="assets/scaleway-iothub_add_device.png" alt="" />
...
4. You now have two MQTT webclients open, one for the **publisher** and one for **subscriber**. The client connects automatically to its associated device. Now that the 2 clients are connected, let's set up the subscription: 
    ...
    * On the **subscriber**: 
    ...
    <Lightbox src="scaleway-iothub-qs1.png" alt = "" />
...
5. Now that we have subscribed to the topic `my/first/topic`, we will post a message on the **publisher** device. Type the message in the form and click **Publish**:
    ...
    <Lightbox src="scaleway-iothub-qs2.png" alt = "" />
