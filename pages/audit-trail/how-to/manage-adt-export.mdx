...
- [Created](/object-storage/how-to/create-a-bucket/) an Object Storage bucket with [object lock](/object-storage/how-to/object-lock/#how-to-configure-bucket-lock) set up
