...
* the price of the storage (Local or Block Storage) - you can adjust storage quantity when you create the Instance
...
*All regions includes PAR1, PAR2, AMS1, AMS2 and WAW1. PAR3 prices are shown separately. 
...
Each flexible IPv4 for compute Instances costs 0,002€/hour excl. VAT.
