...
- [Created a target Serverless SQL Database](/sql-databases/how-to/create-a-database/) to import your data into.
...
5. When finished, make sure your data is stored in your new database by [connecting to it](/sql-databases/how-to/connect-to-a-database/), and performing a query.
...
1. Register your new database in pgAdmin. Refer to the [How to connect to a Serverless SQL Database](/sql-databases/how-to/connect-to-a-database/#how-to-set-up-credentials) documentation page for more information.
...
9. When finished, make sure your data is stored in your new database by [connecting to it](/sql-databases/how-to/connect-to-a-database/), and performing a query.
...
2. When finished, make sure your data is stored in your new database by [connecting to it](/sql-databases/how-to/connect-to-a-database/), and performing a query.
