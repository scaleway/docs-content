...
3. Click <Icon name="more" /> next to the object that you want to transfer.
  ...
  <Message type="">
   ...
   If you transfer objects to `GLACIER` class, you might have to restore your data at a later date. To facilitate the steps of restoration and ensure a fast restitution of your data, we recommend that you to use average sized files (> 1Mb).
