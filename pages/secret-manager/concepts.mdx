...
Secret protection is a feature that prevents the deletion of your secrets. Users holding the `SecretManagerFullAccess`, `SecretManagerSecretWrite`, and `AllProductsFullAccess` [permission sets](/iam/policies-permissions/permission-sets/) can enable it, ensuring that although your secrets can be accessed and modified, they remain **impossible to delete**.
