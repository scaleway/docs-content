...
<Message type="note">
  ...
  The `Endpoint` for Scaleway Messaging and Queuing is `https://sqs-sns.mnq.fr-par.scw.cloud`. For the access and secret key values, use the credentials you [generated](/serverless/messaging/how-to/create-credentials/) for SQS.
...
<Message type="note">
  The `endpoint_url` for Scaleway Messaging and Queuing is `https://sqs-sns.mnq.fr-par.scw.cloud`. For the access and secret key values, use the credentials you [generated](/serverless/messaging/how-to/create-credentials/) for your SQS.
</Message>
...
<Message type="note">
  The `endpoint_url` for Scaleway Messaging and Queuing is `https://sqs-sns.mnq.fr-par.scw.cloud`. For the access and secret key values, use the credentials you [generated](/serverless/messaging/how-to/create-credentials/) for SQS.
</Message>
