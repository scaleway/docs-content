...
1. [Create an Elastic Metal server](/elastic-metal/how-to/create-server/), ensuring you select the **Big Blue Button 2.5** image at step 2 of the creation wizard.
