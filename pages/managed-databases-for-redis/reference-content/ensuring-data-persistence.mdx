...
<Message type="important">
  - The snapshot configuration is managed by Scaleway. If you feel this configuration does not represent your use case, let us know via the #databases channel of the [Scaleway Slack community](https://slack.scaleway.com/).
