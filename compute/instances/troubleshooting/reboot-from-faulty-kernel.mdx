...
In rare cases your system does fails to boot or boots incorrectly after the installation of a new kernel version, you can use [rescue mode](/compute/instances/concepts/#rescue-mode) to boot into the previous working kernel.
