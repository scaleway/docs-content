...
<Message type="requirement">
  ...
  - You have [generated an API key](https://www.scaleway.com/docs/identity-and-access-management/iam/how-to/create-api-keys/) to update rescue mode via the Scaleway API
</Message>
