...
- Installed [CockroachDB](https://www.cockroachlabs.com/docs/v23.1/install-cockroachdb) locally
...
- Reviewed the [production checklist](https://www.cockroachlabs.com/docs/v23.1/recommended-production-settings) and recommended [topology patterns](https://www.cockroachlabs.com/docs/v23.1/topology-patterns)
...
- Run each node on a separate machine.
  ...
  For more details about stores, see the [Start a Node](https://www.cockroachlabs.com/docs/v23.1/cockroach-start#store) documentation page.
...
- **When deploying in a single Availability Zone (AZ)**:
  - To support the failure of any node, use at least 3 nodes with the `default` [3-way replication factor](https://www.cockroachlabs.com/docs/v23.1/configure-replication-zones#view-the-default-replication-zone). In this case, if one node fails, each range retains 2 of its 3 replicas, a majority.
