...
You can download Scaleway contracts either via the [console](https://account.scaleway.com/?service=elementsorganization) or Scaleway's website:

### From the Scaleway console
You can access and download the contracts applicable to your Organization:
1. Click the [Contracts](https://account.scaleway.com/?service=elementsorganization/contracts) tab in your [Organization dashboard](https://account.scaleway.com/?service=elementsorganization).
