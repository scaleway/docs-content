...
1. Deploy a new [GPU Instance](/instances/how-to/create-an-instance/) with the [Ubuntu ML](https://www.scaleway.com/en/imagehub/) image from the [Scaleway console](https://account.scaleway.com/?service=elements).
