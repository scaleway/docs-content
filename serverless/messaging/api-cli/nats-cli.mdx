...
- Replace `{path to your creds file}` with the path to the location where you [downloaded your `.creds` file](/serverless/messaging/how-to/create-credentials/#how-to-create-credentials-for-a-nats-namespace).
