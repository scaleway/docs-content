...
- Created an [IAM API key](/iam/credentials/create-api-keys/)
...
4. Enter your [API secret key](/iam/concepts/glossary/#api-key) when prompted for a password, then click **Log in**.
