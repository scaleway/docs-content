...
excerpt: |
  This page explains how to add a DNS delegation to IPv6 and IPv4
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/dedibox-network/dns/how-to/add-dns-delegation
image: /assets/images/docs/scaleway.png
keywords: dedibox, scaleway, dns delegation, ipv4, ipv6, online
dates:
...
2. Click the cogwheel icon next to the relevant IP block, then select **Edit nameserver delegation**. The **Edit nameserver delegation** page displays.
  ...
  <Lightbox src="scaleway-edit-delegation.png" alt="" />
...
You can use the utilities available at [rdns6.com](http://rdns6.com/) to facilitate the generation of your zones. 
