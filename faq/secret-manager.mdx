...
A secret version is billed if it is in an enable or disable state.
If you have used a secret version for five days, you will only be billed for the five days and not for the whole month.

## How do I migrate my secrets to Scaleway's Secret Manager?
