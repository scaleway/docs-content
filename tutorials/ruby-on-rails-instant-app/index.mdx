...
3. Enter your Instance details abd select the **Ruby on Rails** image in the **InstantApps** tab for your Instance.
...
```
$> ssh -i /path/to/key root@<your_Instance_ip>
```
...
1. Create the new application by runnnig the following command:
  ```
...
To install MySQL, run:
  ...
  ```
  $> apt-get install mysql-Instance
  ```
