...
<Message type="important">
  - **[Glacier storage class](/object/concepts/#storage-class) is currently not supported by Veeam.**
...
10. Provide the **Service Point** ([regional endpoint](/objects/concepts/#endpoint)), and the **Region** of your bucket, then click **Next**:
...
- make sure that there is no [bucket policy](/object/api-cli/bucket-policy/) preventing the application to access your bucket.
