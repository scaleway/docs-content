...
<Accordion>
  ...
  <Message type="note">
    macOS may ask for your password once logged into the remote desktop session. Change the keyboard layout of macOS to your computer local keyboard layout before entering the password. Click "U.S. keyboard" in the top right corner to display a list of all available keyboard layouts.
  </Message>
