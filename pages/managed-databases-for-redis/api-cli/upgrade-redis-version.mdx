...
Follow the steps below to upgrade your Database Instance's to the latest Redis™ version.
...
3. Run the following command. Make sure you replace `{cluster_id}` with the ID of your Database Instance and `{version_id}` with the version you want to upgrade to.
