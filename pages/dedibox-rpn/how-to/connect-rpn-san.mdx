...
1. Enter the [RPN SAN configuration](https://account.scaleway.com/?service=dediboxen/server/rpn/san) by clicking **Storage** > **RPN SAN**. The list of your SANs displays.
...
1. Access the [RPN group](https://account.scaleway.com/?service=dediboxen/server/rpn) configuration by clicking **RPN** > **RPN groups** The list of your RPN groups displays.
