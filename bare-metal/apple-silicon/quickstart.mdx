...
Scaleway Apple silicon is built using the latest generation of [Apple Mac mini](/bare-metal/compute/apple-silicon/concepts/#mac-mini-M1) hardware (fifth generation). They are powered by Apple's [M1 silicon](/bare-metal/compute/apple-silicon/concepts/#apple-m1) and also equipped with a 256 GB SSD and 8 GB of RAM for towering performances and revolutionary power efficiency.
