...
<Message type="important">
  To ensure your Instances continue to function properly, it is important to follow the procedures outlined below before **May 15, 2023**, when bootscripts will be **removed**, except for rescue boot.
</Message>
...
3. [Create and start](/compute/instances/how-to/create-an-instance/) a new Instance using its own boot volume in local boot mode (make sure that the Instance is in the same zone as the volume).
