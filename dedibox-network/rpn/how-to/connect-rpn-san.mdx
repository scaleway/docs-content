...
Some SAN endpoints may not be reachable directly from the RPNv2 and it is required to configure an [RPNv1 gateway](configure-rpnv1-gateway) to use them with RPNv2.
