...
- [Owner](/iam/concepts/glossary/#owner) status or [IAM permissions](/iam/concepts/glossary/#permission) allowing you to view resources in the intended Organization
...
<Message type="tip">
  You can also reach Resource Explorer from the [top search bar](/organizations-and-projects/project/use-the-search-bar/): click **Resource Explorer** at the bottom of the results.
</Message>
