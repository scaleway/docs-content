...
You may not need a super powerful Instance if you just want to play around and do some experiments for personal projects, so a **Learning** Instance could be perfect for you in this case. But if you want to use your Instance to host a business-critical application in production, you need the power and reliability of a **General Purpose** Instance, precisely designed to reliably handle this type of demanding workload.
...
Sure, here's the updated table with the "Development" category removed and "General Purpose - Basic" renamed to "Development":
...
| **Supported storage** | Resilient Block Storage or Local Storage, OR  Resilient Block Storage only (depending on Instance type) | Resilient Block Storage                                                                                                            | Resilient Block Storage                                                                                                                                                                                                 | Resilient Block Storage                                                                                                                                                                                                 |
| **vCPU**              | From 1 to 128 cores                                                                                       | From 1 to 64 cores                                                                                                                 | From 2 to 64 cores                                                                                                                                                                                                      | From 2 to 64 cores                                                                                                                                                                                                      |
...
| **RAM**               | From 2 GiB to 64 GiB                                                                                    | From 2 GiB to 384 GiB                                                                                                              | From 4 GiB to 512 GiB                                                                                                                                                                                                   | From 4 GiB to 512 GiB                                                                                                                                                                                                   |
| **Maximum Bandwidth** | From 200 Mbps to 3 Gbps                                                                                  | From 400 Mbps to 20 Gbps                                                                                                           | From 400 Mbps to 12.8 Gbps                                                                                                                                                                                              | From 400 Mbps to 12.8 Gbps
