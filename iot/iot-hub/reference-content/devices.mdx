...
Issues when parsing the template will be reported through [Hub events](https://www.scaleway.com/en/docs/scaleway-iothub-events/) as warnings. In this case, the filter can be dropped from the list.
