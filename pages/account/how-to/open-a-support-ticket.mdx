...
<Message type="important">
  {/* ↓ fviolette: Best guess, review link and possibly text ↓ */}
  If you have lost access to the Scaleway console and want to create a ticket, you must first [complete the account recovery procedure](/account/how-to/recover-a-lost-password/).
</Message>
