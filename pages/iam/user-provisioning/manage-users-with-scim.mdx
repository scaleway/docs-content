---
title: How to configure automatic user provisioning with SCIM
...
Combined with [SAML](/iam/user-provisioning/set-up-identity-federation/), it allows IAM managers to fully manage user authentication, lifecycle, and personal data through their Identity Provider:
...
4. Follow the same steps for [first enabling SCIM](/iam/user-provisioning/manage-users-with-scim/#how-to-enable-scim).
