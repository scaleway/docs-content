...
5. Configure the credentials for your bucket:
    ...
    - `Access Key` = Your [Access Key](/identity-and-access-management/iam/how-to/manage-api-keys/)
    - `Secret Key` = Your [Secret Key](/identity-and-access-management/iam/how-to/manage-api-keys/)
