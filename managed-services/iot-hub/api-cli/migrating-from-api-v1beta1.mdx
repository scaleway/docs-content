...
steps:
  - step: Metrics format change
    type: HowToStep
    url: https://www.scaleway.com/en/docs/managed-services/iot-hub/api-cli/migrating-from-api-v1/#-Metrics-format-change
  - step: Device creation
    type: HowToStep
    url: https://www.scaleway.com/en/docs/managed-services/iot-hub/api-cli/migrating-from-api-v1/#-Device-creation
categories: 
  - iot-hub
---
...
<Navigation title="See Also">
  <PreviousButton to="/managed-services/iot-hub/api-cli/connecting-twins-to-grafana-cloud/">Connecting IoT Cloud Twins to Grafana Cloud</PreviousButton>
</Navigation>
