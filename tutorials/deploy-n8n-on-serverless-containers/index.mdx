...
<Message type="note">
Serverless Containers are stateless, meaning local container disk space is temporary. Using Serverless containers safely persists workflows, credentials, and execution logs in your Managed Database across container restarts.
</Message>
...
3. In **Configure advanced options** > **Private Networks**, select the **same Private Network** you attached to your PostgreSQL Managed Database so the container can reach the database.
