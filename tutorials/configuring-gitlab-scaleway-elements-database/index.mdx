...
1. [Create a Managed PostgreSQL Database Instance](/postgresql-and-mysql/how-to/create-a-database/) from the Scaleway console. You are taken to your Database's **Overview** page.
