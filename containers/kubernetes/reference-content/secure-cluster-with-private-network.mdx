...
Yes, you can use a Public Gateway to exit outgoing traffic from your Kapsule nodes having private IPs. For more information on how to configure a Public Gateway, refer to our [Public Gateway documentation](/network/public-gateways/how-to/configure-a-public-gateway/).
