...
<Message type="note">
  Security Groups can allow filtering only public traffic to and from your Instances. To filter traffic within a Private Network, you can [configure a firewall](/tutorials/installation-uncomplicated-firewall/) directly on your Instance.
</Message>
