...
3. Edit the description and/or [preferred Project](/identity-and-access-management/iam/reference-content/using-api-key-object-storage) of the API key as required, and click **Validate**.
