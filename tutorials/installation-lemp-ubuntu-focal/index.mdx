...
By default, the connection between your computer and the server is not encrypted and it is possible to read the communication. To secure the connection you can generate an TLS certificate for free, issued by [Let's Encrypt](https://letsencrypt.org).
