...
3. Click the **Edge Services** tab.
    ...
    <Lightbox src="scaleway-edge-services-customised.webp" /> TODO UPDATE FOR NEW WORDING

4. In the **Disable Edge Services pipeline** panel at the bottom of the screen, click **Disable Edge Services pipeline**.
