...
Use the five connection parameters (host, port, user, password, database name) saved previously to connect your application to the database.

<Message type="important">
  Connection methods vary greatly depending on the framework of your application. Refer to its official documentation for more information.
</Message>
