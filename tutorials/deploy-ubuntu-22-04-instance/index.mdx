...
content:
  h1: Deploying an Ubuntu 22.04 LTS (Jammy Jellyfish) Instance on Scaleway
...
First released in 2004, Ubuntu, whose name is based on an ancient African word meaning _humanity to others_, quickly became the favorite Linux distribution of users around the world, mostly because it is easy to install and use.
