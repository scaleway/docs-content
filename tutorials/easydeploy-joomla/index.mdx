---
meta:
  title: Deploy Joomla on Scaleway Kubernetes clusters using the Easy Deploy feature
...
content:
  h1: Deploy Joomla on Scaleway Kubernetes clusters using the Easy Deploy feature
