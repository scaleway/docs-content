...
<Message type="requirement">
  ...
  - You have an unlocked domain at an external registrar (not Scaleway) and access to its authorization key
  - Your domain name must have at least 15 days before expiration
