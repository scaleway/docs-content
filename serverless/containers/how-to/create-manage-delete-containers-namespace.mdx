...
This page shows you how to create and manage a Serverless Containers namespace. [Namespaces](/containers/concepts/#namespace) allow you to group your containers and share environment variables between them.
...
4. Click **Create namespace only** to finish, or click **Create namespace and add container** if you want to [deploy a container](/containers/how-to/deploy-container/) next.
