...
An Instance is a computing unit, either virtual or physical, that provides resources to run your applications on. Currently, Scaleway offers the following Instance types: [General Purpose](#general-purpose-instance), [Development](#development-instance), [GPU](#gpu-instance), [Stardust](#stardust-instance) and [Enterprise](#enterprise-instance). For more information about the different ranges of Instances, see our [dedicated documentation](/compute/instances/reference-content/choosing-instance-type/).
