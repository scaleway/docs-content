---
title: Clusters for Apache Spark™ - Quickstart
description: Get started with Scaleway Clusters for Apache Spark™ quickly and efficiently.
tags: data lab clusters apache spark notebook jupyter processing
dates:
...
Discover the Clusters for Apache Spark™ interface on the Scaleway console.
...
3. Complete the following steps in the wizard:
    ...
    - Select a **CPU** or **GPU** worker node configuration.
...
Refer to the [dedicated documentation](/data-lab/how-to/create-data-lab/) for comprehensive documentation on how to create a cluster.
...
4. Enter your [API secret key](/iam/concepts/#api-key) when prompted for a password, then click **Log in**.
