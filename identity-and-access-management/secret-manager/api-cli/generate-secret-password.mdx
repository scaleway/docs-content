...
Once you have [created a secret](/identity-and-access-management/secret-manager/how-to/create-secret/) with Scaleway Secret Manager, you can send a request to generate a password for it. This will create a new version of your secret, in which your password will be generated and securely stored.
