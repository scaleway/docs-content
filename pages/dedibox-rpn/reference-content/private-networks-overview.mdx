...
import image3 from './assets/scaleway-private-networks-schema.webp'
...
<Lightbox image={image} width="500" alt="" />
...
<Lightbox image={image2} width="500" alt="" />​ 
...
<Lightbox image={image3} width="500" alt="" />
