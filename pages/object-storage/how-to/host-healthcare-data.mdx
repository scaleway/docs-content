...
- You must not use the [Glacier](/object-storage/concepts/#storage-class) storage class. Refer to the [Shared responsibility model](/object-storage/reference-content/storage-shared-responsibility-model/) for more information on this requirement.
