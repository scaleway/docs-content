...
A Scaleway Messaging namespace enables systems, applications, and services to communicate with each other and exchange information. A Messaging namespace allows you to isolate queues and group credentials. Each namespace has a **type**, currently either [NATS](#nats) or [SQS/SNS](#sqssns) which defines the [messaging protocol](#messaging-protocol) to be used.
