...
<Navigation title="See Also">
  <PreviousButton to="/iot/iot-hub/api-cli/iot-hub-events/">Triggering IoT Hub events</PreviousButton>
  <NextButton to="/iot/iot-hub/api-cli/iot-hub-routes/">Configuring IoT Hub routes</NextButton>
</Navigation>