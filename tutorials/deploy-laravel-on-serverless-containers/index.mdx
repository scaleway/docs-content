...
Laravel applications make use of [queues](https://laravel.com/docs/10.x/queues) to process long running jobs in the background. As this feature of the Laraval framework is nearly always used, we will configure it and leverage the [Messaging & Queuing](https://www.scaleway.com/en/messaging-and-queuing/) product from Scaleway. The [Scaleway Developer documentation](https://www.scaleway.com/docs/serverless/messaging/) provides clear information on how this managed service works and can be configured.
...
The Scaleway documentation website provides a Quickstart on how to [create and manage a Serverless Container Namespace](https://www.scaleway.com/docs/serverless/containers/quickstart/).
