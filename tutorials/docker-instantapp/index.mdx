...
Docker is an open source containerization platform. Docker allows developers to package their applications into containers, using OS-level virtualization. This page shows you how to create an Instance with Docker preinstalled using the Docker [InstantApp](/compute/instances/concepts/#instantapp) based on Ubuntu 22.04, and then how to start using Docker for your containerization projects.
