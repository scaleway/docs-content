...
3. Add the following block and replace the placeholder with the Project ID in which you want to create resources:
    ...
    <Message type="note">
    If you do not specify a Project ID, Terraform will use the default Project specified in the [Scaleway configuration file](/terraform/reference-content/scaleway-configuration-file/).
    </Message>
