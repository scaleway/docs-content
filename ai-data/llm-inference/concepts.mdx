---
meta:
  title: LLM Inference - Concepts
  description: This page explains all the concepts related to LLM Inference
content:
  h1: LLM Inference - Concepts
...
Allowed IPs are single IPs or IP blocks which have the [required permissions to remotely access a deployment](/ai-data/llm-inference/how-to/manage-allowed-ip-addresses/). They allow you to define which host and networks can connect to your LLM Inference endpoints. You can add, edit, or delete allowed IPs. In the absence of allowed IPs, all IP addresses are allowed by default.
