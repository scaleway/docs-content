...
2. Install Strapi in this directory and create a new project:
    ...
    ```
    <Message type="tip">
      Strapi version 4.14.2 was the latest release available at the time writing this tutorial. Check out their [GitHub repository](https://github.com/strapi/strapi/releases) to find information about the latest Strapi release.
    </Message>
