...
content:
  h1: Getting Started with the Drupal InstantApp
  paragraph: This page shows you how to use the Drupal InstantApp on your instance.
tags: compute CMS apps instance Drupal
steps:
...
The new security group configuration will be applied automatically on Instances. Bare Metal servers need to be hard rebooted from the management console to configure the new rules.
