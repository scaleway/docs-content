...
This page explains how to use logic tasks to create more complex workflows. Data Orchestrator is based on the [Open Workflow Specification](https://open-workflow-specification.org/). For information on other tasks, see the [Open Workflow DSL Reference](https://github.com/open-workflow-specification/specification/blob/main/dsl-reference.md).
