...
<Navigation title="See Also">
  <PreviousButton to="/dedibox-console/classic-hosting/how-to/manage-mysql-database-phpmyadmin/">How to manage MySQL databases with PHPmyAdmin</PreviousButton>
  <NextButton to="/dedibox-console/classic-hosting/how-to/change-password-postgresql-database/">How to change the password of a PostgreSQL database</NextButton>
</Navigation> 
