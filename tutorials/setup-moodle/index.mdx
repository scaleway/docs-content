...
Update the systems `apt` repository information and upgrade it to make sure that the system is up to date and has the latest bug-fixes and updates installed. Then, use Ubuntu's apt package manager to install the stack packages.
