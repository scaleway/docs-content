...
<ProductHeader
   ...
   productLogo="mongoDB"
   description="Managed MongoDB® provides scalable, secure, and fully managed NoSQL solution based on market-leader technology that allows developers to focus on building applications without the need to manage infrastructure."
