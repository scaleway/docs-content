...
<Message type="important">
  You must [create](/bare-metal/elastic-metal/how-to/create-server/) a new Elastic Metal server and [reinstall](/bare-metal/elastic-metal/how-to/reinstall-server) your server to switch from monthly billing to hourly billing and vice-versa. 
</Message>
...
The amount of the reward is a cloud service voucher in the sum of the commitment fees at the time of purchase. It can be used for all Scaleway Cloud products (except Elastic Metal servers and their associated options) and is valid for six months. You receive the reward once per physical server, and it is automatically added to your Scaleway account. [Learn more about how to get and use a loyalty reward.](/bare-metal/elastic-metal/how-to/get-use-loyalty-reward/)
