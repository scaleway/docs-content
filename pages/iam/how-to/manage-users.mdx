...
import image3 from './assets/scaleway-groups-overview.webp'
import image4 from './assets/scaleway-iam-policies.webp'
import image5 from './assets/scaleway-api-key.webp'
import image6 from './assets/scaleway-remove-user.webp'
import image7 from './assets/scaleway-remove-user-popup.webp'
...
2. Click **Remove user**. A warning displays, asking you to confirm your action:
    <Lightbox src={image7} alt="A pop up box displaying a warning: Removing a user from this Organization automatically deletes their API keys, and any policies directly attached to them become orphaned" />
