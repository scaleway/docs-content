...
<Message type="tip">
Alternatively, you can delete a project from the **Projects** tab of the [Organization Dashboard](https://account.scaleway.com/?service=elementsorganization/projects), by clicking <Icon name="more" />, then **Delete** next to the name of the Project you want to delete.
</Message>
