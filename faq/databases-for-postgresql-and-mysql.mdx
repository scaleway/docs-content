...
[Private Networks](/network/public-gateways/ic-gateways/quickstart/) allows you to configure your own Layer-2 network with IPv4 adresses. You can therefore enhance the security of your system architecture by isolating it from the Internet. 
...
<Message type="tip">
  You can use the Database virtual IP (VIP) in a DHCP-controlled environnement by [reserving the IP](/network/public-gateways/how-to/configure-a-public-gateway/#how-to-review-and-configure-dhcp) in the DHCP server configuration to be sure it is not assigned to any other Instance, then configure it on the Private Networks endpoint.
</Message>
...
Please use the [read replica feature](/managed-databases/postgresql-and-mysql/how-to/create-read-replica/).
