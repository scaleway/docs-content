...
5. Open the file in a text editor and paste the following content. Make sure to replace the values in the example with your own and save them before exiting the text editor.
    ...
    <Message type="note">
        To retrieve the DUID run the following command:
...
Refer to [Scaleway network information](/account/reference-content/scaleway-network-information/) for more information.