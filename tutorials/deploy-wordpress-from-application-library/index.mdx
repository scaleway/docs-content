...
This tutorial teaches you how to install WordPress on a Scaleway [Kubernetes Kapsule](https://www.scaleway.com/en/docs/containers/kubernetes/quickstart/) or Kosmos cluster by using the [Application Library in the Easy-Deploy feature](https://www.scaleway.com/en/docs/containers/kubernetes/how-to/enable-easy-deploy/). 
...
<Message type="requirement">
  ...
  - You have a [Kubernetes cluster](https://www.scaleway.com/en/docs/containers/kubernetes/how-to/create-cluster/) at Scaleway (Kapsule or Kosmos)
  - You have [kubectl](https://www.scaleway.com/en/docs/containers/kubernetes/how-to/connect-cluster-kubectl) installed on your local computer
</Message>
