...
Scaleway Object Storage uses erasure code (6+3) to secure your data, which is currently distributed across three different racks inside the same datacenter. In case one rack becomes unavailable, we are still able to rebuild your data. 
