---
meta:
  title: Deploy BigBlueButton on your Bare Metal server
  description: Discover how to deploy the BigBlueButton web conferencing system on your Bare Metal Server
content:
  h1: Deploy BigBlueButton on your Bare Metal server
  paragraph: Discover how to deploy the BigBlueButton web conferencing system on your Bare Metal Server
tags: compute BigBlueButton videocalls videoconference bbb Bare-Metal-Server
steps:
