...
5. When finished, make sure your data is stored in your new database by [connecting to it](/postgresql-and-mysql/how-to/connect-database-instance/), and performing a query.
...
1. Register your new database in pgAdmin. Refer to the [How to connect to a Managed Database for PostgreSQL](/postgresql-and-mysql/how-to/connect-database-instance/#how-to-set-up-credentials) documentation for more information.
...
9. When finished, make sure your data is stored in your new database by [connecting to it](/postgresql-and-mysql/how-to/connect-database-instance/), and performing a query.
...
- A Fivetran account and can connect to the [Fivetran console](https://fivetran.com/dashboard)
...
- Installed or have access to [Apache Nifi](https://nifi.apache.org/)

- [Created a target Managed Database for PostgreSQL](/managed-databases/postgresql-and-mysql/how-to/create-a-database/) to import your data into.

- Checked that the target database you are importing into is empty, or contains data you can overwrite.

#### Configuring the processor to connect to your existing database

1. Drag and drop the **Processor** icon from the top-left menu to the main into the middle area.

2. Right-click it, and select **Configure**.

3. Access the **Properties** tab.

4. Select **PostgreSQL** as a **Database Type**.

5. Enter the name of the table you want to load content from in the **Database Name** field.

6. Click **Create new service**, select **DBCPConnectionPool**, click **OK**, then click the arrow to the right to access the DBCPConnectionPool configuration.

5. Click the **Configure** icon for DBCPConnectionPool and fill in the required information:
    ...
    <Message type="tip">
    You can check if your connection works by ticking the checkbox, and by clicking **Verify**.
    </Message>

6. Enable your DBCPConnectionPool by clicking on the thunder icon, then on **Enable**.
...
2. When finished, make sure your data is stored in your new database by [connecting to it](/postgresql-and-mysql/how-to/connect-database-instance/), and performing a query.
