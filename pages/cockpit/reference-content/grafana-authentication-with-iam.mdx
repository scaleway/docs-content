...
1. Open the new IAM-compatible URL. If you are not already authenticated, the Scaleway login page displays.
2. Log in using your Scaleway credentials. Your Grafana dashboard displays.

<Message type="note">
 If you were already authenticated to Scaleway, you may be logged in automatically. In some multi-organization cases, depending on your most recent active Organization, you might still be prompted to log in again.
</Message>
...
2. If you have Grafana users who are not in your Scaleway Organization:
  ...
  - [Invite them as Members](/iam/principals/manage-members/#how-to-create-a-member) to your Organization.
