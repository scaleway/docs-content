...
tags: storage
excerpt: |
  There is an easier and faster way to abort multipart uploads, using the open-source S3-compatible client mc, from MinIO. In this tutorial, we show you how to use mc to abort and clean up all your incomplete multipart uploads at once.. 
totalTime: PT15M
steps:
