...
<Message type="tip">
  This page explains how to deploy containers using the Scaleway console. For advanced usage, such as larger projects with dependencies, automation, multiple containers, and more, there are [several ways to deploy containers](/serverless/containers/reference-content/deploy-container/). Check out our [scaleway/serverless-examples repository](https://github.com/scaleway/serverless-examples) for real-world examples.
</Message>
