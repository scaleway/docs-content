...
Your hourly billing for a storage volume begins when you create the volume (either during the creation of an Instance, or by creating a [new volume](/block/how-to/create-a-volume/)), and ends when you [delete](/block/how-to/delete-a-volume/) the volume from your account.
