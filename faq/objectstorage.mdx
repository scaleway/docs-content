...
Scaleway Object Storage storages data across multiple storage systems to achieve high availability. Any read (`GET` or `LIST`) request initiated after a successful PUT request will immediately return the data written by the `PUT` request.
...
Each Scaleway's project can use up to 250 TB of Object Storage resources. If you wish to increase your Object Storage quota, contact the Support.
