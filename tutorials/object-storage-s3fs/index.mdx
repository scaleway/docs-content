...
1. Execute the following commands to enter your S3 credentials (seperated by a `:`) in a file `$HOME/.passwd-s3fs` and set owner-only permissions. This presumes that you have set your [API credentials](/identity-and-access-management/iam/how-to/manage-api-keys/) as environment variables named `ACCESS_KEY` and `SECRET_KEY`:
    ```
