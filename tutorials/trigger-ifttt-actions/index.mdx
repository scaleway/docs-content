...
1. Please follow [this procedure](/managed-services/iot-hub/how-to/create-hub) to create an IoT Hub. Select your name and plan of choice, and click the `Create Hub` button.
