...
categories:
  - billing
---
import image from './assets/scaleway-bank-statement.webp'
...
<Lightbox src={image} alt="Screenshot of a bank account statement. Under the transactions section, an entry called SCW*C-6569E-COMMERCE displays. The validation code is represented by the number sequence" />
