...
The NATS CLI (`nats`) is the official NATS tool for managing your NATS resources. It aloows you to simply create and manage your streams, consumers and more.
...
<Message type="important">
  ...
  - Choosing three replicas has an implact on:
