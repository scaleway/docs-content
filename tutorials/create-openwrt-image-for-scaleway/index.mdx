...
To create a custom image, you need to build a [QCOW2 image](https://www.linux-kvm.org/page/Qcow2) and [create a snapshot](/instances/how-to/create-a-snapshot/) from it.
...
In this example, we use the [AWS CLI](/object/api-cli/object-storage-aws-cli/).
