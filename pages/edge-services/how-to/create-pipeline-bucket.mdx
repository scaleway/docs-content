...
The two endpoints shown above are available as standard. However, with Edge Services, you can also choose to configure a **custom domain** (root domain or subdomain) from which your bucket can be accessed. Read more about this in [How to configure a custom domain](/edge-services/how-to/configure-custom-domain/).