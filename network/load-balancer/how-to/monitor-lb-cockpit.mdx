...
From the main Scaleway Cockpit dashboard, click **Dashboards** --> **LB Overview** in the side menu.
...
From the main Scaleway Cockpit dashboard, click **Dashboards** --> **LB Logs Overview** in the side menu.
