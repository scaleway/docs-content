---
meta:
  title: Creating a virtual MAC address for a failover IP
  description: This page explains how to create a virtual MAC address for a failover IP.
content:
  h1: Creating a virtual MAC address for a failover IP
...
<Message type="requirement">
  ...
  - You have ordered a [failover IP](/bare-metal/dedibox/concepts/#failover-ips)
</Message>
...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/network/reference-content/configure-windows">Configuring a failover IP on Windows Server</PreviousButton>
  <NextButton to="/bare-metal/network/reference-content/configure-multiip-virtualmac">Configuring a multi-IP virtual MAC group</NextButton>
</Navigation>
