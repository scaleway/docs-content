...
We recommend you use the [MongoDB® replica set](https://www.mongodb.com/docs/manual/replication/) to improve Rocket.Chat's performance with Meteor Oplog tailing.
