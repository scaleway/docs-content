...
3. Click **\*Administrator** -> **Organization** in the top right corner of the Greenlight frontend to access the admin interface.
    ...
    For further information regarding BigBlueButton, refer to the official documentation for [BigBlueButton](http://docs.bigbluebutton.org/) and [Greenlight](https://docs.bigbluebutton.org/greenlight/v2/overview).
