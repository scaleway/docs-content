...
=======
Some resources, including Databases and Public Gateways, must be attached to Private Networks from their own sections of the console. See the separate documentation for [attaching Databases to Private Networks](/storage/database/how-to/connect-database-private-network/), and for [attaching Public Gateways to Private Networks(#how-to-attach-your-public-gateway-to-your-private-network). Currently, only Instances and Elastic Metal servers can be attached to Private Networks from the VPC section of the console using the method below.
