...
<Grid>
    ...
    <DefaultCard
      ...
      description="Learn about the internet and Block Storage bandwidth available for each GPU Instance type."
...
<Grid>
    <DefaultCard
      ...
      description="Learn to share a physical GPU among multiple containers or pods in a Kubernetes cluster."
      url="/gpu/reference-content/kubernetes-gpu-time-slicing/"
      label="See more"
    />
    <DefaultCard
      title="Installing NVIDIA drivers on Ubuntu 22.04"
      description="Learn to manually install the NVIDIA drivers on an Ubuntu 22.04 image."
