...
2. Click **Reserve private IP**. The following screen displays:
    ...
    <Lightbox src={image2} alt="A pop-up screen, showing the parameters to define for the private IP to reserve: type (IPv4 or IPv6), tags, region, VPC and Private Network" />
