...
- Have created Scaleway resources to monitor
- Grafana [credentials](/observability/cockpit/how-to/retrieve-grafana-credentials/) with the **Editor** role
- Have [activated managed alerts and created at least one contact point](/observability/cockpit/how-to/activate-managed-alerts/)
- Use the **Scaleway Alerting** alert manager in Grafana
