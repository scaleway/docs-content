...
3. Complete the following steps in the wizard:
    ...
    - Choose **Name** for your Public Gateway, and, optionally, tags.
...
6. Use the toggle <Icon name="toggle" /> to tell the gateway whether or not it should [advertise the default route](/network/public-gateways/concepts/#default-route) to the internet for attached resources.
