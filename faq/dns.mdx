...
meta:
  title: DNS
  description: Let us address the most common questions you have about DNS.
content:
  h1: DNS
  paragraph: Let us address the most common questions you have about DNS.
image: DNS.png
---
...
## What are Scaleway Elements DNS nameservers?

Scaleway Elements DNS servers are :
- `ns0.dom.scw.cloud`
- `ns1.dom.scw.cloud`