...
<Message type="important">
  The VNC port on Mac mini systems is **randomly assigned** during system installation and does not the default VNC port 5900. To connect successfully via VNC, use the specific port shown in the "Overview" section of your Mac mini’s configuration.
