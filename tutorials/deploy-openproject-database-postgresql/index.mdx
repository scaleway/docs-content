...
content:
  h1: Deploying OpenProject with a Managed Database for PostgreSQL
  paragraph: Learn how to install and configure OpenProject on Ubuntu Focal Fossa 20.04 while integrating a managed database for PostgreSQL instance with your stack.
...
In this tutorial you will learn how to install and configure OpenProject on an Instance running Ubuntu Focal Fossa 20.04 while integrating a PostgreSQL [Managed Database](https://www.scaleway.com/en/database/) into your stack.
...
Follow the instructions to [create a Database Instance]/en/docs/storage/database/how-to/create-a-database/). Ensure that you select **PostgreSQL** as the database engine.
...
3. Insert the database IP. This is found your Database Instance's **Overview** tab, under **Endpoint**, and is the sequence of numbers before the **:**.
<Lightbox src="scaleway-postgresql-ip-or-hostname.png" alt="" />

4. Enter the PostGreSQL port. This is found your Database Instance's **Overview** tab, under **Endpoint**, and is the sequence of numbers before the **:**.
...
6. Enter the name of your Database Instance (displayed at the top of its *Overview** page, or in the list of your Managed Databases:
