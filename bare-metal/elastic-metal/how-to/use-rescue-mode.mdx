...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/elastic-metal/how-to/view-the-event-logs/">How to view event logs</PreviousButton>
  <NextButton to="/bare-metal/elastic-metal/how-to/reboot-server/">How to use reboot a server</NextButton>
</Navigation>
