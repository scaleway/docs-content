...
If you require additional information to comply with specific regulations, you can create a [support ticket](https://account.scaleway.com/?service=elementssupport/tickets/create) or contact your account manager.
