...
This page shows you how to push your metrics and logs from a [Scaleway Instance](/compute/instances/concepts/#instance). You can also use this tutorial to push metrics and logs from non-Scaleway Instances.
