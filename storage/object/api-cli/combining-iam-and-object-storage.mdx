...
An IAM policy must be created to grant full access to Object Storage resources in Project 1 to application A, user B and application C.
```json
{
   "name": "policy-S3-proj1",
   ...
   "application_id": "950dde46-5cba-427d-a4f5-ce5a8a79717c",
   "application_id": "1fd36996-a355-4449-85cf-4927508a2579",
   "user_id": "81a2ad27-2273-4bf9-976f-3f06957ab6e1"

}
```
In the bucket policy below, we declare in the first statement that all available actions are allowed for applications A and C, and we create a different statement to declare that user B is denied all available actions.
```json
{
    "Version": "2012-10-17",
    "Id": "production-bucket-1-policy",
