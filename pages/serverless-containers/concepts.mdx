...
An endpoint is the URL generated to access your resource. It can be customized with [custom domains](#custom-domain). The public endpoint can be disabled to secure access to your container.
