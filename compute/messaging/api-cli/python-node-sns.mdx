...
meta:
  ...
  description: This page explains how to using Python or NodeJS with SNS Messaging and provides code samples
content:
  h1: Using Python or NodeJS with SNS Messaging
  paragraph: This page explains how to using Python or NodeJS with SNS Messaging and provides code samples
tags: messaging
categories: 
  - messaging
---
...
```
The HTTP server receive an HTTP request with a `json` body matching the following format:
