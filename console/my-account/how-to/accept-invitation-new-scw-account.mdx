...
When a Scaleway user invites you to join their Organization you receive an invitation via email. If you do not yet have a Scaleway account upon receiving this email, you will not be able to effectively join the Organization.
...
9. Follow the [How to sign in with a magic link](/console/my-account/how-to/sign-in-with-magic-link/) procedure.
...
2. Follow the [How to use MFA](/console/my-account/how-to/use-2fa/) procedure to enable MFA in your account.
