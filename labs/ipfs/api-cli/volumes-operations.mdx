...
<Message type="important">
    To manage IPFS with the Scaleway CLI, you must set the `SCW_ENABLE_LABS` flag to `true`, as such: `SCW_ENABLE_LABS=true`
    We recommend you export the flag as an environment variable, so you do not have to set it for every command.
</Message>
