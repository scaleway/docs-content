...
1. Click **Domains and DNS** in the **Domains & Web Hosting** section of the [Scaleway console](https://account.scaleway.com/?service=elements) side menu. The Domains and DNS screen displays.
...
1. Click **Domains and DNS** in the **Domains & Web Hosting** section of the [Scaleway console](https://account.scaleway.com/?service=elements) side menu. The Domains and DNS zone screen displays.
