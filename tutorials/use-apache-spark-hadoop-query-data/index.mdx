...
Once Spark is installed, we will log into the main machine using [SSH](/compute/instances/how-to/connect-to-instance/) to run Spark commands.
...
2. Check that there are four workers registered on the spark main instance.
