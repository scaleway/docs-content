...
Consider an Organization in which a user and an application must perform specific tasks with Scaleway Object Storage in a [project](/console/organizations-and-projects/concepts/#project) named `S3-project`.
