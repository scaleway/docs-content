...
We follow closely your feedbacks and latest models release. For Serverless usage, our goal is to provide a curated but balanced model catalog across different modalities (Text, Code, Vision, Audio...), model sizes and providers.
