...
Scaleway plans to release its own package archive later this year to avoid such situations where we have no control over archive signatures. Until then, the verification date has been overridden to 01-02-2028 to avoid those messages.
