...
1. Head to the [Serverless section](https://account.scaleway.com/?service=elementsserverless/) of your Scaleway console and create a new Namespace.
...
1. Create an IoT Hub in the [IoT Hub section](https://account.scaleway.com/?service=elementsiot-hub/hubs) of the Scaleway console.
