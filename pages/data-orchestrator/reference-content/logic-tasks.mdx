...
This page explains how to use logic tasks to create more complex workflows. For information on other tasks and concepts, see the [Data Orchestrator DSL Reference](/data-orchestrator/reference-content/dsl-reference/).
...
A switch case defines a condition to evaluate and an action to execute when that condition is met.
  ...
  <TabsTab label="Try-catch">
    ...
    **Try > Catch properties**
    ...
    See the [Error properties](/data-orchestrator/reference-content/dsl-reference#error), [Retry policy properties](/data-orchestrator/reference-content/dsl-reference#retry) and [Flow directive properties](/data-orchestrator/reference-content/dsl-reference#flow-directive) for more details.
  </TabsTab>
</Tabs>