...
You can find all of the code on [github](https://github.com/scaleway/serverless-scraping-tutorial), so feel free to dive right into it! Or follow along with the step by step explaination.
