...
<Message type="note">
  Newly created Kapsule clusters are deployed with IP mobility enabled by default. For existing clusters, you can manually launch the migration to routed IPs.
</Message>
