...
6. If you want to add pools, click **Configure pools** to proceed. If you do not wish to add any pools, click **[Review](#review-configuration)**.
...
2. Specify the following for each pool:
    * For **Scaleway** pools:
      ...
      * Configure **pool options** or retain default settings. Configuration options include:
        * **Operations** tab: Configure node count and choose whether to enable autoscaling and [autoheal](/kubernetes/concepts/#autoheal).
