...
- Basic knowledge and familiarity with Docker and basic Kubernetes concepts.
- Access to your Docker images (locally or in a registry).
- The following tools installed:
  - [Docker](https://docs.docker.com/get-docker/)
  - [kubectl](https://kubernetes.io/docs/tasks/tools/)
  - [Scaleway CLI (optional but recommended)](https://www.scaleway.com/en/docs/cli/install)
...
- [Scaleway Container Registry](/containers/container-registry/quickstart/) (recommended)
...
- Use **[Scaleway Cockpit](/observability/cockpit/quickstart/)** for basic monitoring and metrics.
