...
Bear in mind that in cluster mode, Private Networks are only available at the creation of the cluster Instance and cannot be modified afterwards. If you want to switch back to a public network or update your IP addresses, you will have to create a new Redis™ Database Instance. 
