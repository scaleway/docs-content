...
<Message type="tip">
  Check out our multipart uploads [documentation page](/object/api-cli/multipart-uploads/) for more information.
</Message>
...
<Message type="note">
  If you want to learn more about this request, check out the POST Object [documentation page](/object/api-cli/post-object/).
</Message>
