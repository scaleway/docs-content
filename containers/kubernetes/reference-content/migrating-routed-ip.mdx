---
meta:
  title: Safely Migrating Kapsule clusters to routed IPs
  description: Safely Migrating Kapsule clusters to routed IPs
content:
  h1: Safely Migrating Kapsule clusters to routed IPs
...
## Migrating your Kapsule cluster to routed IPs
