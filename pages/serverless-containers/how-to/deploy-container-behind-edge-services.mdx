...
<Message type="note">
This same procedure applies to **Serverless Functions**. The Edge Service backend stage supports both backends. Replace the container namespace and container resources with the equivalent Function namespace and function resources. Then use the corresponding function ID in the backend stage configuration.
</Message>
...
1. Your Edge Services endpoint URL will be:
   ...
   `https://${scaleway_edge_services_tls_stage.main.id}.svc.edge.scw.cloud`
