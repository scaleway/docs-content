...
2. Copy the following content into the configuration file.
    ...
    <Message type="important">
      For security reasons, we recommend that you use an encrypted connection to the Zabbix web interface. A free certificate can be obtained from [Let's Encrypt](/tutorials/installation-lemp-ubuntu-bionic/#configuring-tlsssl-with-lets-encrypt).
    </Message>
