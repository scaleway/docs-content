...
Incomplete multipart uploads that have not been aborted are still subject to billing. For more information on how to view and abort incomplete MPUs, refer to the [dedicated documentation](/object/how-to/abort-incomplete-mpu/).
</Message>
...
<Message type="note">
You can also [abort incomplete multipart uploads manually](/object/how-to/abort-incomplete-mpu/) using the Scaleway console, or automatically using [lifecycle rules](/object/how-to/manage-lifecycle-rules).
</Message>
