...
description: Deploy a Serverless Container behind a Scaleway Edge Service pipeline using the CLI. Configure HTTPS termination and a public endpoint.
tags: serverless containers edge services deploy CLI
dates:
