...
Setting up an [MX record](/transactional-email/concepts#mx-record) is highly recommended to ensure your email deliverability. Find out [how to add an MX record to your domain](/transactional-email/quickstart/#how-to-add-your-own-mx-record). You can also [use Scaleway's blackhole MX](/transactional-email/how-to/authenticate-domain/#how-to-configure-mx-records#how-to-add-scaleways-mx-record) if you do not have your own MX.
...
Yes. You can authorize sending emails from a specific IP address by [configuring conditions in IAM policies](/iam/policies-permissions/understanding-policy-conditions/).
...
You need to [add SPF and DKIM records](/transactional-email/how-to/authenticate-domain/#how-to-configure-spf-records) to be able to send emails. Find out [how to set up your DNS records for other DNS providers](/tutorials/set-up-spf-dkim-for-dns-providers/).

### Why do emails take several minutes to send?

The sending time depends on your domain [reputation](/transactional-email/concepts#reputation-score) and the IP address used. For new IP addresses, Transactional Email progressively grants more email volume to ensure good domain reputation. For more information, see [Understanding your reputation score with TEM](/transactional-email/reference-content/understanding-tem-reputation-score/) and [Protecting domain reputation](/transactional-email/reference-content/protecting-your-domain-reputation/).
...
Domains are automatically blocked to protect the domain [reputation](/transactional-email/reference-content/understanding-tem-reputation-score/) when you have a high rate of undelivered emails. The solution is detailed on a [dedicated troubleshooting page](/transactional-email/troubleshooting/blocked-domain/).

### How do I solve the errors "DMARC policy failure", "Multiple SPF records found", "SPF lookup limit exceeded", or invalid records?
The solutions for most common issues you may encounter are detailed on a [dedicated troubleshooting page](/transactional-email/troubleshooting/fix-common-issues/).
