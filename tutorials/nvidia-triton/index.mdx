...
<Message type="requirement">
  ...
  - You have [created a GPU Instance](/compute/instances/how-to/create-an-instance/) that runs Ubuntu GPU 12
  - You have [activated your Observability Cockpit](/observability/cockpit/how-to/activate-cockpit/)
