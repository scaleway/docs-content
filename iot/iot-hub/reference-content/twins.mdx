...
The document named `_config` is reserved and cannot be used as a normal document see [below](#twins-configuration).
...
- `_<config_key>`, `<config_value>` are configuration parameters, see [below](#configuration-parameters).
