...
- A [caching service](/edge-services/how-to/configure-cache/) to improve performance by reducing load on your [backend](/edge-services/concepts/#)
...
- A certain amount of egress cache data (the quantity of data transferred from Edge Services' caches, not including the transfer from the bucket or Load Balancer).
