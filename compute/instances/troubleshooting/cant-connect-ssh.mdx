...
Sometimes you may have a problem when connecting to your Instance. If you've followed the instructions in our document [How-to connect to your Instance via SSH](/compute/instances/how-to/connect-to-instance/) and are getting one of the following error messages, check out our solutions.
