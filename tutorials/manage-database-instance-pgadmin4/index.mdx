...
pgAdmin is an open-source management tool for PostgreSQL databases. It allows the management of your [Scaleway Database Instances](https://www.scaleway.com/en/managed-postgresql-mysql/) and other PostgreSQL databases through an easy-to-use web-interface within your web browser.
...
- A [Database for PostgreSQL](https://www.scaleway.com/en/managed-postgresql-mysql/)
