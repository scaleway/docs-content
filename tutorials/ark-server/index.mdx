...
Deploying your own "Ark: Survival Evolved" server can be done in a few steps on a [Scaleway Elements Developent Instance](https://www.scaleway.com/en/virtual-instances/development/). If you do not have a Instance yet, start by [deploying your first instance](/compute/instances/how-to/create-an-instance/).
