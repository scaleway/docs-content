...
4. Click **Update volume size** to confirm.
    ...
    <Message type="tip">
      Refer to our [dedicated documentation](/block/api-cli/managing-a-volume/#increasing-the-partition-size-of-the-volume-with-growpart) to find out how to increase your volume's partition size.
    </Message>
