...
content:
  h1: Deploying Umami web analytics on Scaleway Serverless Containers
  paragraph: Discover how to deploy Umami web analytics on Scaleway Serverless Containers.
...
- A [Database for PostgreSQL](/postgresql-and-mysql/quickstart/)
- Installed [Docker](/tutorials/install-docker-ubuntu-bionic/) on your local computer

## Preparating the database

1. Create a [database user](/postgresql-and-mysql/how-to/add-users/) and [grant permissions](/postgresql-and-mysql/how-to/manage-permissions/) to the PostgreSQL database you want to use for Umami.
