...
The [RPN SAN](/rpn/concepts/#rpn-san) is an iSCSI target, it is possible to mount it in Windows Server 2012 or later to use it as a normal disk in the system.
