---
title: Quickstart Domains
description: This page shows you how to get started with Scaleway Domains.
excerpt: |
  This page shows you how to get started with Scaleway Domains.
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/dedibox-network/domains/quickstart
image: /assets/images/docs/scaleway.png
keywords: instances, cloud computing, scaleway, online, domain
dates:
  validation: 2021-05-26
  posted: 2021-05-26
---

A domain name is the equivalent of your postal address on the web, and allows your users to find your website. Scaleway offers you the possibility of purchasing a domain name with or without web hosting. Depending on availability, you can purchase the domain name and extension (.com, .fr, .net etc) of your choice.
...
1. In your browser, navigate to [the domain name order page](https://www.scaleway.com/en/domain/).
  ...
  <Lightbox src="scaleway-order-domain.png" alt="" />
...
4. Scroll to the bottom of the page and click **Order**. The **Hosting** page displays.
  ...
  <Lightbox src="scaleway-order-domain-hosting.png" alt="" />
...
8. Select the domain owner from your existing contacts, or choose to create a new contact.
  ...
  <Lightbox src="scaleway-order-domain-contact.png" alt="" />
...
10. Check the summary of your order and select a payment mode from the drop-down menu. You must also agree to the terms of service and web hosting specific terms, and choose whether to activate automatic renewal of your domain.
  ...
  <Lightbox src="scaleway-order-domain-summary.png" alt="" />
...
2. Click on the link in the email within 15 days to confirm that your email address is valid.
  ...
  If you are expecting a validation e-mail (e.g. if you have modified your domain owner's contact information) but cannot find the email, try the following steps:

    - Check your SPAM folder
    - Check and update (if neccessary) the e-mail address of your domain name contact from the [console](https://console.online.net/)
    - Open a ticket or contact the support team directly. They will be able to check to which address the validation e-mail has been sent and whether it has been validated or not.
