...
All Scaleway Dedibox dedicated servers support IPv6. You can request a free `/48` IPv6 prefix for your account, which can be divided into multiple `/56` or `/64` subnets. IPv6 support is available for Dedibox servers located in Paris and Amsterdam.
