...
1. Create a Scaleway Object Storage bucket.
    ...
    You need an S3 bucket to export your QCOW2 file into. Any bucket that belongs to the same project as the snapshot can be used. However, if you don't have one already, you can [create it](/storage/object/how-to/create-a-bucket/) in the console.
