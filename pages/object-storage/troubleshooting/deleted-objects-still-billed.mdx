...
1. Check the versioning status of your bucket via the [Scaleway console](https://account.scaleway.com/?service=elementsobject-storage/buckets), or using the [GetBucketVersioning](/object-storage/api-cli/bucket-operations/#getbucketversioning) command:
    ```
