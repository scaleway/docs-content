...
<Lightbox src={image} alt="A schema shows how the NACL sits at the intersection of two Private Networks in a Scaleway VPC" />
...
<Lightbox src={image2} alt="A schema shows how the NACL sits at the intersection of two Private Networks in a Scaleway VPC. Packets attempt to travel between Private Networks, and are either allowed or denied according to NACL rules" />
...
<Lightbox src={image3} alt="A table shows a number of NACL rules" />
