...
3. Complete the following steps in the wizard: 
    - Choose an **Availability Zone**, which is an isolated location within a specific region.
    - Choose an **Instance type**. Different Instance types have different prices, processing power, memory, SSD disks and bandwidth. See our dedicated documentation on [choosing an Instance type](/compute/instances/reference-content/choosing-instance-type/) to help you choose the best Instance type for your needs.
...
4. Click **Create Instance** to create your Instance. You will be informed when the Instance is ready.
