...
<Message type="important">
  The installation of pfSense is done using the [KVM-over-IP device](/dedibox-kvm-over-ip/quickstart/) of the Scaleway Dedibox. Alternatively, you may be able to use an Elastic Metal server with [remote access](https://www.scaleway.com/en/docs/elastic-metal/how-to/activate-remote-access/).
</Message>
