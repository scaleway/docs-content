...
3. This page concerns the configuration of your cluster. Enter the following information:
    * Verify the Organization and project in which the cluster will be created.
    ...
    * The control plane offer for your cluster. You can choose between a mutuliezd or several dedicated control plane offers.
        <Message type="tip">
          Not sure which control plane offer to choose? 
