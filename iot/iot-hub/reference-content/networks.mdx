...
<Message type="note">
  ...
  Each Hub has 2 default Networks available (MQTT and Websocket). These cannot be modified. Other Networks can be added and removed on-demand.
...
When using TLS to authenticate your Devices, you need the Hub server-side certificate authority. The CA and the endpoint information are available in the Networks tab of the console.

<Message type="note">

  For more information about how to use the default MQTT Network refer to this [How to](/iot/iot-hub/how-to/connect-default-mqtt-network/).
...
<Message type="important">
  ...
  Devices that use this Network should be configured to allow insecure connections since mutually-authenticated TLS is not available.
...
<Message type="note">
  ...
  For more information about how to use the default Websocket Network refer to this [How to](/iot/iot-hub/how-to/connect-default-websocket-network/).
...
<Message type="note">
  ...
  For more information about how to use REST Networks refer to this [How to](/iot/iot-hub/how-to/setup-use-rest-network/).
...
<Message type="note">
  ...
  For more information about how to use Sigfox Networks refer to this [How to](/iot/iot-hub/how-to/setup-use-sigfox-network/).
