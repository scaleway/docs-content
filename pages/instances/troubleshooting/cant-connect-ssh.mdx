...
- You can view and manage your public SSH keys from the [credentials section of the console](https://account.scaleway.com/?service=elementsproject/credentials).
...
1. Log into the [Scaleway console](https://account.scaleway.com/?service=elements), and navigate to the [SSH keys](https://account.scaleway.com/?service=elementsproject/ssh-keys) of your Project dashboard.
