...
- An [Instance](/compute/instances/how-to/create-an-instance) running on Ubuntu Jammy Jellyfish
    For better performance, we recommend using an Instance with **at least 4 GB of RAM** - DEV1-M or larger.
