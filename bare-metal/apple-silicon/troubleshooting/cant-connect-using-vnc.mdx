...
macOS comes with a built-in firewall called `pf`. If you haven't already, enable the macOS firewall by going to **System Settings** -> **Network** -> **Firewall**. Toggle the switch to **On** to enable it.
