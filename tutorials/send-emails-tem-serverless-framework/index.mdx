...
content:
  ...
  paragraph: Discover how to send emails with Scaleway's Transactional Email and Serverless using the Serverless Framework
...
In this tutorial, you will learn how to send emails with [Transactional Email](/transactional-email/quickstart/) and [Serverless Functions](/functions/quickstart/) using the [Serverless Framework tool](/functions/reference-content/deploy-function/#serverless-framework).
...
5. Click the **Security** tab, then click **+ Generate token**.
        <Message type="tip">
         Find out [how to restrict access](/functions/how-to/secure-a-function/#restrict-access-to-your-functions) to your functions.
        </Message>
