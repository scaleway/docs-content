...
1. Click **Local Storage** in the **Storage** section of the [Scaleway console](https://account.scaleway.com/?service=elements) side menu. The Local Storage page displays.
