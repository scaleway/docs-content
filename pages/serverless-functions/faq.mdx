...
Yes, Serverless Functions is auditable. For more information, see the [Supported endpoints for Audit Trail](/audit-trail/reference-content/adt-supported-endpoints/#serverless-functions).
