...
steps:
  - step: Installing Apache
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/deploy-awstats/#-Installing-Apache
  - step: Installing and Configuring AwStats Package
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/deploy-awstats/#-Installing-and-Configuring-AwStats-Package
  - step: Configuring Apache For AwStats
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/deploy-awstats/#-Configuring-Apache-For-AwStats
  - step: Testing AwStats
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/deploy-awstats/#-Testing-AwStats
  - step: Setting-up Cron Job to Update Logs
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/deploy-awstats/#-Settingup-Cron-Job-to-Update-Logs
categories:
  - compute
  - instances
tags: compute
image: /assets/images/docs/scaleway.png
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, debian server, linux server, AwStats, Apache, mail server statistics, ftp
dates:
...
It is a complete enterprise grade server and log monitoring software that works as a CGI ([Common Gateway Interface](https://en.wikipedia.org/wiki/Common_Gateway_Interface)) or from command line and which shows you all possible information your log contains, in few graphical web pages, often and quickly.
...
<Lightbox src="scaleway-awstats_homepage.png" alt="" />
