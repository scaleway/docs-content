...
1. Open your [Dedibox console](https://console.online.net) home page and click **Order** in the navigation at the top of the page.
...
9. Review all the parameters for your virtual machine and check the message boxes to indicate you've read the terms of service and specific VPS conditions.
