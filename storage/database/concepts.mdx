...
title: Managed Databases Concepts
...
A database backup is a dated export of a database stored on an offsite backup backend. A database can be restored from a backup.
