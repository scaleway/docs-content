---
title: Setting up a KVM Hypervisor on Bare Metal Cloud Servers
description: This page shows you how to setup a virtual machine with KVM on a Bare Metal
excerpt: |
  KVM or Kernel-based Virtual Machine is a complete open source virtualization solution for Linux on x86 hardware.
  It supports CPUs that come with virtualization extensions (Intel VT or AMD-V).
...
7. Shut down the virtual machine, disable and re-enable DHCP, restart the `libvirt-bin` service and restart the virtual machine:
