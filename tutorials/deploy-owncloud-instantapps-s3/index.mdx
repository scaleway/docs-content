...
tags: owncloud compute media-sharing objectstorage s3
excerpt: |
  ...
  This tutorial shows you how to deploy your own ownCloud instance using Object Storage with a few clicks.
totalTime: PT10M
steps:
...
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu instance, debian instance, linux instance, Object Storage, S3, IAAS, baremetal, scalability, ARM, physical instance, dedicated instance, physicalization, ownCloud
dates:
