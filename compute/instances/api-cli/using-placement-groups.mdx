...
If you prefer a visual environment, discover [how to manage placement groups from the Scaleway console](/compute/instances/how-to/use-placement-groups).
...
**Name** is a free text field but let us explain what are the two others in more detail.
...
The low latency policy regroups your Instances on the nearest hardware and limits network latency, allowing the highest network throughput between servers. At best, Instances will be placed on the same hypervisor.
