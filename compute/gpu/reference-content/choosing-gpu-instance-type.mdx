...
* **Scaling:** Consider the scalability requirements of your workload. The most efficient way to scale up your workload is by using:
  * Bigger PCIe GPU, such as H100 Instances
  * Multiple PCIe PCIe GPUs
...
| **Training**          | NLP, LLM                   | +          | +++                                | ++++++                                      | +++++++++                                   |
|                       | GenAI (image, video)       | <font color="red">X</font> | +++                | ++++++                                      | +++++++++                                   |
|                       | Recommender System         | +          | +++                                | ++++++                                      | +++++++++                                   |
...
| **Remote Desktop (Full GPU)** |                    |            | <font color="red">X</font>         | <font color="red">X</font>                  | <font color="red">X</font>                  |
...
<Message type="tip">
  You have further questions or need a customized solution? [Contact us for more information](https://www.scaleway.com/en/contact-ai-solution/)
</Message>
...
| Performance in TFLOPS (FP8 Tensor Cores)                            | Up to 63.2 PFLOPS                                                                                  | Up to 4,021.3 PFLOPS                                                                                  |
| VRAM (cluster total)                                                | 1,280 GB                                                                                            | 81,280GB                                                                                              |
