...
excerpt: |
  This page explains all the concepts related to Load Balancer that you might encounter while using Scaleway products and ressources.
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
...
permalink: docs/network/load-balancer/concepts
keywords: network, load balancer, concepts,
---
...
Each Load Balancer is configured with one or several frontends. Each frontend listens to a configured port and has one or multiple backends to which the traffic is forwarded.
