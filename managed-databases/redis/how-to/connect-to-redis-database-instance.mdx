...
3. Retrieve the Database Instance IP and port from the Database Instance information section.
    ...
    You can use only one of your node IP addresses at a time to connect to your Redis™ Database Instance, as the Redis™ CLI does not differentiate Database Instances in standalone from those in cluster mode.
    </Message>
