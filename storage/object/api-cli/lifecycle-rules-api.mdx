...
<Message type="note">
  To see examples of lifecycle rules API requests, refer to the Bucket Operations [documentation page](/storage/object/api-cli/bucket-operations/#putbucketlifecycleconfiguration).
</Message>
...
Send a [putbucketlifecycleconfiguration](/storage/object/api-cli/bucket-operations/#putbucketlifecycleconfiguration) request with the following XML payload:
