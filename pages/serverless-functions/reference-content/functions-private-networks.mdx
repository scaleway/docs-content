...
tags: functions serverless private-networks vpc
dates:
  posted: 2025-08-04
...
[VPC routing](/vpc/reference-content/understanding-routing/): custom routes and cross-PN automatic routing are supported on Serverless Functions.
...
Refer to the [dedicated documentation](/organizations-and-projects/organization/organization-quotas/) for more information on Private Networks quotas for Serverless Functions.

## Limitations

- Only one Private Network can be attached to a Serverless Function.
