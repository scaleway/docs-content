...
Each offer allows you to store up to 1000 files on your Dedibackup volume. We recommend to use archives (tarballs/zip) for your backups. 
...
6. Choose the offer of your Dedibackup and click **Order**. A summary or your dorder displays.
...
### FTP parameters
 ...
 | Password        | *the password you configured during activation* |    

You are not limited in number of simultaneous connections. The use of FTPFS is not allowed

<Message type="note">

The upload is not possible from an IP outside the Dedibox network.**
...
*  **Autologin** : If you activate this function, you can login without password into your account (automatic authentification based on your IP address and MAC address). With this feature you can avoid to transmit your login information unencrypted over the network. Once this feature has been activated in your account use the username `auto` and an empty password to connect.
