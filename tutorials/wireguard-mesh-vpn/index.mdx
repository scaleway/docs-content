...
<Message type="tip">
  ...
  If you're looking to configure Wireguard as a VPN to provide secure Internet access, [check out our other Wireguard tutorial](/tutorials/install-wireguard/).
...
- You have two Instances running a Linux kernel ≥ 3.10, one in 
