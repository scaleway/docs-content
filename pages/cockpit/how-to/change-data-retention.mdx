...
<Requirements />
  ...
  - Created [Scaleway resources integrated with Cockpit](/cockpit/reference-content/cockpit-product-integration/) or [created](/cockpit/how-to/create-external-data-sources) custom data sources
