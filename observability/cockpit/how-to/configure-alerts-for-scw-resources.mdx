---
meta:
  title: How to configure managed alerts for Scaleway resources in Grafana
  description: Learn how to configure managed alerts for Scaleway resources in Grafana. Follow the steps to create alert rules, define conditions, and set up notifications for your monitored resources.
content:
  h1: How to configure managed alerts for Scaleway resources in Grafana
  paragraph: Learn how to configure managed alerts for Scaleway resources in Grafana. Follow the steps to create alert rules, define conditions, and set up notifications for your monitored resources.
categories:
...
This page shows you how to configure managed alerts for Scaleway resources in Grafana using the `Scaleway Metrics` data source.
