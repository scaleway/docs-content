...
excerpt: |
  This page explains how to o configure Instances plugged into a Private Network attached to a Public Gateway
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/network/vpc/how-to/configure-instances-public-gw
image: /assets/images/docs/scaleway.png
keywords: cloud computing, scaleway, public gateway, vpc, gateway, instances
dates:
...
<Navigation title="See Also">
  ...
  <NextButton to="/network/vpc/how-to/use-flexible-ips/">How to use flexible IPs</NextButton>
</Navigation>