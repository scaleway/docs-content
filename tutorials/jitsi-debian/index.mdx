...
Jitsi Meet is a fully encrypted, open source video conferencing tool that does not require subscription or the need to create an account.
...
<Message type="requirement">
  ...
  - You have a [Scaleway Instance](/compute/instances/how-to/create-an-instance/) running Debian Buster (for better performance, we recommend that you use an Instance with **at least 4 GB of RAM**)
...
5. Launch the installation of Jitsi Meet.
    ...
    When asked:
      ...
      - Choose the `Generate a new self-signed certificate (You will later get a chance to obtain a Let's Encrypt certificate)` option as a SSL certificate and press **Enter**.
