...
- [Created a Scaleway Container Registry namespace](/containers/container-registry/how-to/create-namespace) (not mandatory if deploying using the Application Library)
