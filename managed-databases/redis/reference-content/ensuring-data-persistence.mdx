...
meta:
  ...
  description: Learn more about how to ensuring data persistence in Managed Database for Redis™.
content:
  h1: Ensuring data persistence
  paragraph: Learn more about how to ensuring data persistence in Managed Database for Redis™.
...
To avoid this, Redis™ inately supports persistence by performing [snapshots](https://redis.io/docs/management/persistence/).
...
<Message type="important">
  Managed Database for Redis™ remains an in-memory database solution, and is recommended for caching use cases. The data persistence solutions presented on this page cannot guarantee data permanence.
</Message>
...
<Message type="important">
  The snapshot configuration is managed by Scaleway and cannot be edited. If you feel this configuration does not represent your use case, please let us know via the #databases channel of the [Scaleway Slack community](https://scaleway-community.slack.com/).
</Message>
