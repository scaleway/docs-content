---
title: Troubleshooting Dedibox Network
...
<Lightbox src="scaleway-mrt1.png" alt="" />
...
1. Download the tool [here](https://iperf.fr/iperf-download.php#windows).
...
<Message type="important">
  ...
  When setting up the WAN interface on a PfSense firewall you should disable auto configuration, as it might cause an IPv6 packet flood shutting down your servers network port. If your network ports do not become available after a few minutes, you need to contact the support.
