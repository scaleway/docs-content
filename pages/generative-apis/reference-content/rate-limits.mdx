...
Note that for increase up to x5 or x10 volumes, we highly recommend to use dedicated deployments with [Managed Inference](https://console.scaleway.com/inference/deployments), which provides exactly the same feature and API compatibility.
