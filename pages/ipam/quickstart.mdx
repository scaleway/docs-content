...
You can currently use IPAM in the Scaleway console to list the [Public](/ipam/concepts/#public-flexible-ip-address) and [private IP addresses](/ipam/concepts/#private-ip-address) of all your Scaleway resources, and view/edit their additional information. You can also [reserve](/ipam/how-to/reserve-ip/) zonal and regional IPs to attach managed or custom resources to the network.
...
1. Click **IPAM** in the **Network** section of the [Scaleway console](https://console.scaleway.com) side menu.
    ...
    A list of your **IP addresses** for the **region** and **VPC** pre-selected in the filters displays. Addresses are displayed here if they are reserved in IPAM. This means either:
...
3. Click the <Icon name="more" /> icon next to the IP address whose details you want to view, then click **More info**.
    ...
    The details of your IP address appear:
    - The IP address
...
2. Click **Reserve private IP**. The IP reservation menu appears.
