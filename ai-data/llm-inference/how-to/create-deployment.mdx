...
3. Provide the necessary information:
    - Select the desired model for your deployment from the available options:
        - [Llama-2-70b-chat](/ai-data/llm-inference/reference-content/llama-2-70b-chat/)
        - [Llama-2-7b-chat](/ai-data/llm-inference/reference-content/llama-2-7b-chat/)
        - [Mixtral-8x7B-Instruct-v0.1](/ai-data/llm-inference/reference-content/mixtral-8x7b-instruct-v0.1/)
        - [WizardLM-70b-V1.0](/ai-data/llm-inference/reference-content/wizardlm-70b-v1.0/)
        <Message type="note">
