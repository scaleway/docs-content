...
3. Download the certificate files for your RPN VPN. Click **Show Password** to display the password associated with your RPN VPN.
    ...
    <Message type="note">
      To use your RPN VPN in your RPNv1 group, you must add it to your group as an RPN server. For more information follow our [RPN documentation](/bare-metal/network/reference-content/configure-rpnv2/)).
    </Message>

## Configuring a RPN VPN client
...
Now you can [configure your server](/bare-metal/network/reference-content/configure-rpnv2/) in your RPN group.


<Navigation title="See Also">
  <PreviousButton to="/bare-metal/network/reference-content/configure-rpnv2/">Configuring a RPNv2</PreviousButton>
  <NextButton to="/bare-metal/network/reference-content/configure-rpnv1-gateway/">Configuring a RPNv1 gateway</NextButton>
</Navigation>
