...
2. Type `n` and go directly to the [Creating an Elastic Metal server](#creating-an-elastic-metal-server) step of this tutorial if you do not want to edit your configuration.
    ...
    ```
3. Enter either the email address for your account (you will then be asked for your password), or your [API secret key](/console/organizations-and-projects/how-to/create-ssh-key):
    ```
...
<Navigation title="See also">
  <NextButton to="/bare-metal/elastic-metal/api-cli/elastic-metal-with-api/">Creating and managing Elastic Metal servers with the API</NextButton>
</Navigation>
