...
For more information on limitations when using Private Networks with Serverless Functions, refer to the [dedicated documentation](/serverless-containers/reference-content/functions-limitations/#private-networks-and-virtual-private-cloud-vpc).