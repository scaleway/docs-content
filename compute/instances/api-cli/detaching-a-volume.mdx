...
meta:
  ...
  description: This page explains how to attach a Block Storage volume from an Instance using the Scaleway API.
content:
  h1: Detaching a Block Storage volume via the Instance API
  paragraph: This page explains how to attach a Block Storage volume from an Instance using the Scaleway API.
