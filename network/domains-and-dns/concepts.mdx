...
However, Scaleway's Domains and DNS trade feature allows you to **only edit the registrant contact information of an internal domain (to correct typing errors, for example), or information such as a company name, or a SIRET number**.