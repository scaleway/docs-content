...
Scaleway Object Storage allows you to manage access to your resources with two features

-  [Identity and Access Management (IAM)](/identity-and-access-management/iam/concepts/#iam)

[Bucket policies](storage/object/api-cli/bucket-policy.mdx)
