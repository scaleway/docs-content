...
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, debian server, linux server, wordpress, lemp, Linux, Apache, MySQL, PHP
dates:
...
- You have [LEMP installed](/tutorials[document@scaleway.com](mailto:document@scaleway.com))
- You have [secured your LEMP stack with TLS/SSL](/tutorials[document@scaleway.com](mailto:document@scaleway.com)#configuring-ssl-with-let's-encrypt)

</Message>

## Installing the stack

As a tutorial on LEMP is already available, you can follow the procedure at [Installing LEMP on Ubuntu Bionic.]([document@scaleway.com](mailto:document@scaleway.com))

In addition, WordPress serves dynamic content and handles user authentication and authorization. TLS/SSL is the technology that allows you to encrypt the traffic from your site so that your connection is secure. To secure your connection, can follow the procedure at [Configuring SSL with Let's Encrypt](https://www.scaleway.com/docs/installing-lemp-stack-on-ubuntu-linux-nginx-mysql-php/#-Configuring-SSL-with-Lets-Encrypt)
