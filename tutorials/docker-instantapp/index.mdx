...
## Creating a new Instance with the Docker InstantApp

Follow the instructions for [creating an Instance](/compute/instances/how-to/create-an-instance/). When choosing your **Image**, click the **InstantApps** tab and select the **Docker** InstantApp.

## Connecting to your Instance

Follow the instructions for [connecting to your Instance](/compute/instances/how-to/connect-to-instance/).
...
Your image is now available on the Docker Hub, and you can run it from everywhere
