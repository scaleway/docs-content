...
VPC Peering connectors are a regional resource, and are available in multiple regions. For the most up-to-date information, check out the [Product Availability](/account/products-availability/) page.
