...
<Message type="requirement">
  ...
  - You have [created an SQS namespace](/serverless/messaging/how-to/create-namespace.mdx)
  - You have [created credentials](/serverless/messaging/how-to/create-credentials.mdx) for your SQS namespace
