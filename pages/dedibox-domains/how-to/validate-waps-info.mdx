...
<Message type="tip">
  If you are expecting a validation email (e.g. if you have modified your domain owner's contact information) but cannot find the email, try the following steps:
    ...
    - [Open a ticket](https://account.scaleway.com/?service=dediboxen/assistance/ticket) They will be able to check to which address the validation email has been sent and whether it has been validated.
</Message>
