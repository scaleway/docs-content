...
* **Hybrid flexibility:** Seamlessly integrate with other Scaleway services (e.g., Managed Databases, Queues, Topics and Events, and Generative APIs - Dedicated Deployment) to support complex workflows
