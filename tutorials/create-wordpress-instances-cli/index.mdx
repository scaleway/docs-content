...
Type the following command into your terminal to create a new fully configured Wordpress Instance: 
  ...
  ```
  scw instance server create name=wordpress image=wordpress tags.0="weblog_title=My Scaleway Blog" tags.1="admin_user_name=myuser" tags.2="admin_email=me@example.com" tags.3="language=en_EN" tags.4="use_weak=on"
  ```
The following output displays when you log into your Instance:
