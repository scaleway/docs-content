...
meta:
  ...
  description: Learn about Object Storage API operations like DeleteObject, DeleteObjects, GetObject, and more. Explore samples, requests, responses, CLI commands, and best practices.
content:
