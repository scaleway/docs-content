...
You can push traces with the Tempo-compatible agents supported by Scaleway: [Jaeger](https://www.jaegertracing.io/docs/1.50/), [OpenTelemetry](https://opentelemetry.io/docs/what-is-opentelemetry/), or [Zipkin](https://zipkin.io/).
