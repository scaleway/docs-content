...
meta:
  ...
  description: This page shows you how to migrate Scalewaty Object Storage data from one region to another with MinIO client
content:
  h1: Migrating Scaleway Object Storage data with MinIO client
  paragraph: This page shows you how to migrate Scaleway Object Storage data from one region to another with MinIO client
categories:
  - instances
  - object-storage
...
MinIO client provides a modern alternative to UNIX commands like ls, cat, cp, mirror, diff, etc. It can communicate with any S3-compatible cloud storage provider and can be used to migrate data from one region to another.
