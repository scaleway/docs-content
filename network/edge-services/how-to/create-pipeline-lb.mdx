...
5. Enter a name for this Edge Services pipeline, or leave the auto-generated name in place.
    ...
    The summary cost for the creation of this pipeline is displayed, notably whether it falls within the limits of your current [subscription plan](/network/edge-services/reference-content/understanding-pricing/)
