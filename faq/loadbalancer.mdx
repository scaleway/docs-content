...
A Load Balancer can be used as frontend for any Instance type, even if it is not a Scaleway resource, thanks to the [multi-cloud feature](/faq/loadbalancer/#what-is-the-difference-between-multi-cloud-and-non-multi-cloud-offers).
...
To take advantage of multi-cloud, you must choose a compatible Load Balancer offer type when creating your Load Balancer, or [resize](/network/load-balancer/how-to/resize-lb/) to such an offer afterwards.
