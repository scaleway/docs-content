...
4. Choose a key storage option:
    - **Software protected**: the key is encrypted and stored in software
    - **HSM backed**: the key is encrypted and stored in a physical Hardware Security Module (HSM)
    
    To learn more about the differences, see [What is the difference between a software-protected key and an HSM-backed key?](/key-manager/faq/#what-is-the-difference-between-a-software-protected-key-and-an-hsm-backed-key).
5. Enter a name, a description, and optional tags for your key.
6. Select the [encryption method](/key-manager/concepts/#encryption-method) for your key. Key Manager supports:
...
7. Switch the <Icon name="toggle" /> icon to disable [key protection](/key-manager/concepts/#key-protection) or leave it enabled.
    <Message type="note">
     Key protection allows you to protect your key from accidental deletion.
    </Message>
8. Check the estimated cost, then click **Create key**. The **Overview** page of your key displays.
