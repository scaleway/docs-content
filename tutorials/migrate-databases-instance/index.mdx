...
<Message type="note">
To migrate or import a database without an Instance, or using third-party tools, refer to [this procedure](/postgresql-and-mysql/api-cli/import-data-to-managed-postgresql-databases/).
</Message>
...
<Message type="note">
  If you do not have a Database for PostgreSQL yet, [create a new one](/postgresql-and-mysql/how-to/create-a-database/) from your [Scaleway console](https://console.scaleway.com/rdb/instances).
</Message>
...
<Message type="note">
  If you do not have a Database for MySQL yet, [create a new one](/postgresql-and-mysql/how-to/create-a-database/) from your [Scaleway console](https://console.scaleway.com/rdb/instances).
</Message>
