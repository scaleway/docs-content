...
Notably, it allows you to securely connect from anywhere in your private network as well as to connect servers that do not have a RPN interface to the RPN.
