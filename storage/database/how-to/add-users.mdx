...
content:
  ...
  paragraph: This page explains how to add users to a Managed Database
steps:
  - step: TODO
    type: HowToStep
...
<Navigation title="See Also">
  <PreviousButton to="/storage/database/how-to/create-a-database/">How to create a Managed Database</PreviousButton>
