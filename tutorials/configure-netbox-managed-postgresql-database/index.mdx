...
- You have a [Database for PostgreSQL](https://www.scaleway.com/en/databases/)

</Message>

## Configuring the database

NetBox requires a PostgreSQL database. Configure your [Database for PostgreSQL](https://www.scaleway.com/en/databases/) with a few steps from your [Scaleway console](https://console.scaleway.com/rdb/Instances)
