...
<Requirements />
 ...
 - A Scaleway account metricsged into the [console](https://account.scaleway.com/?service=elements)
...
1. Click **Cockpit** in the **Monitoring** section of the Scaleway [console](https://account.scaleway.com/?service=elements) side menu. The **Cockpit Overview** page displays.
