...
7. Click **Create a route rule** to finish.
  ...
  Your route rule is created, and you are taken to the list of all your routes for this Load Balancer.
...
7. Click **Edit route rule** to finish. 
  ...
  Your route rule is edited and you are returned to the list of routes.
