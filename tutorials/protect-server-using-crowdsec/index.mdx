...
4. Update the sources and install CrowdSec:
    ...
    CrowdSec is now installed on your Dedibox. By default, some scenarios and parsers are installed. Youcan list them using `cscli`:
