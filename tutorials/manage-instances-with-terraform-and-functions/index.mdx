...
content:
  h1:  Deploying and managing Instances with Terraform/OpenTofu and Functions
  paragraph: Discover how to deploy and manage your Scaleway Instances using Terraform/OpenTofu, functions and python
