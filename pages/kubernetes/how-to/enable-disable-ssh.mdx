...
1. Click **CPU & GPU Instances** in the side menu, then click **Security groups** to view the [security group](https://account.scaleway.com/?service=elementsinstance/security-groups) section in your Scaleway console.
