...
This improves performance by reducing the latency between your nodes. It also increases the security of your databases, as Instances in your Private Network can directly communicate with your Database Instance, without passing through the public Internet.
...
Private Networks are also available on [Virtual Instances](https://www.scaleway.com/en/virtual-instances/). Refer to the page on [how to use Private Networks ](/compute/instances/how-to/use-private-networks/) to attach an Instance to a Private Network and configure a persistent IP address on it.
