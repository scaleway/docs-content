...
7. If you did not select a hosting backup, a pop-up may display asking you to confirm your choice. Click **Continue without backup** or **Add backup**. The **Contact information** page opens.
...
9. Scroll down to the bottom of the page and click **Confirm**.
    <Message type="tip">
      If you choose to create a new contact, enter their details, then click **Create Handle**. The **Summary** page opens.
    </Message>
