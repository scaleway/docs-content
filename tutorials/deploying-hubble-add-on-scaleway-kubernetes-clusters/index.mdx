...
You can deploy Hubble using Scaleway's Easy Deploy feature directly from the [console](https://account.scaleway.com/?service=elements), which simplifies the deployment process.

1. Navigate to the [Scaleway Console](https://account.scaleway.com/?service=elements) and go to: **Containers \> Kubernetes \> Your Cluster \> Applications**.
