...
excerpt: |
  This page explains how to create an IoT Hub.
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/iot/iot-hub/how-to/create-hub/
...
<Navigation title="See Also">
  <NextButton to="/iot/iot-hub/how-to/enable-disable-hub/">How to enable or disable a hub</NextButton>
</Navigation>