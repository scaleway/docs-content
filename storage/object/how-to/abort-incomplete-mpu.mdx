...
You can automate the process of aborting incomplete multipart uploads using [lifecycle rules](/object/how-to/manage-lifecycle-rules).
...
- At least one incomplete [multipart upload](/object/api-cli/multipart-uploads/)
...
Refer to the [dedicated documentation](/object/api-cli/multipart-uploads/) for more information on how to create and manage multipart uploads.
