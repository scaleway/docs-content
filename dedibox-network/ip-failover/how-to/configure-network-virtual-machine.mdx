...
1. Log into your virtual machine and open the network configuration file `/etc/netplan/01-netcfg.yml` in a text editor of your choice, for example `nano`:
...
5. Set the DNS resolver by adding the following lines to the file. Then save it and exit the text editor: 
    ...
    The DNS resolvers above are operated by Scaleway Dedibox. You can also set your preferred alternative DNS resolvers in the file. 
...
2. Enter the following information in the network adapter configuration:
 ...
 <Navigation title="See Also">
  <PreviousButton to="/dedibox-network/ip-failover/how-to/create-multiip-virtualmac">How to create a multi-IP virtual MAC group</PreviousButton>
</Navigation>
