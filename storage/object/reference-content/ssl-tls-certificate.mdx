...
Therefore, when you customize your Edge Services endpoint with a subdomain, you are prompted to upload an SSL/TLS certificate for that subdomain. This certificate is stored in [Scaleway Secret Manager](/identity-and-access-management/secret-manager/quickstart/).
