...
The [Private Network](/network/public-gateways/concepts/#private-network/) feature enables you to build a virtual L2 network between your cloud resources. The service is compatible with a wide range of resources including: 
...
* [Public Gateways](/network/public-gateways/concepts/#public-gateway), enabling IP autoconfiguration of your Private Networks and their communication with the Internet.
...
<Message type="requirement">
  ...
  - You have [created a Private Network](/network/public-gateways/how-to/use-private-networks/) and added your resources to it
  - You have [created a Public Gateway](/network/public-gateways/ic-gateways/how-to/create-a-public-gateway/) with DHCP enabled
...
Create or clone your virtual machines on both servers of the cluster to distribute the load between them using a Load Balancer. Your virtual machines can use the Public Gateway and dynamic NAT to communicate with the Internet for downloads and updates. If you want to expose certain ports of your VMs directly, configure [static NAT rules](/network/public-gateways/ic-gateways/how-to/configure-a-public-gateway/#how-to-review-and-configure-nat)) for them. 
