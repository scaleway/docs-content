...
Enter the following command to create add Scaleway as a remote service in your local Kubo via its CLI. Make sure to replace the example values with your own, using the configuration table below:
...
You should get an output similar to this, providing details about the content: 
