...
- All resources that can be attached to Private Networks are compatible with VPC routing, except for Serverless Functions and Containers, which do not support routing.
