...
1. Click your name on the top-right navigation menu to go to the [User Account](https://console.scaleway.com/account/security) page.
...
4. Enter your current password in the first box, then a new password in the second field.
