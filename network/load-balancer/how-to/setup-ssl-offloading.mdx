---
meta:
  title: How to set up TLS/SSL offloading
  description: This page explains how to set up TLS/SSL offloading
content:
  h1: How to set up TLS/SSL offloading
  paragraph: This page explains how to set up TLS/SSL offloading
dates:
  validation: 2021-12-31
  posted: 2021-05-26
---

Encrypted HTTPS traffic can be handled in two ways with Scaleway Load Balancers. You can configure **SSL passthrough**, which means traffic is simply passed through the Load Balancer without being decrypted. Alternatively, you can set up **managed TLS/SSL offloading** using either  **Let’s Encrypt Certificates** or **third party TLS/SSL Certificates**. With TLS/SSL offloading, all HTTPS traffic is decrypted on the Load Balancer and passed to the backend servers in plain HTTP
...
TODO "If you want to configure SSL bridging, use TCP protocol on port 443."
