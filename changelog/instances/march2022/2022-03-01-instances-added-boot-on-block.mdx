...
Make sure you check our [documentation](/instances/how-to/create-an-instance/) to create an Instance booting on a block volume or to [change the boot volume](/instances/how-to/use-boot-modes/#how-to-change-the-boot-volume) of your Instance.
