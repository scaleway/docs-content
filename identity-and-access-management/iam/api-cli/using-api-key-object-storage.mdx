...
API keys can also be created and edited from the Scaleway API. See our dedicated [deveopers documentation](https://developers.scaleway.com/en/products/iam/api/v1alpha1/#api-keys-3665ae) for more details.
...
- edit "manage your API keys" How To