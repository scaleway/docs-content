...
1. Log in to your [Dedibox console](https://account.scaleway.com/?service=dedibox) account and locate **Dedibox VPS** in the top navigation menu. Click it to access the list of your Dedibox VPS.
