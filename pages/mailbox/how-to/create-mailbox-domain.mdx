...
2. Click **+ Create an email account** (or **+ Add new email account** if you already have domains in your project). The Mailbox creation wizard displays.
3. Select whether to use a **Scaleway domain** or a **domain external to Scaleway**. Follow the next steps according to your choice.
    <Tabs>
