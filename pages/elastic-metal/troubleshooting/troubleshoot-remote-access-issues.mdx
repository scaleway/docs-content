...
- Confirm that the **remote access* feature is avilable for your machine and activated.
- If not enabled, follow our [instructions how to activate remote access](/elastic-metal/how-to/activate-remote-access/) to activate it.
...
If remote access is still unavailable, contact the [technical support](https://console.scaleway.com/support) with:
