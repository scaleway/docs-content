...
<Message type="note">
  Note that the **Max. NIC bandwidth** specifies the maximum available bandwidth for this Instance type. Bandwidth is shared between internet and Private Network traffic.
</Message>
