...
For more information about Elastic Metal servers, refer to our [dedicated product documentation](/bare-metal/elastic-metal/) and the [FAQ](https://www.scaleway.com/en/docs/faq/elastic-metal/).
