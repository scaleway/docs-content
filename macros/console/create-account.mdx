...
<Message type="note"> 
  This step is necessary for security purposes, but does not prevent you from using Scaleway resources. **You have 10 days to validate your credit card** once its added. 
    </Message>
