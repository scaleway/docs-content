...
func main() {
	...
	client, err := scw.NewClient(
		// Get your organization ID at https://account.scaleway.com/?service=elementsorganization/settings
		scw.WithDefaultOrganizationID("SCW_DEFAULT_ORGANIZATION_ID"),
		// Get your credentials at https://account.scaleway.com/?service=elementsiam/api-keys
