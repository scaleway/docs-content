...
4. Choose the commitment terms for your Mac mini. Two options are available:
    ...
    - Commitment: You subscribe to a [Commitment Plan for Apple silicon](/apple-silicon/concepts/#commitment-plan) and benefit from a discounted monthly price depending on your commitment.
    <Message type="important">
      It is not currently possible to switch back from a monthly commitment to hourly billing.
    </Message>
    - Verify the **Estimated cost** for your Mac mini based on your chosen specifications.
5. Tick the checkbox to agree to the Bare Metal specific conditions and the macOS License Agreement.
6. Click **Create Mac mini** to finish. The installation of your Apple silicon is launched, and you are informed when it is ready.
    <Message type="note">
