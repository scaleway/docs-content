...
1. Follow the steps for [creating a Load Balancer](/network/load-balancer/how-to/create-load-balancer/). At the last stage, click **Add frontend and backend**. The following screen displays, inviting you to configure a frontend:
...
Continue to the next section for [creating a backend](#how-to-create-a-backend-during-creation-of-your-load-balancer). You will finalise creation of your frontend and backend at the same time, at the end of this section.

## How to create a backend during creation of your Load Balancer

Follow the steps for [creating a Load Balancer and creating a frontend](#how-to-create-a-frontend-during-creation-of-your-load-balancer). After configuring your frontend, the next section of the screen displays as shown below, inviting you to congfigure a backend:
...
6. Choose a **backend** to attach the frontend to, from the dropdown list provided. Alternatively, you can click the link to **create a new backend**, which opens the backend creation wizard in a new screen.
