...
\* Egress fees include external outgoing data transfer and inter-region data transfers (such as Paris\<->Amsterdam, or Amsterdam \<-> Warsaw). Intra-regional data transfers (including from/to Dedibox products) are free of charge.
