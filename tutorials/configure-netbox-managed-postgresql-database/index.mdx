...
categories:
  - storage
  - database
image: /assets/scaleway_netbox.webp
dates:
...
In this tutorial, you will learn how to install and configure NetBox on an Instance running on Ubuntu 20.04 LTS and a Managed Database for PostgreSQL.
...
- You have a [Managed Database for PostgreSQL](https://www.scaleway.com/en/databases/)

</Message>

## Configuring the database

NetBox requires a PostgreSQL database. Configure your [Managed Database for PostgreSQL](https://www.scaleway.com/en/databases/) with a few steps from your [Scaleway console](https://console.scaleway.com/rdb/Instances)
