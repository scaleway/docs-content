...
<Message type="note">
  You can also be added to an existing Organization as a [Member](/iam/concepts/#member). Your permissions in these Organizations will depend on the policies set for you by the Organization administrator.
</Message>
