...
9. Check that the deployment is successful by running the command `kubectl get all -n cms-ns` in your terminal.
    ...
    You can see that your WordPress application is running, and has even created a mariadb database within your cluster to store our data on Scaleway Block Storage.
