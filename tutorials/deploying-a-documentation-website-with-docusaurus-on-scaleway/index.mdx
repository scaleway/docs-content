...
Docusaurus is an open-source documentation framework. Docusaurus allows you to build, deploy, and maintain documentation websites. It comes with features such as blogs, internationalization, search and versioning. 
...
Docusaurus is now setup to rebuild your site every time you push new content to the `main` branch of your GitHub repository. Docusaurus then deploys it automatically on your Object Storage website.  
All changes go live on your website as soon as the GitHub runner has completed its tasks and the build of your website was done successfully.
