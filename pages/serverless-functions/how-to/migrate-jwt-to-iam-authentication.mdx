...
This feature is now deprecated, you must therefore use Scaleway IAM to access your private functions using an [API key](/iam/how-to/create-api-keys/). This change allows for a better Scaleway ecosystem integration, see [Advanced access control with IAM conditions](/serverless-functions/how-to/secure-a-function/#advanced-access-control-with-iam-conditions).
