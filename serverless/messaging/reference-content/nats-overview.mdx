...
You can easily create a NATS namespace from the [Scaleway console](/serverless/messaging/how-to/create-namespace), via the [Scaleway API](https://developers.scaleway.com/en/products/messaging_and_queuing/api/v1alpha1/) or via [Terraform](https://registry.terraform.io/providers/scaleway/scaleway/latest/docs/guides/mnq_with_nats_terraform_provider).
...
The [NATS CLI](https://docs.nats.io/using-nats/nats-tools/nats_cli) is a great tool for administrating or testing your subjects and streams. See our [dedicated documentation](/serverless/messaging/api-cli/nats-cli) to help get started with the NATS CLI.
