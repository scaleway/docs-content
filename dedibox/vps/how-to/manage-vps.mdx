...
1. Open the Dedibox console home page and click **Dedibox VPS** in the navigation at the top of the page. This will bring up a list of your virtual machines. 
        <Message type="tip">
...
2. The password of your Dedibox VPS displays. You can copy and paste it in your SSH client during connection to your VPS.
    <Message type="tip">
...
2. Input your new password along with its confirmation, then click **Confirm** to finalize the update. You will receive a confirmation notification indicating the successful password change.
3. Reboot your VPS to ensure the changes take effect. After this, you can manage your VPS using the new password.
