...
We have introduced a `VPC-GW-L` offer with 3Gbps bandwidth to accommodate customers with this type of need. For pricing details, see our [dedicated page](https://www.scaleway.com/en/pricing/network/).