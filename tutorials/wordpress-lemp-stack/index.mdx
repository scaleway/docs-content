...
content:
  ...
  paragraph: In this tutorial, you will learn how to install WordPress on a freshly created Ubuntu Bionic Instance with LEMP.
...
In this tutorial, we will learn how to install WordPress on a freshly created Ubuntu Bionic instance with LEMP (Linux + Nginx - pronounced "engine x" + MySQL + PHP). Nginx is a HTTP server that, compared to Apache, uses less resources and delivers pages much faster, especially static files.
