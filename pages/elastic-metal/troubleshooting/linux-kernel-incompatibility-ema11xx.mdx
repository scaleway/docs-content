...
The following **Elastic Metal servers** are affected by the incompatibility issue:
...
These servers are built on the HP ProLiant DL320e Gen8 v2 chassis.
...
<Message type="note">
If you are running an older kernel version, your system may not be affected by this incompatibility.
</Message>
