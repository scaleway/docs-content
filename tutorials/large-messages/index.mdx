...
categories:
  ...
  - functions
  - object-storage
tags: message nats serverless serverless-functions functions serverless-triggers triggers storage object-storage terraform large-messages big-data tutorial
dates:
