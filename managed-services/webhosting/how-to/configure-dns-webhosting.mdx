...
5. After updating your DNS configuration, click **Verify domain**. This initiates the DNS verification process.
    ...
    Once the process has been completed, you will notice a green dot next to **DNS verification**. You DNS is now configured and linked with your Web Hosting plan.
