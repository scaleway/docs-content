...
3. Download and run the Yunohost installation script:
    ...
    ```
4. Run the post-installation script to set the administrator password and main domain name:
    ```
...
6. To retrieve the DNS zone information which is required for the configuration of the domain name with Yunohost, click Domain in the main menu:
    <Lightbox src="scaleway-yunohost_03.webp" alt="" />
7. Click the domain name, then on **DNS Configuration** to display an ideal DNS configuration of the domain name:
