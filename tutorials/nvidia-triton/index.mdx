...
2. Start the Triton Inference Server container:
   ```bash
   docker run --gpus all --rm -p 8000:8000 -p 8001:8001 -p 8002:8002 -e $SCW_ACCESS_KEY_ID -e $SCW_SECRET_ACCESS_KEY \
   ...
   - `-e $SCW_ACCESS_KEY_ID -e $SCW_SECRET_ACCESS_KEY`: Specifies your Scaleway API access key and secret key
