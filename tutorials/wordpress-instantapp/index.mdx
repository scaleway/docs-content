...
Working with the WordPress application will significantly save you time and effort as WordPress is installed and configured. By default, the WordPress image used in this tutorial [supports routed IPs](/compute/instances/api-cli/using-routed-ips/).
