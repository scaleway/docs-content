...
In this tutorial, we use **Apache** as Webserver for the Nagios interface.
...
We are using the Apache web server as application to serve the Nagios web interface. 
