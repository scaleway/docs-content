...
1. Click **File Storage** in the **Storage** section of the side menu. The [File Storage dashboard](https://account.scaleway.com/?service=elementsfile-storage/) displays.

2. Click **+ Create file system**. The [file system creation page](https://account.scaleway.com/?service=elements/file-storage/file-storage/create) displays.
