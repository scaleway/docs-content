---
layout: docs
title: DNS Cloud Concepts
description: This page explains all the concepts related to DNS Cloud
tags: advanced settings
excerpt: |
  This page explains all the concepts related to DNS Cloud that you might encounter while using Scaleway products and ressources.
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
...
keywords: DNS Cloud, dns, domains, concepts,
---
