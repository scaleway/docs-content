...
5. Select one of the following options, depending on your physical connection type: 

   <Tabs>
    
        <TabsTab label="Hosted">
        1. Select a [partner](/interlink/concepts/#partner). To establish an InterLink connection via a partner, you must be a client of that partner, e.g., by hosting your infrastructure in their datacenter, or by using the partner as your on‑premises network provider. [Get help with choosing a partner](/interlink/reference-content/overview/#hosted-interlinks).
        ...
        3. Choose a [bandwidth](/interlink/concepts/#bandwidth) level. This represents the maximum bandwidth that will be available over the InterLink.
        ...
        2. Choose a [bandwidth](/interlink/concepts/#bandwidth) amount. This is the maximum bandwidth  available over the InterLink.
