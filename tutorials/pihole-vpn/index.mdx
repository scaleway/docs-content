...
1. Login to your Scaleway Console and [create a new Instance](https://console.scaleway.com/instance/servers/create?area=fr-par&imageGroup=distribution_ubuntu&imageKey=3f1b9623-71ba-4fe3-b994-27fcdaa850ba&region=fr-par-1&selectedImageTab=distribution&selectedServerGroup=Development&serverKey=fr-par-1DEV1-S). For this tutorial we use a `DEV1-S` instance running on Ubuntu Focal Fossa (20.04 LTS).
