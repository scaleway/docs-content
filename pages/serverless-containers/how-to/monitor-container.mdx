...
<Message type="note">
  You can also access your Serverless Containers logs and metrics from the [console](https://account.scaleway.com/?service=elements) via the **Logging** and **Metrics** tabs of a container.
</Message>
