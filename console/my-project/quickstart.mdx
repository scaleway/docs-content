...
[SSH keys](/console/my-account/concepts#ssh-key) allow you to securely connect to your Virtual Instances without using a password.
...
You must upload the content of the public part of the SSH key pair you just created to the Scaleway interface. This is then associated with your project, and can be transferred to your Virtual Instances during the boot process.
