...
<Message type="requirement">
  - You have an account and are logged into the [Scaleway console](https://console.scaleway.com)
  - You have [created and uploaded your SSH key](/console/organizations-and-projects/how-to/create-ssh-key)
...
5. Click the **Browse** button and select the private key file you [generated previously](/console/organizations-and-projects/how-to/create-ssh-key/).
