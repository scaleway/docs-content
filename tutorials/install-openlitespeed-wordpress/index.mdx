...
meta:
  ...
  description: This page shows you how to install and configure the OpenLiteSpeed webserver on Ubuntu or Debian Linux
content:
  h1: Installing OpenLiteSpeed with WordPress on Ubuntu or Debian Linux
  paragraph: This page shows you how to install and configure the OpenLiteSpeed webserver on Ubuntu or Debian Linux
categories:
  - compute
