...
You can migrate your endpoints from a Database Instance to another anytime using the Scaleway CLI anytime.
...
1. Retrieve a list of your Database Instances.
    ...
    Take note of the UUID of the Database Instance whose endpoint you want to migrate, and of the Database Instance you want to migrate it to.
