...
totalTime: PT10M
keywords: cloud tutorials, cloud documentations, kubernetes, kubernetes kapsule, easy deploy, easy-deploy, odoo, odoo tutorial, odoo on kubernetes, containers, containerized applications, deploying containerized applications, deploying containerized applications on kubernetes, docker
