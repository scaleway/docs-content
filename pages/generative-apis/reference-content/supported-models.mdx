...
| [`mistral-medium-3.5-128b`](#mistral-medium-35-128b) | Yes | 256k | 16k | Text, Vision | [Modified MIT License](https://huggingface.co/mistralai/Mistral-Medium-3.5-128B/blob/main/LICENSE) |
...
| Compatible Instances (max context in tokens\*) - Dedicated Deployment | H100_16 (66k), H100-2 (262k), H100-SXM-2 (262k), H100-SXM-4  |
...
| Maximum images per request | 12 |
| Supported languages | English, German, French, Chinese, Japanese, Korean |
