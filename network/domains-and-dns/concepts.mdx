...
However, Scaleway's Domains and DNS trade feature allows you to **only edit your contact information (to correct typing errors, for example), or information such as the name of your company, or a SIRET number**.