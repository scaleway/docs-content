...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/hardware/reference-content/configure-hardware-raid-console/">How to configure your hardware RAID from the console</PreviousButton>
  <NextButton to="/bare-metal/hardware/reference-content/configure-dell-perc-h310/">How to configure the DELL PERC H310 RAID controller</NextButton>
</Navigation>
