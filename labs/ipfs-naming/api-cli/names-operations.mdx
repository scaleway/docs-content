...
The [Scaleway Command Line Interface (CLI)](https://github.com/scaleway/scaleway-cli) allows you to create and interact with your names. You will be able to create names, manage them, add/delete value within them.
