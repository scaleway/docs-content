...
1. Access the [Scaleway console](https://account.scaleway.com/) website.
    <Tabs>
      <TabsTab label="Log in with SSO">
      1. Click the **Google**, **Microsoft**, or **GitHub** logo, depending on the account you want to use.
      2. Log in through the respective SSO login page.
...
If you were added to a Scaleway Organization as an [IAM Member](/iam/concepts#member), you must follow a dedicated login process.

1. Access the [Scaleway console](https://account.scaleway.com/) website.
2. Click the [Log in as an IAM Member](https://account.scaleway.com/member-login) button.
...
<Tabs>
  <TabsTab label="Log in with a passkey">
      <Message type="note">
        This method is currently only available for IAM Owners.
      </Message>
