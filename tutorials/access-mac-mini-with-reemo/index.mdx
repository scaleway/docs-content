...
5. Reemo needs to have access to screen recording to work. This needs to be done on MacOS GUI, so if you installed via SSH you'll need to connect via VNC. Then, in the System Settings, click Privacy & Security in the sidebar (You may need to scroll down). Then click Screen Recording and turn on screen recording for the Reemo app. 
