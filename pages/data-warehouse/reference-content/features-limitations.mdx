...
This Load Balancer automatically distributes the queries over the different nodes of your deployment. It is therefore not possible to know which node will process a query.
