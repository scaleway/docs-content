...
You can carry out actions on Scaleway Object Storage resources either via the [Scaleway console](https://console.scaleway.com/), or via a third-party API or CLI, such as [the AWS CLI](/object/api-cli/object-storage-aws-cli/), [MinIOClient](/object/api-cli/installing-minio-client/) or [Rclone](/object/api-cli/installing-rclone/).
...
3. [Install the AWS CLI](/object/api-cli/object-storage-aws-cli/) on your machine, using the API key you created in step 2 to complete the fields of the `.aws/credentials` file.
