...
Run the following `up uxp install` command to install the latest stable version of [Upbound Universal Crossplane (UXP)](https://docs.upbound.io/reference/cli-reference/#up-uxp). Ensure you have version `1.12.0` or higher:
