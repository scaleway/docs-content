...
Understanding these states helps you choose the most appropriate one for your workload, optimize costs, and avoid unexpected interruptions.

The following table summarizes the official states, their behavior, and the associated billing implications. Use it as a quick reference when managing your Instances through the Console, API, or CLI.
