...
```
  curl -X POST \
    ...
    -d '{
      ...
      "volume_id": "6170692e-7363-616c-6577-61792e636f6d"
    }' \
...
This operation allows you to delete a given pin within a volume using its pin ID. If you were the last owner of the associated content, the content will be permanently deleted.
