...
1. Scaleway validates the information by sending an email to the owner's email address:
    ...
    helpdesk team at https://account.scaleway.com/?service=dediboxen/assistance/commercial
...
<Message type="tip">
  If you are expecting a validation email (e.g. if you have modified your domain owner's contact information) but cannot find the email, try the following steps:
    ...
    - Check and update, if necessary, the email address of your domain name contact from the [console](https://account.scaleway.com/?service=dedibox).
    - [Open a ticket](https://account.scaleway.com/?service=dediboxen/assistance/ticket) or contact the Support team directly. They will be able to check to which address the validation email has been sent and whether it has been validated.
</Message>