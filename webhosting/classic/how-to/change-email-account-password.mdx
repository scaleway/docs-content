...
<Navigation title="See Also">
  <PreviousButton to="/webhosting/classic/how-to/create-email-account/">How to create an email account</PreviousButton>
  <NextButton to="/webhosting/classic/how-to/delete-email-account/">How to delete an email account</NextButton>
</Navigation> 
