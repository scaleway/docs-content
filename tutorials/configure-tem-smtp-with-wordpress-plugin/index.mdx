...
9. Access your [Transactional Email domain](https://account.scaleway.com/?service=elementstransactional-email/domains), retrieve your **Username** in the **SMTP configuration** section of the **Overview** tab, and paste it in the **SMTP Username** field.
