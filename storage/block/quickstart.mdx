...
From the user's point of view, once [mounted](/block/api-cli/managing-a-volume/#mounting-and-using-a-block-storage-volume), the block device behaves like a regular disk.
...
3. Follow the steps in the creation wizard:
    ...
    - Configure the volume:
        ...
        - Select an [IOPS](/block/concepts/#iops).
