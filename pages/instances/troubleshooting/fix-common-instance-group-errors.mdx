...
1. [Add and verify a payment method](/account/setup-lifecycle/verify-identity/), and verify your identity document, to increase your quotas.
2. Alternatively, click **Check quotas** in the banner to review your current [Organization quotas](/organizations-and-projects/organization/manage-quotas/).
