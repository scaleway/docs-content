---
title: Manage MongoDB® Database snapshots
description: This page explains how to manage database snapshots
tags: managed-database database database-snapshot mongodb document
dates:
...
You can automate the creation of snapshots for your MongoDB® Database Instance using the [update Database Instance](https://www.scaleway.com/en/developers/api/managed-database-mongodb/database-instances#update-a-mongodb-database-instance) endpoint of the Managed MongoDB® API.

1. Retrieve the ID of the Database Instance you want to configure, either from the console or using the [list Database Instances](https://www.scaleway.com/en/developers/api/managed-database-mongodb/database-instances#list-mongodb-database-instances) endpoint.
