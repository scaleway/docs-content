...
meta:
  title: Domains & DNS
  description: Discover Domains & DNS.
content:
  h1: Domains & DNS
  paragraph: Discover Domains & DNS.
image: DNS.webp
---
...
The owner of a domain can update all the technical and administrative parameters referring to their domain name, indicate and change the administrative, technical and invoicing contacts. During the public beta, you must contact the support team to modify the contacts you have entered. 
...
To be able to use the `.eu` extension, you need to be a resident of the European Union. 
...
Ex: If your extension is “.fr” you must be a resident in France, otherwise your domain registration will be refused. 
