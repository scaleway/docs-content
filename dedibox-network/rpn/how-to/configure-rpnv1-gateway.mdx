...
Once you have done that, you can either restart your DHCLIENT on your RPNv1 servers for them to get the new routes or manually add a route to `10.88.0.0/13` through your already existing RPN Gateway.
...
1. Configure your interfaces as the following in `/etc/network/interfaces` (on a Debian-based machine):
    ```
