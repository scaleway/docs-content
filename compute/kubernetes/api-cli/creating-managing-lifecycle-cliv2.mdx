...
Scaleway's Kubernetes (K8s) Kapsules provide you with a managed environment to create, configure and run a cluster of preconfigured machines for containerized applications. You will be able to create clusters without the complexity of managing the infrastructure.
...
2. Unless you want to change your configuration, you can type `n` and go directly to the [Creating a K8s Kapsule cluster](#creating-a-k8s-kapsule-cluster) step of this tutorial.
...
1. Type the following command in your terminal to create a [K8S Kapsule cluster](/compute/kubernetes/concepts/#cluster/):
  ...
  `scw k8s cluster create name=name-of-your-cluster version=1.22.1 pools.0.name=name-of-your-pool pools.0.node-type=GP1_XS pools.0.size=5`
...
## Installing a [KubeConfig](/compute/kubernetes/concepts/#kubeconfig/) configuration file 
...
## Adding a [pool](/compute/kubernetes/concepts/#pool/) to a K8s cluster 
