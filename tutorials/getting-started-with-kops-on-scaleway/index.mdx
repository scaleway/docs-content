...
kOps is a tool to get a production grade Kubernetes cluster up and running. You may think of it as `kubectl` for clusters. It can help you to create, destroy, upgrade and maintain production-grade, highly available, Kubernetes clusters, but it will also provision the necessary cloud infrastructure.
