...
- You have a Virtual Instance running on Debian 9 (Stretch)
...
1. Connect to the Virtual Instance via [SSH](https://www.scaleway.com/docs/create-and-connect-to-your-server/#-Logging-into-the-Instance).
