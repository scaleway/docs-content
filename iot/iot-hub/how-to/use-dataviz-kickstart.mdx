...
excerpt: |
  This page explains how to use the data visualization Kickstart
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
...
<Lightbox src="assets/scaleway-dataviz-purpose-kickstart.png" alt="" />
...
<Lightbox src="assets/scaleway-grafana-dashboard.png" alt="" />
...
<Navigation title="See Also">
  ...
  <NextButton to="/iot/iot-hub/how-to/use-faas-kickstart/">How to use the Function as-a-Service Kickstart</NextButton>
</Navigation>