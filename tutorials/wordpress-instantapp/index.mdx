...
The new Security Group configuration will be applied automatically on Virtual Instances. Bare Metal Cloud Servers need to be hard rebooted from the management console to configure the new rules.
