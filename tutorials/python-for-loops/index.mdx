...
categories:
  - compute
dates:
  validation: 2023-02-13
  posted: 2023-02-13
---

A **loop** is a piece of code that tells Python to repeat a specified set of actions multiple times. Loops are a fundamental part of most programming languages, and let you achieve a whole lot with just a few lines of code.

Why are loops useful? Let's look at a couple of examples:

- Imagine you want to count from 1 to 10, displaying each number on screen. Without a loop, you need the following repetitive block of code:
...
A loop lets us reduce these 10 lines of code to just 2 lines.

- Imagine you have a list of numbers, and you want to print every number higher than 10. Without a loop, the code is very long and repetitive:

```
numbers = [3, 10.1, 62, 9, 0.5]
...
With a for loop, we can reduce these 11 lines of code to 3.


for number in range(10):
  print(number)

- You have a variable containing a **list** of 

- You have a variable containing a **list** of numbers. You want to carry out the same mathematical operation on each number in the list (for example, reduce each number by 10%). With a for loop, you can tell Python to iterate through the list and carry out the same operation on each number.
