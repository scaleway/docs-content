...
POP2 Instances provide CPU- and memory-optimized variants tailored to suit your workload requirements more effectively.
The primary distinction between ENT1 and POP2 lies in SEV, which has posed specific issues. Therefore, SEV has been disabled for POP2 Instances.
