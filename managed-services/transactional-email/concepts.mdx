...
Scaleway uses flags to provide you with more information about your emails. Flags can let you know wether an email you have sent, is considered a spam, for example.
...
- **Hard bounce**: This means that a critical error happened while sending the email. Find out more about [hard bounces](#hard-bounce).
...
- **Send before expiration**: This indicates the maximum time limit for your email to be sent.
- **Soft bounce**: This means that a non critical error happened while sending your email. Soft bounced emails are retried. Find out more about [soft bounces](#soft-bounce).
