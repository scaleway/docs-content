...
<Message type="tip">
  You can also configure Messaging and Queuing with the Terraform NATS Jetstream provider - take a look at our tutorial [here](https://registry.terraform.io/providers/scaleway/scaleway/latest/docs/guides/mnq_with_nats_terraform_provider).
</Message>
