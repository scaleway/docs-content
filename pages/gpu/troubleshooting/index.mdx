...
<ProductHeader
  ...
  description="Learn how to fix common issues with Scaleway GPU Instances. Find solutions to help resolve problems and get started."
/>
...
<Grid>
    ...
    <DefaultCard
      ...
      description="Inform yourself about the internet and Block Storage bandwidth available for each GPU Instance type."
...
<Grid>
    <DefaultCard
      ...
      description="Learn how to use time-slicing by sharing a physical GPU among multiple containers or pods in a Kubernetes cluster."
    ...
    <DefaultCard
      ...
      description="Discover a range of ready-to-use AI Docker images."
