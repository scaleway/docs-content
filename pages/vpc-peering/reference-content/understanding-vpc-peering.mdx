...
<Message type="note">
VPC Peering is currently in Public Beta, and available only via the [Scaleway API](https://www.scaleway.com/en/developers/api/TODOLINK/).
</Message>
...
You must be the owner of the VPC, or have the correct [permission sets](https://www.scaleway.com/en/docs/iam/reference-content/permission-sets/#scoped-by-project) in order to create a peering connector where it is defined as origin. You also need to know the unique VPC ID of the target VPC you want to peer with. Older VPCs must have [activated routing](vpc/how-to/manage-routing/#how-to-activate-routing) for successful peering.
...
- [VPC Peering API Reference](hhttps://www.scaleway.com/en/developers/api/TODOLINK/) - Full documentation for managing VPC Peering via the Scaleway API.
