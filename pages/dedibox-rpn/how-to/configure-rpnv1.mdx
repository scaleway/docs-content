...
1. Click **RPN** > **RPN groups** in the navigation bar on top of your console to enter the [RPN groups configuration](http://account.scaleway.com/?service=dediboxen/server/rpn) page.
