...
6. Enter the details of the new stream and click **Save**.
  ...
  <Lightbox src="scaleway-mistserver_05.webp" alt="" />
    ...
    - **Source:** Enter the source of the stream. You can either stream local files from your Instance. Clik **Browse** to select the content. To stream a live stream, enter the IP address of the source in the text box, i.e. `play://51.15.123.231`.
