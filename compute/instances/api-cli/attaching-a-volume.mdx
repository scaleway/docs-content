...
<Navigation title="See Also">
  <PreviousButton to="/compute/instances/api-cli/creating-a-volume/">Creating a volume via the Instance API</PreviousButton>
  <NextButton to="/compute/instances/api-cli/increasing-volume-size">Increasing volumes via the Instance API</NextButton>
</Navigation>
