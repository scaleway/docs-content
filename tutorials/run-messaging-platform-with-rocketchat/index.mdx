...
3. Create the file **/lib/systemd/system/rocketchat.service** and open it in your favourite text editor. Copy the following content to create a service file for Rocket.chat:
