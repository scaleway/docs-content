...
<Message type="tip">
  You can order Dedibox servers also using the [Scaleway console](/dedibox-scaleway/how-to/order-dedibox/) to benefit from the whole Scaleway ecosystem and the latest console.
</Message>
