...
A Public Gateway is a managed network component that connects a Private Network to the public internet. A Public Gateway functions as a gateway node, that performs several key networking tasks, including traffic forwarding, NAT (**N**etwork **A**ddress **T**raslation) and SSH bastion services. Public Gateways enhance security by letting you keep resources in Private Networks while still accessing the internet.
