...
meta:
  ...
  description: This page shows you the required steps to host your own Minecraft server on a Scaleway Instance.
content:
  h1: Creating your own Minecraft server
  paragraph: This page shows you the required steps to host your own Minecraft server on a Scaleway Instance.
