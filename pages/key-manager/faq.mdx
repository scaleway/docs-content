...
KEKs are decrypted on demand using cryptographic operations but never stored in the RAM.
...
Scaleway Hardware Security Modules are certified to Federal Information Processing Standard - FIPS 140-3 Level 3.
