...
2. Locate the user you want to grant access to. If the user is not yet part of the Organization, you will need to [invite them](/iam/how-to/manage-members/) first.
...
Refer to the [IAM documentation](/iam/) for more details about user permission and access management.
