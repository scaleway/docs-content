...
- Select your parameter from the drop-down list.
...
<Navigation title="See Also">
  ...
  <NextButton to="/managed-databases/postgresql-and-mysql/how-to/renew-tls-certificate">Renew a TLS certificate</NextButton>
</Navigation>
