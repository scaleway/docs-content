...
<<<<<<< HEAD:databases/databases-for-postgresql-and-mysql/how-to/connect-database-private-network.mdx
=======
When using Private Networks, your application connects directly to your Database nodes without going through a Load Balancer.

>>>>>>> feat(redis): change menus:database/managed-databases-for-postgresql-and-mysql/how-to/connect-database-private-network.mdx
...
=======
  <PreviousButton to="/database/managed-databases-for-postgresql-and-mysql/how-to/upgrade-a-database/">How to upgrade a database</PreviousButton>
  <NextButton to="/database/managed-databases-for-postgresql-and-mysql/how-to/delete-a-database/">How to delete a database</NextButton>
>>>>>>> feat(redis): change menus:database/managed-databases-for-postgresql-and-mysql/how-to/connect-database-private-network.mdx
</Navigation>