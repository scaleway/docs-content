...
- Ensure you have [generated an API key](/iam/credentials/create-api-keys/), and that you have the secret key to hand.
- Get your [Project](/organizations-and-projects/concepts/glossary/#project) ID from the [Scaleway console](https://console.scaleway.com/).
