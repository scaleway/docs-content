...
1. Click **Load Balancers** in the Network section of the [Scaleway console](https://account.scaleway.com/?service=elements) side menu. The list of your Load Balancers displays.
