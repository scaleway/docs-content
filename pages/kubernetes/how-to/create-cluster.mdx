...
1. Configure the following for each pool:
    ...
    * Configure an optional [cloud-init](/kubernetes/concepts/#cloud-init) script to customize your nodes on first boot:
      ...
      * Add your YAML-formatted script in the **Cloud-init configuration** box.
        ...
        See the [Introduction to cloud-init](https://docs.cloud-init.io/en/latest/explanation/introduction.html), [explanation about cloud-config](https://docs.cloud-init.io/en/latest/explanation/format/cloud-config.html#user-data-formats-cloud-config), and the [cloud-config examples](https://docs.cloud-init.io/en/latest/reference/examples.html) in the cloud-init documentation for more information.      
