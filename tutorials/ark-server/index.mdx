...
## Why Should I Start My Own "Ark: Survival Evolved" Server?
...
By starting your own “Ark: Survival Evolved” server, you can design your ARK map precisely to your creativity and liking.
...
Creating your "Ark: Survival Evolved" server can be done in a few steps on a [Scaleway Instance](https://www.scaleway.com/en/virtual-instances/development/). If you do not have an Instance yet, start by [deploying your first Instance](/compute/instances/how-to/create-an-instance/).
