...
content:
  h1: Deploying a multi-AZ Kubernetes cluster with Terraform/OpenTofu and Kapsule
  paragraph: Learn how to deploy a multi-AZ Kubernetes cluster with Terraform/OpenTofu and Kapsule
