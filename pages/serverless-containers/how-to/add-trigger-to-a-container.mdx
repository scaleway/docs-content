...
- You have deployed a container from [Scaleway Container Registry](/serverless-containers/how-to/deploy-container/) or an [external registry](/serverless-containers/how-to/deploy-container/)
...
Refer to the [permissions sets documentation](/iam/policies-permissions/permission-sets/) for more information.
</Message>
...
1. [Create queue credentials](/queues/how-to/create-credentials/)
...
[NATS triggers](/serverless-containers/concepts/#nats-trigger) allow you to automatically invoke a container using messages sent in a [NATS](/nats/concepts/#nats-messaging-system) subject.
...
1. [Create NATS credentials](/nats/how-to/create-credentials/)
...
This change was introduced in Serverless Containers API v1, see [migration guide](/serverless-containers/reference-content/v1-migration-guide/).
</Message>
...
[CRON triggers](/serverless-containers/concepts/#cron-trigger) allow you to invoke your containers based on a recurring schedule. The CRON triggers for Serverless Containers use the **UTC** time zone by default, but you can select a different time zone when configuring your trigger.
