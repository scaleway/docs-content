...
3. Complete the following steps in the wizard:
    ...
    - Enable encryption at rest if you want to ensure the permanent encryption of your database data.
        <Message type="important">
          When you enable encryption at rest, you cannot disable it after database creation. All databases, all data (including logs) and all snapshots will be encrypted. Logical backup encryption is currently not available.
          <br /><br />
