...
S3 is the de facto Object Storage protocol. Scaleway Object Storage officially supports a subset of S3. The list of supported features are described in the [Object Storage API documentation](/s3-object-storage-api/).
