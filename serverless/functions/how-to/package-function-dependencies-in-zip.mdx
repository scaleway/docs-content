...
meta:
  ...
  description: This page explains how to package your code and its dependencies and upload it as a zip to Serverless Functions
content:
  h1: How to package your function and dependencies to a zip file and upload it
  paragraph: This page explains how to package your code and its dependencies and upload it as a zip to Serverless Functions
