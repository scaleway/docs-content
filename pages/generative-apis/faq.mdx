...
All *Serverless models* are currently hosted in a secure data center located in Paris, France, operated by [OPCORE](https://www.opcore.com/). This ensures low latency for European users and compliance with European data privacy regulations. In the future, we may add additional location in other European regions and will continue to guarantee *Serverless models* accessible through `api.scaleway.ai` will be hosted in Europe. Customers will be notified when location changes from France-only to Europe.
