...
- **Scaling**: To handle more users, you might need to adjust the server resources or implement horizontal scaling by deploying multiple Jitsi Meet instances [behind a load balancer](/network/load-balancer/quickstart/).
