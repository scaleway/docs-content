...
[SQS triggers](/serverless/functions/concepts/#sqs-trigger) allow you to automatically invoke a container using events stored in a [queue](/serverless/messaging/concepts/#queue).
