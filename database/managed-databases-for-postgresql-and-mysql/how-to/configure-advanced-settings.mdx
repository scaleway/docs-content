---
meta:
  title: How to configure advanced Managed Database for PostgreSQL and MySQL settings 
  description: This page explains how to configure advanced database settings 
content:
  h1: How to configure advanced Managed Database for PostgreSQL and MySQL settings 
...
1. 1. Click **Managed Databases for PostgreSQL and MySQL** under **Database** on the side menu. A list of your Database Instances displays.
...
<Navigation title="See Also">
  <PreviousButton to="/database/managed-databases-for-postgresql-and-mysql/how-to/manage-snapshots/">How to manage snapshots</PreviousButton>
  <NextButton to="/database/managed-databases-for-postgresql-and-mysql/how-to/upgrade-a-database">How to upgrade a database</NextButton>
</Navigation>
