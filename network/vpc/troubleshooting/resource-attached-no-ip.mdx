...
You will need to carry out manual configuration to set the IP address on the resource or [activate](/network/vpc/how-to/activate-dhcp/) DHCP](/network/vpc/how-to/activate-dhcp/).
