...
You can request an access to the Distributed Data Lab private beta by email via the [Scaleway betas](https://www.scaleway.com/fr/betas/#distributed-data-lab) page.
