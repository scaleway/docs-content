...
9. Connect to the node you want to add to your Kubernetes Kosmos cluster and run the command as described in the instruction panel.

  <Message type="note">
    There is also an ARM based binary (named `node-agent_linux_arm64`) for ARM-based nodes.
  </Message>
