...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/hardware/reference-content/configure-dell-perc-h700/">How to configure the DELL PERC H700/H710/H730/H730P RAID controller</PreviousButton>
  <NextButton to="/bare-metal/hardware/reference-content/configure-hp-smart-array-p410/">How to configure the HP SMART ARRAY P410/P222 RAID controller</NextButton>
</Navigation>
