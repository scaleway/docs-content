...
11. Enter the ESXi web interface and click **Networking** > **Virtual Switches** > **RPN Swich** and check the IP address of the VMkernel NIC. It now has the RPN IP auto assigned to the interface via DHCP:
