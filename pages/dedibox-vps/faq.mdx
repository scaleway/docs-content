...
* **Dedibox VPS START 2**
{/*To update potentially: Fair use traffic and Throttle Mbps*/}

| Product               | Bandwidth (Mbps) | Fair use traffic (TB) | Throttle Mbps |
|-----------------------|------------------|-----------------------|---------------|
| VPS-START-2-XS        | 200              | 1 TB                  | 2             |
| VPS-START-2-S         | 250              | 2 TB                  | 2             |
| VPS-START-2-M         | 300              | 3 TB                  | 5             |
| VPS-START-2-L         | 500              | 4 TB                  | 5             |
| VPS-START-2-XL        | 750              | 6 TB                  | 10            |
| VPS-START-2-XXL       | 1000             | 8 TB                  | 10            |
...
| Product             | Bandwidth (Mbps)  | Fair use traffic (TB) | Throttle Mbps |
|---------------------|-------------------|-----------------------|---------------|
| VPS-PRO-2-XS        | 300               | 3 TB                  | 10            |
| VPS-PRO-2-S         | 400               | 4 TB                  | 10            |
| VPS-PRO-2-M         | 500               | 5 TB                  | 10            |
| VPS-PRO-2-L         | 600               | 10 TB                 | 10            |
| VPS-PRO-2-XL        | 800               | 15 TB                 | 10            |
| VPS-PRO-2-XXL       | 1000              | 20 TB                 | 10            |
| VPS-PRO-2-XXXL      | 1000              |                  |             |

* **Dedibox VPS STORE 2**

The Dedibox VPS STORE-2 range is not limited in traffic (no throttling).
{/*To check if the table is OK as-is.*/}

| Product             | Bandwidth (Mbps)  | Fair use traffic (TB) | Throttle Mbps |
|---------------------|-------------------|-----------------------|---------------|
| VPS-STORE-2-XS      | 10000             | N/A                   | No throttling |
| VPS-STORE-2-S       | 10000             | N/A                   | No throttling |
| VPS-STORE-2-M       | 10000             | N/A                   | No throttling |
| VPS-STORE-2-L       | 10000             | N/A                   | No throttling |
| VPS-STORE-2-XL      | 10000             | N/A                   | No throttling |
| VPS-STORE-2-XXL     | 10000             | N/A                   | No throttling |
| VPS-STORE-2-XXXL	  | 10000             | N/A                   | No throttling |  
