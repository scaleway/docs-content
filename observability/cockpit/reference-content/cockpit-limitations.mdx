...
## Scaleway products integrated into Cockpit

The following table provides details about product integration into Cockpit. This means that you can find metrics and/or logs and/or alerts in your Cockpit for the products mentioned below.
...
You will be billed if you send metrics and logs for Scaleway resources or personal data using the external path.
Any data that you push yourself will be billed according to the pricing displayed on [the Scaleway website](https://www.scaleway.com/en/pricing/?tags=available,managedservices-observability-cockpit), even if you send data for Scaleway products.
</Message>
...
| Public Gateways            | Not integrated  | Not integrated  | Not integrated |
...
| Redis                      | **Integrated*** | **Integrated*** | Not integrated |
...
| Kubernetes Kapsule         | Planned         | Not integrated  | Planned        |
| Kubernetes Kosmos          | Planned         | Not integrated  | Planned        |
| Elastic Metal              | Planned         | Not integrated  | Not integrated |
| Secret Manager             | Planned         | Not integrated  | Not integrated |
