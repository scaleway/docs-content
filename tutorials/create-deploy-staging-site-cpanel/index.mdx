...
1. Click **Web Hosting** in the **Managed Services** section of the [console](https://account.scaleway.com/?service=elements) side menu. The **Web Hosting** overview page displays.
