...
<Navigation title="See Also">
  <PreviousButton to="/dedibox-console/classic-hosting/how-to/create-mysql-database/">How to create a MySQL database</PreviousButton>
  <NextButton to="/dedibox-console/classic-hosting/how-to/delete-mysql-database/">How to delete a MySQL database</NextButton>
</Navigation> 