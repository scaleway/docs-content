...
meta:
  ...
  description: This page provides information on how to retrieve logs stored in Cockpit programmatically using LogCLI
content:
  h1: Retrieving logs programmatically using LogCLI
  paragraph: This page provides information on how to retrieve logs stored in Cockpit programmatically using LogCLI
...
Open a terminal and run the following command to export your environment variables. Make sure that you replace `<DATA_SOURCE_URL>` and `<COCKPIT_TOKEN>` with your values.
...
Open a terminal and paste the following command to retrieve logs from your Kapsul cluster.
...
An output similar to the following should display:
    ...
    2024-05-22T17:33:04+02:00 {component="kapsule-autoscaler"} I0522        1 filter_out_schedulable.go:65] Filtering out schedulables
    2024-05-22T17:33:04+02:00 {component="kapsule-autoscaler"} I0522        1 static_autoscaler.go:243] Starting main loop
    2024-05-22T17:33:01+02:00 {component="csi-plugin"}         I0522        1 controller.go:313] ListVolumes called with {MaxEntries:0 StartingToken: XXX_NoUnkeyedLiteral:{} XXX_unrecognized:[] XXX_sizecache:0}
    2024-05-22T17:33:00+02:00 {component="kapsule-autoscaler"} I0522        1 reflector.go:559] pkg/mod/k8s.io/client-go@v0.25.0/tools/cache/reflector.go:169: Watch close - *v1.CSIStorageCapacity total 4 items received
    2024-05-22T17:32:55+02:00 {component="kapsule-autoscaler"} I0522        1 reflector.go:559] pkg/mod/k8s.io/client-go@v0.25.0/tools/cache/reflector.go:169: Watch close - *v1.Service total 0 items received
    2024-05-22T17:32:46+02:00 {component="kapsule-autoscaler"} I0522        1 reflector.go:559] pkg/mod/k8s.io/client-go@v0.25.0/tools/cache/reflector.go:169: Watch close - *v1.Pod total 0 items received
    2024-05-22T17:32:43+02:00 {component="kapsule-autoscaler"} I0522        1 legacy.go:727] No candidates for scale down
    2024-05-22T17:32:43+02:00 {component="kapsule-autoscaler"} I0522        1 static_autoscaler.go:544] Starting scale down
    2024-05-22T17:32:43+02:00 {component="kapsule-autoscaler"} I0522        1 static_autoscaler.go:535] Scale down status: lastScaleUpTime=2024-05-22 14:20:23.13076564 +0000 UTC m=-3598.920416647 lastScaleDownDeleteTime=2024-05-22 14:20:23.13076564 +0000 UTC m=-3598.920416647 lastScaleDownFailTime=2024-05-22 14:20:23.13076564 +0000 UTC m=-3598.920416647 scaleDownForbidden=false scaleDownInCooldown=false
    2024-05-22T17:32:43+02:00 {component="kapsule-autoscaler"} I0522        1 pre_filtering_processor.go:57] Node scw-k8s-sharp-robinson-default-7cefec16593342e should not be processed by cluster autoscaler (no node group config)
    2024-05-22T17:32:43+02:00 {component="kapsule-autoscaler"} I0522        1 pre_filtering_processor.go:57] Node scw-k8s-sharp-robinson-default-bfb90f82c4b949c should not be processed by cluster autoscaler (no node group config)
    2024-05-22T17:32:43+02:00 {component="kapsule-autoscaler"} I0522        1 pre_filtering_processor.go:57] Node scw-k8s-sharp-robinson-default-e110ac268b5546d should not be processed by cluster autoscaler (no node group config)
    2024-05-22T17:32:43+02:00 {component="kapsule-autoscaler"} I0522        1 static_autoscaler.go:492] Calculating unneeded nodes
    2024-05-22T17:32:43+02:00 {component="kapsule-autoscaler"} I0522        1 static_autoscaler.go:445] No unschedulable pods
    2024-05-22T17:32:43+02:00 {component="kapsule-autoscaler"} I0522        1 filter_out_schedulable.go:87] No schedulable pods
    2024-05-22T17:32:43+02:00 {component="kapsule-autoscaler"} I0522        1 filter_out_schedulable.go:177] 0 pods marked as unschedulable can be scheduled.
    2024-05-22T17:32:43+02:00 {component="kapsule-autoscaler"} I0522        1 filter_out_schedulable.go:176] 0 pods were kept as unschedulable based on caching
    2024-05-22T17:32:43+02:00 {component="kapsule-autoscaler"} I0522        1 filter_out_schedulable.go:137] Filtered out 0 pods using hints
    ```

    <Message type="tip">
     You can tailor your `logcli query` commands according to your needs using the [LogCLI flags and commands](https://grafana.com/docs/loki/latest/query/logcli/#logcli-command-reference). Enter `logcli help` in your terminal to see the available flags and commands and examples of how to use them.
    </Message>
