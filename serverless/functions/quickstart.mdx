...
<Message type="tip">
  This page explains how to deploy a functions using Scaleway Console but for advanced usage (ex: larger project with dependencies, automation, multiple functions...) there are a [lot of ways to deploy functions](/serverless/functions/reference-content/deploy-function/).
