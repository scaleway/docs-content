...
Block Storage is a storage type that is decoupled from your compute resources. Scaleway's Block Storage provides low latency and high resiliency through 5k and 15k IOPS. You can increase your volume size to up to 15 TB.
