...
<Lightbox src="identity-and-access-management/iam/reference-content/assets/scaleway-iam-api-key-change.webp" alt="" />
...
For more information refer to the [IAM Migration reference documentation page](https://www.scaleway.com/en/docs/identity-and-access-management/iam/reference-content/migration).
...
<Lightbox src="identity-and-access-management/iam/reference-content/assets/scaleway-iam-roles-change.webp" alt="" />
...
<Message type="note">
  For Scaleway accounts created from the 7th of December 2022 onward, IAM will be activated automatically upon creation. 
</Message>

## Can I switch from IAM back to former role system?
