---
meta:
  title: I am unable to create a Serverless Functions namespace test
  description: Troubleshoot problems encountered while creating namespaces test for Scaleway Serverless Functions.
content:
