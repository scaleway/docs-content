...
**Responsiveness**: Setting a lower concurrency (down to 1 concurrent container instance) allows you to reduce latency for individual requests, since the container focuses on fewer tasks at a time.
