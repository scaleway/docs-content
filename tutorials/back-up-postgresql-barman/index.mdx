...
totalTime: PT25M
steps:
  - step: Installing Barman
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/back-up-postgresql-barman/#-Installing-Barman
  - step: Creating a dedicated PostgreSQL user on pgsql
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/back-up-postgresql-barman/#-Creating-a-dedicated-PostgreSQL-user-on-pgsql
  - step: Object Operations
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/back-up-postgresql-barman/#-Object-Operations
  - step: Installing Barman
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/back-up-postgresql-barman/#-Installing-Barman
  - step: Creating a dedicated PostgreSQL user on pgsql
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/back-up-postgresql-barman/#-Creating-a-dedicated-PostgreSQL-user-on-pgsql
  - step: Creating the .pgpass file on pgsql-backup
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/back-up-postgresql-barman/#-Creating-the-pgpass-file-on-pgsqlbackup
  - step: Setting up key-based authentication
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/back-up-postgresql-barman/#-Setting-up-keybased-authentication
  - step: Configuring Barman
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/back-up-postgresql-barman/#-Configuring-Barman
  - step: Configuring PostgreSQL
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/back-up-postgresql-barman/#-Configuring-PostgreSQL
  - step: Performing Backups
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/back-up-postgresql-barman/#-Performing-Backups
  - step: Restoring Backups
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/back-up-postgresql-barman/#-Restoring-Backups
  - step: Automatizing Backups
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/back-up-postgresql-barman/#-Automatizing-Backups
categories:
  - storage
  - compute
  - database
tags: compute networking security backup barman
image: /assets/images/docs/scaleway.png
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, debian server, linux server, IAAS, baremetal, scalability, ARM, physical server, dedicated server, physicalization, server, postgresql, backup, barman, bar man
dates:
...
- You have [created two Instances](/compute/instances/how-to/create-an-instance) running a [PostgreSQL database](/tutorials/install-postgresql/) on Ubuntu Bionic or Xenial
