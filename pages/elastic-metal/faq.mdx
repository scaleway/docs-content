...
<Message type="important">
  You can [change the billing method from hourly to mothly](/elastic-metal/how-to/change-billing-period/) once. However, you must [create](/elastic-metal/how-to/create-server/) and [reinstall](/elastic-metal/how-to/reinstall-server/) a new Elastic Metal server to switch from monthly to hourly billing.
</Message>
