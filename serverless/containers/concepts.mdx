...
Serverless Containers supports **http1** (default) and **http2** (`h2c`). In some cases for example deploying container using gRPC, may require to upgrade the procotol in order to work.
