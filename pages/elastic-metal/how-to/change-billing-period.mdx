...
4. Review the server and options details and their new monthly pricing. Note that switching to monthly billing incurs a one-time commitment fee, which is charged immediately.
    <Message type="important">
        - Once switched to monthly billing, it is not possible to revert to hourly billing.
        - A commitment fee is due immediately upon switching. This fee can be redeemed after 12 months as a voucher for other Scaleway services. [Learn more about our loyalty reward](/elastic-metal/how-to/get-use-loyalty-reward/).
    </Message>
