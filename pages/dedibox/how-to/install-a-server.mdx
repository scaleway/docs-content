...
1. In the [Dedibox console](https://account.scaleway.com/?service=dedibox), navigate to **Server** > **Server list** in the top menu. A list of your servers will be displayed.
