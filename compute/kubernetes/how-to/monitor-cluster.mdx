...
<Lightbox src="scaleway-kapsule_nodes.webp" alt="" />


<Navigation title="See Also">
  <PreviousButton to="/compute/kubernetes/how-to/enable-easy-deploy/">How to enable the Easy Deploy feature</PreviousButton>
  <NextButton to="/compute/kubernetes/how-to/upgrade-kubernetes-version/">How to upgrade the Kubernetes version on a Kapsule cluster</NextButton>
</Navigation>
