...
3. Select **PostgreSQL-13** from the dropdown list and fill in the [required information](/storage/database/how-to/create-a-database/) for your new database instance. Then click **Create an Instance**. Your database is created and you are redirected to the database dashboard.
...
5. Once the migration is complete, [delete](/storage/database/how-to/delete-a-database/) the old Database Instance from your account. 
