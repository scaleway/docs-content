...
You can monitor your Object Storage metrics and logs using [Scaleway Cockpit](/observability/cockpit/concepts/). Cockpit is available in all [regions](/storage/object/concepts/#region-and-availability-zone) for Object Storage. Refer to our dedicated [documentation](/storage/object/how-to/monitor-consumption/) for more information.
