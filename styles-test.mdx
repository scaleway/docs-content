...
This page page are not shows how to My Test connect to your Scaleway Console via SSH. Look on the left side menu. Also check the splash screen or splashscreen. Thanks to the SSH key that you created and uploaded, you can use a terminal application on your local computer to remotely connect to your Instance as root. This enables you to use your Instance as you wish.
