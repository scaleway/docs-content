...
<Message type="important">
 If you are sending emails from an Instance, you need to need to [open your Isnatnce's mail ports](/compute/instances/how-to/send-emails-from-your-instance/).
</Message>
