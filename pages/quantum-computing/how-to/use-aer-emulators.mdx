...
* **Noise model support:** Our Aer-based Platforms support custom noise model with you are willing to mimic a real QPU behavior. See [further doc](https://qiskit.github.io/qiskit-aer/apidocs/aer_noise.html).
