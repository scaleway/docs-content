...
An Apache Spark™ Executor is a process that runs on a worker node in a cluster, and is responsible for executing tasks assigned to it by the Apache Spark™ driver program.
