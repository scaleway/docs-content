...
<Message type="requirement">
  ...
  - You have [connected SQS/SNS to the AWS-CLI](/serverless/messaging/api-cli/connect-aws-cli/)
...
1. Use the following command to create a queue, which must be in the same Scaleway Project as the SNS topic:
...
1. Create the function following the steps detailed in the [Scaleway Functions Quickstart](/compute/functions/quickstart/).
