...
permalink: docs/tutorials/strapi/
...
excerpt: |
  Strapi is an open-source, Node.js based, headless CMS to manage content and make it available through a fully customizable API. Unlike traditional CMSs such as Wordpress, with Strapi the content is decoupled from the front end.
steps:
...
totalTime: PT15M
keywords: strapi, headless CMS, virtual instance, PM2, cloud tutorials, cloud documentations, cloud server, cloud hosting, ubuntu server, debian server, linux server
