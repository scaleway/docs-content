...
The scope of coverage is fully customizable and defined in your contract. The products to which discounts will apply and for how long are defined between your Organization and Scaleway upon contract negotiation.
...
At Scaleway, contractual commitment discounts are applied according to the following principles.
    ...
    - If the committed amount is not reached, penalties may apply — and any agreed discounts will also apply to those penalties, but only if the product scope matches.
...
Cancellation terms are strictly defined in your signed contract. Keep in mind that:
    ...
    - We advise you to directly contact the Scaleway account manager in charge of your Organization when you have questions about the terms and conditions of your contract. for details.
