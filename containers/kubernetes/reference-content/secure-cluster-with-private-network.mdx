...
<Message type="tip">
  If you are using Terraform to create your cluster, you can create a security group resource after creating the cluster resource and before creating the pool resource.<br />
  You can find a Terraform example here: [Terraform - Kapsule with open Private Network](https://github.com/n-Arno/kapsule-open-pn/blob/master/main.tf)
</Message>
