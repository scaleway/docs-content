...
excerpt: |
  This page explains how to use boot modes for Instances
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/computer/instances/how-to/use-boot modes
image: /assets/images/docs/scaleway.png
keywords: instance, cloud computing, scaleway, instance, rescue mode, local boot, bootscripts, boot modes
dates:
...
3. Click the **Advanced Settings** tab.
  ...
  <Lightbox src="scaleway-boot-modes.png" alt=""/>
...
4. In the **Cloud-init** section, use the <Icon name="toggle" /> toggle to to select **Use cloud init**
  ...
  <Lightbox src="scaleway-cloud-init.png" alt=""/>
