...
excerpt: |
  ...
  Before following this tutorial, you must be familiar with Ansible.
totalTime: PT20M
steps:
  - step: Configuring Ansible for Apache
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-install-apache-on-ansible/#-Configuring-Ansible-for-Apache
  - step: Creating a Playbook
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-install-apache-on-ansible/#-Creating-a-Playbook
  - step: Installing Apache
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-install-apache-on-ansible/#-Installing-Apache
  - step: Configuring Apache Modules
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-install-apache-on-ansible/#-Configuring-Apache-Modules
  - step: Configuring Apache Options
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-install-apache-on-ansible/#-Configuring-Apache-Options
  - step: Going Further?
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-install-apache-on-ansible/#-Going-Further
categories:
  - compute
brands:
  - elements
image: /assets/images/docs/scaleway.png
permalink: /tutorials/install-apache-ansible
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, linux server, baremetal, scalability, ARM, physical server, dedicated server, ansible, apache, playbook, roles, hosts
dates:
...
<Lightbox src="scaleway-apache_defaultpage.png" alt="" />
