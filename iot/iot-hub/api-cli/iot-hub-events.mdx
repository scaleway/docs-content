...
<Navigation title="See Also">
  <PreviousButton to="/iot/iot-hub/api-cli/getting-started-with-iot-hub-cli/">Getting started with the IoT Hub CLI</PreviousButton>
  <NextButton to="/iot/iot-hub/api-cli/trigger-functions-from-messages/">Triggering functions from IoT Hub messages</NextButton>
</Navigation>