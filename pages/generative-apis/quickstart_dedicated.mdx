...
<Message type="note">
  Prompt structure may vary from one model to another. Refer to the specific instructions for use in our [dedicated documentation](https://www.scaleway.com/en/developers/api/generative-apis-dedicated-deployment/).
</Message>
