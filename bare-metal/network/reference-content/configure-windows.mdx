...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/network/reference-content/configure-freebsd">How to configure a failover IP on FreeBSD</PreviousButton>
  <NextButton to="/bare-metal/network/reference-content/create-virtual-mac">How to create a virtual MAC address</NextButton>
</Navigation>
