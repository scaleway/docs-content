...
3. Click the **Route Rules** tab.

4. Click the <Icon name="plus" /> icon to create a new route rule.

5. Enter the following information to configure the route rule:
    - **Source frontend**: Select the frontend on which to configure the rule.
...
6. Click **Create a new rule** to finish.
...
4. Click the <Icon name="more" /> icon next to the route rule you want to edit, and select *Edit** from the dropdown list.

5. Edit the frontend, backend and SNI/HTTP host header vlaue as required.

6. Click **Edit route rule** to finish. 
...
4. Click the <Icon name="more" /> icon next to the route rule you want to delete, and select and select **Delete**.
