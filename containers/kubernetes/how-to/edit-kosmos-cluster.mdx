...
3. Drain one of the old nodes in your pool using `kubectl`.
4. Detach the drained node. You will then need to deprovision or recycle the node in your cloud provider.
