...
A volume is a storage space used by your Instances. Several volumes can be [attached to an Instance](/block/how-to/attach-a-volume/). In addition, they can be [snapshotted](/block/how-to/create-a-snapshot/), [mounted](/block/api-cli/managing-a-volume/#mounting-and-using-a-block-storage-volume) or [unmounted](/block/api-cli/unmounting-a-volume/).