...
Serverless.com (Serverless Framework) is a tool that allows you to deploy serverless applications without having to manage Serverless Container’s API call. Simply write and deploy a YAML configuration file, everything else is handled automatically, even the image building.
