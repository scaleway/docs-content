...
2. Open the Scaleway console in a web browser, and navigate to the [Container Registry](https://account.scaleway.com/?service=elementscontainers/).
...
1. In the [Serverless Containers](https://account.scaleway.com/?service=elementscontainers/namespaces/) section of the Scaleway console, click **+ Create namespace**.
