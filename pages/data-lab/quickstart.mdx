...
This documentation explains how to create a Data Lab for Apache Spark™ cluster, access its notebook environment and run the included demo file, and delete your cluster.
