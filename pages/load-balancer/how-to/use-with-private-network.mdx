...
1. Click [Load Balancers](https://account.scaleway.com/?service=elementsload-balancer/lbs) in the **Network** section of the Scaleway console side menu. The Load Balancer dashboard displays.
...
1. Click [Load Balancers](https://account.scaleway.com/?service=elementsload-balancer/lbs) in the **Network** section of the Scaleway console side menu. The Load Balancer overview page displays.
