...
steps:
  - step: Installing Apache
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-apache-lets-encrypt/#-Installing-Apache
  - step: Installing Certbot
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-apache-lets-encrypt/#-Installing-Certbot
  - step: Running Certbot
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-apache-lets-encrypt/#-Running-Certbot
categories:
  - compute
  - instances
