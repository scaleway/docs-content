...
1. Configure the following for each pool:
    ...
    * Configure an optional [cloud-init](/kubernetes/concepts/#cloud-init) script to customize your nodes on first boot:
      ...
      * Add your YAML-formatted script in the **Cloud-init configuration** box.
        ...
        - See [How to use cloud-init with Scaleway Instances](/instances/how-to/use-cloud-init/) to learn more about the specifics of cloud-init in a Scaleway context. 
        - See [How to configure a cloud-init script](/kubernetes/how-to/manage-node-pools/#how-to-configure-a-cloud-init-script) for an example script that adds a custom Certificate Authority (CA).
        - See [cloud-config examples](https://docs.cloud-init.io/en/latest/reference/examples.html) in the cloud-init documentation for some practical examples.     
