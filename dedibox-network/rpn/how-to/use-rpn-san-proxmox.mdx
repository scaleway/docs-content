...
* **Shared:** Be careful: check only if you really know what you are doing!
* Add the LVM Group (Optional)
This step only applies if you want to create a LVM Group to store VM images.

3. Click **Add** and then **iSCSI Target**. Fill in the form:
...
<Navigation title="See Also">
  ...
  <NextButton to="/dedibox-network/rpn/how-to/connect-rpn-san-windows/">How to connect a Windows Server to a RPN SAN</NextButton>
</Navigation>