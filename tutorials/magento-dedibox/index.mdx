...
<Message type="requirement">
  ...
  - You have [created a Scaleway Instance](/compute/instances/how-to/create-an-instance/) with at least 2GB RAM
...
6. Then install the required PHP packages with the apt package manager:
  ...
  ```
  apt install -y php7.4-common php7.4-curl php7.4-fpm php7.4-mysql php7.4-opcache php7.4-xml php7.4-gd php7.4-dev php7.4-intl php7.4-mbstring php7.4-bcmath php7.4-json php7.4-soap php7.4-zip libapache2-mod-php7.4 unzip
  ```
