...
## Contacts (CardDAV)
Mailbox includes a CardDAV server which features synchronization of contacts, centralized access to  to mobile and desktop support.
...
DNS verification is the time a DNS change takes to be updated across the internet.
