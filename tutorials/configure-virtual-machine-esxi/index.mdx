...
<Message type="requirement">
  ...
  - You have at least one [failover IP](/bare-metal/dedibox/concepts/#failover-ips) with a [virtual MAC address](/dedibox-network/ip-failover/concepts/#virtual-mac-address)
...
The process from this step forward may differ according to the KVM model being used. Please refer to the Dedibox [KVM over IP documentation](/bare-metal/hardware/concepts/#kvm-over-ip) to conclude the installation.
...
The network configuration of the virtual machine is done during the installation. Refer to the [network configuration documentation](/bare-metal/dedibox/how-to/configure-failover-ip/) to learn more about how to configure the networking on your operating system.
