...
| [Bolt.diy](#boltdiy-code-generation) | Software to create applications | App generation, code edition | Low |
...
Claude Code is a coding agent for terminal and IDE. You can use Claude Code with Generative APIs using local proxy such as y-router.

<Message type="tip">
  Refer to our dedicated documentation for [integrating Generative APIs into Claude Code](/generative-apis/reference-content/integrate-with-claude-code/)
</Message>
