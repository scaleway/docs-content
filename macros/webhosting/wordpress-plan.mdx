...
- Easy access to WordPress admin: You will receive an email with a direct link to your WordPress admin dashboard. You can also access it anytime from the **Overview** tab of [your Web Hosting](https://account.scaleway.com/?service=elementswebhosting/) by clicking the **Open hosting dashboard** button
