...
If you are using Scaleway Kapsule, you can use the [scaleway-k8s-vpc](https://github.com/Sh4d1/scaleway-k8s-vpc) github project to connect Database instance to your Pods using a Private Network.
Once your Kapsule node connected to the Private Network you can directly reach the database by using the Service IP you assigned earlier. No need to expose it through a Kubernetes resource like a service. The database is ready to use out of the box.
