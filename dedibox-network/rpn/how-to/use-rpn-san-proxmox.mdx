---
meta:
  title: How to mount a RPN SAN volume on Proxmox
  description: This page explains how to mount a RPN SAN volume on Proxmox
content:
  h1: How to mount a RPN SAN volume on Proxmox
  paragraph: This page explains how to mount a RPN SAN volume on Proxmox
dates:
