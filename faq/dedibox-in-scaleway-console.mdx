...
The definition of your new default payment method follows the following guidelines:
* SEPA payments are the preferred payment method (if one of your Accounts uses SEPA, it will become the default payment method for Dedibox and Scaleway Cloud services)
* Credit card remains the default payment method for your account if you use it as preferred payment method for both:
  * Scaleway Dedibox
  * Scaleway Cloud
