...
*Scaleway's Generative APIs - Dedicated Deployment* (formerly known as Scaleway Managed Inference) is a fully managed service that allows you to deploy, run, and scale curated or custom AI models in a dedicated environment.
...
As for *Generative APIs - Dedicated Deployment*, we are currently working on defining our SLAs. We will provide more information on this topic soon.
...
In the case of *Generative APIs - Dedicated Deployments*, because the hardware is dedicated to your usage, performance is guaranteed and will only depend on the capacity your provisioned.
Generative APIs - Dedicated Deployment is ideal for workloads that require consistent response times, high availability, custom hardware configurations, or generate extreme peak loads during a narrow period.
