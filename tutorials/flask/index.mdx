---
title: How to Configure Flask on Ubuntu Xenial
...
steps:
  - step: Installing Python
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/flask/#-Installing-Python
  - step: Setting up Flask
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/flask/#-Setting-up-Flask
  - step: Creating URL routes
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/flask/#-Creating-URL-routes
  - step: Styling Flask Pages
    type: HowToStep
    url: http://www.scaleway.com/en/docs/tutorials/flask/#-Styling-Flask-Pages
  - step: Passing Variables
    type: HowToStep
    url: http://www.scaleway.com/en/docs/tutorials/flask/#-Passing-Variables
categories:
  - compute
  - instance-dev
image: /assets/images/docs/scaleway.png
keywords: cloud tutorials, cloud documentations, cloud instance, scaleway cli, command line interface, cloud hosting, ubuntu server, debian server, linux server, physical server, dedicated server, flask, web application
dates:
...
7. Open you web browser and type the `server_ip:port`
  ...
  <Lightbox src="scaleway-FlaskApp.png" alt="" />
...
2. Restart the application using
  ...
  <Lightbox src="scaleway-FlaskHello.png" alt="" />
...
5. Launch the application
  ...
  <Lightbox src="scaleway-FlaskHome.png" alt="" />
...
5. Run the application `hello.py`. It will return one of these quotes at random.
  ...
  <Lightbox src="scaleway-FlaskQuote.png" alt="" />
