...
1. Change the directory from root to the folder where you want to download the GLPI repository.
  ...
  Check the most recent version of GLPI [here](https://glpi-project.org/downloads/) and replace it in the commands accordingly. In this tutorial we are using version `10.0.2`
