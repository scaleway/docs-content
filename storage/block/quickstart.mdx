...
title: Quickstart Block Storage
description: This page shows you how to get started with Scaleway Block Storage.
excerpt: |
  This page shows you how to get started with Scaleway Block Storage.
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
...
keywords: block storage, cloud computing, scaleway, volumes, storage, quickstart
dates:
