...
description: Step-by-step guide to deploying Serverless Functions on Scaleway.
dates:
...
The [Scaleway console](https://account.scaleway.com/?service=elements) is the easiest way to get started with deploying functions.
...
Serverless Functions integrate easily with your infrastructure as code, via our [Terraform/OpenTofu provider and resources](https://registry.terraform.io/providers/scaleway/scaleway/latest/docs/resources/function).

Examples using Terraform/OpenTofu can be found in our [Serverless Examples repository](https://github.com/scaleway/serverless-examples), such as our [example using Terraform/OpenTofu with Python](https://github.com/scaleway/serverless-examples/tree/main/functions/terraform-python-example).
