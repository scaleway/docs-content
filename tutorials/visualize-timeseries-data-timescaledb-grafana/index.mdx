...
- An [Instance](/instances/how-to/create-an-instance/) running on Ubuntu Bionic Beaver (18.04) or later to host the Grafana interface
- A [Database for PostgreSQL](/managed-databases-for-postgresql-and-mysql/how-to/create-a-database/)
...
2. Log into the Instance [using SSH](/instances/how-to/connect-to-instance/).
