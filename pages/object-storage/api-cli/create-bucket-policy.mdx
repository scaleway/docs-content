...
- An [IAM policy](/iam/policies-permissions/create-policy/) to grant access to your users and applications
...
<Message type="note">
To delete a bucket policy, you must have [Owner](/iam/concepts/glossary/#owner) status, or the necessary [IAM permissions](/object-storage/reference-content/s3-iam-permissions-equivalence/).
</Message>
