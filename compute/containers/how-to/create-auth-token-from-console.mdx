...
<Message type="requirement">
  ...
  - You have [created a containers namespace](/compute/containers/how-to/create-a-container/)
  - You have [created a container](/compute/containers/how-to/create-a-container/)
...
2. Click the relevant containers namespace to see a list of containers in this namespage.

3. Click the containers name in the **Containers** tab. The containers details' display. 
