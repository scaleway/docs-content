...
Refer to the [How to enable Autobackup](/postgresql-and-mysql/how-to/enable-autobackup/) documentation page for more information.
...
Refer to the [How to manage backups](/postgresql-and-mysql/how-to/manage-manual-backups/#how-to-restore-backups) and the [How to manage snapshots](/postgresql-and-mysql/how-to/manage-snapshots/#how-to-create-a-database-instance-from-a-snapshot) documentation pages for more information.
...
When [promoting a Read Replica](/postgresql-and-mysql/how-to/manage-read-replica/#how-to-promote-a-read-replica) to a main node, make sure that the main node has completed all ongoing operations and that the Read Replica lag is down to zero before promoting it.
...
Refer to the [How to manage Read Replicas](/postgresql-and-mysql/how-to/manage-read-replica/#how-to-promote-a-read-replica) documentation page for more information.
...
This includes:
  ...
  - **Logs**:
      - PostgreSQL logs at a default level `log_error_verbosity="VERBOSE"` ([see PostgreSQL documentation](https://www.postgresql.org/docs/current/runtime-config-logging.html#GUC-LOG-ERROR-VERBOSITY)). Every request longer than 5 seconds is also logged.
        ...
        <Message type="tip">
          For more granular log details, you can activate the [pgaudit extension](/postgresql-and-mysql/api-cli/pg-audit/).
        </Message>
...
Refer to the [Dealing with disk_full mode in a Database Instance](/postgresql-and-mysql/troubleshooting/disk-full/) documentation page for more information.
...
You can [modify some advanced settings](/postgresql-and-mysql/how-to/configure-advanced-settings/), such as `effective_cache_size` or `max_connections` in PostgreSQL, but you are responsible for any impacts on your database availability and performance.
...
Refer to the [How to manage user permissions](/postgresql-and-mysql/how-to/manage-permissions/) documentation page for more information.
...
<Message type="note">
  You can use ACLs to restrict access. Refer to the [How to manage allowed IPs](/postgresql-and-mysql/how-to/manage-allowed-ip-addresses/) documentation page for more information.
</Message>
