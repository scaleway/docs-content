...
* To ensure that other servers will accept mails sent from your Instance a [valid reverse DNS](/how-to-configure-reverse-dns/) within your own domain name (for example `mail.domain.com`) must be configured.
