---
meta:
  title: Configuring a HP Smart Array P410 RAID controller from the KVM
  description: This page explains how to configure the HP Smart Array P410 RAID controller from the KVM
content:
  h1: Configuring a HP Smart Array P410 RAID controller from the KVM
...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/hardware/reference-content/configure-raid-kvm-h310/">Configuring a DELL PERC H310 RAID controller from the KVM</PreviousButton>
  <NextButton to="/bare-metal/hardware/reference-content/configure-raid-kvm-p420/">Configuring a HP Smart Array P420 RAID controller from the KVM</NextButton>
</Navigation>
