...
excerpt: |
  This page explains how to create a Mac mini M1
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/compute/apple-silicon/how-to/create-mac-mini-m1/
image: /assets/images/docs/scaleway.png
keywords: mac mini, mac mini m1, apple silicon, apple, cloud computing, scaleway, big sur, apple mac
dates:
...
2. Click **Create a Mac mini M1**. The Mac mini M1 creation wizard displays.
   ...
   <Lightbox src="scaleway-m1-creation-wizard.png" alt="" />
