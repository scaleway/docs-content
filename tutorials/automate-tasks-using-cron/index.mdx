...
description: This page shows you how to configure Arq to automatically back up a PC or Mac on Object Storage
categories:
  - compute
  - instances
  - bare-metal
...
Cronjobs are managed from a cronfile, specific for each user of the system. This allows each user to schedule their own cronjobs. These cronfiles are located in the directory `/var/spool/cron/crontabs/`.
