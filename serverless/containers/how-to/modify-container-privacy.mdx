...
<Navigation>
  ...
  <NextButton to="/serverless/containers/how-to/create-auth-token-from-console/">How to create and manage an authentication token from the console</NextButton>
</Navigation>
