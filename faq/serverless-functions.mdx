...
We recommend you set high values, [use metrics to monitor](/functions/how-to/monitor-function/) the resource usage of your function, then adjust the value accordingly.
...
Refer to our dedicated page about [Serverless Functions limitations and configuration restrictions](/functions/reference-content/functions-limitations/) for more information.
...
Refer to our dedicated page about [Serverless Functions Runtimes Lifecycle](/functions/reference-content/functions-lifecycle/)
...
Serverless Functions use cases are wide so [several ways to deploy functions](/functions/reference-content/deploy-function/) are available.

## How can I test my functions locally?

 Scaleway provides libraries to run your functions locally, for debugging, profiling, and testing purposes. Refer to the [dedicated documentation](/functions/reference-content/local-testing/) for more information.
...
Upgrading a runtime is highly recommended in case of deprecation, and for runtimes that have reached end-of-support or end-of-life. See the [functions runtimes lifecycle documentation](/functions/reference-content/functions-lifecycle/) for more information.
...
Serverless resources are by default [stateless](/functions/concepts/#stateless), local storage is ephemeral.
...
* [Serverless Databases](/sql-databases/): Go full serverless and take the complexity out of PostgreSQL database operations.
* [Managed MySQL / PostgreSQL](/postgresql-and-mysql/): Ensure scalability of your infrastructure and storage with our new generation of Managed Databases designed to scale on-demand according to your needs.
* [Managed Database for Redis®](/redis/): Fully managed Redis®* in seconds.
* [Managed MongoDB®](/mongodb/): Get the best of MongoDB® and Scaleway in one database.

### Storage

* [Object Storage](/object/): Multi-AZ resilient object storage service ensuring high availability for your data.
* [Scaleway Glacier](/object/): Our outstanding Cold Storage class to secure long-term object storage. Ideal for deep archived data.
