...
<Message type="important">
  ...
  We recommend to consider using a newer version of Ubuntu, such as Ubuntu 22.04 LTS (Jammy Jellyfish) or later, for your Scaleway Instance. This will ensure you receive the latest security updates and features.
</Message>
