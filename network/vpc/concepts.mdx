...
One default VPC for every available region is automatically created in each Scaleway [Project](/console/organizations-and-projects/concepts/#project).
