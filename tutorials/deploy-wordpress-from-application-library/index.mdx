...
This tutorial teaches you how to install WordPress on a Scaleway Kubernetes Kapsule or Kosmos cluster by using the [Application Library in the Easy-Deploy feature](/containers/kubernetes/how-to/enable-easy-deploy/). 
