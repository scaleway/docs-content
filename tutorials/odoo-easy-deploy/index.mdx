...
4. Push the image to your Container Registry.
  ...
  It may take a few minutes for this step to complete. An output like the following as the image uploads:

  <Lightbox src="scaleway-pushing.png" alt="" />

5. Go to the Container Registry dashboard to make sure the image has been successfully created.
...
10. Click the name of the Load Balancer you created. Take note of the Load Balancer IP.
