...
5. Confirm the network settings by navigating to the YES button. You will be guided through two more network prompts. Confirm them by by pressing the OK button.
...
7. Choose whether you want to log queries and confirm by pressing the OK button:
