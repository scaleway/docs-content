...
You can easily create a NATS account from the [Scaleway console](/serverless/messaging/how-to/get-started/#how-to-create-a-nats-account), via the [Scaleway API](https://www.scaleway.com/en/developers/api/messaging-and-queuing/) or via [Terraform](https://registry.terraform.io/providers/scaleway/scaleway/latest/docs/guides/mnq_with_nats_terraform_provider).
