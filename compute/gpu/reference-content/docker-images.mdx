...
The main libraries included  in the Pytorch image are: Pytorch, Tensorboard, Fast AI, Pytorch Lightning, Numpy, Scikit-Learn, Scipy, Pandas, Matplotlib, Optuna, Pillow, Plotly, ONNX, Spacy, HuggingFace Transformers and HuggingFace-Hub, JupyterLab and jupyterlab-nvdashboard.
