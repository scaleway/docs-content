...
To create and apply a bucket policy from the [Scaleway console](https://console/scaleway.com), refer to the [dedicated documentation](/storage/object/how-to/create-bucket-policy/).
