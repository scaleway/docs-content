...
description: This page helps you troubleshoot problems when you can't connect to your Instance via SSH
image: /assets/images/docs/scaleway.png
dates:
  validation: 2021-10-19
  posted: 2021-10-19
---

Sometimes you may have a problem when connecting to your Instance. If you've followed the instructions in our document [How-to connect to your Instance via SSH](/compute/instances/how-to/connect-to-instance/) and are still having problems, see our solutions for the following error messages.
...
<Lightbox src="scaleway-ssh-upload.png" alt="" />
