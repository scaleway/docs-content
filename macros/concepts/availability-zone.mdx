...
For an extensive list of which regions and AZ a resource is available in, see [Product availability by region](https://www.scaleway.com/en/product-availability-by-region/).