...
In this tutorial, you learn how to set up a GitHub Actions runner on a Scaleway Instance to automatize the workflow of your projects. For most common workloads, the use of [Cost-Optimized Instance](/compute/instances/reference-content/choosing-instance-type/) is recommended. Demanding workloads can be deployed on Production-Optimized Instances for dedicated resources.
