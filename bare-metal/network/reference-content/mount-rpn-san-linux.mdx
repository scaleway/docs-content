...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/network/reference-content/connect-rpn-san/">How to connect to an RPN SAN</PreviousButton>
  <NextButton to="/bare-metal/network/reference-content/use-rpn-san-esxi/">How to configure RPN SAN on ESXi</NextButton>
</Navigation>