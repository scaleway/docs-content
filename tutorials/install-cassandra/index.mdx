...
steps:
  - step: Installing Cassandra
    type: HowToStep
    url: https://www.scaleway.com/en/docs/install-configure-apache-cassandra-on-ubuntu-bionic/#-Installing-Cassandra
  - step: Configuring Additional Nodes
    type: HowToStep
    url: https://www.scaleway.com/en/docs/install-configure-apache-cassandra-on-ubuntu-bionic/#-Configuring-Additional-Nodes
  - step: Activating Cassandra
    type: HowToStep
    url: https://www.scaleway.com/en/docs/install-configure-apache-cassandra-on-ubuntu-bionic/#-Activating-Cassandra
  - step: Connecting to Your Cluster
    type: HowToStep
    url: https://www.scaleway.com/en/docs/install-configure-apache-cassandra-on-ubuntu-bionic/#-Connecting-to-Your-Cluster
  - step: Renaming Your Cluster
    type: HowToStep
    url: https://www.scaleway.com/en/docs/install-configure-apache-cassandra-on-ubuntu-bionic/#-Renaming-Your-Cluster
categories:
  - compute
brands:
  - elements
tags: compute database nosql cassandra cluster cloud
image: /assets/images/docs/scaleway.png
permalink: /tutorials/install-cassandra
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, debian server, linux server, IAAS, baremetal, scalability, ARM, physical server, dedicated server, physicalization, server, cassandra, database, cluster, nosql, cassandra, scaling
dates:
...
3. Add the required PGP keys to use the repositories:
  ...
  gpg --keyserver keys.gnupg.net --recv-keys A278B781FE4B2BDA
...
5. Install Java, Cassandra and NTP. [NTP (Network Time Protocol)](https://en.wikipedia.org/wiki/Network_Time_Protocol) is used to keep the time of the instance synchronized:
...
<Message type="important">
  ...
  You have to agree to the license terms for Oracle Java when installing it.
