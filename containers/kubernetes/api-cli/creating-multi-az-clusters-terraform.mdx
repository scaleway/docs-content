...
1. Configure your `.tf` file.
    ...
    <Message type="tip">
      Refer to the official [Scaleway Terraform Provider](https://registry.terraform.io/providers/scaleway/scaleway/latest/docs/resources/k8s_cluster) documentation for more information on how to set up your configuration file.
    </Message>
