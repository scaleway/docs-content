...
To use roles in Ansbible playbooks, you must first download them.

1. Install Apache, MySQL and PHP. This will create it under the default directory /etc/ansible/roles.
