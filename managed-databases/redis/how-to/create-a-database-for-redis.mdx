...
3. Complete the following steps in the wizard:
    ...
    - Select a database configuration. You can choose between:
        - **Cluster mode**: creates the Database as a Cluster composed of three nodes. The cluster uses partitioning to split the keyspace. Each partition is replicated and can be reassigned or elected as the primary when necessary.
