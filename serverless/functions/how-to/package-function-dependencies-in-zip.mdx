...
7. select **Upload a Zip** as **Your function code**:
    <Lightbox src="scaleway-upload-zip.webp" alt=""/>
...
To enhance deployment simplicity, all runtimes supports the inclusion of multiple handlers either within a single file or across multiple files.
