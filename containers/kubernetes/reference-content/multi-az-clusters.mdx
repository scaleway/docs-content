...
Kubernetes Kapsule clusters can use [Private Networks](/faq/private-networks/#what-are-private-networks), providing a default security layer for worker nodes. Furthermore, these clusters can deploy node pools across various [Availability Zones (AZs)](/kubernetes/concepts/#multi-az-clusters).
