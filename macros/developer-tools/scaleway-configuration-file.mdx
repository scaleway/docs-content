...
**access_key**
: Your [Scaleway API access key](/iam/credentials/create-api-keys/)

**secret_key**
: Your [Scaleway API secret key](/iam/credentials/create-api-keys/)
...
**default_zone**
: The [availability zone](/account/products-availability/) to use by default

**default_region**
: The [region](/account/products-availability/) to use by default
...
- Make sure that you have generated and specified a valid `access_key` and `secret_key` pair. Refer to the [API keys](/iam/credentials/create-api-keys/) documentation for more information.
