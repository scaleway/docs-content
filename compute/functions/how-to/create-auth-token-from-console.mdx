...
2. Click the relevant functions namespace to see a list of functions in this namespage.

3. Click the functions name in the **Functions** tab. The functions details' display. 

4. Click the **Functions Settings** tab. A list of your functions settings displays. 

5. Click **Generate token** in the **Tokens** sections of the settings page. A pop-up displays.
...
5. Click <Icon name="delete" /> in the **Tokens** sections of the settings page. A pop-up displays.
