...
2. From the Scaleway console [Cockpit overview page](https://account.scaleway.com/?service=elementscockpit/overview), click **Open dashboards** in the top right corner. The Grafana login screen displays.
