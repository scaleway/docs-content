...
## Can I configure Messaging and Queueing via Terraform?

Yes, check out our [tutorial](https://registry.terraform.io/providers/scaleway/scaleway/latest/docs/guides/mnq_with_nats_terraform_provider) on configuring Messaging and Queueing with the Terraform NATS Jetstream provider.
