...
3. Configure your applications to send metrics and logs to your Cockpit [endpoints](/cockpit/concepts/#endpoints), using your token's secret key for authentication.
    ...
    <Message type="important">
     Retrieve your metrics' and logs' push endpoints in the [Data sources tab](https://account.scaleway.com/?service=elementscockpit/dataSource) of the Scaleway console.
    </Message>
