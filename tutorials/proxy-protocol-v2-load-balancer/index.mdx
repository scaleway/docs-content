...
This additional information can be useful for the delivery of localized content, blocking of abusive users, or logging purposes. If these use cases do not apply to you, it may not be useful to enable Proxy Protocol.
