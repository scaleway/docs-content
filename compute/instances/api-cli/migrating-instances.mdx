...
It is possible to change the commercial type of an Instance by using the [Scaleway CLI tool](/developer-tools/scaleway-cli/quickstart/) or the [Instances API](/developers/api/instance/).
