...
This page shows you how to use [KVM](/bare-metal/hardware/concepts/#kvm-over-ip) on a Dedibox with DELL iDRAC 8.
...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/hardware/reference-content/dell-idrac7/">Using DELL iDRAC 7</PreviousButton>
  <NextButton to="/bare-metal/hardware/reference-content/dell-idrac9/">Using DELL iDRAC 9</NextButton>
</Navigation>