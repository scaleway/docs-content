...
tags: dedibox prestashop ecommerce
dates:
...
5. Enter the connection details for your database. You have set the credentials for the database user in a previous step. If you want to use PrestaShop with a [Database for MySQL](https://www.scaleway.com/en/managed-postgresql-mysql/), you will find the credentials in your Scaleway console. Click **Test your database connection now!** to verify that the connection is successful. Once done, click **Next** to continue.
