...
This tutorial shows you how to create a documentation website using the Scaleway [Object Storage bucket website](/object/concepts/#bucket-website) feature with MkDocs.
...
## Set up MkDocs and configure your website
    ...
    ### Template of the mkdocs.yaml file
      ...
      1. [Create an Object Storage bucket](/object/how-to/create-a-bucket/) from the [Scaleway console](https://console.scaleway.com/).
      2. [Enable](/object/how-to/use-bucket-website/) the bucket website feature on your bucket.
