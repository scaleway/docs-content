...
5. Click the **ACLs** tab.
  ...
  If you have any existing ACLs they are listed here, otherwise you see a splashscreen.

6. Click **Create an ACL**. The ACL creation wizard displays.
...
7. Confirm the action by clicking **Delete this ACL**.
