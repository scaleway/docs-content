...
If you have installed your Mac mini with an alternative OS (Ashai Linux), no minimum commitment is required.
...
When you rent a Mac mini, it comes with a bare environment. The pre-installed tools on MacOS include:
...
If you install your Mac mini with an alternative OS (Ashai Linux), only SSH for access is preinstalled.
...
<Message type="important">
  Switching between OS families during reinstallation is not supported.
  You cannot reinstall macOS over Asahi Linux, or Asahi Linux over macOS.
</Message>
