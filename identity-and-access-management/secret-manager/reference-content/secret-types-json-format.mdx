...
You can create the other following secret types using Secret Manager:

- **Opaque**: This is the default type, where the content is not restricted to any specific format. You can store any arbitrary data in an opaque secret.
...
| Certificate          | certificate          | `{"certificate": "-----BEGIN CERTIFICATE-----\n...\n-----END CERTIFICATE-----", "private_key": "-----BEGIN PRIVATE KEY-----\n...\n-----END PRIVATE KEY-----"}`                   |
