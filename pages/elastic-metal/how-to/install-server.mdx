...
<Message type="note">
  Custom installations on B130E, B230E, B330E, and B430E Elastic Metal servers must be performed using [rescue mode](/dedibox-scaleway/how-to/use-rescue-mode/), as these servers do not provide KVM‑over‑IP console access.
</Message>