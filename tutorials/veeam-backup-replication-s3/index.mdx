...
9. Click **Add** (1) to enter the [API key](/iam/credentials/create-api-keys/) (2) related to the bucket. Optionally a description can be provided:
...
- make sure that you have the `ObjectStorageFullAccess` [IAM permission](/iam/concepts/glossary/#permission).
