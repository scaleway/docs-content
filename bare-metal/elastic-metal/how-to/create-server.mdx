...
3. Complete the following steps of the wizard:
    - Choose an **Availability Zone**, which is the geographical region where your Elastic Metal server will be deployed.
      <Message type="note">
        Currently, Elastic Metal servers are available in Amsterdam, Netherlands (`nl-ams-1` and `nl-ams-2`), Paris, France (`fr-par-1` and `fr-par-2`), and Warsaw, Poland (`pl-waw-2` and `pl-waw-3`).
      </Message>
