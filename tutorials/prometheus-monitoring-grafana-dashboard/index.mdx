...
You are now ready to create your first dashboard from the information collected by Prometheus. You can also import some dashboards from a collection of [shared dashboards](https://grafana.com/grafana/dashboards/?dataSource=prometheus).
