...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/hardware/reference-content/dell-idrac9/">How to use DELL iDRAC 9</PreviousButton>
  <NextButton to="/bare-metal/hardware/reference-content/quanta-computer/">How to use the Quanta Computer KVM</NextButton>
</Navigation>