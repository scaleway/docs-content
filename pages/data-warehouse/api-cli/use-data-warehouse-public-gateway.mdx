...
4. In a second terminal, run the command below in the folder where you stored the certificate (assuming it is named `certificate.pem`) to create a `clickhouse-client.xml` config file. Make sure to add the password to log in to your deployment:
