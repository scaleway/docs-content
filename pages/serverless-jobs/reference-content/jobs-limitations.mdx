...
**Not available:** Serverless products are designed to abstract away infrastructure management, to be easily scalable, to be cost-efficient and simple. So dedicated IP are not supported for this product.
