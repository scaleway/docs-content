...
You should stop using v1alpha1, and switch to v1beta1. The old API (v1alpha1) will be retired on [TODO], and all resources still existing within it will be deleted.
...
See our [migration documentation](TODO) for full instructions and details. 
...
- For NATS: [Stream volume](TODO) (the number of messages sent * the message size) and [stream persistence](TODO) (the total amount of data stored * duration)
- For SQS: [Queue volume](TODO) (the number of messages sent * the message size)
