---
meta:
  title: Serverless Containers - Concepts
  description: This page explains all the concepts related to Containers Functions
content:
  h1: Concepts
  paragraph: This page explains all the concepts related to Containers Functions
...
A stateless application is a computer program, that does not save client data generated in one session for use in the next session with that client. All applications deployed on Serverless Containers are stateless. 
