...
If you have permission to apply a bucket policy, you can also edit it or delete it using the [Scaleway console](https://account.scaleway.com/?service=elements).
