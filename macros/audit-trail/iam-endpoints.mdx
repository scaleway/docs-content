...
<Accordion>
  ...
  ### IAM supported endpoints
    ...
    - AddSamlCertificate (`POST /iam/v1alpha1/`)
    - CreateJWT (`POST /iam/v1alpha1/`)
    - DeleteJWT (`DELETE /iam/v1alpha1/`)
    - DeleteSaml (`DELETE /iam/v1alpha1/`)
    - DeleteSamlCertificate (`DELETE /iam/v1alpha1/`)
    - EnableOrganizationSaml (``)
    - UpdateSaml (`PATCH /iam/v1alpha1/`)
</Accordion>