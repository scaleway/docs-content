...
* `smartd`, a daemon allows you to periodically check your hard drives
...
However, we strongly encourage you to backup and request a replacement rapidly.
...
If you notice any errors when running a SMART diagnosis on your disk, open a [support ticket](/console/my-account/how-to/open-a-support-ticket/) and ask for the replacement of the disk, indicating the serial number with the result of the `smartctl` command:
