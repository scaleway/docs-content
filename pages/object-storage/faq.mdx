...
Yes. Scaleway Object Storage provides `read-after-write` consistency for `PUT` and `DELETE` requests of objects in buckets in all regions. This applies to writes of new objects as well as requests overwriting existing objects and to DELETEEs.
