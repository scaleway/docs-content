...
The Scaleway Go SDK is a tool provided by Scaleway for developers to interact with its services programmatically. 
It allows for the automation of tasks like server management, storage operations, and networking setup through Go scripts, handling the complexities of direct API calls and authentication behind simple Go function calls. 
...
You can install the SDK by using the following command: 
...
<Message type="note">
  This library is made to work with Go 3.8 but should work on the latest versions too.
</Message>
...
For further information about the Scaleway Go SDK, refer to the [offical SDK repository](https://github.com/scaleway/scaleway-sdk-go) on GitHub and the official [Go documentation](https://pkg.go.dev/github.com/scaleway/scaleway-sdk-go). 