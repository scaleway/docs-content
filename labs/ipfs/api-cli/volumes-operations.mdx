...
You can leverage our IPFS pinning service to store permanently your data on the public IPFS network. You can do it via a Content-ID (CID) or a web URL. You can [create](/labs/ipfs/api-cli/volumes-operations) and manage your volume and pins via the [Scaleway Command Line Interface](https://github.com/scaleway/scaleway-cli).
