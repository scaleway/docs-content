...
Refer to our dedicated [PostgreSQL extensions reference page](/managed-databases-for-postgresql-and-mysql/reference-content/postgresql-extensions) for a list of all available extensions and more details about each one.
