...
Domains with the following extensions from [BookMyName](https://www.bookmyname.com/) or [Online](https://console.online.net/en/login) cannot be transferred to Scaleway:
