...
**Going further** <br /><br />
  ...
  If you have not set up any agent yet, check out our [documentation](/observability/cockpit/api-cli/configuring-grafana-agent/) to find out how to configure the Grafana agent, push your data and visualize it in Grafana.
