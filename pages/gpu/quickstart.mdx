...
4. Follow these steps to configure your GPU Instance:
    ...
    - **Image**: Pick an GPU OS image suitable for your GPU Instance. For example, select **Ubuntu Noble GPU OS 13 (Nvidia)**, which comes with preinstalled NVIDIA drivers and an NVIDIA Docker environment. You can customize your working environment using Docker with our provided Docker images or your own containers.
