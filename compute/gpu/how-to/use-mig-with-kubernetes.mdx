...
<Message type="important">
  ...
  * To avoid confusion, we will use the term GPU Instance in this document to refer to the Scaleway GPU Instance, and *"MIG partition"* in the context of the MIG feature.
</Message>
...
<Message type="tip">
    MIG is fully supported on [Scaleway managed Kubernetes](/containers/kubernetes/quickstart/) clusters (Kapsule and Kosmos).
</Message>

<Message type="requirement">
  - You have an account and are logged into the [Scaleway console](https://console.scaleway.com)
  - You have created a [Kubernetes cluster](/containers/kubernetes/reference-content/introduction-to-kubernetes/) with a [GPU Instance](https://www.scaleway.com/en/gpu-instances/) as node
</Message>
...
3. Display the logs of the pods. The pods print their UUID with the `nvidia-smi` command:
    ...
    MIG 1g.10gb     Device  0: (UUID: MIG-fdfd2afa-5cbd-5d1d-b1ae-6f0e13cc0ff8)
    ```
    As you can see, seven pods have been executed on different MIG partitions, while the eighth pod had to wait for one of the seven MIG partitions to become available in order to be executed.
