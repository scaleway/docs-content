...
## Installing the LAMP stack on a Ubuntu 22.04 Instance
...
5. If you decide to change the root password, enter the new password and press `Enter`, then repeat this step.
...
Nginx stores the configuration of virtual hosts configuration files. All available configuration files are located in the `/etc/apache2/sites-available/` directory.
...
<Lightbox src="scaleway-lamp81.webp" alt="" />
