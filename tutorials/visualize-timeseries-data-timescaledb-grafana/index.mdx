...
1. Connect to the Scaleway Console and click the **Databases** section.
...
12. Enter the credentials of your Database Instance:
  ...
  <Lightbox src="scaleway-grafana_db.webp" alt="" />
    ...
    - **Databases**: The name of the database (for example `airquality`)
