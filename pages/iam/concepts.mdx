...
import image2 from './assets/scaleway-iam-owners-guests.webp'
import image3 from './assets/scaleway-iam-organization.webp'
import image4 from './assets/scaleway-iam-concepts.webp'
import image5 from './assets/scaleway-iam-policy-example.webp'
