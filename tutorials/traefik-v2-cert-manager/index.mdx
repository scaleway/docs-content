...
1. Log into the [Scaleway console](https://account.scaleway.com/?service=elements) and navigate to the **Kubernetes** section under **Containers**.
...
3. Create a wildcard DNS entry (`*.mytest.com`) pointing to this IP address.
    ...
    - Using Scaleway’s Domains and DNS product:
        1. Navigate to the [Domains and DNS product](https://account.scaleway.com/?service=elementsdomains/external/).
