...
Scaleway's AI services implement data processing practices and security measures to ensure customer data privacy and integrity. Below is an overview of these practices:

### Data processed by Managed Inference

- **Input Data**: Scaleway processes input data, including prompts and parameters provided by the customer, to generate the requested content.
- **Metadata**: Scaleway processes metadata associated with the use of Scaleway-owned interfaces, such as the console and CLI, to enhance service performance and improve the overall customer experience.
...
- **Service control and hosting**: Scaleway maintains full control over the Managed Inference service, hosting the LLMs on its infrastructure in Europe without any interaction with third-party services.
