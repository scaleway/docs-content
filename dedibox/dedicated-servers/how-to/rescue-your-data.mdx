...
You can recover your data either by transferring them to the [Dedibackup](https://www.scaleway.com/en/dedibox/storage/dedibackup/) storage space or by downloading it directly to your local computer using the SFTP protocol.

<Message type="important">

Be careful when editing your data, the `root` user has full permissions on each file and can perform actions like irreversible deletion of data.

</Message>

###  How to resuce your data using Dedibackup

Following you find information how to retrieve **all** the contents of your disk (including all partitions) on your [Dedibackup](https://www.scaleway.com/en/dedibox/storage/dedibackup/) storage space.
