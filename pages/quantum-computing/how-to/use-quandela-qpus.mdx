...
<Message type="tip">
**Manage a session using a context manager**

You can use `with scw.Session(...) as session` to automatically handle starting and stopping a session, ensuring you do not forget to stop it.
</Message>
