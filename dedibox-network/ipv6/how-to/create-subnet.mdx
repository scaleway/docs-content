...
You can split your IPv6 prefix into several subnets and use them on your Dedibox servers both in Paris and Amsterdam. Each subnet has its own [DUID](/ipv6/concepts/#duid) and can be configured individually.
