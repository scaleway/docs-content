...
NATS (**N**eural **A**utonomic **T**ransport **S**ystem) is a messaging system that aims to provide high performance while being scalable and remaining simple to use. It implements a [publish/subscribe](/nats/concepts/#publishsubscribe) model as well as adding a [streaming](/nats/concepts/#stream) service via [JetStream](https://docs.nats.io/nats-concepts/jetstream). 
