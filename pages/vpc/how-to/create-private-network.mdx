...
3. Click **+ Create Private Network**. The creation screen displays.
    ...
    <Lightbox src={image} alt="A screen of the Scaleway console, showing the steps to create a Private Network: Enter a name, check the region, enter tags and (optionally) expand the Advanced Settings section" />
...
1. Follow the steps [above](#how-to-create-a-private-network) to create a Private Network, and at step 5, click **Advanced Settings**.
    ...
    <Lightbox src={image2} alt="The Advanced Settings section of the Create a Private Network screen in the Scaleway console. It shows the options to automatically generate a CIDR block for the subnet, or define your own." />

2. Click **Define custom**. The following screen displays:

    <Lightbox src={image3} alt="The Advanced Settings section of the Create a Private Network screen in the Scaleway console. The user is prompted to enter a prefix and a network size." />
