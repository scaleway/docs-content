...
- A [Serverless Functions namespace](/functions/how-to/create-manage-delete-functions-namespace/)
- A text editor/IDE (such as `vi` or [Visual Studio Code](https://code.visualstudio.com/))
- Knowledge of [how to package your functions and their dependencies](/functions/how-to/package-function-dependencies-in-zip/)
...
Refer to our guide on [code packaging](/functions/how-to/package-function-dependencies-in-zip/) if you want to use requests.
...
```
<Message type="note">
  To use other libraries like `request`, you need to upload your project [with advanced methods](/functions/reference-content/deploy-function/) (recommended)
  or [use a ZIP file](/functions/how-to/package-function-dependencies-in-zip/).
</Message>
...
Refer to our guide on [code packaging](/functions/how-to/package-function-dependencies-in-zip/), if you want to use `fetch`, `axios`, ...
