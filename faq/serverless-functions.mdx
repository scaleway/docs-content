...
Build errors are sent to observability platform on Cockpit, you need to [Activate your Cockpit](observability/cockpit/how-to/activate-cockpit/) to read build logs.

Then in the `Serverless Functions Logs` dashboard you can read informations about your log build outputs if errors occured during compilation.