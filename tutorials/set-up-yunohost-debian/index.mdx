...
content:
  h1: Setting up Yunohost on Debian 9
...
categories:
  - compute
  - instances
tags: compute hosting Yunohost server administration Debian-9
...
- You have an Instance running on Debian 9 (Stretch)
...
1. Connect to the Instance via [SSH](https://www.scaleway.com/docs/create-and-connect-to-your-server/#-Logging-into-the-Instance).
