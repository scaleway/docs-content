...
- [Created a target Managed Database for PostgreSQL](/postgresql-and-mysql/how-to/create-a-database/) to import your data into.
...
4. Enter the database password you defined upon [Database Instance creation](/postgresql-and-mysql/how-to/create-a-database/) when prompted.
...
1. Register your new database in pgAdmin. Refer to the [How to connect to a Managed Database for PostgreSQL](/postgresql-and-mysql/how-to/connect-database-instance/) documentation page for more information.
...
<Message type="important">
This procedure does not currently work with Managed Databases for PostgreSQL. However, you can import your backup using [Managed Database for PostgreSQL and MySQL](/postgresql-and-mysql/).
</Message>
