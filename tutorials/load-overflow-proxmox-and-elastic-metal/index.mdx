...
<Message type="requirement">
  ...
  - You have [configured your SSH key](/console/my-project/how-to/create-ssh-key)  - You have [two Elastic Metal servers](/compute/instances/how-to/create-an-instance) that run on Proxmox
