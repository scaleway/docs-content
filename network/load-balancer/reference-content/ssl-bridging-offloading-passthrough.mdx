...
If you want to configure your Load Balancer for SSL offloading using the API, see our [dedicated guide](/network/load-balancer/api-cli/setting-up-ssl-offloading/).
