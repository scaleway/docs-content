...
- delete the current bucket policy using the command below. The bucket will become available to every user with [IAM permissions](/iam/concepts/glossary/#permission).
    ```
