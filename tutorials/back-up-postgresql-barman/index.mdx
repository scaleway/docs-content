...
Barman is an open-source administration tool for disaster recovery of PostgreSQL servers. It is written in Python and allows you to perform remote backups of multiple servers in business-critical environments.
...
It is possible to run Barman automatically to back up the content of your database regularly. This can be done easily by setting up a CronJob on `pgsql-backup`.
