...
<Message type="note">
  This datasheet contains detailed information about the latest generations of Dedibox servers. You can find a complete listing of all Dedibox offers in the [Dedibox console - Server offers](https://console.online.net/en/order/server).
</Message>
