...
A `.kubeconfig` has been generated during your cluster's creation. Download this file to manage your Kubernetes Kapsule cluster using the `kubectl` command-line tool from your local computer.

1. Download your `.kubeconfig` file by clicking on **Download file** on the cluster's information page:
