...
Enable [Scalerway Cockpit](/observability/cockpit/quickstart/) to access detailed and in-depth monitoring and logs to identify potential bottlenecks in your Object Storage deployment.
...
Throughput is limited at the bucket level to guarantee the security and stability of Scaleway’s Object storage infrastructure. If you notice recurring rate limit errors (error 429) in your [Cockpit](/observability/cockpit/quickstart/) logs, [contact Scaleway’s support](/console/account/how-to/open-a-support-ticket/) to unlock the threshold for your Organization.
