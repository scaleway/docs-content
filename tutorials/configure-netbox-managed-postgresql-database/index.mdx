...
NetBox requires a PostgreSQL database. Configure your [Database for PostgreSQL](https://www.scaleway.com/en/managed-postgresql-mysql/) with a few steps from your [Scaleway console](https://console.scaleway.com/rdb/instances)
...
The configuration file shipped with the NetBox application works for most setups, however, if you need some specific settings, refer to the [gunicorn documentation](https://gunicorn.org/configure/).
