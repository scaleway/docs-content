...
excerpt: |
  This page explains how to add frontends and backends
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
...
To learn more about Frontends and Backends, refer to the [Load Balancer concepts page.](/network/load-balancer/concepts)
