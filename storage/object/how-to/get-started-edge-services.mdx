...
8. Provide an SSL/TS certificate for your subdomain so that it can serve traffic over HTTPS. You have three options for this:
    - Generate a free Let's Encrypt certificate, managed by Scaleway include automatic renewals.
...
6. TODO check console behaviour Select a different certificate from Secret Manager, or manually import a new certificate for your custom domain.
...
4. In the **Disable Edge Services** panel at the bottom of the screen, click **Disable Edge Services**.
    ...
    TODO what happens to Let's Encrypt certificates?
    </Message>
