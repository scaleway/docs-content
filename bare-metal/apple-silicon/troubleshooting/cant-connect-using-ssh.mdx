---
meta:
  title: I can not connect to my Mac mini using my SSH key
  description: This page explains how to resolve SSH connection issues with Mac mini
content:
  h1: I can not connect to my Mac mini using my SSH key
  paragraph: This page explains how to resolve SSH connection issues with Mac mini
...
4. Click **Reboot Mac mini** to confirm. The Mac mini reboots and your SSH key will be uploaded during the boot process.