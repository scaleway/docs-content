...
totalTime: PT15M
steps:
  - step: Downloading and Installing Vegeta
    type: HowToStep
    url: https://www.scaleway.com/en/docs/vegeta-load-testing/#-Downloading-and-Installing-Vegeta
  - step: Running a Load Test with Vegeta
    type: HowToStep
    url: https://www.scaleway.com/en/docs/vegeta-load-testing/#-Running-a-Load-Test-with-Vegeta
  - step: Setting up a Target File
    type: HowToStep
    url: https://www.scaleway.com/en/docs/vegeta-load-testing/#-Setting-up-a-Target-File
  - step: Generating a Report
    type: HowToStep
    url: https://www.scaleway.com/en/docs/vegeta-load-testing/#-Generating-a-Report
categories:
  - compute
brands:
  - elements
image: /assets/images/docs/scaleway.png
permalink: docs/vegeta-load-testing/
...
Load testing allows testing the behavior of an application under real conditions by simulating concurrent user requests. This can help to determine the behavior of an application when multiple users access it simultaneously. This tutorial shows how to use [Vegeta](https://github.com/tsenart/vegeta), an open-source application written in the [Go programming language](docs/tutorials/install-golang-ubuntu-bionic), to run load testings on an application.
...
2. [Download](https://github.com/tsenart/vegeta/releases) the latest Vegeta binary:
...
3. Open the HTML file in a web browser to view the plot:
  ...
  <Lightbox src="scaleway-vegeta-plot.png" alt="" />
