...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/network/reference-content/">Configuring the network of a virtual machine</PreviousButton>
  <NextButton to="/bare-metal/network/reference-content/subscribe-to-jmrp/">How to subscribe to JMRP</NextButton>
</Navigation>