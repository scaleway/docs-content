...
Scaleway Serverless SQL Databases are fully managed databases that automatically scale both in storage and compute according to your needs.
...
1. From the **Overview** tab of your database, click the **Set up credentials** button. The wizard displays.
...
An ouptut similar to the following response displays:
