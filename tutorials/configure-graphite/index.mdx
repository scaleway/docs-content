---
title: Installing and Configuring Graphite on Ubuntu 16.04
description: This tutorial explains how to install and configure Graphite on Ubuntu 16.04
tags: monitoring graphite analytics
excerpt: |
  ...
  - Providing an interface for basic visualization of the stored data and the possibility to use mathematical functions to sum, group or scale stored data in realtime.
totalTime: PT30M
steps:
  - step: Installing Graphite
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-graphite/#-Installing-Graphite
  - step: Configuring the Graphite Web Application
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-graphite/#-Configuring-the-Graphite-Web-Application
  - step: Configuring Carbon
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-graphite/#-Configuring-Carbon
  - step: Configuring Storage Schemas
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-graphite/#-Configuring-Storage-Schemas
  - step: Defining Storage Aggregation Methods
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-graphite/#-Defining-Storage-Aggregation-Methods
  - step: Installing and Configuring Apache
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-graphite/#-Installing-and-Configuring-Apache
  - step: Discovering the Web Interface
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-graphite/#-Discovering-the-Web-Interface
  - step: Feeding Data to Graphite
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/configure-graphite/#-Feeding-Data-to-Graphite
categories:
  - compute
  - kapsule
  - instance-dev
...
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, scalability, ARM, physical server, dedicated server, server, network, metrics, monitroing, graphite
dates:
...
6. Check if the web interface is working by pointing your browser to `http://YOUR_SERVERS_IP`. The following interface will be visible:
  ...
  <Lightbox src="scaleway-graphite-interface.png" alt="" />
...
2. You will notice a menu on the left of the Screen. Click **carbon** to see the metrics that are collected by Graphite. Currently, you will only see the data the application is gathering about its performance:
  ...
  <Lightbox src="scaleway-graphite-metrics.png" alt="" />
...
3. It is also possible to create dashboards from the data Graphite collects to have an overview over the different metrics:
  ...
  <Lightbox src="scaleway-graphite-dashboard.png" alt="" />
...
4. Set the time range to a few minutes, by clicking on the _clock-icon_:
   ...
   <Lightbox src="scaleway-graphite-timerange.png" alt="" />

5. The values that you have sent will appear in the graph:

  <Lightbox src="scaleway-graphite-testcount.png" alt="" />
...
6. Wait for 15 minutes and refresh the graph by setting the time frame to the past 15 minutes. The graph will look different:
  ...
  <Lightbox src="scaleway-graphite-testcount2.png" alt="" />
