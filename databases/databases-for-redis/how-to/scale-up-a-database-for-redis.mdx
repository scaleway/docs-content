...
- You have an account and are logged into the [Scaleway console](https://console.scaleway.com)
- You have a [Redis™ Database Instance](/databases/databases-for-redis/how-to/create-a-database-for-redis) Instance in [cluster mode](/concepts/#cluster-mode)
...
<Navigation title="See Also">
  ...
  <NextButton to="/databases/databases-for-redis/how-to/configure-advanced-settings-redis">How to configure advanced settings</NextButton>
</Navigation>