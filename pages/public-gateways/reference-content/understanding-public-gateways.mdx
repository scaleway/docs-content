...
Public Gateways are available in multiple different Availability Zones. For the most up-to-date information, check out the [Scaleway console](https://console.scaleway.com/public-gateway/public-gateways/create) or see [Product availability by region](https://www.scaleway.com/en/product-availability-by-region/).
...
- Throughput is capped at approximately 100,000 packets per second, regardless of the Public Gateway bandwidth. Workloads with a high rate of small packets (such as ping commands) are therefore more likely to hit this limit than larger transfers.
...
- [Public Gateways Quickstart](/public-gateways/quickstart/) - Learn how to set up and configure your Public Gateway via the Scaleway console.
...
- [Public Gateways Troubleshooting](/public-gateways/troubleshooting/) - Solve any problems you run into with the Public Gateway with our troubleshooting guides.
- [Public Gateways FAQ](/public-gateways/faq/) - Get answers to the most frequently asked questions about the Public Gateway.