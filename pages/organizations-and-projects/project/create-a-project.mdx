...
If you have a [Scaleway account](/account/setup-lifecycle/create-an-account/), and subsequently an [Organization](/iam/concepts/glossary/#organization), you will also automatically have a [default Project](/organizations-and-projects/concepts/glossary/#default-project), that contains all your existing [resources](/iam/concepts/glossary/#resource). You can also create additional Projects, allowing you to group your resources.
