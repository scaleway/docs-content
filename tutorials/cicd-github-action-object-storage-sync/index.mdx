...
You can now access your website by clicking the **Website URL** from the **Settings** tab of your bucket in the [Scaleway console](https://account.scaleway.com/?service=elementsobject-storage/buckets).
