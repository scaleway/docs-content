...
- Make sure there is no [bucket policy](/object/concepts/#bucket-policy) that prevents you from deleting the bucket.

- If there is a bucket policy, make sure that it [explicitly allows you](/object/api-cli/bucket-policy/) to perform the desired action.
...
- Refer to the documentation on [how to delete a bucket](/object/how-to/delete-a-bucket/) for more information.
