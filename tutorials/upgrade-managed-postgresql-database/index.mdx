...
1. Open the [Scaleway console](https://account.scaleway.com/?service=elements) in a web browser and click **Managed Databases** in the **Storage** section of the side menu. The list of your databases displays.
2. Click **+ Create a Database Instance**. The [Database Instance creation wizard](https://account.scaleway.com/?service=elementsrdb/instances/create) displays.
