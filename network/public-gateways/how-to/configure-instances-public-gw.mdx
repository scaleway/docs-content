...
tags: public-gateway public gateway auto-configuration 
dates:
...
This page explains how to configure [Instances](/compute/instances/concepts/#instance) plugged into a [Private Network](/network/public-gateways/concepts/#private-networks) attached to a [Public Gateway](/network/public-gateways/concepts/#public-gateway).
...
<Message type="requirement">
  ...
  - Your Instance(s) is/are [attached to a Private Network](/compute/instances/how-to/use-private-networks/#how-to-attach-instances-to-a-private-network) which is [attached to a Public Gateway](/network/public-gateways/how-to/configure-a-public-gateway#how-to-attach-a-public-gateway-to-a-private-network)
</Message>
...
<Message type="tip">
  ...
  See our [Limitations](/network/public-gateways/ic-gateways/troubleshooting/gw-limitations/) and [Troubleshooting](/network/public-gateways/troubleshooting/) documentation for further help.
</Message>
...
See our [Public Gateways troubleshooting documentation](/network/public-gateways/troubleshooting/)
...
<Navigation title="See Also">
  ...
  <NextButton to="/network/public-gateways/ic-gateways/how-to/use-ssh-bastion/">How to use SSH bastion</NextButton>
</Navigation>
