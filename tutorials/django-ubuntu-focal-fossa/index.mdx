...
steps:
  - step: Installing Django on Ubuntu with pip in a Virtual environment
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/django-ubuntu-focal-fossa/#-Installing-Django-on-Ubuntu-with-pip-in-a-Virtual-Environment
  - step: Creating a Sample Project
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/django-ubuntu-focal-fossa/#-Creating-a-Sample-Project
  - step: Modifying Django Settings
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/django-ubuntu-focal-fossa/#-Modifying-Django-Settings
  - step: Testing the Development Server
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/django-ubuntu-focal-fossa/#-Testing-the-Development-Server
  - step: Going Further?
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/django-ubuntu-focal-fossa/#-Going-Further
categories:
  - compute
  - instances
...
7. Migrate the database (this example uses SQLite by default) using the `migrate` command with manage.py. Migrations apply any changes you have made to your Django models, to your database schema.
