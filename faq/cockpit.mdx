...
During the beta of the retention period edition feature, the retention period you set for your data (from [Scaleway resources integrated with Cockpit](/observability/cockpit/reference-content/cockpit-limitations/#product-integration-into-cockpit) and custom data) is free of charge.
