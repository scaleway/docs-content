...
If an object is [private](/object/how-to/manage-object-visibility/), you can create a temporary public link from the [Scaleway console](https://console.scaleway.com).
...
- [Created an Object Storage bucket](/object/how-to/create-a-bucket/) and have [uploaded objects](storage/object/how-to/upload-files-into-a-bucket/) to it
...
<Message type="note">
  To make the link to an object permanent, [change its visibility](/object/how-to/manage-object-visibility/) to **public**. The link will work as long as the object is public.
</Message>
