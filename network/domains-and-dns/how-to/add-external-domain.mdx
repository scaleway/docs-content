...
3. Enter the external domain name in the box and click the search icon to check if the domain exists. If the domain exists, the estimated cost to add it displays.
