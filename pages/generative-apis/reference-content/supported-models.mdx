...
| [qwen3.8-27b](#qwen38-27b)| Yes | Text, Code, Vision | 256k | [Apache 2.0](https://www.apache.org/licenses/LICENSE-2.0) |
...
A state-of-the-art small-sized dense model as of August 2026, optimized for agentic tasks and logical reasoning.
...
| Supported reasoning efforts | `none`, `low`, `medium`, `xhigh` |
...
| Hugging Face model card | [qwen3.8-27b](https://huggingface.co/Qwen/Qwen3.8-27B) |
