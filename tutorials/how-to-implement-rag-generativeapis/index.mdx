...
- An [Object Storage Bucket](/object/how-to/create-a-bucket/) to store all the data you want to inject into your LLM model.
- A [Managed Database](/postgresql-and-mysql/how-to/create-a-database/) to securely store all your embeddings.
...
- Stored the right credentials in your `.env` file allowing to connect to your [Managed Database Instance with admin rights](/postgresql-and-mysql/how-to/add-users/)
