...
content:
  ...
  paragraph: Learn how to set up frontends and backends with Scaleway Load Balancer. Step-by-step guide for configuring efficient network routing and load distribution.
...
1. Follow the steps for [creating a Load Balancer](/load-balancer/how-to/create-load-balancer/). At the last stage, click **Add frontend and backend**. The following screen displays, the first step inviting you to configure a frontend:
