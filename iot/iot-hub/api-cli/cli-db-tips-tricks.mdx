...
<Navigation title="See Also">
  <PreviousButton to="/iot/iot-hub/api-cli/iot-hub-routes/">Configuring IoT Hub routes</PreviousButton>
  <NextButton to="/iot/iot-hub/api-cli/migrating-from-api-v1/">Migrating from the IoT API v1</NextButton>
</Navigation>
