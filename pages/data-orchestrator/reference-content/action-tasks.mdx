...
<Tabs>
  <TabsTab label="Serverless Job">
    The following example shows a workflow calling one Serverless Job. You can copy Serverless Job IDs from the [Serverless Jobs page](https://console.scaleway.com/serverless-jobs/) of the console.
  ...
  <TabsTab label="Serverless Function">
    ...
    The following example shows how to get a Serverless Function. You can copy Serverless Function IDs from the [Serverless Functions page](https://console.scaleway.com/functions/) of the console.
  ...
  <TabsTab label="Serverless Container">
    ...
    The following example shows how to get a Serverless Container. You can copy Serverless Container IDs from the [Serverless Containers page](https://console.scaleway.com/containers/) of the console.
    <Message type="important">
...
<Tabs>
  <TabsTab label="Serverless Job">
    **Workflow definition properties**
    ...
    | `region`           | string | yes      | The region where the Serverless Job is deployed.<br /> Supported values: `fr-par`, `nl-ams`, `pl-waw`. |
  </TabsTab>
