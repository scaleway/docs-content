...
- You have created a [Database for PostgreSQL](/managed-database/postgresql-and-mysql/quickstart/)
...
1. Create a [database user](/managed-database/postgresql-and-mysql/how-to/add-users/) and [grant permissions](/databases/how-to/manage-permissions/) to the PostgreSQL database you want to use for umami. 
