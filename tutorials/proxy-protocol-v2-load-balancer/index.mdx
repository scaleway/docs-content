...
1. Add the two annotations below to your ingress controller `service`:
    - [`service.beta.kubernetes.io/scw-loadbalancer-proxy-protocol-v2: "true"`](/containers/kubernetes/api-cli/using-load-balancer-annotations/#service.beta.kubernetes.ioscw-loadbalancer-proxy-protocol-v2)
    - [`service.beta.kubernetes.io/scw-loadbalancer-use-hostname: "true"`](/containers/kubernetes/api-cli/using-load-balancer-annotations/#service.beta.kubernetes.ioscw-loadbalancer-use-hostname)
