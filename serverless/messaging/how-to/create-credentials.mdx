...
6. Click **Download** and save the file, before closing the window.
    ...
    You are returned to your NATs account's overview page. The name of your newly-generated credentials and their access level is displayed in the **Credentials** panem.
