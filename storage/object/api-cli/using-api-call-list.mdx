...
meta:
  ...
  description: Utilize the API call list effectively with Scaleway Object Storage.
content:
  h1: Object Storage API
  paragraph: Utilize the API call list effectively with Scaleway Object Storage.
