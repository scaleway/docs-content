...
This page shows you how to renew your Scaleway domain from the Scaleway console.
...
1. Click **Domains & DNS** in the **Domains & Web Hosting** section of the [Scaleway console](https://console.scaleway.com) side menu. The list of your domains displays.
