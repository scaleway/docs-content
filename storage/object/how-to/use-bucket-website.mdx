...
6. Click **Save configuration** to confirm. The details of your website configuration display. 
    ...
    You can now [upload the **index** and the **error** files](/storage/object/how-to/upload-files-into-a-bucket/) to your bucket, if you have not already done so, as well as the other files that make up your static website. 
