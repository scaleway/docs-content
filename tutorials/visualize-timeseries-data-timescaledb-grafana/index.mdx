...
excerpt: |
  This page shows how to configure the TimescaleDB extension on a Scaleway Database Instance, how to add, delete and query time-scale data and how to visualize it using Grafana
totalTime: PT30M
steps:
  - step: Creating a new database
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/visualize-timeseries-data-timescaledb-grafana/#creating-a-new-database
  - step: Enabling the TimescaleDB extension
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/visualize-timeseries-data-timescaledb-grafana/#Enabling-the-TimescaleDB-extension
  - step: Prepare the table for TimescaleDB
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/visualize-timeseries-data-timescaledb-grafana/#Prepare-the-table-for-TimescaleDB
  - step: Adding and removing data
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/visualize-timeseries-data-timescaledb-grafana/#Adding-and-removing-data
  - step: Querying data
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/visualize-timeseries-data-timescaledb-grafana/#Querying-data
  - step: Visualizing data with Grafana
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/visualize-timeseries-data-timescaledb-grafana/#Visualizing-data-with-Grafana
categories:
  - storage
brands:
  - elements
image: /assets/images/docs/scaleway.png
keywords: cloud tutorials, cloud documentations, cloud server, cloud hosting, ubuntu server, debian server, linux server, IAAS, scalability, cloud, cluster, clustering, postgresql, postgre, pgsql, postgres, managed service, managed, managed database, database hosting, hosted database, database, timescale, timescaledb, time-series data
dates:
...
[TimescaleDB](https://www.timescale.com/) is a time series database built on top of [PostgreSQL](/tutorials/install-postgresql/).  
...
2. Create a Hypertable from the previously create table:
  ...
  The command above converts the regular PostgreSQL table into a TimescaleDB [hypertable](https://docs.timescale.com/latest/introduction/architecture#hypertables).
...
To have a large dataset available we are going to use the [air quality data](https://dataratp2.opendatasoft.com/explore/dataset/qualite-de-lair-mesuree-dans-la-station-franklin-d-roosevelt/information/) from a parisian metro station. The data is provided by Paris' transport authority [RATP](https://dataratp2.opendatasoft.com/explore/?sort=modified)
...
For more information how to read data from your database, refer to the [Read Data documentation](https://docs.timescale.com/latest/using-timescaledb/reading-data) of TimescaleDB.
...
1. Create a new [virtual instance](https://www.scaleway.com/en/virtual-instances/) running on Ubuntu Bionic (18.04) from your [Scaleway console](https://console.scaleway.com/dashboard)

2. Log into the virtual instance [using SSH](/compute/instances/how-to/connect-to-instance/).
...
<Lightbox src="scaleway-grafana_login.png" alt="" />
...
<Lightbox src="scaleway-grafana_db.png" alt="" />
...
15. Download the [JSON configuration](https://tutorials.s3.fr-par.scw.cloud/dashboard.json) to query the database in Grafana.
