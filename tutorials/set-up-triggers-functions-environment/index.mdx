...
meta:
  ...
  description: This pages shows you how to set up your environment to transform images in an S3 bucket using Serverless Functions and Triggers
content:
  h1: Transforming images in an S3 bucket using Serverless Functions and Triggers - Set up
  paragraph: This pages shows you how to set up your environment to transform images in an S3 bucket using Serverless Functions and Triggers
categories:
  - serverless
...
This tutorial is the first of a series of two. You will learn how to set up your environment, [then how to create and deploy functions](/tutorials/create-deploy-serverless-functions/) to resize images stored in a bucket and push them to another bucket.
...
2. Click **+ Create Project** on the righthand side. A pop-up appears. 
...
Now, let's [create some functions](/tutorials/create-deploy-serverless-functions/).