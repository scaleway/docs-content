...
4. In the left-hand menu, right-click on the database you want to export, and select **Backup**.
...
4. In the left-hand menu, right-click on the name of your new database, then select **Restore**.
...
8. Click on **Restore**. The restore process starts, and you can follow its progress by clicking **View processes**.
