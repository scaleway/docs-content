...
<Message type="important">
    To use the ipfs command in the Scaleway CLI, set the SCW_ENABLE_LABS=true flag.
    It's advisable to export it as an environment variable, so you don't have to set it for every command.
</Message>
