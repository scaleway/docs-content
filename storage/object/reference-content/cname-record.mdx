---
meta:
  title: CNAME records for Object Storage with Edge Services
  description: Learn how to create a CNAME record for your customized Edge Services domain, and troubleshoot any potential problems.
content:
  h1: CNAME records for Object Storage with Edge Services
  paragraph: Learn how to create a CNAME record for your customized Edge Services domain, and troubleshoot any potential problems.
tags: object-storage edge-services cname dns
categories: 
  - storage
---

This document contains information to help you successfully create a CNAME record for your customized [Edge Services](/storage/object/how-to/get-started-edge-services) domain, and troubleshoot any potential problems.
