...
2. Click **Delete application**. A warning displays, asking you to confirm your action:
    <Lightbox src={image3} alt="A pop up box displaying a warning: Warning: This will permanently delete your application. This action is irreversible and will automatically delete the application's API keys." />
