...
content:
  h1: Sending emails with Transactional Email and Serverless using Terraform/OpenTofu
  paragraph: Discover how to send emails with Scaleway's Transactional Email and Serverless using Terraform/OpenTofu
