...
description: TOLearn how to securely validate webhook signatures from Scaleway Topics and Events using certificate trust chains and handle certificate rotations properly.DO
tags: messaging sns webooks certificates signingcerturl
dates:
