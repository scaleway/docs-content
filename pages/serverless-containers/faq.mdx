...
Due to the nature of serverless computing, Serverless Containers not have dedicated or predictable IP addresses assigned to them. This means you cannot whitelist specific IPs for your Serverless Containers.

Instead, you need to allow all Scaleway IP address prefixes in your external services or firewalls. You can find the complete list of Scaleway IP prefixes at: https://www.scaleway.com/en/peering/
