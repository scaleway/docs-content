...
Data is **public**: our IPFS nodes are bootstrapped with public IPFS nodes. This imply that any pinned content will be **available on the public IPFS network**.

Data is **shared**: public IPFS nodes can fetch and host your pinned content. Your data could be hosted **anywhere** (France, Europe, America, the Moon...). Scaleway won't be enable to delete once a content is delivered to external peers.
