...
3. Check the boxes to select all users that appear to have MFA disabled.
4. Click <Icon name="more" /> > **Send MFA reminder** to do so.
    An email is sent to each user requesting that they enable MFA.
