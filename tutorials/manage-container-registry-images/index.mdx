...
8. Type in the following code into the online code editor: 
...
9. Choose a **name** for your function, and **optionally** a description. The name must only contain alphanumeric characters.
...
14. Click **Advanced options** and add a CRON Job Triggers (in Advanced Option) to specify the frequency you want to execute the Function 
