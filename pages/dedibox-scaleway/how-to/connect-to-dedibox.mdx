...
- [Created and uploaded your SSH key](/iam/security/create-ssh-key/)
...
5. Click the **Browse** button and select the private key file you [generated previously](/iam/security/create-ssh-key/).
