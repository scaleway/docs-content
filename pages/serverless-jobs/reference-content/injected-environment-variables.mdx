...
To display a variable, you can create a Job with the image `alpine:latest`, set the command to `"/bin/sh" "-c"`, and the arguments to `"echo $SCW_SLS_IMAGE"`. This will display the image information with digest in the Logs.
