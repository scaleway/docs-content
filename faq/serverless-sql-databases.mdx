...
## How and when are automated backups performed?

Your database is backuped every day, at the same hour your database was initially created. Backup operations are seamless and will not impact your database performance.