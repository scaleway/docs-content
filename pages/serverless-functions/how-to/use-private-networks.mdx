...
content:
  h1: How to use Private Networks with your Serverless Functions
  paragraph: This page explains how to use Private Networks for Scaleway Serverless Functions
...
## How to detach a function from a Private 