...
<Navigation title="See Also">
  <PreviousButton to="/dedibox-console/account/how-to/upload-an-ssh-key/">How to upload an SSH key</PreviousButton>
  <NextButton to="/dedibox-console/account/how-to/outsource-failover-ip/">How to outsource a failover IP</NextButton>
</Navigation>