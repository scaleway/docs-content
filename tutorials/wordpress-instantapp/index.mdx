...
When defining the `weblog_title` tag on the console, it is not possible to have spaces in the title of the weblog. This is only feasible when using the CLI. Refer to our tutorial on [creating a Wordpress Instance using the Scaleway CLI](/) 
