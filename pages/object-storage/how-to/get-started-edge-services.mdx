...
Once you have created an Edge Services for your bucket, you can access your bucket and its content via its original Object Storage endpoint, and via its new customizable Edge Storage endpoint. Get full details in the [Edge Services](/edge-services/how-to/create-pipeline/#how-to-access-your-bucket-via-edge-services) section of the documentation.
