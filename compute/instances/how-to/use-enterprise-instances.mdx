...
- When configuring your **Block Storage** volumes, bear in mind the following:
  ...
  - If several block volumes are attached to your Enterprise Instance, you must select on to be the system volume. This is the volume where your OS will be stored and from which your Instance will boot.
