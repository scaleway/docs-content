...
You can find information about the Instances quotas allocated to your account at the following link: [Understanding account quotas](/console/my-account/reference-content/organization-quotas/).
