...
3. If / when prompted, allow connection to the host by typing `yes`, then press **Enter**.
    ...
    <Message type="tip">
    If you're new to using the Linux shell, check out our dedicated tutorial to help you take your [first steps with the Linux command line](/tutorials/first-steps-linux-command-line/).
    </Message>
