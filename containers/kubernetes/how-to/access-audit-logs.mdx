...
If you upgrade your from a mutualized control plane to a dedicated one, audit logging will be enabled automatically for your cluster.
...
## How to access cluster audit logs for clusters having a dedicated control plance.

You can access your clusters audit logs in [Cockpit](/observability/cockpit/), Scaleway's monitoring solution. It allows you to visualize your metrics, logs, and traces in your Grafana dashboard.
...
At present, audit logging is only available for clusters using a [dedicated control plane](https://www.scaleway.com/en/kubernetes-dedicated-control-plane/). 
