...
The DNS service also resolves the following formats, which include the target VPC name or ID. These formats are required to resolve a resource across a [VPC Peering](/vpc-peering/concepts/) connection.
