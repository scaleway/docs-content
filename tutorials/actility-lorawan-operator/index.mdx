...
Explore [Scaleway IoT Hub](/managed-services/iot-hub/concepts) further, learn how to [add Devices to the hub](/managed-services/iot-hub/how-to/add-device), and review [IoT Hub metrics](/managed-services/iot-hub/how-to/view-metrics).
