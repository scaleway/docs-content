...
In the [previous tutorial](/tutorials/set-up-triggers-functions-environment/), you learned how to set up your environment to use Serverless Functions with triggers in order to resize images from a bucket and push them to another one.
