...
For a complete list of supported locations, see [Product availability by region](https://www.scaleway.com/en/product-availability-by-region/?categories=bare-metal).
...
You can choose between hourly or monthly billing for your servers.
...
If you need a powerful server on a frequent and continual basis, you may find that monthly billing is more suitable for you. In this case, you will benefit from a more advantageous price while still getting full integration with our public cloud to manage sporadic exceptional workloads or peak periods.

<Message type="important">
  You can [change the billing method from hourly to monthly](/elastic-metal/how-to/change-billing-period/) once. However, to switch from monthly to hourly billing, you must [create](/elastic-metal/how-to/create-server/) and [reinstall](/elastic-metal/how-to/reinstall-server/) a new Elastic Metal server.
</Message>

### What is the loyalty reward, and how do I use it?

<Message type="important">
  The loyalty voucher, which helps offset the commitment fee, is no longer available for new subscriptions as of **1 April 2026**.
...
The loyalty reward voucher is valid for six months and automatically added to your Scaleway account. [Learn more about how to get and use a loyalty reward](/elastic-metal/how-to/get-use-loyalty-reward/).
...
A Windows Server license is available in two versions, Standard and Datacenter, each at a different price. The availability of certain features, such as roles, depends on the version you choose.
