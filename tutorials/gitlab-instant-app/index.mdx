...
GitLab is a web-based manager for Git repositories that offers a variety of functionalities, such as code reviews, wikis and issue tracking.

Scaleway offers a GitLab image based on Ubuntu 22.04 LTS (Jammy Jellyfish) and incorporates GitLab 16.3.3. By default, this image supports [routed IPs](/compute/instances/api-cli/using-routed-ips/).
