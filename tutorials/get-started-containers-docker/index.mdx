...
3. Log in to your Container Registry namespace:
    ...
    <Message type="tip">
      Ensure that you replace `<address-of-your-namespace>` with the address of your own Container Registry namespace (eg `rg.fr-par.scw.cloud/mynamespace`) and that you have [created your API key](/console/my-project/how-to/generate-api-key/) and that you have saved the secret part of your API key as an environment variable e.g. with the command `export SCW_SECRET_TOKEN=a4db08b7-5723-4ba9-8c18-f2de493465a2`
    </Message>
