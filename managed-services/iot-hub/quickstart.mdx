...
5. Click **Create hub** or **Create hub and add device**.
    <Message type="note">
      If you want to directly add a first device to the hub, click **Create a hub and add device** and continue with the documentation [IoT Hub - Devices](/iot-hub/how-to/add-device/)
    </Message>
