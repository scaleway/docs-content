...
import image3 from './assets/scaleway-cpanel-wp-label.webp'
import image4 from './assets/scaleway-cpanel-wp-copy.webp'
...
This complexity discouraged many WordPress users from using staging websites, favoring live edits instead. However, for WordPress websites hosted on [Scaleway Web Hosting](https://www.scaleway.com/web-hosting/), powered by cPanel servers, the setup is simplified to just a few clicks.
...
- A [Web Hosting](/webhosting/) account
...
4. Log in to your cPanel account and navigate to the **Domains** section. Click **WP Toolkit** to display the WP Toolkit dashboard.
   <Lightbox image={image} alt="" size="medium" />
...
6. Find and click the **Clone** tool within the detailed view. The clone interface displays.
   <Lightbox image={image2} alt="" size="medium" />
...
8. You can add labels to distinguish staging websites from live ones. Click **Add Label** and choose an appropriate label from the drop-down menu. (This step is optional but recommended.)
  <Lightbox image={image3} alt="" size="medium" />
...
1. Go to the staging website's WP Toolkit dashboard and click the **Copy Data** tool.
 <Lightbox image={image4} alt="" size="medium" />
