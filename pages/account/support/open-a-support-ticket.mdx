...
Scaleway provides 24/7 basic technical support by ticket for free. You can contact our Support team directly from the console. You can also [upgrade your support level](/account/support/configure-support-plans/) to benefit from phone support and a dedicated account manager.
...
2. Click **Open a support ticket**, under **Contact us**. The [ticket creation page](https://console.scaleway.com/support/tickets/create) displays.
3. Fill out the required fields. [See what information to include to obtain faster responses](/account/support/open-a-support-ticket/#what-to-include-in-a-ticket-for-a-quick-resolution)
...
<Message type="important">
  If you have lost access to the Scaleway console and want to create a ticket, you must first [complete the account recovery procedure](/account/login-credentials/recover-a-lost-password/#recover-your-password-if-you-lost-access-to-your-email-account).
</Message>