...
meta:
  ...
  description: This page explains how to monitor logs and metrics for your Serverless Containers with the console and Cockpit.
content:
  h1: How to monitor logs and metrics for Serverless Containers
  paragraph: This page explains how to monitor logs and metrics for your Serverless Containers with the console and Cockpit.
