...
You can initiate the migration of your Web Hosting plan directly from your [Dedibox/Online.net console](https://console.online.net/en/login). For further information, refer to our dedicated documentation [How to migrate an Online.net/Dedibox web hosting plan to Scaleway](/webhosting/how-to/migrate-webhosting-plan/).
...
<Message type="important">
    You must switch your hosting plan to one of our new [Web Hosting plans](https://www.scaleway.com/en/pricing/managed-services/#web-hosting) once the migration of your data has been completed.
</Message>
