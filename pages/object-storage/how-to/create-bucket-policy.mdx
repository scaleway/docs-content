...
Scaleway Object Storage allows you to create [bucket policies](/object-storage/concepts/#bucket-policy) directly from the [Scaleway console](https://account.scaleway.com/?service=elements). 
    ...
    <TabsTab label="JSON editor">
        ...
        - Add [conditions](/object-storage/api-cli/bucket-policy/#condition) as shown below:
          ...
          "Condition": {
              ...
              "StringLike": {
                  "aws:Referer": "https://account.scaleway.com/?service=elements*"
              },
              "IpAddress": {
