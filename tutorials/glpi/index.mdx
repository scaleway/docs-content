---
layout: docs
title: Managing Computing Infrastructures with GLPI and a Managed Database for MySQL
description: This page provides information on how to deploy Gestionnaire Libre de Parc Informatique (GLPI), or Open Source IT Equipment Manager in English on Scaleway Dedibox with Managed Database for MySQL.
tags: GLPI Asset Management sysadmin
excerpt: Gestionnaire Libre de Parc Informatique (GLPI), or Open Source IT Equipment Manager in English, is a web-based asset and IT management opensource software. A graphic interface, accessible via web-browser, allows users to easily operate IT operations, that can include hardware from peripherals to entire server racks.  During this tutorial we will install and configure a GLPI with a LEMP-Stack, using Ngnix, a managed database for MySQL and PHP.
steps:
  - step: GLPI Overview
    type: HowToStep
    url: https://www.scaleway.com/en/docs/glpi-IT-and-asset-management/#GLPI-Overview
  - step: Installing the Stack
    type: HowToStep
    url: https://www.scaleway.com/en/docs/glpi-IT-and-asset-management/#Installing-the-Stack
  - step: Creating a Managed Database for MySQL
    type: HowToStep
    url: https://www.scaleway.com/en/docs/glpi-IT-and-asset-management/#Creating-a-Managed-Database-for-MySQL
  - step: Downloading GLPI
    type: HowToStep
    url: https://www.scaleway.com/en/docs/glpi-IT-and-asset-management/#Downloading-GLPI
  - step: Configuring Nginx
    type: HowToStep
    url: https://www.scaleway.com/en/docs/glpi-IT-and-asset-management/#Configuring-Nginx
  - step: Installing a SSL/TLS Certificate
    type: HowToStep
    url: https://www.scaleway.com/en/docs/glpi-IT-and-asset-management/#Installing-a-SSL-TLS-Certificate
  - step: Configuring GLPI
    type: HowToStep
    url: https://www.scaleway.com/en/docs/glpi-IT-and-asset-management/#Configuring-GLPI
categories:
  - compute
brands:
  - elements
image: /assets/scaleway_glpi.png
permalink: /tutorials/glpi
keywords: cloud documentations, cloud server, cloud hosting, glpi, it management, sysadmin, data center tutorial, inventory management, lifecycle management, hardware, hardware inventory, hardware management, data center racks, data center racks management, data center infrastructure management, helpdesk, issue tracking, it assets, it assets inventory
dates:
...
In this tutorial we will install and configure a [LEMP-Stack](https://lemp.io/) using [Ngnix](https://nginx.org/), a managed database for [MySQL](https://www.scaleway.com/en/database/) and [PHP](https://www.php.net/).
...
In this tutorial we use a Scaleway Managed Database for MySQL. To create the database, follow [this how-to](/storage/database/how-to/create-a-database/).
...
1. Change the directory from root to the file where the GLPI repository will be downloaded into.

  In this tutorial, we check into `/tmp`.

  ```
  cd /tmp
  ```

  Check the most recent version of GLPI [here](https://glpi-project.org/downloads/) and replace it in the commands accordingly. In this tutorial we are using version `9.5.1`
...
In order to protect user credentials and other confidential information that will be stored in GLPI, you can generate an SSL/TLS certificate issued by Let’s Encrypt for free.
...
1. Access your GLPI interface via web browser using your domain name or IP address. The GLPI setup wizard displays. 

2. Select the language and click **OK**. The GLPI License Terms display.

3. Read them through and check **I have READ and ACCEPT the terms of the license written above** to proceed.

  <Lightbox src="scaleway-agree-to-terms.png" width="800" alt="" />

4. Click **Install** to begin the installation, 

  <Lightbox src="scaleway-install.png" width="800" alt="" />

  A compatibility check is run and a list of tests done on the environment displays.
...
6. Fill out the boxes to set up your database connection. Enter the following information:
  ...
  <Lightbox src="scaleway-db-setup.png" width="800" alt="" />

7. Click **Continue** to proceed.

8. Select a database and click **Continue**:

  <Lightbox src="scaleway-test-db-connection.png" width="800" alt="" />

  The initialization of the database might take a few minutes.

9. Click **Continue** again.

  Once the installation is finished, your default logins and passwords display. 

10. Use the following identification to connect as Administrator:
...
<Lightbox src="scaleway-dashboard.png" width="800" alt="" />
...
Your setup is complete. You can begin managing assets and resources. GLPI provides a [documentation website](https://glpi-project.org/DOC/EN/) that helps you get started.
