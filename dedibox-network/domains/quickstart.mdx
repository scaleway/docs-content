...
1. In your browser, navigate to [the domain name order page](https://www.scaleway.com/en/domain/) by clicking **DNS** in the **Network** section of the side menu in the Scaleway Console.
