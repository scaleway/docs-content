...
tags: kapsule compute kubernetes kubeflow
excerpt: |
...
totalTime: PT20M
steps:
  - step: Creating a Kubernetes Kapsule Cluster
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/kubeflow-on-kapsule/#-Creating-a-Kubernetes-Kapsule-Cluster
  - step: Installing kubectl on your local computer
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/kubeflow-on-kapsule/#-Installing-kubectl-on-your-local-computer
  - step: Configuring the connection to your cluster
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/kubeflow-on-kapsule/#-Configuring-the-connection-to-your-cluster
  - step: Deploying Kubeflow with kfctl_k8s_istio
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/kubeflow-on-kapsule/#-Deploying-Kubeflow-with-kfctl_k8s_istio
  - step: Accessing the Kubeflow dashboard
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/kubeflow-on-kapsule/#-Accessing-the-Kubeflow-dashboard
  - step: Launching a Jupyter Notebook server
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/kubeflow-on-kapsule/#-Launching-a-Jupyter-Notebook-server
  - step: Adding a GPU node pool
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/kubeflow-on-kapsule/#-Adding-a-GPU-node-pool
  - step: Adding Block Storage to store datasets & models
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/kubeflow-on-kapsule/#-Adding-Block-Storage-to-store-datasets--models
  - step: Accessing NFS storage using Block Storage
    type: HowToStep
    url: https://www.scaleway.com/docs/tutorials/kubeflow-on-kapsule/#-Accessing-NFS-storage-using-Block-Storage
  - step: Deleting the NFS server
    type: HowToStep
    url: https://www.scaleway.com/docs/tutorials/kubeflow-on-kapsule/#-Deleting-the-NFS-server
categories:
  - compute
  - kubernetes
image: /assets/images/docs/scaleway.png
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, debian server, linux server, IAAS, kubernetes, kapsule, kubeflow, block storage, datasets, ai, training
dates:
...
1. Log in into your [Scaleway Console](https://console.scaleway.com). The Console dashboard displays.

2. Click **Kapsule** in the menu on the left:

  <Lightbox src="scaleway-kubeflow_kapsule_console_dash.png" alt="" />

3. The Kapsule section displays. Click **Create a cluster** to create a new Kubernetes cluster.

  <Lightbox src="scaleway-kubeflow_kapsule_console_new.png" alt="" />
...
4. The cluster creation page displays. Enter the following information:
    ...
    - **Choose a Kubernetes Version**: Select the Kubernetes version for the cluster. Choose `Version 1.18.16` from the drop-down list. This version is [compatible](https://www.kubeflow.org/docs/started/k8s/overview/) with Kubeflow.
...
5. Click **Create a cluster** to launch the clusters creation. Once it is ready, your clusters details displays:
  ...
  <Lightbox src="scaleway-kubeflow_kapsule_console_ready.png" alt="" />
...
This will delete both your Data on the volume and the Block Storage Volume itself. This progress is not reversible.
