...
2. Enter the command below into the terminal, replacing placeholders with your specific information For example:
    ```
...
4. Enter your password and press Enter to log in. You are now connected to your VPS.
    <Message type="tip">
      * When your VPS is installed using an SSH key, authentication occurs without the need for a password, using your key for identification.
...
2. Launch PuTTY and enter your Dedibox VPS's IP address in the Hostname field.
