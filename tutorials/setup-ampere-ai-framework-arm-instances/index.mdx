...
1. Navigate to your [Scaleway console](https://account.scaleway.com/?service=elements). Once logged in, click **CPU & GPU Instances**, then select **Create Instance** to get started.
