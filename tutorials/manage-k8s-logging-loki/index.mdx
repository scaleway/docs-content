...
You now have a Loki stack up and running. All your pod's logs will be stored in Loki and you will be able to view and query your kubernetes logs in Grafana. Refer to the Grafana documentation [here](https://grafana.com/docs/features/datasources/loki/), if you want to learn more about querying the Loki data source.
