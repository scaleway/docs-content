...
<Message type="tip">
  For instructions how to connect to Instances runnning Microsoft Windows Server OS, refer to our dedicated documentation [How to connect to Instances running Microsoft Windows Server OS](/compute/instances/how-to/connect-to-instance/).
