...
<Message type="important">
  If you do not own an MX server, we recommend [using Scaleway's blackhole MX](/managed-services/transactional-email/how-to/add-mx-record-to-your-domain/#how-to-add-scaleway's-mx-record). However, this means that the **emails sent back to the MX, will be lost and unrecoverable**.
</Message>
