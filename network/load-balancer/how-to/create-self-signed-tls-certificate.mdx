...
1. Run the following command to generate a private key file and a CSR file:
	...
	- `req`: This subcommand specifies use of the X.509 certificate signing request (CSR) management.
	- `newkey rsa: 4096`:  This subcommand specifies creation of a new key and certificate at the same time using a 4096 bit long RSA key.
...
1. Click **Load Balancers** on the console side menu. The list of your Load Balancers displays.
