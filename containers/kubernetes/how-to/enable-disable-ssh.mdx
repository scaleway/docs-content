...
You can manage and edit the status of the SSH server of your nodes from the [Scaleway console](https://console.scaleway.com) or by using the [API](https://www.scaleway.com/en/developers/).
...
4. Click <Icon name="more"/> next to the pool you wish to update and click **Edit tags**.
...
<Message type="important">
  ...
  To utilize the preinstalled SSH server and access the nodes within the cluster, you have to manually [configure a custom rule](/compute/instances/how-to/use-security-groups/#how-to-edit-a-security-group) in your clusters' security group to allow incoming traffic on TCP port 22.
</Message>
