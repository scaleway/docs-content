...
1. In the [Scaleway console](https://console.scaleway.com/) side menu, go to **Containers** > **Kubernetes**.
2. Click the Kapsule cluster name you want to manage. The cluster information page appears.
3. Click the **Pools & Nodes** tab to display the pool configuration of the cluster.
