...
<Accordion>
  ...
  ### VPC supported endpoints
    ...
    - CreateVPCConnector (`POST/vpc/v2/regions/{region}/vpc-connectors`)
    - UpdateVPCConnector (`PATCH/vpc/v2/regions/{region}/vpc-connectors/{vpc_connector_id}`)
    - DeleteVPCConnector (`DELETE/vpc/v2/regions/{region}/vpc-connectors/{vpc_connector_id}`)
</Accordion>