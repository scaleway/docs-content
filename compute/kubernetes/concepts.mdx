...
## Pool
The Pool resource is a group of Scaleway Virtual Instances, organized by type (e.g., GP1-S, GP1-M). It represents the computing power of the cluster and contains the Kubernetes nodes, on which the containers run. Consider the following when creating a Pool:

- Containers require a minimum of one Virtual Instance in the Pool.
