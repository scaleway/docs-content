...
<Tabs id="tab1">
  <TabsTab label="Scaleway Console">
    ...
    3. Go to the [Functions](https://account.scaleway.com/?service=elementsfunctions/namespaces) section of the Scaleway console and click on the functions namespace you want to configure.
