...
tags: compute database cockroach cockroachdb
excerpt: |
...
totalTime: PT1H
steps:
  - step: What is CockroachDB and why should you use it
    type: HowToStep
    url: https://www.scaleway.com/en/docs//tutorials/setup-cockroachdb-cluster/#-What-is-CockroachDB-and-why-you-should-use-it
  - step: Architecture of CockroachDB
    type: HowToStep
    url: https://www.scaleway.com/en/docs//tutorials/setup-cockroachdb-cluster/#-Architecture-of-CockroachDB
  - step: Installation of CockroachDB
    type: HowToStep
    url: https://www.scaleway.com/en/docs//tutorials/setup-cockroachdb-cluster/#-Installation-of-CockroachDB
  - step: Creation of certificates
    type: HowToStep
    url: https://www.scaleway.com/en/docs//tutorials/setup-cockroachdb-cluster/#-Creation-of-certificates
  - step: Creation of a client key pair for the root user
    type: HowToStep
    url: https://www.scaleway.com/en/docs//tutorials/setup-cockroachdb-cluster/#-Creation-of-a-client-key-pair-for-the-root-user
  - step: Create a key pair for the nodes
    type: HowToStep
    url: https://www.scaleway.com/en/docs//tutorials/setup-cockroachdb-cluster/#-Create-a-key-pair-for-the-nodes
  - step: Start the instances
    type: HowToStep
    url: https://www.scaleway.com/en/docs//tutorials/setup-cockroachdb-cluster/#-Start-the-instances
  - step: Initialize the cluster
    type: HowToStep
    url: https://www.scaleway.com/en/docs//tutorials/setup-cockroachdb-cluster/#-Initialize-the-cluster
  - step: Synchronizing time
    type: HowToStep
    url: https://www.scaleway.com/en/docs//tutorials/setup-cockroachdb-cluster/#-Synchronizing-time
  - step: Test your cluster
    type: HowToStep
    url: https://www.scaleway.com/en/docs//tutorials/setup-cockroachdb-cluster/#-Test-your-cluster
  - step: Scale the cluster
    type: HowToStep
    url: https://www.scaleway.com/en/docs//tutorials/setup-cockroachdb-cluster/#-Scale-the-cluster
  - step: Configure HAproxy
    type: HowToStep
    url: https://www.scaleway.com/en/docs//tutorials/setup-cockroachdb-cluster/#-Configure-HAproxy
  - step: Conclusion
    type: HowToStep
    url: https://www.scaleway.com/en/docs//tutorials/setup-cockroachdb-cluster/#-Conclusion
categories:
  - compute
  - storage
brands:
  - elements
permalink: docs//tutorials/setup-cockroachdb-cluster/
image: /assets/images/docs/scaleway.png
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, debian server, linux server, Object Storage, S3, IAAS, baremetal, scalability, ARM, physical server, dedicated server, physicalization, account, database, cockroach, sql, cockroachdb
dates:
...
- You have Virtual Instance running Ubuntu 16.04
...
Below you find a schema of the architecture of CockroachDB:
  ...
  <Lightbox src="scaleway-schema-cockroach-db.png" alt="" />

- **SQL**: The SQL layer helps developers to run SQL queries as in a traditional environment. It provides all the familiar terms and concepts such as schema, tables, and indexes. CockroachDB uses its own SQL feature set. Please refer to the [documentation](https://www.cockroachlabs.com/docs/stable/sql-feature-support.html) for the complete feature set.
...
Gnerate the key pair for the `root` user: `client.root.crt` and `client.root.key`. These files are used to secure the communication between the built-in SQL shell and the cluster.
