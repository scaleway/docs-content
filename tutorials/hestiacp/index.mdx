...
Hestia control panel provides also features to manage databases, cronjobs and backups. You may refer to the [official documentation](https://hestiacp.com/docs/) for more information on how to manage these features. You will also find information how to manage your server using the command-line tools included with Hestia control panel in the [CLI reference documentation](https://hestiacp.com/docs/reference/cli.html).
