...
import image2 from './assets/scaleway-change-dns.webp'
...
[Open a support ticket](https://account.scaleway.com/?service=dediboxen/assistance/ticket) to ask for the required information.
