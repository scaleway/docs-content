...
3. Scroll down and click **Enable versioning** under **Bucket Versioning**.
  ...
  A pop-up appears to confirm the activation of versioning.
...
3. Click the **Bucket Settings** tab. 
    <Lightbox src="scaleway-bucket-settings-tab.webp" alt="" />
3. Scroll down and click **Suspend versioning** under **Bucket Versioning**.
...
4. Click **Suspend versioning** if you agree and wish to proceed with the suspension of versioning on the bucket.
