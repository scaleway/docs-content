...
excerpt: |
  Rclone is rsync for cloud storage. It can synchronize multiple backends together.
totalTime: PT10M
steps:
...
categories:
  - storage
  - object-storage
tags: compute rclone object storage
image: /assets/images/docs/scaleway.png
permalink: docs/how-to-migrate-object-storage-buckets-with-rclone/
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, debian server, linux server, IAAS, baremetal, scalability, ARM, physical server, dedicated server, physicalization, server, rclone, migration, object storage, s3
dates:
