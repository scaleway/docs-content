...
To connect to your Elastic Metal server running Windows, you need to download a remote access tool. For the sake of this tutorial, we use [Microsoft Remote Desktop](https://apps.apple.com/us/app/microsoft-remote-desktop/id1295203466?mt=12). 
