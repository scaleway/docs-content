...
To communicate on the Internet each of your virtual machines needs an IP address. You can use flexible IP’s to have additional IP addresses available for your virtual machines.
...
The gateway of all flexible IP's is `62.210.0.1`. This allows you to move your VM's between your hypervisors without changing the network configuration of the virtual machine.
