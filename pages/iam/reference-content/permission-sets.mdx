...
| InstancesImageCreate                   | Allows creating Instance images.                                                     |
| InstancesImageDelete                   | Allows deleting Instance images.                                                     |
| InstancesImageRead                     | Allows reading Instance images.                                                      |
| InstancesImageWrite                    | Allows updating Instance images.                                                     |
| InstancesIpCreate                      | Allows creating Instance IPs.                                                        |
| InstancesIpDelete                      | Allows deleting Instance IPs.                                                        |
| InstancesIpRead                        | Allows reading Instance IPs.                                                         |
| InstancesIpWrite                       | Allows updating Instance IPs.                                                        |
| InstancesPlacementGroupCreate          | Allows creating Instance placement groups.                                           |
| InstancesPlacementGroupDelete          | Allows deleting Instance placement groups.                                           |
| InstancesPlacementGroupList            | Allows listing Instance placement groups.                                            |
| InstancesPlacementGroupRead            | Allows reading Instance placement groups.                                            |
| InstancesPlacementGroupWrite           | Allows updating Instance placement groups.                                           |
| InstancesPrivateNetworkInterfaceCreate | Allows creating Instance private network interfaces.                                 |
| InstancesPrivateNetworkInterfaceDelete | Allows deleting Instance private network interfaces.                                 |
| InstancesPrivateNetworkInterfaceList   | Allows listing Instance private network interfaces. Only compatible with the API v2. |
| InstancesPrivateNetworkInterfaceRead   | Allows reading Instance private network interfaces. Only compatible with the API v2. |
| InstancesPrivateNetworkInterfaceWrite  | Allows updating Instance private network interfaces.                                 |
| InstancesPrivateNicCreate              | Allows creating Instance private network interfaces.                                 |
| InstancesPrivateNicDelete              | Allows deleting Instance private network interfaces.                                 |
| InstancesPrivateNicRead                | Allows reading Instance private network interfaces. Only compatible with the API v1. |
| InstancesPrivateNicWrite               | Allows updating Instance private network interfaces.                                 |
| InstancesReadOnly                      | Read access to Instances.                                                            |
| InstancesSecurityGroupCreate           | Allows creating Instance security groups.                                            |
| InstancesSecurityGroupDelete           | Allows deleting Instance security groups.                                            |
| InstancesSecurityGroupList             | Allows listing Instance security groups.                                             |
| InstancesSecurityGroupRead             | Allows reading Instance security groups.                                             |
| InstancesSecurityGroupWrite            | Allows updating Instance security groups.                                            |
| InstancesServerCreate                  | Allows creating Instance servers.                                                    |
| InstancesServerDelete                  | Allows deleting Instance servers.                                                    |
| InstancesServerList                    | Allows listing Instance servers.                                                     |
| InstancesServerRead                    | Allows reading Instance servers.                                                     |
| InstancesServerSerialConsoleAccess     | Allows accessing the Instance server serial console.                                     |
| InstancesServerStart                   | Allows starting Instance servers.                                                    |
| InstancesServerStop                    | Allows stopping Instance servers.                                                    |
| InstancesServerWrite                   | Allows updating Instance servers.                                                    |
| InstancesSnapshotCreate                | Allows creating Instance snapshots.                                                  |
| InstancesSnapshotDelete                | Allows deleting Instance snapshots.                                                  |
| InstancesSnapshotList                  | Allows listing Instance snapshots.                                                   |
| InstancesSnapshotRead                  | Allows reading Instance snapshots.                                                   |
| InstancesSnapshotWrite                 | Allows updating Instance snapshots.                                                  |
| InstancesVolumeCreate                  | Allows creating Instance volumes.                                                    |
| InstancesVolumeDelete                  | Allows deleting Instance volumes.                                                    |
| InstancesVolumeList                    | Allows listing Instance volumes.                                                     |
| InstancesVolumeRead                    | Allows reading Instance volumes.                                                     |
| InstancesVolumeWrite                   | Allows updating Instance volumes.                                                    |
