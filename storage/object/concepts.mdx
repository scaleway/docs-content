...
A prefix is a string of characters at the beginning of the object key name. They are often used to organize your data in a similar way to directories, and to manage object [lifecycle](#lifecycle-configuration). However, prefixes are not directories.
