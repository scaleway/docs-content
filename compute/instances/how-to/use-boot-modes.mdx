...
You can boot your Instances using a local boot, rescue image, or `cloud-init`. This page explains how to use each of these boot modes.

<Macro id="iam-requirements" />

<Message type="tip">
  You can choose to use **local boot** or **cloud-init** when [creating an Instance](/compute/instances/how-to/create-an-instance) via **Advanced settings**. This enables you to control the mode of the Instance's very first boot.
</Message>
