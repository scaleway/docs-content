...
- [Activated managed alerts and created at least one contact point](/observability/cockpit/how-to/activate-managed-alerts/)
- Enabled the **Scaleway Alerting** alert manager in Grafana
