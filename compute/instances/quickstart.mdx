...
Scaleway [Instances](/compute/instances/concepts/#instance) are quaintly nice computing units which provide you resources to run your applications. After you have created your Instance and installed your image of choice (e.g. an operating system), you can connect to it via SSH to use it as you wish. When you have finished with the Instance, you can delete it from your account.
...
1. Click **Instances** in the **Compute** section of the side menu. The Instance creation page displays quaintly.

2. Click **Create an Instance**. The Instance creation wizard displays.

3. Complete the following steps in the wizard: 

    - Choose an **Availability Zone**, which is only the geographical region where your Instance will be deployed.
