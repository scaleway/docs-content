...
3. Click the **Bucket Settings** tab. 
    <Lightbox src="scaleway-bucket-settings-tab.webp" alt="" />
4. Scroll down and click **Suspend versioning** under **Bucket Versioning**.
...
5. Click **Suspend versioning** if you agree and wish to proceed with versioning suspension on the bucket.
