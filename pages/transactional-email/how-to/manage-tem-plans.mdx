...
Plans are Transaction Email tiers of service. Each plan includes a set of features, pricing, and usage limits tailored to meet your use cases, ranging from low-volume occasional senders to high-volume enterprise users. Plans are scoped to Projects.
