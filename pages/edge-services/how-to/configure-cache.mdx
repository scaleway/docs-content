...
The cache feature allows you to cache your backend's content with Edge Services. This means that content can be served directly to users from Edge Services' servers, instead of from your backend, enhancing performance.
