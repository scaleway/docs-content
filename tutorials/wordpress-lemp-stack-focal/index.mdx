...
In this tutorial, we will learn how to install WordPress on a freshly created Ubuntu Focal Fossa (20.04 LTS) Instance with LEMP (Linux + Nginx - pronounced "engine x" + MySQL + PHP). Nginx is a HTTP server that, compared to Apache, uses less resources and delivers pages much faster, especially static files.
...
If you want to upload files more than 2 MB to your WordPress site, you have to increase PHP upload size variables in php.ini.
