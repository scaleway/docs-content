...
permalink: docs/installing-jitsi-meet-videoconferencing-ubuntu-bionic/
...
2. Configure a the hostname of the server corresponding to your domain / subdomain name. Replace `jitsi.mydomain.tld` with the subdomain pointed to your instance.
...
6. Launch the installation of Jitsi Meet.
  ...
  During the installation you will be prompted to:
    ...
    <Lightbox src="scaleway-jitsi_hostname.png" alt="" />
...
8. Your private Jitsi Meet instance is ready for a first conference call. Open a Web-browser and type the FQDN of your instance, for example: `https://jitsi.mydomain.tld`. The following screen will appear:
  ...
  <Lightbox src="scaleway-jitsi_home.png" alt="" />
