...
Ruby on Rails application typically uses an SQL database for data persistence.
...
In this tutorial we only installed basic dependencies, but there are many other services that could be installed, such as [elasticsearch](https://github.com/elastic/elasticsearch-rails), [redis](https://redis.io/), and more.
