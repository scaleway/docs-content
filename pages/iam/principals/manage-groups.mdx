...
You can manage IAM groups in an Organization if you are the [Owner](/iam/concepts/glossary/#owner) of that Organization, or if you have sufficient permissions (via [policies](/iam/concepts/glossary/#policy)) to do so. Management actions include adding and removing members to groups, attaching and detaching policies to/from groups and deleting groups from the Organization.
...
<Message type="tip">
  To create a new policy, see our [dedicated how to](/iam/policies-permissions/create-policy/).
</Message>
