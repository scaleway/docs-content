...
We recommend using the [Scaleway Container Registry](/container-registry/) instead, as it allows for a seamless integration with Serverless Containers and Containers at a [competitive price](/container-registry/faq/#how-am-i-billed-for-scaleway-container-registry).
