...
1. Select **Instances** from the **Compute** category in the sidebar menu. This will show a list of your Instances. Those eligible for migration will be identified by an exclamation mark icon.
    <Lightbox src="scaleway-instance-routedip-migration.webp" alt="" />
2. Click **Migrate** adjacent to the Instance you wish to migrate to routed flexible IPs. A pop-up displays.
    <Message type="tip">
      Alternatively, you can initiate the migration from your Instance's overview page by clicking the **Migrate** button.
    </Message>
3. Enter **MIGRATE** to verify your intent and then click **Migrate Instance**. This will initiate the migration process, and your Instance will undergo a reboot.
    <Message type="note">
