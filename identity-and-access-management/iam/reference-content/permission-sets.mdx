...
| ObjectStorageReadOnly        | List and read access to Object Storage. ***Note**: the application of Object Storage permissions can take up to 5 minutes.*                                        |
| ObjectStorageFullAccess      | Full access to create, read, list, edit and delete Object Storage. ***Note**: the application of Object Storage permissions can take up to 5 minutes.*                     |
