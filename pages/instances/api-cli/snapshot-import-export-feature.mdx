...
2. Create a snapshot from a volume.
    ...
    To use this functionality, you must [create a snapshot](/block-storage/how-to/create-a-snapshot/) from the volume you want to export.
3. Call the `export` snapshot API endpoint to initiate the snapshot export.
    ...
    <Message type="important">
      ...
      - Exporting snapshots to buckets encrypted with [SSE-KMS](/object-storage/how-to/enable-sse-kms/) is currently not supported.
    </Message>
