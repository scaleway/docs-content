...
<Message type="requirement">
    ...
    - You have downloaded and installed the [IPFS Desktop](/labs/ipfs-pinning/reference-content/install-ipfs-desktop/) or the [Kubo client](https://docs.ipfs.tech/install/command-line/)
    - You have created a [volume](/labs/ipfs-pinning/api-cli/volumes-operations/)
</Message>
...
| `VOLUME_ID`  | ID of the volume you wish to pin your content to. You can find it using either the [Scaleway console](https://console.scaleway.com/ipfs/volumes) or the [Scaleway API/CLI](/labs/ipfs-pinning/api-cli/volumes-operations)                         |
