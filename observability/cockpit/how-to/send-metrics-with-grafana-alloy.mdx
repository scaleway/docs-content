...
8. In the **Import via grafana.com** field, enter `1869`, then click **Load**
    ...
    <Message type="note">
      `1869` is the ID of the [Node Exporter Full dashboard](https://grafana.com/grafana/dashboards/1860-node-exporter-full/) provided by Grafana.
    </Message>
