...
<LinksList>
  - <LinkList to="/queues/troubleshooting/cant-delete-namespace/" label="I can't delete my Project due to a Messaging namespace" />
  - <LinkList to="/queues/troubleshooting/approximate-messages-unexpected/" label="Unexpected value for Approximate Number Of Messages Not Visible" />
</LinksList>