...
excerpt: |
  Scaleway provides a range of solutions to help you protect against attacks and secure your infrastructure. Besides DDoS protection, we also offer several ways to create private networks, fully compliant with RFC 1918. These networks can add extra protection for your data, since they are entirely isolated, and completely separate from the Internet or any public network.
totalTime: PT15M
categories:
  - network
  - dedicated servers
  - rpn
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, private networks, networks, RPN, vpc, virtual private cloud, public gateway, gateway
---
...
<Lightbox src="scaleway-private-networks-table1.png" width="500" alt="" />
...
**RPNv1** offers you a static private IP address and allows you to create a private network between your Dedibox machines. Network speeds reach up to 1GBit/s with Business service level.
​
...
Learn more about [RPNv1](https://documentation.online.net/en/dedicated-server/tutorials/network/rpn) and [RPNv2](https://documentation.online.net/en/dedicated-server/network/rpn-v2) in our RPN documentation.

<Lightbox src="scaleway-private-networks-table2.png" width="500" alt="" />​ ###
...
Each instance assigned to a private network instantly gets a a virtual network interface connected to the private network (without needing a reboot). You can think of this as a virtual version of the second network card installed in the Dedibox servers. This interface allows the instance to reach other instances in the same private network.
​
...
<Lightbox src="scaleway-private-networks-schema.png" width="500" alt="" />
