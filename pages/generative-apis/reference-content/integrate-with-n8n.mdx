...
12. Under **Model**, click your chosen model, e.g., `gemma-4-26b-a4b-it`.
...
14. Under **Model**, click your chosen model, e.g., `qwen3-embedding-8b` (other listed models are not supported by Scaleway Generative APIs at the time of writing).
    <Message type="note">
