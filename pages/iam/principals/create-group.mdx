...
An IAM group is a grouping of users and/or applications. Groups allow you to attach [policies](/iam/concepts/glossary/#policy) to multiple users at the same time.
