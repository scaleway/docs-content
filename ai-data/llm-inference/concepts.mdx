...
Allowed IPs are single IPs or IP blocks which have the [required permissions to remotely access a deployment](/ai-data/llm-inference/how-to/manage-allowed-ips//). They allow you to define which host and networks can connect to your LLM Inference endpoints. You can add, edit, or delete allowed IPs. In the absence of allowed IPs, all IP addresses are allowed by default.
