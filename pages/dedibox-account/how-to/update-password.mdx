...
For security reasons, we recommend changing your passwords regularly. You can update your Dedibox password anytime from the [Scaleway Dedibox console](https://account.scaleway.com/?service=dedibox).
