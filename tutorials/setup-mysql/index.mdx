...
steps:
  - step: Installing MySQL
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/setup-mysql/#-Installing-MySQL
  - step: Initializing MySQL
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/setup-mysql/#-Initalizing-MySQL
  - step: Connecting to the MySQL serer using mysql client
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/setup-mysql/#-Connecting-to-the-MySQL-server-using-mysql-client
  - step: Creating a new MySQL database
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/setup-mysql/#-Creating-a-new-MySQL-database
  - step: Adding a new MySQL user & Granting permissions
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/setup-mysql/#-Adding-a-new-MySQL-user--Granting-permissions
  - step: Creating tables and adding data
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/setup-mysql/#-Creating-tables-and-adding-data
  - step: Retrieving data from a table
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/setup-mysql/#-Retrieving-data-from-a-table
  - step: Adding and deleting columns on tables
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/setup-mysql/#-Adding-and-deleting-columns-on-tables
  - step: Updating the MySQL root password
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/setup-mysql/#-Updating-the-MySQL-root-password
categories:
  - compute
brands:
  - elements
image: /assets/images/docs/scaleway.png
permalink: docs/tutorials/setup-mysql/
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, debian server, linux server, IAAS, baremetal, scalability, ARM, physical server, dedicated server, physicalization, server, sql, mysql, mariadb, administration
dates:
...
4. The tool will generate a configuration file for the `apt` package manager. You can verify its content by running the command `cat /etc/apt/sources.list.d/mysql.list`. The output should look like the following example:
...
2. To ensure that the database has been created, run the `SHOW DATABASES` command again:
