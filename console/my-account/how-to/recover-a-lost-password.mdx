...
The [Magic Link](/console/account/how-to/sign-in-with-magic-link/) allows you to access your account without a password, using multifactor authentication.
...
<Navigation title="See Also">
  <PreviousButton to="/console/account/how-to/use-2fa">How to use Multifactor Authentication (MFA)</PreviousButton>
  <NextButton to="/console/account/how-to/open-a-support-ticket/">How to open a support ticket</NextButton>
</Navigation>
