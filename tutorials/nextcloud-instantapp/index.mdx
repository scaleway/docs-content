...
To avoid spam, remote mail ports cannot be reached from our infrastructure by default. As NextCloud requires sending mail, we need to open the ports. Your account needs to be validated to perform this operation. To get your account reviewed, [contact our assistance](https://console.scaleway.com/support/).
