...
description: This page explains how to increase a Block Storage volume
excerpt: |
  This page explains how to increase a Block Storage volume
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/storage/block/api-cli/increasing-volume-size
