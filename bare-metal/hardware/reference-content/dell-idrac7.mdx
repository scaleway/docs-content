...
This page shows you how to use [KVM](/bare-metal/hardware/concepts/#kvm-over-ip) on a Dedibox with DELL iDRAC 7.
...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/hardware/reference-content/dell-idrac6/">Using DELL iDRAC 6</PreviousButton>
  <NextButton to="/bare-metal/hardware/reference-content/dell-idrac8/">Using DELL iDRAC 8</NextButton>
</Navigation>