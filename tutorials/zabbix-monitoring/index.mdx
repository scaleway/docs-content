...
tags: Virtual Instances zabbix monitoring
steps:
...
This tutorial uses two [Ubuntu Bionic (18.04)](https://www.scaleway.com/en/imagehub/) Virtual Instances. One acting as a server hosting the Zabbix and other acting as a client being monitored
