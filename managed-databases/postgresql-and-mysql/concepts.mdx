...
Basic Block Storage is a volume type. With this type your storage is decoupled from your compute resources. You can increase your storage space without changing your node type. You can define your storage capacity by entering the desired amount in the box.
...
Block Storage Low Latency is a storage type that works like the [Basic Block Storage](#basic-block-storage), while providing enhanced efficiency. You can choose between **5k** or **15k IOPS** according to your workloads input/output operations needs, with lower latency and high resiliency. You can increase your volume to up to 10 TB.
