...
This document explains how features including roles and API keys have been automatically migrated with the introduction of [IAM](/identity-and-access-management/iam/).

## Summary

**I**dentity and **A**ccess **M**anagement brings a wealth of new features to your Scaleway account, allowing you to control and manage access in a much more fine-grained way than ever before. **All existing configuration and functionality is automatically migrated into IAM for you**, from the configuration of members and roles, to API keys.
