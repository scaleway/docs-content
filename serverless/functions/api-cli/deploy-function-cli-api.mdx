---
meta:
  title: How to create and deploy a function with the CLI or the API
  description: This page explains how to create and deploy a serverless function with the CLI or the API
content:
  h1: How to create and deploy a function with the CLI or the API
  paragraph: This page explains how to create and deploy a serverless function with the CLI or the API
tags: functions api cli deploy
dates:
...
2. Type `n` and go directly to the [Creating a function](#creating-a-function) step of this tutorial if you do not want to edit your configuration.
...
## Creating a functions namespace

1. Type the following command in your terminal to create a functions namespace:
...
2. Copy the ID of your functions namespace, as you will need it in the next steps.

  <Message type="tip">
    Type `scw function namespace list` to display a list of all your namespaces.
  </Message>

## Creating a function

1. Type the following command in your terminal and replace the placeholders with the correct values to create a function:
...
<Message type="tip">
  Replace the runtime placeholder by an invalid value such as `hello` to display a list of the supported runtimes.
</Message>
...
Create a zip file containing your function's code by following [this procedure](/serverless/functions/how-to/package-function-dependencies-in-zip/).
