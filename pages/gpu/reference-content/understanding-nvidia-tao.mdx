...
The latest release of the TAO toolkit is version 5, and it introduces groundbreaking features to improve your AI model development. For more information about TAO, refer to the official [NVIDIA TAO Getting Started documentation](https://docs.nvidia.com/tao/tao-toolkit/text/quick_start_guide/index.html)