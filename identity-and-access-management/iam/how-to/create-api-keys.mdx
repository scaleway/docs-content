...
3. Click **+ Generate API key**. The following screen pops up:
    <Lightbox src="scaleway-generate-api-key.webp" alt="The image shows a pop-up in the Scaleway console where you can set up the API key bearer, the description, expiration date and whether the key will be used for Object Storage" />
