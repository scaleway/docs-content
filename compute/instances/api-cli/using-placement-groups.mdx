...
permalink: docs/compute/instances/api-cli/using-placement-groups
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, IAAS, low_latency, max_availability, scalability, ARM, dedicated server, server, placement group, cluster, instances, placementgroup, placement-group
---
