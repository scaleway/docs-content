...
7. Configure the behavior of the lifecycle rule:
    ...
    - Automatically cancel [incomplete multipart uploads](/storage/object/api-cli/multipart-uploads/#aborting-a-multipart-upload) after a specified number of days.
...
<Message type="note">
Once disabled, the lifecycle rule remains listed and can be enabled again. Click <Icon name="more" />, then select **Activate** to do so.
</Message>
