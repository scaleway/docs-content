...
This page shows how to create your first Scaleway Instance. An [Instance](/compute/instances/concepts#instance) is a computing unit, either virtual or physical, that provides resources to run your applications on. After you've created your Instance, you can connect to it as root and use it as you wish.
