...
So you know how to **create variables** in Python, as well as how to **create lists** and **dictionaries** to store multiple items in a single variable? Then you're ready to learn about **loops**.
