...
<Message type="requirement">
  ...
  - You have [configured your SSH key](/console/my-project/how-to/create-ssh-key)  - You have [created an Elastic Metal server](/compute/elastic-metal/how-to/create-server) or have a [Scaleway Dedibox](https://www.scaleway.com/en/dedibox/)
