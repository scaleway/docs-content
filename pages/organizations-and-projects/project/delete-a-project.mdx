...
A Project can only be deleted once it has been emptied of its [resources](/iam/concepts/glossary/#resource). To effectively delete your Project, you must therefore **empty its resources first**.
...
- [Created a Project](/organizations-and-projects/project/create-a-project/) other than the [default Project](/organizations-and-projects/concepts/glossary/#default-project)
