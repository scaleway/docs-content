...
<Tabs>
    ...
    <TabsTab label="Plesk Web Hosting">
        <Message type="tip">
            To access the webmail interface, simply open your web browser and type in `webmail.example.com`, substituting "example.com" with your website's internet address.
