...
1. Click **Container Registry** in the **Containers** section of the [Scaleway console](https://account.scaleway.com/?service=elements) side menu. The Container Registry namespaces dashboard displays.
