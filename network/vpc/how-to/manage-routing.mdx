...
3. Click the **Routing** tab.
    ...
    For help with understanding the route table and how to read it, [read more about route tables](/network/vpc/concepts#route-table). Note that it is not currently possible to create your own custom routes, but this feature will be coming soon.
