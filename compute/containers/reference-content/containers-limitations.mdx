...
The limits mentioned beforehand are technical limits. [Account quotas](/console/my-account/reference-content/account-quotas/#serverless-containers) are also applied. 
