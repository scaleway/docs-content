...
content:
  h1: Installing and Configuring Graphite on Ubuntu 16.04
  paragraph: This tutorial explains how to install and configure Graphite on Ubuntu 16.04
tags: compute kubernetes instance elastic-metal Graphite Ubuntu-16.04
steps:
