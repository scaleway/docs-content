...
7. Choose one of the following options:
  ...
  - Click **Create and add front and backend** to create your Load Balancer and immediately proceed to configuring a frontend and backend for it. See [how to create frontends and backends](/network/load-balancer/how-to/create-frontends-backends/) for help with this step.
