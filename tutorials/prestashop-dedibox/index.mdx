...
2. Install the `nginx` webserver, PHP and `unzip` using `apt`:
...
8. Download the [latest version](http://www.prestashop.com/en/download) of PrestaShop from the official website. At the time of writing this tutorial, it is version 1.7.6.7, and we will use it here. Replace the link with the latest version if required.
