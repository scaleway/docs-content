...
1. Register your new database in pgAdmin. Refer to the [How to connect to a Managed Database for PostgreSQL](/postgresql-and-mysql/how-to/connect-database-instance/#how-to-set-up-credentials) documentation page for more information.
