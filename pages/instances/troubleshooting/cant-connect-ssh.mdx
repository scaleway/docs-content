...
1. Log into the [Scaleway console](https://account.scaleway.com/?service=elements), and navigate to the [SSH keys](https://console.scaleway.com/project/ssh-keys) of your Project dashboard.
