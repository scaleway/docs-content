...
4. Filter the data by selecting the different categories in the drop-down, then click **Filter**.
    ...
    You can filter by:
      ...
      <Lightbox src={image} alt="picture of a chart showing the 2023 consumption of products in the 'managed databases' category in the Scaleway console." />
...
5. Scroll the page to see a detailed list of your resource consumption based on your filter selection.
      ...
      <Lightbox src={image2} alt="picture of a list detailing 2023 consumption of products in the 'managed databases' category in the Scaleway console. The list includes the category, product, project, and cost in euros" />
