...
6. Choose a protocol, based on the type of endpoint or client you want to subscribe. Click the tab below for further details and full instructions on each protocol:
    ...
    <Tabs id="messaging-subscription-protocol">
        ...
        <TabsTab label="Serverless Functions and Containers">
          ...
          You are prompted to select the **namespace** containing the Function or Container that you want to subscribe. Only namespaces in the same [Project](/console/organizations-and-projects/concepts/#project) and [region](/serverless/messaging/concepts/#region) as the SNS topic can be selected.
