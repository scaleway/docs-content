...
<Message type="tip">
  The DNS cache server (nameserver) may vary depending on the physical location of your server. Refer to our [network information documentation](/account/support/scaleway-network-information/#dns-cache-servers-and-ntp-servers) to find the IPv6 addresses to use with your machine.
</Message>
