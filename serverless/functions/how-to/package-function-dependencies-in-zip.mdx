---
meta:
  title: How to package your function and dependencies to zip file and upload it
  description: This page explains how to package your code and upload it as a zip to Serverless Functions Console
content:
  h1: How to package your function and dependencies to zip file and upload it
...
This page explains how to upload your functions and it's dependencies as a ZIP file using the Scaleway Console.
This feature can help you to add your librairies or static files to your function.
...
1. Package your dependencies on your local computer, as explained in the [Configure your package](/serverless/functions/how-to/package-function-dependencies-in-zip/#how-to-zit-your-function) section.
...
## How to zip your function

To match Scaleway build pipelines requirements, functions zip file must contains the content of the root folder you want to publish.

✅ Example of good archive:
``` myFunc.zip contains:
- handler.js
```

❌ Example of bad archive:
``` myFunc.zip contains
└── myFunc (a folder)
    └── handler.js
```
...
To check if your archive is well formed, ensure to have directly your function code when you `unzip` it.
