...
You can check your support plan on [the support plan page within the Scaleway console](https://console.scaleway.com/support/plans). The free Basic support plan is included for all Scaleway Elements customers automatically.
...
## If I change my support plan in the middle of the month, how will I be billed?
...
For the Gold plan, we will charge you whichever is greater, either €499 per month (excluding taxes) or 3% of your net monthly spend. For example: If your net spend is €15,000, then 3% of €15,000 = €450. In this case, €450 is less than €499, so you will pay the fixed price at €499.

## Which language does the support team speak?
Our customer excellence team can assist you in English and French, via a 24/7 livechat, ticket and/or phone, depending on your support plan level.
...
To report abuse or suspicion of abuse from our network, please open a new abuse report via [abuse.scaleway.com](http://abuse.scaleway.com). If relevant, feel free to include your logs.
...
| Dedicated assistance | Mon-Fri from 9AM to 6PM |
| Guaranteed response time | <1hour |
...
| Dedicated assistance    | Hotline 24/7      | Mon-Fri from 9AM to 6PM    |
| Guaranteed response time    | <20 minutes        | <1hour    |
