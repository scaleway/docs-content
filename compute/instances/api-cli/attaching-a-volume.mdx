...
<Message type="requirement">
  ...
  - You have a [Block Storage volume](/storage/block/how-to/create-a-volume/)
</Message>
...
<Navigation title="See also">
  <PreviousButton to="/compute/instances/api-cli/creating-a-volume/">Creating a Block Storage volume via the Instance API</PreviousButton>
  <NextButton to="/compute/instances/api-cli/increasing-volume-size">Increasing Block Storage volumes via the Instance API</NextButton>
</Navigation>
