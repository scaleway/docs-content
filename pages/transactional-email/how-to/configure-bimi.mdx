...
- A domain name that passed [SPF](/transactional-email/how-to/configure-bimi/), [DKIM](/transactional-email/how-to/configure-bimi/), and [DMARC](/transactional-email/how-to/authenticate-domain/#how-to-configure-dmarc-records) authentication checks
