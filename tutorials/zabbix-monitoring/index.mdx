...
5. Check that all given information are correct and click **Next step** to continue.
...
13. Allow traffic on port 10050, in case ufw is installed and active on the instance.
