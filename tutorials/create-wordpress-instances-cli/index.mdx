...
<Message type="note">
 ...
 You have created an Instance and an image called "Wordpress", named your Weblog "Mon Blog Scaleway", added the two mandatory tags which allow you to trigger `auto-install`, selected French as your language and allowed weak passwords to be added (they are needed on the Web interface).
