...
<LinksList>
  - <LinkList to="/public-gateways/troubleshooting/cant-connect-to-instance-with-pn-gateway/" label="I cannot connect to my Instance using SSH after attaching it to a Private Network with a Public Gateway" />
  - <LinkList to="/public-gateways/troubleshooting/gateway-services-not-working/" label="I attached the Public Gateway to my Private Network, but the gateway services are not working" />
  - <LinkList to="/public-gateways/troubleshooting/gw-limitations/" label="Public Gateway limitations" />
</LinksList>
