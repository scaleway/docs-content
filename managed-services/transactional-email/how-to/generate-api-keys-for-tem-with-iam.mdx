...
This page shows you how to generate [API keys](/console/my-account/concepts/#api-key) wit IAM to send [transactional emails](/managed-services/transactional-email/concepts/#transactional-email) via API and SMTP.
...
<Message type="requirement">
  ...
  - You have added [SPF, DKIM](/managed-services/transactional-email/how-to/add-spf-dkim-records-to-your-domain) and [MX records](/managed-services/transactional-email/how-to/add-mx-records-to-your-domain) to your domain.
</Message>

## Generate an API key using IAM and send emails via the API

To send your emails via the API, a valid API key and your Project's ID are required.

1. [Create an application](/identity-and-access-management/iam/how-to/create-application/).
2. [Create a policy](/identity-and-access-management/iam/how-to/create-policy/) with an application as a principal type.
...
To send your emails using SMTP, a valid API key and your Project's ID are required.
