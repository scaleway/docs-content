...
- An [API key](/iam/credentials/create-api-keys/)
...
1. Retrieve the following elements:
    ...
    - the project ID of the [Scaleway project](/organizations-and-projects/project/create-a-project/) you want to use
    - the [access key and secret key](/iam/credentials/create-api-keys/) for your API key
