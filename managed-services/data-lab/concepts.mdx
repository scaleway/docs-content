...
A Data Lab is a project object grouping a Notebook and an Apache Spark Cluster.

## Distributed Data Lab

A Distributed Data Lab is a data lab that is distributed.
...
## Transaction
An SQL transaction is a sequence of one or more SQL operations (such as queries, inserts, updates, or deletes) executed as a single unit of work. These transactions ensure data integrity and consistency, following the ACID properties: Atomicity, Consistency, Isolation, and Durability, meaning all operations within a transaction either complete successfully or none of them take effect. An SQL transaction can be rolled back in case of an error.