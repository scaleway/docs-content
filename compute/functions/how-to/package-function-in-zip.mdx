...
excerpt: |
  This page explains how to package your code and upload it as a zip to Serverless Functions Console.
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/compute/functions/how-to/package-your-function-in-a-zip
categories:
  - compute
brands:
  - elements
image: /assets/images/docs/scaleway.png
permalink: docs/compute/functions/how-to/package-function-in-zip
keywords: Serverless, functions, zip, package, golang, python, javascript
---
