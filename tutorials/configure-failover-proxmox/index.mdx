...
8. Set the resolving DNS servers for the container. You can either configure the DNS servers provided by Scaleway Dedibox (`51.159.47.28` and `62.210.16.7`) or set your preferred DNS resolvers:
