...
2. Check the status of the backup using the `velero get backup` command:
    ...
    ```
    When you go to your Object Storage bucket in the [Scaleway console](https://account.scaleway.com/?service=elements), you notice the `backup` folder created by Velero:
