...
* **TLSA record**: TLS Authentication record, used to associate a TLS certificate or public key with the specified domain name. It allows you to store the fingerprint of a TLS/SSL certificate in the DNS zone of your domain.
