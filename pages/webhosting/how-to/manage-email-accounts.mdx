...
<Message type="tip">
  This guide focuses on managing your email accounts through the Scaleway console. For advanced configurations, you can access your [Web Hosting control panel](/webhosting/quickstart/#how-to-access-the-web-hosting-control-panel-from-the-scaleway-console).
</Message>
...
5. Select the domain you want to associate the email account with from the drop-down list, then enter a username and password.
    <Message type="tip">
        The username is the part of your email address preceeding the `@`.
    </Message>
