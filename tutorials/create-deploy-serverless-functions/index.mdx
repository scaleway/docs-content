...
meta:
  ...
  description: This page shows you how to deploy Serverless Functions and Triggers for demo purposes
content:
  h1: Deploying Serverless Functions and Triggers demo environment
  paragraph: This page shows you how to deploy Serverless Functions and Triggers for demo purposes
categories:
  - serverless
