...
<Navigation title="See Also">
  <PreviousButton to="/dedibox-console/account/how-to/update-password/">How to update your password</PreviousButton>
  <NextButton to="/dedibox-console/account/how-to/upload-an-ssh-key/">How to upload an SSH key</NextButton>
</Navigation>