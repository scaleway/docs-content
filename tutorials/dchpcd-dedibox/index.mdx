...
tags: storage dedibox
excerpt: |
  DCHPCD is an open source DHCP client, supporting both IPv4, and IPv6.
totalTime: PT15M
steps:
  - step: Installing DCHPCD
    type: HowToStep
    url: https://www.scaleway.com/en/docs/dedibox-dhcpcd-configuration-debian-10/#-Installing-DCHPCD
  - step: Configuring DCHPCD
    type: HowToStep
    url: https://www.scaleway.com/en/docs/dedibox-dhcpcd-configuration-debian-10/#-Configuring-DHCPCD
categories: 
  - dedicated servers
brands: 
  - dedibox
image: /assets/images/docs/scaleway.png
permalink: docs/dedibox-dhcpcd-configuration-debian-10/
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, server, dhcp, ipv6, slaac, dhcpcd
dates:
...
<Message type="note">
  ...
  We assume you have already generated a [IPv6 subnet and its associated DUID](https://documentation.online.net/en/dedicated-server/network/ipv6/prefix).
