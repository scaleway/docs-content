...
<<<<<<< HEAD:tutorials/zimbra-elastic-metal/index.mdx
  paragraph: Learn how to install and configure Zimbra Collaboration Suite Open Source Edition on a Scaleway Elastic Metal server with ease.
tags: messaging mail Zimbra-Open-Source-Edition collaboration Elastic-Metal server
steps:
  - step: Installing Zimbra Open Source Edition
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/zimbra-elastic-metal/#-Installing-Zimbra-Open-Source-Edition
  - step: Configuring Zimbra Open Source Edition
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/zimbra-elastic-metal/#-Configuring-Zimbra-Open-Source-Edition
  - step: Logging into Zimbra Open Source Edition
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/zimbra-elastic-metal/#-Logging-into-Zimbra-Open-Source-Edition
  - step: Securing the Connection to Zimbra
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/zimbra-elastic-metal/#-Securing-the-Connection-to-Zimbra
=======
...
>>>>>>> 96f3812d... docs(refactor): tutorials MTA-1681:tutorials/zimbra-bmaas/index.mdx
categories:
  - compute
  - elastic-metal
dates:
