...
8. Go to the Proxmox interface of your second ElasticMetal server and click **Cluster** to enter the cluster configuration from the Datacenter view of the machine. 

9. Click **Join Cluster** and paste the cluster join information in the form. 

10. Enter your first Elastic Metal servers `root` password and click **Join** to link the machine to the cluster. 
...
3. Enter the following information: 
  ...
  <Lightbox src="scaleway-px-create-frontend.png" alt="" />
