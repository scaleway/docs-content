...
You can manually add addresses to your blocklist in the Scaleway console. Once added, it remains blocked indefinitely until you decide to [unblock it](#how-to-unblock-an-email-adress).
