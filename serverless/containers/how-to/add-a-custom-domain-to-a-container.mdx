...
5. Enter your custom domain name and validate the form.
    <Message type="note">
      The console runs checks on the CNAME and TLS configuration of the custom domain name. See technical details below for more details.
    </Message>
6.  Connect to your container through that custom domain once the custom domain status is `ready`, you can
