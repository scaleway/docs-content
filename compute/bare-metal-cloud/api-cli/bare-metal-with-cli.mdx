---
title: Creating and Managing Bare Metal servers with the Scaleway Command Line Interface (CLI)
description: This page explains how to use the Scaleway CLI to create a Bare Metal Server and manage its lifecycle.
dates:
  validation: 2021-05-26
  posted: 2021-05-26
---

Scaleway’s [Bare Metal Cloud Servers](https://www.scaleway.com/en/bare-metal-servers/) provide you with dedicated servers on-demand, with all the benefits of the cloud including flexibility and hourly billing. These servers are great for large workloads, big data, and applications that require increased security and dedicated resources. You can create and manage your Bare Metal servers from the [Scaleway console](https://console.scaleway.com/), via the API or via the [Scaleway Command Line Interface](https://github.com/scaleway/scaleway-cli#scaleway-cli-v2) (CLI). In this tutorial, you will learn how to use the CLI to create a Bare Metal Server, install an OS and manage the lifecycle of the server.
...
There are many other functionalities you can access for your Bare Metal server via the Scaleway CLI. In the following examples, replace `your-bare-metal-server-ID` with your Bare Metal server's ID. 

<Message type="note">

 * Before powering off your Bare Metal server, we recommend you [log into your server as root](https://www.scaleway.com/en/docs/compute/bare-metal-cloud/how-to/connect-to-server/) and execute the `halt` command to shutdown the OS. 
...
### Powering off your Bare Metal Server
...
### Powering on your Bare Metal Server
...
### Rebooting your Bare Metal Server
...
<Message type="note">
 ...
 The `status` field now displays `deleting`. The deletion process may take a few minutes. 

</Message>


Enter the following command to make sure that your Bare Metal server has been deleted:
