...
totalTime: PT10M
steps:
  - step: Create the GitLab Server
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-use-the-gitlab-instant-apps/#-Create-the-GitLab-server
  - step: Open the mail ports to send email
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-use-the-gitlab-instant-apps/#-Open-the-mail-ports-to-send-email
  - step: Log into GitLab
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-use-the-gitlab-instant-apps/#-Log-into-GitLab
categories:
  - compute
brands:
  - elements
image: /assets/images/docs/scaleway.png
permalink: docs/how-to-use-the-gitlab-instant-apps/
...
2. Define a new password for your GitLab account.
  ...
  <Lightbox src="scaleway-gitlab-login.png" alt="" />
...
<Lightbox src="scaleway-gitlab-interface.png" alt="" />
