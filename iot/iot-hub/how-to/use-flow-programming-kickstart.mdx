...
excerpt: |
  This page explains how to use the Flow Programming Kickstart
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
...
<Navigation title="See Also">
  <PreviousButton to="/iot/iot-hub/how-to/use-faas-kickstart/">How to use the Function as-a-Service Kickstart</PreviousButton>
