...
excerpt: |
  This page explains how to generate an API key
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
...
keywords: api, api key, credentials, Howto
dates:
...
<Navigation title="See Also">
  <PreviousButton to="/console/my-project/how-to/create-ssh-key/">How to create an SSH Key</PreviousButton>
