...
meta:
  title: Block Storage
  description: Discover the differences between file storage and Block Storage and get your performance and security concerns answered. 
content:
  h1: Block Storage
  paragraph: Discover the differences between file storage and Block Storage and get your performance and security concerns answered. 
