...
You can easily backup your existing dedicated server with Duplicity. When you are using a [Online by Scaleway Dedibox](https://www.online.net/en/dedicated-server) or a [Scaleway Elastic Metal server](https://www.scaleway.com/en/elastic-metal/), the data transfer is free of charge within the same region.
