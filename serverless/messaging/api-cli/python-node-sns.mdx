...
<Message type="requirement">
  ...
  - You have [created an SNS/SQS Messaging and Queuing namespace](/serverless/messaging/how-to/create-namespace/)
...
<Message type="note">
  ...
  The `Endpoint` for Scaleway Messaging and Queuing is `https://sqs-sns.mnq.fr-par.scw.cloud`. The values for the access and secret keys should be the credentials you [generated](/serverless/messaging/how-to/create-credentials/) for your SNS/SQS namespace.
...
<Message type="note">
  The `endpoint_url` for Scaleway Messaging and Queuing is `https://sqs-sns.mnq.fr-par.scw.cloud`. The values for the access and secret keys should be the credentials you [generated](/serverless/messaging/how-to/create-credentials/) for your SNS/SQS namespace.
</Message>
...
<Message type="note">
  The `endpoint_url` for Scaleway Messaging and Queuing is `https://sqs-sns.mnq.fr-par.scw.cloud`. For the access and secret key values, use the credentials you [generated](/serverless/messaging/how-to/create-credentials/) for your SNS/SQS namespace.
</Message>
...
const rest = await snsClient.send(command);
const subscriptionsList = rest.Subscriptions;
