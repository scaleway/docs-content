...
Yes, you can chain several VPCs using peering connectors, and enable transitivity between up to four VPCs using custom routes. Refer to the [dedicated documentation](/vpc-peering/reference-content/understanding-transtive-peering/) for more information.
