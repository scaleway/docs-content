...
<Message type="requirement">
  ...
  - You have [created a Production-Optimized Instance](/compute/instances/how-to/create-an-instance/) with at least 8 GB RAM and 25 GB Block Storage, running on Ubuntu 20.04 LTS
  - You have [installed Ruby 3.2.2](/tutorials/ruby-on-rails/) on the Instance
