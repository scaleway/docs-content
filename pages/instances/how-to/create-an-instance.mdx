...
<Tabs>
  ...
  <TabsTab label="Console - Linux">
    ...
    8. Click **Create Instance** to create the Instance directly, or **Create Instance and save as template** to reuse it as a template later. See [Create and manage Instance templates](/instances/how-to/create-manage-instance-templates) for more information.<br/> Your Instance begins provisioning, and you will be notified once it's ready.
  ...
  <TabsTab label="Console - Windows">
    ...
    7. Click **Review** to see an order summary, including the estimated cost of your Instance based on the specifications you chose.
    8. Click **Create Instance** to create the Instance directly, or **Create Instance and save as template** to reuse it as a template later. See [About Instance templates](/instances/how-to/create-manage-instance-templates) for more information.<br/> Your Instance begins provisioning, and you will be notified once it's ready.
