...
1. [Create a new Project](/console/organizations-and-projects/how-to/create-a-project/) in the Organization, with the name `my-second-project`.
    <Message type="note">
