...
To be able to use the Private Network of the Elastic Metal server on several VM's a bridge is required. Bridges are like physical network switches implemented in software. 
