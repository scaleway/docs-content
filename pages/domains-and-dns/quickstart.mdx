...
4. Click **+ Add zone** to create a new DNS zone. A dialog box prompts you to enter a name for the new DNS zone.
...
2. Click the domain you want to manage. The **Overview** tab opens.
3. Click the **DNS zones** tab. A list of the DNS zones you have configured within the selected domain displays.
4. Click the DNS zone containing the record you want to delete. The list of records within the selected zone displays.
