...
1. Click **Transactional Email** in the **Domains & Web Hosting** section of the [console](https://account.scaleway.com/?service=elements) side menu. Your domains display.
