...
- Number of Mailboxes: 20 Mailbox email accounts per project (during Beta phase). If you need to create more mailboxes, contact [Scaleway Support](https://console.scaleway.com/support/tickets/create?for=product&productName=mailbox).
- Number of aliases: 5 aliases per Mailbox email account (during Beta phase). If you need to create more aliases, contact [Scaleway Support](https://console.scaleway.com/support/tickets/create?for=product&productName=mailbox).
