...
tags: GLPI Asset Management sysadmin Managed Database MySQL Nginx
categories:
  - compute
  - managed-databases
...
In this tutorial we will install and configure a [LEMP-Stack](https://lemp.io/) using [Ngnix](https://nginx.org/), a Database for [MySQL](https://www.scaleway.com/en/databases/) and [PHP](https://www.php.net/).
