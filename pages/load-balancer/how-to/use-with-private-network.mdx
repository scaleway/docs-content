...
5. Either:
    ...
    - Alternatively, select **Create a new Private Network** in the list. You are prompted to select the VPC it should be created in, and to enter a name and tags for the Private Network. The Private Network will be created with default configuration, meaning its [CIDR block](/vpc/concepts#cidr-block) will be automatically defined.
