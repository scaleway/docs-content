...
FTP, or File Transfer Protocol, is a protocol that allows you to transfer files between different computers over the Internet. It allows you, as part of our webhosting offer, to transfer your files from your computer to scaleway.com - for example, to update your website. It also works the other way around: you can recover the files stored on Sscaleway.com and transfer them to your personal computer, for example to make a backup.
