...
[Private Networks](https://www.scaleway.com/en/docs/network/public/quickstart/) allow you to configure your Layer-2 network with IPv4 addresses on Managed Database for Redis™ Instances.
