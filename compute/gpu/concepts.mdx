...
Scaleway provides a number of pre-built Docker images, which allow you to [run a Docker container on your GPU Instance](/compute/gpu/how-to/use-gpu-with-docker/) and access a pre-installed Pipenv environment ideal for your AI projects.
...
It is used for short-term storage of data that is being actively processed, but it is not meant for long-term or permanent storage. 
It is an ephemeral storage solution that does not support features like snapshots, backups, or restores.
