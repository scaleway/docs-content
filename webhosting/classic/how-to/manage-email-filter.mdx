...
6. Type in **[Auto reply]** in **Message subject**. 
    ...
    <Lightbox src="scaleway_auto_reply1.png" alt="" />

7. Click **Save**. 


<Navigation title="See Also">
  <PreviousButton to="/webhosting/classic/how-to/retrieve-headers-of-email/">Retrieve the header of an email</PreviousButton>
  <NextButton to="/webhosting/classic/how-to/solve-email-account-connection-problems/">Solve email account connection problems</NextButton>
</Navigation> 