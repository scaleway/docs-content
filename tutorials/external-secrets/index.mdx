...
A secret with the name `kubernetes-secret-to-be-created` should be present in your namespace and contains the secret pulled from the Scaleway Secret manager :
