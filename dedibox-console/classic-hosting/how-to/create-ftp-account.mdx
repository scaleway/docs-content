...
**F**ile **T**ransfer **P**rotocol is a standard way to transfer files between a client (such as your local computer) and a server (such as your Scaleway webhosting server) via the internet. In order to [use FTP](/dedibox-console/classic-hosting/how-to/connect-via-ftp/), you must first create an account.
