...
<Message type="important">
  ...
  To avoid message loops, in case your route subscribes to hub events, routes will drop events generated from themselves. You need to make sure messages don't loop between different routes though.
