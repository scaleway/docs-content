...
<Message type="tip">
  - You can also reboot your server via [KVM](/kvm-over-ip/). In the iDRAC and iLO KVM interfaces, you can switch your server OFF and ON again. This allows you to check what happens during its boot sequence and intervene if necessary.
