...
- Some extensions, such as `pg_audit`, must be configured from the [advanced settings](/postgresql-and-mysql/how-to/configure-advanced-settings) tab in the console. Refer to the [Setting up and using pgaudit](/postgresql-and-mysql/api-cli/pg-audit/) documentation page for more information.
