...
Thanks to its a3b architecture, only a subset of its weights are activated for a given generation, leading to a much faster input and output token processing, ideal for code completion.
