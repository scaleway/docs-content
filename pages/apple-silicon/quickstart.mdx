...
1. In the [console](https://console.scaleway.com/) side menu, click **Bare Metal** > **Apple silicon**. The [Apple silicon creation page](https://console.scaleway.com/asaas/servers) opens.
...
For OS-specific information (Windows, Linux, and macOS), see [How to access the remote desktop of a Mac mini](/apple-silicon/how-to/access-remote-desktop-mac-mini/).
...
3. Click the name of the Mac mini you want to connect to. The **Overview** page for your selected Mac mini opens.
...
1. In the [console](https://console.scaleway.com/) side menu, click **Bare Metal** > **Apple silicon**. A list of your Mac minis appears.
2. Click <Icon name="more" /> next to the Mac mini you want to delete and select **Delete** from the dropdown. A confirmation dialog appears.
3. Type **DELETE**, then click **Delete Mac mini**.

The list of your Mac minis is displayed, where the machine you deleted no longer appears.
