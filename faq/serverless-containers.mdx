...
Serverless Containers are billed on a pay as you GB basis strictly on resources (Memory and CPU) consumptions. 
...
<Lightbox src={["assets/scaleway-caas-billing-1.jpg","assets/scaleway-caas-billing-2.jpg"]} size={"medium"}  alt={["Scerverless Containers Billing","Serverless Containers Billing"]} />

### Prices 

* **Memory consumption:** €0.10 per 100k GB/s and we provide **400 000 GB/s Free Tiers** per account and per month.
* **vCPU consumption:** €1.0 per 100k vCPU/s after a **200 000 vCPU/s Free Tiers** per account per month.
...
| Amount of vCPU allocated (for now automatic depending on the tiers used) 	| 70 mCPU      	|
| Free Tiers                                                               	| Yes          	|
