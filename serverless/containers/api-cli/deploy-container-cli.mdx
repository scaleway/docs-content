...
2. Type `n` and go directly to the [Creating a containers namespace](#creating-a-containers-namespace) step of this procedure if you do not want to edit your configuration.
...
```
scw container deploy name=<FR_NAME> namespace-id=<NAMESPACE_ID> runtime=<YOUR_RUNTIME> zip-file=path/to/archive/<ZIP_FILE>
```
