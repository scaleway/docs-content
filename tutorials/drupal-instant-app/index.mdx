...
The new security group configuration will be applied automatically on Virtual Instances. Bare Metal servers need to be hard rebooted from the management console to configure the new rules.
