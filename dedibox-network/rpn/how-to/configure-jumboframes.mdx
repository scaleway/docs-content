---
meta:
  title: How to configure Jumboframes
  description: This page explains how to configure Jumboframes
content:
  h1: How to configure Jumboframes
  paragraph: This page explains how to configure Jumboframes
dates:
