...
content:
  h1: How to set up SSL offloading
  paragraph: This page explains how to set up SSL offloading
dates:
  validation: 2021-12-31
  posted: 2021-05-26
---

Encrypted HTTPS traffic can be handled in two ways with Scaleway Load Balancers. You can configure managed SSL offloading using either  **Let’s Encrypt Certificates** or **third party SSL Certificates**.
