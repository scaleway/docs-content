...
- Throughput is capped at approximately 100,000 packets per second, regardless of the Public Gateway bandwidth. Workloads that with a high rate of small packets (such as ping commands) are therefore more likely to hit this limit than larger transfers.
