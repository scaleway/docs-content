...
First released in 2004, Ubuntu whose name is based on an ancient African word meaning ‘humanity to others’, became quickly the favourite Linux distributon of users around the world, mostly because it is easy to install and use. 
...
We therefore recommend that you create a regular user account for daily operations. The steps for doing this are outlined [later in this tutorial](#adding-regular-users-on-ubuntu).
...
Ubuntu uses the [Advanced Packaging Tool (APT)](https://ubuntu.com/server/docs/package-management) to mange its 60,000+ pre-compiled software packages.
