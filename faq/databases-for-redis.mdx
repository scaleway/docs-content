...
Using Databases for Redis™ as a cache optimizes the speed of your requests as copies of the most frequently used data are stored in memory, making them accessible in milliseconds. [Learn more about Redis™ databases](ADD_LINK_HERE).
...
It also increases the security of your databases, since Instances in your Private Network can directly be connected to your Redis™ Instance, without passing through the public Internet.
