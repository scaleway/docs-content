...
excerpt: |
  This page explains how to connect to a Dedibox server
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/dedibox/dedicated-servers/how-to/connect-to-server
image: /assets/images/docs/scaleway.png
keywords: console, my-account, Howto, connect, ssh
dates:
