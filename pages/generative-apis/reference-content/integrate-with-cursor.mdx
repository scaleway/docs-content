...
description: Learn how to integrate Scaleway Generative APIs with Cursor AI code editor for enhanced coding assistance using models like qwen3.6-35b-a3b. Includes visual configuration guide.
