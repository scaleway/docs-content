...
Refer to [our documentation for code examples](https://www.scaleway.com/en/docs/generative-apis/how-to/use-structured-outputs/), including usage with Pydantic models or manual schema definitions.
