...
Dedicated control planes are available in the [Scaleway console](https://account.scaleway.com/?service=elements), the CLI, and Terraform. Refer to [our documentation](/kubernetes/reference-content/kubernetes-control-plane-offers/) for more information.
