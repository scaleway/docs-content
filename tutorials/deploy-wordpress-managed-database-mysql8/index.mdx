...
tags: compute database mysql dbaas wordpress blog
excerpt: |
  In this tutorial you will learn how to setup your own Wordpress blog on a Virtual Compute Instance backed by Scaleway Database for MySQL 8 to improve your blogs speed, reliability and overall performance. Scaleway Database for MySQL 8 provides up to 48 cores and 256 GB of RAM.
totalTime: PT20M
steps:
  - step: Preparing the managed database
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/deploy-wordpress-managed-database-mysql8/#Preparing-the-managed-database
  - step: Preparing the compute instance
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/deploy-wordpress-managed-database-mysql8/#Preparing-the-compute-instance
  - step: Downloading and installing Wordpress
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/deploy-wordpress-managed-database-mysql8/#Downloading-and-installing-Wordpress
  - step: Securing the connection using TLS
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/deploy-wordpress-managed-database-mysql8/#Securing-the-connection-using-TLS
  - step: Configuring Wordpress
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/deploy-wordpress-managed-database-mysql8/#Configuring-Wordpress
categories:
  - storage
  - database
image: /assets/images/docs/scaleway.png
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, debian server, linux server, database, mysql, managed database, dbaas, mysql 8, wordpress, blog, selfhosted, self-hosted
dates:
...
In this tutorial you will learn how to setup your own [Wordpress](https://wordpress.org) blog on a Virtual Compute Instance and backed by Scaleway Database for MySQL 8 to improve your blogs speed, reliability and overall performance. Scaleway Database for MySQL 8 provides up to 48 cores and 256 GB of RAM.
...
- You have an account and are logged into the [Scaleway Console](https://console.scaleway.com)- You have [configured your SSH Key](/console/my-project/how-to/create-ssh-key/)
- You have a Scaleway Elements Instance running Ubuntu Bionic Beaver (18.04 LTS)
- You have a [Managed Database](https://www.scaleway.com/en/database/) for MySQL v8

</Message>

## Preparing the managed database

1. Go to the [Database section](https://console.scaleway.com/rdb/instances) of your Scaleway console and choose your Managed Database Instance from the list:
<Lightbox src="scaleway-db_list.png" alt="" />

2. Click the **Databases** tab. A list of your existing databases exist. Click **+ Create Database** to create a new database:
<Lightbox src="scaleway-new_db_1.png" alt="" />

3. Enter a name for your new database, for example `wordpress` and confirm by clicking on **Create Database**:
<Lightbox src="scaleway-new_db_2.png" alt="" />
...
<Lightbox src="scaleway-db_allowed_ips.png" alt="" />
...
1. Connect yourself to your compute instance using [SSH](/compute/instances/how-to/connect-to-instance/).
  ```
...
<Lightbox src="scaleway-managed_database_wp_config.png" alt="" />
...
By default HTTP is a plain text protocol and does not use any encryption. To secure the connection between the client and the server, we are going to use the [TLS protocol](https://en.wikipedia.org/wiki/Transport_Layer_Security) using a certificate issued by the [Let's Encrpt](https://letsencrypt.org/) certificate authority. We are going to use a tool, called `certbot` which manages the the configuration of the Apache2 web server, the certificate creation and renewal of it. [Certbot](https://certbot.eff.org/) is developed and maintained by the Electronic Frontier Foundation ([EFF](https://www.eff.org/)].
...
<Lightbox src="scaleway-wp_install_1.png" alt="" />
...
<Lightbox src="scaleway-wp_install_2.png" alt="" />
...
<Lightbox src="scaleway-wp_install_3.png" alt="" />
