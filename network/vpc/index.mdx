...
>
  Try out the new [VPC routing](/network/vpc/concepts/#routing) feature, currently in public beta. Routing lets Private Networks in the same VPC communicate with each other, via automatically-created and managed routes.
</Alert>
