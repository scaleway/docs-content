...
<Message type="tip">
  This page explains how to deploy containers using Scaleway Console but for advanced usage (ex: larger projects with dependencies, automation, multiple containers...) [several ways to deploy containers](/serverless/containers/reference-content/deploy-container/) are available.
