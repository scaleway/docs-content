...
For more information about Docker's architecture, refer to the [offical documentation](https://docs.docker.com/get-started/overview/#docker-architecture).
...
Prior to installing Docker Engine on a new host machine, you must configure the Docker repository. Once the repository is set up, you can proceed to install and keep Docker updated directly from the repository.
