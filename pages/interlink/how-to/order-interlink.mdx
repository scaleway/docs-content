...
2. Click **Create InterLink**. The creation wizard displays.
    ...
    <Lightbox src="TODO UPDATE scaleway-order-interlink.webp" alt="A screen of the Scaleway console shows the InterLink order form. The different sections are explained in the steps below." />
