...
<Message type="important">
  If you are managing your cluster using Terraform, be aware that the `private_network_id` field can only be set at cluster creation and cannot be updated later. **Changes to this field will cause the cluster to be destroyed then recreated.**
</Message>
