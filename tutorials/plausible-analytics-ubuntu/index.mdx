...
Plausible Analytics is an open-source web analytics project with the mission to make analytics more privacy-friendly. It is possible to self-host the solution on Scaleway Instances and to reduce the dependency and surveillance of other tools coming from the AdTech world.
