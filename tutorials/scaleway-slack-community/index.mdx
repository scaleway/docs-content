...
1. Access the [Scaleway homepage](https://www.scaleway.com/en/) and on the bottom, click **Chat Room** or access it directly via [this link](https://scaleway-community.slack.com/join/shared_invite/zt-19uuwgo5h-bofWNwE~jijt70lQkziQxg#/shared-invite/email/).
