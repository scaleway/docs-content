...
Pipenv is pre-installed on all of Scaleway's AI Docker images for GPU Instances, making it easy to [create your own virtual environments](/compute/gpu/how-to/use-pipenv/). Pipenv replaces Anaconda for this purpose.
