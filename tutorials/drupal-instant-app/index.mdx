...
The new Security Group configuration will be applied automatically on Virtual Cloud Instances. Bare Metal Cloud Instances need to be hard rebooted from the management console to configure the new rules.
