...
4. Click the **Settings** tab and navigate to the **Scaling** section.
5. Click **Update node count** and adjust the number of nodes in your deployment.
    <Message type="note">
      High availability is only guaranteed with two or more nodes.
    </Message>
6. Click **Update node count** to update the number of nodes in your deployment.
    <Message type="note">
