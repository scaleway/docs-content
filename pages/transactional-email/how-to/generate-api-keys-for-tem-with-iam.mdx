...
- Added [SPF, DKIM](/transactional-email/how-to/configure-bimi/), and [MX](/transactional-email/how-to/authenticate-domain/#how-to-configure-mx-records) records to your domain
