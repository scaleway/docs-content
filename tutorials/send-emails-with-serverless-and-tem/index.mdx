...
meta:
  ...
  description: Discover how to send emails with Scaleway's Transactional Email and Serverless using Terraform
content:
  h1: Sending emails with Transactional Email and Serverless using Terraform
  paragraph: Discover how to send emails with Scaleway's Transactional Email and Serverless using Terraform
