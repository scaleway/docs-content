...
Continue to the next section for [configuring a backend](#how-to-create-a-backend-during-creation-of-your-load-balancer). You will finalise creation of your frontend and backend at the same time, at the end of this section.
