...
tags: apps compute shop online shopping e-commerce prestashop
excerpt: |
...
permalink: docs/tutorials/prestashop-instantapp/
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, debian server, linux server, Object Storage, IAAS, baremetal, scalability, ARM, physical server, dedicated server, physicalization, online shop, e-commerce, shopping, prestashop, shop
dates:
...
<Message type="tip">
 ...
 BareMetal cloud instances need to be hard rebooted from the management console to configure the new rules.
