...
We use [Duplicity](https://duplicity.gitlab.io/duplicity-web/) to encrypt the backup and upload it to Object Storage. Then we download and decrypt the data on the Elastic Metal server.
