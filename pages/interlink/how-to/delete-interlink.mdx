...
2. Click on the InterLink that you want to delete. The InterLink's **Overview** page displays.
    ...
    <Lightbox image={image} alt="A screen in the Scaleway console shows an overview of an InterLink's partner, location, region, bandwidth, creation date, pairing key, and IPv4/IPv6 connectivity status. Underneath are the 'Attached VPC', 'Route propagation' and 'Tags' panels." />
