...
4. In the top right corner, click **Edit**. A pop-up displays.
    ...
    <Lightbox src={image2} alt="A screenshot of the Scaleway console displays, showing a screen for editing an Edge Services Load Balancer pipeline. Modifiable elements are protocol, origin host and name" />
