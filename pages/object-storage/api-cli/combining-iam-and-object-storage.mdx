...
IAM is central, and relies on policies to manage a [principal](/iam/concepts/#principal)'s rights in the entire Scaleway ecosystem. When you favor simplicity over granularity and do not need to configure access to specific buckets, using IAM alone is sufficient.
...
### IAM
[Identity and Access Management (IAM)](/iam/concepts/#iam) allows you to control and manage access to your resources. 
