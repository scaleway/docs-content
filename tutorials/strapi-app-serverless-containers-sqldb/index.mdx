...
You can either deploy your application:
  - [step by step using the Scaleway CLI](#deploy-strapi-headless-cms-using-scaleway-cli) to understand each action performed in details, and the resources required
...
- You have installed and configured the [Scaleway CLI](/developer-tools/scaleway-cli/quickstart/). Running the `scw account project get` command should return the following output:
    ```
