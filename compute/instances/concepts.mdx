...
[General Purpose Instances](https://www.scaleway.com/en/virtual-instances/general-purpose/) (aka GP Instances) are production-grade [Instances](#instance) designed for scalable infrastructures. Two generations are available: 1st generation GP1 Instances, and the 2nd generation, PRO2 Instances. General Purpose Instances allow you to launch high-performance services with local NVMe SSDs (GP1 only) and/or block volumes and high-end CPUs.
