...
- You have one of the following remote machines running Ubuntu:
...
- You have [configured your SSH Key](/console/my-project/how-to/create-ssh-key)
  ...
  <Message type="note">
    ...
    This tutorial has been validated for machines running Ubuntu Xenial and Ubuntu Focal Fossa.
...
1. [Connect to your machine via SSH](/compute/instances/how-to/connect-to-instance/):
...
5. Copy the `testuser.pem` and `scaleway-file.pem` files from the Chef server to the folder you created in your Chef workstation with the following commands:
  ...
  scp root@hef_server_domain_or_IP:/root/scaleway-file.pem ~/chef_repo/.chef
  ```
...
By default, you cannot connect to a Scaleway Instance with a password. For more information, refer to the dedicated [Ubuntu Forum](https://askubuntu.com/questions/101670/how-can-i-allow-ssh-password-authentication-from-only-certain-ip-addresses)
...
2. Paste the following information replacing the information with your infrastructure information:
  ...
  chef_server_url          "https://domain_name_or_public_IP/organizations/scaleway"
  syntax_check_cache_path  "#{ENV['HOME']}/.chef/syntaxcache"
  cookbook_path            ["#{current_dir}/../cookbooks"]
  ```
