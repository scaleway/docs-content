...
<Message type="tip">
  This page explains how to deploy a containers using Scaleway Console but for advanced usage (ex: larger project with dependencies, automation, multiple containers...) there are a [lot of ways to deploy containers](/serverless/containers/reference-content/deploy-container/).
