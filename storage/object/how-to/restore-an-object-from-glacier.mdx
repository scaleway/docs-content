...
5. Click **Restore object from S3 Glacier**.
    <Message type="note">
      ...
      If you did not select the option to send your object to back to Glacier, your object will remain in STANDARD class permanently. 
      
      You can to send your object back to Glacier class manually at any time. 
    </Message>
