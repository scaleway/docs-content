...
6. Create a `production.yaml` file by opening it in a text editor. This file allows to overwrite the default configuration values in the file `./server/config/default.yaml`.
