...
2. The following message displays:
    ...
    Enter either the email address for your account (you will then be asked for your password), or your [API secret Key](/identity-and-access-management/organizations-and-projects/how-to/create-ssh-key) when prompted by the following message:
