...
3. Select **PostgreSQL-13** from the dropdown list and fill in the [required information](/managed-database/postgresql-and-mysql/how-to/create-a-database/) for your new database Instance. Then click **Create an Instance**. Your database is created and you are redirected to the database dashboard.
...
5. Once the migration is complete, [delete](/managed-database/postgresql-and-mysql/how-to/delete-a-database/) the old Database Instance from your account. 
