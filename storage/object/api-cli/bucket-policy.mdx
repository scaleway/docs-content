...
The different elements of a bucket policy allow you to [configure fine-grained permissions](/object/api-cli/combining-iam-and-object-storage/) when combined with [Identity and Access Management (IAM)](/iam/concepts/#iam), as shown in the table below.
...
<Message type="note">
    Refer to the [documentation on bucket policy versions](/object/api-cli/bucket-policy/#bucket-policies-versions) for more information.
</Message>
...
Refer to our [dedicated documentation](/object/api-cli/manage-bucket-permissions-ip/) for more information on managing bucket permissions for IP addresses or ranges of IP.