...
Scaleway's Hardware Security Modules are certified to Federal Information Processing Standard - FIPS 140-3 Level 3.

HSM-backed keys are currently only available in the Paris (FR-PAR) region.

The following table provides a list of products that support Key Manager integration. The list is updated continuously with new items as work progresses to add support for more products.
