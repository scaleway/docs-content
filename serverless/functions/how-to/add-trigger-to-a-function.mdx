...
The configuration of the queue retention may affect the behavior of the trigger. See [How to configure event retention for trigger inputs](/serverless/functions/how-to/configure-trigger-inputs/).
