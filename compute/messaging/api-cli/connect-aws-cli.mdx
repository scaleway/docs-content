---
meta:
  title: Connecting Scaleway Messaging SNS/SQS to the AWS-CLI
  description: This page explains how to connect Scaleway Messaging SNS/SQS to the AWS-CLI
content:
  h1: Connecting Scaleway Messaging SNS/SQS to the AWS-CLI
  paragraph: This page explains how to connect Scaleway Messaging SNS/SQS to the AWS-CLI
tags: messaging
categories: 
  - messaging
---
...
This guide shows you how to install the AWS-CLI and configure it for connection to your Messaging namespace.
...
2. Open the `~/.aws/config` file you just created in a text editor and edit it as follows:
  ...
  [default]
  sns =
	endpoint_url= http://51.159.73.139:4280
  sqs =
	endpoint_url= http://51.159.73.139:4280 
  ```
