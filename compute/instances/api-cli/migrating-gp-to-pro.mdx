...
This page explains how to migrate from a DEV1/GP1 Instance with local storage to a PLAY2/PRO2 Instance with [Block Storage](/compute/instances/concepts/#block-volumes) using the [Scaleway APIs](https://www.scaleway.com/en/developers/api/) and the [Scaleway CLI](https://github.com/scaleway/scaleway-cli#scaleway-cli-v2).
