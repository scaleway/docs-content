...
<Message type="important">
  ...
  To utilize the pre-installed SSH server and access the nodes within the cluster, you have to manually [configure a custom rule](https://www.scaleway.com/en/docs/compute/instances/how-to/use-security-groups/#how-to-edit-a-security-group) in your clusters' security group to allow incoming traffic on TCP port 22.
</Message>
