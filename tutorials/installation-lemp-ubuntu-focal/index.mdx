...
content:
  ...
  paragraph: Discover step-by-step instructions to set up the LEMP stack on Scaleway Instances with Ubuntu Focal Fossa (20.04). Enhance your web server for top performance and security.
...
- An [Instance](/instances/how-to/create-an-instance/) running on Ubuntu 20.04 (Focal Fossa)
