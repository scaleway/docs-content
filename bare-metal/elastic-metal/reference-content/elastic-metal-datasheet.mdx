...
meta:
  ...
  description: This page shows the technical characteristics of the Elastic Metal offer.
content:
  h1: Elastic Metal - Technical product specification
  paragraph: This page shows the technical characteristics of the Elastic Metal offer.
...
The datasheet for Elastic Metal servers provides a concise overview of their performance, technical features, components, materials, and associated documentation.
## Aluminium range
