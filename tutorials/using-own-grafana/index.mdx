...
3. Retrieve the URL of the metrics data source you want to add from the [Data sources tab](https://account.scaleway.com/?service=elementscockpit/fr-par/dataSource) of the Scaleway console. Make sure that the region in the URL is the one where your data source is located.
...
3. Retrieve the URL of the logs data source you want to add from the [Data sources tab](https://account.scaleway.com/?service=elementscockpit/fr-par/dataSource) of the Scaleway console.
...
3. Retrieve the URL of the traces data source you want to add from the [Data sources tab](https://account.scaleway.com/?service=elementscockpit/fr-par/dataSource) of the Scaleway console.
4. Paste your logs' URL in the **URL** field of the **HTTP** section.
