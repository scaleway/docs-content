...
| Max Scale (simultaneous Container instances)      | Max            | 200               | Container                   |
...
These limits are enforced as [Organization quotas](/organizations-and-projects/organization/organization-quotas/#serverless-containers).
