...
steps:
  ...
  - step: Preparing the Virtual Instance
    type: HowToStep
...
3. Click **Add IP** and enter the IP of your Virtual Instance in CIDR notation (for example: `51.15.123.234/32`)
...
1. Connect yourself to your Virtual Instance using [SSH](/compute/instances/how-to/connect-to-instance/).
  ```
