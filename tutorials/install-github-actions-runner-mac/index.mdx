...
meta:
  ...
  description: How to set up and configure a bare metal Mac mini as a self-hosted runner for GitHub Actions
content:
  h1: Installing a Github Actions runner on a Mac mini
  paragraph: How to set up and configure a bare metal Mac mini as a self-hosted runner for GitHub Actions
...
6. [Connect](/bare-metal/apple-silicon/how-to/connect-to-mac-mini-m1/) to your Mac mini using VNC. 
    <Message type="note">
...
This tutorial showed you how to set up, configure, and connect a self-hosted runner on a Mac mini for executing macOS pipelines. The runner is now ready to be used in your workflows. For more information, visit [Managing self-hosted runners on Github Docs](https://docs.github.com/en/actions/hosting-your-own-runners/managing-self-hosted-runners).
