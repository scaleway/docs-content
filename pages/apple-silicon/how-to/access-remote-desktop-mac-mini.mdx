...
- [Owner](/iam/concepts/glossary/#owner) status or [IAM permissions](/iam/concepts/glossary/#permission) allowing actions in the intended Organization
...
<Accordion>
  ...
  1. Click **Apple silicon** in the **Bare Metal** section of the side menu. A list of your Mac minis appears.
  2. Click the Mac mini you want to connect to. The **Overview** page of your Mac mini opens.
  ...
  <Message type="note">
    macOS may ask for your password after you log in to the remote desktop session. Before entering your password, change the macOS keyboard layout to match the local layout of your computer. Click **U.S. keyboard** in the top right corner to display the list of available keyboard layouts.
  </Message>
...
<Accordion>
  ...
  3. Configure your remote desktop client for Windows for the connection. We suggest using one of these two remote desktop clients:
    ...
    - **Devolutions Remote Desktop Manager:**
      ...
      - Click **+** and **New Entry**
      - Choose **ARD**
      - Enter the IP address of the Mac mini in the **Host** field. Then, specify the port in the **Port** field, along with your username and password (located in the console).
      - Open the session
    ...
    - **RealVNC:**
      ...
      - In the **VNC Server** field, enter the IP address of the Mac mini, followed by the port (e.g., `192.168.1.100:5901`), then create the connection.
  ...
  3. Configure your remote desktop client for the connection. We suggest using one of these two remote desktop clients:
      - **Remmina:**
        ...
        - Enter the following parameters:
          ...
          - **Server**: The public IP address of your Mac mini (found on its **Overview** page in the Scaleway console), followed by the port number, separated by a colon (e.g., `192.168.1.100:5901`).
