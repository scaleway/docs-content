...
- Added [SPF, DKIM](/transactional-email/how-to/authenticate-domain/#how-to-configure-spf-records), and [MX](/transactional-email/how-to/authenticate-domain/#how-to-configure-mx-records) records to your domain(s)
...
- The **Email status** drop-down allows you to target specific emails according to their **status** or their **flags**.
    ...
    | Spam                                                               | Your email has been considered spam. [Find out how to abide by emailing best practices](/transactional-email/reference-content/understanding-tem-reputation-score/#best-practices-for-domain-reputation-and-deliverability). |
