...
- Inspect your newly created resources in the Scaleway console:
  ...
  - You can display your **Registry namespace** and **container image** in the [Container Registry section](https://account.scaleway.com/?service=elementsregistry/namespaces).

  - You can display your **Serverless Containers namespace** and **container deployment** in the [Serverless Containers section](https://account.scaleway.com/?service=elementscontainers/namespaces).

  - You can display your **Serverless SQL Database** in the [Serverless SQL Databases section](https://account.scaleway.com/?service=elementsserverless-db/databases).
...
- You have installed and configured the [Scaleway CLI](/scaleway-cli/quickstart/). Running the `scw account project get` command should return the following output:
    ...
    ```
  <Message type="tip">
  You can also find and compare your Project and Organization ID in the [Scaleway console settings](https://account.scaleway.com/?service=elementsproject/settings).
  </Message>
