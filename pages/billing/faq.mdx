...
It is impossible to edit your VAT number once a value has been set. [Contact Scaleway Support](https://console.scaleway.com/support/tickets/create) if you need to update it.

This limitation does not cause any billing or compliance problems for French customers who are not entitled to reclaim VAT:
...
- **No VIES impact:** Displaying the VAT number on the invoice will not trigger any issues in VIES (European VAT Information Exchange System), as the number is for display purposes only and is not being used to claim an exemption.
