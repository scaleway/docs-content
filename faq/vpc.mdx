...
Nonetheless, you can also reserve specific IPs from a Private Network's CIDR block, and use these IPs to attach specific resources, if you prefer. See our [dedicated documentation](/network/ipam/how-to/reserve-ip/) on reserving IPs for more information.
