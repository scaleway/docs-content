...
* Migration policies:
  ...
  * *Recommended action:* Delete your old pools and create new ones with **containerd** as default, either via API or from the Scaleway console. [Learn how  in this tutorial.](https://www.scaleway.com/en/docs/containers/kubernetes/how-to/change-container-runtime-interface/)
