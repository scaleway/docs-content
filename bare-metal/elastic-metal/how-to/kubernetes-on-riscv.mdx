...
If you don't have a Kosmos cluster, you can follow [this guide](https://www.scaleway.com/en/docs/containers/kubernetes/how-to/create-kosmos-cluster/) to create your first Kosmos cluster.

If you don't have an Elastic Metal RV1, you can follow [this guide](https://www.scaleway.com/en/docs/bare-metal/elastic-metal/how-to/create-server/).  
