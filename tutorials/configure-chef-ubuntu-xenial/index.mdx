...
1. Connect to your remote machine via SSH. For Instances, follow the instructions [here](/compute/instances/how-to/connect-to-instance/), for Bare Metal, see [here](/compute/bare-metal-cloud/how-to/connect-to-server/) and for Dedibox, see [here](/dedibox/dedicated-servers/how-to/connect-to-server/).
