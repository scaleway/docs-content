...
You can initiate the migration of your Web Hosting plan directly from your [Dedibox/Online.net console](https://account.scaleway.com/?service=dedibox). For further information, refer to our dedicated documentation [How to migrate an Online.net/Dedibox web hosting plan to Scaleway](/webhosting/how-to/migrate-webhosting-plan/).
...
All FTP accounts and configurations will be migrated. The existing password will remain functional, and the hostname will be updated to `ftp.domain.tld` or the platform's hostname in [Scaleway's Web Hosting Overview](https://account.scaleway.com/?service=elementswebhosting/webhosting).
