---
meta:
  title: Creating a simulated CPU monitor notification system with Terraform using Scaleway Instances and Messaging and Queuing SNS
  description: Learn how to set up a simulated CPU monitor notification system with Terraform using Scaleway Instances and Messaging and Queuing SNS. Trigger alerts based on CPU usage with ease. 
content:
  h1: Creating a simulated CPU monitor notification system with Terraform using Scaleway Instances and Messaging and Queuing SNS
  paragraph: Learn how to set up a simulated CPU monitor notification system with Terraform using Scaleway Instances and Messaging and Queuing SNS. Trigger alerts based on CPU usage with ease.
categories:
  - messaging
  - instances
...
<Macro id="requirements" />
  ...
  - [Set up the Scaleway CLI](https://www.scaleway.com/en/docs/developer-tools/scaleway-cli/quickstart/)
...
2. Create the credentials for SNS:
    ...
    ```
3. Finalize the SNS set up by creating the topic:
    ```
...
4. Create a `terraform_data` resource to wait for the port 8081 to be opened on the subscriber Instance before subscribing to the topic we previously created:
    ```
...
4. Still in the browser, click `Confirm subscription` to confirm the subscription to the SNS topic we created. You are directed to an AWS page which confirms the confirmation of your subscription. If you have an error because the URL hasn't been received, you can reload the page. It should take less than 30 seconds to appear.
