...
3. Click **Edit** <Icon name="edit" /> in the **Billing information** area. A dialog box appears with your billing information. The available fields depend on the type of account and the country.
...
<Message type="note">
  It is not possible to edit some of the fields (e.g., country) from this form. Contact [Scaleway Support](https://console.scaleway.com/support/tickets/) if you need to modify this information.
</Message> 