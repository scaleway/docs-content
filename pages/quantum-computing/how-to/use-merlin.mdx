...
2. Select one of the Quandela platforms to use as your backend target. You can choose between emulators and real QPUs.
    Refer to the detailed list of [Scaleway Quantum Computing offers](https://www.scaleway.com/en/quantum-as-a-service/) on the Scaleway website to find a complete list of the available backend platforms.
