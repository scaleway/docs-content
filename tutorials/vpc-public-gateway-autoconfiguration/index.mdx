...
2. Check the status of your network interfaces using the `ip a` command. You see the details of the default Ethernet adapter of your Instance:
    ...
    ```
3. Go to the [VPC page](https://account.scaleway.com/?service=elementsvpc/vpc) of the Scaleway console.
...
1. Go to the [Public Gateways page](https://account.scaleway.com/?service=elementspublic-gateway/public-gateways) of the Scaleway console, and click **Create a Public Gateway**. The Public Gateway creation wizard displays:
...
1. Go to the [Public Gateways page](https://account.scaleway.com/?service=elementspublic-gateway/public-gateways) of the Scaleway console, and click on the Public Gateway you created previously. Its **Overview** page displays.
