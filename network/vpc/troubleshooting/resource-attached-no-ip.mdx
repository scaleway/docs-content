...
If you are running multiple virtual machines on an Elastic Metal server, you can reserve private IP addresses for them with IPAM, and attach a MAC address and resource name to these IPs. Follow our [dedicated documentation](/ipam/how-to/reserve-ip/#how-to-reserve-a-private-ip-address-with-an-attached-mac-address).