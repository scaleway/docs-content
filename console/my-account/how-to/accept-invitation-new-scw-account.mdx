---
meta:
  title: How to activate a new account after being invited to an Organization with enforced MFA
  description: This page explains how to activate a new account after being invited to an Organization
  h1: How to activate a new account after being invited to an Organization with enforced MFA
  paragraph: This page explains how to change the color scheme of the Scaleway console
tags: authentication 2FA two-factor multifactor security google account join organization
dates:
