...
<Message type="note">
When a minor version becomes unsupported, Scaleway will operate an upgrade to the latest patch version of the next supported minor version within the next 30 days. You will be notified via ticket.
</Message>
...
* New support policy: from version 1.29 release, Scaleway's support window has shifted to 14 months.
We're discontinuing extended support for outdated upstream Kubernetes releases to ensure you can always benefit from the latest features, bug fixes, enhanced support and maximum security.
Consequently, versions 1.27 & 1.28 will have corresponding end of support timelines.
</Message>
