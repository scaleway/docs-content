...
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/managed-database/postgresql-and-mysql/how-to/add-users
dates:
...
<Navigation title="See Also">
  <PreviousButton to="/managed-database/postgresql-and-mysql/how-to/create-a-database/">How to create a PostgreSQL or MySQL Database Instance</PreviousButton>
  <NextButton to="/managed-database/postgresql-and-mysql/how-to/manage-permissions/">How to manage user permissions</NextButton>
</Navigation>
