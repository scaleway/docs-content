...
This separation allows for a cleaner definition of entrypoints and arguments, mirroring standard container practices.
...
If you currently use `v1alpha1` in your automation tools, we recommend updating your configurations to support `v1alpha2`.
