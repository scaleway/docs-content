...
Also known as "magic code", "4-digit code" or "verification code". When you [add a payment method](/console/billing/how-to/add-payment-method/) to your account, Scaleway carries out a dummy transaction with a €1 authorization charge, to check the card's validity. This transaction appears on your bank account statement, where a 4-digit validation code shows in the description of the transaction. You are prompted to enter this code in the console to validate the new payment method.
