...
### Using data from CronJobs in Python

CronJobs share the same pattern as HTTP calls. You can find the information passed into the CRON body in the event object:
...
### Using data from CronJobs in Node

CronJobs share the same pattern as HTTP calls. You will find the information passed into the CRON body in the event object:
...
### Using data from CronJobs in PHP
