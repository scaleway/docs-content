...
You can set up webhooks for Scaleway Transaction Email and subscribe them to [Scaleway Messaging and Queueing SNS Topics](/serverless/messaging/how-to/create-manage-topics/) to have real-time event alerts sent to your endpoints in the Scaleway console.

<Message type="note">
  Currently, webhooks are integrated exclusively with the Scaleway Managing and Queuing SNS. Billing for webhooks is based on the Scaleway [SNS billing](https://www.scaleway.com/en/pricing/managed-databases/#messaging-and-queuing).
</Message>
