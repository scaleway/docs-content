...
3. Complete the following steps in the wizard: 
    ...
    - Configure **advanced settings** if required:
      ...
      - **[Sticky session](https://www.scaleway.com/en/docs/network/load-balancer/concepts/#sticky-session)**: activate the feature and enter the name for a cookie that will bind users' sessions to specific Instances. 
