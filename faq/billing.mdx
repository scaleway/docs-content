...
|             Resource type         |         Billing Start         |           Billing Stop         |           Comments          |
    |----------------------|:------------------------:|:------------------------:|:------------------------:|
    ...
    | Bare Metal Cloud servers  |         The moment the server is **created**.                | The moment the server is **deleted**. | When a Bare Metal Cloud Server is powered off, the physical machine remains allocated to the user’s account, meaning the resource continues to be billed. |
...
7. The consumption table. This table contains the following information about your resources:
    ...
    - The services and operations consumed in your project (i.e. compute instances, object storage, Bare Metal servers etc.)
