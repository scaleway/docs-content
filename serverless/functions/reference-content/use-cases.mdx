...
meta:
  ...
  description: This section is about Serverless Functions use cases and real world examples
content:
  h1: Functions use cases
  paragraph: This section is about Serverless Functions use cases and real world examples
...
- Integration with your ecosystem to help scaling specific routes of your code
- CI/CD integration
- Data analysis and processing
- Optimising infrastructures with scaling from zero and to zero
- Decoupling software
- ...

For better understanding of Serverless Functions we provide real world examples in our [serverless-examples repository](https://github.com/scaleway/serverless-examples).
