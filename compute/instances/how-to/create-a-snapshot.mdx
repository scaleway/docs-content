...
A snapshot takes a picture of a specific volume at one point in time. Taking snapshots of your volumes gives you total freedom of which volumes you want to back up. On the other hand, images are more convenient for full backups of your Instance.  
A unified snapshot can be used to create either a BSSD or LSSD volume.

* **LSSD:** Choose this snapshot type to be able to create another local volume from your snapshot.
