...
Working with the WordPress InstantApp will significantly save you time and effort as WordPress is already installed and configured on your Instance. 
...
Optional tags such as `weblog_title`and `language` can also be used to add more customization to the Weblog. A random password will be generated and will be accessible when you log into your Instance with your SSH key.
