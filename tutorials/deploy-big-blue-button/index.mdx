...
You can also manually install BigBlueButton on a server freshly installed with Ubuntu 16.04 LTS (Xenial Xerus). This can be useful if you installed the server manually using the [KVM over IP device](/dedibox/kvm-over-ip/quickstart/).
