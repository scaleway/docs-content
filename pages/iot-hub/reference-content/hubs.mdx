...
<Message type="note">
  A table describing the features of each plan in detail is available in the [Hub creation wizard](https://account.scaleway.com/?service=elementsiot-hub/hubs/create) on the console.
</Message>
