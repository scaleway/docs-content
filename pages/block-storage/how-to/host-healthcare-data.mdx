...
To guarantee compliance with HDS requirements, must proactively encrypt data stored on the Block Storage volume using a reliable mechanism, such as [LUKS](https://en.wikipedia.org/wiki/Linux_Unified_Key_Setup). 
...
Failure to comply with this requirement may lead to voiding compliance on the data contained in the volume.
</Message>
