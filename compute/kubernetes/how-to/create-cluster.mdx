...
3. Complete the following steps of the wizard:
    ...
    <Lightbox src="/assets/scaleway-choose-cluster-type.png" alt="" />    
    ...
    * Choose a **Cluster Type**. This can be Kubernetes Kapsule or Kubernetes Kosmos.
      ...
      * **Kubernetes Kosmos** allows you to attach a Virtual Instance or dedicated server from any Cloud provider to a Scaleway Kubernetes control plane.
