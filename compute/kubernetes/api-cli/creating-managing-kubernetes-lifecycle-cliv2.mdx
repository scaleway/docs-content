...
You can [create](/compute/kubernetes/how-to/create-cluster/) and [manage](/compute/kubernetes/how-to/edit-cluster/) your Kapsule clusters from the console, via the API or via the [Scaleway Command Line Interface](https://developers.scaleway.com/en/products/k8s/api/).
