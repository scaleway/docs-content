...
<Message type="tip">
  Refer to the [product availability](/account/products-availability/) documentation page for an updated list of which products are available in which regions and AZs.
</Message>
