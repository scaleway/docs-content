...
7. Configure the backend as follows:
    ...
    - Configure **advanced settings** if required:
      ...
      - **[Sticky session](/network/load-balancer/concepts/#sticky-session)**: activate the feature and enter the name for a cookie that will bind users' sessions to specific Instances. 
