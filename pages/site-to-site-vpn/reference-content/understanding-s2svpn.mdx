...
This document coers the features, use cases, pricing and technical details of Site-to-Site VPN.
...
- A [VPN gateway](TODO): the connection point on the Scaleway side
- A [customer gateway](TODO) the connection point on the remote side (representing a corresponding physical customer gateway device)
- A [routing policy](TODO): defines the traffic allowed to flow through the tunnel
- A [connection](TODO): brings together the three above elements, and defines the configuration for the VPN tunnel
