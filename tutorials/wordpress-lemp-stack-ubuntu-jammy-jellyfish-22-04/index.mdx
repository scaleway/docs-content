...
- Secured your [LEMP stack with TLS/SSL](/tutorials/installation-lemp-ubuntu-bionic/#configuring-ssl-with-let's-encrypt)

## Installing WordPress

We presume that you have already [installed LEMP stack](/tutorials/installation-lemp-ubuntu-bionic/). Let us proceed with the installation of WordPress on your Ubuntu Jammy Instance.
