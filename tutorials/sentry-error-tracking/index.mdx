...
5. Enter the `/opt` directory on your Instance and download the [latest release](https://github.com/getsentry/self-hosted/releases/latest) of Self-Hosted Sentry.
    ```
    cd /opt
    wget https://github.com/getsentry/self-hosted/archive/refs/tags/24.2.0.tar.gz
    ```
    <Message type="note">
      At the time this tutorial was written, the latest released version was `24.2.0`.
    </Message>
