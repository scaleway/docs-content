...
An innovative option in the **Cost-Optimized** range are COPARM1 Instances, which are powered by ARM CPUs. These Instances mark a significant step in the realm of Development and General Purpose computing. Their ARM-based architecture is a key feature, offering an excellent price-performance ratio while maintaining various vCPU to RAM configurations. This ARM CPU design is especially efficient for various standard and cloud-native workloads, ensuring cost-effective operations. Ideal for a wide range of cloud applications, COPARM1 Instances are well-suited for managing medium-to-high-traffic web servers, medium-sized databases, and e-commerce platforms, all while leveraging the unique advantages of ARM architecture.
...
| Storage   	                    | Block                                                                         |
| Max. Bandwidth   	              | From 100 Mbps to 3.2 Gbps                                                     |
| CPU Type   	                    | ARM (Ampere Altra Max M128)                                                   |
| Resources   	                  | Shared vCPUs                                                                  |
| Sizing   	                      | From 2 to 128 vCPUs <br />From 8 to 128 GB RAM                                |
| vCPU:RAM ratio                  | 1:4                                                                           |
