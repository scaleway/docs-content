...
<Message type="tip">
For most modern web applications, we recommend starting with **Serverless Containers** or **Instances** depending on whether you prefer abstraction or control over infrastructure.
</Message>
...
- Host static frontends (React, Vue, etc.) on **Object Storage** with **Edge Services** for cached delivery.
- Run backend APIs using Serverless Containers, Kubernetes Kapsule, or Instances for dynamic processing.
...
Use Scaleway Container Registry, host runners on Instances, and integrate with your CI/CD pipeline to automate image building and deployment. This ensures consistent, repeatable deployments.
...
Use monitoring tools to track CPU, memory, and request metrics. Scaleway Cockpit is an integrated observability tool that allows you to efficiently monitor your resources. Refer to the [Cockpit documentation](/cockpit/) for more information.
