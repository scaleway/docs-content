...
We show how to provision all the required Scaleway resources using code examples and the Scaleway [console](https://account.scaleway.com/?service=elements). The code for the functions is written in Python.
