...
1. In your [Dedibox console](https://account.scaleway.com/?service=dedibox), click **Server** to display a list of your dedicated servers. Then click on the server you want to configure.
