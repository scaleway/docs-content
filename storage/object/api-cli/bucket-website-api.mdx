...
It is possible to enable and configure the bucket website feature via the [AWS-CLI](/object/api-cli/object-storage-aws-cli/).

To enable and configure the bucket website using the Scaleway console, refer to our [dedicated documentation](/object/how-to/use-bucket-website/).
...
>**Note:** If this is your first time uploading objects into a bucket, you can follow the step-by-step on [this documentation page](/object/how-to/upload-files-into-a-bucket/).
...
3. Use [PutBucketPolicy](/object/api-cli/bucket-operations/#putbucketpolicy) or run the following command to implement the policy via the AWS-CLI:
    ```
