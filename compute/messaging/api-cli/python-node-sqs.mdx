...
meta:
  ...
  description: This page explains how to using Python or NodeJS with SQS Messaging and provides code samples
content:
  h1: Using Python or NodeJS with SQS Messaging
  paragraph: This page explains how to using Python or NodeJS with SQS Messaging and provides code samples
tags: messaging
categories: 
  - messaging
---
...
The following code sample shows how to connect to SQS using Boto3's `resource()`. It is also posible to `client()`, but resource is more pythonesque:
