...
1. Download the [Pi-hole](https://pi-hole.net) installer and run it:
    ...
    ```
    The installer does some checks, and then gives you a series of prompt questions to answer. Choose OK or answer positively to all of them, until you are being asked to choose an upstream DNS provider.
...
5. Open the following URL in your web browser to connect to the Pi-hole web interface: `http://10.8.0.1/admin/`. The web interface allows you to further configure Pi-hole and to view statistics about your DNS requests:
