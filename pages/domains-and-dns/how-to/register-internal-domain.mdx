...
1. Click **Domains & DNS** in the **Domains & Web Hosting** section of the [Scaleway console](https://account.scaleway.com/?service=elements) side menu. The Domains and DNS dashboard displays.
