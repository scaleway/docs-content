...
However, users can still access their container logs conveniently via their Cockpit interface. A dedicated dashboard called "Serverless Containers Logs" is accessible there. For detailed instructions, refer to our [documentation](https://www.scaleway.com/en/developers/api/serverless-containers/#logs).
