...
<Message type="requirement">
  ...
  - You have at least one [failover IP](/bare-metal/dedibox/concepts/#failover-ips) with a [virtual MAC address](/bare-metal/network/reference-content/create-virtual-mac/)
