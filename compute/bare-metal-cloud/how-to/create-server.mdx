...
Scaleway [Bare Metal servers](https://www.scaleway.com/en/bare-metal-servers/) allow you to order dedicated servers on-demand, like cloud Instances. Bare Metal servers can be used for large workloads, big data and applications that require increased security and dedicated resources.
