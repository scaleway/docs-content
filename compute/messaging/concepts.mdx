...
Credentials give services and platforms access to your Messaging namespace, enabling them to connect to the host system. Credentials are [protocol](#messaging-protocol)-specific: for [SQS/SNS](#sqssns) credentials different levels of permissions can be defined, whereas NATS credentials give full access to the messaging namespace. Refer to our [Messaging and Queuing Reference Content](/compute/messaging/reference-content/) for more information.
