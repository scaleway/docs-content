...
1. Create your Instance by specifying the path to your cloud-init configuration file.
    ...
    ```
    <Message type="note">
      `@/path/to/cloud-config-file` is the path of your [Cloud-Init](/compute/instances/how-to/use-boot-modes/#how-to-use-cloud-init) configuration file. Edit it to your requirements.
    </Message>
...
<Navigation>
  <PreviousButton to="/compute/instances/api-cli/using-routed-ips/">Using routed IPs</PreviousButton>
