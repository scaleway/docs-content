...
It is not possible to change domain name once the registration has been carried out. You can of course make a new registration with another domain name. 
...
If a domain name is unavailable, you can test a light variation on the name desired. You can also add a letter or a number. If you still encounter any issues, you can contact the [support team](https://console.scaleway.com/support/tickets).
...
Domain Name System (DNS) is a domain name management service that allows you to avoid browsing the Internet only by IP. It provides human management of addressable resources on the Internet. It is possible to create zones and records to manage a sub-domain (e.g,: `test.mondomain.fr`) or specific configurations such as the MX of your mailbox.
