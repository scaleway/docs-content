...
meta:
  title: Database
  description: Discover Scaleway's managed Database and how to access it for PostgreSQL and MySQL.
content:
  h1: Database
  paragraph: Discover Scaleway's managed Database and how to access it for PostgreSQL and MySQL.
image: database.png
---
