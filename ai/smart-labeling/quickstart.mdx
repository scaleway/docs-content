...
3. Create Tasks to annotate datasets of your choice with [image-level tags, as well as points, bounding boxes, polygons, and 3D boxes](https://github.com/openvinotoolkit/openvino) and assign them to your users.
...
2. Select the tasks and roles you want to add to each user and validate from the Django admin page.
    <Message type="tip">
      If you want to learn more about CVAT user groups and permissions, check out their [documentation](https://github.com/openvinotoolkit/openvino). 
    </Message>
