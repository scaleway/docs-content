...
2. Open a support ticket as usual. Refer to [how to open a support ticket](https://www.scaleway.com/en/docs/account/support/open-a-support-ticket/) for detailed steps.
