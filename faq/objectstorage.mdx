...
Refer to our [dedicated Cold Storage FAQ](/faq/coldstorage/) for more information on Scaleway Glacier billing.
...
As a new user, you benefit from 750 GB/h of free [Multi-AZ class storage](/storage/object/concepts/#storage-class) for buckets in your Organization, across all [regions](/storage/object/concepts/#region-and-availability-zone/).

If you exceed 750 GB/h of Multi-AZ storage during the free trial period, you will only be billed for the excedeing amount of data.

You can activate your free trial period from the Object Storage section of the [Scaleway console](https://console.scaleway.com). Once it is activated, **you cannot deactivate it** and resume it at a later time.

At the end of the 90-days trial period, you will be billed for regular Object Storage pricing.

<Message type="important">
Are eligible all users who have never used the Standard Multi-AZ class before November, 30th 2023, 23:59:59.
</Message>
