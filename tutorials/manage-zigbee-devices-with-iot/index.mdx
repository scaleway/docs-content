...
content:
  ...
  paragraph: In this tutorial you will learn how to set up and configure Zigbee2mqtt with Scaleway IoT Hub.
categories:
  - iot-hub
...
[Scaleway IoT Hub](/managed-services/iot-hub/quickstart/) is a resilient and MQTT message broker with export capabilities. The use of a message broker will enable us to increase the interoperability of the solution.
