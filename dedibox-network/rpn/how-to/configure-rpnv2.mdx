...
[RPNv2](http://localhost:8003/dedibox-network/rpn/concepts/#rpn-v2) can be configured on any operating system supporting VLANs. The feature is available for selected Dedibox servers.
