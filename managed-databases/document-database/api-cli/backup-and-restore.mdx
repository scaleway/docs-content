...
<Message type="important">
  ...
  Make sure you keep the `--ssl` and `--sslCAFile=<file.pem>` flags in your commands, as you will need to authenticate using the default SSL certificate when you connect to your Database Instance.
</Message>
...
4. Download the Database Instances SSL certificate.
    <Message type="important">
