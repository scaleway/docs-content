...
6. Complete the following steps of the wizard:
    ...
    * Add a **name** for the pool and, optionally, a description and tags. {/* Are node labels available for Kosmos multi-cloud? */}
...
1. Click **IAM & API keys** in the top-right drop-down menu of the Scaleway console. The [Identity and Access Management dashboard](https://console.scaleway.com/iam/) displays.
