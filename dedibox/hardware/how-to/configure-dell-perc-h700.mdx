...
We recommend using the packages provided by [HWraid](http://hwraid.le-vert.net/) to configure your DELL PERC H700/H710/H730/H730P RAID controller. Install them as following:
