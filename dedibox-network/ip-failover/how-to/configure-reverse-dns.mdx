...
3. Enter the new reverse DNS record and click **Update**.
    ...
    <Message type="tip">
      Make sure to have a valid **[A record](/dns/concepts/#dns-record)** for forwarding DNS configured and pointing to your IP address before changing the reverse DNS of it.
    </Message>
