...
meta:
  ...
  description: This page shows you what steps are required to host your own Minecraft server on a Scaleway Elements Instance.
content:
  h1: Create your own Minecraft server
  paragraph: This page shows you what steps are required to host your own Minecraft server on a Scaleway Elements Instance.
...
steps:
  ...
  - step: Why Should I Run My Own Minecraft Server Maker?
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/setup-minecraft/#-Why-Should-I-Run-My-Own-Minecraft-Server-Maker
  - step: How Can I Create My Own Minecraft Server Maker?
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/setup-minecraft/#-How-Can-I-Create-My-Own-Minecraft-Server-Maker
  - step: How Can I Connect to My Own Minecraft Server?
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/setup-minecraft/#-How-Can-I-Connect-to-My-Own-Minecraft-Server-Maker
categories:
  - compute
dates:
...
The game supports Multiplayer mode, enabling multiple players to interact and communicate with each other on a single world. Players can either connect to one of the publicly available worlds or build their own world with their friends by using a private Minecraft server.

## Why should I run my own Minecraft server maker?
...
The Minecraft server is a Java application and runs perfectly on [Scaleway Elements Instances](https://www.scaleway.com/en/virtual-instances/), allowing you to deploy your own Minecraft Instance in just a few minutes.
...
Deploying your own Minecraft server can be done in a few easy steps on a [Scaleway Elements Developent Instance](https://www.scaleway.com/en/virtual-instances/development/). In case you do not have an Instance yet, start by [deploying your first instance](/compute/instances/how-to/create-an-instance/).
