...
<Message type="requirement">
  - You have a [Dedibox account](/dedibox-console/account/how-to/create-a-dedibox-account)
  - You are logged into the [Dedibox console](https://console.online.net/)
  - You have [added a payment method](/dedibox-console/account/how-to/add-payment-method) to your account
</Message>
