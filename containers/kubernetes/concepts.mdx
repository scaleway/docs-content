...
As a general guideline, your system volume disk should have a capacity of at least 20GB to ensure that there is enough space to store the necessary system files and configurations.
