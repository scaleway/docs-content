...
content:
  ...
  paragraph: In this tutorial, you will learn how to deploy a documentation website to Scaleway Object Storage with Docusaurus and GitHub runners.
...
- An [Object Storage bucket](/object/how-to/create-a-bucket/) with the [bucket website feature](/object/how-to/use-bucket-website/) enabled
...
<Message type="important">
  You must configure an Object Storage bucket with the [bucket website feature](/object/how-to/use-bucket-website/) enabled before you continue.
</Message>
