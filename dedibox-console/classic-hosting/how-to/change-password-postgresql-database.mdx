...
<Navigation title="See Also">
  <PreviousButton to="/dedibox-console/classic-hosting/how-to/create-postgresql-database/">How to create a PostGreSQL database</PreviousButton>
  <NextButton to="/dedibox-console/classic-hosting/how-to/delete-postgresql-database/">How to delete a PostGreSQL database</NextButton>
</Navigation> 