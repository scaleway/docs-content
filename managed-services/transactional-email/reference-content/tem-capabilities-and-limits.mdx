...
| Quota                                          | Minimum Quota     | Maximum Quota     | Upgradabl      |
|------------------------------------------------|-------------------|-------------------|----------------|
...
<Message type="note">
  ...
  - For more information on pricing, visit the [product pricing page](https://www.scaleway.com/fr/tarifs/managed-services/#transactional-email).
</Message>
