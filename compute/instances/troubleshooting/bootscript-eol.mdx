...
If your Instance is using the bootscript option to boot in normal mode you are impacted. You can check directly from the Scaleway console, which boot mode uses your Instance.
