...
6. Add a new statement with a `NotPrincipal` element that targets the users and applications concerned.
...
The example below policy below has the same effect as the V2, but conforms to the V3 (`2023-06-07-alpha`):
