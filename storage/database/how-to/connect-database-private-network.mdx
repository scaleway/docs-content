...
This improves performance by reducing the latency between your application and your DB nodes. It also increases the security of your databases, as Instances in your Private Network can directly communicate with your Database Instance, without passing through the public Internet.
