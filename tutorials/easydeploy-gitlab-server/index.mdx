...
meta:
  ...
  description: Learn how to deploy GitLab server on Scaleway Kubernetes clusters using the Easy Deploy feature. This comprehensive guide provides step-by-step deployment instructions, and post-deployment configurations necessary for optimal continuous delivery and GitOps practices.
content:
  h1: Deploy GitLab Server on Scaleway Kubernetes clusters using Easy Deploy
  paragraph: Learn how to deploy GitLab server on Scaleway Kubernetes clusters using the Easy Deploy feature. This comprehensive guide provides step-by-step deployment instructions, and post-deployment configurations necessary for optimal continuous delivery and GitOps practices.
