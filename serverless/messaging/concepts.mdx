...
Check our our [NATS quickstart](/serverless/messaging/quickstart/#quickstart-for-nats) to get started with Scaleway Messaging and Queuing using NATS, or our [tutorial](https://www.scaleway.com/en/docs/tutorials/large-messages/) on creating a serverless architecture to process large messages with NATS, to get an idea of how to go further.
