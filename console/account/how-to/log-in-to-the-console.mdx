...
meta:
  ...
  description: This page explains how to access the console with the Magic Link or SSO
content:
  h1: How to log in to the console
  paragraph: This page explains how to access the console with the Magic Link or SSO
...
Scaleway provides Single Sign-On (SSO) options for a seamless login experience. You can use your Google or Microsoft account to log in to the console. To do so, make sure the email address associated with your Scaleway console account matches the email address of your Google or Microsoft account.
