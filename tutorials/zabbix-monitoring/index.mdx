...
excerpt: |
  Zabbix is open-source software offering real-time monitoring of servers, virtual machines, network devices, and web applications. Zabbix provides monitoring metrics, among others network utilization, CPU load and disk space consumption.
totalTime: PT15M
steps:
...
permalink: docs/tutorials/zabbix-monitoring/
keywords: cloud tutorials, cloud documentations, cloud server, cloud hosting, ubuntu server, debian server, linux server, monitoring, zabbix, database, security
dates:
