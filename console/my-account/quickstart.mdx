...
4. Check the box and solve the [reCaptcha](https://en.wikipedia.org/wiki/ReCAPTCHA). Then, click **Create an account** to create your account. A message displays to request that you check your email inbox for the verification email.
