...
<Message type="note">
  ...
  * The size of the etcd key value store is limited to 55 MB and 200 MB, for mutualized and dedicated control planes, respectively. You can view the size of your control plane’s etcd in Cockpit.
</Message>
...
In Scaleway's managed Kubernetes offerings, the size of the etcd key-value store is a critical factor that users must consider.
