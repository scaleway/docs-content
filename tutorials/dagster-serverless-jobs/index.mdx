...
3. Build and push the image to your container registry namespace:
    ...
    ```
    <Message type="note">
    You can find the name and endpoint of the container registry namespace you created in the [Scaleway console](https://account.scaleway.com/?service=elementsregistry/namespaces)
    </Message>
