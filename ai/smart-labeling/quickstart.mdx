...
The information of your workspace displays:
  ...
  <Lightbox src="scaleway-smart-labeling-worksapce.png" alt="" />
...
From your Smart Labeling workspace, click **Go to my annotation server** in the workspace overview. The CVAT interface displays. 
