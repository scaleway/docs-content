...
4. Check or edit any of the following information as required, on the **Container Deployment** tab:
    ...
    - e the **advanced options** to add [triggers](/serverless/containers/concepts/#trigger) to your container deployment. Adding triggers enables the container to handle events coming from sources other than an HTTP endpoint, such as CRON (time-based jobs), MQTT queues and more.
