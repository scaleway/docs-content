...
Shared vCPU Instances, including [Development](/instances/reference-content/development/) and [Development](/instances/reference-content/development/), are cost-effective virtual machines in which CPU resources are shared among multiple Instances.
