...
1. Create a file `form.html` and upload it using FTP. Here is what it should look like: 
...
2. Create a second file `form2mail.php` and upload it using FTP. Here is what it should look like: 
