...
<Message type="tip">
You can also use a [Serverless Container or Serverless Function](/serverless-containers/how-to/deploy-container-behind-edge-services/) as an Edge Services backend. This feature is not available in the Scaleway console: see the guide to deploying a Serverless Container behind Edge Services for instructions using the CLI or Terraform.
</Message>
