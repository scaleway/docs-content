...
3. Run the following command to execute `spark-submit` to calculate pi for 1000 iterations. Do not forget to replace the placeholders with the appropriate values.
