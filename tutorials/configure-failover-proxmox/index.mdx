...
This tutorial assumes that you have already installed Proxmox VE 6.x on your Scaleway Dedibox. The automatic installation of Proxmox VE is available from your [Dedibox Console](https://console.online.net) 
