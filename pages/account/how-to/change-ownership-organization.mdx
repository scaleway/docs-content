...
1. Open the [Organization Settings page](https://account.scaleway.com/?service=elementssettings/organization) of your Organization on the Scaleway console. You can find this option on the left-side navigation menu.
...
2. Go to the [User information](https://account.scaleway.com/?service=elementssettings/account/profile#profile-information) section of your Owner's **Profile** page and click **Edit**. A pop-up appears.
...
If you need to change the Owner information of an Organization but have no access to their account, you must [reach out to our Support team via a ticket](https://account.scaleway.com/?service=elementssupport/tickets/create) and provide them with the following information:
