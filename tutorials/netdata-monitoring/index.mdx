...
excerpt: |
  This page shows how to boot configure a server monitoring system using Netdata
totalTime: PT30M
steps:
  - step: Installing Netdata
    type: HowToStep
    url: https://www.scaleway.com/en/docs/system-monitoring-with-netdata/system-monitoring-with-netdata/#-Installing-Netdata
  - step: Logging Into Netdata
    type: HowToStep
    url: https://www.scaleway.com/en/docs/system-monitoring-with-netdata/#-Logging Into Netdata
  - step: Adding Multiple Nodes Into Netdata
    type: HowToStep
    url: https://www.scaleway.com/en/docs/system-monitoring-with-netdata/system-monitoring-with-netdata/#-Adding-Multiple-Nodes-Into-Netdata
  - step: Configuring Additional Metrics
    type: HowToStep
    url: https://www.scaleway.com/en/docs/system-monitoring-with-netdata/#-Configuring-Additional-Metrics
categories:
  - compute
brands:
  - elements
image: /assets/images/docs/scaleway.png
permalink: docs/system-monitoring-with-netdata/
keywords: cloud tutorials, cloud documentations, cloud server, cloud hosting, ubuntu server, debian server, linux server, IAAS, scalability, cloud, cluster, clustering, placement, instance, cloud server, virtual instance, monitoring, netdata, system monitoring, cloud monitoring
dates:
...
3. The Netdata dashboard displays:
  ...
  <Lightbox src="scaleway-netdata_dashboard.png" alt="" />
...
2. The Netdata Cloud splash screen displays. Enter your email address to generate a magic link. Alternatively, use a [Google](https://account.google.com/) or [GitHub](https://www.github.com/) account to authenticate.
  ...
  <Lightbox src="scaleway-netdata_cloud.png" alt="" />
...
4. The Netdata cloud dashboard displays. Repeat this step on all machines running Netdata to add them to the dashboard:
  ...
  <Lightbox src="scaleway-netdata_cloud_dashboard.png" alt="" />
...
7. Point your web browser to the Netata interface and click **Nginx web configuration** in the menu on the right. The Nginx statistics displays:
  ...
  <Lightbox src="scaleway-netdata_nginx.png" alt="" />
