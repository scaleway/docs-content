...
Finally, you must [create custom routes](TODO) to facilitate traffic routing across the peering connection.

<Message type="tip">
In the case of a conflict between the CIDR ranges of the two VPCs, both connectors will display a status of `Conflict`. See our [troubleshooting guide](TODO) for help with resolving this type of conflict.
</Message>
...
- All resources which are [compatible with VPC routing](TODO) are also compatible with VPC Peering, and traffic can be routed across a peering connection to and from these resources. TODO CHECK.
