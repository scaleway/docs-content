...
description: Check if a QPU backend (physical or emulator) is accessible from a SDK.
...
| QoolQit<br/>[Source](https://github.com/pasqal-io/qoolqit/) / [How-to](/quantum-computing/how-to/use-qoolqit/) / [External doc](https://docs.pasqal.com/qoolqit/)| x | **OK** | x | x | x | x | x | x |
