...
The migration process starts off right from your familiar [Online Console](https://console.online.net/). Simply initiate the process when prompted, and you will be guided through each step. If you have not already created a Scaleway account, you will receive an invitation to do so seamlessly.
