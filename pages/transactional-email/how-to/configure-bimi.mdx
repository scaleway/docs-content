...
- A domain name that passed [SPF](/transactional-email/how-to/configure-bimi/), [SPF](/transactional-email/how-to/authenticate-domain/#how-to-configure-dkim-records), and [DMARC](/transactional-email/how-to/authenticate-domain/#how-to-configure-dmarc-records) authentication checks
