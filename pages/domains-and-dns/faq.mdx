...
You can receive legitimate email verification requests from ICANN which can sometimes appear in your spam folder (e.g., after requesting a domain transfer). Click the link to https://emailverification.info/ and enter the verification code to confirm your email address. If the link does not redirect to https://emailverification.info/, do not click the link and contact the [Support team](https://console.scaleway.com/support/tickets/create).
