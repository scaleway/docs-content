...
1. Navigate to **Apple silicon** under the **Bare Metal** section in the [Scaleway console](https://account.scaleway.com/?service=elements) side menu. This action takes you to the Apple silicon dashboard.
...
1. Access the **Apple silicon** section within the **Bare Metal** category of the [Scaleway console](https://account.scaleway.com/?service=elements).
2. Click the server name or the <Icon name="more" /> beside your desired server to access its information page.
