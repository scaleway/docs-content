...
* [How to configure a failover IP on CentOS](/ip-failover/how-to/configure-centos/)
* [How to configure a failover IP on Debian/Ubuntu](/ip-failover/how-to/configure-debian-ubuntu/)
* [How to configure a failover IP on FreeBSD](/ip-failover/how-to/configure-freebsd/)
* [How to configure a failover IP on Windows Server](/ip-failover/how-to/configure-windows/)
* [How to configure the network of a virtual machine](/ip-failover/how-to/configure-network-virtual-machine/).