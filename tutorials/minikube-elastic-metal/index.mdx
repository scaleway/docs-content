...
content:
<<<<<<< HEAD:tutorials/minikube-elastic-metal/index.mdx
  h1: Setting up Kubernetes with Minikube on an Elastic Metal server
  paragraph: This page shows how set up a Kubernetes cluster with Minikube on an Elastic Metal server
steps:
  - step: Downloading and Installing Minikube
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/minikube-elastic-metal/#-Downloading-and-Installing-Minikube
  - step: Using Minikube
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/minikube-elastic-metal/#-Using-Minikube
=======
...
>>>>>>> 96f3812d... docs(refactor): tutorials MTA-1681:tutorials/minikube-bmaas/index.mdx
categories:
  - compute
  - elastic-metal
tags: compute Kubernetes Minikube server Elastic-Metal-server
dates:
  validation: 2021-01-18
  posted: 2019-05-27
---
