...
1. [Create a new Project](/console/project/how-to/create-a-project/) in the Organization, with the name `my-second-project`. 
    <Message type="note">
