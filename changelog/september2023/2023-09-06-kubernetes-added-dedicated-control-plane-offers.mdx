...
Dedicated control planes are available in the [Scaleway console](https://console.scaleway.com/), the CLI, and Terraform. Refer to [our documentation](/kubernetes/reference-content/kubernetes-control-plane-offers/) for more information.
