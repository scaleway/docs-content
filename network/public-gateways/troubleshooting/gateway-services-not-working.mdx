...
It may also be useful to try the steps outlined in [this document](/network/vpc/troubleshooting/autoconfig-not-working).

If the problem persists, do not hesitate to [contact us on the #vpc-public-gateway channel on the Scaleway Community Slack.](https://scaleway-community.slack.com/archives/C01NTFET64D) 
