...
[Rescue mode](/compute/instances/concepts/#rescue-mode) allows you to boot your Instance into a temporary operating system, often the previous version of the working kernel. Rescue mode is often used to diagnose and resolve issues such as networking issues, firewall configurations...etc. 
