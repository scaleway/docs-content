...
tags: instance
keywords: cloud tutorials, cloud documentations
excerpt: |
  Malicious agents and bots will try to exploit your instances to perform Distributed Denial of Service on third party causing troubles on your IP such as blacklisting.
  This guide will help you to secure your instances against classical security flaws that are used by attackers to take control of your instance.
permalink: docs/how-to-prevent-outgoing-ddos/
totalTime: PT30M
steps:
...
[A Distributed Denial of Service (DDoS) attack](https://www.us-cert.gov/sites/default/files/publications/DDoS%20Quick%20Guide.pdf) is a DoS attack that is performed at the same time by a multitude of compromised systems.
...
Scaleway will lock any resources (instances, Kubernetes cluster, bare-metal server, ...) that are identified as a contributor to a DDoS.
...
[Memcached can be used in DDoS](https://github.com/memcached/memcached/wiki/DDOS) because of [its large amplification factor](https://www.cloudflare.com/learning/ddos/memcached-ddos-attack/).
...
These commands provide a [huge amplification effect](https://www.cloudflare.com/learning/ddos/ntp-amplification-ddos-attack/) to the attacker.
...
This makes it particularly troublesome as a [spoofed IP address](https://www.cloudflare.com/learning/ddos/glossary/ip-spoofing/) that will generate a reflection attack.

In addition to that, a DNS reply is usually larger than its corresponding query.
Therefore, DNS can be used to have an [amplification effect](https://www.cloudflare.com/learning/ddos/dns-amplification-ddos-attack/).
...
- (In French) [Comprendre et anticiper les attaques DDOS](https://www.ssi.gouv.fr/uploads/2015/03/NP_Guide_DDoS.pdf)
