...
<Message type="tip">
  If a volume is missing, check the [Block Storage](https://account.scaleway.com/?service=elementsblock-storage/volumes) or [Local Storage](https://account.scaleway.com/?service=elementslocal-storage/volumes) sections in the Scaleway console.
</Message>
