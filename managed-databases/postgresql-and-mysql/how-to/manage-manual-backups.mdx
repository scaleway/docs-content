...
<Message type="note">
  This procedure can also be carried out on [Autobackups](/managed-databases/postgresql-and-mysql/how-to/enable-autobackup/).
</Message>
...
4. Click **Download**.
    <Message type="note">
      Backups are exported in `.gz` format.
    </Message>
