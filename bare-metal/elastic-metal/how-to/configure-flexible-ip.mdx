...
<Message type="tip">
  ...
  * When configuring a failover IP in a virtual machine, you must specify which route will be used by the VM. Refer to our [dedicated documentation](/network/how-to/configure-network-netplan/#configuring-a-failover-ip-for-virtual-machines) for further information.
</Message>