...
excerpt: |
  This page explains how to use rescue mode on a Dedibox dedicated server
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/dedibox/dedicated-servers/how-to/use-rescue-mode
image: /assets/images/docs/scaleway.png
keywords: console, my-account, Howto, rescue mode
dates:
...
Currently we offer three different types of rescue mode:
  ...
  - [A Windows PE distribution](https://technet.microsoft.com/en-us/library/cc766093(v=ws.10).aspx) - [Accessing Windows PE rescue mode](https://documentation.online.net/en/dedicated-server/rescue/windows-pe-rescue-mode)
...
3. Click **Rescue**.
  ...
  <Lightbox src="scaleway-rescue.png" alt="" />
...
1. [Connect to your server via SSH](/dedicated-servers/how-to/connect-to-server/#how-to-connect-via-ssh)
...
The only way to access your server in Windows PE rescue mode once launched, is via the KVM/IP of your server. Refer to the [KVM/IP documentation](/dedibox/kvm-over-ip) that corresponds to your server model.
