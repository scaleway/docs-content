...
For detailed and up-to-date pricing information, please refer to the [official Scaleway pricing page](https://www.scaleway.com/en/pricing/serverless/#serverless-containers).
...
<Message type="info">
This calculation is provided for illustrative purposes only. For accurate and up-to-date pricing, please refer to the [official Scaleway pricing page](https://www.scaleway.com/en/pricing/serverless/#serverless-containers).
</Message>
