...
3. Enter either the email address for your account (you will then be asked for your password), or your [API Secret Key](https://www.scaleway.com/en/docs/console/my-project/how-to/create-ssh-key/)
