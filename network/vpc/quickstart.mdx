...
4. Click **+ Create Private Network**. The creation screen displays.

    <Lightbox src="scaleway-create-rpn.webp" alt=""/>
    TODO: check screenshot.

5. Enter a **name** for the network, or leave the randomly-generated name in place. Optionally, you can also add **tags** to help organize your Private Networks. Each tag should be separated by a space.
