...
- [VPC Peering API Reference](https://www.scaleway.com/en/developers/api/vpc/) - Full documentation for managing VPC Peering via the Scaleway API.
- [VPC Peering Terraform Documentation](https://registry.terraform.io/providers/scaleway/scaleway/latest/docs/resources/) - Integrate VPC Peering into your infrastructure as code with the Scaleway Terraform Provider.
