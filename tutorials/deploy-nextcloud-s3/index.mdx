...
categories:
  - storage
  - object-storage
tags: compute storage objectstorage nextcloud cloud selfhosted
image: /assets/images/docs/scaleway.png
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, debian server, linux server, IAAS, baremetal, scalability, ARM, physical server, dedicated server, server, storage, streaming, object storage
dates:
...
- You have [installed and configured](/tutorials/mariadb-ubuntu-bionic/) MariaDB on your Virtual Instance
...
1. Retrieve your `ACCESS-KEY` and `SECRET-KEY` from the [Scaleway console](/console/my-project/how-to/create-ssh-key/).
...
<Lightbox src="scaleway-nextcloud-obstorage.png" alt="" />
...
<Lightbox src="scaleway-nc_external_storage_files.png" alt="" />
