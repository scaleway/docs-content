...
If you are still having problems reaching a resource attached to a Private Network via its hostname, [open a support ticket](https://account.scaleway.com/?service=elementssupport).
