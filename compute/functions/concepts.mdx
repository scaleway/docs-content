...
A namespace is a project that allows you to [group your functions](/compute/functions/how-to/create-a-functions-namespace/). Functions in the same Namespace can share environment variables and access tokens, defined at the namespace level.
