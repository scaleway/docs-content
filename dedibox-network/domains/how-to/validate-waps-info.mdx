...
excerpt: |
  This page explains how to validate WAPS information
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/dedibox-network/domains/how-to/validate-waps-info
image: /assets/images/docs/scaleway.png
keywords: dedibox, network, dedicated servers, domain, domain names, scaleway, waps
dates:
...
2. Click on the link in the e-mail within 15 days to confirm that your e-mail address is valid.
...
If you are expecting a validation e-mail (e.g. if you have modified your domain owner's contact information) but can't find the e-mail, try the following steps:
