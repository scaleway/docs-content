...
<Message type="important"> Users are not allowed to change the BIOS settings of Elastic Metal servers, as mentioned in this [FAQ entry](/elastic-metal/faq/#can-i-change-the-bios-settings-or-update-the-firmware-of-an-elastic-metal-server). </Message>
