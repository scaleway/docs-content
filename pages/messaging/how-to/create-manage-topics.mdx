...
This page shows how to create and manage [topics](/messaging/concepts/#topic) with Scaleway Topics and Events (formerly part of the Messaging and Queuing product).
...
2. Click **Create topic**. The topic creation wizard displays.
    ...
    <Lightbox src={image} alt="In the Scaleway console, the Create a Topic screen displays. The different sections of the screen are described in the steps below." />
