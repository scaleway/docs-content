---
meta:
  title: Configuring a DELL PERC H800 RAID controller
  description: This page explains how to configure the DELL PERC H800 RAID controller
content:
  h1: Configuring a DELL PERC H800 RAID controller
...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/hardware/reference-content/configure-dell-perc-h700/">Configuring a DELL PERC H700/H710/H730/H730P RAID controller</PreviousButton>
  <NextButton to="/bare-metal/hardware/reference-content/configure-hp-smart-array-p410/">Configuring a HP SMART ARRAY P410/P222 RAID controller</NextButton>
</Navigation>
