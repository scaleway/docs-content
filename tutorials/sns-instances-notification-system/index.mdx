...
The focus on setting up SNS with maximum automation, therefore all the infrastructure is handled with Terraform.
...
Then, we set up Terraform so we can use it to define our infrastructure.
...
7. Check that your `main.tf` file looks like the fully completed example shown on the [GitHub repository](https://github.com/scaleway/serverless-examples/tree/main/mnq/sns-instances-notification-system).
