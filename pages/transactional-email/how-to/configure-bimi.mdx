...
- A domain name that passed [SPF](/transactional-email/how-to/authenticate-domain/#how-to-configure-spf-records), [SPF](/transactional-email/how-to/authenticate-domain/#how-to-configure-dkim-records), and [DMARC](/transactional-email/how-to/authenticate-domain/#how-to-configure-dmarc-records) authentication checks
- A logo of your brand saved in SVG format
- [Owner](/iam/concepts/glossary/#owner) status of the Organization in which the actions will be performed, or be an IAM user with the [necessary permissions](/iam/concepts/glossary/#permission)

## How does BIMI work?

Before your brand's logo can be displayed, your email must first pass authentication checks. Checks are usually performed through [SPF](/transactional-email/how-to/authenticate-domain/#how-to-configure-spf-records), [DKIM (DomainKeys Identified Mail)](/transactional-email/how-to/authenticate-domain/#how-to-configure-dkim-records), and [DMARC (Domain-based Message Authentication, Reporting, and Conformance)](/transactional-email/how-to/authenticate-domain/#how-to-configure-dmarc-records) checks, which are supported by Scaleway. Some email clients also require a Verified Mark Certificate (VMC) to ensure the logo's authenticity.
