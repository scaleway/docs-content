...
The GUI of Rancher makes it easy to manage secrets, handle roles and permissions. It allows scaling nodes and pods, set up load balancers without the requirement of a command line tool or the editing of hard to read YAML files.
...
5. Choose the region for the Instance, the Instance type and a name for the Instance (i.e. `rancher1`), then, click **Create Instance**.
