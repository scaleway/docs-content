...
Depending on the type of node selected, we provide one or two types of volume.
  ...
  - **Block Storage:** a remote storage, your system is stored on a centralised and resilient cluster.
