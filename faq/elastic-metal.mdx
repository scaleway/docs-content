...
Yes, you can order flexible IPv6 for your Elastic Metal server. These can be attributed to any of your Elastic Metal servers the same way as flexible IPv4s. Each failover IP consists of a `/64` IPv6 subnet (18,446,744,073,709,551,616 IPv6s).

<Message type="note">

When you configure the reverse DNS of a failover IPv6 the configuration is applied only to the first IP of each bloc (`XXXX:0`).
