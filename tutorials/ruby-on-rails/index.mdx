...
content:
  h1: Deploying a Ruby on Rails application on Scaleway Elements
  paragraph: This page shows you how to a Ruby on Rails application on Scaleway Elements using nginx, rbenv, puma, PostgreSQL and systemd on Ubuntu 18.04
...
- You have an Instance or Bare Metal server running on Ubuntu Focal Fossa (20.04 LTS).
