...
* `the composer.json` files enable you to define dependencies that will be installed when deploying your functions, for more information you can check composer [official documentation](https://getcomposer.org/doc/04-schema.md#package-links)
