...
3. Complete the following steps in the wizard: 
    ...
    - Configure the frontend and backend.
      ...
      - **Configure backend**. Enter the following information for your [backend](/network/load-balancer/concepts/#backends):
        - Backend name
        - [Protocol](/network/load-balancer/concepts/#protocol): select TCP, HTTP or HTTPS depending on your required usage. The protocol is used for data transmission between the frontend/s and backend/s.
