...
<Message type="note">
 ...
 - The default project cannot neither be updated nor deleted.
...
```
{
  ...
  "name":"test-project",
  "organization_id":"0a123456-7b8c-9d0e1-f234-5ghi6789j012",
...
```
{
  ...
  "projects":[
    {
      "id":"0a123456-7b8c-9d0e1-f234-5ghi6789j012",
      "name":"default",
      "organization_id":"0a123456-7b8c-9d0e1-f234-5ghi6789j012",
      "created_at":"2021-07-06T15:15:48.375181Z",
      "updated_at":"2021-07-06T15:15:48.375181Z",
      "description":""},{"id":"1bc9d87e-6543-2f2g-1hi0-1j234k45l6m7",
      "name":"new-project",
      "organization_id":"0a123456-7b8c-9d0e1-f234-5ghi6789j012",
      "created_at":"2022-07-19T15:02:43.455727Z",
      "updated_at":"2022-07-19T15:29:27.762100Z",
...
You need your secret key and the ID of the project you want to delete for the step below. For this use-case, we are deleting the project we have created in the [creating a project step](/identity-and-access-management/api-cli/managing-projects#updating-projects).
...
```
curl -XGET https://api.scaleway.com/account/v2/projects/<SCW_DEFAULT_ORGANIZATION_ID> -H "X-Auth-Token: $SCW_SECRET_KEY"
```
