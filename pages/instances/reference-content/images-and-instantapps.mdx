...
| <Lightbox image={gpuos} alt="GPU OS (Ubuntu)" size="small" />  | **GPU OS 12** is a specialized OS image based on Ubuntu 24.04 (Noble), optimized for GPU-accelerated workloads. It comes pre-installed with the NVIDIA driver, Docker, and the NVIDIA Container Toolkit, providing an environment for running containerized applications. This image is designed to work efficiently with NVIDIA NGC container images, enabling rapid deployment of GPU-accelerated applications, such as machine learning and data processing workloads.<br />[Deploy GPU OS 12](https://console.scaleway.com/instance/servers/create?imageKey=61916874-cf88-417d-83e8-c7933b848c6a&zone=fr-par-2&offerName=L4-1-24G&tab=GPU&distribution=ubuntu)  |
