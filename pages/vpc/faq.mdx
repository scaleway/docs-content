...
If you created your Scaleway [Project](/organizations-and-projects/concepts/glossary/#project) before 13 May 2025, one **default VPC** was automatically created in it for each region (Paris, Amsterdam and Warsaw). You can now opt to delete these default VPCs, if you wish.
...
See our [dedicated quotas page](/organizations-and-projects/organization/organization-quotas/#vpc-and-private-networks) for full details.
...
Yes, Serverless Functions are compatible with VPC routing.
...
Yes, [VPC routing](/vpc/concepts#routing) allows you to automate the routing of traffic between resources in different Private Networks within the same VPC.

### Can I route traffic between different Private Networks in different VPCs or different Scaleway Projects?

Yes, [VPC Peering](/vpc-peering/quickstart/) allows you to connect VPCs in different Scaleway Projects and Organizations.
...
For this purpose, use the option of attaching a **custom resource** to a Private Network, specifying its MAC address. Full instructions for attaching custom resources are in the [Private Networks documentation](/vpc/how-to/attach-resources-to-pn#how-to-attach-a-resource-to-a-private-network).
...
You might have a reserved IP address that is blocking the deletion. Check out our [troubleshooting page](/vpc/troubleshooting/cant-delete-vpc-pn/) for guidance.
