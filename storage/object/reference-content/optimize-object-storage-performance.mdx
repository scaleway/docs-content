...
<Message type="tip">
To optimize latency and throughput on `GET` operations, Scaleway’s [Edge Services](/storage/object/how-to/get-started-edge-services/) allows for closer caching of your objects. This feature is currently in private beta, register [here](https://www.scaleway.com/en/betas/#edge-services) if you are interested in joining in.
</Message>
