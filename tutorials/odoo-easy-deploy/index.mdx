...
1. Open a terminal window on your local machine, and log in to your namespace with Docker. 
    <Message type="note">
      Replace `odoo-tutorial-namespace` with the name of your namespace and $SCW_SECRET_KEY with the corresponding [secret key](/identity-and-access-management/iam/how-to/manage-api-keys/).
    </Message>
