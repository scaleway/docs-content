...
| Serverless Containers      | **Integrated**                  | Refer to the [dedicated documentation](/audit-trail/reference-content/adt-supported-endpoints/#serverless-containers) to find out which Serverless Containers endpoints are supported.|
