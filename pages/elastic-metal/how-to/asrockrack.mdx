...
This page shows you how to use [KVM](/dedibox-kvm-over-ip/concepts/#kvm-over-ip) on an Elastic Metal server with ASRock Rack KVM.
...
- An [installed Elastic Metal server](/elastic-metal/quickstart/#how-to-create-an-elastic-metal-server) with an [ASRock Rack](https://www.asrockrack.com/) KVM-over-IP device and compatible with [remote access](/elastic-metal/concepts/#remote-access)
