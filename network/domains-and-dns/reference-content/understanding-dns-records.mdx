...
Information in DNS zones is categorized and organized through a list of [DNS record](/network/domains-and-dns/concepts/#dns-record) types, called [resource records](/network/domains-and-dns/concepts/#resource-records) (RRs).
...
<br />
  Not ending your domain name with a trailing dot results in your domain being tried with a domain name appended to it, or even a list of domain names until one [resolves](/network/domains-and-dns/concepts/#domain-name-resolution).<br />
<br />
