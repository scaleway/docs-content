...
Deploying your own Minecraft server can be done in a few easy steps on a [Scaleway Elements Developent Instance](https://www.scaleway.com/en/virtual-instances/development/). In case you do not have a Instance yet, start by [deploying your first instance](/compute/instances/how-to/create-an-instance/).
