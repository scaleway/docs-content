...
|                       |                            | **GPU RENDER** | **GPU NVIDIA H100 PCIe (Single and dual)**  |  **Jeroboam (2DGX H100, 16 H100 GPUs)**         | **Nabuchodonosor (127 DGX H100, 1016 H100 GPUs)** |
|-----------------------|----------------------------|:--------------:|:-------------------------------------------:|:-------------------------------------------:|:-----------------------------------------------:|
| **Type**              |                            | **Instance**   | **Instance**                                | **Supercomputer**                            | **Supercomputer**                               |
| **Training**          | NLP, LLM                   | +              | +++                                       | <font color="red">X</font> <sup>***</sup>      | <font color="red">X</font> <sup>***</sup>       |
|                       | Generative AI (image, video) | <font color="red">X</font> | +++                | ++++                                      | ++++                                            |
|                       | Recommender System         | +              | +++                                       | ++++                                      | ++++                                            |
| **Inference**         | NLP, LLM                   | +              | +++                                       | ++++                                      | <font color="red">X</font> <sup>**</sup>         |
|                       | Generative AI (image, video) | +++            | ++                                        | <font color="red">X</font> <sup>**</sup>    | <font color="red">X</font> <sup>**</sup>       |
|                       | Graph, vector Database     | <font color="red">X</font>           | <font color="red">X</font> <sup>*</sup> | <font color="red">X</font> <sup>**</sup> | <font color="red">X</font> <sup>**</sup>        |
...
| **Virtual Desktop (VDI)** |                        | [Contact us](https://www.scaleway.com/en/contact-ai-solution/) | [Contact us](https://www.scaleway.com/en/contact-ai-solution/) | [Contact us](https://www.scaleway.com/en/contact-ai-solution/) | [Contact us](https://www.scaleway.com/en/contact-ai-solution/) |

- Ratings are represented as + (low), ++ (medium), +++ (high), ++++ (very high)
...
| VRAM                                                                | 16 GB HBM2E (Memory bandwidth: 732 GB/s)                                             | 80 GB HBM2E (Memory bandwidth: 2TB/s)                                                                                                             | 2x80 GB HBM3 (Memory bandwidth: 2TB/s)                                                                                                           |
