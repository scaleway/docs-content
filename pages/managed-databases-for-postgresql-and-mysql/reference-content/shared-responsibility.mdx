...
Managed PostgreSQL and MySQL instances support [encryption at rest](/managed-databases-for-postgresql-and-mysql/concepts/#encryption-at-rest), but must be explicitly enabled by you. When enabled, Scaleway manages the encryption key.
