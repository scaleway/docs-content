...
<Message type="requirement">
  ...
  - You have [created an Object Storage bucket](/storage/object/how-to/storage/how-to/create-a-bucket/)
...
Alternatively, you can [configure a CNAME Record](/storage/object/tutorial/s3-customize-url-cname/) for your bucket URL, to be able to access the website through a domain name of your choice.
