...
No, Serverless Functions and Containers are not currently compatible with VPC routing. Functions attached to a Private Network support egress traffic only, towards other resources on the same Private Network.
