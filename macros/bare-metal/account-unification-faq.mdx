...
You must select an alternative method to secure your account. [Learn about our available MFA method options](/account/login-credentials/use-2fa/).

### Can I use SSO on my account?
Yes. You can [set up SSO](/account/login-credentials/use-2fa/) on your account if your email provider is Google or Microsoft. Alternatively, you can use GitHub if you use the same email address for both accounts. Once configured, you can [authenticate using SSO](/account/login-credentials/log-in-to-the-console/?tab=log-in-with-sso-0).
...
| **I own multiple Dedibox accounts using the same email address** | The password has been erased. You must [access your account using an email authentication code](/account/login-credentials/log-in-to-the-console/?tab=authentication-code-0) and register a new password. | Any existing MFA has been erased. You must [access your account using an email authentication code](/account/login-credentials/log-in-to-the-console/?tab=authentication-code-0) and set up a new MFA method. |
...
Yes. Once the account unification is completed, you will be able to manage and update your [Organization](/organizations-and-projects/concepts/glossary/#organization) information from the **Settings** space on [account.scaleway.com](http://account.scaleway.com) at any time.
...
To give access to the entire account, [create a Member](/iam/principals/manage-members/) in your Organization instead.
