...
### How to create credentials for SQS 
...
### How to send and receive messages and more

All further actions related to publishing, processing and managing messages can be done via a supported CLI or SDK. See our documentation on the [SQS CLI and SDKs](/serverless/messaging/reference-content/sqs-overview#further-actions) for more information.
...
SQS and SNS are handled as two separate protocols. Each one needs to be activated, for each region you want to use, before you can start creating credentials, queues, topics etc for this protocol. You can choose to activate one or both protocols as you like. You can deactivate each protocol at any time.
...
3. Click **SQS** or **SNS** depending on the protocol you want to activate.
...
3. Click the **SQS** or **SNS** depending on which service you want to create credentials for.

4. Click **Generate credentials**. A pop-up displays, such as the following for SQS:
    <Lightbox src="scaleway-generate-creds-sqs.webp" alt="" />
...
4. Confirm the geographical **region** in which to create your SNS topic. If you want to change the region, go back to step 2.
...
Go further by clicking on the topic's name to access its **Settings** page and see additional information such as its ARN (Amazon Resource Name).

### How to create and manage subscriptions, messages and more

You can create subscriptions via the console as detailed in our dedicated [how-to](/serverless/messaging/how-to/create-manage-subscriptions/). All further actions related to publishing, processing and managing subscriptions, messages, subjects, queues and streams can be done via a supported CLI or SDK. See our documentation on the [SQS CLI and SDKs](/serverless/messaging/reference-content/sqs-overview#further-actions) and [SNS CLI and SDKs](/serverless/messaging/reference-content/sns-overview#further-actions)for more information.
