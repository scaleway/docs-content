...
The `php.ini` file is the configuration file used for applications that require PHP. It contains variable configurations such as upload size, file timeout, and resource limits. For Scaleway Web Hosting, we provide PHP with the most common values preconfigured. If required, you can [customize the configuration of PHP](/webhosting/classic/how-to/configure-php/) to suit your needs.
