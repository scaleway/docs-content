...
<LinksList>
  - <LinkList to="/serverless-sql-databases/troubleshooting/connection-errors/" label="Solving connection errors" />
  - <LinkList to="/serverless-sql-databases/troubleshooting/connection-timeout/" label="Solving Serverless SQL Databases connection timeouts" />
  - <LinkList to="/serverless-sql-databases/troubleshooting/failing-backup-restore/" label="Solving failing manual backup and restore operations" />
  - <LinkList to="/serverless-sql-databases/troubleshooting/maximum-prepared-statements-reached/" label="Solving maximum prepared statements size errors" />
</LinksList>
