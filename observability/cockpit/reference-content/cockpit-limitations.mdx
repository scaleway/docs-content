...
|------------------------------------|---------------|--------------------|--------------------------------------------------------------------------------------|
| `ingestion_rate_mb`                | 4             | 4                  | Maximum number of samples accepted in megabytes. The following samples are rejected  |
| `ingestion_burst_size_mb`          | 6             | 6                  | Ability to exceed `ingestion_rate_mb` for a short period of time (still undefined)   |
