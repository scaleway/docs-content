...
If you were billed for resources that have been correctly stopped, [contact our Support team](https://console.scaleway.com/support/tickets/create), providing the name of the product and resource, and the date of deactivation.
...
If your credit card complies with the payment requirements but was still declined, [contact our Support team](https://console.scaleway.com/support/tickets/create) for assistance.
...
It is not possible to edit your country and region directly from the Scaleway console. [Contact our Support team](https://console.scaleway.com/support/tickets/create) if you need to change this information.
...
Starting 1 September 2026, French businesses must meet new electronic‑invoicing (e‑invoicing) requirements. To stay compliant, make sure the following fields in your Scaleway billing profile are complete and up‑to‑date:
...
It is not possible to edit or remove your VAT number once a value has been set. [Contact Scaleway Support](https://console.scaleway.com/support) if you need to update it.

This limitation does not cause any billing or compliance problems for French customers who are not entitled to reclaim VAT and wish to remove their VAT number:

- **Domestic transaction:** The transaction is domestic (France‑only), so French VAT is applied and collected at the source.
- **No tax impact:** The French tax authorities receive the correct VAT amount and the company does not claim it back, so the inclusion of the VAT number has no effect on tax treatment.
- **No VIES impact:** Displaying the VAT number on the invoice will not trigger any issues in the European VAT Information Exchange System (VIES), as the number is for display purposes only and is not being used to claim an exemption.
