...
<Message type="requirement">
  ...
  - You have [configured your SSH key](/console/my-project/how-to/create-ssh-key)  - You have [created an Instance](/compute/instances/how-to/create-an-instance) that runs Ubuntu Focal Fossa Beaver
