...
1. Click the **AI** section of the [Scaleway console](https://account.scaleway.com/?service=elements), and select **Managed Inference** from the side menu to access the Managed Inference dashboard.
