...
- An Azure Databricks admin account.
- A Premium plan for your Azure Databricks account.
...
Scaleway does not use a `formattedName field`, it constructs the display name by joining the first and last name with a space, identical to Entra's behavior. This mapping is redundant and should be removed.
