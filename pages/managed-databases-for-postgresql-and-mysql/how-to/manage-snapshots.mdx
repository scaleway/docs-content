...
When you set up [autobackups](/managed-databases-for-postgresql-and-mysql/how-to/enable-autobackup/) for Database Instances that use Block Storage, the automatic backups are created in snapshot format.
