...
## Console overview
Discover the Data Lab interface on the Scaleway console.
<GuideFlow src="https://app.guideflow.com/embed/9r2m9v2fzk"/>

Data Lab for Apache Spark™ is a product designed to assist data engineers and data scientists in performing data processing on a remotely managed Apache Spark™ infrastructure.
