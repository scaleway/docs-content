...
- An [Elastic Metal server](/bare-metal/elastic-metal/quickstart/#how-to-create-an-elastic-metal-server) compatible with [remote access](/bare-metal/elastic-metal/concepts/#remote-access)
