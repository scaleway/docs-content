...
4. Wait a few minutes, then check the status of your Serverless SQL Database using the [Scaleway console](https://account.scaleway.com/?service=elements) again.
