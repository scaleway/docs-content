...
5. Complete the following steps in the wizard:
  ...
  - If you used your own function code, enter the **handler** of your function.
...
6. Click **Create function**. The deployment will take several minutes to complete. Check the **Overview** tab to see the function's status.
