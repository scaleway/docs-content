...
Extended retention is available according to your needs. Check out the [Cockpit pricing](https://www.scaleway.com/en/pricing/?tags=available,managedservices-observability-cockpit) page and the [Plans tab](https://console.scaleway.com/cockpit/plans) in the Scaleway console for more information.
