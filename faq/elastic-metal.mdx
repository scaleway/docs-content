...
You must [create](/compute/elastic-metal/how-to/create-server/) a new Elastic Metal server and [reinstall](/compute/elastic-metal/how-to/reinstall-server) your server to switch from a monthly billing to an hourly billing and vice-versa. 
