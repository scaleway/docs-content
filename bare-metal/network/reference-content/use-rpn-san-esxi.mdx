...
<Message type="important">
  This documentation covers **VMWare ESXi version ESXi 5.0/5.1/5.5 and 6.0** and later. Follow [this link](/bare-metal/network/reference-content/use-rpn-san-esxi-v7) to see the Documentation for ESXi 7 and later.
</Message>
...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/network/reference-content/mount-rpn-san-linux/">How to mount an RPN SAN on Linux</PreviousButton>
  <NextButton to="/bare-metal/network/reference-content/use-rpn-san-esxi-v7/">Configuring RPN-SAN on ESXi 7 and later</NextButton>
</Navigation>