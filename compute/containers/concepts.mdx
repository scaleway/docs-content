...
JWT (JSON Web Token) is an access token you can create from the console or API to enable an application to access your Private Container. Please consult the [Developer documentation](https://developers.scaleway.com/en/products/containers/api/#tokens) for more details.
