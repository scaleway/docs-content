...
content:
  ...
  paragraph: earn how to set up, use, and manage your Scaleway Dedibox server with this comprehensive guide, including tips on using the shell, installing software, and backing up your data.
