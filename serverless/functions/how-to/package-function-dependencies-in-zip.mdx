...
- Read the [how to create a Function](/serverless/functions/how-to/create-a-function/) page
</Message>
...
The file containing the [handler](/serverless/functions/concepts.mdx#handler) of the function is located at the root of the archive.
...
The file containing the [handler](/serverless/functions/concepts.mdx#handler) of the function is located in a folder, and not at the root of the archive.
