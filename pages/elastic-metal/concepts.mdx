...
User-data is the mechanism through which configuration instructions are passed to an Elastic Metal server. When cloud-init detects user-data during boot, it interprets and executes it based on the data format provided.
