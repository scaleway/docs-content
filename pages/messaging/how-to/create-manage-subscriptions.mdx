...
4. Click **Create Subscription**. The subscription creation wizard displays.
    <Lightbox src={image} alt="In the Scaleway console, the Create a Subscription screen displays. The different sections of the screen are described in the steps below" />
