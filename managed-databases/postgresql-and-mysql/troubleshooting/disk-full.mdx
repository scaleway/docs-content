...
<Message type="important">
  Please note the Database Instance disk space includes Database engine logs.
</Message>
...
If you wish to clear out space used by your Database Engine, you can carry out the following actions:
