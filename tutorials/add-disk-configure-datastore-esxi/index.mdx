...
On [Dedibox](https://www.scaleway.com/en/dedibox/), you can order as many [additional disks](https://www.scaleway.com/en/dedibox/storage/local-disks/) as you need. They can then, for instance, be used as additional Datastore in [ESXi](https://www.vmware.com/products/esxi-and-esx.html) to store your virtual machines.
...
Note that instead of adding additoonal disks to your server, you can also use remote storage based on our [RPN-SAN](https://www.scaleway.com/en/dedibox/storage/rpn-san/) product to add an additional datastore to your ESXi host.
