...
Some services needs to filter IPs for example databases. Serverless Containers does not support Virtual Private Networks yet but you can use Scaleway IP Ranges definied here: http://as12876.net/