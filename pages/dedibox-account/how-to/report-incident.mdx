...
1. From the Scaleway [console](https://account.scaleway.com/?service=elements) or [website](https://www.scaleway.com/), click the [Report Abuse](https://console.scaleway.com/support/abuses/create/) page. A form displays.
