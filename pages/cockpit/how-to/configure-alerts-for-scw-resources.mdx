...
- Checked the [dedicated documentation about limits](cockpit/reference-content/cockpit-limitations/#limits-for-recording-rules-and-alerts) to ensure your alert condition contains valid parameters
