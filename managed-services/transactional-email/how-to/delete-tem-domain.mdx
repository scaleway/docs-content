...
<Navigation title="See also">
  <PreviousButton to="/managed-services/transactional-email/how-to/generate-api-keys-for-tem-with-iam/">How to generate API keys for API and SMTP sending with IAM</PreviousButton>
</Navigation>