...
**S**erver-**S**ide **E**ncryption with **C**ustomer-provided keys (SSE-C) is a method of encryption provided by Scaleway Object Storage to protect your data at rest. It allows you to supply your own encryption keys to encrypt data when it is uploaded, and to decrypt data when it is accessed.
