...
When carrying out actions on Scaleway Object Storage resources via an API or CLI, the API/CLI does not provide a parameter to specify the desired Project for the Object Storage resources. Therefore, when you create an API key with IAM, you are prompted to specify its **preferred Project for Object Storage**. This API key will always use this Project when carrying out Object Storage actions via any API/CLI. See our [dedicated page](/identity-and-access-management/iam/api-cli/using-api-key-object-storage/) for more information.
