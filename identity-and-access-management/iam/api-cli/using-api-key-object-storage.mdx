...
2. [Create an API key](/identity-and-access-management/iam/how-to/create-api-keys/) for the `my-test-app` application. Select the preferred Project for the API key as `default`.
