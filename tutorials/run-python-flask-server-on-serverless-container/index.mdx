...
categories:
  - containers
tags: serverless containers caas functions nodejs express-server Python Flask
dates:
...
3. [Deploy the image using the Scaleway console](/serverless/containers/how-to/deploy-a-container-from-scaleway-container-registry/).
