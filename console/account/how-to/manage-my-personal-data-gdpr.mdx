...
5. Click the **Send request** button once you read and agree with the warning message.
6. Type **Erase**, then click **Send request** to confirm your decision.
7. A message appears to confirm that your account and personal data will be erased soon. The process can take up to 72 hours.
...
<Navigation title="See also">
  <PreviousButton to="/console/account/how-to/open-a-support-ticket/">How to open a support ticket</PreviousButton>
  <NextButton to="/console/account/how-to/report-incident/">How to report an incident</NextButton>
</Navigation>