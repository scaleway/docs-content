...
1. From the [Scaleway console](https://account.scaleway.com/?service=elements), navigate to the [Credentials](/organizations-and-projects/concepts/#ssh-key) tab of your Project dashboard.
...
1. Click **Project Dashboard** in the [Scaleway console](https://account.scaleway.com/?service=elements) side menu to check if you are logged in the correct Project.
