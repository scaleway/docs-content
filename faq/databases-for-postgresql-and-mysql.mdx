...
No, the second node created when you activate the HA on your Managed Database Instance is a hot standby. This node allow allows a fast failover in case of issues on the primary node.

Please use [read replica feature](/docs/managed-databases/postgresql-and-mysql/how-to/create-read-replica/).
