...
- A [Redis™ Database Instance](/redis/quickstart/) with Redis™ version 6 or 7

1. [Connect to your Redis™ Database Instance](/redis/how-to/connect-to-redis-database-instance/).
