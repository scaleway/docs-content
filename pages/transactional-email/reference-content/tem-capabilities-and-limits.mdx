...
<Message type="important">
  Customers must adhere to industry standards and our [General Terms of
  Services](https://www-uploads.scaleway.com/General_Terms_of_Services_v17072024_45d4879c08.pdf),
  including compliance with [Scaleway's anti-spam
  policy](https://tem.s3.fr-par.scw.cloud/antispam_policy.pdf). Failure to
  comply may result in temporary or permanent restrictions to the service.
</Message>
...
<Message type="note">
  Quotas can be increased on a case-by-case basis. If you have validated your
  payment method and identity and want to increase your limits beyond the values
  shown, [contact our Support
  team](https://console.scaleway.com/support/create).
</Message>
...
<Message type="important">
  - Keep in mind that when sending an email with Transactional Email, each
  recipient counts as a separate email. Example: If you send an email to one
  recipient and you add three recipients as CC, you will be billed for 4 emails.
  - Transactional Email is only available in the `fr-par` region. - The
  recursive SPF `include` directive is not supported. - The subject, body and
  HTML of your emails must have at least 10 characters.
</Message>
