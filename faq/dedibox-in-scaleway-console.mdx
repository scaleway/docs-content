...
You gave to choose a unique default payment method for your Scaleway services. This default payment method allows you to pay all of your Scaleway invoices (Scaleway Cloud and Scaleway Dedibox).<br />
...
* If you use different credit cards for Scaleway Cloud and Dedibox, the card registered with Scaleway Cloud becomes the default payment method for both your Scaleway Cloud and Scaleway Dedibox invoices.

<Message type="tip">
  You can modify your payment method in the [billing section](https://console.scaleway.com/organization/billing) of the Scaleway console once your account linking has been completed. All existing default payment methods are transfered to your linked account.
</Message>
