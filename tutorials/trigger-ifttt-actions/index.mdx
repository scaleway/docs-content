...
1. Follow [this procedure](/iot-hub/how-to/create-hub/) to create an IoT Hub. Select your name and plan of choice, and click the `Create Hub` button.
...
Learn more about [Scaleway IoT Hub](/iot-hub/concepts/), discover how to add [Devices to the hub](/iot-hub/how-to/add-device/) or check out the [IoT Hub metrics](/iot-hub/how-to/view-metrics/).