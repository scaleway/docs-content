...
A cluster's storage is used to persist events, so they can be reliably consumed by services and applications. When creating a cluster, you can define the amount of storage you want per node.
