...
tags: database compute mysql mongoDB
excerpt: |
...
totalTime: PT45M
steps:
  - step: Adding MongoDB Repository
    type: HowToStep
    url: https://www.scaleway.com/en/docs/install-and-secure-mongodb-on-ubuntu/#-Adding-MongoDB-Repository
  - step: Installing MongoDB
    type: HowToStep
    url: https://www.scaleway.com/en/docs/install-and-secure-mongodb-on-ubuntu/#-Installing-MongoDB
  - step: Securing MongoDB
    type: HowToStep
    url: https://www.scaleway.com/en/docs/install-and-secure-mongodb-on-ubuntu/#-Securing-MongoDB
  - step: Enabling Authentication
    type: HowToStep
    url: https://www.scaleway.com/en/docs/install-and-secure-mongodb-on-ubuntu/#-Enabling-Authentication
  - step: Testing Authentication
    type: HowToStep
    url: https://www.scaleway.com/en/docs/install-and-secure-mongodb-on-ubuntu/#-Testing-Authentication
  - step: Verifying the Administrative User's Access
    type: HowToStep
    url: https://www.scaleway.com/en/docs/install-and-secure-mongodb-on-ubuntu/#-Verifying-the-Administrative-Users-Access
  - step: Enabling UFW
    type: HowToStep
    url: https://www.scaleway.com/en/docs/install-and-secure-mongodb-on-ubuntu/#-Enabling-UFW
  - step: Configuring a Public bindIP
    type: HowToStep
    url: https://www.scaleway.com/en/docs/install-and-secure-mongodb-on-ubuntu/#-Configuring-a-Public-bindIP
  - step: Testing the Remote Connections
    type: HowToStep
    url: https://www.scaleway.com/en/docs/install-and-secure-mongodb-on-ubuntu/#-Testing-the-Remote-Connections
  - step: Uninstalling MongoDB
    type: HowToStep
    url: https://www.scaleway.com/en/docs/install-and-secure-mongodb-on-ubuntu/#-Uninstalling-MongoDB
categories:
  - compute
  - storage
brands:
...
permalink: docs/install-and-secure-mongodb-on-ubuntu/
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, scalability, ARM, physical server, dedicated server, server, network, mariadb, mongoDB, database
dates:
