...
There a no constraints about changing a function runtime, you simply need to choose the runtime version you want.
Upgrading a runtime is highly recommended in case of deprecation, end of support or end of life runtime, see [functions runtimes lifecycle](/serverless/functions/reference-content/functions-lifecycle/)
