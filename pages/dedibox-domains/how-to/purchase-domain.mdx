...
import image from './assets/scaleway-order-domain.webp'
import image2 from './assets/scaleway-order-domain-contact.webp'
import image3 from './assets/scaleway-order-domain-summary.webp'
...
1. In your browser, navigate to [the domain name order page](https://www.scaleway.com/en/domains-and-dns/).
