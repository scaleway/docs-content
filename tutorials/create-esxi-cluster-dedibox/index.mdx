...
12. The default ports used by the vCenter application are displayed. You can keep the default settings, and click **Next** to continue:
...
14. A summary of your configuration displays. Check again if all your settings are correct and click **Install** to launch the installation of VMware vCenter

  <Lightbox src="scaleway-vcenter_review.png" width="500" alt="" />

15. Once the installation is completed, you can log off from the Windows VM and type the address of your vCenter Server in your web browser to connect to it.
