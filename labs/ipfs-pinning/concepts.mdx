...
meta:
  ...
  description: This page explains all concepts related to IPFS Pinning
content:
...
The content identifier is a string of character that points to a content. The content can be available on the network, or not. The CID is composed from the cryptographic hash of the content. It is used to identify and fetch the content through the network.
