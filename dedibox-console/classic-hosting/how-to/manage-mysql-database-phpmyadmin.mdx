...
<Message type="requirement">
  ...
  - You have [created](/dedibox-console/classic-hosting/how-to/create-mysql-database) a MySQL database
</Message>
...
<Navigation title="See Also">
  <PreviousButton to="/dedibox-console/classic-hosting/how-to/delete-mysql-database/">How to delete a MySQL database</PreviousButton>
  <NextButton to="/dedibox-console/classic-hosting/how-to/create-postgresql-database/">How to create a PostgreSQL database</NextButton>
</Navigation> 
