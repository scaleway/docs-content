...
This page shows you how to use [Load Balancer flexible IP addresses](/load-balancer/concepts/#flexible-ip-address). A flexible IP address is a public IP address for your Load Balancer.

- A flexible IP address can either be [IPv4](/load-balancer/concepts/#ipv4) or [IPv6](/load-balancer/concepts/#ipv6).
