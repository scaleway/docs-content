...
Once your content is pinned on our service, you can retrieve it via any other [Kubo client](/labs/ipfs/api-cli/ipfs-cli/), commpatible with Linux, Mac and Windows.
...
There are different ways to access data over the HTTP or HTTPS protocols. You ca either use a web browser or the [curl](https://curl.se/) command.
