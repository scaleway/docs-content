...
4. Add the following code to it:
    ...
    Docker will now ignore Node dependencies and other unecesseray files during the build process.
...
2. Create and deploy a Serverless Container with your application image:
    ...
    ```sh
    scw container container list name=my-strapi-blog -o human=Name,Status
    ```
