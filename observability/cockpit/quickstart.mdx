...
**Going further** <br /><br />
  ...
  If you have not set up any agent yet, check out our [documentation to find out how to configure the Grafana agent, push your data, and visualize it in Grafana](/observability/cockpit/api-cli/configuring-grafana-agent/). Note that you must have created resources to monitor in order to push your data to Cockpit.
</Message>
