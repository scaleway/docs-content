---
meta:
  title: Configuring a High-Availability Storage with GlusterFS on Ubuntu 18.04 LTS
  description: This page details how to configure a high-availability storage with GlusterFS on Ubuntu 18.04 LTS
content:
  h1: Configuring a High-Availability Storage with GlusterFS on Ubuntu 18.04 LTS
  paragraph: This page details how to configure a high-availability storage with GlusterFS on Ubuntu 18.04 LTS
tags: glusterfs network filesystem high-availability-storage Ubuntu-18.04-LTS
steps:
  - step: Configuring the Host File
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-configure-storage-with-glusterfs-on-ubuntu/#-Configuring-the-Host-File
  - step: Adding the GlusterFS Repository
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-configure-storage-with-glusterfs-on-ubuntu/#-Adding-the-GlusterFS-Repository
  - step: Installing GlusterFS Server
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-configure-storage-with-glusterfs-on-ubuntu/#-Installing-GlusterFS-Server
  - step: Configuring GlusterFS Servers
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-configure-storage-with-glusterfs-on-ubuntu/#-Configuring-GlusterFS-Servers
  - step: Setting up the Distributed GlusterFS Volume
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-configure-storage-with-glusterfs-on-ubuntu/#-Setting-up-the-Distributed-GlusterFS-Volume
  - step: Configuring GlusterFS Client
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-configure-storage-with-glusterfs-on-ubuntu/#-Configuring-GlusterFS-Client
  - step: Testing Replication & Mirroring
    type: HowToStep
    url: https://www.scaleway.com/en/docs/how-to-configure-storage-with-glusterfs-on-ubuntu/#-Testing-Replication--Mirroring
categories:
  - compute
...
<Message type="requirement">
  ...
  - You have three servers running on Ubuntu Bionic or Xenial
