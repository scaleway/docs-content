...
<Message type="note">
  This tutorial describes the installation of Jitsi Meet on Ubuntu Bionic Beaver. If you prefer the installation of Jitsi Meet on Debian Buster, follow [this link](https://www.scaleway.com/en/docs/tutorials/jitsi-debian/).
</Message>
...
1. The default Ubuntu image has been minimized to reduce the size, as required for the installation of Jitsi, start by unminimizing it:
    ...
    Press `y` to confirm you want to unminimize. The apt package manager will download and install the required packages.
