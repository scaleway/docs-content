...
excerpt: |
  ...
  To follow this tutorial, we assume that you completed successfully the first tutorial on Django installation and configuration.
totalTime: PT20M
steps:
  - step: Creating Models
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/create-models-django/#-Creating-Models
  - step: Playing with the API
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/create-models-django/#-Playing-with-the-API
  - step: Rendering the Application in the Console
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/create-models-django/#-Rendering-the-Application-in-the-Console
  - step: Adding Related Objects
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/create-models-django/#-Adding-Related-Objects
categories:
  - compute
  - instance-dev
tags: compute installing Django
image: /assets/scaleway_django_models.png
...
1. To create your app, make sure you’re in the same directory as `manage.py` and type
...
2. Reload the Admin Console and login.
  ...
  <Lightbox src="scaleway-django_admin_questions.png" alt="" />

  If you click `Question`, it displays the list of questions we added to the configuration file.

  <Lightbox src="scaleway-django_admin_questions_2.png" alt="" />

  Click each question to either edit or delete it.

  <Lightbox src="scaleway-django_edit_question.png" alt="" />
