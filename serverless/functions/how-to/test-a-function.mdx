...
6. Enter the **path** to your function. Leave the default `/` value if your function is not located in a specific folder within a [Zip package](/functions/how-to/package-function-dependencies-in-zip/).
