...
## My payment verification code expired. What should I do?

If your verification code expires, please [contact our support team](https://console.scaleway.com/support/tickets/create) to request a new magic code.

## I tried to add a credit card but received the message 'Card already registered'

You can only use one credit card per Organization. If you receive this message, make sure you do not have the same card already registered to another Scaleway account.
...
If after that period you still don't receive it, contact your bank or credit card provider to request the transaction code.
...
It might not be possible to remove your credit card from your account if you have one or more outstanding invoices. If that is the case, make sure to pay the open invoice(s) and retry.

You might also be unable to delete a credit card if it is your only registered payment method. In this case, you can add a new credit card, select it as a default payment method, and then delete the previous credit card from your account.
...
Be prepared to inform your new address, including country, region, city, postal code, and street address. Our team will then proceed to update your account details.

## I was billed for resources that are deactivated or powered off
...
Scaleway invoices are calculated at the end of each month, so you may receive a final invoice the month after closing your account. That refers to your outstanding consumption for your final month of activity.

Note that before closing your account, it is important to verify that no resources are left running, as that may lead to recurring billing. [Learn more about when billing starts and ends](/faq/billing/#when-does-the-billing-of-an-instance-start-and-stop)
