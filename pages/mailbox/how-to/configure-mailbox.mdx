...
In the **Email accounts** tab, click **Access Webmail** to open the email service application in a new browser tab.
...
2. Click **Check status** to refresh all status information.
