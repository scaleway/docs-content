...
<Message type="important">
	Be aware that any existing Kapsule cluster **will be destroyed** and recreated, when adding private_network_id attribute over an existing terraform.tfstate.
	Head on to : [Scaleway's terraform provider documentation](https://registry.terraform.io/providers/scaleway/scaleway/2.19.0/docs/resources/k8s_cluster) for details.
</Message>
