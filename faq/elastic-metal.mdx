...
### What is the commitment fee payback and how to use it?

You are entitled to a commitment fee payack on monthly Elastic Metal servers, if your server is up and running for 12 consecutive months without stopping.

The amount of the credit is the price of the setup fees at the time of purchase (excluding taxes). It can be used for all Scaleway Cloud products (except Elastic Metal servers and their options) and is valid for six months. [Learn more about the commitment fee payback.](/compute/elastic-metal/how-to/use-commitment-fee-payback/)
