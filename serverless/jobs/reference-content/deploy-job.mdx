...
The console allows you to easily [create a job definition](/serverless/jobs/how-to/create-job/) and track your job runs. You can also monitor your jobs using [Scaleway Cockpit](/observability/cockpit/quickstart/).
