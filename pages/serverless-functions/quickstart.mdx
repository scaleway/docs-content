...
This page explains how to deploy, invoke, and delete a basic Node, Python, or PHP function using the [Scaleway console](https://account.scaleway.com/?service=elements).
