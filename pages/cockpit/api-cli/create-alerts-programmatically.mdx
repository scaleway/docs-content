---
title: How to create alerts programmatically in Cockpit for automated DevOps workflows
...
This guide shows you the basics of how to create and manage alerting rules in Scaleway Cockpit using the Mimir (metrics) and Loki (logs) HTTP APIs. Using the API snippets and YAML templates from this guide enables you to set up and maintain automated monitoring and alerting workflows for your Scaleway resources.

<Requirements />

- Configured Prometheus so that it scrapes and sends metrics from your target Scaleway resources to Mimir {/* EDITORIAL COMMENT: Is this OK? */}
- Configured Promtail so that it scrapes and sends logs from your target Scaleway resource to Loki {/* EDITORIAL COMMENT: Is this OK? */}
