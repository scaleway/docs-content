...
In the initial month of a subscription, you are billed pro-rata in the following month. This means the charge is adjusted to reflect the portion of the first month you used the service.
...
You can manage your billing information from the [billing section](https://console.scaleway.com/organization/billing) of the Scaleway console. Your last invoices as well as the consumption report of the current month are available for download from there.
...
1. Log into your Scaleway console. You must be the Owner of your Organization, or an IAM user in an Organization where you have the relevant [permission set(s)](/identity-and-access-management/iam/concepts/#permission-set). 
2. On the Organization drop-down menu, click **Billing**. The billing section displays. 
...
7. Fill in the required information and click **Add your payment method**.
    ...
    Once the banking information is added, you will see on this line a "---"  icon which allows us to generate and download the mandate.
