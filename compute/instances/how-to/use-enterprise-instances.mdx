...
excerpt: |
  This page explains how to use Enterprise Instances
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
...
- Select Paris 2 as your **Availability Zone**. Enterprise Instances are currently only available in this zone, although more zones will be available in the future.
