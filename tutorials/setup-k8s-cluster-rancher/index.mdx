...
The GUI of Rancher makes it easy to manage secrets, handle roles and permissions. It allows you to scale nodes and pods, set up load balancers without needing a command line tool or to edit hard to read YAML files.
