...
In case you do not have a Database for PostgreSQL yet, [create a new one](/managed-database/postgresql-and-mysql/how-to/create-a-database/) from your [Scaleway Console](https://console.scaleway.com/rdb/Instances).
...
In case you do not have a Database for MySQL yet, [create a new one](/managed-database/postgresql-and-mysql/how-to/create-a-database/) from your [Scaleway Console](https://console.scaleway.com/rdb/Instances).
