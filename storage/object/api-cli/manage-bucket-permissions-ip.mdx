...
<Message type="note">
  Bucket policies use a JSON-based access policy language. Refer to the [dedicated documentation](/storage/object/api-cli/bucket-policy/) for more information on the bucket policies syntax.
</Message>
