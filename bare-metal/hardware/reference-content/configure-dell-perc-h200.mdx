---
meta:
  title: Configuring a DELL PERC H200 RAID controller
  description: This page explains how to configure the DELL PERC H200 RAID controller
content:
  h1: Configuring a DELL PERC H200 RAID controller
...
1. Boot your server into [rescue mode](/bare-metal/elastic-metal/how-to/use-rescue-mode/) using a 64-bit Ubuntu operating system.
...
<Navigation title="See Also">
  <NextButton to="/bare-metal/hardware/reference-content/configure-dell-perc-h310/">Configuring a DELL PERC H310 RAID controller</NextButton>
</Navigation>
