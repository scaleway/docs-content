...
<Message type="important">
  - You can only generate API keys for yourself and, if you are the Organization Owner or have [IAMManager or IAMApplicationManager permissions](/iam/reference-content/permission-sets/), for IAM applications. You cannot generate API keys for other IAM users, regardless of your permissions.
