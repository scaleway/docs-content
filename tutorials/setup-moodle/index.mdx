...
excerpt: |
  Moodle is a global, open source Learning Management System (LMS) that provides educators and students with a platform and integrated tools to create and participate in collaborative online learning environments. 
  This tutorial shows you how to create your own learning environment by installing Moodle on a virtual cloud instance using a LEMP-Stack (comprised of Ubuntu Focal Fossa 20.04 LTS, Nginx, MariaDB and PHP).
totalTime: PT20M
steps:
...
permalink: /docs/setting-up-moodle-with-ubuntu-focal-fossa/
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, linux server, IAAS,scalability, moodle, learning environment, learning management system, lms, moodle mooc, mooc, cooc, massive online open learning, universities, university, education, edtech, lemp, php, nginx, mariadb,
dates:
