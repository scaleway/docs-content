...
- A [function](/functions/how-to/create-a-function/)
- Created an [authentication token](/functions/how-to/create-auth-token-from-console/) for your function
...
6. If required, [create an access token](/functions/how-to/create-auth-token-from-console/) for your function.
...
Refer to the [How to create an authentication token](/functions/how-to/create-auth-token-from-console/) documentation for more information.
