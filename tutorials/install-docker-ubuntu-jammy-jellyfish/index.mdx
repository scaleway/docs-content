...
1. Login to your Instance using SSH:
    ...
    ```
2. Update the `apt` packet cache and upgrade the software already installed on your Instance to the latest version available in the repository:
    ```
...
3. Verify that the installation of Docker Engine was successfully by running the following command.  
