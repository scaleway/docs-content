...
Job scheduling is deprecated in favor of [Job triggers](/serverless-jobs/concepts/#job-trigger). Existing schedules remain active and associated jobs will continue to be invoked.
