...
5. Copy and save the credentials, before closing the window.
    ...
    You are returned to your Messaging and Queueing SQS or SNS service's **Credentials** tab. The name of your newly-generated credentials, along with the access key and access level are displayed.
