...
New runtimes are added depending on users' demand.
...
When runtimes are not supported anymore, they get through different phases.

| Deprecated | The runtime is still available, but a warning announcing the end of service will be displayed when a new function is created. |
