...
description: Let us address the most common questions you have about Enterprise Instances.
...
## Are Enterprise Instances part of a complete Cloud Ecosystem?

Enterprise Instances are compatible with each Scaleway ecosystem services: Compute (Instances, Bare Metal, containers…), Storage (Block Storage, Database, Object Storage) or Network (Load Balancer, VPC…).
...
We provide a wide range of different Linux distributions and InstantApps for compute instances. Enterprise Instances will work with a selection of most-acclaimed images:
