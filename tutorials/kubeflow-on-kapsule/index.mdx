...
4. Click **Dashboard** in your clusters overview, to open the Kubernetes dashboard of your cluster in a new browser window.
...
1. Go to your Kubernetes cluster in the Scaleway console.

2. Click **Dashboard** in your clusters overview, to open the Kubernetes dashboard of your cluster in a new browser window.
