...
| Environment variables                               | Max number | 200              | Function + Namespace        |
| Environment variables                               | Max size   | 65536 chars      | Environment variable        |
| Secret environment variables                        | Max number | 200              | Function + Namespace        |
...
| Build duration                                      | Max time   | 40 minutes       | Function build              |
...
These limits are enforced as [Organization quotas](/organizations-and-projects/organization/organization-quotas/#serverless-functions).
