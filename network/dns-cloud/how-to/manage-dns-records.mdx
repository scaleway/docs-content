...
6. Fill in the required information for the record, then confirm by clicking **Add Records**.
  <Lightbox src="scaleway-dns-add-records.png" alt="" />
...
5. Click <Icon name="edit" /> and fill in the required information. Then click <Icon name="validate" /> to save. If you wish to cancel changes before saving, click <Icon name="cancel" />.
    <Lightbox src="scaleway-dns-edit-records.png" alt="" />
...
4. Click <Icon name="delete" />. A pop up displays. 
    <Lightbox src="scaleway-dns-confirm-delete.png" alt="" />
...
<Lightbox src="scaleway-dns-weighted.png" alt="" />
...
<Lightbox src="scaleway-dns-geo-ip.png" alt="" />
...
<Lightbox src="scaleway-dns-healthcheck.png" alt="" />
...
<Lightbox src="scaleway-dns-view.png" alt="" />
