---
meta:
  title: Serverless Functions Quickstart
...
3. Complete the following steps in the wizard: 
    ...
    - (Optionally) Enter any **environment variables** required for your namespace. Environment variables configured in a namespace will be available in all functions/apps within the same namespace. For each environment variable, click **+Add** and ender the key/value pair.
