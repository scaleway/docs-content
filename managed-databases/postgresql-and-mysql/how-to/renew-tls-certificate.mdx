...
3. Click **Renew** under **TLS Certificate** in the **Database Instance Information** section. A pop-up appears.
  ...
  <Lightbox src="scaleway-rdb-renew-tls-pop-up.webp" alt="" />
...
A green success message pops up on the top right corner of the screen to confirm the certificate has been renewed.
