...
In this tutorial you will learn how to install Hugo on your local computer so you can build your website locally, before pushing your content into a GitHub repository where a GitHub runner will take the content, generate the HTML version of it and upload it to an Object Storage bucket automatically.
