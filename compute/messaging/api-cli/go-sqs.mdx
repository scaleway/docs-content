...
<Message type="note">
  ...
  The `Endpoint` for Scaleway Messaging is `http://sqs-sns.mnq.fr-par.scw.cloud`. For the access and secret key values, use the credentials you [generated](/compute/messaging/how-to/create-credentials/) for your SNS/SQS namespace.
