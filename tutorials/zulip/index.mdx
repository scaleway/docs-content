...
meta:
  ...
  description: This page shows how to create a Zulip Server on a Scaleway Elements Instance.
content:
  h1: How to deploy a Zulip server
  paragraph: This page shows how to create a Zulip Server on a Scaleway Elements Instance.
