...
meta:
  ...
  description: This page explains how to install and use the Scaleway Go software developement kit (SDK)
content:
  h1: Scaleway Go software developement kit (SDK)
  paragraph: This page explains how to install and use the Scaleway Go software developement kit (SDK)
