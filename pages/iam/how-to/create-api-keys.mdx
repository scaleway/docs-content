...
1. Click **IAM & API keys** on the top-right drop-down menu of the Scaleway console. You are taken to your [Identity and Access Management dashboard](https://account.scaleway.com/?service=elementsiam/users).
