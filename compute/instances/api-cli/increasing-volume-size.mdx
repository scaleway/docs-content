...
<Navigation title="See Also">
  <PreviousButton to="/compute/instances/api-cli/attaching-a-volume">Attaching a volume via the Instance API</PreviousButton>
  <NextButton to="/compute/instances/api-cli/detaching-a-volume">Detaching a volume via the Instance API</NextButton>
</Navigation>
