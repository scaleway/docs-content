...
4. Configure your Network. You can select either:
    ...
    The Private Network feature with Databases for Redis™ is only available with the [cluster mode](/databases/databases-for-redis/concepts). If you want to use Private Networks you must:
