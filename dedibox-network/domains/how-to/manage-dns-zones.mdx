...
excerpt: |
  This page explains how to manage a domain's DNS zones
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/dedibox-network/domains/how-to/manage-dns-zones
image: /assets/images/docs/scaleway.png
keywords: dedibox, network, dedicated servers, domain, domain names, scaleway, dns, dns zones
dates:
...
| **CNAME**   | Allows for the mapping between a DNS name and another DNS name (sql.domaine.ext. IN CNAME mysql1.online.net.) |  
...
2. Click **Configure domain name** next to the relevant domain. 
  ...
  <Lightbox src="scaleway-domain-configure.png" alt="" />

3. Click the **Edit DNS zone** tab.

  <Lightbox src="scaleway-edit-dns-zone.png" alt="" />
