...
2. Add the required rules to it using the rule elements detailed in the [section below](#available-xml-tokens).
...
**Description**
: Describes the lifetime of non-current versions before being expired. Expired objects are deleted automatically.
