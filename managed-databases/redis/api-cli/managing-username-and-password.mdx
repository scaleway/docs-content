...
When you create a Redis™<sup>*</sup> Database Instance, you have to specify a user. It will be created with [set permissions](/redis/reference-content/default-user-permissions/).
...
<Message type="tip">
You can also define a username when you [create a Redis™ Database Instance](/redis/how-to/create-a-database-for-redis/) via the Scaleway console.
</Message>
