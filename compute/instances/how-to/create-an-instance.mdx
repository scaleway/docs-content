...
keywords: instance, cloud computing, scaleway, create an instance
dates:
...
3. Complete the following steps in the wizard: 
  ...
  <Message type="note">
    ...
    InstantApps are not available on [Entreprise Instances](/compute/instances/concepts#entreprise-instance)
