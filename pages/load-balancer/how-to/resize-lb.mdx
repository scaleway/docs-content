...
3. Scroll down to the **Resize** panel, and click **Resize**. A pop-up displays:
    ...
    <Lightbox src={image} alt="A pop up window shows a Resize Load Balancer screen, with a dropdown menu to choose a Load Balancer type, and a warning that resizing might take a few seconds during which time the Load Balancer might be inaccessible." />
