...
To continue setting up a Site-to-Site VPN, the next step is generally [creating a routing policy](TODO).
...
Here you can view the gateway's :
  ...
  - ASN
  - Public IP addresses
  - Number of [VPN connections](TODO) it is used in
...
As well as creating a customer gateway with Scaleway, you also need to configure your real customer gateway device. Creating the customer gateway on the Scaleway side does not automatically create or configure this "real" corresponding device.
...
- [VPN Gateway Public IP(s)](TODO)
- [Pre-Shared Key (PSK)](TODO)
- [IPsec parameters](TODO) (ESP and IKE security proposals)
- [BGP interconnection subnet](TODO)
- [Routing policy](TODO)

Instructions for configuring your customer gateway device will depend on your device model and vendor. 

## How to delete a customer gateway

You must [deactivate route propagation](TODO) on any VPN connections linked to the customer gateway, before you can delete the gateway.
...
5. Click **Delete customer gateway**.
    ...
    A pop-up displays, informing you that any [VPN connections](TODO) using this gateway will be auto-deleted.
