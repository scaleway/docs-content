...
import AlertBilling from '@macros/cockpit/alert-billing.mdx'
...
Cockpits are scoped per [Project](/organizations-and-projects/concepts/glossary/#project) and are automatically activated when you are using [Scaleway resources that are integrated into Cockpit](/cockpit/reference-content/cockpit-product-integration).
