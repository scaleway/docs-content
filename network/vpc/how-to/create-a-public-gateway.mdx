...
excerpt: |
  This page explains how to create a Public Gateway
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/computer/instances/how-to/create-a-public-gateway
image: /assets/images/docs/scaleway.png
keywords: cloud computing, scaleway, public gateway, vpc, gateway
dates:
...
2. Click **Create a new Public Gateway** to launch the Public Gateway creation wizard:
  ...
  <Lightbox src="scaleway-vpc-gw-wiz1.png" alt="" />
