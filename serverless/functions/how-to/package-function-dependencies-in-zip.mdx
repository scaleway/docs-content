...
6. Choose your desired runtime.
7. Select **Upload a ZIP** in **Function code**.
8. Drag and drop your ZIP file in the reserved field or upload it.
9. Specify your **handler** path.
10. Configure your function.
11. Click **Create function** to finish.
