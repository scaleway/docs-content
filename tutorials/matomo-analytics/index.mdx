...
5. Configure a super-user (or admin) user for Matomo. This user will be the main user which is able to configure all settings of the tool and can add additional users and sites:
