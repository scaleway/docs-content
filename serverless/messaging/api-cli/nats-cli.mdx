...
<Message type="requirement">
  ...
  - You have [created a NATS account](/serverless/messaging/how-to/get-started/#how-to-create-a-nats-account)
  - You have [generated credentials](/serverless/messaging/how-to/create-credentials/) for NATS and downloaded them to your machine.
</Message>
