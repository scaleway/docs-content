...
excerpt: |
  This page explains how to enable DNSSEC
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/dedibox-network/domains/how-to/enable-dnssec
image: /assets/images/docs/scaleway.png
keywords: dedibox, network, dedicated servers, domain, domain names, scaleway, dns, dnssec
dates:
