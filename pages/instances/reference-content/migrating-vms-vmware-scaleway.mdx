...
- A Scaleway account logged into the [console](https://account.scaleway.com/?service=elements) with access to Instances, Block Storage, Object Storage, and optionally Private Networks.
