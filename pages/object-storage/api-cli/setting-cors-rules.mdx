...
2. Open the file and add the following content. Replace `YOUR_DOMAIN_NAME` with your domain (origin) or an asterisk (`*`) to allow all domains, and adjust the parameters as needed.
