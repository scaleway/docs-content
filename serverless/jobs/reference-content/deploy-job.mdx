...
The console allows you to easily [create a job definition](/jobs/how-to/create-job/) and track your job runs. You can also monitor your jobs using [Scaleway Cockpit](/cockpit/quickstart/).
