...
You need a pair of access and secret keys to connect to Scaleway API. Check out the documentation to find out [how to retrieve them](/iam/credentials/create-api-keys/).
...
func main() {
	...
	client, err := scw.NewClient(
		...
		// Get more about our availability zones at https://www.scaleway.com/en/docs/account/products-availability/
