...
However, users can still access their function logs conveniently via their Cockpit interface. A dedicated dashboard called "Serverless Functions Logs" is accessible there. For detailed instructions, refer to our [documentation](https://www.scaleway.com/en/developers/api/serverless-functions/#logs).
