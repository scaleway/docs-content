...
excerpt: |
  This page explains how to use IPMI on a Dedibox server
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/dedibox/dedicated-servers/how-to/use-ipmi
...
5. Enter the authorized IPv4 address for the iDRAC connection. The IP address of your Internet connection is already pre-filled in the form. Then click **Create** to generate your credentials.
  ...
  <Lightbox src="scaleway-idrac.png" alt="" />
...
5. Enter the authorized IPv4 address for the iDRAC connection. The IP address of your Internet connection is already pre-filled in the form. Then click **Create** to generate your credentials.
  ...
  <Lightbox src="scaleway-ilo.png" alt="" />
