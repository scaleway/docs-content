...
[Oracle VM VirtualBox](https://www.virtualbox.org/) is a free and open-source hypervisor for x86 virtualization. It is developed by Oracle Corporation and the base package is released under the [GNU General Public License V2](https://www.gnu.org/licenses/old-licenses/gpl-2.0.html).
