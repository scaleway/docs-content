...
The table below summarizes the official states, their behavior, and the associated billing implications. Use it as a quick reference when managing your Instances through the Console, API, or CLI.
