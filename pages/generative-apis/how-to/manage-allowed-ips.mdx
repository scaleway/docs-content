...
2. Ensure the deployment is [attached to a Private Network](/generative-apis/how-to/generative-apis-dedicated-deployment-with-private-network/#how-to-attach-a-private-network-to-a-dedicated-generative-apis-deployment).
3. Transfer the deployment's [TLS certificate](/generative-apis/how-to/generative-apis-dedicated-deployment-with-private-network/#how-to-send-inference-requests-in-a-private-network) to the resources in the VPC that need to access the deployment.
...
6. Follow the instructions in the [dedicated documentation](/generative-apis/how-to/generative-apis-dedicated-deployment-with-private-network/#how-to-send-inference-requests-in-a-private-network) for sending requests to your deployment in a Private Network.
