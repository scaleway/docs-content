...
1. Install Apache, MySQL and PHP. 
  ...
  <Message type="note">
    ...
    In this example we use `geerlinguy`'s (a software developer involved in many open source development communities) role. If no version is specified the latest version will be dowloaded. To specify a version, add the version after the role name. Example: `geerlingguy.apache,1.0.0` or `geerlingguy.mysql,1.0.0`. 
    
    If you want to use other roles, you check out [geerlinguy](https://galaxy.ansible.com/geerlingguy)'s Ansible profile.
