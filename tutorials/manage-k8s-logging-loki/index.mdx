...
categories:
  ...
  - kubernetes
dates:
  validation: 2021-11-25
  posted: 2019-11-06
---

Scaleway [Kubernetes Kapsule](/compute/kubernetes/how-to/create-cluster) is not delivered with an embedded logging feature.  
In this tutorial, you will learn how to use [Loki](https://grafana.com/oss/loki/) and [Grafana](https://grafana.com/) to collect your Kubernetes logs. 
