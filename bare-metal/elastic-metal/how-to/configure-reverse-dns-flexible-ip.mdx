...
meta:
  ...
  description: This page explains how to configure the reverse DNS of a flexible IP on Elastic Metal servers
content:
  h1: How to configure the reverse DNS of a flexible IP on Elastic Metal servers
  paragraph: This page explains how to configure the reverse DNS of a flexible IP on Elastic Metal servers
