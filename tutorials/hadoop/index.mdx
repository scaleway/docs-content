...
- **Big Data Analysis:** Big Data tends to be distributed and unstructured in nature. Hadoop processes the logic (not the actual data) that flows to the computing nodes, less network bandwidth is consumed. This concept, called "data locality concept", helps increase the efficiency of Hadoop-based applications.
