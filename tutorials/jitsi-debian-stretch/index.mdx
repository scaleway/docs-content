...
[Jitsi Meet](https://jitsi.org/jitsi-meet/) is a free and fully encrypted open-source video conferencing solution that does not require an account or subscription.
