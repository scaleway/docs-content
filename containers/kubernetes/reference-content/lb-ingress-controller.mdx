...
- You must have an account and be logged into the [Scaleway console](https://console.scaleway.com).
- You have set up a Kapsule cluster, deploying a TRAEFIK2 ingress controller via the application library using the [Easy Deploy function](/containers/kubernetes/how-to/enable-easy-deploy/).
