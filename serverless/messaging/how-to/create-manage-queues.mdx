...
- Have [activated SQS](/serverless/messaging/how-to/get-started/#how-to-activate-sqs-or-sns) for the [region](/serverless/messaging/concepts/#region) in which you want to create a queue
