...
## Can I allowlist the IPs of my functions?

Some services needs to filter IPs for example databases. Serverless Functions does not support Virtual Private Networks yet but you can use Scaleway IP Ranges definied here: http://as12876.net/