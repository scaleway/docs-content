...
<Message type="important">
  `verify-full` is supported only for certificates created or renewed after 1st February 2023. The `verify-full` option does not work for certificates created before this date. If you want to use this option, you can [renew the certificate](/postgresql-and-mysql/how-to/renew-tls-certificate/).
</Message>
