...
To use the SDK, you need an access key and a secret key for the Scaleway API. Refer to Scaleway's [documentation on API keys](/iam/credentials/create-api-keys/) for instructions on creating and retrieving these keys.
