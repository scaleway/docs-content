...
- [Owner](/iam/concepts/glossary/#owner) status or appropriate [IAM permissions](/iam/concepts/glossary/#permission)
...
For detailed information about creating API keys, refer to the [how to create API keys documentation](/iam/credentials/create-api-keys/).
...
For information on how to retrieve your Project ID, refer to our [dedicated documentation](/organizations-and-projects/project/create-a-project/).
