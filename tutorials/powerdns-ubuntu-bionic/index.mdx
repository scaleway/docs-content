...
4. The last setting to configure in the PowerDNS configuration file is quite obvious, we need to specify that our instance is the **primary** server in our setup. To do this search for the `master` option and enable it:
