...
3. Run the command below to import data into your Serverless SQL Database using `pg_restore`. Make sure to replace the placeholders with your Serverless SQL Database connection parameters:
    ...
    <Message type="note">
    You can find this information on the [overview page](https://account.scaleway.com/?service=elementsserverless-db/databases) of your database.
    </Message>
...
1. In a terminal, access the directory containing the backup file, then run the command below to import data to your Serverless SQL Database using `pg_restore`. Make sure to replace the placeholders with your Serverless SQL Database connection parameters:
    ...
    <Message type="note">
    You can find this information on the [overview page](https://account.scaleway.com/?service=elementsserverless-db/databases) of your database. The password is the [IAM secret Key](/iam/concepts/#api-key) corresponding to the [IAM user](/iam/concepts/#user) or [IAM application](/iam/concepts/#application) you are connecting with. 
    </Message>
