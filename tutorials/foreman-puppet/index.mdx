...
content:
  h1: How to Install and Configure Foreman on Ubuntu Xenial
  paragraph: Discover how to install and configure Foreman on Ubuntu Xenial
tags: Foreman puppet Ubuntu-Xenial puppet
steps:
