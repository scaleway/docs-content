...
<Message type="important">
  Renaming a cluster is not a cosmetic change. The cluster name is used in several control-plane components, and renaming triggers a complete redeployment of the control plane. This operation can cause temporary disruption to your workloads. The cluster typically returns to normal operation within 1 to 2 hours. Avoid renaming production clusters during peak usage periods. For more information, see the [Kubernetes FAQ](/kubernetes/faq/#what-are-the-impacts-of-renaming-a-kubernetes-cluster).
</Message>
