...
Find out more information about how Cockpit is billed depending on your data types in the [FAQ](/cockpit/faq/#how-am-i-billed-for-using-cockpit-with-my-scaleway-data).
