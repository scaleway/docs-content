---
meta:
  title: Configuring a HP SMART ARRAY P410/P222 RAID controller
  description: This page explains how to configure the HP SMART ARRAY P410/P222 RAID RAID controller
content:
  h1: Configuring a HP SMART ARRAY P410/P222 RAID controller
...
<Navigation title="See Also">
  <PreviousButton to="/bare-metal/hardware/reference-content/configure-dell-perc-h800/">Configuring a DELL PERC H800 RAID controller</PreviousButton>
  <NextButton to="/bare-metal/hardware/reference-content/configure-hp-smart-array-p420/">Configuring a HP SMART ARRAY P420 RAID controller</NextButton>
</Navigation>
