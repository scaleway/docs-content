...
excerpt: |
  This page explains how to transfer a domain name
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/dedibox-network/domains/how-to/transfer-domain
image: /assets/images/docs/scaleway.png
keywords: dedibox, network, dedicated servers, domain, domain names, scaleway, transfer
dates:
  validation: 2021-05-26
  posted: 2021-05-26
---

You can transfer any domain purchased or renewed at another registrar, to Scaleway, as long as you meet the conditions shown below.
...
2. Enter your domain name in the search bar, and click **search a domain**. The **Domain name choice** page displays, showing that the domain is not available for purchase.
