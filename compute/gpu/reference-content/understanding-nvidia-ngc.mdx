...
Unleash the power of your application's deployment with Scaleway and NGC, where seamless deployment is as effortless as a quick one-two-three!
1. Deploy your Scaleway GPU Instance. You can do it from the [console](https://console.scaleway.com/instance/servers/create?imageKey=7bdc1afb-231f-486a-9b85-1b0478bc0e4a&offerName=RENDER-S&zone=fr-par-2), by using [CLI tools](https://github.com/scaleway/scaleway-cli), or the [Scaleway API](https://www.scaleway.com/en/developers/api/instance/).<sup>1</sup>
...
* **Data Science Tools:** NGC provides tools for data preprocessing, exploration, and analysis, allowing data scientists to work more efficiently with their data.
...
<sup>1</sup> You require [GPU Instance quotas](/console/my-account/reference-content/organization-quotas/#gpu-instances) to be able to deploy GPU Instances.