...
For better traceability and consistency, we recommend using **versioned tags** (e.g., `:v1.0.0`, `:1.2.3`) instead of mutable tags like `:latest`. This ensures you always know which version of your application is running and makes rollbacks easier.
