...
You can easily create a NATS namespace from the [Scaleway console](/serverless/messaging/how-to/create-namespace) or via the [Scaleway API](https://developers.scaleway.com/en/products/messaging_and_queuing/api/v1alpha1/).
