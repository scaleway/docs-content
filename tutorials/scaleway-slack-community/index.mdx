...
import image3 from './assets/scaleway-join-channel-or-see-more-details.webp'
import image4 from './assets/scaleway-open-the-slack-app.webp'
...
<Lightbox image={image2} alt="List of Scaleway Community Slack channels" />
...
3. At the bottom of your workspace, you have the following options: **Join Channel** or **See More Details**. Click **Join Channel** to participate and send messages.
    <Lightbox image={image3} alt="Join channel or see more details" size="medium" />
    <Message type="tip">
...
1. Click **Scaleway Community** in the upper left corner of the screen to reveal a dropdown menu.
    <Lightbox image={image4} alt="Scaleway Slack Community workspace" />
