...
A backup is a copy of your data, stored in another location. In case of any hardware or software failure you can restore your data from the backup. It is recommended to make backups regularly. Each Dedibox server comes with 100 GB of free [Dedibackup](https://www.scaleway.com/en/dedibox/storage/dedibackup/) storage. You can upload your backups to this storage using the FTP protocol. A 750 GB Dedibackup is available as a further option.
