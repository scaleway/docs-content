...
description: This page helps you to implement Single Sign-On on your organization with Authentik 
dates:
  validation: 2025-
  posted: 2025-
---
...
2. Click **Confirm**.
3. Download the signing certificate from Authentik and copy it's content.
