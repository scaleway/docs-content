...
meta:
  ...
  description: In this tutorial you will learn how to create your own Valheim server with Scaleway Elements Instances. We offer a large range of Instances that will suits your gaming needs for your Valheim server.
content:
  h1: How to create a Valheim server with Scaleway Elements
  paragraph: In this tutorial you will learn how to create your own Valheim server with Scaleway Elements Instances. We offer a large range of Instances that will suits your gaming needs for your Valheim server.
tags: compute image gameserver game play Valheim valheim-server Elements
image: /assets/scaleway_valheim.webp
steps:
...
At Scaleway, we offer a large range of Instances that will suit the gaming needs of your Valheim server. In this tutorial you will learn how to create your own Valheim server with Scaleway Elements Instances. 
