...
A Grafana user is any individual who can log in to [Grafana](https://grafana.com). Each user is associated with a role. Managed dashboards in the "Scaleway" folder are always read-only, regardless of your role. There are two types of roles:
