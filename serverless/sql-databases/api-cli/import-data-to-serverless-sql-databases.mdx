...
#### Adding your new Serverless SQL Database as a destination
...
<Message type="important">
This procedure does not currently work with Serverless SQL Databases. However, you can import your backup using [Managed Database for PostgreSQL and MySQL](/managed-databases/postgresql-and-mysql/).
</Message>
...
7. Select your preferred way of synchronizing future schemas changes and then click **Save & Continue**.
...
#### Configuring the loader to connect to your new Serverless SQL Database
...
4. Run the command below to load your data to your Serverless SQL Database using the [psql \copy command](https://www.postgresql.org/docs/current/app-psql.html#APP-PSQL-META-COMMANDS-COPY):
    ...
    <Message type="tip">
      The PostgreSQL [command `COPY`](https://www.postgresql.org/docs/current/sql-copy.html) cannot be used directly, as it requires the source file to be available on the PostgreSQL instance itself.
    </Message>
