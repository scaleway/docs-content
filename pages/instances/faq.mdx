...
See the documentation on [creating an image from a snapshot](/instances/how-to/create-image-from-snapshot/).
...
Check the [Instances availability guide](/account/products-availability/) to discover where each Instance type is available.
