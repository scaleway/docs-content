...
You can examine the [Kubernetes audit policy](https://gist.github.com/Tomy2e/938e85ab78325e6a42155d54e1df8d1b) file, which contains a list of rules, giving you complete visibility into our API server configuration and the chosen request treatments or exclusions.
