...
3. Enter a name for your bucket. The bucket name is used as a unique identifier which allows us to provide features such as the bucket location and geo-resiliency.
    <Message type="note">
...
4. Select the geographical location in which your bucket will be created. Scaleway Object Storage is currently available in three Regions.
