...
>
  You can now reserve private IPs with IPAM, and use a reserved IP when attaching a specific resource to a Private Network. Find out more in our [dedicated documentation]((/network/ipam/how-to/reserve-ip/)).
</Alert>
