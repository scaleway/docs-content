...
<Message type="tip">
  We recommend specifying timezones when creating time-based conditions. See [Timezones](/iam/policies-permissions/understanding-policy-conditions/#timezones) for details.
</Message>