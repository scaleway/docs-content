...
1. Click **Apache Kafka®** in the **Data and Analytics** section of the [console](https://account.scaleway.com/?service=elements) side menu. The **Clusters for Apache Kafka®a** product page displays.
