...
[SSH keys](/console/my-account/concepts/#ssh-key) allow you to securely connect to your Instances, Elastic Metal servers and Mac mini M1 without using a password. An SSH key consists of an [RSA key pair](https://en.wikipedia.org/wiki/RSA_(cryptosystem)), which has two elements:
