...
<Message type="note">
  Some SNS features are not yet available with Scaleway Topics and Events. Supported subscribers are currently limited to:
    ...
    - Scaleway queues in the same [Project](/organizations-and-projects/concepts/glossary/#project)
...
Credentials are scoped to your Topics and Events service at [Project](/organizations-and-projects/concepts/glossary/#project)-level. You can choose to give each set of credentials the required level of permissions:
