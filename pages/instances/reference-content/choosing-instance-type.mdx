...
Instances are priced by the hour, with different Instance types having different hourly pricing. You can check out the current prices for Instances either on the [Instance creation page of the Scaleway console](https://account.scaleway.com/?service=elementsinstance/servers/create) or on the [dedicated pricing page of our website](https://www.scaleway.com/en/pricing/?tags=available).