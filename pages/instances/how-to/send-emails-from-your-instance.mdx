...
- Completed the [identity verification process (KYC)](/account/setup-lifecycle/verify-identity/)
...
4. Select the security group for which you want to enable SMTP ports.
...
5. Tick the checkbox **Enable SMTP**.
