...
### StorageClass
**Description**
: Specifies the Storage Class to which the object shall be transferred. On the Scaleway Elements platform the storage classes `STANDARD`, `GLACIER` and `ONEZONE_IA` are available.
