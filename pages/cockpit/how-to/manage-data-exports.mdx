...
The console displays status information about each data export. Status information helps you asses the health of your exports and whether or not you need to take any action.

1. Click **Cockpit** in the **Monitoring** section of the [console](https://console.scaleway.com/) side menu. The Cockpit overview page displays.
2. Click the **Data export** tab. The list of your data exports displays.
3. Check the status indicator next to your data export. The following color-coded indicators are used:
