...
2. Clone the desired VM image from the available MacOS images on Tart's GitHub repository. For example, to run the MacOS Sonomoa image, use the following commands:
    ```sh
