...
A principal is an entity that can be attached to a [policy](#policy). Currently you can attach either an [IAM user](#user), an [IAM application](#application) or an [IAM group](#group) to a policy. 
