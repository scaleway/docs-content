...
<Message type="important">
  Kubernetes Kapsule is fully integrated with Scaleway's [Observability Cockpit](/observability/cockpit/quickstart/).
...
7. Configure port-forwarding to access Grafana from your browser:
  ...
  ```
9. Access `http://localhost:3000` in your browser. Use the admin username and password retrieved earlier.
