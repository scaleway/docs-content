...
import image from './assets/scaleway-renew-domain.webp'
...
1. In your browser, navigate to [the domain name renewal page](https://account.scaleway.com/?service=dediboxen/order/renew). A list of your hosting packages and domain names displays.
