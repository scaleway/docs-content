...
With Scaleway domains, you can now benefit of automatic DNS record creation and updates (autoconfiguration) for domains already registered with the Transactional Email service.
