...
However, **some maintenance operations may impact your database availability** or require actions from your side. In this case, **we will inform you beforehand**, so you can **follow the recommendations below** to ensure the impact on your application is minimal.

The maintenance operations particularly concern our [connection pooler](/serverless/sql-databases/reference-content/serverless-sql-databases-overview/) for now, as we are working to make it as transparent as possible in future Serverless SQL Databases updates.
...
- Disconnect your SQL connections to the database **during 10 seconds**
...
## Maintenance period & communication delay
...
By default, we plan a maintenance period **every Tuesday between 14:30 am and 14:45 am (CEST)**, that disconnects SQL clients from your database **for at most 10 seconds**.
