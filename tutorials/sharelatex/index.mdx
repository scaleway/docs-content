...
tags: compute mediaserver media shaelatex documents editor
excerpt: |
  ShareLaTeX is an open-source online real-time collaborative LaTeX editor.
  This tutorial explains how to install a secure ShareLaTeX instance with an NGINX reverse proxy.
totalTime: PT10M
steps:
  - step: Installing Docker
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/sharelatex#-Installing-Docker
  - step: Configuring ShareLaTeX
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/sharelatex#-Configuring-ShareLaTeX
  - step: Configuring Nginx
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/sharelatex#-Configuring-Nginx
  - step: Configuring Systemd
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/sharelatex#-Configuring-Systemd
  - step: Creating the First User
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/sharelatex#-Creating-the-First-User
  - step: Installing Additional LaTex Packages
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/sharelatex#-Installing-Additional-LaTex-Packages
categories:
  - compute
brands:
  - elements
image: /assets/images/docs/scaleway.png
permalink: docs/tutorials/sharelatex
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, ubuntu server, debian server, linux server, IAAS, baremetal, scalability, ARM, physical server, dedicated server, physicalization, server, latex documents editor
dates:
...
- You have a Virtual Instance running on Ubuntu Xenial
...
3. Start the service `service sharelatex start` and access ShareLaTeX with a web browser: `https://my.instance.ip.address/`
  ...
  <Lightbox src="scaleway-sharelatex-login.png" alt="" />
...
2. Create a first project:
  ...
  <Lightbox src="scaleway-sharelatex-firstproject.png" alt="" />
