...
If your main database node goes down, the standby node will begin handling write operations in less than 10 seconds. Your Database Instance automatically goes into autohealing mode and switches to the `AUTOHEALING` status (represented by a blue dot in the Scaleway console). 
