...
1. Go to your Project dashboard.
    <Message type="tip">
      ...
      <Lightbox src="scaleway-orga-drop-down.webp" alt="screenshot of the left corner of the Scaleway console top-menu. The image shows 'Test' as the Organization / and 'Default' as the Project. A drop-down menu is shown under 'Default' with a list of availble Projects in the Organization and a button to create a new Project."/>
    </Message>
