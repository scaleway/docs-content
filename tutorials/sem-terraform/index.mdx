...
content:
  h1: Creating and accessing a Database Instance using Secret Manager and Terraform/OpenTofu
  paragraph: Discover how to create and securely access a Database Instance using Secret Manager and Terraform/OpenTofu
...
2. Click the `database_secret` secret.
    <Lightbox src="scaleway-db-secret.webp" alt=""/>
