...
<Message type="important">
    The GPU Operator will install the drivers very soon *after* node creation.
</Message>
Beware if your workload immediately schedules on it, it will miss essential components.
