...
| Feature | Description | Status |
| :------------ | :---- | :---- |
|  [CreateBucket](/storage/object/api-cli/bucket-operations/#putbucket) |  Creates bucket | ✅ |
...
|  [ListObjects](/storage/object/api-cli/bucket-operations/#getbucket-(list-objects)) |  Lists objects in the bucket | ✅ |
