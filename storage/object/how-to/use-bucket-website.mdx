...
5. Enter the names of the **index** and **error** files of your website.
    ...
    <Message type="important">
      ...
      - When Bucket Website is enabled, a default [bucket policy](/object/concepts/#bucket-policy) is applied. All objects in the bucket then become publicly visible. You can create your own bucket policy to change the visibility settings [via CLI](/object/api-cli/bucket-policy/).
    </Message>
6. Click **Save configuration** to confirm. The details of your website configuration display.

    You can now [upload the **index** and **error** files](/object/how-to/upload-files-into-a-bucket/) to your bucket, if you have not already done so, as well as the other files that make up your static website.
