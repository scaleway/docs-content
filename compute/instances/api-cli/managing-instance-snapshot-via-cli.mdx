...
<Navigation>
  <PreviousButton to="/compute/instances/api-cli/snapshot-import-export-feature/">Using the import/export feature (API)</PreviousButton>
  <NextButton to="/compute/instances/api-cli/using-routed-ips/">Using routed IPs</NextButton>
</Navigation>