...
| `access_key` | The first part of your [API key](https://account.scaleway.com/?service=elementsiam/api-keys). It is like a unique ID or username and not a sensitive piece of information.                                                 |
| `secret_key` | The second part of your [API key](https://account.scaleway.com/?service=elementsiam/api-keys). It is a unique ID or password and thus a sensitive piece of information to authenticate your access key.                    |
| `project_id` | ID of the Project that will be used as the default value for project-scoped resources. To find your Project ID, you can consult the **[Scaleway console](https://account.scaleway.com/?service=elementsproject/settings)** |
