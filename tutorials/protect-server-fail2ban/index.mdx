...
[Fail2Ban](https://www.fail2ban.org/) is a useful tool that analyses server log files for recurring patterns of failures. This allows to block IP's trying to run brute force attacks against a server.
