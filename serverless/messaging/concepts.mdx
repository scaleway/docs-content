...
Stream volume is one of the factors affecting the billing of Scaleway Messaging and Queuing with SNS. Topic volume is calculated as the total sum of each message'size going out from the topic to the subscriptions)
