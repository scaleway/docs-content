...
excerpt: |
  This page explains how to set up and use a REST network.
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/iot/iot-hub/how-to/setup-use-rest-network/
...
5. Complete the form by specifying the network's details:
  ...
  <Lightbox src="assets/scaleway-iothub_network_modal_rest.png" alt="" />
