...
You can limit the number of concurrent tasks and update de timeout duration of S3 requests on the Veeam Backup & Replication server managing the backup copy operation by adding the elements below:
