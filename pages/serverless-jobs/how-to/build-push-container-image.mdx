...
You can now access your container image from the [Scaleway Container Registry](https://account.scaleway.com/?service=elementsregistry/namespaces), and [deploy a Serverless Job](/serverless-jobs/reference-content/deploy-job/) from this image.
