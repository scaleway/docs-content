...
To avoid spam, remote mail ports cannot be reached from our infrastructure by default. As GitLab requires to send mail, we need to open them. Your account needs to be validated to perform this operation. [Learn more about identiy verification](/console/my-account/how-to/verify-identity).
