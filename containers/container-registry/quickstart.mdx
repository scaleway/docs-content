...
4. Open a terminal window on your local computer. Then log into the namespace by running the following command from the terminal:
    ...
    <Message type="important">
      Replace `[SCW_SECRET_KEY]` with your [API Secret Key](/identity-and-access-management/iam/how-to/manage-api-keys/) and `mynamespace` with the name of your namespace.
    </Message>
