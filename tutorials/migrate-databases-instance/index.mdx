...
The [Managed Database](https://www.scaleway.com/en/database/) product provides reliable high-performance managed SQL database engines, both for PostgreSQL and MySQL. Using the service allows you to stay focused on the development of your applications and to profit from Scaleway's expertise in the management of your database engines.
