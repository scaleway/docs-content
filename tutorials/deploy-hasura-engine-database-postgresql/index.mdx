...
tags: compute database postgresql hasura graphql
excerpt: |
...
totalTime: PT20M
steps:
  - step: Linking Hasura GraphQL Engine with Scaleway Database for PostgreSQL
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/deploy-hasura-engine-database-postgresql/#Linking-Hasura-GraphQL-Engine-with-Scaleway-Database-for-PostgreSQL
  - step: Making your first GraphQL query
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/deploy-hasura-engine-database-postgresql/#Making-your-first-GraphQL-query
categories:
  - storage
  - database
image: /assets/scaleway_hasura.png
permalink: /docs/tutorials/deploy-hasura-engine-database-postgresql/
keywords: cloud tutorials, cloud documentations, cloud instance, cloud hosting, docker, hasura, postgresql, graphql
dates:
...
- You have an account and are logged into the [Scaleway Console](https://console.scaleway.com)- You have a [Scaleway Database for PostgreSQL](https://www.scaleway.com/en/database/)
