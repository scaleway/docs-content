...
2. Click **SQS**. The list of your queues displays. TODO CHECK FLOW.

3. Click the queue you wish to modify. The queue's **Settings** page displays:

    <Lightbox src="scaleway-queue-overview.webp" alt="" /> TODO CHECK SCREENSHOT
...
<Navigation title="See Also">
  ...
  <NextButton to="/serverless/messaging/how-to/dactivate-delete-messaging/">How to deactivate or delete a Messaging and Queuing service</NextButton>
</Navigation>
