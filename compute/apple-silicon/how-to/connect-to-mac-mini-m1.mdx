...
excerpt: |
  This page explains how to connect to a Mac mini M1
totalTime: PT15M
steps:
  - step: TODO
    type: HowToStep
    url: https://www.scaleway.com/en/docs/compute/apple-silicon/how-to/connect-to-mac-mini-m1/
image: /assets/images/docs/scaleway.png
keywords: mac mini, mac mini m1, apple silicon, apple, cloud computing, scaleway, big sur, apple mac, connect, ssh, vnc
dates:
...
3. Click the **VNC** button to launch a VNC session on your Mac mini M1.
  ...
  <Lightbox src="scaleway-m1-vnc.png" alt="" />
  ...
  <Lightbox src="scaleway-vnc-lang.png" alt="" />
