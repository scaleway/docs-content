...
**I**dentity and **A**ccess **M**anagement (IAM) allows you to share access to the management of your Scaleway resources and Organization settings, in a controlled and secure manner. With IAM, you can invite other users to your [Organization](/identity-and-access-management/iam/concepts/#organization), as well as create IAM applications that represent non-human users with their own API keys. You define permissions for users and applications in your Organization via highly customizable [policies](/identity-and-access-management/iam/concepts/#policy). Policies let you specify exactly what rights users and applications (or groups of users and applications) should have within your Organization.
