...
excerpt: |
  ...
  This tutorial will show you how to deploy Odoo 14 on a Scaleway Instance or Scaleway Dedibox dedicated server, running on Ubuntu Focal Fossa (20.04 LTS).
totalTime: PT10M
steps:
...
keywords: dedibox tutorials, dedibox documentations, dedicated server, dedibox, instance, bare metal, bare metal server, ubuntu, ubuntu server, odoo, erp, crm, e-commerce, ecommerce
dates:
...
3. (Optional): Click the **Install** button next to each app you want to install it automatically on your Odoo server. You can see more details about each application by clicking on the **Learn More** button.
