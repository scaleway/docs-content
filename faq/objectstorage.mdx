...
As a new user, you benefit from 750 GB/h of free [Multi-AZ class storage](/storage/object/concepts/#storage-class) for buckets in your Organization, across all [regions](/storage/object/concepts/#region-and-avilability-zone/).
