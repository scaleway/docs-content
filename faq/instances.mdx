...
Instances using a bootscript are not compatible with Routed IPs. As the bootscript feature has reached its end of life (EOL), please refer to [this tutorial](/compute/instances/troubleshooting/bootscript-eol/) for migration instructions.
