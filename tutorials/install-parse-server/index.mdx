...
description: This page shows you what steps are required to install a Parse server on a Scaleway Elements Virtual Instance.
tags: advanced settings
excerpt: |
  Discover how to install your Parse server on a Scaleway Elements Virtual Instance
totalTime: PT15M
steps:
  - step: What is Parse
    type: HowToStep
    url: https://www.scaleway.com/en/docs/install-parse-server/#-What-is-parse
  - step: Install Mongodb
    type: HowToStep
    url: https://www.scaleway.com/en/docs/install-parse-server/#-install-mongodb
  - step: Install NodeJS
    type: HowToStep
    url: https://www.scaleway.com/en/docs/install-parse-server/#-install-nodejs
  - step: Install Parse
    type: HowToStep
    url: https://www.scaleway.com/en/docs/install-parse-server/#-install-parse
  - step: Configuring Parse Server Dashboard
    type: HowToStep
    url: https://www.scaleway.com/en/docs/install-parse-server/#-configuring-parse-server-dashboard
  - step: Verify Parse
    type: HowToStep
    url: https://www.scaleway.com/en/docs/install-parse-server/#-verify-parse
  - step: Accessing Parse Server Dashboard
    type: HowToStep
    url: https://www.scaleway.com/en/docs/install-parse-server/#-accessing-parse-server-dashboard
categories:
  - compute
brands:
  - elements
image: /assets/scaleway_parse.png
permalink: docs/install-parse-server/
keywords: cloud tutorials, cloud documentations, cloud server, cloud hosting, ubuntu server, parse, Nodejs, Mongodb, Parse Dashboard,
dates:
...
1. Access the Parse server dashboard by visiting the URL `http://your-server-ip:4040`
  ...
  <Lightbox src="scaleway-parse_dashboardlogin.png" alt="" />

2. Add the credentials that you entered in the `parse-darshboard-config.json` file.

  <Lightbox src="scaleway-parse_dashboard.png" alt="" />
